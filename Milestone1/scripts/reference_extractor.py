...
def get_paper_references(arxiv_id, retry=3, delay=2):
    """
...
def save_references(arxiv_id, version_folder, verbose=True):
    """
    ...
    if not references:
        ...
        json_path = os.path.join(version_folder, "references.json")
...
def extract_references_for_paper(paper_id, base_data_dir="../data"):
    ...
    """
    paper_folder = os.path.join(base_data_dir, paper_id)
