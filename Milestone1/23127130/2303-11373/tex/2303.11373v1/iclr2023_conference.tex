...
\author{
  Michael Chang\thanks{
  UC Berkeley. 
  $^\dagger$Meta AI Research.
  $^\ddagger$Princeton University.
  $^\star$UT Austin.\newline
  Work done while MC interned at Meta AI. Correspondence to: mbchang@berkeley.edu, amyzhang@meta.com
  }, 
  Alyssa L. Dayan$^*$, Franziska Meier$^\dagger$, \\
  \textbf{ Thomas L. Griffiths$^\ddagger$, Sergey Levine$^*$, Amy Zhang$^{\dagger,\star}$} \\
}
