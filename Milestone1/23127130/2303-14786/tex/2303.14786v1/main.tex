...
Cosmological N-body simulations predict dark matter halos to have significant ellipticities \citep{ellipticity_sim}. We investigate our sensitivity to the ellipticity of the perturber by using an elliptical NFW (eNFW) profile \citep{elliptical_nfw}, whose angular deflection field is given by
\begin{equation}
...
PN acknowledges support from the Gordon and Betty Moore Foundation and the John Templeton Foundation that fund the Black Hole Initiative where she serves as one of the PIs.
