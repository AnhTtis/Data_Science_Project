\documentclass[aps,reprint,twocolumn,superscriptaddress]{revtex4-1}
...
The calculations are based on the formalism of quantum electrodynamics with unstable vacuum developed in Ref.~\cite{fradkin1991}. The nuclei are treated classically as finite-size particles moving along  the hyperbolic Rutherford trajectories. The vector part of the 4-potential created by the nuclei is neglected.
   ...
   \end{align}
   Finally, the mean number of positrons created in the $m$th energy state is
   \begin{align}
...
This work was supported by the Russian Science Foundation (Grant No. 22-62-00004).
...
A.~Gumberidze, Th.~Stöhlker, H.~F. Beyer, F.~Bosch,
...
A.~I.~Bondarev, Y.~S.~Kozhedub, G.~Plunien, and Th. Stöhlker,
...
\bibitem{maltsev2017}
I.~A.~Maltsev, V.~M.~Shabaev, I.~I.~Tupitsyn,
Y.~S.~Kozhedub, G.~Plunien, and Th. Stöhlker,
...
Y.~S.~Kozhedub, G.~Plunien, X.~Ma, and Th. Stöhlker,
\href{https://link.aps.org/doi/10.1103/PhysRevA.98.062709}
{Phys. Rev. A {\bf 84}, 062709 (2018)}.

\bibitem{popov2018}
R.~V.~Popov, A.~I.~Bondarev, Y.~S.~Kozhedub,
I.~A.~Maltsev, V.~M.~Shabaev, I.~I.~Tupitsyn,
 X.~Ma, G.~Plunien, and Th. Stöhlker,
...
\bibitem{maltsev2019}
I.~A.~Maltsev, V.~M.~Shabaev, R.~V.~Popov,
Y.~S.~Kozhedub, G.~Plunien, X.~Ma, Th. Stöhlker,
and D.~A.~Tumakov,
...
\bibitem{shabaev2004}
V.~M.~Shabaev, I.~I.~Tupitsyn, V.~A.~Yerokhin, G.~Plunien, and G.~Soff, \href{https://link.aps.org/doi/10.1103/PhysRevLett.93.130405}
