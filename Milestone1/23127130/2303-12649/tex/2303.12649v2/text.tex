...
Previous researches have exploited its usage in increasing the generalizability for classification networks when solving the vision recognition~\cite{cha2022domain}\cite{liu2021mutual}\cite{peng2019domain} and US image classification~\cite{meng2020mutual} problems.
...
The visual comparisons are shown in Fig.~\ref{Fig:VisualComparison}.
