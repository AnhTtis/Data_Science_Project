...
\tikzfeynmanset{inline=(a1.base)}
\begin{feynman}
	\vertex (a1);
    \vertex[left=1cm of a1] (e1) {$e$};
    \vertex[right=2cm of a1] (b1);
    \vertex[right=1cm of b1] (l1) {$B$};
    \vertex[above=2cm of a1] (c1);
    \vertex[above=2cm of b1] (d1);
    \vertex[above=2cm of e1] (h1) {$H$};
    \vertex[right=1cm of d1] (w1) {$\ell$};
    
    \diagram*[baseline=(e1.base)] {
      {[edges=fermion]
        (e1) -- (a1),
        (d1) -- [edge label=$q$] (c1) -- [edge label=$u$] (a1),
        (d1) -- (w1),
      },
      (b1) -- [charged scalar,thick, edge label'=$S_1$] (a1),
      (d1) -- [charged scalar,thick, edge label'=$S_1$] (b1),
      (h1) -- [scalar] (c1),
      (b1) -- [boson] (l1),
    };
