...
To remedy this problem, we start by considering the continuous equation~\eqref{eq:projected_amstutz} for evolving the level-set function from \cite{Amstutz2006new}
\begin{equation}
\label{eq:gradient_flow}
\frac{\partial \psi}{\partial t} = P_{\psi^\perp}(\mathcal{D}J(\Omega)).
\end{equation}
Instead of using the elaborate approach of \cite{Amstutz2006new}, we discretize \eqref{eq:gradient_flow} by an explicit Euler method, which yields the discretized equation
\begin{equation}
...
Note that we have implemented all of the optimization algorithms for topology optimization considered in Section~\ref{sec:preliminaries} and the novel gradient descent and BFGS methods from Section~\ref{sec:quasi_newton} in our open-source software package cashocs \cite{Blauth2021cashocs}, which is a software for solving arbitrary PDE constrained shape optimization and optimal control problems. Our software is based on the finite element software FEniCS \cite{Alnes2015FEniCS,Logg2012Automated} and derives the necessary adjoint systems for the optimization with the help of automatic differentiation. Therefore, for the discretization of the PDE constraints, the finite element method is naturally employed. Moreover, the source code for our numerical experiments is available freely on GitHub \cite{Blauth2023Software}.
...
\begin{figure}[!b]
	...
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/poisson/nonprincipal_96_cost_functional}
		\caption{Cost functional.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/poisson/nonprincipal_96_angle}
		\caption{Angle.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/poisson/nonprincipal_96_gradient_norm}
...
\begin{table}[!t]
	...
	\begin{tabular}{m{0.1\textwidth} @{\hskip 0.5em} C C C @{\hskip 1em} C}
		...
		\midrule
		Sphere combination & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/sphere_combination_50} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/sphere_combination_100} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/sphere_combination_500} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/clover} \\ 
		%
		Convex combination & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/convex_combination_50} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/convex_combination_100} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/convex_combination_500} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/clover} \\ 
		%
		Gradient descent & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/gradient_descent_50} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/gradient_descent_100} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/gradient_descent_500} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/clover} \\ 
		%
		BFGS & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/bfgs_50} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/bfgs_100} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/bfgs_500} & \includegraphics[width=\sizebox]{./img/poisson/nonprincipal_96/clover} \\ 
		\bottomrule 
	\end{tabular}
\end{table}


However, none of the methods converged based on the angle criterion after \num{500}~iterations. On the contrary, the angle between level-set function and generalized topological derivate remains bounded from below by about \SI{35}{\degree}, so that none of the methods can be considered as converged by this criterion. However, if we take a look at the evolution of the relative norm of the projected gradient, we observe a steep decrease for all methods. The convex and sphere combination methods are able to decrease the norm of the projected gradient by about five and six orders of magnitude, respectively. The gradient descent and BFGS methods are even more efficient and decrease the norm of the projected gradient by about seven and eight orders of magnitude, respectively. Therefore, based on the second convergence criterion, the algorithms can be considered converged. Moreover, for this example, it seems like the angle criterion is too strict as a convergence criterion, whereas the norm of the projected gradient seems to be better suited. 
...
\begin{figure}[!t]
	...
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/poisson/nonprincipal_32_cost_functional}
		\caption{$32\times 32$}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/poisson/nonprincipal_48_cost_functional}
		\caption{$48\times 48$}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/poisson/nonprincipal_64_cost_functional}
		\caption{$64\times 64$}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
...
\begin{figure}[!b]
	...
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/poisson/semilinear_cost_functional}
		\caption{Cost functional.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/poisson/semilinear_angle}
		\caption{Angle.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/poisson/semilinear_gradient_norm}
		\caption{Norm of the projected topological derivative.}
	\end{subfigure}
...
\begin{table}[!t]
	...
	\begin{tabular}{m{0.1\textwidth} @{\hskip 0.5em} C C C @{\hskip 1em} C}
		...
		\midrule
		Sphere combination & \includegraphics[width=\sizebox]{./img/poisson/semilinear/sphere_combination_100} & \includegraphics[width=\sizebox]{./img/poisson/semilinear/sphere_combination_200} & \includegraphics[width=\sizebox]{./img/poisson/semilinear/sphere_combination_500} & \includegraphics[width=\sizebox]{./img/poisson/clover} \\ 
		%
		Convex combination & \includegraphics[width=\sizebox]{./img/poisson/semilinear/convex_combination_100} & \includegraphics[width=\sizebox]{./img/poisson/semilinear/convex_combination_200} & \includegraphics[width=\sizebox]{./img/poisson/semilinear/convex_combination_500} & \includegraphics[width=\sizebox]{./img/poisson/clover} \\ 
		%
		Gradient descent & \includegraphics[width=\sizebox]{./img/poisson/semilinear/gradient_descent_100} & \includegraphics[width=\sizebox]{./img/poisson/semilinear/gradient_descent_200} & \includegraphics[width=\sizebox]{./img/poisson/semilinear/gradient_descent_500} & \includegraphics[width=\sizebox]{./img/poisson/clover} \\ 
		%
		BFGS & \includegraphics[width=\sizebox]{./img/poisson/semilinear/bfgs_100} & \includegraphics[width=\sizebox]{./img/poisson/semilinear/bfgs_200} & \includegraphics[width=\sizebox]{./img/poisson/semilinear/bfgs_500} & \includegraphics[width=\sizebox]{./img/poisson/clover} \\ 
		\bottomrule 
	\end{tabular}
\end{table}
...
\begin{figure}[!b]
	...
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/linear_elasticity/cantilever_cost_functional}
		\caption{Cost functional.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/linear_elasticity/cantilever_angle}
		\caption{Angle.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/linear_elasticity/cantilever_gradient_norm}
		\caption{Norm of the projected topological derivative.}
	\end{subfigure}
...
\begin{figure}[!t]
	...
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{./img/linear_elasticity/cantilever/sphere_combination}
		\caption{Sphere combination.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{./img/linear_elasticity/cantilever/convex_combination}
		\caption{Convex combination.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{./img/linear_elasticity/cantilever/gradient_descent}
		\caption{Gradient descent.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{./img/linear_elasticity/cantilever/bfgs}
		\caption{BFGS.}
	\end{subfigure}%
...
\begin{figure}[!b]
	...
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/linear_elasticity/bridge_single_cost_functional}
		\caption{Cost functional.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/linear_elasticity/bridge_single_angle}
		\caption{Angle.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/linear_elasticity/bridge_single_gradient_norm}
		\caption{Norm of the projected topological derivative.}
	\end{subfigure}
...
\begin{figure}[!t]
	...
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/linear_elasticity/bridge_single/sphere_combination}
		\caption{Sphere combination.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/linear_elasticity/bridge_single/convex_combination}
		\caption{Convex combination.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/linear_elasticity/bridge_single/gradient_descent}
		\caption{Gradient descent.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/linear_elasticity/bridge_single/bfgs}
		\caption{BFGS.}
	\end{subfigure}%
...
\begin{figure}[!b]
	...
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/linear_elasticity/bridge_multiple_cost_functional}
		\caption{Cost functional.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/linear_elasticity/bridge_multiple_angle}
		\caption{Angle.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/linear_elasticity/bridge_multiple_gradient_norm}
		\caption{Norm of the projected topological derivative.}
	\end{subfigure}
...
\begin{figure}[!b]
	...
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/linear_elasticity/bridge_multiple/sphere_combination}
		\caption{Sphere combination.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/linear_elasticity/bridge_multiple/convex_combination}
		\caption{Convex combination.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/linear_elasticity/bridge_multiple/gradient_descent}
		\caption{Gradient descent.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/linear_elasticity/bridge_multiple/bfgs}
		\caption{BFGS.}
	\end{subfigure}%
...
\begin{figure}[!t]
	...
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/navier_stokes/navier_stokes_pipe_bend_cost_functional}
		\caption{Cost functional.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/navier_stokes/navier_stokes_pipe_bend_angle}
		\caption{Angle.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/navier_stokes/navier_stokes_pipe_bend_gradient_norm}
		\caption{Norm of the projected topological derivative.}
	\end{subfigure}
...
\begin{figure}[!t]
	...
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/navier_stokes/pipe_bend/sphere_combination}
		\caption{Sphere combination.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/navier_stokes/pipe_bend/convex_combination}
		\caption{Convex combination.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/navier_stokes/pipe_bend/gradient_descent}
		\caption{Gradient descent.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/navier_stokes/pipe_bend/bfgs}
		\caption{BFGS.}
	\end{subfigure}%
...
\begin{figure}[!t]
	...
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/navier_stokes/navier_stokes_rugby_ball_cost_functional}
		\caption{Cost functional.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/navier_stokes/navier_stokes_rugby_ball_angle}
		\caption{Angle.}
	\end{subfigure}%
	\begin{subfigure}{0.333\textwidth}
		\centering
		\includegraphics[width=\textwidth]{img/navier_stokes/navier_stokes_rugby_ball_gradient_norm}
		\caption{Norm of the projected topological derivative.}
	\end{subfigure}
...
\begin{figure}[!t]
	...
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/navier_stokes/rugby_ball/sphere_combination}
		\caption{Sphere combination.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/navier_stokes/rugby_ball/convex_combination}
		\caption{Convex combination.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/navier_stokes/rugby_ball/gradient_descent}
		\caption{Gradient descent.}
	\end{subfigure}%
	\begin{subfigure}{0.25\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./img/navier_stokes/rugby_ball/bfgs}
		\caption{BFGS.}
	\end{subfigure}%
...
The source code for our numerical examples is available publicly on GitHub \cite{Blauth2023Software} and the methods presented in this paper are implemented in our open-source software cashocs \cite{Blauth2021cashocs}.
