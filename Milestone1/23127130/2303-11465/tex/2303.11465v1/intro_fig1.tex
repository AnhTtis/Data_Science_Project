...
\node[scale=4.7] at (4.5,1.15){\input{alice.tex}};
\node[scale=4.7] at (4.57,-1.15){\input{bob.tex}};
...
\node[scale=2.10] at (3,1/2){\input{meas.tex}};
\node[scale=1.3] at (3.3,1/2){$0$};
\node[scale=2.10] at (3,0.8){\input{meas.tex}};
...
\node[scale=2.10] at (3,-1.1){\input{meas.tex}};
\node[scale=1.3] at (3.3,-1.1){$1$};
\node[scale=2.10] at (3,-1.4){\input{meas.tex}};
