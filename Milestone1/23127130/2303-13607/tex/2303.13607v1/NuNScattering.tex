...
\title{High-energy neutrino deeply inelastic scattering cross sections from 100 GeV to 1000 EeV}
...
\begin{abstract}
We present a state-of-the-art prediction for cross sections of neutrino deeply inelastic scattering (DIS) from nucleon at high neutrino energies, $E_\nu$, from 100 GeV to 1000 EeV ($10^{12}~\GeV$).
Our calculations are based on the latest CT18 NNLO parton distribution functions (PDFs) and their associated uncertainties. In order to make predictions for the highest energies, we extrapolate the PDFs to small $x$ according to several procedures and assumptions, thus affecting the uncertainties at ultra-high $E_\nu$; we quantify the uncertainties corresponding to these choices. Similarly, we quantify the uncertainties introduced by the nuclear corrections which are required to evaluate neutrino-nuclear cross sections for neutrino telescopes.
These results can be applied to currently-running astrophysical neutrino observatories, such as IceCube, as well as various future experiments which have been proposed.
\end{abstract}
...
%
Other neutrino telescopes under development with complementary reach include IceCube-Gen2~\cite{vanSanten:2017chb}, KM3NeT~\cite{KM3Net:2016zxf}, Baikal-GVD~\cite{Avrorin:2011zzc}, P-ONE~\cite{P-ONE:2020ljt}, and TRIDENT~\cite{Ye:2022vbk}.
%
The neutrino DIS cross sections are essential inputs to the modeling of the detection of high-energy neutrinos as well as their propagation through the earth, and directly impact the extracted flux of astrophysical neutrinos with energies of about $10^{4}$ GeV to $10^7$ GeV~\cite{IceCube:2017roe,IceCube:2020rnc} as well as output of earth tomography~\cite{Donini:2018tsg}.
%
We may expect the observed neutrino energies extended by a few orders of magnitudes due to large exposure from the next generation of neutrino telescopes.
%
...
%
We also note the recently proposed FASER (ForwArd Search ExpeRiment) program~\cite{Feng:2017uoz,FASER:2018bac} as well as other Forward Physics Facilities (FPFs)~\cite{Anchordoqui:2021ghd,Feng:2022inv} at the LHC, which can potentially fill the gap between neutrino energies measured at IceCube and fixed-target experiments. 
%
%

For all these reasons, a better understanding of $\nu$DIS is also crucial for programs centered on neutrino telescopes and neutrino-based particle astrophysics.
%
...
%\kp{INSERT OUR MAIN CONCLUSION HERE}
...
%
In parallel, we briefly discuss some of the other calculations in the literature, such as GQRS~\cite{Gandhi:1998ri}, CTW~\cite{Connolly:2011vc}, and BGR~\cite{Bertone:2018dse}.
%
...
%\kp{Comments on the Froissart bound~\cite{Illarionov:2011wc}.}
...
%
%\tim{Keping, Dan: I think it might make sense to restructure the flow of sections; at the moment, there is one giant main section on neutrino-nucleon DIS, which is indeed the entirety of the paper. Perhaps subsections A-I should be combined in some cases and elevated to main sections. You might try this, but I can also restructure if you prefer.}
%
...
\begin{figure}
    \centering
    \includegraphics{figs/feyn/feyn_vN_DIS.pdf}
...
\end{equation}
%\kp{Check the coefficient for $F_2$.}
...
\begin{figure}
    \centering
    \includegraphics{figs/Int_xQrange.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.45\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_CC_isoscalar_ScanQlow.pdf}
\includegraphics[width=0.45\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_NC_isoscalar_ScanQlow.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.45\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_CC_isoscalar_ScanX2.pdf}
\includegraphics[width=0.45\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_NC_isoscalar_ScanX2.pdf}
%\includegraphics[width=0.45\textwidth]{figs/UHExsec_CC_neu_CT18NNLO_scanQ.pdf}    
%\includegraphics[width=0.45\textwidth]{figs/UHExsec_CC_neu_CT18NNLO_scanx.pdf}
...
\begin{figure}
    \centering
%    \includegraphics[width=0.49\textwidth]{figs/MSHT20_rglu_Q10GeV.pdf}
%    \includegraphics[width=0.49\textwidth]{figs/MSHT20_rSigma_Q10GeV.pdf}    
%    \includegraphics[width=0.49\textwidth]{figs/nCTEQ15WZSIH_rglu_Q10GeV.pdf}
%    \includegraphics[width=0.49\textwidth]{figs/nCTEQ15WZSIH_rSigma_Q10GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/EPPS21_00_rglu_Q10GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/EPPS21_10_rSigma_Q10GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/nCTEQ15WZ_00_rglu_Q10GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/nCTEQ15WZ_10_rSigma_Q10GeV.pdf}
%\includegraphics[width=0.49\textwidth]{figs/nCTEQ15WZSIH_00_rglu_Q10GeV.pdf}
%\includegraphics[width=0.49\textwidth]{figs/nCTEQ15WZSIH_10_rSigma_Q10GeV.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{figs/Evolution2Extrapolation_CC.pdf}
    \includegraphics[width=0.49\textwidth]{figs/Evolution2Extrapolation_NC.pdf}    
...
\begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{figs/Corr/Corr_CC_sum_isoscalar_gluon_Q1.3GeV-1.png}
    \includegraphics[width=0.49\textwidth]{figs/Corr/Corr_CC_sum_isoscalar_Sglt_Q1.3GeV-1.png}
    \includegraphics[width=0.49\textwidth]{figs/Corr/Corr_CC_sum_isoscalar_gluon_Q100GeV-1.png}
    \includegraphics[width=0.49\textwidth]{figs/Corr/Corr_CC_sum_isoscalar_Sglt_Q100GeV-1.png}
...
%\begin{figure}
%    \centering
%    \includegraphics[width=0.49\textwidth]{figs/Corr/Corr_NC_sum_isoscalar_gluon-1.png}
%    \includegraphics[width=0.49\textwidth]{figs/Corr/Corr_NC_sum_isoscalar_Sglt-1.png}
%    \includegraphics[width=0.49\textwidth]{figs/Corr/Corr_NC_sum_isoscalar_gluon_Q100GeV-1.png}
%    \includegraphics[width=0.49\textwidth]{figs/Corr/Corr_NC_sum_isoscalar_Sglt_Q100GeV-1.png}
%    \caption{Similar to Fig.~\ref{fig:corr}, but for the neutral-current cross section.}
%    \label{fig:corrZ}
%\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{figs/UHExsec_xQmin_CT18NNLO_ZM-VFNSRloPDF_CC.pdf}
    \includegraphics[width=0.49\textwidth]{figs/UHExsec_xQmin_CT18NNLO_ZM-VFNSRloPDF_NC.pdf}
    \caption{Comparison of the neutrino-isoscalar charged $(W)$ and neutral $(Z)$ current DIS cross-section ratios to their respective NNLO predictions, at different orders of QCD perturbation theory. The LO and NLO cross sections are calculated with the corresponding CT18 PDFs at LO~\cite{Yan:2022pzl} and NLO~\cite{Hou:2019efy}.
    }\label{fig:RLO}
\end{figure}

The CT18 global analysis is performed at both NLO and NNLO, with the corresponding error sets determined with the Hessian method~\cite{Hou:2019efy}. Afterward, the leading order analysis has been released based on a few special considerations to improve the quality of fit~\cite{Yan:2022pzl}. In Fig.~\ref{fig:RLO}, we show the CT18 predictions for the neutrino-isoscalar charged and neutral current DIS cross sections, normalized to the individual NNLO prediction.
The LO~\cite{Yan:2022pzl} and NLO~\cite{Hou:2019efy} PDFs are adopted with the same corresponding order of Wilson coefficients in the LO and NLO cross sections.
...
The resulting cross sections normalized to the NNLO ones are displayed in Fig.~\ref{fig:N3LOPDFs}.
...
This result gives us confidence that, in terms of the perturbative expansion, our predictions are already showing strong evidence of convergence at NNLO. In the rest of this work, we will adopt the NNLO calculation as our baseline, with N3LO$'$ corrections included as $K$-factors extracted from Fig.~\ref{fig:N3LOPDFs}.

\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figs/UHExsec_N3LOKF_HOPPET_WZ.pdf}
...
Recently, the complete mass corrections to CC DIS have been achieved up to NNLO~\cite{Gao:2017kkx}. The general-mass corrections to the structure functions have been implemented in the ACOT framework~\cite{Gao:2021fle}, which we will mainly rely on in this work.

\begin{figure}
    \centering
    \includegraphics[width=0.48\textwidth]{figs/KFmc_ACOT2ZM.pdf}
    \includegraphics[width=0.48\textwidth]{figs/UHExsec_xQmin_CT18NNLO_ZM-VFNSRtPDF.pdf}
...
In Fig.~\ref{fig:ACOT} (left), we show the charm mass correction to the (anti)neutrino cross sections, with the ACOT general-mass scheme normalized to the ZM-VFN scheme up to $n_f=4$ flavors.
...
For this reason, we will assume the ZM-VFN scheme for the remainder of this work, with heavy-quark mass effects folded in via $K$-factors (GM/ZM ratios) extracted from Fig.~\ref{fig:ACOT} (left).
...
For this reason, we take $n_f=6$ to include the third-generation quarks in the zero-mass scheme beyond the leading order consistently. The $n_f=6$ cross sections normalized to the $n_f=4$ ones are shown in Fig.~\ref{fig:ACOT} (right).
...
In Fig.~\ref{fig:ACOT} (right), we see that the $n_f=6$ scheme gives at most $6\%(4\%)$ larger cross sections
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figs/CT18NNLO_rglu_Q2GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/CT18NNLO_rSigma_Q2GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/CT18NNLO_rglu_Q10GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/CT18NNLO_rSigma_Q10GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/CT18NNLO_rglu_Q100GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/CT18NNLO_rSigma_Q100GeV.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.48\textwidth]{figs/UHExsec_xQmin_CT18NNLO_ZM-VFNSRNLLx.pdf}
    %\includegraphics[width=0.48\textwidth]{figs/UHExsec_CT18X2CT18_HOPPET_x1e-9.pdf}    
...
%\todo{Compare CT18sx with CT18X calculations. Generate CT18XNNLO\_NF6 PDFs and calculation the $x$-dependent DIS structure functions to calculation cross sections with HOPPET.}

\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figs/UHExsec_CT18NNLO_NLLx_nf6_N3LO.pdf}
\includegraphics[width=0.49\textwidth]{figs/UHExsec_CT18NNLO_NLLx_nf6_N3LO_unc.pdf}
%\includegraphics[width=0.49\textwidth]{figs/UHExsec_xQmin_CT18NNLO_NLLx_nf6_PDFunc_CCNC_vI.pdf}    
...
Here, the impacts from the approximate N3LO$'$ fixed-order corrections, the heavy-quark mass in the ACOT scheme up to $n_f=6$ flavors, as well as the small-$x$ resummation are all included. The specific numerical results are tabulated in Tab.~\ref{tab:ccdis}-\ref{tab:ncdis} in App.~\ref{app:num}.
...
\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figs/CT18ANLO_EPPS21nlo_CT18Anlo_O16_00_rglu_Q10GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/CT18ANLO_EPPS21nlo_CT18Anlo_O16_10_rSigma_Q10GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/nCTEQ15WZDimuNeu_00_rglu_Q10GeV.pdf}
\includegraphics[width=0.49\textwidth]{figs/nCTEQ15WZDimuNeu_10_rSigma_Q10GeV.pdf}    
...
such as $^{40}\mathrm{Ar}$ and $^{56}\mathrm{Fe}$. In the meantime, present or planned neutrino telescopes, including IceCube
...
thus, such nuclear DIS events are subject to modifications, relative to scattering from free nucleons, due to the influence of the
nuclear medium. The analogous nuclear parton distribution functions (nPDFs) relevant for nuclear DIS must quantify the effects
of nuclear binding on the free-nucleon PDFs --- physics which is known to possess rich phenomenology from very low
to high $x$. Much like the proton PDFs at very low $x$, nuclear PDFs remain essentially unconstrained for $x\! <\! 10^{-4}$, driving significant uncertainties which can in turn
propagate to high-energy nuclear cross sections. This lack of constraints comes not only from the challenge, familiar from studies of proton PDFs, of probing QCD bound states at very high energies, but from the additional complication of gathering
such information from a sufficient variety of nuclear species as to allow a detailed unfolding of the nPDFs' $A$ dependence; such
knowledge is required to leverage the world's nuclear data to improve nPDF predictions for specific nuclei like O relevant to IceCube.

In our present study of neutrino DIS at ultra-high energy, the prevailing nuclear corrections are those at very low $x$, where the
nuclear medium produces a relative suppression of the nPDFs in a phenomenon known as {\it nuclear shadowing}, as shown in Fig.~\ref{fig:nuclPDFs}.
...
\begin{figure}
    \centering
\includegraphics[width=0.49\textwidth]{figs/nCTEQ15WZDimuNeu_CC_O16toIso_Unc.pdf}
\includegraphics[width=0.49\textwidth]{figs/nCTEQ15WZDimuNeu_NC_O16toIso_Unc.pdf}
...
%\begin{figure}
%    \centering
%    %\includegraphics[width=0.49\textwidth]{figs/UHExsec_CC_O16toIso.pdf}
%    \includegraphics[width=0.49\textwidth]{figs/UHExsec_xQmin_CT18NNLO_ZM-VFNS_R_tmc.pdf}      
%    \includegraphics[width=0.49\textwidth]{figs/UHExsec_xQmin_CT18NNLO_ZM-VFNS_R_ht.pdf}    
%    \caption{The target-mass and higher-twist corrections to the neutrino-isoscalar DIS cross section.}
%    \label{fig:tmc}
%\end{figure}
%
%We also have explored other corrections, such as target mass and higher twist, with results shown in Fig.~\ref{fig:tmc}.
%We follow the same prescription adopted in the CT18QED study~\cite{Xie:2021equ}.
%We take the Georgi-Politzer model as our baseline scenario for target mass corrections.

\begin{figure}
    \centering
    \includegraphics[width=0.52\textwidth]{figs/UHExsec_proton.pdf}  
    \includegraphics[width=0.47\textwidth]{figs/UHExsec_p2I.pdf}
    \includegraphics[width=0.49\textwidth]{figs/UHExsec_H2OtoO.pdf}
...
%\kp{Provide the predictions of H$_2$O.}
...
The neutral-current scattering gives $R_{p/I}^{\bar{\nu}(Z)}\sim1$, which is resulted from an accidental numerical cancellation  between the spin correlation (\emph{i.e.}, in the minus sign) and the $F_3$ difference in Eq.~(\ref{eq:diffXS}). 
...
Taking the universal nuclear correction in the high-energy limit to be $R_{O}\sim0.81$ [cf.~Eq.~(\ref{eq:RO}) and Fig.~\ref{fig:nucl} based on EPPS21], 
...
In addition, a number of similar calculations exist in the literature, such as the Gandhi, Quigg, Reno, and Sarcevic (GQRS)~\cite{Gandhi:1998ri}, Connolly, Thorne, and Waters (CTW)~\cite{Connolly:2011vc}, as well as Bertone, Gauld, and Rojo (BGR)~\cite{Bertone:2018dse}. Similar to our framework, all these calculations adopt the structure-function approach, but with different schemes at different orders, as well as different PDFs. Both the GQRS and CTW took the LO structure functions, while PDFs are based on CTEQ4M~\cite{Lai:1996mg} and MSTW08~\cite{Martin:2009iq}, respectively. The CSMS calculation is performed with the Thorne-Roberts scheme~\cite{Thorne:1997ga,Thorne:2006qt} at NLO with the HERAPDF1.5 PDFs~\cite{Cooper-Sarkar:2010yul}. The BGR calculation is the most closed one to our framework, with the heavy-flavor structure function in the FONLL scheme up to $n_f=6$ flavors~\cite{Forte:2010ta} together with the small-$x$ resummation~\cite{Ball:2017otu} included. In this work, we have gone beyond in two aspects. We have included the complete heavy-quark effect up to NNLO in the ACOT scheme~\cite{Gao:2021fle}. It turns out the heavy-flavor effect is negligible at an ultrahigh energy, while a negative 2\% when $E_\nu\sim100~\GeV$, as examined in Sec.~\ref{sec:th}. We also extend our calculation up to approximate N3LO, with zero-mass Wilson coefficient functions. 

\begin{figure}
\centering
\includegraphics[width=0.49\textwidth]{figs/CT18toCSMS_CC_neu.pdf}
\includegraphics[width=0.49\textwidth]{figs/CT18toCSMS_CC_ant.pdf}
\includegraphics[width=0.49\textwidth]{figs/CT18toCSMS_NC_neu.pdf}
\includegraphics[width=0.49\textwidth]{figs/CT18toCSMS_NC_ant.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{figs/HERAPDF15_00_rglu_Q10GeV.pdf}
    \includegraphics[width=0.49\textwidth]{figs/HERAPDF15_10_rSigma_Q10GeV.pdf}
    \caption{The comparison of gluon and flavor-singlet PDFs at $Q=10~\GeV$ between the CT18 NNLO and HERAPDF1.5 NLO PDFs.}
    \label{fig:HERAPDF15}
\end{figure}

In this work, we are mainly targeting a state-of-art prediction for the high-energy neutrino cross section measured at IceCube. 
...
In the earth absorption (up-going muon) case, the neutrino and antineutrino cross section was flux weighted as
...
Finally, based on nuclear PDF sets, EPPS21 and nCTEQ15WZ, we have estimated the nuclear corrections up to be negative $-20\%$ as a result of the nuclear shadowing effect.
...
\begin{figure}[h]
    \centering
    %\includegraphics{figs/IceCube+CSMS+CT18.1208.pdf}
\includegraphics[width=0.49\textwidth]{figs/CT18_CSMS_IceCube_abspt.pdf}    
\includegraphics[width=0.49\textwidth]{figs/CT18H2O_CSMS_IceCube_H2O.pdf}
...
The theoretical {\em neutral current} (NC) cross section is also important because the IceCube Collaboration uses {\em the absorption of neutrinos by the Earth} to estimate the flux of neutrinos incident on the Earth. Neutrinos incident on the Earth from the Northern Hemisphere must pass through a fraction of the Earth, dependent on their direction, before reaching the IceCube Observatory at the South Pole. As they travel through the Earth, some neutrinos will be absorbed or scattered by interacting with matter, including both CC and NC interactions. 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.49\textwidth]{figs/ColliderNeuXS2E_CT18.pdf}
    \includegraphics[width=0.49\textwidth]{figs/EnergyGap_FASER.pdf}    
...
Our theoretical cross section is also shown as the red line in Fig.~\ref{fig:collider}~(right), which provides state-of-the-art predictions for the neutrino scattering measured at these FPFs~\cite{Anchordoqui:2021ghd,Feng:2022inv}.

%these emulsion detectors will observe neutrino charged-current interactions from which the cross section can be determined, for neutrino energies ranging 
%Therefore, one goal of neutrino observations at FASER is to obtain an accurate measurement of the cross section in the ``energy gap". 
%Figure \ref{fig:energygap} shows neutrino cross sections measured at the Tevatron (the NuTeV experiments) and at IceCube.
%The energy gap would be filled in by FASER.
%The figure also shows our prediction based on CT18 parton distribution functions.

%For LHC Run 3 to detectors have been installed on the beam collision axis  on opposite sides of the ATLAS detector: FASER$\nu$ with pseudorapidity $\eta>8.2$ and SND@LHC with $-8.4<\eta<-7.2$~\cite{FASER:2020gpr}.
%
%This range is the ``energy gap" between the highest energy Tevatron experiments, e.g., at the NuTeV detector~\cite{NuTeV:2005wsg}, and the lowest energy cosmic neutrinos, e.g., at IceCube.

\section{Conclusions}
\label{sec:conc}
%
In this work, we have presented up-to-date theory calculations for neutrino-nucleon deeply-inelastic scattering (DIS) mediated by both charged- and neutral-current interactions over a wide range of neutrino energies, spanning $E_\nu\! \sim\! 50~\GeV$ up to $10^{12}~\GeV$. We have also
...
This latter quantity may be expanded in a complete basis of allowed Lorentz structures, such that folded into the hadronic tensor are the structure functions of the target nucleon or nucleus; these in turn can be computed according to
 %
...
energies, as well as astrophysical neutrino telescopes, which can potentially observe events in the ultra-high energy regime. 

%\kp{Rephrase the motivations and goals for this paper.}
%
...
which is based on an NLO QCD calculation using HERAPDF1.5 PDFs. While our calculation agrees with CSMS for NC DIS, our results are $\sim\!10\!-\!20\%$ smaller for CC DIS. This difference is a consequence of two primary factors: the negative NNLO corrections including in our calculation as well as the (comparatively) smaller gluon PDF obtained by CT18 in the small-$x$ region relative to HERAPDF1.5. 
...
In between the accelerator neutrinos and the IceCube telescope, an energy gap exists for $360~\GeV\lesssim E_\nu\lesssim6~\TeV$, which may potentially be filled by the ongoing and future FASER~\cite{FASER:2018bac} as well as other Forward Physics Facilites~\cite{Anchordoqui:2021ghd,Feng:2022inv} experiments at the LHC.

A number of improvements upon the present work can be pursued in the future. For instance, very recently, approximate N3LO PDFs have been released based on the global analysis of the MSHT group~\cite{McGowan:2022nag}.
A complete N3LO PDF set is needed to obtain the full N3LO contribution.
As we have seen, theoretical uncertainties increase significantly with neutrino energy, mainly induced by the large free-nucleon and nuclear PDF uncertainties in the small-$x$ region. Constraining small-$x$ PDFs, especially the gluon PDF, better can greatly enhance the accuracy of high-energy theory predictions. This might be furthered by incorporating LHCb data on the forward production of $D$ and $B$ mesons~\cite{LHCb:2015swx,LHCb:2017vec} into global QCD analyses of PDFs.
...
We would like to thank Valerio Bertone for the helpful instruction about the BGR calculation
and Donna Naples for providing the NuTeV data. We also thank Faiq Muzakka, Fred Olness, and the larger nCTEQ collaboration for providing grid files
corresponding to the recent DimuNeu nPDF fit as well as for useful discussions related to
neutrino-nuclear interactions, and Tyce DeYoung for reading part of this manuscript as well as a few useful comments. 
%
The work of KX is supported by the U.S. Department of Energy under grant No. DE-SC0007914, the U.S. National Science Foundation under Grants No. PHY-1820760, and also in part by the PITT PACC. 
%
The work of JG is sponsored by the National Natural Science Foundation of China under Grant No.12275173 and No.11835005.
%
The work of TJH~was supported by the U.S.~Department of Energy under contract DE-AC02-06CH11357.
%\dan{The work of DS is supported by XXXX.}
...
\label{app:num}
As explained in the Sec.~\ref{sec:th} and \ref{sec:PDFs}, we collect our theoretical predictions
for the neutrino charged-current and neutral-current deep inelastic scattering cross sections
in Tabs.~\ref{tab:ccdis} and \ref{tab:ncdis}.
The second column of Tabs.~\ref{tab:ccdis}-\ref{tab:ncdis} corresponds to the 
neutrino-isoscalar cross sections $\sigma_{\nu I}$ based on the CT18 NNLO PDFs, including the heavy-quark mass effect with the ACOT scheme, parton flavors up to $n_f=6$, approximate N3LO corrections (N3LO$'$) with massless Wilson coefficient functions, as well as the small-$x$ resummation, which are detailed in Sec.~\ref{sec:aN3LO}, \ref{sec:ACOT} and \ref{sec:smallx}.
The third column indicates the CT18 proton PDF uncertainty quantified with the traditional Hessian error method at 68\% confidence level (CL)~\cite{Pumplin:2001ct}.
In the fourth ($R_{\nu O}$) and fifth columns, we present the nuclear corrections to the isoscalar target O
and the corresponding uncertainty, based on the EPPS21 nuclear PDF sets~\cite{Eskola:2021nhw}, explored in Sec.~\ref{sec:nuclear}.
The sixth column ($R_{\rm H_2O/O}$) denotes the water (H$_2$O) nucleon-averaged ratio defined in Eq.~(\ref{eq:RH2O}). The final neutrino-water cross section can be obtained with Eq.~(\ref{eq:H2O}) and uncertainty with Eq.~(\ref{eq:H2Ounc}). The antineutrino cross sections follow after as another block in Tabs.~\ref{tab:ccdis}-\ref{tab:ncdis}.
...
\begin{figure}
\centering
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_CC_neu_isoscalar_Enu1e4.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_CC_neu_isoscalar_Enu1e8.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_CC_neu_isoscalar_Enu1e12.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_CC_ant_isoscalar_Enu1e4.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_CC_ant_isoscalar_Enu1e8.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_CC_ant_isoscalar_Enu1e12.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_NC_neu_isoscalar_Enu1e4.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_NC_neu_isoscalar_Enu1e8.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_NC_neu_isoscalar_Enu1e12.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_NC_ant_isoscalar_Enu1e4.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_NC_ant_isoscalar_Enu1e8.pdf}
\includegraphics[width=0.32\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_NC_ant_isoscalar_Enu1e12.pdf}
...
\end{equation}
With a few representative energies, we show the percentage of the total cross section as contours plots in Fig.~\ref{fig:xQmin}.
...
\begin{figure}
    \centering
\includegraphics[width=0.45\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_CC_isoscalar_ScanQ.pdf}
\includegraphics[width=0.45\textwidth]{figs/xQ2D/UHExsec_xQmin_CT18NNLO_NLLx_nf6_ZM-VFNS_NC_isoscalar_ScanQ.pdf}    
...
%The corresponding cross sections $\sigma(x_{\min},Q_{\min})$ normalized to the maximal one with respect to Eq.~(\ref{eq:xQ2}) are plotted as the 2D contours in Fig.~\ref{fig:xQmin}. As seen already before, the phase space with $Q>M_{W,Z}$ only contributes a very small amount (less than 10\%) to the total integrated cross section. Similarly, the small-$x$ region, especially the extrapolated region even though covered when $E_\nu>10^{9}~\GeV$, also contributed negligibly to the total cross section. When $Q_{\min}$ increases in the small $Q_{\min}$ region, the contours behave almost vertically. That is to say, cross sections almost remain unchanged, reflecting the negligible contribution from the low $Q$ region. The gap between the contours of 0.99 and 0.01 roughly corresponds to the phase space contributing 98\% to the total cross section, which is the neighborhood around $(x,Q)\sim(M_{W,Z}^2/(2m_NE_\nu),M_{W,Z})$.
%\kp{We remind the reader that the islands of $\sigma/\sigma_{\max}=0.99$ in the charged-current case when $E_\nu=10^{8}~\GeV$ is due to the numerical instability, which does not influence our conclusion here.} 
%\kp{I may need to improve the $0.99$ contours.}
...
\begin{figure}
    \centering
    \includegraphics[width=0.41\textwidth]{figs/Earth.pdf}
    \includegraphics[width=0.58\textwidth]{figs/Earth_density.pdf}    
...
In principle, the neutrino-electron scattering should be included as well. However, the corresponding cross section is generally two or three magnitudes smaller than the nuclear-nucleon one, with an exception around the Glashow resonance region. (See App.~\ref{sec:Glashow} for its details.) Therefore, we can safely neglect it in this estimation.
...
\begin{figure}
    \centering  
    \includegraphics[width=0.49\textwidth]{figs/Trans_prob_neu.pdf}
    \includegraphics[width=0.49\textwidth]{figs/Trans_prob_ant.pdf}    
...
\begin{figure}
    \centering
    \includegraphics[width=0.32\textwidth]{figs/feyn/feyn_ve_NC.pdf}
    \includegraphics[width=0.32\textwidth]{figs/feyn/feyn_ve_CC.pdf}    
    \includegraphics[width=0.32\textwidth]{figs/feyn/feyn_ve_res.pdf}    
...
\begin{figure}
    \centering
    \includegraphics{figs/Glashow_Resonance2.pdf}
