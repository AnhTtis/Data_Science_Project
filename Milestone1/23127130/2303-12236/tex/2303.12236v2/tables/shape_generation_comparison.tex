...
% \salad{} outperforms, or is on par with, the baselines in all evaluation metrics. 
...
\begin{tabularx}{\linewidth}{>{\centering}m{0.5cm} |>{\centering}m{3.5cm}| Y Y Y Y Y Y | Y Y Y Y Y Y }
  ...
  \rowcolor{Gray}
  % Neural Wavelet$*$~\cite{Hui:2022NeuralWavelet}  & \textbf{58.19}  & \textbf{55.46}   & 11.70  & 14.31   & 61.47  & 61.62   & \textbf{64.78}  & 64.40   & \textbf{3.230}  & \textbf{7.756}   & \textbf{71.69}  & \textbf{66.74} \\
  ...
  % 10 & Diff. of $\{(\B{e}_i, \B{s}_i)\}_{i=1}^N$ & 52.36 &	55.01 &	14.56 &	15.86 &	66.92 &	64.31 & 54.02 &	62.05 &	4.551 &	9.627 &	82.76 &	78.99 \\
  \midrule 
