...
\begin{figure*}
    \centering
\includegraphics[width=0.75\paperwidth]{Vis.pdf}% {Vis.eps}
...
\bibitem {Znidarcic2014}%
  ...
  {https://doi.org/10.1063/1.4866270} {10.1063/1.4866270} (
  {2014})
\bibitem {Morton2023}%
  \BibitemOpen
   { { {J.}~
...
\bibitem {Koukouvinis2017}%
  ...
  mechanism behind pistol shrimp cavitation}},\ }\href@noop {} { 
...
\bibitem {Pan2017}%
  ...
  {https://doi.org/10.1073/pnas.1702502114} {10.1073/pnas.1702502114} ( 
  {year} {2017})
\bibitem {Pandey2014}%
  \BibitemOpen
   { { {A.}~
...
\bibitem {Gorissen2020}%
  ...
  {Gorissen}},  { {D.}~ {Melancon}},
   { {N.}~ {Vasios}},  
    { {M.}~ {Torbati}},\ and\ 
  { {K.}~ {Bertoldi}},\ }{ 
   {Inflatable soft jumper inspired by shell snapping},\ }\href@noop {}
  { { {Sci. Robot}\ }\textbf { 
  {volume} {5}},\  {1967} ( {2020})}\BibitemShut
  {NoStop}%
\bibitem {DeGraaf2014}%
  \BibitemOpen
   { { {K.~L.}\ 
  ...
  flat surface},\ }in\ \href@noop {} {\emph {  {Proceedings
  of 19th Australasian Fluid Mechanics Conference}}}\ (
  {2014})
\bibitem {DeGraaf2015}%
  \BibitemOpen
   { { {K.~L.}\ 
  ...
  impacting sphere}},\ }in\ \href@noop {} {\emph {  {Journal
...
\bibitem {Mansoor2016}%
  ...
  sphere with an ultra-viscous wetted surface}},\ }\href@noop {} { 
...
\bibitem {Mansoor2014}%
  ...
  sphere with a wetted surface}},\ }\href@noop {} {
...
\bibitem {White2003}%
  \BibitemOpen
   { { {F.~M.}\ 
  {White}},\ }\href@noop {} {\emph { {Fluid Mechanics 5th
...
\bibitem {Duclaux2007}%
  ...
  {L.}~ {Bocquet}},\ and\  {
  {C.}~ {Clanet}},\ }{ {Dynamics
  of transient cavities},\ }\href@noop {} { { 
...
\bibitem {Audoly2010}%
  \BibitemOpen
   { { {B.}~
  {Audoly}}\ and\  { {Y.}~
  {Pomeau}},\ }\href@noop {} {\emph { {Elasticity and Geometry:
...
\bibitem {Patek2005}%
  ...
  shrimp Odontodactylus scyllarus}},\ }\href@noop {} {
