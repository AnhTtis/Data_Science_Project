...
\date{Version 2.0 dated 26 September 2024%\thanks{\copyleft}
}
...
The details here are unexpectedly subtle.
For starters, for the induction to work
in the case where removing a tet yields
a pair of spheres joined along an edge,
we need to know that an optimal tetration
of this almost-disjoint union of spheres splits as a disjoint union
of tetrations.
We'll address this elsewhere.
