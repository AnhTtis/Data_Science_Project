...
$^1$\small{The Hong Kong University of Science and Technology.} \\
$^2$\small{International Digital Economy Academy (IDEA).} \\
$^3$\small{Microsoft Research at Redmond.} 
$^4$\small{University of Wisconsin-Madison.} \\
$^5$\small{Dept. of CST., BNRist Center, Institute for AI, Tsinghua University.}
...
\begin{center}
    \centering
    \includegraphics[width=0.98\textwidth]{iccv2023AuthorKit/resources/imgs/introfig_v3.1.pdf}  
