\begin{figure*}[b]
\begin{lstlisting}[language=Python, xleftmargin=.15\textwidth, xrightmargin=.15\textwidth]
class ImagePatch:
...
Next, we specify details about all the pretrained models used, as well as the code-generation large language model:
\begin{itemize}
...
\noindent We provide the full API next, in Listing~\ref{listing}:


\begin{figure*}[tp]
\begin{lstlisting}[language=Python, xleftmargin=.15\textwidth, xrightmargin=.15\textwidth, firstnumber=61]
            self.left = left
            self.upper = upper
            self.right = right
            self.lower = lower
...
\end{figure*}
\begin{figure*}[tp]
\begin{lstlisting}[language=Python, xleftmargin=.15\textwidth, xrightmargin=.15\textwidth, firstnumber=159]
...
\end{figure*}
\begin{figure*}[tp]
\begin{lstlisting}[language=Python, xleftmargin=.15\textwidth, xrightmargin=.15\textwidth, firstnumber=259]
...
\end{figure*}
\begin{figure*}[tp]
\begin{lstlisting}[language=Python, xleftmargin=.15\textwidth, xrightmargin=.15\textwidth, firstnumber=372, caption=\textbf{Full API.}, label={listing}]
...
\begin{itemize}
    ...
    \begin{lstlisting}[language=Python, caption=\textbf{RefCOCO example.}]
# chair at the front
def execute_command(image) -> ImagePatch:
    # Return the chair
    image_patch = ImagePatch(image)
...
\begin{lstlisting}[language=Python, caption=\textbf{GQA example.}]
...
\begin{lstlisting}[language=Python, caption=\textbf{OK-VQA example.}]
...
\begin{lstlisting}[language=Python, caption=\textbf{NeXT-QA example.}]
