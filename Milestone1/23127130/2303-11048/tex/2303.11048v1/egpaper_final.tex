...
\par\textbf{(3)} We benchmark our SGT on the established 3DSGG dataset~\cite{3dssg}, with 35.9\% absolute improvements over the state-of-the-art GCN-based method. More importantly, we achieve an 80.40\% improvement on the subset with complex scenes. 
