...
%%%%%%%%% TITLE - PLEASE UPDATE
\title{Generalize More and Forget Less: Domain Continual Face Anti-Spoofing}  % **** Enter the paper title here
...
We find that learning a face anti-spoofing model has better generalized capability tends to forget less in the continual learning setting.
