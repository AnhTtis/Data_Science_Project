...
We first rewrite Eq.~\eqref{eq:dob-weak} in terms of Eq.~\eqref{eq:weakly-unbalanced-walks-k}
...
using a laptop with AMD Ryzen 9 5900HX CPU and 32Gb of RAM. As evident in Fig.~\ref{app:fig:efficiency},
