...
\revII{
$\mathbf{M}$ is a shorthand for the product $\mathbf{Q}^\top\mathbf{NQ}$
that appears in the middle of the second line,
} 
and $\mathbf{L}(k,l)_{ij} = \lambda_i^{l-1}\lambda_j^{k-l}$. Moreover, we used the fact that
