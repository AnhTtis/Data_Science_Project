...
the notion of weak pairwise DoB (see SI, Sec.~\ref{app:sec:weak-pairwise-balance}, for the proof).
...
efficient, even when applied to large systems. Sec.~\ref{app:sec:efficiency} in SI presents
