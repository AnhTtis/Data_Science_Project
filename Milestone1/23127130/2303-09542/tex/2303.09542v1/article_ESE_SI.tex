...
\begin{equation*}
\alpha =\frac{\sigma_{vv}}{2( \sigma_{vv}\sigma_{xx}-\sigma_{xv})},
\quad
\beta =\frac{\sigma_{xx}}{2( \sigma_{vv}\sigma_{xx}-\sigma_{xv})}
\end{equation*}
\begin{equation*}
\delta =\frac{-\sigma_{xv}}{( \sigma_{vv}\sigma_{xx}-\sigma_{xv})}
\end{equation*}
