...
\begin{eqnarray}
M_{\rm ej} \simeq 2\pi R_{\star}^{2}\Sigma \approx 2.4\times 10^{-7} \; {\rm M_{\odot}} \, \frac{\mathcal{R}_{\star}^{2} \mathcal{T}_{\rm QPE,4}}{\alpha_{-1}\dot{m}_{-1} M_{\bullet,6}},
\label{eq:Mej}
\end{eqnarray}
...
\begin{align}
    ...
    4.5\times 10^{45}\,{\rm erg}\,\frac{\mathcal{R}_{\star}^{2}\mathcal{T}_{\rm QPE,4}^{1/3}}{\alpha_{-1}\dot{m}_{-1}M_{\bullet,6}^{1/3}},
    \label{eq:Eej}
\end{align}
...
0.09\,{\rm hr}\frac{\mathcal{R}_{\star}\mathcal{T}_{\rm QPE,4}^{2/3}}{\alpha_{-1}^{1/2}\dot{m}_{-1}^{1/2}M_{\bullet,6}^{2/3}},  \,
\label{eq:tpk}
\end{multline}
...
\begin{eqnarray}
L_{\rm QPE} &\approx& \frac{E_{\rm ej} (R_\star^2 h)^{1/3} }{3v_{\rm ej} t_{\rm QPE}^2} \approx \frac{L_{\rm Edd}}{3}\frac{(R_\star^2 h)^{1/3} }{r_{0}} \nonumber \\
...
\be
\mathcal{D} = \frac{t_{\rm QPE}}{T_{\rm QPE}} \approx 0.022 \, \frac{\mathcal{R}_{\star}}{\alpha_{-1}^{1/2}\dot{m}_{-1}^{1/2} M_{\bullet,6}^{2/3}\mathcal{T}_{\rm QPE,4}^{1/3}}
 \,.
\label{eq:duty}
\ee
...
\approx 12.6\,{\rm eV} \frac{\alpha_{-1}^{1/4}\dot{m}_{-1}^{1/3}M_{\bullet,6}^{1/3}}{\mathcal{R}_{\star}^{1/3}\mathcal{T}_{\rm QPE,4}^{1/4}}   \,.
\label{eq:TBB}
\ee
...
\begin{eqnarray}    
    ...
    &\approx& {76 \, \rm eV} \, \frac{\alpha_{-1}^{5/2}\dot{m}_{-1}^{11/4}M_{\bullet,6}^{14/3}}{\mathcal{R}_{\star}^{1/3} \mathcal{T}_{\rm QPE,4}^{13/3}} \,,
\label{eq:Tobs}
\end{eqnarray}
...
\be
\tau_{\rm decay} = \frac{T_{\rm orb}}{|\dot{T}_{\rm orb}|} \approx \frac{T_{\rm orb}}{2} \frac{M_\star}{M_{\rm ej}} \approx 2000\,{\rm yr} \; \frac{\alpha_{-1}\dot{m}_{-1} M_{\bullet,6} \mathcal{M}_{\star}}{\mathcal{R}_{\star}^{2}},
\label{eq:taudecay}
\ee
...
p_{\rm ram} \simeq \frac{1}{2}\rho_{\rm c} v_{\rm sh}^{2} \simeq \rho_{\rm c}v_{\rm K}^{2} \approx \\ 3.5\times 10^{11}\frac{\mathcal{T}_{\rm QPE,4}^{1/3}}{\alpha_{-1}M_{\bullet,6}^{4/3} \dot{m}_{-1}^{2}} \,{\rm erg\,cm^{-3}},
\end{multline}
...
\label{eq:Liu}
   ...
   & \approx 5\times 10^{-7}\frac{\mathcal{R}_\star^4 \mathcal{T}_{\rm QPE,4}^{1/3}}{\alpha_{-1} \mathcal{M}_\star^2 M_{\bullet,6}^{4/3}\dot{m}_{-1}^{2}} \,.
\end{align}
...
\be
\tau_{\rm abl} \approx 
\frac{M_{\star}}{\Delta M_{\star}}\frac{T_{\rm orb}}{2} \approx 880\,{\rm yr}\, \frac{\alpha_{-1}M_{\bullet,6}^{4/3}\dot{m}_{-1}^{2}\mathcal{T}_{\rm QPE,4}^{2/3} \mathcal{M}_\star^2}{\mathcal{R}_\star^4},
\label{eq:tauabl}
\ee
...
%\begin{multline}
%    \frac{\Delta M_{\rm sh}}{M_{\star}} \approx \left(\frac{p_{\rm ram}}{p_{\star}}\right)^{5/3} \\ \approx  2\times 10^{-6}\frac{\mathcal{R}_{\star}^{20/3}\mathcal{T}_{\rm QPE,4}^{5/9}}{\alpha_{-1}^{5/3}\mathcal{M}_{\star}^{10/3}M_{\bullet,6}^{10/9}\dot{m}_{-1}^{10/3}},
%\end{multline}
%The value of $\Delta M_{\rm sh}$ can in some cases exceed our estimate $\Delta M_{\star},$ (Eq.~\eqref{eq:Liu}), potentially shortening $\tau_{\rm abl}$; however, matter being shocked does not guarantee it will be unbound from the star (see \citealt{Liu+15}).
...
\be
\dot{m}_{\rm dest} \approx 1.3\times 10^{-2}\frac{ \mathcal{R}_\star^{20/13} (\mathcal{M}_{\star}^{\rm 2nd})^{17/65}}{\alpha_{-1}^{5/13} \mathcal{M}_\star^{10/13} M_{\bullet,6}^{2/3}\mathcal{T}_{\rm QPE,4}^{10/39}} \, ,
\label{eq:mdotdest}
\ee
as achieved on a timescale after the TDE,
\be
\tau_{\rm dest} 
\approx 24.7\,{\rm yr}\; \frac{\alpha_{-1}^{3/13}(\mathcal{M}_{\star}^{\rm 2nd})^{34/65} \mathcal{M}_\star^{6/13} \mathcal{T}_{\rm QPE,4}^{2/13}}{\mathcal{R}_\star^{12/13}} \,.
\label{eq:taudest}
\ee 
...
\be
\dot{m}_{\rm dest,2} \approx 0.074\mathcal{M}_{\star}^{-5/3}\mathcal{R}_{\star}^{4}\alpha_{-1}^{-1/3}M_{\bullet,6}^{-4/9}\mathcal{T}_{\rm QPE,4}^{-2/9},
\ee
and corresponding destruction time
\begin{eqnarray}
\tau_{\rm dest,2} &\approx& \frac{M_{\star}}{\dot{m}_{\rm destr,2}\dot{M}_{\rm Edd}} \nonumber \\
&\approx& 480\,{\rm yr}\,\mathcal{M}_{\star}^{8/3}\mathcal{R}_{\star}^{-4}\alpha_{-1}^{1/3}M_{\bullet,6}^{-5/9}\mathcal{T}_{\rm QPE,4}^{2/9}.
\label{eq:taudest2}
\end{eqnarray}
...
\begin{eqnarray}    
    ...
    \approx 1.3\frac{\alpha_{-1}^{5/2}\dot{m}_{-1}^{11/4}M_{\bullet,6}^{14/3}}{\mathcal{R}_{\star}^{1/3}\mathcal{T}_{\rm QPE,4}^{13/3}} \,.
    \label{eq:TQratio}
\end{eqnarray}
...
If the observed quiescent luminosity $L_{\rm Q} \sim 10^{43}$ erg s$^{-1}$ and temperature $T_{\rm Q} \approx 50$ eV from GSN 069 is thermal disk emission (Eqs.~\eqref{eq:LQ}, \eqref{eq:TQ}), then for SMBH masses $M_{\bullet} \sim 3\times 10^{5}-3\times 10^{6}M_{\odot}$ consistent with the host galaxy \citep{Miniutti+23} we infer a range of Eddington accretion fraction $\dot{m} \sim 10^{-2}-0.3$.  As summarized in Fig.~\ref{fig:LpkTobs}, given the observed QPE period $T_{\rm QPE} \approx 9$ hr, our light curve model (Sec.~\ref{sec:lightcurve}; Eqs.~\eqref{eq:tpk}, \eqref{eq:Lpk}, \eqref{eq:Tobs}) predicts QPE flare luminosities $L_{\rm QPE} \approx (1-5)\times 10^{41}\,{\rm erg\,s^{-1}}\mathcal{R}_{\star}^{2/3}$, durations $t_{\rm QPE} \sim (0.1-0.5)\mathcal{R}_{\star}$ hr.  These are in reasonable agreement with those observed ($L_{\rm QPE} \approx 10^{42}$ erg s$^{-1}$; $t_{\rm QPE} \sim 1$ hr; Table \ref{tab:sources}) for a star of a couple solar radii orbiting a SMBH of mass $\sim (1-3)\times 10^{6}M_{\odot}$.  The observed temperature $T_{\rm obs} \sim 100$ eV can can also be reproduced by the model (Eq.~\eqref{eq:Tobs}; Fig.~\ref{fig:LpkTobs}), though there substantial degeneracy between the SMBH mass, accretion rate, and disk viscosity $\alpha.$
...
If the disk extends past the star's apocenter, two collisions will occur per orbit, at radii $\{ r_1,r_2\} $, at intervals $\Delta T_1 \leq \Delta T_2$, such that their sum equals the orbital period $\Delta T_1 + \Delta T_2 = T_{\rm orb}$. When $e$ is relatively small, $(T_1-T_2)/T_{\rm orb} \sim \mathcal{O}(e) \ll 1$, and we have thus assumed $T_{\rm QPE} \approx T_{\rm orb}/2$.
However, for high $e$, the time difference between consecutive collisions can be as short as $\Delta T_1 \approx T_{\rm orb} (r_{\rm p}/r_0)^{3/2} = T_{\rm orb} (1-e)^{3/2}$, and as long as $\Delta T_2 \lesssim T_{\rm orb}$. If both collisions produce observable flares, they will appear to be produced in pairs, spaced with highly asymmetric intervals, $\Delta T_1 \ll \Delta T_2$.
...
\end{equation}
higher by a factor $\sqrt{2/(1-e)}$ compared with Eq.~\eqref{eq:vK}. Previously, we assumed $T_{\rm QPE} \approx T_{\rm orb}/2$, and therefore associated $T_{\rm QPE}$ with $r_0$ (i.e., Eq.~\eqref{eq:TQPE}). We can generalize some of the expressions by defining $T_{\rm QPE} = (\Delta T_1 + \Delta T_2)/2$, and considering
\begin{equation}
    r_{\rm p} \approx r_0 (1-e) \approx 1.4\times 10^{13} \; {\rm cm} \; (1-e) \mathcal{T}_{\rm QPE}^{2/3} M_{\bullet,6}^{1/3} \,.
\end{equation}
such that corrections of order $(1-e)$ raised to different powers are introduced in some of the previous expressions. For example $M_{\rm ej} \to M_{\rm ej} (1-e)^{3/2}$ (Eq.~\eqref{eq:Mej}), $t_{\rm QPE} \to t_{\rm QPE} (1-e)$ (Eq.~\eqref{eq:tpk}), $L_{\rm QPE} \to L_{\rm QPE} (1-e)^{-1}$ (Eq.~\eqref{eq:Lpk}), $\mathcal{D}\to \mathcal{D}(1-e)^{-1/2}$ (Eq.~\eqref{eq:duty}) and $k_{\rm B} T_{\rm obs} \to k_{\rm B} T_{\rm obs} (1-e)^{-9/2}$ (Eq.~\eqref{eq:Tobs}). Apsidal and nodal precession would introduce order unity corrections to these terms, varying on timescales $T_\epsilon \to T_\epsilon(1-e)$ (Eq.~\eqref{eq:Tepsilon}) and $T_\Omega \to T_\Omega (1-e)^{3/2}$ (Eq.~\eqref{eq:TLT}).

Another subtly introduced when considering high $e$ appears if the disk is confined to a smaller radius $r_{\rm d}$, $r_p \lesssim r_{\rm d} \ll r_0$. In this case, the star might intercept the disk only once per orbit, rather than twice. Flares would then occur periodically, with $T_{\rm QPE} \approx T_{\rm orb}$.
...
%Finally, \citet{Lehto&Valtonen96} predict an optically-thin bremsstrahlung spectrum, while in our model the spectral shape is modified significantly by Comptonization (for $\xi \gtrsim 1$; Eq.~\eqref{eq:xi}, Fig.~\ref{fig:spectrum}).   
...
During the final preparation of this manuscript, we became aware of a work by \citet{Tagawa&Haiman23} that explores the radiation signal produced by the shock break-out of a star from an AGN disk, similar in broad terms to the scenario studied in this paper.  Although aspects of our models appear to differ, the essential conclusion of these authors, namely that star-disk collisions can explain observed QPE flares, broadly agree with our own.
...
\be
R_{\rm B} \simeq \frac{Gm_{\bullet}}{v_{\rm K}^{2}} \simeq \frac{m_{\bullet}}{M_{\bullet}}r_0 \simeq 0.02R_{\odot}M_{\bullet,6}^{-2/3}\left(\frac{m_{\bullet}}{100M_{\odot}}\right)\mathcal{T}_{\rm QPE,4}^{2/3}.
\ee
...
\be
t_{\rm QPE,\bullet} \approx 2\times 10^{-3}\,{\rm hr}\,\alpha_{-1}^{-1/2}\dot{m}_{-1}^{-1/2}M_{\bullet,6}^{-4/3}\left(\frac{m_{\bullet}}{100M_{\odot}}\right)\mathcal{T}_{\rm QPE,4}^{4/3};
\label{eq:tpkBH}
\ee
\be
L_{\rm QPE,\bullet} \simeq \frac{L_{\rm Edd}}{3}\left(\frac{h}{r_{0}}\right)^{1/3}\left(\frac{m_{\bullet}}{M_{\bullet}}\right)^{2/3} \approx 2.6\times 10^{40}\,{\rm erg\,s^{-1}}\,\dot{m}_{-1}^{1/3}M_{\bullet,6}^{5/9}\left(\frac{m_{\bullet}}{100M_{\odot}}\right)^{2/3}\mathcal{T}_{\rm QPE,4}^{-2/9},
\label{eq:LpkBH}
\ee
...
\\
&\approx& 280\,{\rm eV}\,\alpha_{-1}^{5/2}\dot{m}_{-1}^{11/4}M_{\bullet,6}^{44/9}\left(\frac{m_{\bullet}}{100M_{\odot}}\right)^{-1/3}\mathcal{T}_{\rm QPE,4}^{-41/9}.
\label{eq:TobsBH}
\end{eqnarray}
...
{{\'S}niegowska}, M., {Grzedzielski}, M., {Czerny}, B., \& {Janiuk}, A.
