...
\begin{table}[t]
    ...
    % \end{subtable} 
\caption{Comparisons with the state-of-the-art token sparsification methods on DeiT-S and DeiT-B. $\triangle$ shows the accuracy difference between each model and its base model.\vspace{-5mm}} \label{sota}
\end{table}
