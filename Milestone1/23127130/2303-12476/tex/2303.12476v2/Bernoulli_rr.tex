...
Let $\nu$ be $\sigma$-finite measure on $Y$ which is  $e^{-\beta c}$-conformal. Assume that $\nu(X) \in (0,\infty)$. Let $U:=\{U_{(m,n)}\}_{(m,n) \in \bbz^2}$ be the Koopmann representation of $\bbz^2$ on $L^2(Y,\nu)$. 
...
Let $U:=\{U_{(r,s)}\}_{(r,s) \in \bbz^2}$ be the Koopmann representation of $\bbz^2$ on $L^{2}(Y_0,\nu)$. Let $H:=L^{2}(X_0,\nu)$, and let $V:=\{V_{(r,s)}\}_{(r,s) \in \bbn^2}$ be the isometric representation of $\bbn^2$ on $H$ defined by 
\[
V_{(r,s)}:=U_{(r,s)}|_{H}.\]

Let $\widetilde{U}:=\{\widetilde{U}_{(r,s)}\}_{(r,s) \in \bbz^2}$ be the Koopmann representation of $\bbz^2$ on $L^{2}(Y,\mu)$. Set $\widetilde{H}:=L^{2}(X,\mu)$, and let $\widetilde{V}:=\{\widetilde{V}_{(r,s)}\}_{(r,s) \in \bbn^2}$ be the isometric representation
