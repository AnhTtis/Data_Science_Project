...
Our fields are real, isotropic and homogeneous such that 
%
\begin{equation}
...
\end{align}
%
The integral over the volume results in a $(2\pi)^3 \delta_{\rm D}(\mathbf{k}-\mathbf{k}')$.  Comparing equations~\ref{eq:one_halo_term_theta} to \ref{eq:poweruv} we arrive at the one-halo power spectrum,
%
\begin{equation}
