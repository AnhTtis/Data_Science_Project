...
Other public codes that we are aware of, but that we have not had a chance to thoroughly investigate are \textsc{halogen}\footnote{\link{https://github.com/EmmanuelSchaan/HaloGen}} \citep[][]{halogen} and \textsc{aum}\footnote{\link{https://github.com/surhudm/aum}} \citep{More2015a}.
