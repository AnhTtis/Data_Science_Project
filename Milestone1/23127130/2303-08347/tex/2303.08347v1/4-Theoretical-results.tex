...
be computed analytically, but the pion is a notable 
...
for instance the nucleon $N(940)$ and its
negative-parity partner, the $N(1535)$, should have 
the same masses modulo small corrections due 
to the small $m_q$. However, the $N(1535)$ is 
almost 600 MeV heavier than the nucleon, an 
...
In this way, one obtains for the pion (and kaon and $\eta$) 
$D$-term
\be
...
The gravitational interactions of 
...
diquark approaches \cite{Hwang:2007tb,Kumar:2017dbf,Chakrabarti:2020kdc,Choudhary:2022den,Fu:2022rkn}, 
...
spectral function approach 
    \cite{Liuti:2005qj}. 
Nuclear medium effects were investigated
in Skyrme model frameworks
\cite{Kim:2012ts,Jung:2014jja,Kim:2022syw}.

The GFFs of a constituent quark were studied
...
\caption{\footnotesize Ji's mass decomposition~\eqref{Jimassdec} for a proton computed in lattice QCD in~\cite{Yang:2018nqn} at a scale $\mu=2$ GeV, as a function of the pion mass.}
\label{fig:massdecomp}

\vspace{5mm}

\includegraphics[width=0.88\columnwidth]{Figures/AgGFFLattice.pdf}
\caption{\footnotesize $A_G(t)$ GFF for various hadrons from \cite{Pefkou:2021fni}, with quark masses corresponding to a larger-than-physical value of the pion mass of 450MeV. }
...
\caption{\footnotesize $D_G(t)$ and $D_{u+d}(t)$ GFF for the proton from \cite{Shanahan:2018pib}, with quark masses corresponding to a pion mass of 450MeV. \label{fig:Dg}}
\end{figure}
