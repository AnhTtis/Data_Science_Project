...
\section{Problem formulation: Dynamic regret}
...
\end{equation}
Since the distributions $P_t$ can vary with time,
...
with respect to the comparator sequence $(\theta^*_1, \theta^*_2,\dotsc)$ below:
\begin{align}
...
\noindent
This is related to the notion of path length between minimizers
in~\citet{bedi2018tracking}.