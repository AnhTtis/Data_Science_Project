...
We use TensorFlow \citep{abadi2016tensorflow} and
Keras~\citep{chollet2015keras} for the following experiments.
...
the learning rate $\eta_t$ of \Cref{alg:linear} begins to oscillate---decreasing
...
We also study the learning rate schedule in~\Cref{propo:optimal-eta}
