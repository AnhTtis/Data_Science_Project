...
\begin{table}[]
  ...
  % \vspace{-2mm}
  \caption{Evaluating \textbf{M17} with $F1@M$ and $SemF1$ using four label sets. $SemF1$ displays a higher consistency across different label versions, as indicated by a lower standard deviation ($\sigma$).}
