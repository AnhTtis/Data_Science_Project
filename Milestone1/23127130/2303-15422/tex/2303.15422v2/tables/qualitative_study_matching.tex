\begin{figure}[]
    ...
    \textbf{Predictions (M18)}: typed lambda calculus, sums, extensional normalisation, grothendieck logical relations \\
    \hdashline
    \textbf{Human}: \\
    ...
    \end{tabular}}}
    % \vspace{-2mm}
    \caption{An example case from KP20k. For human scores, we take the average of the scores from three annotators and normalize to a [0,1] range. Semantic matching outputs similar intermediate scores compared to humans, as well as the closest score after aggregation. The small differences in human precision and recall scores are due to annotation noises.}
    % \vspace{-1mm}
