...
\begin{table*}[]
 ...
 \vspace{-3mm}
 \resizebox{\linewidth}{!}{
 \begin{tabular}{l | c | l l l  | c | l l  | l l }
 \hline
 \multirow{2}{*}{\textbf{Model}} & \multirow{2}{*}{\textbf{\#KP}} & \multicolumn{3}{c|}{\textbf{Reference Agreement ($\uparrow$)}} & \textbf{Faithfulness ($\uparrow$)} & \multicolumn{2}{c|}{\textbf{Diversity ($\downarrow$)}} & \multicolumn{2}{c}{\textbf{Utility ($\uparrow$)}} \\
