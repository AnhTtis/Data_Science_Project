...
\vspace{-6mm}
\caption{An illustration of the proposed framework. \textsc{KPEval} evaluates keyphrase systems on four crucial properties and incorporates semantic-based metrics for more accurate assessment.}
...
Together, these aspects and metrics form \textsc{KPEval}, a \textit{fine-grained semantic-based} keyphrase evaluation framework (Figure \ref{main-framework}). In \cref{re-eval}, we employ \textsc{KPEval} to evaluate 21 keyphrase systems, producing intriguing insights: 
