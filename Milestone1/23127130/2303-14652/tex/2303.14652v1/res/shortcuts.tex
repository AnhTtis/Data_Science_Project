...
\def\st{^{\textnormal{st}}}
\def\nd{^{\textnormal{nd}}}
\def\pascal{$\text{PASCAL-}5^i$}
\def\coco{$\text{COCO-}20^i$}
\def\wideline{0.6pt}
...
\newcommand\yournamenote[1]{\textcolor{blue}{[Name: #1]}}
\newcommand\yourname[1]{\textcolor{blue}{#1}}

\newcommand\xiaoyangnote[1]{\textcolor{orange}{[Xiaoyang: #1]}}
\newcommand\xiaoyang[1]{\textcolor{orange}{#1}}

\newcommand{\zttian}[1]{\textcolor{blue}{{[\textbf{zttian}: #1]}}}
\newcommand\xyc[1]{\textcolor{orange}{[Xiaoyang: #1]}}
\newcommand\xya[1]{\textcolor{orange}{#1}}
\newcommand\xyr[1]{\textcolor{orange}{\xout{\textcolor{black}{#1}}}}
%Improved version of textcircled
