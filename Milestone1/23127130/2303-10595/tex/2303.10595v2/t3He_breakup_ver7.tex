%#!platex t3He_breakup_ver7;dvipdfmx t3He_breakup_ver7
%%---------------------------------------------------------------------------%%
...
in general,
we use eikonal CDCC (E-CDCC)~\cite{Ogata03,Ogata09,Ogata10,Fukui12},
...
To reproduce the binding energies of $t$ and $^3$He,
...
This behavior can be understood from the larger three-body phase volume.
It should be noted, however, that this is not always the case. 
In Ref.~\cite{Watanabe21}, the authors found with a similar approach that, 
for the breakup of $^6$Li, 
the $d+{}^{4}$He two-body channel is more important than the $p+n+{}^{4}$He one, 
despite that the latter has a larger phase volume. 
Further investigations are needed to clarify the relation between the cross sections 
and the sizes of the phase volume for two-body and three-body breakup processes. 
In any case, the results in Fig.~\ref{fig:p-separation}
suggest that the $^3$He breakup reaction should be described as a four-body breakup reaction.
