...
We set the band width $s_0$ in Epipolar Attention to 10, and the number of anchor point $N_A$ in Structured Feature Extractor is set to 32. The matching threshold $\sigma_h$ in Iterable Epipolar Coarse Matching equals to $0.5$, and the threshold in the matching module before refinement is set to $0.2$.
