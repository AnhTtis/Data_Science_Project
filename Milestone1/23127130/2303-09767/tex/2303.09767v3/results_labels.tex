...
\begin{figure*}[h]
	...
	\begin{minipage}[t]{0.4\textwidth}
		\centering
		\includegraphics[valign=t, width=0.9\textwidth]{images/label_quality_citation_graph.pdf} 
		\vspace{-0.05 in}
...
A similar result was also shown by Shamir et al.~\cite{Shamir:Safran:Ronen:Dunkelman:ArXiv:2019} 
...
Dong et al.~\cite{Dong:Liu:Shang:NeurIPS:2022} show that label noise is an inherent part of adversarial training 
