...
\revadd{Furthermore, Tables~\ref{tbl:categorization1}-\ref{tbl:categorization4} in the Appendix provide a detailed categorization and comparison of papers collected in this survey.}
...
\revadd{Re-weighted loss functions can be used to mitigate this model bias and thereby improve robustness.}
...
%\ad{Consequently, the amount of perturbation required to generate an adversarial example decreases with an increase in dimensionality.}
...
Most papers that provide techniques for improving separations 
\revreplace{e.g., by feature selection,}
{do so by modifying the loss function to learn a latent data representation with higher separation.}
They also ensure that \revreplace{it}{this increase in separation} does not come at the expense of decreasing density, as these two concepts are closely related.
...
\revadd{Label noise can be automatically generated as part of adversarial training 
...
\revadd{As humans perceive differences in images by focusing on low-frequency components 
