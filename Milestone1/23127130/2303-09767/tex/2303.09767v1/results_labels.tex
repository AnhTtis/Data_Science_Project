...
\begin{wrapfigure}{r}{0.5\textwidth}
  \vspace{-0.25in}
    \begin{minipage}[t]{0.5\textwidth}
     ...
     \includegraphics[width=0.45\linewidth]{images/label_noise_guideline_overfit.pdf}
     \vspace{-0.15in}
   	 }
     \subcaptionbox{Not overfit.}{
     \includegraphics[width=0.45\linewidth]{images/label_noise_guideline_not_overfit.pdf}
     \vspace{-0.15in}
     }
     \vspace{-0.15in}
...
(e.g., labels for the entire class of dogs rather than labels for each individual dog breed)
