...
\affiliation{Institut Curie, Université PSL, Sorbonne Université, CNRS UMR168, Laboratoire Physico Chimie Curie, 75005 Paris, France}
...
\begin{eqnarray}
\langle T \rangle = \frac{1}{r} \left( \frac{\widetilde{W}(\mathbf{0},r|\mathbf{0})}{\widetilde{W}(\mathbf{0},r|h_0)}  -1\right) .
\label{MFPT_LT_Prop}
\end{eqnarray}
...
TS also acknowledges the support provided by a grant from ITMO Cancer, PSCI.
\section*{Appendix} 
...
where $\bar{t}= r t$, $\alpha_T^2 = 2D \sqrt{2/(\pi \nu)}$ and $u_p=r^{1/4}h_0/\alpha_T$. Therefore, our MFPT can be written as
\begin{equation}
...
\begin{equation}
\langle T_{\nu} \rangle_{\text{passive}} \simeq  \frac{\Gamma(\frac{1}{4})}{\Gamma(\frac{3}{4})} \frac{1}{r^{1/2}} \,\,\,  \left(\frac{h_0}{\alpha_T}\right)^2  \,\,\,  \text{for}  \,\,\, r \ll \left(\alpha_T/h_0\right)^{4}.
...
\begin{eqnarray}
W_{\text{passive}}(h_0,t) = \frac{1}{\sqrt{\pi}} \frac{1}{\beta_T(t)} \exp{\left(-\frac{h_0^2}{\beta_T(t)^2}\right)}
\end{eqnarray}
where $\beta_T(t)=\beta_T\,\, t^{3/8}$ 
with $\beta_T= \sqrt{\frac{2D}{3\pi^{3/4}}}\, \left[ \frac{8}{\pi \kappa} \right]^{1/8}.$ 
The Laplace transform of the above propagator can be written as 
\begin{eqnarray}
\widetilde{W}_{\text{passive}} (y_p, r) =  \frac{1}{\sqrt{\pi}} \frac{1}{\beta_T \, r^{5/8}} J_p(y_p) \end{eqnarray}
where $y_p= r^{3/8} h_0/\beta_T$, and 
\begin{equation}
...
$ \widetilde{W}_{\text{passive}} (0, r) =  \frac{1}{\sqrt{\pi}} \Gamma\left(\frac{5}{8}\right)/(\beta_T \, r^{5/8})$ and  
\begin{equation}
...
For $r \ll (\beta_T/h_0)^{8/3}$ , we obtain
\begin{equation}
\langle T_{\kappa} \rangle_{\text{passive}} \simeq \frac{c_0}{r^{3/8}} \,\, \left( \frac{h_0}{\beta_T} \right)^{5/3} .
