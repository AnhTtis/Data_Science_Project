...
\begin{figure*}
    ...
    \begin{tabular}{*{5}{l}}
        ...
        \begin{minipage}{.16\linewidth}\centering \includegraphics[width=0.3\linewidth]{figs/transformations/002_crop_01.png}\end{minipage} &  
        \begin{minipage}{.16\linewidth}\includegraphics[width=\linewidth]{figs/transformations/002_jpeg_50.png}\end{minipage} &  
        \begin{minipage}{.16\linewidth}\centering\includegraphics[width=0.8\linewidth]{figs/transformations/002_resize_07.png}\end{minipage} &  
        \begin{minipage}{.16\linewidth}\includegraphics[width=\linewidth]{figs/transformations/002_brightness_2.png}\end{minipage} &
        \begin{minipage}{.16\linewidth}\includegraphics[width=\linewidth]{figs/transformations/002_contrast_2.png}\end{minipage} 
        \\ \\
        Saturation 2.0 & Sharpness 2.0 & Rotation $90$ & Text overlay & Combined \\
        \begin{minipage}{.16\linewidth}\includegraphics[width=\linewidth]{figs/transformations/002_saturation_2.png}\end{minipage} &  
        \begin{minipage}{.16\linewidth}\includegraphics[width=\linewidth]{figs/transformations/002_sharpness_2.png}\end{minipage} &  
        \begin{minipage}{.16\linewidth}\includegraphics[width=\linewidth]{figs/transformations/002_rot_90.png}\end{minipage} &  
        \begin{minipage}{.16\linewidth}\includegraphics[width=\linewidth]{figs/transformations/002_overlay_text.png}\end{minipage} &  
        \begin{minipage}{.16\linewidth}\includegraphics[width=\linewidth]{figs/transformations/002_comb.png}\end{minipage} 
        \\ \\
    \end{tabular}
    }
