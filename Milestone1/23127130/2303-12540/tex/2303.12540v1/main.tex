...
\newif\iflong
\longfalse % switch between true/false
...
%
\author{Patrick Godau\inst{1,2,3,4,5\star} \and 
Piotr Kalinowski\inst{1,5\star} \and Evangelia Christodoulou\inst{1} \and Annika Reinke\inst{1,2,3} \and Minu Tizabi\inst{1,4} \and Luciana Ferrer\inst{6} \and Paul Jäger\inst{3,7} \and 
 Lena Maier-Hein\inst{1,2,3,4,8}}
%
...
%
 \institute{Division of Intelligent Medical Systsems, German Cancer Research Center (DKFZ), Heidelberg, Germany 
 \email{patrick.scholz@dkfz-heidelberg.de} \and
Faculty  of  Mathematics  and  Computer  Science, Heidelberg University, Germany \and 
 Helmholtz Imaging,  German  Cancer  Research  Center  (DKFZ),  Germany \and 
 National Center for Tumor Diseases (NCT), Germany \and
 HIDSS4Health - Helmholtz Information and Data Science School for Health, Karlsruhe/Heidelberg, Germany \and Instituto de Ciencias de la Computación, UBA-CONICET, Argentina \and Interactive Machine Learning Group, German Cancer Research Center (DKFZ), Germany \and Medical  Faculty, Heidelberg University, Germany}
...
\begin{figure}[!t]
  \centering
  \includegraphics[width=0.9\linewidth]{assets/1_concept/concept.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{assets/2_overview/sample_grid.pdf}
...
The purpose of our experiments was twofold: (1) to quantify the effect of ignoring prevalence shifts when validating and deploying models and (2) to show the value of the proposed workflow. 
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\linewidth]{assets/3_2_calibration/calibration_cwce_main.pdf}
...
\begin{figure}[!t]
  \centering
  \includegraphics[width=0.95\linewidth]{assets/3_3_threshold/decision_rule_main.pdf}
...
\begin{figure}[!t]
  \centering
  \includegraphics[width=0.95\linewidth]{assets/3_4_assessment/assessment_main.pdf}
...
This project has been funded by (i) the Surgical Oncology Program of the National Center for Tumor Diseases (NCT) Heidelberg, (ii) the German Federal Ministry of Health under the reference number 2520DAT0P1 as part of the pAItient (Protected Artificial Intelligence Innovation Environment for Patient Oriented Digital Health Solutions for developing, testing and evidence based evaluation of clinical value) project, (iii) HELMHOLTZ IMAGING, a platform of the Helmholtz Information \& Data Science Incubator and (iv) the Helmholtz Association under the joint research school “HIDSS4Health – Helmholtz Information and Data Science School for Health” (v) state funds approved by the State Parliament of Baden-Württemberg for the Innovation Campus Health + Life Science Alliance Heidelberg Mannheim.
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.95\linewidth]{assets/3_2_calibration/calibration_bs_suppl.pdf}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.95\linewidth]{assets/3_2_calibration/calibration_cwce_suppl.pdf}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.95\linewidth]{assets/3_3_threshold/decision_rule_supp.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.95\linewidth]{assets/3_4_assessment/assessment_suppl.pdf}
