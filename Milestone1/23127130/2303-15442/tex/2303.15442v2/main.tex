...
%%%%%%%%%%
    ...
    %
    \begin{equation}
    	 p(\{\vec{\delta t}\} | \vec\eta) \propto \prod_{p=1}^{N_p}\prod_{k=1}^{N_f} \int \mathrm{d}\rho_k\,\, \frac{p(\rho_k | \vec{\delta t}_p)}{p(\rho_k)} \times p(\rho_k | \vec\eta) .
    \end{equation}
    %
