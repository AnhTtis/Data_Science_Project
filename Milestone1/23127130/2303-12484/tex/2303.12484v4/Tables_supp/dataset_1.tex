...
\centering
\begin{center}
\caption{Summary of publicly available databases for label-efficient learning in MIA}
...
\multirow{37}{*}{Brain} & \rule{0pt}{2.5ex}BraTS (2012) & Segmentation & \url{http://www.imm.dtu.dk/projects/BRATS2012/data.html}   \\ 
\cline{2-4}
                       & \rule{0pt}{2.5ex}BraTS \citep{menze2014multimodal}  & Segmentation & \url{https://www.smir.ch/BRATS/Start2013\#!\#download}   \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
...
\cline{2-4}
                       & \rule{0pt}{2.5ex}MSD \citep{simpson2019large} &Segmentation &\url{https://drive.google.com/drive/folders/}   \rule[-1ex]{0pt}{0pt}\\
                       &&& \url{1HqEgzS8BV2c7xYNrZdEAnrHk7osJJ--2}\\
\cline{2-4}
                       & \rule{0pt}{2.5ex}dHCP \citep{makropoulos2018developing}            &Segmentation     &\url{http://www.developingconnectome.org/data-release/}       \rule[-1ex]{0pt}{0pt}\\ 
\cline{2-4}
                       &   \rule{0pt}{2.5ex}JSRT Database 
\citep{shiraishi2000development}            & Classification             &\url{http://db.jsrt.or.jp/eng.php}       \rule[-1ex]{0pt}{0pt}\\ 
% \cline{2-4}
...
\cline{2-4}
                       &\rule{0pt}{2.5ex}BigBrain \citep{amunts2013bigbrain}              &Segmentation              &\url{https://bigbrainproject.org/maps-and-models.html\#download}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
...
\cline{2-4}
                       &\rule{0pt}{2.5ex}TCIA \citep{seff2015leveraging}              &Segmentation              &\url{https://www.cancerimagingarchive.net/}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
...
\cline{2-4}
                       &\rule{0pt}{2.5ex}MIRIAD (2012)              &Classification              & \url{https://www.ucl.ac.uk/drc/research/research-methods/minimal-interval-resonance}      \rule[-1ex]{0pt}{0pt}\\
                       &&& \url{-imaging-alzheimers-disease-miriad}\\
                       
\hline
\multirow{50}{*}{Chest}  &\rule{0pt}{2.5ex}IS-COVID \citep{fan2020inf}          &Segmentation              &\url{http://medicalsegmentation.com/covid19/}       \rule[-1ex]{0pt}{0pt}\\ 
\cline{2-4}
                       &\rule{0pt}{2.5ex}CC-COVID \citep{zhang2020clinically}              &Segmentation              &\url{https://ncov-ai.big.ac.cn/download?lang=en}       \rule[-1ex]{0pt}{0pt}\\ 
\cline{2-4}
                       &\rule{0pt}{2.5ex}NLST (2009)              &Detection              &\url{https://cdas.cancer.gov/datasets/nlst/}       \rule[-1ex]{0pt}{0pt}\\ 
\cline{2-4}
                       &\rule{0pt}{2.5ex}NIH Chest X-ray \citep{wang2017chestx}              &Classification              &\url{https://www.kaggle.com/datasets/nih-chest-xrays/data}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
...
\cline{2-4}
                       &\rule{0pt}{2.5ex}ChestX \citep{kermany2018identifying}              &Classification              &\url{https://data.mendeley.com/datasets/rscbjbr9sj/3}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
                       &\rule{0pt}{2.5ex}LUNA (2016)              &Detection              &\url{https://luna16.grand-challenge.org/}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
                       &\rule{0pt}{2.5ex}SegTHOR \citep{trullo2017segmentation}              &Segmentation              &\url{https://competitions.codalab.org/competitions/21145}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
                       &\rule{0pt}{2.5ex}LIDC–IDRI \citep{armato2011lung}              &Segmentation              &\url{https://wiki.cancerimagingarchive.net/pages/viewpage.action?pageId=1966254}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
...
\cline{2-4}
                       &\rule{0pt}{2.5ex}MIMIC-CXR \citep{johnson2019mimic}             &Detection              &\url{https://physionet.org/content/mimic-cxr/2.0.0/}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
                       &\rule{0pt}{2.5ex}CC-CCII \citep{zhang2020clinically} &  Classification & \url{http://ncov-ai.big.ac.cn/download/}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
                       &\rule{0pt}{2.5ex}ChestX-ray8 \citep{wang2017chestx} & Segmentation  & \url{https://nihcc.app.box.com/v/ChestXray-NIHCC/}      \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
...
\cline{2-4}
                       &\rule{0pt}{2.5ex}CheXpert \citep{wang2017chestx} & Segmentation  & \url{https://nihcc.app.box.com/v/ChestXray-NIHCC/}       \rule[-1ex]{0pt}{0pt}\\
\hline
\end{tabular}}
\label{tab:Dataset1}
% \end{tabular}
