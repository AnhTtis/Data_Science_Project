...
\multirow{33}{*}{Brain} & \rule{0pt}{2.5ex}BraTS (2012) & Segmentation & \url{http://www.imm.dtu.dk/projects/BRATS2012/data.html}   \\ 
\cline{2-4}
...
\cline{2-4}
                       & \rule{0pt}{2.5ex}MSD (2018)\cite{simpson2019large} &Segmentation &\url{https://drive.google.com/drive/folders/}   \rule[-1ex]{0pt}{0pt}\\
...
(2000)\cite{shiraishi2000development}            & Classification             &\url{http://db.jsrt.or.jp/eng.php}       \rule[-1ex]{0pt}{0pt}\\ 
% \cline{2-4}
...
\hline
\multirow{35}{*}{Chest}  &\rule{0pt}{2.5ex}IS-COVID (2020)~\cite{fan2020inf}          &Segmentation              &\url{http://medicalsegmentation.com/covid19/}       \rule[-1ex]{0pt}{0pt}\\ 
\cline{2-4}
...
\cline{2-4}
                       &\rule{0pt}{2.5ex}SegTHOR (2017)~\cite{trullo2017segmentation}              &Segmentation              &\url{https://competitions.codalab.org/competitions/21145}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
                       &\rule{0pt}{2.5ex}LIDC–IDRI (2011)~\cite{armato2011lung}              &Segmentation              &\url{https://wiki.cancerimagingarchive.net/pages/viewpage.action?pageId=1966254}       \rule[-1ex]{0pt}{0pt}\\
\cline{2-4}
...
\cline{2-4}
                       &\rule{0pt}{2.5ex}CheXpert (2019) \cite{wang2017chestx} & Segmentation  & \url{https://nihcc.app.box.com/v/ChestXray-NIHCC/}       \rule[-1ex]{0pt}{0pt}\\
\hline
\end{tabular}%}
\label{tab:Dataset1}
% \end{tabular}
