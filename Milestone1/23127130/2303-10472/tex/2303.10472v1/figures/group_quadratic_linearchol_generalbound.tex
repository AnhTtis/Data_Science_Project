...
% https://holatex.app/examples.html?package=tikz
  ...
  \nextgroupplot[
    ...
    \addplot[name path=gvar, color1, mark=none, thick]
      table [x=t, y=gvar] {data/quadratic_linearchol_generalbound.csv}
    ...
    \addplot[name path=opt, color3, mark=none, thick] %
      table [x=t, y=opt] {data/quadratic_linearchol_generalbound.csv} %
    ...
    \addplot[name path=C, fill=none, gray, mark=none]
      table [x=t, y=C] {data/quadratic_linearchol_generalbound.csv}
