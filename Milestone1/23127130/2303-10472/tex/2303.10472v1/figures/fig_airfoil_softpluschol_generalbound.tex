...
\begin{axis}[
    ...
    \addplot[name path=gvar, color1, mark=none, thick]
      table [x=t, y=gvar] {data/airfoil_softpluschol_generalbound.csv}
    ...
    \addplot[name path=ABC, color2, mark=none, thick]
      table [x=t, y=ABC] {data/airfoil_softpluschol_generalbound.csv}
    ...
    \addplot[name path=opt, color3, mark=none, thick] %
      table [x=t, y=opt] {data/airfoil_softpluschol_generalbound.csv} %
    ...
    %  table [x=t, y=ABC] {data/quadratic_softpluschol_generalbound.csv}
    %  ;

    \addplot[name path=C, fill=none, gray, mark=none]
      table [x=t, y=C] {data/airfoil_softpluschol_generalbound.csv}
