  ...
  \nextgroupplot[
    ...
    \addplot[name path=gvar, color1, mark=none, thick]
      table [x=t, y=gvar] {data/pendulum_linearchol_generalbound.csv}
    ...
    \addplot[name path=opt, color3, mark=none, thick] %
      table [x=t, y=opt] {data/pendulum_linearchol_generalbound.csv} %
    ...
    \addplot[name path=ABC, color2, mark=none, thick]
      table [x=t, y=ABC] {data/pendulum_linearchol_generalbound.csv}
    ...
    \addplot[name path=C, fill=none, gray, mark=none]
      table [x=t, y=C] {data/pendulum_linearchol_generalbound.csv}
