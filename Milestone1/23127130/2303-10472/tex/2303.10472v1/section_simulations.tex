...
where \(\lambda\) and \(\sigma\) are hyperparameter.
...
\begin{figure}[t]
  ...
  \caption{
    \textbf{
      ...
      (a) Evaluation of the upper bound (\cref{thm:gradient_upper_bound}).
      (b) Comparison of the variance of different parameterizations resulting in the same \(\vm\), \(\mC\).
    }
  }
  \vspace{-2.0ex}
\end{figure}
