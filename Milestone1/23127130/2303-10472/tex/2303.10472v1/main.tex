...
%\newpage
\input{section_main_result}
%\input{section_smoothness}
\input{section_simulations}
\input{section_relatedworks}
\input{section_conclusion}

%\input{thm_gradient_lower_bound_stl}
...
\section{Survey of Parameterizations}\label{section:survey}
A survey of the parameterizations used by probabilistic programming frameworks is shown in \cref{table:parameterization_survey}.

\input{table_survey_parameterizations}

\clearpage
\input{section_additional_simulations}

\clearpage
\twocolumn

%\input{section_gradient_variance_conditions}
