...
\begin{proofEnd}
  ...
  \begin{align}
    ...
    =
    \left(\alpha - 1\right) \log x + \left(\beta - 1\right) \log\left(1 - x\right)
    \nonumber
  \end{align}
  ...
  \begin{align*}
    ...
    \frac{d \psi^{-1}}{dx}
    \left(
    \left(\alpha - 1\right) \frac{1}{\psi^{-1}\left(x\right)}  + \left(\beta - 1\right) \frac{1}{1 - \psi^{-1}\left(x\right)}
    \right)
    \\
    &\;=
    \left(\alpha - 1 \right) \frac{ {\left( \psi^{-1} \right)}^{\prime} \left(x\right) }{\psi^{-1}\left(x\right)} + \beta \frac{{\left( \psi^{-1} \right)}^{\prime} \left(x\right)}{ 1 - \psi^{-1}\left(x\right) }.
    \\
    &\;=
