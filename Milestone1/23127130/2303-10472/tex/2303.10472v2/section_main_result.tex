...
\begin{remark}
  ...
  for some \(\delta > 0\).
  By setting \(\delta^2 = {\lVert\bar{\zeta}_{\mathrm{KL}} - \bar{\zeta}_{\mathrm{H}}\rVert}_2\), 
  {%
  \setlength{\belowdisplayskip}{1.ex} \setlength{\belowdisplayshortskip}{1.ex}%
  \setlength{\abovedisplayskip}{1.ex} \setlength{\abovedisplayshortskip}{1.ex}%
  \[
  ...
  However, the stated form is more convenient for theory since the first term does not depend on \(\bar{\vzeta}_{\text{KL}}, \bar{\vzeta}_{\mathrm{H}}\).
\end{remark}
