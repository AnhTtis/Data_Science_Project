...
% https://holatex.app/examples.html?package=tikz
  ...
  \nextgroupplot[
      ...
      ytick  = {1e+4, 1e+5, 1e+6, 1e+7, 1e+8, 1e+9},
      %
      ymin   = 1e+4,
      ymax   = 1e+9,
      %
    ...
    \addplot[name path=gvar, color1, mark=none, thick]
      table [x=t, y=gvar] {data/simulation/quadratic_linearchol_boundedentropybound.csv}
    ...
    \addplot[name path=opt, color3, mark=none, thick] %
      table [x=t, y=opt] {data/simulation/quadratic_linearchol_boundedentropybound.csv} %
    ...
    \addplot[name path=ABC, color2, mark=none, thick]
      table [x=t, y=ABC] {data/simulation/quadratic_linearchol_boundedentropybound.csv}
    ...
    \addplot[name path=axis, domain=0:490, fill=none, no markers, draw=none] {1e+4}
    ...
    \addplot[name path=C, fill=none, gray, mark=none]
      table [x=t, y=C] {data/simulation/quadratic_linearchol_boundedentropybound.csv}
    ...
    \draw[thick,color=color3, latex-latex] (ABCcoord2) -- (optcoord)
      node[midway,xshift=-25pt] {\scriptsize\(h\left(\vlambda\right) - h^*\)}
      coordinate [pos=0.5] (dklarrow_coord);

    %\draw[thick,color=color1] (gvarcoord) -- (optcoord)
