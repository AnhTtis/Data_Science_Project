  ...
  \nextgroupplot[
    ...
    \addplot[name path=gvar, color1, mark=none, thick]
      table [x=t, y=gvar] {data/simulation/fertility_squareroot_generalbound.csv}
    ...
    \addplot[name path=ABC, color2, mark=none, thick]
      table [x=t, y=ABC] {data/simulation/fertility_squareroot_generalbound.csv}
    ...
    \addplot[name path=opt, color3, mark=none, thick] %
      table [x=t, y=opt] {data/simulation/fertility_squareroot_generalbound.csv} %
    ...
    \addplot[name path=C, fill=none, gray, mark=none]
      table [x=t, y=C] {data/simulation/fertility_squareroot_generalbound.csv}
    ...
    \draw[thick,color=gray,latex-] (Ccoord) -- (axiscoord)
      node[pos=0.7,xshift=5pt] {\scriptsize\(C\) };
