  ...
  \nextgroupplot[
    ...
    \addplot[name path=gvar, color1, mark=none, thick]
      table [x=t, y=gvar] {data/simulation/pendulum_softpluschol_generalbound.csv}
    ...
    \addplot[name path=opt, color3, mark=none, thick] %
      table [x=t, y=opt] {data/simulation/pendulum_softpluschol_generalbound.csv} %
    ...
    \addplot[name path=ABC, color2, mark=none, thick]
      table [x=t, y=ABC] {data/simulation/pendulum_softpluschol_generalbound.csv}
    ...
    \addplot[name path=axis, domain=0:3990, fill=none, no markers, draw=none] {1e+3}
      coordinate [pos=0.05] (axiscoord);

    \addplot[name path=C, fill=none, gray, mark=none]
      table [x=t, y=C] {data/simulation/pendulum_softpluschol_generalbound.csv}
    ...
    \node[%
      pin={%
        [%
          ...
          pin edge={color3},%
          text=color3%
        ]110:{\scriptsize\(\DKL{q_{\vlambda}}{p}\)}},%
      inner sep=0pt,%
    ] at (DKLcoord) {};
