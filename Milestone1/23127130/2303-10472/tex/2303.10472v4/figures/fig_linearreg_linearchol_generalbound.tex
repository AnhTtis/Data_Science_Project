...
\begin{tikzpicture}
  \begin{groupplot}
    ...
    \input{figures/group_fertility_linearchol_generalbound}
    \input{figures/group_pendulum_linearchol_generalbound}
    \input{figures/group_airfoil_linearchol_generalbound}
    \input{figures/group_wine_linearchol_generalbound}
  \end{groupplot}
