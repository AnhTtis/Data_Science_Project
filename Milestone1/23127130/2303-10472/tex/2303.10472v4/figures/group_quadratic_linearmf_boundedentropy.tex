...
% https://holatex.app/examples.html?package=tikz
  ...
  \nextgroupplot[
    ...
    \addplot[name path=gvar, color1, mark=none, thick]
      table [x=t, y=gvar] {data/simulation/quadratic_linearmf_boundedentropybound.csv}
    ...
    \addplot[name path=opt, color3, mark=none, thick] %
      table [x=t, y=opt] {data/simulation/quadratic_linearmf_boundedentropybound.csv} %
    ...
    \addplot[name path=ABC, color2, mark=none, thick]
      table [x=t, y=ABC] {data/simulation/quadratic_linearmf_boundedentropybound.csv}
    ...
    \addplot[name path=axis, domain=0:490, fill=none, no markers, draw=none] {1e+1}
      coordinate [pos=0.05] (axiscoord);

    %\addplot[name path=ABC, color2, mark=none]
    %  table [x=t, y=ABC] {figures/quadratic_linearchol_boundedentropybound.csv}
    %  ;

    \addplot[name path=C, fill=none, draw=none, gray, mark=none]
      table [x=t, y=C] {data/simulation/quadratic_linearmf_boundedentropybound.csv}
    ...
    \draw[thick,color=color3,{Latex[scale=0.5]}-{Latex[scale=0.5]}] (ABCcoord2) -- (optcoord)
      %node[midway,xshift=-25pt] {\scriptsize\(\DKL{q_{\vlambda}}{p}\)}
    ...
    \draw[thick,color=gray,latex-latex] (Ccoord) -- (axiscoord)
