  ...
  \nextgroupplot[
    ...
    \addplot[name path=gvar, color1, mark=none, thick]
      table [x=t, y=gvar] {data/simulation/fertility_linearchol_generalbound.csv}
    ...
    \addplot[name path=ABC, color2, mark=none, thick]
      table [x=t, y=ABC] {data/simulation/fertility_linearchol_generalbound.csv}
    ...
    \addplot[name path=opt, color3, mark=none, thick] %
      table [x=t, y=opt] {data/simulation/fertility_linearchol_generalbound.csv} %
    ...
    \addplot[name path=axis, domain=0:490, fill=none, no markers, draw=none] {1e+2}
      coordinate [pos=0.05] (axiscoord);

    \addplot[name path=C, fill=none, gray, mark=none]
      table [x=t, y=C] {data/simulation/fertility_linearchol_generalbound.csv}
