...
\begin{eqnarray}
  \Pi^{\text{OPE}}_1 (q^2) = \int_{(3 m_Q)^2}^\infty ds \frac{\rho_{1}^{\text{OPE}}(s)}{s - q^2} + \Pi_1^{\text{cond}}(q^2), \label{Pi-OPE}
\end{eqnarray}
where the second term $\Pi_1^{\text{cond}}(q^2)$ represents the contribution in the correlation function that has no imaginary part but has nontrivial magnitudes after the Borel transformation, and the spectral density $\rho_1^{\text{OPE}}(s)$ in the first term has the following relation: $\rho_{1}^{\text{OPE}}(s) = \text{Im} [\Pi_{1}^{\text{OPE}}(s)]/\pi$. It can be expanded as follows
\begin{eqnarray}
...
\end{eqnarray}
where $\rho_{1}^{\text{pert}}(s)$, $\rho_1^{G^2}(s)$, $\rho_1^{G^3}(s)$, and $\rho_1^{G^4}(s)$ represent the spectral densities of the perturbative term, the two-gluon condensate contribution, the three-gluon condensate contribution, and the four-gluon condensate contribution, respectively. The typical LO Feynman diagrams of a triply heavy hybrid baryon state that contribute to the spectral densities in Eq.(\ref{spectral-density}) are shown in Fig.~\ref{Feynman-diagram}, where diagram I denotes the contribution from the perturbative term, diagram II represents the two-gluon condensate, III and IV are the three-gluon condensates, and V-VII depict the four-gluon condensates, respectively.
\begin{figure}[htb]
\begin{center}
...
\begin{eqnarray}
  \Pi_{1}^{\text{OPE}}(M_B^2) = \int_{(3 m_Q)^2}^\infty ds \rho_{1}^{\text{OPE}}(s) e^{-s/M_B^2} + \Pi_{1}^{\langle G^2 \rangle}(M_B^2) + \Pi_{1}^{\langle G^3 \rangle}(M_B^2) + \Pi_{1}^{\langle G^4 \rangle}(M_B^2). \label{Pi-MB}
\end{eqnarray}

For the triply heavy hybrid baryon states considered in this work, we put the lengthy expressions of spectral densities and $\Pi_1(M_B^2)$ that appeared in Eq.(\ref{Pi-MB}) into the Appendix.
...
\end{eqnarray}
where the subscript $H$ means the lowest-lying triply heavy hybrid baryon state, $M_{H}$ denotes its mass, and $\rho^{\text{phen}}(s)$ is the spectral density that contains the contribution from higher excited states and the continuum states above the threshold $s_0$. The coupling constant $\lambda_{H}$ is defined through
\begin{eqnarray}
...
\begin{eqnarray}
  \Pi^{\text{phen}}(M_B^2)=\lambda_H^2 (q\!\!\!\slash - M_H) e^{-M_H^2/M_B^2}.
\end{eqnarray}

After equating the two sides and assuming the quark-hadron duality, the sum rules can be written as
\begin{eqnarray}
  \lambda_H^2 e^{-M_H^2/M_B^2} &\!\!=\!\!& \int_{(3m_Q)^2}^\infty ds \rho_1^{\text{OPE}}(s) e^{-s/M_B^2} + \Pi_1^{\langle G^2 \rangle}(M_B^2) + \Pi_1^{\langle G^3 \rangle}(M_B^2) + \Pi_1^{\langle G^4 \rangle}(M_B^2).
\end{eqnarray}
...
\begin{eqnarray}
  L_1(s_0, M_B^2) &\!\!=\!\!& \int_{(3 m_Q)^2}^\infty ds \, \rho^{\text{OPE}}_1(s) e^{-s/M_B^2} + \Pi_1^{\langle G^2 \rangle}(M_B^2) + \Pi_1^{\langle G^3 \rangle}(M_B^2) + \Pi_1^{ \langle G^4 \rangle}(M_B^2) , \label{L0} \\
...
We list in this appendix the explicit expressions of the QCD spectral densities $\rho(s)$ and $\Pi(M_B^2)$ in Eq.(\ref{Pi-MB}) for the current shown in Eq.~(\ref{current}).

For the $QQQg$ hybrid baryon states with $Q=c, b$, the spectral densities $\rho_1(s)$ and $\Pi_1^{\text{cond}}(M_B^2)$ are
\begin{eqnarray}
\rho^{\text{pert}, \text{I}}(s) &=& \frac{g_{s}^{2}}{2^{8}\times\pi^{6}}\int_{9m_{Q}^{2}}^{s_{0}} ds  \int_{\alpha_{min}}^{\alpha_{max}} d\alpha
...
{2^{7}\times\pi^{4}\times\alpha\beta}\int_{9m_{Q}^{2}}^{s_{0}} ds
\int_{\alpha_{min}}^{\alpha_{max}} d\alpha\int_{\beta_{min}}^{\beta_{max}} d\beta\left\{ F_{ \alpha\beta}(\alpha+\beta-1)\right\},
\end{eqnarray}

\begin{eqnarray}
\Pi^{\langle G^{2}\rangle, \text{II}}(M_B^2) =0,
\end{eqnarray}

\begin{eqnarray}
\rho^{\langle G^{3} \rangle , \text{III}}(s) &=&\frac{\langle g_{s}^{3}G^{3}\rangle}
{2^{8}\times\pi^{4}}\int_{9m_{Q}^{2}}^{s_{0}} ds
\int_{\alpha_{min}}^{\alpha_{max}} d\alpha\int_{\beta_{min}}^{\beta_{max}} d\beta\left\{(\alpha+\beta-1)(3m_{c}^{2}+8s\alpha\beta)\right.\nonumber\\
&-&\left.12(\alpha+\beta-1)F_{\alpha\beta}\right\},
\end{eqnarray}

\begin{eqnarray}
\Pi^{\langle G^{3} \rangle , \text{III}}(M_{B}^{2}) &=&\frac{m_{c}^{4}\langle g_{s}^{3}G^{3}\rangle}
{2^{8}\times\pi^{4}}\int_{0}^{1} d\alpha\int_{0}^{1-\alpha} d\beta e^{-\frac{c_{\alpha\beta}m_{Q}^{2}}{M_{B}^{2}}}\times\left\{
...
{2^{9}\times\pi^{4}\alpha\beta}\int_{9m_{Q}^{2}}^{s_{0}} ds
\int_{\alpha_{min}}^{\alpha_{max}} d\alpha\int_{\beta_{min}}^{\beta_{max}} d\beta\left\{ \alpha-\alpha^{2}-(\beta-1)\beta\right\},
\end{eqnarray}

\begin{eqnarray}
\rho^{\langle G^{4} \rangle , \text{V}}(s) &=& 0,
\end{eqnarray}

\begin{eqnarray}
\Pi^{\langle G^{4} \rangle , \text{VI}}(M_{B}^{2}) &=&\frac{\kappa m_{c}^{2}\langle g_{s}^{2}G^{2}\rangle^{2}(\alpha+\beta)}
{2^{14}\times\pi^{4}}\int_{0}^{1} d\alpha\int_{0}^{1-\alpha} d\beta e^{-\frac{c_{\alpha\beta}m_{Q}^{2}}{M_{B}^{2}}}\times\left\{
\frac{2m_{b}^{2}\alpha\beta(\alpha+\beta-1)}
...
{3\times2^{14}\times\pi^{4}}\int_{9m_{Q}^{2}}^{s_{0}} ds
\int_{\alpha_{min}}^{\alpha_{max}} d\alpha\int_{\beta_{min}}^{\beta_{max}} d\beta
\left\{(\alpha+\beta)\right\},
\end{eqnarray}

\begin{eqnarray}
\Pi^{\langle G^{4} \rangle , \text{VI}}(M_{B}^{2}) &=&\frac{\kappa m_{c}^{2}\langle g_{s}^{2}G^{2}\rangle^{2}}
{9\times2^{14}\times\pi^{4}}\int_{0}^{1} d\alpha\int_{0}^{1-\alpha} d\beta e^{-\frac{c_{\alpha\beta}m_{Q}^{2}}{M_{B}^{2}}}\times\left\{
...
{27\times2^{14}\times\pi^{4}}\int_{9m_{Q}^{2}}^{s_{0}} ds
\int_{\alpha_{min}}^{\alpha_{max}} d\alpha\int_{\beta_{min}}^{\beta_{max}} d\beta
...
\begin{eqnarray}
\Pi^{\langle G^{4} \rangle , \text{VII}}(M_{B}^{2}) &=& \frac{\kappa m_{c}^{2}\langle g_{s}^{2}G^{2}\rangle^{2}}
{81\times2^{15}\times\pi^{4}}\int_{0}^{1} d\alpha\int_{0}^{1-\alpha} d\beta e^{-\frac{c_{\alpha\beta}m_{Q}^{2}}{M_{B}^{2}}}\times\left\{
