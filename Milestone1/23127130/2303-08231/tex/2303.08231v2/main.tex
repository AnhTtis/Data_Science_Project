...
\author{Hao Yu$^1$ \; Zheng Qin$^2$ \;  Ji Hou$^3$ \; Mahdi Saleh$^{1, 4}$ \; Dongsheng Li$^2$ \; Benjamin Busam$^{1, 4}$ \; Slobodan Ilic$^{1, 5}$ \\
$^{1}$TU Munich \quad $^{2}$NUDT \quad $^{3}$Meta Reality Labs \quad $^{4}$3Dwe.ai \quad$^{5}$Siemens AG, Munich
}
