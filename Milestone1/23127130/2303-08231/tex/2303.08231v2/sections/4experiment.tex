...
\begin{figure}
  ...
  \vspace{-0.2cm}
  \caption{\small \textbf{Left}: Runtime comparison between our PPF attention Mechanism~(PAM) and the local attention in PointTransformer~\cite{zhao2021point}. \textbf{Right}: Runtime normalized by aligning the number of parameters. }
  \label{fig:runtime}
