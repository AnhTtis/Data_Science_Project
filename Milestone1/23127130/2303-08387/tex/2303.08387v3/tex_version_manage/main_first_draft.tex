...
\begin{figure}[ht!]
    \centering
        \begin{subfigure}[t]{\columnwidth}
            \centering
            \includegraphics[width=\textwidth]{figures/Figure 1/Figure_1_final.png}
        \end{subfigure}
...
We evaluate our framework, SOP-NET, via a task for stable object placement that require appropriate object's orientation that allow object sustain stable configuration on horizontal surface. To evaluate the performance for SOP in simulation, we use ShapeNet\cite{} and 3DNet\cite{} objects for the seen categories, and YCB objects for the unseen categories. In real-world, we use YCB objects (drill, cracker box, mustard bottle) to evaluate our system.
...
We employed PyTorch\cite{} to train our model and we used 2 NVIDIA Titan RTX GPUs with batch size = 128 and epoch = 300. With patience = 50, an early stopping is set. The Adam optimizer is used with the parameters of learning rate = 1e-3. For training dataset generation, we use a physic simulator, CoppeliaSim (V-REP)\cite{}, to annotate the stable regions as planes after being released on the horizontal plane\ref{dataset_generation}. For the motion planar to place object stably with predicted object rotation, we use RRT-Star\cite{} implemented with OMPL\cite{} integrating with the collision checking on the physics engine.

\subsection{Evaluating in Simulation}
\noindent \textbf{Metrics.} For evaluating the performance for stable object placement, we measure the stability of objects after being placed on table. \\

\noindent \textbf{Comparison with Baselines in SOP-NET.}
...
\multicolumn{2}{|c|}{\multirow{3}{*}{\textbf{Object Type}}} & \multicolumn{8}{c|}{\textbf{Stability (S)}} & \multicolumn{4}{c|}{\multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Success Rate of \\ Stable Placement ($\%$)\end{tabular}}}} \\ \cline{3-10}
\multicolumn{2}{|c|}{} & \multicolumn{4}{c|}{\textbf{Rotation (R, $^{\circ}$) \downarrow}} & \multicolumn{4}{c|}{\textbf{Translation (T, $mm$) \downarrow}} & \multicolumn{4}{c|}{} \\ \cline{3-14} 
...
& 36.74 & 37.34 & 5.32 & \multicolumn{1}{c|}{\textbf{1.35}} % Rotation
& 0.28 & 2.99 & 0.20 & \multicolumn{1}{c|}{\textbf{0.19}}  % Translation
& 90.48 & 33.33 & \textbf{95.24} & \textbf{95.24} \\ % Success Rate
\multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{Normal} % Normal
& \textbf{0.74} & 14.17 & 2.65 & \multicolumn{1}{c|}{0.78} % Rotation
& \textbf{0.12} & 2.36 & 0.30 & \multicolumn{1}{c|}{0.13} % Translation
& \textbf{100} & 52.38 & 85.71 & 85.71 \\ % Success Rate
\multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{Hard} % Hard
& 11.04 & 33.19 & 12.14 & \multicolumn{1}{c|}{\textbf{2.86}} % Rotation
& 1.10 & 4.21 & 1.52 & \multicolumn{1}{c|}{\textbf{0.37}} % Translation
& \textbf{52.38} & 33.33 & 47.62 & 33.33 \\ \cline{2-14} % Success Rate
\multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{Total avg.} % Total
& 4.55 & 21.84 & 5.46 & \multicolumn{1}{c|}{\textbf{1.66}} 
& 0.50 & 3.19 & 0.67 & \multicolumn{1}{c|}{\textbf{0.23}} 
& \textbf{80.95} & 39.68 & 76.19 & 71.43 \\ \hline % Success Rate
% Partial Point Cloud
\multicolumn{1}{|c|}{\multirow{5}{*}{\begin{tabular}[c]{@{}c@{}}Partial \\ Point cloud\end{tabular}}} & \multicolumn{1}{c|}{Easy} % Easy
& 36.74 & 37.34 & 5.32 & \multicolumn{1}{c|}{\textbf{2.65}} % Rotation
& 7.48 & 6.76 & 0.75 & \multicolumn{1}{c|}{\textbf{0.38}}  % Translation
& 38.95 & 4.90 & \textbf{86.90} & 85.24 \\ % Success Rate
\multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{Normal} % Normal
& 66.04 & 67.43 & 36.84 & \multicolumn{1}{c|}{\textbf{3.23}} % Rotation
& 11.94 & 12.20 & 6.37 & \multicolumn{1}{c|}{\textbf{0.46}} % Translation
& 33.05 & 15.67 & 52.24 & \textbf{79.95} \\ % Success Rate
\multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{Hard} % Hard
& 28.50 & 37.71 & 27.84 & \multicolumn{1}{c|}{\textbf{14.24}} % Rotation
& 3.34 & 4.14 & 2.97 & \multicolumn{1}{c|}{\textbf{1.84}} % Translation
& \textbf{43.71} & 26.43 & 40.14 & 29.33 \\ \cline{2-14} % Success Rate
\multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{Total avg.} % Total avg.
& 43.76 & 47.49 & 23.33 & \multicolumn{1}{c|}{\textbf{6.71}} % Rotation
& 7.59 & 7.70 & 3.36 & \multicolumn{1}{c|}{\textbf{0.89}} % Translation
& 38.57 & 15.67 & 59.76 & \textbf{64.84} \\ \hline % Success Rate
...
\section{Conclusions} 
We present a framework that can place a diverse objects stably on horizontal surface for various manipulation tasks. Our system learns to predict the stable plane based on partial point clouds of the object. We present the efficacy of our synthetic data generation pipeline and show how it can be used in practice. Currently our system only takes vision sensory data about object as input. In the future, we would like to investigate how target objects interact with other surrounding objects (e.g., packing, stacking).
