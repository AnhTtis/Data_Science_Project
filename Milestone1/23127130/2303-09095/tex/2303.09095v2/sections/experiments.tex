...
\begin{figure}[!htb]
    \centering
     ...
     \vspace{-3mm}
     \caption{The comparison before (\textbf{left}) and after (\textbf{right}) extrinsic optimization by projecting the point clouds (upper) and SMPL (lower) are projected onto the image.}
     \label{fig:eval_cali}
