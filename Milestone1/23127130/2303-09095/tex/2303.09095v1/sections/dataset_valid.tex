...
\begin{tabular}{l|rr|rr}
    \hline
    \multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}\diagbox{Train}{Test}\end{tabular}} & \multicolumn{2}{c|}{LH26M } & \multicolumn{2}{c}{Ours} \\ 
    ...
    \hline
    \multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}\diagbox{Train}{Test}\end{tabular}} & \multicolumn{2}{c|}{3DPW} & \multicolumn{2}{c}{Ours} \\ 
