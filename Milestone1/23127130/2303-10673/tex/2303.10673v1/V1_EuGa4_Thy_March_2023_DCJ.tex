...
\begin{figure}
\includegraphics [width=3in]{Fig01a.pdf}
\includegraphics [width=3in]{Fig01b.pdf}
...
\begin{figure}
\includegraphics [width=2.25in]{Fig02a.pdf}
\includegraphics [width=1.5in]{Fig02b.pdf}
...
%\begin{figure}
%\includegraphics [width=3.2in]{Fig_M-H_fit.pdf}
...
\label{Eq:DeltaPhi4a}\\
M_x&=&\chi_\perp H_x \quad (H_{\rm c1}\leq H_x \leq H^{\rm c}_{ab}),\label{Eq:DeltaPhi4b}\\
M_x &=& M_{\rm sat} = N_{\rm A}gS\mu_{\rm B}\quad (H_x\geq M_{\rm sat}),
\eea
\ese
where $N_{\rm A}$ is Avogadro's number.

\begin{figure}[ht]
\includegraphics [width=2.8in]{Fig04.pdf}
