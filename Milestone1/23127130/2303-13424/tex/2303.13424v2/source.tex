...
\hline
\end{tabular}
\tablefoot{Standard errors for mean proper motions and parallaxes are shown in the brackets. The full version of this table with 7167 rows and many extra columns is available at the CDS only, with a complete description of the included additional data in Appendix~\ref{app:tables}.
