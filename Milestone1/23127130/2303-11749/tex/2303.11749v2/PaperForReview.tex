...
\author{Zhenyu Wang$^{1,2}$ ~~~~~~~ Yali Li$^{1,2 ~ *}$ ~~~~~~~  Xi Chen$^3$  ~~~~~~~  Ser-Nam Lim$^4$ \\ Antonio Torralba$^{5}$ ~~~~~~~ Hengshuang Zhao$^{3}$ \thanks{corresponding author} ~~~~~~~Shengjin Wang$^{1,2}$  \\ \\
...
% {\small
% \paragraph{Acknowledgement.} This work was supported by the research fund under Grant No. 2019GQG0001 from the Institute of GuoQiang, Tsinghua University. Meta AI author Ser-Nam Lim is neither supported by the grant nor has any relationship whatsoever with the grants.}

% This work was supported by the National Key Research and Development Program of China in the 14th Five-Year (Nos.2021YFF0602103 and 2021YFF0602102) and the research fund under Grant No. 2019GQG0001 from the Institute of GuoQiang, Tsinghua University.
