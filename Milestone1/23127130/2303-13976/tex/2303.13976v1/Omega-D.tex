...
the QCD sum rules  systematically. The predicted masses $M=3.35^{+0.13}_{-0.18}\,\rm{GeV}$, $3.34^{+0.14}_{-0.18}\,\rm{GeV}$ and $3.35^{+0.12}_{-0.13}\,\rm{GeV}$ for the $\Omega_c(0,2,{\frac{1}{2}}^+)$,
...
\begin{eqnarray}
\Pi(p)&=&i\int d^4x e^{ip \cdot x} \langle0|T\left\{J/\eta(x)\bar{J}/\bar{\eta}(0)\right\}|0\rangle \, , \nonumber\\
\Pi_{\alpha\beta}(p)&=&i\int d^4x e^{ip \cdot x} \langle0|T\left\{J/\eta_{\alpha}(x)\bar{J}/\bar{\eta}_{\beta}(0)\right\}|0\rangle \, , \nonumber\\
\Pi_{\alpha\beta\mu\nu}(p)&=&i\int d^4x e^{ip \cdot x} \langle0|T\left\{J/\eta_{\alpha\beta}(x)\bar{J}/\bar{\eta}_{\mu\nu}(0)\right\}|0\rangle \, ,
\end{eqnarray}
where
\begin{eqnarray}\label{Jspin0}
J/\eta(x)&=&J/\eta^1(x)\, ,\,\,J/\eta^2(x)\, ,\,\,J/\eta^3(x)\, , \nonumber\\
J/\eta_\alpha(x)&=&J/\eta_\alpha^1(x)\, ,\,\,J/\eta_\alpha^2(x)\, ,\,\,J/\eta_\alpha^3(x)\, , \nonumber\\ J/\eta_{\alpha\beta}(x)&=&J/\eta_{\alpha\beta}^1(x)\, ,\,\,J/\eta_{\alpha\beta}^2(x)\, ,\,\, J/\eta_{\alpha\beta}^3(x)\, ,
\end{eqnarray}
\begin{eqnarray}
...
\end{eqnarray}
$q=u,\,d$, the $i$, $j$, $k$ are color indexes, the $C$ is the charge conjugation matrix. In the Isospin limit, the $uuc$, $udc$ and $ddc$ baryon states have  degenerated masses, while the $usc$  and $dsc$ baryon states have  degenerated masses, we only study  the $udc$ and $usc$ baryon states for simplicity.

The attractive interaction of one-gluon exchange  favors forming diquark correlations in  color antitriplet $\overline{3}_{ c}$ \cite{One-gluon-1,One-gluon-2}.
The  diquarks $\varepsilon^{ijk} q^{T}_j C\Gamma q^{\prime}_k$
...
The calculations based on the QCD sum rules  lead to the conclusion  that  the favored configurations are the $C\gamma_5$ and $C\gamma_\mu$ diquark states \cite{WangLDiquark}. For the $ss$ diquark states, we have to resort to the $\Sigma$-type diquark states to satisfy the Fermi-Dirac statistic without introducing additional P-wave.



In the diquark-quark models for the baryon states, we usually denote the angular momentum between the two light quarks  by $L_\rho$, and denote the angular momentum between the  light diquark and heavy quark  by $L_\lambda$. In the case of $L_\rho=0$, we obtain  the $J^P=0^+$ and $1^+$ diquarks, therefore the $\Lambda$-type and $\Sigma$-type baryons, respectively \cite{Korner-PPNP}. While in the case of $(L_\rho,L_\lambda)=(2,0)$, $(0,2)$ and $(1,1)$, we can obtain copious spectrum of the D-wave charmed baryon states.
However, it is difficult or impossible to construct  all currents to interpolate all the D-wave baryon states with the spin-parity $J^P={\frac{1}{2}}^+$, ${\frac{3}{2}}^+$, ${\frac{5}{2}}^+$ and ${\frac{7}{2}}^+$ in a systematic way.
...
\end{eqnarray}
while the $L_\rho=1$ diquark states cannot exist due to the Fermi-Dirac statistic.
In the heavy quark limit, the $c/b$-quark is static, the $\stackrel{\leftrightarrow}{\partial}_\mu$ is reduced to $\stackrel{\leftarrow}{\partial}_\mu$ when it operates   on the $c/b$-quark field.
For $L_\rho=0$ and $L_{\lambda}=2$, we acquire  the $qq$ diquark states with the spin-parity  $J^P=3^+$,
\begin{eqnarray}
...
We choose the currents $J/\eta^i(x)$, $J/\eta^i_\alpha(x)$ and $J/\eta^i_{\alpha\beta}(x)$ to interpolate the $J^P={\frac{1}{2}}^+$, ${\frac{3}{2}}^+$ and ${\frac{5}{2}}^+$ charmed  baryon states,  respectively.  We tentatively assign the $\Omega_c(3327)$ to be the  D-wave $\Omega_c$ state with the spin-parity $J^P={\frac{1}{2}}^+$, ${\frac{3}{2}}^+$ or ${\frac{5}{2}}^+$, the currents $J/\eta^3(x)$, $J/\eta^3_\alpha(x)$ and $J/\eta^3_{\alpha\beta}(x)$ maybe couple potentially to the  $\Omega_c(3327)$.


In general, we can choose either the partial  derivative $\partial_\mu$ or covariant derivative $D_\mu$ to construct  the currents, see Eqs.\eqref{Jspin0}-\eqref{Etaspin2}. The currents with  covariant derivative $D_\mu$ maybe gauge invariant, but hinders  interpreting  the $\stackrel{\leftrightarrow}{D}_\mu=\stackrel{\rightarrow}{\partial}_\mu-ig_sG_\mu-\stackrel{\leftarrow}{\partial}_\mu-ig_sG_\mu $ as  angular momentum. The currents with partial derivative $\partial_\mu$ are not gauge invariant, but favors  interpreting  the $\stackrel{\leftrightarrow}{\partial}_\mu=\stackrel{\rightarrow}{\partial}_\mu-\stackrel{\leftarrow}{\partial}_\mu$ as  angular momentum, furthermore, the covariant derivative $D_\mu$ leads to some hybrid components in meson or baryon states due to the gluon field $G_\mu$. Most importantly, even the covariant derivative $D_\mu$ is of no use in acquiring  gauge invariant baryon currents, all the baryon currents are not gauge invariant.  If we insist on choosing gauge invariant currents, all the QCD sum rules on the baryon states should be abandoned.


 The currents $J/\eta(0)$, $J/\eta_\alpha(0)$ and $J/\eta_{\alpha\beta}(0)$ couple potentially to the   ${\frac{1}{2}}^\pm$, ${\frac{3}{2}}^\pm$ and  ${\frac{5}{2}}^\pm$  charmed baryon
 states   $B_{\frac{1}{2}}^{\pm}$, $B_{\frac{3}{2}}^{\pm}$ and   $B_{\frac{5}{2}}^{\pm}$, respectively \cite{Oka96-SB,Oka96,WangPc,WZG-Negative-P,WZG-Pcs-Old,WZG-Pcs-NPB},
\begin{eqnarray}
\langle 0| J/\eta(0)|B_{\frac{1}{2}}^{+}(p)\rangle &=&\lambda^{+}_{\frac{1}{2}} U^{+}(p,s) \, ,  \nonumber\\
\langle 0| J/\eta_{\alpha} (0)|B_{\frac{3}{2}}^{+}(p)\rangle &=&\lambda^{+}_{\frac{3}{2}} U^{+}_\alpha(p,s) \, ,  \nonumber\\
\langle 0| J/\eta_{\alpha\beta} (0)|B_{\frac{5}{2}}^{+}(p)\rangle &=&\lambda^{+}_{\frac{5}{2}} U^{+}_{\alpha\beta}(p,s) \, ,\\
\langle 0| J/\eta (0)|B_{\frac{1}{2}}^{-}(p)\rangle &=&\lambda^{-}_{\frac{1}{2}}i\gamma_5 U^{-}(p,s) \, , \nonumber\\
\langle 0| J/\eta_{\alpha} (0)|B_{\frac{3}{2}}^{-}(p)\rangle &=&\lambda^{-}_{\frac{3}{2}}i\gamma_5 U^{-}_{\alpha}(p,s) \, , \nonumber\\
\langle 0| J/\eta_{\alpha\beta} (0)|B_{\frac{5}{2}}^{-}(p)\rangle &=&\lambda^{-}_{\frac{5}{2}}i\gamma_5 U^{-}_{\alpha\beta}(p,s) \, ,
\end{eqnarray}
...
same quantum numbers as the currents  $J/\eta(x)$, $i\gamma_5 J/\eta(x)$,  $J/\eta_\alpha(x)$,
$i\gamma_5 J/\eta_\alpha(x)$, $J/\eta_{\alpha\beta}(x)$ and
$i\gamma_5 J/\eta_{\alpha\beta}(x)$ into the correlation functions $\Pi(p)$,
$\Pi_{\alpha\beta}(p)$ and $\Pi_{\alpha\beta\mu\nu}(p)$ to obtain the hadronic representation
...
On the other hand, the currents $J/\eta_\alpha(0)$ and $J/\eta_{\alpha\beta}(0)$ have substantial  couplings with  the spin-parity $J^P={\frac{1}{2}}^\pm$ and $J^P={\frac{1}{2}}^\pm$, ${\frac{3}{2}}^\pm$ charmed baryon states, respectively,  we choose the tensor structures $g_{\alpha\beta}$ and $g_{\mu\alpha}g_{\nu\beta}+g_{\mu\beta}g_{\nu\alpha}$, the corresponding $J^P={\frac{1}{2}}^\pm$, ${\frac{3}{2}}^\pm$ baryon states cannot  contaminate the QCD sum rules \cite{WangPc}.
...
Then we accomplish  all the integrals in the coordinate and momentum spaces  in sequence to achieve the QCD representation, and  achieve   the QCD spectral densities  through  dispersion relation,
\begin{eqnarray}
...
$\Omega_c(2,0,{\frac{3}{2}}^+)$ and $\Omega_c(0,2,{\frac{5}{2}}^+)$ states,  respectively, which differ from the present predictions
   $3.53^{+0.13}_{-0.17}\,\rm{GeV}$, $3.54^{+0.12}_{-0.16}\,\rm{GeV}$ and $3.35^{+0.12}_{-0.13}\,\rm{GeV}$ significantly, this maybe due to the different Borel windows to extract the baryon masses.
...
\begin{figure}
 ...
 \includegraphics[totalheight=5cm,width=7cm]{mass-Omega-52.EPS}
        \caption{ The masses  of the $\Omega_c(0,2,{\frac{1}{2}}^+)$ (I),
$\Omega_c(0,2,{\frac{3}{2}}^+)$ (II) and $\Omega_c(0,2,{\frac{5}{2}}^+)$ (III) states with variations of the Borel parameters $T^2$, where the Expt denotes the experimental value of the mass of the $\Omega_c(3327)$.  }\label{Omega-Borel}
\end{figure}
...
\end{tabular}
\end{center}
\caption{ The Borel parameters $T^2$, continuum threshold parameters $s_0$, pole contributions (from the ground states) and perturbative contributions for the D-wave charmed baryon states.}\label{Borel}
\end{table}
...
\end{tabular}
\end{center}
\caption{ The masses  and pole residues of the D-wave charmed baryon states.} \label{mass}
\end{table}
...
\section{Conclusion}
In this article, we construct the $\Sigma$-type interpolating currents to study  the D-wave charmed baryon states via
the QCD sum rules in a systematic way. We carry out the operator product expansion up to the vacuum condensates of dimension $10$  consistently, and distinguish  the contributions of the positive and negative parity baryon states unambiguously,
 then  we study the masses and pole residues of the ground states in details,  the  predicted masses $M=3.35^{+0.13}_{-0.18}\,\rm{GeV}$, $3.34^{+0.14}_{-0.18}\,\rm{GeV}$ and $3.35^{+0.12}_{-0.13}\,\rm{GeV}$ for the $\Omega_c(0,2,{\frac{1}{2}}^+)$,
$\Omega_c(0,2,{\frac{3}{2}}^+)$ and $\Omega_c(0,2,{\frac{5}{2}}^+)$ states are in excellent agreement  with the experimental data $ 3327.1\pm1.2 \mbox{ MeV}$ from the LHCb collaboration, and support assigning the $\Omega_c(3327)$ to be the $\Sigma$-type D-wave $\Omega_c$ state with the spin-parity $J^P={\frac{1}{2}}^+$, ${\frac{3}{2}}^+$ or ${\frac{5}{2}}^+$. Other predictions can be confronted to the experimental data in the future to diagnose the nature of the D-wave charmed baryon states.


\section*{Appendix}
The QCD spectral densities,
\begin{eqnarray}
\rho_{j,QCD}^1(s)&=&\rho_{\frac{1}{2},\Sigma_c}^1(s)\, ,\,\, \rho_{j,\Xi_c}^1(s)\, , \, \,\rho_{j,\Omega_c}^1(s)\, , \nonumber \\
\rho_{j,QCD}^0(s)&=&\rho_{\frac{1}{2},\Sigma_c}^0(s)\, ,\,\, \rho_{j,\Xi_c}^0(s)\, , \, \,\rho_{j,\Omega_c}^0(s)\, ,
\end{eqnarray}
...
\bibitem{PDG}  P. A. Zyla et al, Prog. Theor. Exp. Phys. {\bf 2020} (2020) 083C01.
