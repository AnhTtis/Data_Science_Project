...
% Mutual information
\newcommand{\Mi}[2]{\,\mathrm{I}\mathopen{}\left(#1; #2\right)\mathclose{}}
...
% \newcommand{\policy}{\ensuremath{\pi(x)}}
...
\newcommand{\U}{\mathcal{A}}

% Subscripts
\renewcommand{\ni}{n}                  % Timestep counter
\newcommand{\Ni}{N}
\newcommand{\ti}{t}                % Iteration counter  
\newcommand{\Ti}{T}

% Noise variables
\newcommand{\noise}{\bm{\omega}}
\newcommand{\snoise}{\omega}
...
% Adversarial states/inputs
\newcommand{\xadv}{\bar{\x}}
\newcommand{\uadv}{\bar{\u}}
\newcommand{\Uadv}{\bar{\U}} 
\newcommand{\piadv}{\bar{\pi}} 
\newcommand{\Piadv}{\bar{\Pi}} 
...
\newcommand{\modelposterior}{\ensuremath{p(\tilde{f} \mid \dataset_{1:\ti})}}
...
% Generic inputs for GP
\newcommand{\adomain}{\mathcal{X}}
