...
\newcommand{\TODO}[1]{\AuthorCOMMENT{TODO}{red}{#1}}
\newcommand{\cSI}[1]{\AuthorCOMMENT{SI}{blue}{#1}}
\newcommand{\cAC}[1]{\AuthorCOMMENT{AC}{olive}{#1}}
\newcommand{\cCW}[1]{\AuthorCOMMENT{CW}{cyan}{#1}}
...
\iffinalversion
\newcommand{\rev}[1]{{#1}}
\newcommand{\sttext}[1]{}%for final version.
\newcommand{\stkouteq}[1]{}
\else
\newcommand{\rev}[1]{\textcolor{red}{#1}}
\newcommand{\stkouteq}[1]{\ifmmode\text{\sout{\ensuremath{#1}}}\else\sout{#1}\fi}
% reference: https://tex.stackexchange.com/questions/480113/striking-out-colored-text-through-user-defined-commands?noredirect=1
\newcommand{\sttext}[1]{\setstcolor{red}\st{#1}} 
\fi

% reference: https://tex.stackexchange.com/questions/20609/strikeout-in-math-mode
\newcommand\steq[1]{\setbox0=\hbox{$#1$}%
\rlap{\raisebox{.45\ht0}{\textcolor{red}{\rule{\wd0}{1pt}}}}#1} 
