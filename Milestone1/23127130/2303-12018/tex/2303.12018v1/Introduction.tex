...
In\blfootnote{$^*$thomas.biekoetter@kit.edu,
...
We estimated the central value
to be roughly the difference of observed and
expected exclusion limit at $95.4\gev$,
and the uncertainty was estimated
such that in gaussian approximation
a vanishing
signal rate corresponds to a deviation of $\sigCMS\,\sigma$
...
extracted 
from the previous results~\cite{CMS:2018cyk}.
