...
\begin{figure}[t]
\centering
\includegraphics[width=0.9\columnwidth]{plots/Both/mh1_xsyyvague.pdf}~
\vspace*{-0.4cm}
\caption{\small
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.82\columnwidth]{plots/type2/muyy_mubb_chisq125vague.pdf}~~~
\includegraphics[width=0.82\columnwidth]{plots/type4/muyy_mubb_chisq125vague.pdf}\\[0.4em]
\includegraphics[width=0.82\columnwidth]{plots/type2/muyy_mull_chisq125vague.pdf}~~~
\includegraphics[width=0.82\columnwidth]{plots/type4/muyy_mull_chisq125vague.pdf}
\vspace*{-0.4cm}
\caption{\small
S2HDM parameter points 
\GW{passing the applied constraints}
...
The black dashed ellipses indicate the
...
and the black dashed ellipses indicate
the region in which the di-photon excess and
...
points within or close to the black ellipse.
...
reach the lower edge of the black ellipse
...
extended Higgs sectors containing at least one doublet with a SM-like Higgs boson and at least one singlet with a Higgs boson at about 
$95\gev$.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.96\columnwidth]{plots/Both/h125cplsvague.pdf}
\vspace*{-0.4cm}
\caption{\small
S2HDM parameter points 
\GW{passing the applied constraints}
...
in the 
\GW{preferred range of $0.23 \leq \mu_{\gamma\gamma}
\leq 0.47$
...
i.e.~$\TB{0.23} \leq \mu_{\gamma\gamma} \leq \TB{0.47}$,
...
precision that greatly improves on
the precision achievable at the LHC.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.96\columnwidth]{plots/Both/cplsprecvague.pdf}
\vspace*{-0.4cm}
\caption{\small
S2HDM parameter points passing the
applied constraints that
predict a di-photon signal strength
in the preferred range $0.23 \leq \mu_{\gamma\gamma}
\leq 0.47$ 
in view of the excess observed by
CMS~\cite{CMSnew} in the
