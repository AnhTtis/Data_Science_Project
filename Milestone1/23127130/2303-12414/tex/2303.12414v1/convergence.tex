...
Completing the induction, we show that $e_2^{(t_k)}\leq\eta_{k+1}Y_2$ and $e_3^{(t_k)}\leq\eta_{k+1}Y_3$. Finally, substituting these results back into~\eqref{eq:final} completes the proof.
\end{skproof}
