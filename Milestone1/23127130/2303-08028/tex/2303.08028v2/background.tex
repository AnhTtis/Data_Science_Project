...
The premise of decentralized prediction is to design such approximations to the centralized prediction problems by distributing some of the computation throughout the network via these $g_i$ functions
...
\noindent \textbf{The Need For \sys. }
\sys provides a simple API where single stream, multiple stream, and decentralized ML applications can easily be expressed by developers.
