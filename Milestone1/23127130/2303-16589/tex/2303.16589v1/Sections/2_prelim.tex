...
A lack of robustness could be attributed to long-tail distribution of the training dataset \cite{bhatti2022formal}, with the probability of correct classification for head classes being higher than that for the tail classes, in the trained DNN.\\
