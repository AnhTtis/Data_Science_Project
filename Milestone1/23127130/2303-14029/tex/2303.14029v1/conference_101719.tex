...
\title{PENTACET data -  23 Million Contextual Code Comments and 500,000 SATD comments 
...
Most Self-Admitted Technical Debt (SATD) research utilizes explicit SATD features such as `TODO' and `FIXME' for SATD detection. A closer look reveals several SATD research uses simple SATD (`Easy to Find') code comments without the contextual data (preceding and succeeding source code context). This work addresses this gap through PENTACET (or 5C dataset) data. PENTACET is a large Curated Contextual Code Comments per Contributor and the most extensive SATD data. We mine 9,096 Open Source Software Java projects with a total of 435 million LOC. 
...
\item first big SATD dataset with more than 500,000 SATD comments.
...
\hline
\textbf{\# Comments} & 1,057,300 & 2,500,688 & 4,640,698 & 15,546,125 & \textbf{23,744,811} \\ 
\hline
\textbf{\# Invalid Comments} & 31,386 & 37,778 & 87,480 & 156,900 & \textbf{313,544} \\ 
\hline
\textbf{\# NL Comments} & 715,079 & 1,737,402 & 3,367,863 & 10,655,760 & \textbf{16,476,104} \\ 
\hline
\textbf{\# SATD  Comments} & 24,969 & 55,921 & 79,609 & 339,697 & \textbf{500,196} \\ 
\hline
\textbf{\% SATD }\par{}\textbf{Comments} & 3.49 & 3.21 & 2.36 & 3.18 & \textbf{3,03} \\
\bottomrule
\end{tabular}
}
\end{table}
...
FROM COMMENT\_ATTR 
  ...
  FROM PROJECT\_MAIN WHERE PROJECT\_LOC $>$ 10,000)
...
we plan to fetch the source code metrics, static analysis, git process metrics for all the repositories in PENTACET and associate SATD comments with the generated metrics. It will enable software researchers to investigate the correlational study and improve SATD forecasting.
