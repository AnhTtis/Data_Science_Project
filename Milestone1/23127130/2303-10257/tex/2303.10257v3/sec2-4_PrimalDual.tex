...
The Deep BSDE method presented above tackles directly a BSDE, without making explicit use of the fact that, in our context, the BSDE comes from an optimal control problem. In this context and under suitable assumptions, we can rely on a dual formulation to introduce primal-dual deep learning methods. Such methods have been studied, {\it e.g.}, in~\cite{henrylabordere2017deep,benderschweizerzhuo2017primal,daveyzheng2020deep} and have applications to several problems in finance. 
