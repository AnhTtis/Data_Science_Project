...
The data used in this study are available in a Zenodo repository under accession code XXX. \\
...
\bibitem [{\citenamefont {Ivakhnenko}\ \emph {et~al.}(2023)\citenamefont
  ...
  Landau{\textendash}Zener{\textendash}Stückelberg{\textendash}Majorana
...
\bibitem [{\citenamefont {Cao}\ \emph {et~al.}(2013)\citenamefont {Cao},
  ...
  Landau{\textendash}Zener{\textendash}Stückelberg
...
Correspondence should be addressed via e-mail to Katrin.Hecker@rwth-aachen.de\\
