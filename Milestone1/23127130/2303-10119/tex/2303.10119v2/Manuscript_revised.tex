...
%
%
However, despite these recent experimental advances, no coherent oscillations of either charge, spin or valley states have yet been reported in BLG quantum devices. A priori, it is not obvious that charge coherence can be observed in van der Waals heterostructures such as BLG encapsulated between hexagonal boron nitride (hBN) crystals.
In contrast to QDs in semiconductor heterostructures based on GaAs~\cite{Martins2016Mar,Botzem2016Apr} and SiGe~\cite{philips2022universal,Ward2016Oct}, which are buried tens of nm below the dielectric interface, the electron wave function of a BLG QD extends into the hBN making it susceptible charge noise present due to disorder at the BLG/hBN interface and to impurities in the hBN. 
%
...
\textbf{Discussion}
For comparison, Fig.~\ref{f5}f shows a histogram of $T_{2,\text{PAT}}^*$ extracted from fits to PAT peaks as shown exemplary in Fig.~\ref{f2}g, measured at different excitation frequencies in a range of $f = 9$ to 30~GHz (see also Supplementary Figs.~S2 and S3). 
%
...
\bibitem [{\citenamefont {Ivakhnenko}\ \emph {et~al.}(2023)\citenamefont
  ...
  {Nori}},\ }\href {\doibase 10.1016/j.physrep.2022.10.002} {\bibfield
  {journal} {\bibinfo  {journal} {Phys. Rep.}\ }\textbf {\bibinfo {volume}
  {995}},\ \bibinfo {pages} {1} (\bibinfo {year} {2023})}\BibitemShut {NoStop}%
...
\bibitem [{\citenamefont {Rozhkov}\ \emph {et~al.}(2016)\citenamefont
  ...
  {Nori}},\ }\href {\doibase 10.1016/j.physrep.2016.07.003} {\bibfield
  {journal} {\bibinfo  {journal} {Phys. Rep.}\ }\textbf {\bibinfo {volume}
  {648}},\ \bibinfo {pages} {1} (\bibinfo {year} {2016})}\BibitemShut {NoStop}%
...
\bibitem [{\citenamefont {Martins}\ \emph {et~al.}(2016)\citenamefont
  ...
  {\bibfnamefont {F.}~\bibnamefont {Kuemmeth}},\ }\href {\doibase
  10.1103/PhysRevLett.116.116801} {\bibfield  {journal} {\bibinfo  {journal}
  {Phys. Rev. Lett.}\ }\textbf {\bibinfo {volume} {116}},\ \bibinfo {pages}
  {116801} (\bibinfo {year} {2016})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Botzem}\ \emph {et~al.}(2016)\citenamefont {Botzem},
  ...
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {T.}~\bibnamefont
  {Botzem}}, \bibinfo {author} {\bibfnamefont {R.~P.~G.}\ \bibnamefont
  {McNeil}}, \bibinfo {author} {\bibfnamefont {J.-M.}\ \bibnamefont {Mol}},
  \bibinfo {author} {\bibfnamefont {D.}~\bibnamefont {Schuh}}, \bibinfo
  {author} {\bibfnamefont {D.}~\bibnamefont {Bougeard}}, \ and\ \bibinfo
  {author} {\bibfnamefont {H.}~\bibnamefont {Bluhm}},\ }\href {\doibase
  10.1038/ncomms11170} {\bibfield  {journal} {\bibinfo  {journal} {Nat.
  Commun.}\ }\textbf {\bibinfo {volume} {7}},\ \bibinfo {pages} {1} (\bibinfo
...
\bibitem [{\citenamefont {Ward}\ \emph {et~al.}(2016)\citenamefont {Ward},
  ...
  {Ward}}, \bibinfo {author} {\bibfnamefont {D.}~\bibnamefont {Kim}}, \bibinfo
  ...
  {M.~A.}\ \bibnamefont {Eriksson}},\ }\href {\doibase 10.1038/npjqi.2016.32}
