...
\newcommand{\BeF}[1]{\textcolor{violet}{{\bf BF:} #1}}
%\newcommand{\BeF}[1]{#1}
...
This section presents further data on the Landau-Zener-St\"uckelberg (LZS) interference pattern to elucidate the effect of different measurement parameters. 
...
%
As explained in the main text, these two parameters change the relative phase that the two parts of a wave function, split in an LZS experiment, acquire before interfering with each other.
%
...
The effect of changing the pulse amplitude can also be studied in the time domain. Fig.~\ref{fs5} shows the results of LZS interference experiments with the pulse duration ranging from \SI{0}{\pico\second} to \SI{300}{\pico\second}, for different values of $V_\mathrm{p}$.
%
...
Fig.~\ref{fs7}a shows a data set of amplitude-dependent LZS interference measured at the triple point shown in Fig.~\ref{fs7}b.
