...
\begin{table}[t]
    ...
    \caption{State of the Art comparison table for qualitative comparison on the top side, and quantitative comparison on the bottom side.}
        ...
        \begin{tabular}{@{}l ccccccrrc@{}}\toprule
             & \multirow{2}{*}{\gls{isa}} & Reliability & Fault & Split- & Area & Recovery & \multicolumn{1}{c}{Frequency} & \multicolumn{1}{c}{Area} & Open-
            \\ 
            & & Method & Recovery & Lock & Overhead & Cycles & \multicolumn{1}{c}{[\si{\mega\hertz}]} & \multicolumn{1}{c}{[\si{\milli\meter\squared}]} & Source \\\midrule
            BAE RAD5500~\cite{berger_quad-core_2015} & PowerPC & \gls{radhard} & - & - & - & - & - & - & \xmark \\
            Gaisler GR740~\cite{hijorth_gr740_2015} & SPARC & \gls{radhard}+\gls{ecc} & - & - & - & - & - & - & \xmark \\
            Ramon RC64~\cite{ginosar_rc64_2016} & CEVA X & \gls{radhard} & - & - & - & - & - & - & \xmark \\
            STRV~\cite{walsemann_strv_2023} & RISC-V & gate-level \gls{tmr} & - & - & - & - & - & - & \xmark \\
            AURIX TriCore~\cite{infineon_aurixtricore_2016} &  TriCore & \gls{tcls} & - & - & - & - & - & - & \xmark% \\
            \\ \midrule
