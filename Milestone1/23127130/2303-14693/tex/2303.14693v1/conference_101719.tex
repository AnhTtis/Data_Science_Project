...
In this context, data-driven methods become appealing, since they are able to provide robust solutions without requiring an understanding of all of the specific details of the system. More specifically, Reinforcement Learning (RL) allows for finding solutions by trial and error, where, with enough training, all of the edge cases should be experienced and addressed. Moreover, the same framework can be employed to obtain controllers for different machines and scenarios, without requiring a re-engineering process, as long as the problem's objective remains constant. Nevertheless, although RL methods have demonstrated success in various simulated environments, their adoption in real-world applications has been relatively slow. This can be attributed, in large part, to a significant gap between the way current experimental RL setups are designed and the often ill-defined nature of real-world systems, where challenges such as system delays, safety and performance constraints must be addressed \cite{b8}. Furthermore, in industrial scenarios it may be necessary to only solve a part of a problem with RL; hence, such methods must coexist with other control systems, minimizing interference with them \cite{b54}.
...
\begin{itemize}
    \item a RL solution for optimizing real robotic solutions in the food packaging industry.
...
In this research, we deal with a secondary robotic packaging machine. Fig. \ref{fig:machineoverview} depicts a schematic overview of this specific configuration. It contains four delta robots (denoted by R1-R4), and their workspaces depicted by the rectangles below them.
...
This approach is similar to the concept of Smith predictor \cite{b36}.
...
Additionally, the lost products metric provides the mean number of lost products that result from the performance and quality metrics. Furthermore, two control input metrics are used to indicate the smoothness of the control input and the time required for computing the control input. Lastly, the two methods are compared on their degree of constraint satisfaction regarding performance, the number of empty and partly filled boxes leaving the machine, and maximum box belt acceleration. 
...
\bibitem{b41} Ghobakhloo, Morteza. ``The future of manufacturing industry: a strategic roadmap toward Industry 4.0." Journal of manufacturing technology management 29.6 (2018): 910-936.
\bibitem{b46} Wyrwa, Joanna, and Anetta Barska. ``Innovations in the food packaging market: Active packaging." European Food Research and Technology 243 (2017): 1681-1692.
\bibitem{b8} Dulac-Arnold, Gabriel, et al. ``Challenges of real-world reinforcement learning: definitions, benchmarks and analysis." Machine Learning 110.9 (2021): 2419-2468.
\bibitem{b54} Papoudakis, Georgios, et al. ``Dealing with non-stationarity in multi-agent deep reinforcement learning." arXiv preprint arXiv:1906.04737 (2019).
\bibitem{b44} Moriyama, Takao, et al. ``Reinforcement learning testbed for power-consumption optimization." Methods and Applications for Modeling and Simulation of Complex Systems: 18th Asia Simulation Conference, AsiaSim 2018, Kyoto, Japan, October 27–29, 2018, Proceedings 18. Springer Singapore, 2018.
\bibitem{b43} Pane, Yudha P., et al. ``Reinforcement learning based compensation methods for robot manipulators." Engineering Applications of Artificial Intelligence 78 (2019): 236-247.
\bibitem{b4} Brunke, Lukas, et al. ``Safe learning in robotics: From learning-based control to safe reinforcement learning." Annual Review of Control, Robotics, and Autonomous Systems 5 (2022): 411-444.
\bibitem{b42} Garcıa, Javier, and Fernando Fernández. ``A comprehensive survey on safe reinforcement learning." Journal of Machine Learning Research 16.1 (2015): 1437-1480.
\bibitem{b3} Liu, Yongshuai, Avishai Halev, and Xin Liu. ``Policy learning with constraints in model-free reinforcement learning: A survey." The 30th International Joint Conference on Artificial Intelligence (IJCAI). 2021.
\bibitem{b36} Dalal, Gal, et al. ``Safe exploration in continuous action spaces." arXiv preprint arXiv:1801.08757 (2018).
%\bibitem{b40} Zhao, Wenshuai, Jorge Peña Queralta, and Tomi Westerlund. "Sim-to-real transfer in deep reinforcement learning for robotics: a survey." 2020 IEEE symposium series on computational intelligence (SSCI). IEEE, 2020.
%\bibitem{b51} Zhu, Henry, et al. "The ingredients of real-world robotic reinforcement learning." arXiv preprint arXiv:2004.12570 (2020).
\bibitem{b38} Pan, Xinlei, et al. ``Risk averse robust adversarial reinforcement learning." 2019 International Conference on Robotics and Automation (ICRA). IEEE, 2019.
\bibitem{b39} Rana, Krishan, et al. ``Bayesian controller fusion: Leveraging control priors in deep reinforcement learning for robotics." arXiv preprint arXiv:2107.09822 (2021).


%\bibitem{b27} Shyalika, Chathurangi, Thushari Silva, and Asoka Karunananda. "Reinforcement learning in dynamic task scheduling: A review." SN Computer Science 1 (2020): 1-17.
%\bibitem{b28} Liu, Chien-Liang, Chuan-Chin Chang, and Chun-Jan Tseng. "Actor-critic deep reinforcement learning for solving job shop scheduling problems." Ieee Access 8 (2020): 71752-71762.
%\bibitem{b29} Zhang, Cong, et al. "Learning to dispatch for job shop scheduling via deep reinforcement learning." Advances in Neural Information Processing Systems 33 (2020): 1621-1632.
%\bibitem{b30} Kim, Daewoo, et al. "Learning to schedule communication in multi-agent reinforcement learning." arXiv preprint arXiv:1902.01554 (2019).
%\bibitem{b31} Waschneck, Bernd, et al. "Optimization of global production scheduling with deep reinforcement learning." Procedia Cirp 72 (2018): 1264-1269.
%\bibitem{b5} Bhatia, Abhinav, Pradeep Varakantham, and Akshat Kumar. "Resource constrained deep reinforcement learning." Proceedings of the International Conference on Automated Planning and Scheduling. Vol. 29. 2019.
%\bibitem{b1} Castañeda, Luis Angel, Alberto Luviano-Juárez, and Isaac Chairez. "Robust trajectory tracking of a delta robot through adaptive active disturbance rejection control." IEEE Transactions on control systems technology 23.4 (2014): 1387-1398.

\bibitem{b47} OEE Industry Standard, ``OEE – Overall Equipment Effectiveness: The OEE Industry Standard," oeeindustrystandard.org. https://www.oeeindustrystandard.org/v2011/ (accessed Feb. 10, 2023).
% \bibitem{b15} Köppen, Mario. ``The curse of dimensionality." 5th online world conference on soft computing in industrial applications (WSC5). Vol. 1. 2000.
% \bibitem{b52} Mousavi, Seyed Sajad, Michael Schukat, and Enda Howley. ``Deep reinforcement learning: an overview." Proceedings of SAI Intelligent Systems Conference (IntelliSys) 2016: Volume 2. Springer International Publishing, 2018.
\bibitem{b53} Freund, Robert M. ``Penalty and barrier methods for constrained optimization." Lecture Notes, Massachusetts Institute of Technology (2004).

%\bibitem{b6} Otterlo, Martijn van, and Marco Wiering. "Reinforcement learning and markov decision processes." Reinforcement learning. Springer, Berlin, Heidelberg, 2012. 3-42.
\bibitem{b9} Bouteiller, Yann, et al. ``Reinforcement learning with random delays." International conference on learning representations. 2020.
\bibitem{b7} Schuitema, Erik, et al. ``Control delay in reinforcement learning for real-time dynamic systems: A memoryless approach." 2010 IEEE/RSJ International Conference on Intelligent Robots and Systems. IEEE, 2010.
%\bibitem{b10} Frydenberg, Morten. "The chain graph Markov property." Scandinavian Journal of Statistics (1990): 333-353.

%\bibitem{b11} Plappert, Matthias, et al. "Multi-goal reinforcement learning: Challenging robotics environments and request for research." arXiv preprint arXiv:1802.09464 (2018).
%\bibitem{b20} Brys, Tim, et al. "Multi-objectivization of reinforcement learning problems by reward shaping." 2014 international joint conference on neural networks (IJCNN). IEEE, 2014.

%\bibitem{b14} Sugiyama, Masashi, and Motoaki Kawanabe. Machine learning in non-stationary environments: Introduction to covariate shift adaptation. MIT press, 2012.
%\bibitem{b15} Kaelbling, Leslie Pack, Michael L. Littman, and Andrew W. Moore. "Reinforcement learning: A survey." Journal of artificial intelligence research 4 (1996): 237-285.
%\bibitem{b12} Tobin, Josh, et al. "Domain randomization for transferring deep neural networks from simulation to the real world." 2017 IEEE/RSJ international conference on intelligent robots and systems (IROS). IEEE, 2017.
\bibitem{b36} [1] O. J. Smith, “Closer control of loops with dead time,” Chemical engineering progress, vol. 53, pp. 217–219, 1957.
\bibitem{b16} Levine, Sergey, et al. ``Offline reinforcement learning: Tutorial, review, and perspectives on open problems." arXiv preprint arXiv:2005.01643 (2020).
\bibitem{b17} Schulman, John, et al. ``Proximal policy optimization algorithms." arXiv preprint arXiv:1707.06347 (2017).
\bibitem{b18} Liu, Zechun, et al. ``How do adam and training strategies help bnns optimization." International Conference on Machine Learning. PMLR, 2021.
\bibitem{b49}International Conference on Machine Learning. PMLR, 2021.
Hendrycks, Dan, and Kevin Gimpel. ``Bridging nonlinearities and stochastic regularizers with gaussian error linear units." CoRR, abs/1606.08415 3 (2016).
\bibitem{b50} Xiong, Ruibin, et al. ``On layer normalization in the transformer architecture." International Conference on Machine Learning. PMLR, 2020.
%\bibitem{b21} Charlesworth, Henry, and Giovanni Montana. "Plangan: Model-based planning with sparse rewards and multiple goals." Advances in Neural Information Processing Systems 33 (2020): 8532-8542.
%\bibitem{b22} Goecks, Vinicius G., et al. "Integrating behavior cloning and reinforcement learning for improved performance in dense and sparse reward environments." arXiv preprint arXiv:1910.04281 (2019).
%\bibitem{b23} Mohtasib, Abdalkarim, Gerhard Neumann, and Heriberto Cuayáhuitl. "A study on dense and sparse (visual) rewards in robot policy learning." Towards Autonomous Robotic Systems: 22nd Annual Conference, TAROS 2021, Lincoln, UK, September 8–10, 2021, Proceedings 22. Springer International Publishing, 2021.
%\bibitem{b19} Ng, Andrew Y., Daishi Harada, and Stuart Russell. "Policy invariance under reward transformations: Theory and application to reward shaping." Icml. Vol. 99. 1999.
%\bibitem{b24} Bøhn, Eivind, et al. "Deep reinforcement learning attitude control of fixed-wing uavs using proximal policy optimization." 2019 International Conference on Unmanned Aircraft Systems (ICUAS). IEEE, 2019.
%\bibitem{b25} Li, Lun, et al. "Basic flight maneuver generation of fixed-wing plane based on proximal policy optimization." Neural Computing and Applications (2023): 1-17.
%\bibitem{b26} Jiang, Zifei, and Alan F. Lynch. "Quadrotor motion control using deep reinforcement learning." Journal of Unmanned Vehicle Systems 9.4 (2021): 234-251.
%\bibitem{b32} Wang, Dawei, et al. "A two-stage reinforcement learning approach for multi-UAV collision avoidance under imperfect sensing." IEEE Robotics and Automation Letters 5.2 (2020): 3098-3105.
%\bibitem{b37} Liu, Yongshuai, Jiaxin Ding, and Xin Liu. "Ipo: Interior-point policy optimization under constraints." Proceedings of the AAAI conference on artificial intelligence. Vol. 34. No. 04. 2020.
\bibitem{b33} Kang, Katie, et al. ``Generalization through simulation: Integrating simulated and real data into deep reinforcement learning for vision-based autonomous flight." 2019 international conference on robotics and automation (ICRA). IEEE, 2019.
%\bibitem{b34} Zhang, Huan, et al. "Robust deep reinforcement learning against adversarial perturbations on state observations." Advances in Neural Information Processing Systems 33 (2020): 21024-21037.
%\bibitem{b13} Moos, Janosch, et al. "Robust reinforcement learning: A review of foundations and recent advances." Machine Learning and Knowledge Extraction 4.1 (2022): 276-315.
%\bibitem{b35} Van Moffaert, Kristof, and Ann Nowé. "Multi-objective reinforcement learning using sets of Pareto dominating policies." The Journal of Machine Learning Research 15.1 (2014): 3483-3512.
