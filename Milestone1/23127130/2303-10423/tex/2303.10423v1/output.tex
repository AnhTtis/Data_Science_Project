...
\affiliation{\mbox{AGH University of Science and Technology, Faculty of Physics and Applied Computer Science},\\
...
Our calculations of the percolation thresholds $p_c$ are based on finite-size analyses of the probability $\mathcal{P}_\text{max}$ that the randomly selected site belongs to the larges cluster of occupied sites.
...
%% ---------------------------------------------------------------
\begin{equation}
\mathcal A(x;L) L^{\varepsilon_1} = \mathcal F \left( 0 \right).
\end{equation}
%% ---------------------------------------------------------------
...
For our purposes, we assume that $\mathcal A\equiv \mathcal P_\text{max}$ (the probability that a randomly selected site belongs to the large cluster) and $x\equiv p$ (the probability of occupation of the sites).
...
\includegraphics[width=0.99\textwidth]{F01.pdf}
\end{subfigure}
%% ---------------------------------------------------------------
\begin{subfigure}[b]{0.49\textwidth}
...
\includegraphics[width=0.99\textwidth]{F02.pdf}
\end{subfigure}
%% ---------------------------------------------------------------
\begin{subfigure}[b]{0.49\textwidth}
% \psfrag{PmaxLx}[][c]{$\mathcal{P}_\text{max}\cdot L^{\beta/\nu}$}
...
\includegraphics[width=0.99\textwidth]{F03.pdf}
\end{subfigure}
%% ---------------------------------------------------------------
...
\begin{ruledtabular}
\begin{tabular}{lrrrl}
lattice                & $z$ & $\zeta$ & $\xi$ & $p_c$\\
\hline %% --------------------------------------------------------
\textsc{sq-1,2,3,4,5,6} & 28 & 58.8591 & 136 & 0.14325\footnote{0.142 \cite{Iribarne1999}, 0.143255 \cite{PhysRevE.103.022126}}\\ 
\hline %% --------------------------------------------------------
\textsc{sq-2,3,4,5,6}   & 24 & 54.8591 & 132 & 0.14576\\
\textsc{sq-1,3,4,5,6}   & 24 & 53.2022 & 128 & 0.14801\\
\textsc{sq-1,2,4,5,6}   & 24 & 50.8591 & 120 & 0.15223\\
\textsc{sq-1,2,3,5,6}   & 20 & 40.9705 &  96 & 0.16661\\
\textsc{sq-1,2,3,4,6}   & 24 & 47.5453 & 104 & 0.16133\\
\hline %% --------------------------------------------------------
\textsc{sq-3,4,5,6}     & 20 & 49.2022 & 124 & 0.15221\\
\textsc{sq-2,4,5,6}     & 20 & 46.8591 & 116 & 0.15844\\
\textsc{sq-2,3,5,6}    	& 16 & 36.9705 &  92 & 0.17601\\
\textsc{sq-2,3,4,6}    	& 20 & 43.5453 & 100 & 0.16529\\
\textsc{sq-1,4,5,6}     & 20 & 45.2022 & 112 & 0.15816\\
\textsc{sq-1,3,5,6}    	& 16 & 35.3137 &  88 & 0.18007\\ %% \footnote{as for \textsc{sq-1,2,4,6}}
\textsc{sq-1,3,4,6}    	& 20 & 41.8885 &  96 & 0.16675\\
\textsc{sq-1,2,5,6}    	& 16 & 32.9705 &  80 & 0.18216\\
\textsc{sq-1,2,4,6}    	& 20 & 39.5453 &  88 & 0.17409\\
\textsc{sq-1,2,3,6}    	& 16 & 29.6568 &  64 & 0.20135\\
\hline %% --------------------------------------------------------
\textsc{sq-4,5,6}     	& 16 & 41.2023 & 108 & 0.16819\\
\textsc{sq-3,5,6}     	& 12 & 31.3137 &  84 & 0.19868\\ %% \footnote{as for \textsc{sq-2,4,6}}
\textsc{sq-3,4,6}     	& 16 & 37.8885 &  92 & 0.17288\\
\textsc{sq-2,5,6}     	& 12 & 28.9706 &  76 & 0.20036\\
\textsc{sq-2,4,6}     	& 16 & 35.5454 &  84 & 0.18454\\
\textsc{sq-2,3,6}     	& 12 & 25.6569 &  60 & 0.21503\\
\textsc{sq-1,5,6}     	& 12 & 27.3137 &  72 & 0.19936\\
\textsc{sq-1,4,6}     	& 16 & 33.8885 &  80 & 0.18143\\
\textsc{sq-1,3,6}     	& 12 & 24.0000 &  56 & 0.22577\\
\textsc{sq-1,2,6}     	& 12 & 21.6568 &  48 & 0.23076\\
\hline %% --------------------------------------------------------
\textsc{sq-5,6}         &  8 & 23.3137 &  68 & 0.24422\\
\textsc{sq-4,6}         & 12 & 29.8885 &  76 & 0.19800\\
\textsc{sq-3,6}         &  8 & 20.0000 &  52 & 0.25673\\
\textsc{sq-2,6}         &  8 & 17.6568 &  44 & 0.26600\\
\textsc{sq-1,6}         &  8 & 16.0000 &  40 & 0.27309\\
\hline %% --------------------------------------------------------
\textsc{sq-6}\footnote{equivalent to \textsc{sq-1}} & 4 & 12.0000 & 36 & 0.59275\footnote{0.592746 \cite[p. 17]{bookDS}, 0.59274621(13) \cite{PhysRevLett.85.4104}, 0.59274(5) \cite{PhysRevE.103.012115} for \textsc{sq-1}}\\
%% ===============================================================
\end{tabular}
\end{ruledtabular}
\end{table}
...
% \includegraphics[width=0.95\columnwidth]{sq-pc_vs_z}
\includegraphics[width=0.95\columnwidth]{F04.pdf}
\end{subfigure}
%% ---------------------------------------------------------------
\begin{subfigure}[b]{0.48\textwidth}
% \psfrag{xi}{$\xi$}
...
% \includegraphics[width=0.95\columnwidth]{sq-pc_vs_xi}
\includegraphics[width=0.95\columnwidth]{F05.pdf}
\end{subfigure}
%% ---------------------------------------------------------------
\begin{subfigure}[b]{0.48\textwidth}
% \psfrag{zeta}{$\zeta$}
...
% \includegraphics[width=0.95\columnwidth]{sq-pc_vs_zeta}
\includegraphics[width=0.95\columnwidth]{F06.pdf}
\end{subfigure}
%% ---------------------------------------------------------------
...
Orange crosses show equivalent neighborhoods (\textsc{sq-1}$\equiv$\textsc{sq-2}$\equiv$\textsc{sq-3}$\equiv$\textsc{sq-5}$\equiv$\textsc{sq-6}, \textsc{sq-2,5}$\equiv$\textsc{sq-1,3} and \textsc{sq-2,3,5}$\equiv$\textsc{sq-1,2,3}).
\subref{fig:pc_vs_zeta} Dependence $p_c(\zeta)$. Inflated neighborhoods corresponding to higher indexes (i.e., \textsc{sq-2}, \textsc{sq-3}, \textsc{sq-5}, \textsc{sq-6}, \textsc{sq-2,5} and \textsc{sq-2,3,5}) are excluded from the fitting procedure.
...
Similarly to the earlier observation for the honeycomb lattice \cite{2204.12593}, some deviations from the straight line in \Cref{eq:pc_vs_xi} are observed for $32\le\xi\le 64$.
...
those for compact neighborhoods containing sites from the seventh to the tenth coordination zones (i.e., \textsc{sq-1,2,$\cdots$,6,7}, \textsc{sq-1,2,$\cdots$,7,8}, \textsc{sq-1,2,$\cdots$,8,9} and \textsc{sq-1,2,$\cdots$,9,10}) are taken from References \onlinecite{PhysRevE.103.022126} and \onlinecite{Iribarne1999}.
...
The \textsc{sq-6} neighborhood is topologically equivalent to \textsc{sq-1} (but for a three-time larger lattice constant), resulting in identical percolation thresholds $p_c(\textsc{sq-6})=p_c(\textsc{sq-1})$.
...
Inflated neighborhoods \textsc{sq-2}, \textsc{sq-3}, \textsc{sq-5}, \textsc{sq-6}, \textsc{sq-2,5} and \textsc{sq-2,3,5} (corresponding to \textsc{sq-1}, \textsc{sq-1}, \textsc{sq-1}, \textsc{sq-1}, \textsc{sq-1,3} and \textsc{sq-1,2,3}, respectively) were excluded from the fitting procedure.

%\lipsum[9]

Among the neighborhoods that contain sites up to the sixth coordination zone, there are six pairs of various neighborhoods with exactly the same $\zeta$ index, namely 
$\zeta(\textsc{sq-1,2,3,4,5})   =\zeta(\textsc{sq-2,4,5,6}) \approx 46.86$, 
...
$\zeta(\textsc{sq-2,4,6})       =\zeta(\textsc{sq-1,2,3,4}) \approx 35.55$ and
$\zeta(\textsc{sq-2,6})         =\zeta(\textsc{sq-1,2,3})   \approx 17.66$.
...
In this paper with \citeauthor{NewmanZiff2001} effective Monte Carlo algorithm we calculated 32 percolation threshold for complex neighbourhoods (containing sites from the sixth coordination zone) on square lattice.
