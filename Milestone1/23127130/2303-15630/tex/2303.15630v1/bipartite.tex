...
\begin{lem}\label{prop:bij-BGS-beta}
...
Let $G$ be a bipartite $2b$-map. Let $\cW=(W_1,...,W_{2b})$ be an even $2b$-GS wood and define the mapping $\lambda$ as $\lambda(W_1,...,W_{2b}) = (W_2,...,W_{2b}) = (W_1',...,W_b')$. Then $\lambda$ is a bijection between even $2b$-GS woods and $b$-BGS woods. The set $\bBL_G$ of $b$-BGS labelings of $G$ and the set $\bBW_G$ of $b$-BGS woods of $G$ are in bijection.
\end{lemma}
