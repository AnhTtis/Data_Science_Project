...
We tested the models' robustness to translation using the framework presented by \citet{Engstrom2017ExploringRobustness}, originally designed to test the robustness of classification models to translations and rotations.
...
\begin{figure}[ht]
    ...
    \end{subfigure}
\caption{\textbf{Adversarial accuracy for other types of shifts.} \textbf{Left}: Zero-padding, bilinear interpolation results. AFC is the most robust model for all tested grid sizes. 
