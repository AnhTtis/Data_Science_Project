...
Next, we explain the main steps and features of our work.  
...
level (extensible to SQL queries~\citep{DBLP:journals/pacmpl/BiswasKVEL21}). These constraints refer to a specific set of
