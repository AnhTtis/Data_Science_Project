...
\begin{proof}
	...
	\underline{$\impliedby$}
	Let's suppose that $h = h_p \oplus r \oplus \wro(r, t)$ for some transaction $t$. Let's suppose that $r <_{\ora} t$. As $\oraRespectfulCanon{h_p}$, there exists some event $e''$ s.t. $\trans{h_p}{e''} \lor \trans{h}{r}$, $t \ [\so \cup \wro]^* \trans{h}{e''}$ and $e'' \leq r$ so $\lnot(\swapped{h}{r})$.
