...
We extend $\so$\oldver{ and $\wro$} to pairs of events by $(e_1,e_2)\in \so$ if $(\trans{h}{e_1},\trans{h}{e_2})\in\so$\oldver{ and $(e_1,e_2)\in \wro$ if $e_1\in\writeOp{\trans{h}{e_1}}$, $(\trans{h}{e_1},e_2)\in\wro$, and $\mathit{var}(e_1)=\mathit{var}(e_2)$}. We also define $\po=\bigcup_{t\in T} \po_t$.
