...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\textwidth]{fig/adapter-albert.png}
...
The memory architecture described above is designed to support the operation of a NLP hardware accelerator modeled after EdgeBERT~\cite{EdgeBERTTambe20}. The main computational units in the accelerator are depicted in the block diagram with the yellow blocks.
