...
\author{OpenAI\thanks{Please cite this work as ``OpenAI (2023)". Full authorship contribution statements appear at the end of the document.}}
...
\toprule
\multicolumn{2}{p{5in}}{
\textbf{GPT-4 visual input example, Solving École Polytechnique's Physics Exam}:}\\
\midrule
