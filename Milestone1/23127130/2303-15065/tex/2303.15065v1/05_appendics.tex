...
\begin{figure}[tbh!]
    ...
    \includegraphics[clip, trim=7cm 4.25cm 3cm 4.25cm, scale=0.39]{figures/msseg.pdf}
    \includegraphics[clip, trim=7cm 4.25cm 3cm 4.25cm, scale=0.39]{figures/brats.pdf}
