...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={Single-subject Multi-contrast MRI Super-resolution via INRs},
...
%
\begin{document}
\title{Single-subject Multi-contrast MRI Super-resolution via Implicit Neural Representations}
\titlerunning{Single-subject Multi-contrast MRI Super-resolution via INRs}
...
\keywords{Multi-contrast Super-resolution \and Implicit Neural Representations \and Mutual Information.}
\end{abstract}
...
\clearpage
\appendix
% Uncomment to include supplementary
\input{05_appendics}
\end{document}
