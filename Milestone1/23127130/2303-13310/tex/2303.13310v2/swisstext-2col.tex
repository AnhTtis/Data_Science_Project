...
\conference{8th Swiss Text Analytics Conference (SwissText), 2023}
...
However, our model may be used in any non-commercial setting, including academic research.\footnote{A more permissive license might be applied at a later time. We kindly advise you to refer to the code repository for the most recent information.}
