...
To perform the data generation, we use an open-source tool\footnote{The \href{https://github.com/atlantis-ar/matterport_utils}{matterport utils} tool.} to convert the 3D mesh semantic labels in Matterport3D~\cite{Matterport3D} into $194,400$ pinhole images with semantic labels. Then, every $18$ semantic label pairs are concatenated via a corresponding rotation-translation matrix, yielding $10,800$ panoramic semantic ground truth, which is referred to as 360FV-Matterport by us. These panoramic semantic images are originally annotated with $40$ object categories.
...
\input{Tables/s_tables/s2d3d_fv_every_classes}

\subsection{Results on 360FV-Matterport}
\input{Tables/matterport3d_front_view_test}
...
\input{Tables/s_tables/mp3d_fv_every_class}
...
\input{Tables/s_tables/360_s2d3d_per_class}
...
We further compare our approach with three backbones, \eg, MiT-B0, MiT-B2 from SegFormer~\cite{xie2021segformer} and MSCA-B from SegNeXt~\cite{guo2022segnext} %with other approaches 
...
\begin{figure*}[t]
    ...
    \begin{tabular}{c c c c}
        \vspace{1pt}
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/rgb_1ce1.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/baseline_1ce1.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/detr_1ce1.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/gt_1ce1.png}}\\

        \vspace{1pt}

        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/rgb_01d2.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/baseline_01d2.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/detr_01d2.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/gt_01d2.png}}\\
        
        \vspace{1pt}

        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/rgb_6a82.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/baseline_6a82.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/detr_6a82.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/gt_6a82.png}}\\
        
        \vspace{1pt}

        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/rgb_9ab5.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/baseline_9ab5.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/detr_9ab5.png}} &
        \raisebox{-0.5\height}{\includegraphics[width=0.24\textwidth]{Figures/s_fv_qualitative_analysis/gt_9ab5.png}}\\
        
        \vspace{1pt}
        RGB Input&Baseline&Ours&Ground Truth
    \end{tabular}
    \vskip -2ex
    \caption{\textbf{360FV visualization and qualitative analysis} on the Stanford2D3D dataset.}
    \label{fig:s2d3d_fv}
    % \vskip -1ex
\end{figure*}
