...
\renewcommand{\ss}[1]{_{\text{#1}}}        % Text subscripts
\newcommand{\us}[1]{^{\text{#1}}}          % Text superscripts
...
% \newcommand{\good}{{\color{mygreen} \ding{51}}}
% \newcommand{\bad}{{\color{myred} \ding{55}}}
...
\newcommand{\bmxc}{\mathbf{x}_c}
\newcommand{\bmyc}{\mathbf{y}_c}

\newcommand{\bmxt}{\mathbf{x}_t}
\newcommand{\bmyt}{\mathbf{y}_t}
\newcommand{\pgt}{p_{\text{true}}}
