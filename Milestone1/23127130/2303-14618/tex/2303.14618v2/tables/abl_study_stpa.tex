...
% \hline
% 2 & 5 & $\checkmark$ &                & $\checkmark$ & 41.5 & 24.0 & 32.0 \\
2 & 5 & $\checkmark$ &  $\checkmark$  & $\checkmark$ & \textbf{43.0}  & \textbf{26.9} & \textbf{34.0} \\
\Xhline{0.8pt}
\end{tabular}
\vspace{-2mm}
\caption{Ablation studies on the STPA loss (without using $L_\text{pse-mask}$), where $|\cdot|$ denotes the number of pixels in the set. 
