%%
%% myvancouver. bst ADAPTED FROM THE BELOW BY CARL 
%% WESOLOWSKI for imitating JPKPD style as of 2019, August 9
%%
...
{
  " " 'urlintro := % prefix before URL  was "Available from: "
...
FUNCTION {add.blank} %moved from old 253
...
{ 's :=
  output.state mid.sentence =
    { " " * write$ }                    %was % { ". " * write$ } 
        ...
        {  add.blank " " * write$       %  " " * write$ % didn't work. Trying %add.period$ write$
                  newline$
          "\newblock " write$
        }
...
{ 
  bracket.state close.brackets = % urlbst
    ...
    'skip$
  if$
  add.blank " " * write$  % was add.period$ !!!
%  write$
  newline$
}
...
{ output.bibitem
  ...
  if$
  format.date "year" output.check    %new position
  new.block
  format.publisher.address output
 %format.date "year" output.check
  new.block
