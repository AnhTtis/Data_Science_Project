...
\begin{figure}[t!]
	\centering
	\includegraphics[width=0.9\textwidth]{Figures/model_predicted2}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.95\textwidth]{Figures/cor_fxn_labels}
