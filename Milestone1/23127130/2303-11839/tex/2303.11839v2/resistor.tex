...
\[ \vcenteredinclude{scale=0.04}{diag/Confluence_3.png} \xRightarrow{(Y/\Delta)_3} %\stackrel{(Y/\Delta)_3}{\xRightarrow} 
   ...
   \vcenteredinclude{scale=0.09}{diag/Step2b.png} \xRightarrow{\sf[Parallel]}
...
\begin{enumerate}[(a)]
   ...
   \[ \includegraphics[scale=0.03]{diag/CP1.png} 
    ...
    \begin{minipage}[h]{0.3\textwidth}
            \[ \includegraphics[scale=0.07]{diag/N9.png} \]
    \end{minipage}
    \begin{minipage}[h]{0.7\textwidth}
...
ARK would like to thank NTT Research for financial support.Research at IQC is supported in part by the Government of Canada through Innovation, Science and Economic Development Canada (ISED).
\newpage
