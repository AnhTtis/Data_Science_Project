...
\label{fig:habit_bounds_Bandit25-75}}
 \begin{subfigure}[t]{.5\textwidth}
 ...
 \end{subfigure}
\vspace{-1.5em}\caption{Bounds for pessimistically optimal strategy (UCB left, LCB right)\vspace{1em}\label{fig:habit_corr_bounds_Bandit25-75}}
 ...
 \end{subfigure}
\vspace{-1.5em}\caption{Expected total reward in $\cM$ w.r.t. policy $\sigma$ (UCB left, LCB right)\label{fig:real_strategy_Bandit25-75}}
