            ...
            \begin{tikzpicture}
                    \begin{axis}[
                     legend style={at={(1.02,1)},anchor=north west},
                        ...
                        table/col sep=space,
                        xlabel={episode},
                        ymax=57.46371962666243,
                        ymin=10.0,
                        scale only axis,
                        width=6cm
                    ]
                        \addplot [mark=none, gray] coordinates {(0,10) (50,10)}; 
                        ...
                        {data/BettingUnfav_EpsilonLCB-NONE.log};
                        ...
                        {data/BettingUnfav_EpsilonLCB-REC.log};
                        ...
                        {data/BettingUnfav_EpsilonLCB-REE.log};
                        ...
                        {data/BettingUnfav_EpsilonLCB-REC-AHP-005.log};
                        ...
                        {data/BettingUnfav_EpsilonLCB-REE-AHP-005.log};
