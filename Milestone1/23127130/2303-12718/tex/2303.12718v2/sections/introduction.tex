...
We consider the setting where the environment is modelled as a \emph{contracting MDP}, i.e., 
...
While methods for analyzing IMDPs have already been considered in the literature~\cite{Givan00,Wu08}, 
and IMDPs have been used in the context of RL algorithms \cite{SuiSimJan22}, we 
provide a new connection of their use in PAC RL algorithms.
...
In contrast, the \emph{linearly updating intervals} \cite{SuiSimJan22} algorithm utilizes
IMDPs but uses potentially unsafe intervals and focuses on learning on changing environments.
