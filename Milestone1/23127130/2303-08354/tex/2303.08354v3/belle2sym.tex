...
\def\Bpipi   {\ensuremath{B^0 \to \pi^0 \pi^0}\xspace}


\def\mbc{{\ensuremath{M_{\rm bc}}}\xspace\xspace}
\def\dele{{\ensuremath{\Delta E}\xspace\xspace}}
\def\Tc{{\ensuremath{T_{c}}\xspace\xspace}}
\def\Acp{{\ensuremath{\mathcal{A}_{\it CP}}\xspace\xspace}}
\def\Scp{{\ensuremath{\mathcal{S}_{\it CP}}\xspace\xspace}}
\def\BR{{\ensuremath{\mathcal{B}}}}
\def\qr{{\ensuremath{q \cdot r}\xspace\xspace}}
