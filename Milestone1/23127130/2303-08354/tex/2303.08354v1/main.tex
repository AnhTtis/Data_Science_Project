...
\vspace{1.5cm}
\title {Measurement of the branching fraction and $\it CP$ asymmetry of $B^{0} \to \pi^{0} \pi^{0}$ decays using 2019–2021 Belle II data}
...
% A fit of the sample composition is used to identify the signal through kinematic and event-topology observables. To distinguish $B^0$ from $\overline{B}{}^0$, information from the accompanying $B$ meson in the event is used. The signal yield and $\Acp$ are determined from maximum likelihood fits.
...
\begin{figure*}[th!]
    \makebox[0.329\textwidth]{\includegraphics[clip, trim=0.75cm 0cm 0.2cm 0cm, width=0.333\textwidth]{images/official_plots/mbc_DATA_signal_region_control_mode.pdf}}
    \makebox[0.329\textwidth]{\includegraphics[clip, trim=0.75cm 0cm 0.2cm 0cm,width=0.333\textwidth]{images/official_plots/dele_DATA_signal_region_control_mode.pdf}}    
    \makebox[0.329\textwidth]{\includegraphics[clip, trim=0.75cm 0cm 0.2cm 0cm,width=0.333\textwidth]{images/official_plots/Tc_DATA_signal_region_control_mode.pdf}}
...
\begin{figure*}[th!]
    \makebox[0.329\textwidth]{\includegraphics[clip, trim=0.75cm 0cm 0.2cm 0cm, width=0.333\textwidth]{images/official_plots/mbc_full_Data_8ARGUS_signal_region_flav1.pdf}}
    \makebox[0.329\textwidth]{\includegraphics[clip, trim=0.75cm 0cm 0.2cm 0cm,width=0.333\textwidth]{images/official_plots/dele_full_Data_8ARGUS_signal_region_flav1.pdf}}    
    \makebox[0.329\textwidth]{\includegraphics[clip, trim=0.75cm 0cm 0.2cm 0cm,width=0.333\textwidth]{images/official_plots/Tc_full_Data_8ARGUS_signal_region_flav1.pdf}}
    \makebox[0.329\textwidth]{\includegraphics[clip, trim=0.75cm 0cm 0.2cm 0cm, width=0.333\textwidth]{images/official_plots/mbc_full_Data_8ARGUS_signal_region_flav-1.pdf}}
    \makebox[0.329\textwidth]{\includegraphics[clip, trim=0.75cm 0cm 0.2cm 0cm,width=0.333\textwidth]{images/official_plots/dele_full_Data_8ARGUS_signal_region_flav-1.pdf}}    
    \makebox[0.329\textwidth]{\includegraphics[clip, trim=0.75cm 0cm 0.2cm 0cm,width=0.333\textwidth]{images/official_plots/Tc_full_Data_8ARGUS_signal_region_flav-1.pdf}}
