...
Polynomial $\chi$-boundedness is one of the tamest behaviours a class can have. The simplest case is the case of perfect graphs, which can be defined by forbidden induced subgraphs (odd holes and antiholes) as well as they enjoy some structural results based on some elementary decompositions. This leads to three main directions of research: Which forbidden induced subgraphs give polynomial $\chi$-boundedness? Which structural parameters give polynomial $\chi$-boundedness? Which operations preserve $\chi$-boundedness? These three questions are intimately connected. The most natural example of \pcb~class, cographs, are altogether $P_4$-free graphs, have clique-width at most 2 and are the closure under substitutions of the graphs of size at most 2.
