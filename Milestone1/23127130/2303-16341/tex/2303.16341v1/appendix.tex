...
\subsection{Structure of Grouping Blcok}
...
\begin{figure}[h] 
    \centering
    \includegraphics[width=0.9\linewidth]{figures/grouping-block.pdf}
...
\begin{table}[!h]
    ...
    \vspace{2pt}
    \caption
	{End-to-end fine-tuning configurations for \textbf{MSR-VTT} of text-to-video retrieval.
	}
...
\begin{table}[h]
    ...
    \vspace{2pt}
    \caption
	{End-to-end fine-tuning configurations for \textbf{MSRVTT-QA} and \textbf{MSVD-QA} of video question answering.
	}
	\label{tbl:msrvtt-qa}
	\vspace{-10pt}
\end{table}
...
\begin{table}[h]
    ...
    \vspace{2pt}
    \caption
	{End-to-end fine-tuning configurations for \textbf{UCF101} and \textbf{HMDB51} of video action recognition.
	}
...
\begin{table}[!h]
    ...
    \vspace{2pt}
    \caption
	{End-to-end fine-tuning configurations for \textbf{ActivityNet} of temporal action localization.
	}
	\label{tbl:tal}
\vspace{-10pt}
\end{table}
...
\begin{figure*}[th] 
    ...
    \caption{Visualization of spatiotemporal grounding. The attention feature map of each example is computed from corresponding regions assigned to the group token which achieves the highest similarity score to the target noun phrase.}
    \vspace{-0.8em}
