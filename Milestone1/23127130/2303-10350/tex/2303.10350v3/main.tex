...
\hyperref[fig:logarithm-error-test1]{\bf Figure \ref*{fig:logarithm-error-test1}} presents log-log scale graphs demonstrating the dependence of maximum absolute errors between the exact and approximate solutions of \hyperref[problem:test1]{\bf Test \ref*{problem:test1}} under four different scenarios: $\lambda = 1$, $3$, $7$, $11$, with respect to temporal steps. The logarithmic scales are used on both the abscissa and ordinate axes. The horizontal axis corresponds to the decimal logarithms of the temporal steps denoted as ${\tau}_{j} = {10}^{-1}{\left( 100 - j \right)}^{-1}$, while the vertical axis represents the maximum absolute errors $g\left( {\tau}_{j} \right) = \max_{0 \leq k \leq {n}_{j}}\left| {E}_{1000}\left( {k}{\tau}_{j} \right) \right|$ for ${j}=0,1,\ldots,99$. It is assumed that when $h$ is sufficiently small, the behavior of $g\left( {\tau}_{j} \right)$ can be expressed by $g\left( {\tau}_{j} \right) \approx \mathrm{c}{\tau}_{j}^{2}$ ($\mathrm{c} = \mathrm{const} > 0$). Consequently, ${\log}_{10}\left( g\left( {\tau}_{j} \right) \right) \approx {2}\,{\log}_{10}\left( {\tau}_{j} \right) + {\log}_{10}\left( \mathrm{c} \right)$. In other words, on a log-log scale graph, the error exhibits a linear relationship with a slope of $2$, which signifies a second-order accuracy concerning the temporal variable. To perform curve fitting on the given data points in all four two-dimensional graphs, Simple Linear Regression (SLR) is employed. The resulting curves correspond to straight lines with slopes approximately equal to $2$, providing evidence that the proposed scheme \eqref{eq:semidiscrete_scheme} achieves second-order accuracy with respect to the temporal variable. In each of the four cases, the division number $m$ of the spatial domain remains fixed at $m = 1000$.

\begin{figure}[H]
    \centering
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{Log_graph_Test1_osc=1.pdf}
        \caption{$\lambda = 1$.}
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{Log_graph_Test1_osc=3.pdf}
        \caption{$\lambda = 3$.}
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{Log_graph_Test1_osc=7.pdf}
        \caption{$\lambda = 7$.}
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{Log_graph_Test1_osc=11.pdf}
        \caption{$\lambda = 11$.}
...
\begin{table}[H]
    \centering
    \input{table1_linear_regression}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{fig_Test2_osc5_n1024_m32.pdf}
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{fig_Test2_osc5_n4096_m64.pdf}
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{fig_Test2_osc17_n16384_m128.pdf}
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{fig_Test2_osc17_n65536_m256.pdf}
...
\begin{table}[H]
    ...
    \begin{subtable}{.49\textwidth}
        \centering
        \input{table2-error_Test2_osc5_n1024_m32}
        \caption{$\lambda = 5$, $m = 32$.}
    ...
    \begin{subtable}{.49\textwidth}
        \centering
        \input{table2-error_Test2_osc5_n4096_m64}
        \caption{$\lambda = 5$, $m = 64$.}
    ...
    \begin{subtable}{.49\textwidth}
        \centering
        \input{table2-error_Test2_osc17_n16384_m128}
        \caption{$\lambda = 17$, $m = 128$.}
    ...
    \begin{subtable}{.49\textwidth}
        \centering
        \input{table2-error_Test2_osc17_n65536_m256}
        \caption{$\lambda = 17$, $m = 256$.}
...
\begin{table}[H]
    ...
    \begin{subtable}{.25\textwidth}
        \centering
        \input{table3-error_Test3_osc5_n16_m16}
    ...
    \begin{subtable}{.25\textwidth}
        \centering
        \input{table3-error_Test3_osc5_n32_m32}
        \caption{$\lambda = 5$, $m = 32$.}
    ...
    \begin{subtable}{.25\textwidth}
        \centering
        \input{table3-error_Test3_osc17_n64_m64}
    ...
    \begin{subtable}{.25\textwidth}
        \centering
        \input{table3-error_Test3_osc17_n128_m128}
        \caption{$\lambda = 17$, $m = 128$.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.50\linewidth]{initial_cond_psi0.pdf}
...
\begin{table}[H]
    \centering
    \include{table5-UnkSolmaxCondNumb}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{UnknownSol1.pdf}
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{UnknownSol2.pdf}
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{UnknownSol3.pdf}
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{UnknownSol4.pdf}
