\begin{figure*}[!ht]
	...
	\begin{subfigure}[t]{0.41\textwidth}
     ...
     %        \includegraphics[width=0.33\textwidth]{./figs/experiments/scene_completion/bed/ours/Bedroom-4098_51_008.jpg}%
		...
		\caption{Ours}
	\end{subfigure}
	\caption{Scene completion from partial scenes with only 3 objects given as inputs. Compared to ATISS, our diffusion-based method produces more diverse completion results with higher fidelity, fewer intersections, and more symmetries.}
