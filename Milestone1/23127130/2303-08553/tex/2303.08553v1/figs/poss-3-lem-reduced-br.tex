...
% pos:3.3
%--------- 
\matrix[anchor=center,row sep=0.8cm,column sep=1.15cm,every node/.style={draw,thick,circle,minimum width=2.5pt,fill,inner sep=0pt,outer sep=2pt}] at (8.6,0) {
                    &  \node(v){};
  \\[0.25cm]
  \node(w-1-bar){}; &  \node[draw=none,fill=none](h0){};
                                    &  \node(w-2-bar){};  
...
% pos:3.5
%--------- 
\matrix[anchor=center,row sep=0.8cm,column sep=1.15cm,every node/.style={draw,thick,circle,minimum width=2.5pt,fill,inner sep=0pt,outer sep=2pt}] at (4.1,-6) {
                    &  \node(v){};
  \\[0.25cm]
  \node(w-1-bar){}; &  \node[draw=none,fill=none](h0){};
                                    &  \node(w-2-bar){};  
