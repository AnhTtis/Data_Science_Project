\begin{tikzpicture}
  ...
  %
  \path (acd) ++ (-1.5cm,1.5cm) node {\LARGE $\aonechartacci{1} \, / \, \aonecharthatacci{1} $};
...
%   \end{scope}
  ...
  \draw[->,densely dotted,thick,bend right,distance=1.25cm,relative=false,out=90,in=0] 
    (abcd-2) 
      to node[right,pos=0.45,xshift=0.05cm]{$\sone$} 
    (abc--C1acc);
  %
