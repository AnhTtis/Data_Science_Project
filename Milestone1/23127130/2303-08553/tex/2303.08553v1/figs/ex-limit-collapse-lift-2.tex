...
%   \end{scope}
  ...
  \draw[->,very thick,palegreen] (acd--C10) to node[above,pos=0.225]{\black{$a$}} (a2--C10);
  \draw[->,very thick,palegreen] (acd--C10) to node[below,%near start,yshift=0.6mm,xshift=0.3mm
  ...
  \draw[->,very thick,palegreen,bend right,relative=false,out=-45,in=167.5,looseness=1] (acd--C10) to node[below,pos=0.7]{\black{$d$}} (e--C10);
  %
  ...
  \draw[->,very thick,palegreen] (abcd-2--C10) to node[right]{\black{$d$}} (e--C10);
  \draw[->,very thick,palegreen,out=250,in=-80,distance=1.5cm] (abcd-2--C10) to node[right,pos=0.8]{\black{$\aact$}} (a1--C10);
  \draw[->,very thick,palegreen,out=240,in=-80,distance=1cm] (abcd-2--C10) to node[right,pos=0.7]{\black{$\aact$}} (a2--C10);
  ...
  % 
  \path (abc--C2) ++ (-2.5cm,0.5cm) node{\LARGE $\aonecharti{2}$};
  %
%   % Mark the angle XAY
%   \begin{scope}
%     \path[clip] (A) -- (X) -- (Y);
...
%   \end{scope}
  ...
  \draw[->,very thick,palegreen] (acd--C2) to node[above,pos=0.225]{$a$} (a2--C2);
  \draw[->,very thick,palegreen] (acd--C2) to node[below,%near start,yshift=0.6mm,xshift=0.3mm
                                pos=0.68]{$a$} (a1--C2);
  ...
  \draw[->,very thick,palegreen,bend right,relative=false,out=-45,in=167.5,looseness=1] (acd--C2) to node[below,pos=0.7]{$d$} (e--C2);
  %
