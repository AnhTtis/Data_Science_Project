...
% 
\path (w-2) ++ ({0.2*\mylen pt},{-0.25*\mylen pt}) node{$\bverti{2}$}; 
\path (w-2) ++ ({0.2*\mylen pt},{0.35*\mylen pt}) node{\text{\mediumblue{\large $\bverti{2}$ normed}}};    
...
% pos:2
%--------- 
\matrix[anchor=center,row sep=0.8cm,column sep=1.15cm,every node/.style={draw,thick,circle,minimum width=2.5pt,fill,inner sep=0pt,outer sep=2pt}] at (9,6) {
...
% pos:3.2
%--------- 
\matrix[anchor=center,row sep=0.8cm,column sep=1.15cm,every node/.style={draw,thick,circle,minimum width=2.5pt,fill,inner sep=0pt,outer sep=2pt}] at (4.5,0) {
                    &  \node(v){};
  \\[0.25cm]
  \node(w-1-bar){}; &  \node[draw=none,fill=none](h0){};
                                    &  \node(w-2-bar){};  
...
% pos:3.3
%--------- 
\matrix[anchor=center,row sep=0.8cm,column sep=1.15cm,every node/.style={draw,thick,circle,minimum width=2.5pt,fill,inner sep=0pt,outer sep=2pt}] at (9,0) {
                    &  \node(v){};
  \\[0.25cm]
  \node(w-1-bar){}; &  \node[draw=none,fill=none](h0){};
                                    &  \node(w-2-bar){};  
...
\path (label) ++ (0pt,-5pt) node{\large \ref{pos:3},\ref{pos:3.3}};
...
\path (label) ++ (0pt,-5pt) node{\large \ref{pos:3},\ref{pos:3.5}};
...
\end{center}
  %
  \caption{\label{fig:lem:reducing:1brs}%
    Illustrations of the position conditions \ref{pos:1}, \ref{pos:2}, 
                                and \ref{pos:3} with subconditions \ref{pos:3.1}, \ref{pos:3.2}, \ref{pos:3.3}, \ref{pos:3.4}, \ref{pos:3.5} 
                                in Lemma~\ref{lem:reducing:1brs}
    that define reduced \protect\onebisimilarity\ redundancies $\pair{\bverti{1}}{\bverti{2}}$ in a LLEE-1-chart.
    Those of case \ref{pos:3}, \ref{pos:3.5}, we call `pre-crystalline', all other ones `simple'.
    This analysis is the basis for the partial collapse procedure in which all
    simple reduced \protect\onebisimilarity\ redundancies can be eliminated from a LLEE-1-chart.               
                                }
\end{figure*}  