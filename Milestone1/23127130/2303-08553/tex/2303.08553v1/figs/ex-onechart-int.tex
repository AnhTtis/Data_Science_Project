\begin{tikzpicture}
  ...
  \draw[->,thick,densely dotted,shorten <= -1cm,shorten >=3pt,pos=0.2] (e) to node[above]{$\sone$} (1);
  \draw[->%,thick
          ] (e) to node[above,pos=0.4]{$\aact$} (e-000);
  \draw[->%,thick
          ] (e) to node[above,pos=0.4]{$\bact$} (e-100);  
  %   
  \draw[->,%thick,
           shorten <= -2pt,shorten >= -2pt] (e-00) to node[left]{$\aact$} (e-000);   
  ...
  %
  \draw[->,%thick,
           shorten <= -2pt,shorten >= -2pt] (e-10) to node[right]{$\bact$} (e-100);
