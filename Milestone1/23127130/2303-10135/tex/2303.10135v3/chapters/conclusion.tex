\section{Conclusion}
In this work, we addressed the RASP problem, which is aimed at deriving an order of operations, according to which a target product can be assembled step-by-step on a robotic system. 
...
We conducted extensive experiments in simulation to evaluate the capability of our model to transfer knowledge between different assembly tasks, as previous methods lacked this capacity. 
...
Instead of considering 2d assemblies, laying on a flat surface and comprised of simple profiles, we suggest to generalize our graph representation to support complex 3d objects as well.
