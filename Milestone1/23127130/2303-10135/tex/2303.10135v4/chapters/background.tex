...
In our proposed method we apply a Graph Attention Network (GAT)~\cite{velivckovic2017graph}, a popular variant of \gls{gnn}s, that defines $g_{\omega}$ as attention:
\begin{align}
\label{eq:2}
