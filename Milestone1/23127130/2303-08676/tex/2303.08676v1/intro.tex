...
Indeed, weakenings called target-collapsing and generalized-target-collision-resistance, that can be obtained from (regular) variants of one-way functions, suffice for publicly-verifiable deletion.
...
D.K. was supported in part by by NSF CAREER CNS-2238718, DARPA SIEVE
and a gift from Visa Research. This material is based upon work supported by
