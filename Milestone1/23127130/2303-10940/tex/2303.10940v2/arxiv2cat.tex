...
and what simplified statistical models can be used to describe these \cite{mayle:12,mayle:13,croft:23,christianen:21}.
...
NaLi+Na \cite{son:22},
and even NaLi+NaLi \cite{park:23} collisions, but the three systems are very different.
...
though assignment of the observed resonance in terms of a stable resonance state is complicated \cite{park:23}.
...
Furthermore, we explain the qualitative difference between the numbers of resonances in either spin state,
...
\end{align}
where $[\hat{A} \otimes \hat{B}]^{(k)}_q$ indicates a tensor product and $C^{(2)}(\hat{R})$ indicates spherical harmonics, see the Appendix.
...
In the spin-stretched states, the background loss rate is likely to lie between $10^{-13}$ and a few $10^{-12}$ cm$^3$/s.
...
\end{align}
where $\langle v\rangle$ is the thermally averaged speed at $T=2~\mu$K \cite{son:20},
...
This was previously also argued for NaK+K collisions \cite{wang:21c}, and may more generally be true of atom+molecule collisions \cite{frye:23}.
...
This means that the pattern of resonances cannot be explained in terms of the long-range \emph{isotropic} van der Waals interaction alone, as is argued in Ref.~\cite{frye:23},
despite the fact that vast majority of resonances is supported by the long-range $R^{-6}$ interaction, as argued in Ref.~\cite{frye:23} and confirmed in our density of states calculations. 
...
This is in qualitative agreement with experimental observation of 8 and 17 resonances in the upper and lower stretched state, respectively.
...
where the interaction can be described by its asymptotic $R^{-6}$ form, as was previously argued for alkali-metal atom-molecule collisions \cite{wang:21c,frye:23}.
...
\end{align}
is the rank-$k$ spherical tensor product and $C^{(2)}(\hat{\bm{r}}_\mathrm{NaLi})$ is a tensor of Racah-normalized spherical harmonics depending on the Euler angles of the molecular axis, $\bm{r}_\mathrm{NaLi}$.
...
\bibitem [{\citenamefont {Croft}\ \emph {et~al.}(2023)\citenamefont {Croft},
  \citenamefont {Bohn},\ and\ \citenamefont {Qu\'em\'ener}}]{croft:23}%
  \BibitemOpen
  ...
  {Qu\'em\'ener}},\ }\href {\doibase 10.1103/PhysRevA.107.023304} {\bibfield
  {journal} {\bibinfo  {journal} {Phys. Rev. A}\ }\textbf {\bibinfo {volume}
  {107}},\ \bibinfo {pages} {023304} (\bibinfo {year} {2023})}\BibitemShut
  {NoStop}%
...
\bibitem [{\citenamefont {Nichols}\ \emph {et~al.}(2022)\citenamefont
  ...
  {12}} (\bibinfo {year} {2022}),\ 10.1103/physrevx.12.011049}\BibitemShut
  {NoStop}%
...
\bibitem [{\citenamefont {Park}\ \emph {et~al.}(2023)\citenamefont {Park},
  \citenamefont {Lu}, \citenamefont {Jamison}, \citenamefont {Tscherbul},\ and\
  \citenamefont {Ketterle}}]{park:23}%
  \BibitemOpen
  ...
  {author} {\bibfnamefont {T.~V.}\ \bibnamefont {Tscherbul}}, \ and\ \bibinfo
  {author} {\bibfnamefont {W.}~\bibnamefont {Ketterle}},\ }\href {\doibase
  10.1038/s41586-022-05635-8} {\bibfield  {journal} {\bibinfo  {journal}
  {Nature}\ }\textbf {\bibinfo {volume} {614}},\ \bibinfo {pages} {54}
...
\bibitem [{\citenamefont {Janssen}\ \emph {et~al.}(2013)\citenamefont
  ...
  {NoStop}%
\bibitem [{\citenamefont {Karman}(2023)}]{karman:23}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {T.}~\bibnamefont
  {Karman}},\ }\href {\doibase 10.1021/acs.jpca.3c00797} {\bibfield  {journal}
  {\bibinfo  {journal} {J. Phys. Chem. A}\ }\textbf {\bibinfo {volume} {127}},\
  \bibinfo {pages} {2194} (\bibinfo {year} {2023})},\ \Eprint
...
\bibitem [{\citenamefont {Gribakin}\ and\ \citenamefont
  ...
  (\bibinfo {year} {1993})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Frye}\ and\ \citenamefont {Hutson}(2023)}]{frye:23}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {M.~D.}\ \bibnamefont
  {Frye}}\ and\ \bibinfo {author} {\bibfnamefont {J.~M.}\ \bibnamefont
  {Hutson}},\ }\href {\doibase 10.1103/PhysRevResearch.5.023001} {\bibfield
  {journal} {\bibinfo  {journal} {Phys. Rev. Res.}\ }\textbf {\bibinfo {volume}
  {5}},\ \bibinfo {pages} {023001} (\bibinfo {year} {2023})}\BibitemShut
  {NoStop}%
