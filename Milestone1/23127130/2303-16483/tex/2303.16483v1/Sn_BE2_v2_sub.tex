...
\title{Low-energy quadrupole collectivity of Sn nuclei
  in self-consistent calculations with semi-realistic interaction}
...
considering only the degrees-of-freedom of the valence neutrons,
...
This difference may be caused by the difference in the employed bases.
...
and whether the deformation could solve the controversy.
...
\label{fig:sph-dpot}}\vspace*{0.5cm}
\end{figure}
...
\includegraphics[scale=0.7]{cpair.eps}%\vspace*{-0.5cm}\\%\vspace*{1cm}\\
...
consisting of the collective degrees of freedom~\cite{ref:WHN21}.
...
to argue whether weak deformation is likely in the neutron-deficient Sn nuclei.
