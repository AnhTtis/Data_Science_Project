...
viscosity parameter is sufficiently large; see~\cite[section\,8.2.1]{elman14}.}  
...
%\begin{algorithm}\label{refinedpcd}
\begin{itemize} 
...
Generate  a PCD  solution  to  the {\it reduced system} %$\lbrack \bfu_1^T, \bfp_1^T \rbrack$ 
