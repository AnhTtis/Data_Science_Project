...
\center{\includegraphics[width=0.90\linewidth]{phase portraits/xy1.png}}
\end{minipage}
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.90\linewidth]{phase portraits/xz1.png}}
\end{minipage}
\begin{minipage}[h]{0.32\linewidth}
\center{\includegraphics[width=0.90\linewidth]{phase portraits/yz1.png}}
\end{minipage}
...
The work is supported by the grant of the Russian Science Foundation (project No. 20-71-10048).
