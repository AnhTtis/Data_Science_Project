...
{\parbox{\textwidth}{\centering Songheng Zhang$^{1}$,
        Dong Ma$^{1}$ and Yong Wang$^{1}$\thanks{The corresponding author}
%        S. Spencer$^2$\thanks{Chairman Siggraph Publications Board}  
        }
        \\
% For Computer Graphics Forum: Please use the abbreviation of your first name.
{\parbox{\textwidth}{\centering $^1$School of Computing and Information Systems, Singapore Management University, Singapore
%		\\
...
The
% \alexout{resulted} 
\alexin{resulting} visualization retains its original 
% visualization 
information in close proximity but reduces the visibility when viewed from a certain distance or further away. We conducted \alexin{two
% \alexout{well-designed} 
user studies} to inform the design of our approach (N=16) and systematically evaluate its performance (N=18), respectively. The results demonstrate the effectiveness of our approach in terms of privacy preservation for mobile data visualizations.
%-------------------------------------------------------------------------
%  ACM CCS 1998
