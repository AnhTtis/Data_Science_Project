...
Also, it will be interesting to explore how we can leverage the screen setting of mobile devices (e.g., sizes and resolutions) to achieve automated optimal parameter configuration for our approach on different mobile devices.
