...
Specifically, many
data anonymization techniques have been developed to encrypt identifiers of individual data items that can connect individual data items to
% a data point 
...
% the data's content.
Although these methods can avoid the revelation of individual data items,
