...
\author{Yiming Li$^{1,*}$ \quad Qi Fang$^{1,*}$ \quad  Jiamu Bai$^1$ \quad Siheng Chen$^{2,3}$ \quad Felix Juefei-Xu$^1$ \quad Chen Feng$^{1}$\\
$^{1}$New York University \quad $^{2}$Shanghai Jiao Tong University \quad $^{4}$Shanghai AI Laboratory
\\
% {\tt\small yimingli@nyu.edu, cfeng@nyu.edu}
% {\tt\small \url{github}}
{\tt\small yimingli@nyu.edu, sihengc@sjtu.edu.cn, juefei.xu@nyu.edu, cfeng@nyu.edu} \\
