...
%\usepackage{tikz-cd}
%\input{tikz-cd-migration}% In order to upgrade tikz-cd from ver. 0.? to 0.9
\tikzcdset{
  shift left/.default=+0.7ex,% default: +0.56ex
  shift right/.default=+0.7ex}
...
%
%\newcommand{\withSmallerSymbol}[2]{\text{\scalebox{1}[0.8]{\(#1{\text{\scalebox{1}[1.25]{\(#2\)}}}\)}}}
%\newcommand{\overleftarrowSS}{\withSmallerSymbol\overleftarrow}
%\newcommand{\overrightarrowSS}{\withSmallerSymbol\overrightarrow}
%\newcommand{\overleftrightarrowSS}{\withSmallerSymbol\overleftrightarrow}
%\newcommand{\underleftarrowSS}{\withSmallerSymbol\underleftarrow}
%\newcommand{\underrightarrowSS}{\withSmallerSymbol\underrightarrow}
...
\newcommand{\mnd}{\nabla}%{{\scriptstyle \nabla}}
\newcommand{\unt}{{\scriptstyle \bot}}
\newcommand{\cmn}{\Delta}%{{\scriptstyle \Delta}}
\newcommand{\cun}{\top}%{{\scriptstyle \top}}
...
%\newcommand{\AK}{\theta}
%\newcommand{\LK}{\lambda}
%\newcommand{\UKK}[2]{\left\{{#1}\right\}{#2}}
%\newcommand{\VK}{{v}}
%\newcommand{\WK}{{w}}
%\newcommand{\TK}{{\sf t}}
%\newcommand{\SK}{[\, ]}
%\newcommand{\SKK}[2]{\left[{#1}\right] {#2}}
%%\newcommand{\TIME}{\mbox{\sc tm}}
%%\newcommand{\SPACE}{\mbox{\sc sp}}
...
%\newcommand{\PP}{\PPp}
%\newcommand{\WW}{{\widetilde{\Sigma}}}
%
%\newcommand{\tu}{{\rho}}
%\newcommand{\tuu}{\widetilde{\tu}}
%\newcommand{\tuuu}{\overline{\tu}}
%
%\newcommand{\tum}{{p}}
%\newcommand{\tumm}{\widetilde{\tum}}%{\widehat{t}}
%\newcommand{\tummm}{\overline \tum}%{\overset{\infty}{t}}%{\overline{t}}
%\newcommand{\Turmm}{\widetilde P}
%\newcommand{\Turmmm}{\overline P}
%\newcommand{\Turm}{{\QQq}}
%
%
%\newcommand{\tim}{t}
%\newcommand{\timm}{\widetilde \tim}
%\newcommand{\timmm}{\overline \tim}
%\newcommand{\Timm}{\widetilde T}
%\newcommand{\Timmm}{\overline T}
%
%
%\newcommand{\spac}{s}
%\newcommand{\spacc}{\widetilde \spac}
%\newcommand{\spaccc}{\overline \spac}
%\newcommand{\Spacc}{\widetilde S}
%\newcommand{\Spaccc}{\overline S}
%
%
%
%\newcommand{\RR}{\SSs}
...
%\newcommand{\MMMM}{\MMM}
%\newcommand{\MMmm}{\MMm}
%\newcommand{\doublone}{\mathbb{1}}%{1\!\!1}
%\newcommand{\tru}{\mathbb{t}}%{t\!t}
%\newcommand{\fls}{\mathbb{f}}%{f\!\!f}
%\newcommand{\Bits}{\mathbb{2}}%{2\hspace{-1.5mm}2}%{\BBb}
%\newcommand{\Totel}{\TTt}
%\newcommand{\NNnn}{\overline\NNn}
