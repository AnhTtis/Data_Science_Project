...
to the completeness of bot beliefs\\[.5ex]
...
\section{Universal language}\label{Sec:moncom}
\input{40-wollic}

\section{Self-explanations}\label{Sec:self-fulfill}
\input{50-wollic}
...
\section{From natural science to artificial delusions}\label{Sec:Outro}
\input{70-wollic}

%\bibliographystyle{abbrv}
\bibliography{CT,induction,logic,modal,networks,PavlovicD,semantics,statistics}
