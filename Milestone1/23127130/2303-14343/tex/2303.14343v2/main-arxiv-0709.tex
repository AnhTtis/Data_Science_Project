...
\title{Ferroelectric metals in 1T/1T$^{\prime}$-phase transition metal dichalcogenides bilayers}
...
%As reported in T$_d$-MoTe$_2$, the interlayer shifts of $C_{2z}$-related centrosymmetric 1T$^{\prime}$-monolayers actually break IS, yielding ferroelectricity in a semimetal~\cite{MoTe2.wzj.PRL}. 
Inspiredly, we construct a bilayer system, where the top and bottom 1T-monolayers ($xy$-plane) are related by $C_{2z}$ rotation. 
...
The $\pi$-bilayer structure can be widely found in nature materials, such as 1T$^{\prime}$/T$_d$/T$_0$-TMD, $\alpha$-Bi$_4$X$_4$(X=Br, I).
Noting the monolayer of T$_d$ and T$_0$ phase is identical.
Exfoliated from the T$_d$-MoTe$_2$ bulk, we calculate the FE polarization of the metallic MoTe$_2$ $\pi$-bilayer (with 1T$^{\prime}$-monolayer) being 0.25 pC/m, where the FE switching under the electric field can be easily achieved (Section~\ref{SM2} of the Supplemental Material (SM)).
In addition, the crystal structures, $\pi$ bilayers, and vertical polarization of topological compounds Bi$_4X_4$ are presented in detail in Section~\ref{SM2} of the SM. 
...
The interlayer Te atoms distance $d_z$ of the $\pi$-bilayer is obtained by fully relaxation. Its structure is parametrized by the $\textbf{v}_{||}\equiv M_{top}-M_{bottom}=(x_1,x_2)$ [with respect to the lattice constants; $\textbf{v}_{||}=x_1 \textbf{a} +x_2 \textbf{b}$].
...
Because the two FE structures are related by mirror symmetry $m_z$, they have the opposite vertical polarizations.
...
The existence of vertical polarization is also confirmed by the discontinuity of vacuum levels on the upper and lower sides of the slab, details of which are shown in Section~\ref{SM3} of the SM.
...
The PE phase (SG Aem2 (\#39)) with $\textbf{v}_{||}=(1/2,1/2)$ at the saddle point of energy surface is unstable and will spontaneously transition to two FE phases, which indicates that the PE phase is the transition state of the FE switching pathway.

In addition, the typical energy double well structure is clearly visible in Fig.~\ref{fig:1}(d), with a low energy barrier of 56 meV per unit cell for PtTe$_2$ $\pi$-bilayer, which is listed in Table~\ref{table:1}. Such a low energy barrier is attributed to the fact that the interlayer sliding to achieve FE switching only needs to overcome weak interlayer vdW interactions, which does not involve the deformations of tightly bonded atoms as in displacive ferroelectrics~\cite{In2Se3.NC, BaTiO.Nature}. Sliding driven the oscillation of interlayer potential can generate alternating current, which provides a platform for the development of nanogenerator~\cite{Nano.2017, WTe2.JPCL}.
For PdTe$_2$ and NiTe$_2$ $\pi$-bilayers, contour plots of total energy and vertical polarization versus the $\textbf{v}_{||}$ and phonon spectra can be found in Fig.~\ref{fig:S4} and Fig.~\ref{fig:S5}, which are similar to those of PtTe$_2$ $\pi$-bilayer.
...
\paragraph*{Metallicity.}
 It is worth mentioning that the vdW charge transfer also introduces additional metallicity into our FE $\pi$-bilayers. Although the monolayer is insulating, the bilayer becomes metallic, which is further checked by the HSE06 functional (Section~\ref{SM4} of the SM). After the stacking, Te$_{up}$ and Te$_{dn}$ atoms loses electrons seriously due to the space expansion of $p_z$ orbital, forming a large charge depletion zone like $p_z$ orbital, as shown by charge density difference in Fig.~\ref{fig:3}(a) for PtTe$_2$ $\pi$-bilayer. When the two monolayers are far apart in Fig.~\ref{fig:3}(c), band structure can be regarded as a direct doubling of the band of monolayer in Fig.~\ref{fig:S8}(a). With the increase of the interlayer vdW charge transfer due to the reduced $d_z$ in Fig.~\ref{fig:3}(d-f), the valence band dominated by Te$_{up}$-$p_z$ and Te$_{dn}$-$p_z$ orbitals gradually rise above $E_F$ near $\Gamma$ point, moving PtTe$_2$ FE $\pi$-bilayer from an insulating phase to a metallic phase (see more in Section~\ref{SM5} of the SM).
...
As the Bi$_4$X$_4$ monolayer is a quantum spin Hall insulator, the Bi$_4$X$_4$ $\pi$-bilayer would show both ferroelectricity and topology.
In conclusion, the $\pi$-bilayer structure can be obtained in nature or in laboratory, which enables us to manipulate the interplay between the ferroelectricity and other novel properties, such as superconductivity and topology.
...
\subsection{Calculation and Methodology}
\label{SM1}
We carried out the first-principles calculations based on the density functional theory (DFT) with projector augmented wave (PAW) method~\cite{paw1, paw2}, as implemented in the Vienna \emph{ab initio} simulation package (VASP)~\cite{KRESSE199615, vasp}. The generalized gradient approximation (GGA) in the form of Perdew-Burke-Ernzerhof (PBE) function~\cite{pbe} was employed for the exchange-correlation potential. The kinetic energy cutoff for plane wave expansion was set to 500 eV, and a 18$\times$18$\times$1 Monkhorst-Pack $\textbf{k}$-mesh was adopted for the Brillouin zone sampling in the self-consistent process. The thickness of the vacuum layer along $z$ axis was set to \textgreater ~20 \AA. Both lattice parameters and atomic positions were fully relaxed by minimizing the interionic forces below 10$^{-3}$ eV/\AA. The DFT-D3 method of Grimme with BJ damping was applied to consider vdW interaction~\cite{DFT-D3.JCP,DFT-D3.JCC}. The dipole correction was applied in all calculations~\cite{dipole}.  
...
\subsection{Ferroelectric in MoTe$_2$ and Bi$_4$X$_4$ $\pi$-bilayers}
\label{SM2}
...
As shown in Fig.~\ref{fig:S1}(a), the two FE phases with SG $Pm$ (\#6) and PE phase with SG $Pmc2_1$ (\#26) are obtained in our calculations [FE1: $\textbf{v}_{||}=(0.44,0)$; FE2: $\textbf{v}_{||}=(0.56,0)$; PE: $\textbf{v}_{||}=(0.50,0)$]. 
Because the two FE structures are related by $m_z$ symmtery, they have the opposite vertical polarizations (0.25 pC/m). A glide symmetry ($g_z$: $m_z$ with a fractional in-plane translation) and $C_{2x}$ symmetry in the PE phase forbid vertical polarization. 
As confirmed by phonon spectra in Fig.~\ref{fig:S1}(b), the two FE phases are dynamically stable. The FE switching is realized by interlayer sliding. The polarization transition and energy barrier (under different vertical electric fields) on the FE switching pathway are plotted in Fig.~\ref{fig:S1}(c) and Fig.~\ref{fig:S1}(d), respectively. The typical energy double well is clearly visible, with a low energy barrier of 3.18 meV per unit cell. In addition, we investigate the influence of external electric field perpendicular to the slab on the energy pathway of FE switching, where the vertical electric field is applied by introducing a dipole layer in the middle of the vacuum region~\cite{dipole}. With increasing the electric field in Fig.~\ref{fig:S1}(d), the energy barrier from FE1 to FE2 decreases dramatically, which suggests that the FE switching under the electric field can be easily achieved~\cite{M1M1P2X6.SB}.
...
The two FE phases with SG $Cm$ (\#8) and PE phase with SG $Pc$ (\#7) are obtained in our calculations [FE1: $\textbf{v}_{||}=(0.225,0)$; FE2: $\textbf{v}_{||}=(0.275,0.5)$; PE: $\textbf{v}_{||}=(0.25,0.25)$], whose structures are shown in Fig.~\ref{fig:S2}(b).
The two FE structures linked by $m_z$ symmtery have the opposite vertical polarizations (0.05 pC/m), and are dynamically stable, which is confirmed by phonon spectra in Fig.~\ref{fig:S2}(c). A glide symmetry $g_z$ in the PE phase forbids vertical polarization.
From the total energy as a function of the $\textbf{v}_{||}$ in Fig.~\ref{fig:S2}(e), we obtained FE switching pathway realized by interlayer sliding as depicted by the dashed line.
...
In addition, Bi$_4$I$_4$ $\pi$-bilayer with vertical polarizations of 0.24 pC/m has the same FE behaviors [FE1: $\textbf{v}_{||}=(0.23,0)$; FE2: $\textbf{v}_{||}=(0.27,0.5)$; PE: $\textbf{v}_{||}=(0.25,0.25)$], as shown in Fig.~\ref{fig:S2}(d), Fig.~\ref{fig:S2}(f), and Fig.~\ref{fig:S2}(g).
...
\begin{figure}[!htb]
\centering
\includegraphics[width=12 cm]{figS1.pdf}
\caption{(Color online)
(a) Side view of two energy-degenerate FE phases (FE1 and FE2) linked by $m_z$ and PE phase for MoTe$_2$ $\pi$-bilayers. The blue and red crosses represent the inversion center of monolayer in the upper and lower layer, respectively. The orange arrows indicate the direction of polarization. (b) Phonon spectra of FE phase for MoTe$_2$ $\pi$-bilayer. 
(c) Polarization transitions and (d) energy barriers (under different vertical electric fields) on the FE switching pathway
for MoTe$_2$ $\pi$-bilayer. The total energies corresponding to two FE phases without external electric field are set to zero, and the energy curves with external electric field are shifted so that the total energies of PE phases without and with external electric field coincide.
} \label{fig:S1}
\end{figure}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=17.5 cm]{figS2.pdf}
\caption{(Color online)
(a) Schematic diagram of $\beta$ and $\alpha$-Bi$_4X_4$ ($X$=Br, I) structures.
(b) Side view of two energy-degenerate FE phases (FE1 and FE2) linked by $m_z$ and PE phase for Bi$_4X_4$ $\pi$-bilayers. 
The orange arrows indicate the direction of polarization.  Phonon spectra of FE phase for (c) Bi$_4$Br$_4$ and (d) Bi$_4$I$_4$ $\pi$-bilayers. Contour plots of total energy versus the $\textbf{v}_{||}$ for (e) Bi$_4$Br$_4$ and (f) Bi$_4$I$_4$ $\pi$-bilayers. FE switching pathway is marked with black dotted line. (g) Energy barriers on the FE switching pathway for Bi$_4$Br$_4$ (red circle) and Bi$_4$I$_4$ (blue triangle) $\pi$-bilayers. The total energies corresponding to two FE phases are set to zero.
} \label{fig:S2}
\end{figure}
...
\label{SM3}
Due to the presence of spontaneous vertical polarization, there is a built-in electric field, resulting in different vacuum levels on the upper and lower sides of FE slab. As shown by plane-averaged electrostatic potential along $z$ direction in Fig.~\ref{fig:S3}, the discontinuity of vacuum levels $(\Delta\varphi=\varphi_1 - \varphi_2)$ is obvious, where $\varphi_1$ and $\varphi_2$ represent the vacuum levels of the top and bottom sides, respectively. For PtTe$_2$ $\pi$-bilayers in Fig.~\ref{fig:S3}(a) and Fig.~\ref{fig:S3}(b), the negative $\Delta\varphi$ (-0.051 eV) of FE1 phase indicates an upward vertical polarization, while a vertical polarization of FE2 phase with the equal magnitude and the opposite direction is demonstrated by the positive $\Delta\varphi$ (0.051 eV) with the equal magnitude. The same is true for PdTe$_2$ and NiTe$_2$ $\pi$-bilayers, as shown in Fig.~\ref{fig:S3}(c-f). The larger $\Delta\varphi$, the greater spontaneous polarization, which is also reflected in $M$Te$_2$ FE $\pi$-bilayers.



\subsection{Band structure with the HSE06 functional}
\label{SM4}
In order to check the metallicity of $M$Te$_2$ FE $\pi$-bilayers, we employ the HSE06 functional to obtain more accurate band structures. As shown in Fig.~\ref{fig:S7}, the bilayers are metallic, which is consistent with the results of the PBE functional (see Fig.~\ref{fig:3}(f), Fig.~\ref{fig:S9}(d), and Fig.~\ref{fig:S9}(h)). The difference in band structure obtained by the HSE06 function and the PBE function is negligible.



\subsection{Origin of metallicity for PdTe$_2$ and NiTe$_2$ $\pi$-bilayers}
\label{SM5}
As with PtTe$_2$ FE $\pi$-bilayer described in main text, interlayer vdW charge transfer also causes the valence band rise to introduce metallicity into PdTe$_2$ and NiTe$_2$ FE $\pi$-bilayers. With the increase of the interlayer vdW charge transfer due to the reduced $d_z$ in Fig.~\ref{fig:S9}(a-d), the valence band dominated by the Te$_{up}$-$p_z$ and Te$_{dn}$-$p_z$ orbitals gradually rise above $E_F$ near $\Gamma$ point, which transforms PdTe$_2$ FE $\pi$-bilayer from an insulator to a metal. For NiTe$_2$ 1T-monolayer in Fig.~\ref{fig:S8}(c), although there is a non-zero density of states near $E_F$, only two isolated valence bands dominated by the Te-$p_x$ and Te-$p_y$ orbitals pass through $E_F$, limiting conductivity. As shown in Fig.~\ref{fig:S9}(e-h), the same valence band rise gives NiTe$_2$ FE $\pi$-bilayer more conductive electron states.
...
\begin{figure}[!htb]
\centering
\includegraphics[width=15 cm]{figS3.pdf}
%\includegraphics[width=0.9\linewidth]{figS1.pdf}
\caption{(Color online)
...
\begin{figure}[!htb]
\centering
\includegraphics[width=13.5 cm]{figS4.pdf}
\caption{(Color online)
...
\begin{figure}[!htb]
\centering
\includegraphics[width=12 cm]{figS5.pdf}
\caption{(Color online)
...
\begin{figure}[!htb]
\centering
\includegraphics[width=15 cm]{figS6.pdf}
\caption{(Color online)
...
\begin{figure}[!htb]
\centering
\includegraphics[width=15 cm]{figS7.pdf}
\caption{(Color online)
...
\begin{figure}[!htb]
\centering
\includegraphics[width=15 cm]{figS8.pdf}
\caption{(Color online)
...
\begin{figure}[!htb]
\centering
\includegraphics[width=17.5 cm]{figS9.pdf}
\caption{(Color online)
