...
\begin{figure}
    ...
    \begin{tabular}[]{c c c c}
        \includegraphics[scale=2]{figures/kernels/4.png} &
        \includegraphics[scale=2]{figures/kernels/7.png} &
        \includegraphics[scale=2]{figures/kernels/9.png} &
        \includegraphics[scale=2]{figures/kernels/11.png} \\
        (a) & (b) & (c) & (d) 
    \end{tabular}
...
\begin{figure}
    \begin{subfigure}[h]{\linewidth}
        ...
        \includegraphics[width=\fwidth]{figures/deb_s255_k4.pdf}
        \caption{kernel (a), $\sigma=2.55$}
    \end{subfigure}
    
    \begin{subfigure}[h]{\linewidth}
    \centering
    \includegraphics[width=\fwidth]{figures/deb_s255_k9.pdf}
    \caption{kernel (c), $\sigma=2.55$}
    \end{subfigure}

    \begin{subfigure}[h]{\linewidth}
        \centering
        \includegraphics[width=\fwidth]{figures/deb_s765_k4.pdf}
...
\begin{figure}
    \begin{subfigure}[h]{\linewidth}
    \centering
    \includegraphics[width=\fwidth]{figures/deb_s765_k9.pdf}
    \caption{kernel (d), $\sigma=7.65$}
    \end{subfigure}

    \begin{subfigure}[h]{\linewidth}
    \centering
    \includegraphics[width=\fwidth]{figures/deb_s1275_k7.pdf}
    \caption{kernel (b), $\sigma=12.75$}
    \end{subfigure}

    \begin{subfigure}[h]{\linewidth}
    \centering
    \includegraphics[width=\fwidth]{figures/deb_s1275_k11.pdf}
...
\begin{figure}
    ...
    \includegraphics{figures/demo_inp_bsd3.pdf}
