...
\begin{figure}
    \includegraphics[width=\linewidth]{figures/demo_inpainting.pdf}
    \caption{\label{fig:inp_add}Inpainting}
\end{figure}

\begin{figure}
    \includegraphics[width=\linewidth]{figures/demo_sr_sf4_s3.pdf}
    \caption{\label{fig:sr_add}$\times 4$ super-resolution, with kernel (a) from Figure~\ref{fig:kernels} and $\sigma=3$}
\end{figure}

\begin{figure}
    \includegraphics[width=\linewidth]{figures/demo_deblurring_kernel_11_s8.pdf}
