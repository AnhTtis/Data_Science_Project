...
and two CEs, one with 40-km long arms and one with 20-km long arms, located in the Idaho and New Mexico proposed sites respectively; see Ref.~\cite{Iacovelli:2022mbg} for details on the adopted noise curves and orientations. As standard practice in the field, we consider the SNR as a detection statistics and adopt a threshold of $8$. %
...
\begin{figure*}
         ...
         \includegraphics[width=0.97\columnwidth]{zzplot_popaverage_linspace_well_cond_res900_raster_prior-com_vol.pdf}
        \hfill
        \includegraphics[width=0.97\columnwidth]{zzplot_popaverage_linspace_flatLog_well_cond_res900_raster_prior-com_vol.pdf}
