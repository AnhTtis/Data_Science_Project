\begin{table}[t]
    ...
    \caption{X-SHOOTER and GNIRS/GMOS observations of our compact PNe and one transient. For U, V, and N we refer to the UVB, VIS and NIR channels of X-SHOOTER. In case of DdDm-1, V refers to GMOS and N to GNIRS.}
    \smallskip
    \begin{tabular}{|lccc|}
    \hline
        Name & $t_{\rm exp}$ [s] & Airmass & Seeing [$^{\prime\prime}$] \\
         & U, V, N & (at zenith) & \\
        \hline
        DdDm-1     & --, 480,160/320\tnote{a} & 1.06 & 0.43 \\
        ...
        STRIPE82-0130\tnote{b} & 240, 80, 240 & 1.41 & 0.32 \\
        \hline
    \end{tabular}
    \footnotesize
    \begin{tablenotes}
    \item[a] Values for the GMOS/GNIRS setups.
    \item[b] Transient, not a PN.
    \end{tablenotes}
