...
\begin{figure*}[h]
    \centering
    \vstretch{0.95}{\includegraphics[width=0.85\textwidth]{figures/gnnbuilder_arch.png}}
...
\begin{figure*}[h]
    \centering
    \small
    \includegraphics[width=0.8\textwidth]{figures/gnnconv.png}
...
\begin{itemize}
    ...
    \item \textbf{FPGA-Base}: Proposed hardware model without parallelism
    \item \textbf{FPGA-Parallel}: Proposed hardware model with parallelism
\end{itemize}
...
Future work involves optimizing graph convolution kernels, exploring intelligent DSE search methods, train-time co-design, and expanding our kernel template library to accommodate more graph convolution kernels such as GAT \cite{velivckovic2017graph} and other emerging GNN architectures. The initial software framework is available at \url{https://anonymous.4open.science/r/gnn-builder-83B4/} for both software and hardware practitioners.
