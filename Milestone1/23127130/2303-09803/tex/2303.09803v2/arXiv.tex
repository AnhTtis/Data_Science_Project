...
parameter of the the receptive fields.
...
Beyond the variability due to natural image transformations, which are
...
the motion parameter $v$ in the spatio-temporal receptive field model
...
(Lindeberg \citeyear{Lin10-JMIV,Lin13-BICY,Lin16-JMIV,Lin21-Heliyon}) regarding a
...
\begin{figure}[hbtp]
  ...
  \caption{Due to the effects of natural image transformations, the
    ...
    (middle row) the viewing direction and (bottom row) the relation motion
