...
$\theta$ denotes the collection of the weights and biases
\[\theta=((W_1,b_1),\cdots,(W_L,b_L))\in\Omega\]
We use the same activation function for layers $1$ through $L-1$, denoted by $\sigma:\mathbb{R}\rightarrow\mathbb{R}$, which can be applied in an element-wise fashion to vectors. 
