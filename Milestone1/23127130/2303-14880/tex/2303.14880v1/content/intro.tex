...
% writing down here
% Paragraph 1: humans are good at social navigation and there are a lot of such data easily available everywhere. 
...
With an increasing amount of autonomous mobile robots being deployed in public spaces \cite{scout, tinymile, dilligent, starship}, those robots are also expected to navigate among humans in a similar, human-like, socially compliant manner. 
...
% Paragraph 2: We want to build robots to do the same thing, but they still suck at it. Many researchers used learning to enable social robot navigation, but to get such data is very expensive. 
...
% new paragraph 3: researchers uses learning for social nav, but data is difficult to get
...
% Paragraph 4: We propose to collect such easily accessible social human navigation data to enable social robot navigation. We build a sensor suite wearable by a human but collect data through multi-modal robotic perception. 
...
% Paragraph 5: How great our dataset is, multi-modal, context-aware, large, diverse, etc.
