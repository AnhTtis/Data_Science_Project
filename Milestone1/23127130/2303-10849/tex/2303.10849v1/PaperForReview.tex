...
These masked images are sent to the MAE encoder and the complete images should be reconstructed by MAE decoder~(See Fig.~\ref{fig:mae}). The loss function of MAE pre-training is the pixel-wise L2 loss to make the reconstructed images close to the target images.

\begin{figure}
    \centering
    \includegraphics[ width=1\linewidth]{images/MAE.pdf}
    %\vspace{-1.5em}
    \caption{Description of MAE self-supervised training.}
    \label{fig:mae}
\end{figure}
