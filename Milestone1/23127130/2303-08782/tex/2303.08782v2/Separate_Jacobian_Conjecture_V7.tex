...
\\
 ...
 \begin{eqnarray}
 \frac{1}{ {\rm{det}[J](\tau,{\x}_{\rm{dp}})} }   \frac{\d {\rm{det} [J](\tau,{\x}_{\rm{dp}})}}{\d \tau}&=&
...
\fi
%
For  $  \Delta \tau'  > 0$ and assuming that the weak energy condition holds $ R_{\alpha\beta}  u^{\alpha} u^{\beta}  \ge 0$ and ${\sigma}_{ab}{\sigma}^{ab}$ is positive definite  this implies that  $ {\rm{det}[J]}(\tau')  \to 0$ in a finite proper time of the same geodesic.
The global Hubble expansion breaks down at ${\x}_{\rm{dp}}$ and any attempt to extend the same one-parameter family of geodesics beyond the causal horizon will end in a singularity or a caustic or a conjugate point. 

There is another crucial piece of information which we have mentioned earlier that at $\Theta(\tau,{r}_{\rm{dp}})  = 0$, the determinant of the Jacobian ($ {\rm{det}}[J](\tau, {\x})$) is a non-zero constant. By the inverse function theorem, this indicates that we can always find another more suitable coordinates in the immediate neighbourhood of the causal horizon.  We show in section \ref{sec:vorticit_generation} that a change of coordinates in the neighbourhood of the causal horizon leads to a generation of vorticity which then alters the key assumption of the focussing theorem, thereby avoiding the singularity. 
...
\begin{eqnarray}\label{eq:vorticity_eqn}
   \dot{\tilde{\omega}}_{+a}+\frac{1}{3}\tilde{\Theta}_{+}\tilde{\omega}_{+a}  =    c_{+s}^2\tilde{\Theta}_{+} \tilde{\omega}_{+a}+\eta_{+} {\D}_{b} {\D}^b \tilde{\omega}_{+a}  \,.
\end{eqnarray}
...
\bibitem{Garny:2022tlk}
M.~Garny, D.~Laxhuber, and R.~Scoccimarro, {\it {Perturbation theory with
  dispersion and higher cumulants: framework and linear theory}},
  \href{http://arxiv.org/abs/2210.08088}{{\tt arXiv:2210.08088}}.

\bibitem{Garny:2022kbk}
M.~Garny, D.~Laxhuber, and R.~Scoccimarro, {\it {Perturbation theory with
  dispersion and higher cumulants: non-linear regime}},
  \href{http://arxiv.org/abs/2210.08089}{{\tt arXiv:2210.08089}}.
...
C.~Clarkson, G.~F.~R. Ellis, A.~Faltenbacher, R.~Maartens, O.~Umeh, and J.-P.
  Uzan, {\it {(Mis-)Interpreting supernovae observations in a lumpy universe}},
   {\em Mon. Not. Roy. Astron. Soc.} {\bf 426} (2012) 1121--1136,
...
O.~Umeh, {\it {Emergence of smooth distance and apparent magnitude in a lumpy
  Universe}},  {\em Class. Quant. Grav.} {\bf 39} (2022), no.~23 235006,
  [\href{http://arxiv.org/abs/2202.08237}{{\tt arXiv:2202.08237}}].
