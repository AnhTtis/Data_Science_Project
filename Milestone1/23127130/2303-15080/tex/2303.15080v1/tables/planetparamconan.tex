\begin{table*}[h]
\caption{Maximum values and 68$\%$ confidence intervals of the posterior distributions from joint modelling with \CONAN.}
\centering
...
\textbf{Parameters} & \textbf{TOI-615}& \textbf{TOI-622} & \textbf{TOI-2641} \\
 \hline
    ...
    $\omega_*$ (deg)\dotfill  & ... & ... & ...\\
    $\textit{K}$ (m$s^{-1}$)\dotfill  & 42.4$^{+6.9}_{-8.6}$ & 27.8$^{+6.4}_{-7.4}$& 39.9$^{+5.3}_{-4.4}$\\
    ...
    $\it{M_{P}}$ (\mjup)\dotfill  & 0.435$^{+0.086}_{-0.082}$ & 0.303$^{+0.069}_{-0.072}$ & 0.367$^{+0.049}_{-0.040}$\\
    $\rho_P$ (\densjup)\dotfill  & 0.084$^{+0.018}_{-0.018}$ & 0.507$^{+0.126}_{-0.126}$ & 0.082$^{+0.071}_{-0.097}$\\
    ...
    $H$ (km)\dotfill  & 1601$^{+332}_{-321}$& 454$^{+108}_{-113}$& 1438$^{+845}_{-1150}$ \\
    ...
    $\sigma_{w,CHIRON}$ ($\kms$)\dotfill  & ... & ... &0.036$^{+0.087}_{-0.036}$\\   
    $\gamma_{CHIRON}$ ($\kms$)\dotfill & ... & ... & -8.027$^{+0.041}_{-0.041}$ \\ 
    \hline
\end{tabular}
\begin{tablenotes}
\item
