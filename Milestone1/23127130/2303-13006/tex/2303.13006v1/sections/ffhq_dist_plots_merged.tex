...
\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \legend{
            ...
            {ID3PM (Ours, FaceNet~\cite{facenet_pytorch})},
    ...
    \end{subfigure}
    \caption{Probability density functions of the ArcFace~\cite{arcface_torch} and FaceNet~\cite{facenet_tf}  distances of $1000$ FFHQ~\cite{stylegan} test images and their corresponding reconstructions.}
    \label{fig:plot_ffhq}
\end{figure}
