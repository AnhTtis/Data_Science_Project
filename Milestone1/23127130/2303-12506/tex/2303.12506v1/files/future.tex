...
\eden{if we have time to try to add: }In Section \ref{sec:app}, we saw that in the problem of stochastic allocations, to extend the approximation algorithm for the egalitarian welfare, we had to change some steps within.
