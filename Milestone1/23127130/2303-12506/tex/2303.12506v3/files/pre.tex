...
\eden{added:}
The term "with high probability" (w.h.p.) is used when the success probability is at least $1-1/poly(X)$ where $X$ describes the input size.
