...
\section{Failed Attempts to Extend the Saturation Algorithm}

An intuitive idea to extend the  saturation algorithm is to considered an objective function as ”saturated” if its maximum attainable value is
close to the maximum $z_t$.
