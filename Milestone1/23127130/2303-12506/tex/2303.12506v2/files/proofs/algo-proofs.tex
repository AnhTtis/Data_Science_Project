...
\begin{proof}[Proof of Theorem \ref{th:main}]
   ...
   \end{align}
    ...
    Now, suppose by contradiction that $\retSol$ is \emph{not} $\left(\multApprox^2\cdot\Delta(\multApprox), \additiveApprox \cdot\Delta(\multApprox)\right)$-approximate leximin-optimal.
