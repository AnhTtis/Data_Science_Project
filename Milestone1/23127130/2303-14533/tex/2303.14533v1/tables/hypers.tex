...
\hline \\[-2.4ex] \hline \\[-2.4ex]
    ...
    \hline \\[-2.4ex]
    KPS & No. of PCA factors & 1, 2, 3, ..., 10 & 5 \\
    & Mean penalty - $\lambda_0$ & $0$, $10^{-5}$, $10^{-4}$, $10^{-3}$, ..., $10^{5}$ & $10^{0}$ \\
    & $L^2$ penalty - $\lambda_2$ & $0$, $10^{-5}$, $10^{-4}$, $10^{-3}$, ..., $10^{5}$ & $10^{-1}$ \\
    \hline \\[-2.4ex]
