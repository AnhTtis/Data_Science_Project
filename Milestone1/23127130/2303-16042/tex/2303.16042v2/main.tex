...
the number of muons or the total energy carried by electrons and photons, decreasing by 1\%
...
radiation length $X_0\approx 38$ g/cm$^2$, with the cross section for a photo-hadronic collision 100 times smaller. This initial EM energy, however, crosses a large depth before it is
...
A simple argument suggests that these processes could be sizeable. 
...
\eeq
We plot this observable in Fig.~\ref{f9}, where we appreciate a 1\% reduction for showers with s = 1.5 due to the
new EM interactions.
\begin{figure}[ht!]
\begin{center}
...
(photo-hadronic collision). These ultra-peripheral processes have a longer interaction length 
