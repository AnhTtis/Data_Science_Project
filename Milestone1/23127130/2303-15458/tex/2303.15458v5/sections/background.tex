...
The simplest dynamic process described in terms of fractional operators consists of an initial value problem for a linear fractional rate equation, which for a given variable $y(t)$ is given by
\begin{equation}
