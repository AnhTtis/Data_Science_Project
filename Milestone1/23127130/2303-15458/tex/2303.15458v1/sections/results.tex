...
\end{equation}
where $\hat{\mat{L}}$ denotes the discrete Laplacian operator. If $\mat{I}$ is the $m \times m$ identity matrix and $\mat{C}$ is an $m \times m$ matrix defined as follows, then matrix $\hat{\mat{L}}$ is given as
...
\begin{minipage}[t]{0.475 \textwidth}
	\centering	\includegraphics[width=1.025\textwidth]{figures/poisson-err}
...
\quad
\begin{minipage}[t]{0.475 \textwidth}
	\centering	\includegraphics[width=1.025\textwidth]{figures/poisson-error-dist}
...
\centering
\begin{minipage}[t]{0.475 \textwidth}
	\centering	\includegraphics[width=1.025\textwidth]{figures/poisson-time-scale}
...
\quad
\begin{minipage}[t]{0.475 \textwidth}
	\centering	\includegraphics[width=1.025\textwidth]{figures/poisson-scale-time}
...
\begin{minipage}[c]{0.475 \textwidth}
	\centering \includegraphics[width=1.025\textwidth]{figures/fem-mesh}
	\caption{Computational mesh of the domain where the fractional convection-diffusion equation is solved.}
	\label{fig:fem_mesh}
\end{minipage}%
\quad
\begin{minipage}[c]{0.475 \textwidth}
	\centering	\includegraphics[width=1.025\textwidth]{figures/fem-eigen-hist}
...
\afterpage{
    ...
    \centering
    \begin{minipage}[t]{0.475 \textwidth}
    	\centering	\includegraphics[width=1.025\textwidth]{figures/fem-err}
    ...
    \quad
    \begin{minipage}[t]{0.475 \textwidth}
    	\centering	\includegraphics[width=1.025\textwidth]{figures/fem-scale-err}
