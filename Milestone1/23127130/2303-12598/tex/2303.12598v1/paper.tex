...
\newcommand{\clu}{CLU-{\em compiled}~}

\newcommand{\jyms}{\,Jy\,ms} % Fluence units
\newcommand{\radsqm}{\,rad\,m$^{-2}$} % Rotation measure units
\newcommand{\pccm}{\,pc\,cm$^{-3}$} % Dispersion measure units
...
\begin{document} 
   ...
   \title{A LOFAR sample of luminous compact sources coincident with nearby dwarf galaxies}
...
\input{sections/2-selection}

\input{sections/3-candidates}
