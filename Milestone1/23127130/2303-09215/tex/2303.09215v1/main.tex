...
\begin{figure*}
    \includegraphics[width=\linewidth]{Figure/profile.pdf}
...
\begin{figure*}
            \includegraphics[width=0.45\linewidth]{Figure/pressure1.pdf}
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/pressure2.pdf}
        }
...
\begin{figure}
    \includegraphics[width=\linewidth]{Figure/VAxial.pdf}
...
\begin{itemize}
    ...
    \item (3) Then, we use Eq.~\eqref{BC2} to replace the 1st line of $\overline{\mathcal{M}}_L$ and $N$th line of $\overline{\mathcal{M}}_R$, while we use Eq.\eqref{CCL} and Eq.~\eqref{CCR} to replace the $N$th line of $\overline{\mathcal{M}}_L$ and 1st line of $\overline{\mathcal{M}}_R$. We now obtain $\mathcal{M}_L\mathcal{L}=\mathcal{M}_R\mathcal{R}=0$, with $\mathcal{M}_L$ and $\mathcal{M}_R$ the modified matrices about $\omega$ and $\kappa$.
...
\begin{figure*}
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Re,Axial,Hern,Newton.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Im,Axial,Hern,Newton.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Re,Polar,Hern,Newton.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Im,Polar,Hern,Newton.pdf}
       }
        \hfill

    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Re,Axial,Hern,Rel.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Im,Axial,Hern,Rel.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Re,Polar,Hern,Rel.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Im,Polar,Hern,Rel.pdf}
       }
...
\begin{figure*}
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Re,Axial,NFW,Newton.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Im,Axial,NFW,Newton.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Re,Polar,NFW,Newton.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Im,Polar,NFW,Newton.pdf}
       }
        \hfill

    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Re,Axial,NFW,Rel.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Im,Axial,NFW,Rel.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Re,Polar,NFW,Rel.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Im,Polar,NFW,Rel.pdf}
       }
...
\begin{figure*}
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Detection,Hern,Newton.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Detection,Hern,Rel.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Detection,NFW,Newton.pdf}
       }
        \hfill
    \subfloat{
            \includegraphics[width=0.45\linewidth]{Figure/Detection,NFW,Rel.pdf}
       }
