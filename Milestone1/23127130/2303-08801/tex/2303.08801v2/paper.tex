...
%\cite{Kim2013,Maldacena2016,Roberts2016,Gu2017,Luitz2017,Bohrdt2017,Das2018,Keyserlingk2018,Nahum2018,Xu2019,Xu2020,Chen2019,Kuwahara2020,Tran2021}.
...
acting on two remote LIOMs at distance $r$
%add
with a decay length $\xi$
%
is a key to interpret 
...
\begin{figure}[b]
    ...
    $\langle C_\alpha(r,t) \rangle_\mathrm{av}$ 
...
Assumed that a perturbation correction
...
$2r(\mathbf{a},\mathbf{b}) = 2(L_x + L_y - 3)$ that depends on the number 
