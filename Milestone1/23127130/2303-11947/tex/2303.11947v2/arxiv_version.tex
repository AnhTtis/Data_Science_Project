...
\begin{eqnarray}
    D_x&=& \frac{d}{dx}+ \frac{{\theta}}{x} \left(1-\hat{R}\right), \label{cd}
\end{eqnarray}
which slightly differs from Yang's derivative by the second term of Eq. \eqref{cd}. {Because of this historical connection, $\theta$ is named the Wigner parameter.  Basically, this real-valued parameter determines the parity effects and it has a lower bound given by $\theta>-1/2$.} The Dunkl derivative aroused the interest of physicists as well as mathematicians. At first, this interest was manifested in the use of the Dunk derivative in the Calogero-Sutherland-Moser model \cite{Lapointe, Kakei}.
...
^{5/2}g_{5/2}{\left( \theta, z\right)} .  \label{ca}
\end{equation}
...
e^{x}z^{-1}-1}dx.
\end{equation}
Similar to the ordinary case, the BEC of a trapped Dunkl-boson system with a finite number of particles should not have an evident critical temperature {\cite{Liu, Du, Pessoa, bilokon}}. However, one still can determine an effective Dunkl-critical temperature, $T_{c}^{D}$, via two methods \cite{Du}:
\begin{itemize}
...
\end{equation}%
Here, $\zeta(n)$ denotes the Riemann-Zeta function. It is worth noting that the Dunkl-critical temperature depends not only on the total number of particles $N$, the length of the system $L$, {and} the mass of the particles $m$ but also on the Wigner parameter. If we consider the limit, $\theta \rightarrow 0$, then the Dunkl-critical temperature reduces to the ordinary Bose critical temperature, $T_{c}^{B}$, given in the form of
\begin{equation}
...
\caption{The variation of $\frac{T_{c}^{D}}{T_{c}^{B}}$ as {the} function of the Wigner parameter in two and three dimensions.} \label{Fig3}
\end{figure}

We observe that in both dimensions this rate increases monotonically with the increasing Wigner parameter. However, the value of {the} Dunkl-condensation temperature ratio in two dimensions is greater in the region where the Wigner parameter is negative than in three dimensions. In the interval where the Wigner parameter is positive, the rate in three {dimensions} becomes greater. Finally, we demonstrate the condensate fraction $\frac{N_{0}^{D}}{N}$ versus normalized temperature $\frac{T}{T_{c}^{B}}$ for different values of the Wigner parameter in two and three dimensions. 

\begin{figure}[htbp]
\centering \includegraphics[scale=0.85]{Ncomparaison.eps}
\caption{The condensate fraction $\frac{N_{0}^{D}}{N}$ as {the} function $\frac{T}{T_{c}^{B}}$ for different values of $\protect \theta $ for $T\leq T_{c}^{D}$ in two and three dimensions.}
\end{figure}

Here, we see that solid lines (three-dimensional), no matter the Wigner parameter values, are greater than the dashed lines(two-dimensional) up to a ratio value of the normalized temperature. This ratio value depends on the Wigner parameter. This shows that the parity symmetry of the particles {is} important on the {BEC}.  


In this manuscript, we consider the {BEC in} the presence of {the} gravitational field in two and three dimensions within the Dunkl-formalism. The semi-classical approach shows that the critical temperature increases with increasing  values of the Wigner parameter; so by using other Bose gases which have smaller Wigner parameter value{s}, we can obtain the Bose condensation at smaller temperatures.
...
\bibitem{Bagnato87} V. Bagnato, D. E. Pritchard, and D. Kleppner, Phys. Rev. A \textbf{35}, 4354 (1987).
...
\bibitem{Liu} T. G. Liu, Y. Yu, J. Zhao, X. Wang, X. Wang, and Q. H. Liu, Physica A \textbf{388},
2383 (2009).
...
%
\bibitem{Lapointe} L. Lapointe and L. Vinet, Commun. Math. Phys. \textbf{178}(2), 425 (1996). 
%
\bibitem{Kakei} S. Kakei, J. Phys. A \textbf{29}, L619 (1996).
%
\bibitem{G1} V. Genest, M. Ismail, L. Vinet, and A. Zhedanov, J. Phys. A \textbf{46}, 145201 (2013).
%
\bibitem{G2} V. Genest,  L. Vinet, and A. Zhedanov, J. Phys. A \textbf{46}, 325201 (2013).
%
\bibitem{G3} V. Genest, M. Ismail, L. Vinet, and A. Zhedanov, Commun. Math. Phys. \textbf{329}, 999 (2014).
%
\bibitem{G4} V. Genest, L. Vinet, and A. Zhedanov, J. Phys. Conf. Ser. \textbf{512}, 012010 (2014).
%
\bibitem{Sargol} S. Sargolzaeipor, H. Hassanabadi, and W. S. Chung, Mod. Phys. Lett. A \textbf{33}(25), 1850146 (2018).
%
\bibitem{Mota1} R. D. Mota, D. Ojeda-Guill\'en, M. Salazar-Ram\'irez, and V. D. Granados, Ann. Phys. \textbf{411}, 167964 (2019).
%
\bibitem{Bilel3} B. Hamil and B. C. L\"utf\"uoğlu, Eur. Phys. J. Plus \textbf{137}, 812 (2022). 
%
\bibitem{Mota2} R. D. Mota, D. Ojeda-Guill\'en, M. Salazar-Ram\'irez, and V. D. Granados, Mod. Phys. Lett. A \textbf{36}(10), 2150066 (2021).
%
\bibitem{Mota3} R. D. Mota, D. Ojeda-Guill\'en, M. Salazar-Ram\'irez, and V. D. Granados, Mod. Phys. Lett. A \textbf{36}(23), 2150171 (2021).
%
\bibitem{Bilel1} B. Hamil and B. C. L\"utf\"uoğlu, Few-Body Syst, \textbf{63}, 74 (2022).
%
\bibitem{Merad} A. Merad and M. Merad, Few-Body Syst. \textbf{62}, 98 (2021).

%
\bibitem{Chungrev} W. S. Chung and H. Hassanabadi, Rev. Mex. Fis.  \textbf{66}(3), 308 (2020).
%

\bibitem{ChungDunkl} W. S. Chung and H. Hassanabadi, Mod. Phys. Lett. A \textbf{36}(18), 2150127 (2021). 
%
\bibitem{DRelat1}
P. Sedaghatnia, H. Hassanabadi, A. D. Alhaidari, and W. S. Chung, Int. J. Mod. Phys. A, {\textbf{37}(35), 2250223} (2023). 
%
\bibitem{DRelat2}
P. Sedaghatnia, H. Hassanabadi, A. A. Araujo Filho, P. J. Porfirio, and W. S. Chung, arxiv: 2302.11460v1 [gr-qc].
%
%
\bibitem{Marcelo} M. R.  Ubriaco, Physica A \textbf{414}, 128 (2014).
%
%
\bibitem{Bilel2} B. Hamil and B. C. L\"utf\"uoğlu, Eur. Phys. J. Plus \textbf{137}, 1241 (2022). 

%
\bibitem{G5} V. Genest, A. Lapointe, and L. Vinet, Phys. Lett. A \textbf{379}, 923 (2015).
%
\bibitem{Jang} E. J. Jan, S. Park, and W. S. Chung, J. Kor. Phys. Soc. \textbf{68}(3), 379 (2016).
%
\bibitem{Ramirez1} M. Salazar-Ramirez, D. Ojeda-Guill\'en, and V. D. Granados, Eur. Phys. J. Plus \textbf{132}, 39 (2017).
%
\bibitem{Ramirez2} M. Salazar-Ramirez, D. Ojeda-Guill\'en, R. D. Mota, and V. D. Granados, Mod. Phys. Lett. A \textbf{33}(20), 1850112 (2018).

%
\bibitem{Chung1} W. S. Chung and H. Hassanabadi, Mod. Phys. Lett. A \textbf{34}(24), 1950190 (2019).
%
\bibitem{Ghaz} S. Ghazouani, I. Sboui, M. A. Amdouni, and M. B. El Hadj Rhouma, J. Phys. A: Math. Theor. \textbf{52}, 225202 (2019).
%
\bibitem{Kim} Y. Kim, W. S. Chung, and H. Hassanabadi, Rev. Mex. Fis.  \textbf{66}(4), 411 (2020).
%
\bibitem{Ojeda}  D. Ojeda-Guill\'en, R. D. Mota, M. Salazar-Ram\'irez, and V. D. Granados, Mod. Phys. Lett. A \textbf{35}(31), 2050255 (2020).
%
\bibitem{ChungEPJP} W. S. Chung and H. Hassanabadi, Eur. Phys. J. Plus.  \textbf{136}, 239 (2021).
%
\bibitem{Hassan} H. Hassanabadi, M. de Montigny, and W. S. Chung, Physica A  \textbf{580}, 126154 (2021).
%
\bibitem{Dong}S. H. Dong, W. H. Huang, W. S. Chung, P. Sedaghatnia, and H. Hassanabadi, EPL \textbf{135}, 30006 (2021).
%
\bibitem{Seda} P. Sedaghatnia, H. Hassanabadi, W. S. Chung, B. C. L\"utf\"uoğlu, S. Hassanabadi, and J. Kříž, {\color{black} arxiv:2208.12416 [quanth-ph].}
%
\bibitem{Mota2022} R. D. Mota and D. Ojeda-Guill\'en, Mod. Phys. Lett. A \textbf{37}(01), 2250006 (2022).
%
\bibitem{new1} S. Hassanabadi, J. Kříž, B. C. L\"utf\"uoğlu, and   H. Hassanabadi,  Phys. Scr. \textbf{97}, 125305 (2022).


\bibitem{new3} S. Hassanabadi, P. Sedaghatnia, W. S. Chung, B. C. L\"utf\"uoğlu,  J. Kříž, and H. Hassanabadi,  {Eur. Phys. J. Plus \textbf{138}, 331
(2023).}


\bibitem{new4} L. Vinet and A. Zhedanov, Rev. Math. Phys. \textbf{34}(08), 2250025,
(2022).

\bibitem{quezada} S. H. Dong, L. F. Quezada, W. S. Chung, P. Sedaghatnia, and H. Hassanabadi, Ann. Phys. \textbf{451}, 169259 (2023).

\bibitem{1} F. Merabtine, B. Hamil, B. C. L\"{u}tf\"{u}oğlu, A. Hocine, and M. Benarous, J. Stat. Mech., \textbf{5}, 053102 (2023).


{ 
\bibitem{bilokon} V. Bilokon, E. Bilokon, A. Peletminskii, and A. Sotnikov, Physica A \textbf{589}, 126605 (2022).}
