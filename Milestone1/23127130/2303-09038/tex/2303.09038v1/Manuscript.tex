...
\author{
  Qing Lyu, Josh Tan, Mike E. Zapadka, Janardhana Ponnatapuram, Christopher T. Whitlow \\
...
0.067 places of information missing and 0.133 places of information misinterpretation on average per chest CT report, which means once in every 15 translated reports and once in every 7.5 translated reports respectively. Among all the translated chest CT reports, 53\% results are rated with an overall score of 5. Regarding the brain MRI scan report translations, there are 5\% results showed information missing, and there are an average 0.066 places of information missing per report. Meanwhile, 9\% of translated reports are with information misinterpretation, and there are an average 0.092 places of misinterpretation per report. 37\% and 32\% of all brain MRI scan results are rated with an overall score of 4 and 5 respectively. Overall, the average numbers of information missing and misinterpretation for all results are 0.066 and 0.111 respectively, with a frequency of roughly once in every 15 and 9 reports respectively. The average overall score of all results is 4.098, in which 34\% and 35\% of all results are rated with an overall score of 4 and 5 respectively.
...
\midrule
Chest CT & 0.067 & 0.133 & 4.267 \\
Brain MRI & 0.066 & 0.092 & 3.961 \\ \hline
Overall & 0.066 & 0.111 & 4.098 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
  ...
  \item Ff there are incidental findings, please introduce in the fourth paragraph.
\end{itemize}
}
