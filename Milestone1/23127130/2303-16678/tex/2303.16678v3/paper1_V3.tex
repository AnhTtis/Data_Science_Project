...
study since protons are least affected by magnetic fields. However, at this 
...
to energy $E$ for the Kolmogorov spectrum ($m=5/3$, $a_\text{L} \approx 0.23 $ 
and $a_\text{I} \approx 0.9$) (left panel) and the Kraichnan spectrum 
($m = 3/2$, $a_\text{L} \approx 0.42 $ and $a_\text{I} \approx 0.65$) (middle 
