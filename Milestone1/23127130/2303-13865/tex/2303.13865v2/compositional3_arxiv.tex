...
Two optics $(M, f, f')$ and $(N,g,g')$ are equivalent, $(M, f, f') \sim (N,g,g')$ if there exists  $r\colon M \to N$ such that 
...
\end{tikzcd}	
\end{center}	
As pointed out in Remark 3 of \cite{gavranovic2022space}, the directionality of the residual morphism in the equivalence relation does not matter.

On optic from  $(A,A')$ to $(B, B')$ can be visualised as follows:
%\begin{figure}
...
\begin{align*}
	...
	\bw & := M_1\otimes (M_2 \otimes C')  \xrightarrow{M_1 \otimes \bw_2} M_1 \otimes B' \xrightarrow{\bw_1} A'
\end{align*}
\end{defn}
