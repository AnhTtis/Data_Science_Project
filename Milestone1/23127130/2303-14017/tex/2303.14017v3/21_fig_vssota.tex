...
% 		\toprule 
        \hline
% 		\multicolumn{2}{c}{Seen Fonts} \\
% 		\midrule
        % \multirow{9}*{\rotatebox[origin=c]{90}{Seen Fonts}} & \makebox[0.11\linewidth][l]{Source} &   \multirow{9}*{\includegraphics[width=0.89\linewidth]{Figs/exp/vs_sota/Seen_vssota_ori_v2_box.png}}\\
        ...
        % {Figs/exp/vs_sota/Seen_vssota_ori_v2_box_cggan_gid0.png}}\\
...
%         \midrule
% 		\multicolumn{2}{c}{Unseen Fonts} \\
% 		\midrule

        \hline
        % \multirow{9}*{\rotatebox[origin=c]{90}{Unseen Fonts}} & \makebox[0.11\linewidth][l]{Source} &   \multirow{9}*{\includegraphics[width=0.89\linewidth]{Figs/exp/vs_sota/Unseen_vssota_ori_v2_box.png}}\\
        ...
        % {Figs/exp/vs_sota/Unseen_vssota_ori_v2_box_cggan_id136.png}}\\
        &\makebox[0.11\linewidth][l]{FUNIT} & \\
		&\makebox[0.11\linewidth][l]{LF-Font} & \\
        &\makebox[0.11\linewidth][l]{MX-Font} & \\
        &\makebox[0.11\linewidth][l]{Fs-Font} & \\
