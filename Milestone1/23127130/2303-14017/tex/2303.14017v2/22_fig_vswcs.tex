...
% 	\begin{tabular}{@{\hspace{0.0in}}l@{\hspace{0in}}c@{\hspace{0.05in}}c@{\hspace{0.0in}}}
% 		\toprule
% 		& Seen Fonts & Unseen Fonts \\ \cmidrule(r){1-1} \cmidrule(r){2-2} \cmidrule(r){3-3}
% % 		\midrule
%         \makebox[0.08\linewidth][l]{Source} &   \multirow{6}*{\includegraphics[width=0.534\linewidth]{Figs/exp/vs_wcs/seen_vswcs_ori_box.png}} & \multirow{6}*{\includegraphics[width=0.356\linewidth]{Figs/exp/vs_wcs/unseen_vswcs_ori_box.png}}\\
