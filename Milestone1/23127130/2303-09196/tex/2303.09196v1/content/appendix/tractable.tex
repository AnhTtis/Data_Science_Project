...
We review tractable reformulations of the risk measures presented in this work. We also highlight dedicated algorithms from literature, whenever they exist.
...
\begin{theorem} \label{thm:conic-ambiguity}
    ...
    \end{equation}
    denote the ambiguity set with $\rho(X) = \sup_{\mu \in \amb} \<\mu, X\>$ (cf. \cref{eq:ambiguity-representation}).
