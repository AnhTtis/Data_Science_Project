...
\begin{equation}
    \begin{split}
        ...
        & \overline{\Delta_i^t} = -\eta\sum_{k=0}^{K-1}\tilde{\mathbf{g}}^{t,k}(i) \cdot \overline{\alpha_i^t}, \nonumber
    \end{split}
\end{equation}
where 
\begin{equation}
    \begin{split}
        & \alpha_i^t := \min \Big (1, \frac{C}{\eta \|\sum_{k=0}^{K-1}\tilde{\mathbf{g}}^{t,k}(i)\|} \Big), \\
        & \overline{\alpha_i^t} := \frac{1}{M}\sum_{i=1}^{M} \alpha_i^t,\\
        & \tilde{\alpha}^t =\frac{1}{M}\sum_{i=1}^{M} |\alpha_i^t - \overline{\alpha_i^t}|.
    \end{split} \nonumber
\end{equation}
...
\begin{equation}
    \begin{split}
        &\mathbb{E} \Big \langle\nabla f(\mathbf{w}^{t}), \mathbb{E}\frac{1}{M}\sum_{i=1}^M\tilde{\Delta}_i^t-\overline{\Delta}_i^t  \Big \rangle\\
        & \leq\mathbb{E} \Big \langle\nabla f(\mathbf{w}^{t}), \mathbb{E}\frac{1}{M}\sum_{i=1}^M \sum_{k=0}^{K-1}\eta |\alpha_i^t - \overline{\alpha_i^t}|\tilde{\mathbf{g}}^{t,k}(i)\Big \rangle\\
        & \leq \frac{\eta K}{M}\sum_{i=1}^{M}\mathbb{E}|\alpha_i^t - \overline{\alpha_i^t}| \Big \langle \nabla F_i(\mathbf{w}^{t}),\tilde{\mathbf{g}}^{t,k}(i) \Big \rangle\\
        & \overset{a)}{\leq} \frac{\eta K}{M}\sum_{i=1}^{M}\mathbb{E}|\alpha_i^t - \overline{\alpha_i^t}| \Big(-\frac{1}{2}(\|\nabla F_i(\mathbf{w}^{t,k})\|^2+\|F_i(\mathbf{w}^{t,k}+\delta; \xi_i)\|^2)
        + \frac{1}{2} \|\nabla F_i(\mathbf{w}^{t,k}+\delta; \xi_i) - \nabla F_i(\mathbf{w}^{t,k}; \xi_i)\|^2\Big)\\
        & \overset{b)}{\leq}\eta \tilde{\alpha}^t K(\frac{1}{2}L^2\rho^2-B^2),
    \end{split}
\end{equation}
where $\tilde{\alpha}^t =\frac{1}{M}\sum_{i=1}^{M} |\alpha_i^t - \overline{\alpha_i^t}|$, a) uses $\langle a,b \rangle = -\frac{1}{2}\|a\|^2-\frac{1}{2}\|b\|^2 + \frac{1}{2}\|a - b\|^2$ and b) bases on assumption \ref{a1},\ref{a3}.\\
