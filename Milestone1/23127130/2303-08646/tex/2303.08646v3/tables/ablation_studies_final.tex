...
\caption{Ablation studies on the proposed three modules using 
the best configurations found in Tab.~\ref{tab:ablation_cae}-\ref{tab:ablation_upsampling} on Pascal Context dataset.
}
