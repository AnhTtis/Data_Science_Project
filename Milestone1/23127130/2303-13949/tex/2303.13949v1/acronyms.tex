\newpage
\noindent{\bf Acronyms}
{\begin{acronym}[12345678901234]
\acro{(A)ATSR}{one or all of ATSR, ATSR-2 and AATSR}
...
\acro{AMSR-E}{Advanced Microwave Scanning Radiometer - EOS}
...
\acro{ARC}{ATSR Reprocessing for Climate}
...
\acro{CF}{clear fraction}
\acro{CGI}{Common Gateway Interface}
%\acro{CHAP}{\textsmaller{CISL} \ac{HPC} Advisory Panel}
\acro{CHAP}{CISL High Performance Computing Advisory Panel}
...
\acro{COCO}{CCSR Ocean Component model}
...
\acro{DDX}{XML version of the combined DAS and DDS}
...
\acro{ECCO2}{Estimating the Circulation and Climate of the Ocean, Phase II}
...
\acro{EDC}{Environmental Data Connector}
...
\acro{GHRSST-PP}{GODAE High Resolution Sea Surface Temperature Pilot Project}
%{ -- \it  http://www.ghrsst-pp.org}
%\acro{GHRSST-PP}{\acs{GODAE}High Resolution Sea Surface Temperature Pilot Project}
%{ -- \it  http://www.ghrsst-pp.org}
\acro{GINI}{GOES Ingest and NOAA/PORT Interface}
...
\acro{GridFTP}{FTP with GRID enhancements}
...
\acro{HDF-EOS}{Hierarchical Data Format - EOS} %{ -- \it http://hdfeos.gsfc.nasa.gov}
\acro{HEC}{High-End Computing}
\acro{HEALPix}{Hierarchical Equal Area isoLatitude Pixelation}
...
\acro{IDLastro}{IDL Astronomy User's Library}
...
\acro{LLC4320}[LLC4320]{\acl{LLC}4320}
\acro{LLC2160}[LLC2160]{\ac{LLC}2160}
\acro{LLC1080}[LLC1080]{\ac{LLC}1080}
...
\acro{MCR}{MATLAB Component Runtime}
...
\acro{MITgcm}{MIT general circulation model}
...
\acro{NOMADS}{NOAA Operational Model Archive Distribution System}
...
\acro{NSEN}{NASA Science and Engineering Network}
...
\acro{NSPIRES}{NASA Solicitation and Proposal Integrated Review and Evaluation System}
...
\acro{OB.DAAC}{Ocean Biology DAAC}
\acro{ODC}{OPeNDAP Data Connector}
\acro{OC}{ocean color}
\acro{OCAPI}{OPeNDAP C API}
...
\acro{OLFS}{OPeNDAP Lightweight Front-end Server}
...
%{ -- \it http://opendap.org}
\acro{OPeNDAPg}{GRID-enabled OPeNDAP tools}
\acro{OpenGIS}{OpenGIS}
\acro{OSCAR}{Ocean Surface Current Analyses Real-time}
...
\acro{PAE}{Probabilistic AutoEncoder}
...
\acro{RAFOS}{SOFAR, SOund Fixing And Ranging, spelled backward}
\acro{RAID}{Redundant Array of Independent Disks}
\acro{RAL}{Rutherford Appleton Laboratory}
\acro{RAN2}{$2^{nd}$ full-mission reanalysis}
\acro{RAN3}{$3^{rd}$ full-mission reanalysis}
...
\acro{SEEDS}{Strategic Evolution of ESE Data Systems}
...
\acro{SLSTR}{Sea and Land Surface Temperature Radiometer}
...
\acro{SSTa}{sea surface temperature anomaly}
...
\acro{Suomi-NPP}[Suomi-NPP]{Suomi-\acl{NPP}}
...
\acro{TIDI}{TIMED Doppler Interferometer}
...
\acro{TMI}{TRMM Microwave Imager}
