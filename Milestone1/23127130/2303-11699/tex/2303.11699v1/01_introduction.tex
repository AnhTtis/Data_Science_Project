...
information from polycrystalline samples. The diffractograms are an
information-dense fingerprint of the structure of the material. However,
analyzing these diffractograms is not an easy task. Full structure solutions and
...
\citeauthor{vecseiNeuralNetworkBased2019} developed
...
\begin{figure}[h]
\centering
\includegraphics{./figures/distribution_spgs_logscale.pdf}
\caption{Distribution (logarithmic scale, space groups sorted by count) of space
groups in the ICSD database. The population of the space groups varies by
multiple orders of magnitude, showing that the ICSD is a highly imbalanced
dataset regarding space groups.}
...
individual entries in the ICSD database. It is our hypothesis that when trying
...
do not need to be stable or chemically viable. We propose viewing the problem
simply as a mathematical task of getting back some of the real-space information
leading to given powder XRD diffractograms. 
...
distributed computing architecture to build an infinite stream of randomly
