...
space group. Our results verify our hypothesis that crystals forming the
...
Furthermore, instead of generating completely random crystals of all space
groups, one can also generate random crystals of given structure types to solve
