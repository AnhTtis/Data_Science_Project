\subsection{Generating synthetic crystals} \label{sec:generate_crystals} 
    ...
    \begin{enumerate}
        \itemsep0em
        \item Random selection of a space group. We follow the space group distribution of the ICSD to allow comparison with previous work.
        ...
        \item Draw lattice parameters from a KDE based on the ICSD.
    ...
    statistics are visualized with black stripes. Since the exclusion is based on 
    ...
    If a similar performance for all space groups is desired, a
