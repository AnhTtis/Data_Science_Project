...
\begin{enumerate}
    \itemsep0em
    \item Random selection of a space group. We follow the space group distribution of the ICSD to allow comparison with previous work (see Section~2.1 of the paper).
