...
According to the theory of LSH, the distance between two images should be approximately preserved in their hashes, given the same $\displaystyle f_{\mW}$.
...
The normalisation term $\displaystyle d_\text{L} + d_\text{R}$ is found empirically useful, 
as it increases the signal-to-noise ratio of the left-right novelty difference.
