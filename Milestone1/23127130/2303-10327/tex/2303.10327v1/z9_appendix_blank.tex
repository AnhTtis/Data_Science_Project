...
%     \end{pmatrix}
% \end{equation}
% where $u$ is the acceleration and the steering angle output, $I_x, l_r, l_f, C_{Sf}, C_{Sr}, g$ are constant factors, and $\mu$ is the road friction factor. More details can be found in~\cite{althoff2017commonroad}.
...
% We recommend readers to~\cite{choi2022computation} for more details.
