\documentclass[final,12pt]{colt2023} % Anonymized submission
...
\coltauthor{%
 ...
 \addr Univ. Lille, Inria, CNRS, Centrale Lille, UMR 9198-CRIStAL, F-59000 Lille, France
 %\AND
 %\Name{Author Name2} \Email{xyz@sample.com}\\
 %\addr Address 2%
}
...
It is said to be \emph{exponentially consistent} \citep{barrier2022best} if for all $\mu \in \mathcal D$, $\limsup_{T \to +\infty} \rho_{\mu, T}(\mathcal A) < +\infty$. We denote that class $\mathcal C_{ec}$.
