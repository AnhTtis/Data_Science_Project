...
VideoBERT \cite{VideoBERT}  & V & 4.0 & 11.0 & 27.5 & 49 \\
VideoBERT+S3D \cite{VideoBERT} & V & 4.3 & 11.9 & 28.8 & 50 \\
ActBERT \cite{Actbert} & V & 5.4 & 14.3 & 30.6 & 65 \\
AT \cite{AT}& V+S & 9.0 & 17.8 & 36.7 & 112 \\
DPC \cite{DPC}& V+S & 2.8 & 18.1 & - & - \\
VALUE \cite{value} &  V+S & 12.4 & \textbf{18.8} & \textbf{40.4} & 130 \\
Univl \cite{univl} & V+S & 9.5 & 16.3 & 37.4 & 115 \\
MV-GPT \cite{MVC}& V+S & \textbf{13.3} & 17.6  & 35.5 & 103 \\ \hline
TextKG & V+S & 11.7 &18.4 &40.2 &\textbf{133} \\
\bottomrule
\end{tabular}}
\caption{Evaluation results on the YouCookII val subset in the micro-level evaluation mode. ‘V’ indicates the methods use video appearance information, and ‘S’ indicates the methods use the speech information.}
...
LAVENDER \cite{lavender} &V & VidSwin & - & - & - & 60.1 \\
DeCEM \cite{DECEM} & V+S & BERT & 45.2 & 29.7 & 64.7 & 52.3 \\
UniVL \cite{univl} & V+S & S3D & 41.8 & 28.9 & 60.8 & 50.0 \\
MV-GPT \cite{MVC} & V+S & ViViT & 48.9$^*$ & 38.7$^*$ & 64.0 & 60.0\\ \hline
...
\checkmark & \checkmark & \checkmark & & & & 13.9 & {\bf 22.1} & 71.3 & 2.9 \\
\checkmark & \checkmark & \checkmark & \checkmark & & \checkmark & 13.7 & 22.0 & 73.5 & {\bf 2.0} \\
...
\checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & {\bf 14.0} & {\bf 22.1} & {\bf 75.9} & 2.8 \\
\hline
\end{tabular}}
