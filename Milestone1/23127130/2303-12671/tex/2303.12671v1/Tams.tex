...
% 			\small{\emph{Journal of Computer Science and Cybernetics, V.38, N.2 (2022), 1--}} \\
% 			\footnotesize{DOI no 10.15625/1813-9663/37/2/16880}
% 		\end{tabular}
% 	}
...
\keywords{Visual Question Answering; Sequence-to-sequence Learning; Multilingual.}
\end{abstract}

\input{sections/1-introduction.tex}
\input{sections/2-relatedworks.tex}
\input{sections/3-dataset.tex}
...
%\input{sections/final_visualize.tex}
