\begin{table*}[t]
  ...
  & \multicolumn{3}{c|}{$\reporder=1$ (0.023 sec./it.)}
  & \multicolumn{3}{c|}{$\reporder=2$ (0.034 sec./it.)}
  & \multicolumn{3}{c|}{$\reporder=3$ (0.043 sec./it.)}
  & \multicolumn{3}{c|}{$\reporder=4$ (0.052 sec./it.)}
  &  \\
