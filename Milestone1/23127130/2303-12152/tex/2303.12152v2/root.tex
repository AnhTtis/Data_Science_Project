...
\vskip -0.2 true in
    ...
    \includegraphics[width=0.8\columnwidth]{lampos.png}
    \vskip -0.1 true in
    {\small{
...
\begin{figure}[!h]
 ...
 \vskip -0.2 true in
   ...
   %  \input{OA.png}%
   % }
   \includegraphics[width=0.7\columnwidth]{OA.png}
    \vskip -0.2 true in
    {\small{
...
\vskip -0.1 true in
    ...
    % \resizebox{0.34\textwidth}{!}{\input{Solution_times.tikz}}
    \includegraphics[width=0.7\columnwidth]{solve_times_N20.png}
    \vskip -0.15 true in
...
\vskip -0.1 true in
    \centering
    % \resizebox{0.9\columnwidth}{!}{\input{Solution_times.tikz}}
    % \resizebox{0.34\textwidth}{!}{\input{Solution_timesN40.tikz}}
    \includegraphics[width=0.68\columnwidth]{solve_times_N40.png}
    \vskip -0.15 true in
