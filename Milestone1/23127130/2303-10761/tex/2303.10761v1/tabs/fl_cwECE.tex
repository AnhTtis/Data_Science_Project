...
\toprule
     Dataset &            Model &    CE &  FL 1 &                   FL 2 &                   FL 3 & LS 0.05 \\
\midrule
...
\caption{cwECE, \% -- Classwise Expected Calibration Error (lower is better), 15 bins without post-processing, columns correspond to different loss functions}
\label{tab:fl:cwECE}
% \end{table}
