...
Notably, `smoothed-MalConv' also offers clean accuracy that is comparable to and often higher than the original MalConv, indicating a much better solution balancing performance and robustness. 
