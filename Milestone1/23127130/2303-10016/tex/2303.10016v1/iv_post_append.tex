...
\begin{align}
\hat{\beta}_1 &= \frac{\sum_{i=1}^nw_i(y_i-\bar{y}_w)(x_i - \bar{x}_w)}{\sum_{i=1}^nw_i(x_i - \bar{x}_w)^2}\label{eq:beta_1}\\ 
\hat{\beta}_0 &= \bar{y}_w  - \hat{\beta}_1\bar{x}_w \nonumber
\end{align}
where $\bar{y}_w = \sum_{i=1}^nw_iy_i/\sum_{i=1}^nw_i$ and $\bar{x}_w$ is defined analogously.
...
Then our estimate for coefficient for $Z$ is $\hat{\beta}_{1, S1} =\widehat{f}_{PS}$ and for the intercept it is $\hat{\beta}_{0, S1} =\bar{D}_w^{obs}(0)$.
The predicted values from this model are $D^{\text{pred}}_i = Z_i\bar{D}_w^{obs}(1) + (1-Z_i)\bar{D}_w^{obs}(0)$.
\end{result}
...
\begin{align*}
\bar{Z}_w &= \sum_{i=1}^nw_iZ_i/\sum_{i=1}^nw_i \\
...
\begin{align*}
\bar{D}_w &= \sum_{i=1}^nw_iD_i/\sum_{i=1}^nw_i \\
&=\frac{1}{N} \sum_{g=1}^G\sum_{i:s_i = g}\left[Z_iD_i(1)\frac{N_{g}}{N_{g,1}}\frac{n_1}{N} + (1-Z_i)D_i(0)\frac{N_{g}}{N_{g,0}}\frac{n_0}{N}\right]\\
&=\frac{1}{N} \sum_{g=1}^G\left[\bar{D}_g^{obs}(1)N_{g}\frac{n_1}{N} + \bar{D}_g^{obs}(0)N_{g}\frac{n_0}{N}\right]\\
&=\frac{n_1}{N}\bar{D}_w^{obs}(1) + \frac{n_0}{N}\bar{D}_w^{obs}(0),
\end{align*}
where $\bar{D}_w^{obs}(z) = \sum_{g=1}^G\frac{N_g}{N}\bar{D}_g^{obs}(z)$ for $z \in \{0,1\}$.


Then for the denominator of $\hat{\beta}_{1, S1}$, following Equation~(\ref{eq:beta_1}), we have
\begin{align*}
\sum_{i=1}^nw_i(Z_i - \bar{Z}_w)^2 &=  \sum_{g=1}^G\sum_{i:s_i = g}\Big[Z_i\frac{N_{g}}{N_{g,1}}\frac{n_1}{N} \left(1 - n_1/N\right)^2 + (1-Z_i)\frac{N_{g}}{N_{g,0}}\frac{n_0}{N} \left( -  n_1/N\right)^2\Big]\\
...
\begin{align*}
&\sum_{i=1}^nw_i(D_i - \bar{D}_w)(Z_i - \bar{Z}_w)\\
 &=  \sum_{g=1}^G\sum_{i:s_i = g}\Big[Z_i\frac{N_{g}}{N_{g,1}}\frac{n_1}{N} \left(D_i(1) - \frac{n_1}{N}\bar{D}_w^{obs}(1) - \frac{n_0}{N}\bar{D}_w^{obs}(0)\right)\left(1 - n_1/N\right) \\
&\qquad \qquad  \qquad+ (1-Z_i)\frac{N_{g}}{N_{g,0}}\frac{n_0}{N} \left(D_i(0) - \frac{n_1}{N}\bar{D}_w^{obs}(1) - \frac{n_0}{N}\bar{D}_w^{obs}(0)\right)\left( -  n_1/N\right)\Big]\\
&= \frac{n_1n_0}{N^2} \sum_{g=1}^GN_g\sum_{i:s_i = g}\Big[\frac{Z_i}{N_{g,1}} \left(D_i(1) - \frac{n_1}{N}\bar{D}_w^{obs}(1) - \frac{n_0}{N}\bar{D}_w^{obs}(0)\right)\\
&\qquad \qquad  \qquad  \qquad  \qquad - \frac{1-Z_i}{N_{g,0}} \left(D_i(0) - \frac{n_1}{N}\bar{D}_w^{obs}(1) - \frac{n_0}{N}\bar{D}_w^{obs}(0)\right)\Big]\\
&= \frac{n_1n_0}{N^2} \sum_{g=1}^GN_g\Big[ \bar{D}_g^{obs}(1) - \frac{n_1}{N}\bar{D}_w^{obs}(1) - \frac{n_0}{N}\bar{D}_w^{obs}(0)- \bar{D}_g^{obs}(0) + \frac{n_1}{N}\bar{D}_w^{obs}(1) + \frac{n_0}{N}\bar{D}_w^{obs}(0)\Big]\\
&= \frac{n_1n_0}{N^2} \sum_{g=1}^GN_g\Big[ \bar{D}_g^{obs}(1) - \bar{D}_g^{obs}(0) \Big]\\
...
The intercept is 
\[\hat{\beta}_0 =\frac{n_1}{N}\bar{D}_w^{obs}(1) + \frac{n_0}{N}\bar{D}_w^{obs}(0) - \frac{n_1}{N}\widehat{f}_{PS} =\bar{D}_w^{obs}(0) .\]

The predicted values are 
\[{D}^{\text{pred}}_i = Z_i\widehat{f}_{PS} +\bar{D}_w^{obs}(0) = Z_i\bar{D}_w^{obs}(1) + (1-Z_i)\bar{D}_w^{obs}(0). \]
...
\begin{proof}
Following the same logic we used to find $\bar{D}_w$, the weighted mean for the outcomes is
\begin{align*}
\bar{Y}_w 
&=\frac{n_1}{N}\bar{Y}_w^{obs}(1) + \frac{n_0}{N}\bar{Y}_w^{obs}(0),
\end{align*}
where $\bar{Y}_w^{obs}(z) = \sum_{g=1}^G\frac{N_g}{N}\bar{Y}_g^{obs}(z)$ for $z \in \{0,1\}$.

For the predicted uptake, the weighted mean is
\begin{align*}
\bar{D}_w^{pred}
&=\frac{n_1}{N}\bar{D}_w^{obs}(1) + \frac{n_0}{N}\bar{D}_w^{obs}(0) = \bar{D}_w.
\end{align*}


Using Equation~(\ref{eq:beta_1}), the denominator of $\hat{\beta}_{1, S2}$ is
\begin{align*}
&\sum_{i=1}^nw_i(D_i^{pred} - \bar{D}_w)^2 \\
&=  \sum_{g=1}^G\sum_{i:s_i = g}\Big[Z_i\frac{N_{g}}{N_{g,1}}\frac{n_1}{N} \left(\bar{D}_w^{obs}(1) - \frac{n_1}{N}\bar{D}_w^{obs}(1) - \frac{n_0}{N}\bar{D}_w^{obs}(0)\right)^2\\
& \qquad \qquad \qquad  + (1-Z_i)\frac{N_{g}}{N_{g,0}}\frac{n_0}{N} \left(\bar{D}_w^{obs}(0) - \frac{n_1}{N}\bar{D}_w^{obs}(1) - \frac{n_0}{N}\bar{D}_w^{obs}(0)\right)^2\Big]\\
&=  \sum_{g=1}^G\sum_{i:s_i = g}\Big[Z_i\frac{N_{g}}{N_{g,1}}\frac{n_1}{N}\frac{n_0^2}{N^2} \left(\bar{D}_w^{obs}(1) - \bar{D}_w^{obs}(0)\right)^2  + (1-Z_i)\frac{N_{g}}{N_{g,0}}\frac{n_0}{N}\frac{n_1^2}{N^2} \left(\bar{D}_w^{obs}(1) - \bar{D}_w^{obs}(0)\right)^2\Big]\\
&=  \frac{n_1n_0}{N} \left(\bar{D}_w^{obs}(1) - \bar{D}_w^{obs}(0)\right)^2\\
& = \frac{n_1n_0}{N}\widehat{f}_{PS}^2.
\end{align*}

For the numerator we have
\begin{align*}
&\sum_{i=1}^nw_i(D_i^{pred} - \bar{D}_w)(Y_i - \bar{Y}_w) \\
&=  \sum_{g=1}^G\sum_{i:s_i = g}\Big[Z_i\frac{N_{g}}{N_{g,1}}\frac{n_1}{N}\frac{n_0}{N} \left(\bar{D}_w^{obs}(1) - \bar{D}_w^{obs}(0)\right)\left(Y_i(1) - \frac{n_1}{N}\bar{Y}_w^{obs}(1) - \frac{n_0}{N}\bar{Y}_w^{obs}(0)\right) \\
& \qquad \qquad \qquad  - (1-Z_i)\frac{N_{g}}{N_{g,0}}\frac{n_0}{N}\frac{n_1}{N} \left(\bar{D}_w^{obs}(1) - \bar{D}_w^{obs}(0)\right)\left(Y_i(0) - \frac{n_1}{N}\bar{Y}_w^{obs}(1) - \frac{n_0}{N}\bar{Y}_w^{obs}(0)\right)\Big]\\
&= \frac{n_1n_0}{N^2}\widehat{f}_{PS} \sum_{g=1}^GN_g\sum_{i:s_i = g}\Big[\frac{Z_i}{N_{g,1}}\left(Y_i(1) - \frac{n_1}{N}\bar{Y}_w^{obs}(1) - \frac{n_0}{N}\bar{Y}_w^{obs}(0)\right)\\
& \qquad \qquad \qquad  \qquad \qquad \qquad \qquad  - \frac{1-Z_i}{N_{g,0}}\left(Y_i(0) - \frac{n_1}{N}\bar{Y}_w^{obs}(1) - \frac{n_0}{N}\bar{Y}_w^{obs}(0)\right)\Big]\\
&= \frac{n_1n_0}{N^2}\widehat{f}_{PS} \sum_{g=1}^GN_g\Big[\left(\bar{Y}_g^{obs}(1) - \frac{n_1}{N}\bar{Y}_w^{obs}(1) - \frac{n_0}{N}\bar{Y}_w^{obs}(0)\right) - \left(\bar{Y}_g^{obs}(0) - \frac{n_1}{N}\bar{Y}_w^{obs}(1) - \frac{n_0}{N}\bar{Y}_w^{obs}(0)\right)\Big]\\
&= \frac{n_1n_0}{N^2}\widehat{f}_{PS} \sum_{g=1}^GN_g\Big[\bar{Y}_g^{obs}(1) - \bar{Y}_g^{obs}(0)\Big]\\
...
Define $c_g(z) =\max_{1 \leq i \leq N} \frac{N^2}{N_g^2}W_i(g)\left(Y_i(z) - \bar{Y}_g(z)\right)^2$,
\[v(z) = \frac{1}{N-1}\sum_{g=1}^G\sum_{i:s_i=g}\left(Y_i(z) - \bar{Y}_g(z)\right)^2,\]
and
\[v(01)= \frac{1}{N-1}\sum_{g=1}^G\sum_{i:s_i=g}\left(Y_i(1) - Y_i(0) -\left[ \bar{Y}_g(1) - \bar{Y}_g(0) \right]\right)^2\]
As $N \to \infty$
...
If we have Assumptions \ref{assump:iv} (Part 1), \ref{assump:strata_prop}, \ref{assump:li_ding_cond_main}, and \ref{assump:clt_cond2_main} then by results from \cite{poststrat_clt},
\begin{align*}
...
If we have Assumptions~\ref{assump:iv} (Part 1), \ref{assump:strata_prop} and \ref{assump:clt_cond_d} 
then by results from \cite{poststrat_clt},
\begin{align*}
...
First let $\bar{Y}_c(z)$ be the average potential outcome under treatment $z$ among compliers.
Similarly, let $\bar{Y}_n(z)$ be the average potential outcome under treatment $z$ among noncompliers (never-takers) and note that $\bar{Y}_n(1)=\bar{Y}_n(0) = \bar{Y}_n$.
Let $\widehat{\bar{Y}}_c(z)$ and $\widehat{\bar{Y}}_n(z)$ be the corresponding estimates we would get based on treatment assignment if we could observe who is a complier or noncomplier.
Then we can write
\begin{align*}
\widehat{\ITT} &= \bar{Y}^{\text{obs}}(1) -  \bar{Y}^{\text{obs}}(0)\\
&= \hat{f}\widehat{\bar{Y}}_c(1) + (1-\hat{f})\widehat{\bar{Y}}_n(1) -\frac{n_c - n_1\hat{f}}{n_0}\widehat{\bar{Y}}_c(0) -\frac{n_0 - n_c + n_1\hat{f}}{n_0}\widehat{\bar{Y}}_n(0)\\
&=\hat{f}\left(\widehat{\bar{Y}}_c(1) - \widehat{\bar{Y}}_n +\frac{n_1}{n_0}\widehat{\bar{Y}}_c(0) - \frac{n_1}{n_0}\widehat{\bar{Y}}_n\right)
+\left(\widehat{\bar{Y}}_n - \frac{n_c}{n_0}\widehat{\bar{Y}}_c(0) - \frac{n_0 - n_c}{n_0}\widehat{\bar{Y}}_n\right)\\
&=\hat{f}\left(\widehat{\bar{Y}}_c(1)  +\frac{n_1}{n_0}\widehat{\bar{Y}}_c(0) - \frac{N}{n_0}\widehat{\bar{Y}}_n\right)
+\left( - \frac{n_c}{n_0}\widehat{\bar{Y}}_c(0) + \frac{n_c}{n_0}\widehat{\bar{Y}}_n\right)
\end{align*}

Therefore,
\begin{align*}
E\left[\widehat{\CACE}\right] &= E\left[E\left[\frac{\widehat{\ITT}}{\hat{f}}|\hat{f}\right]\right]\\
&= E\left[\left(\widehat{\bar{Y}}_c(1)  +\frac{n_1}{n_0}\widehat{\bar{Y}}_c(0) - \frac{N}{n_0}\widehat{\bar{Y}}_n\right) + \frac{1}{\hat{f}}E\left[ - \frac{n_c}{n_0}\widehat{\bar{Y}}_c(0) + \frac{n_c}{n_0}\widehat{\bar{Y}}_n|\hat{f}\right]\right]\\
&= \left(\bar{Y}_c(1)  +\frac{n_1}{n_0}\bar{Y}_c(0)  - \frac{N}{n_0}\bar{Y}_n\right) +E\left[ \frac{1}{\hat{f}}\right]\left( - \frac{n_c}{n_0}\bar{Y}_c(0) + \frac{ n_c}{n_0}\bar{Y}_n\right)\\
&= \bar{Y}_c(1) -\left( \frac{N}{n_0} - E\left[ \frac{1}{\hat{f}}\right]\frac{E[\hat{f}]N}{n_0}\right)\bar{Y}_n - \left(E\left[ \frac{1}{\hat{f}}\right]\frac{E[\hat{f}]N}{n_0} - \frac{n_1}{n_0}\right)\bar{Y}_c(0)\\
&= \bar{Y}_c(1) -\frac{1}{1-p}\left(1  - E\left[ \frac{1}{\hat{f}}\right]E[\hat{f}]\right)\bar{Y}_n - \frac{1}{1-p}\left(E\left[ \frac{1}{\hat{f}}\right]E[\hat{f}] - p\right)\bar{Y}_c(0)\\
\end{align*}

The bias of $\widehat{\CACE}_{\text{IV}}$ is then
\begin{align*}
E\left[\widehat{\CACE}_{\text{IV}}\right] - \CACE &=  -\frac{1}{1-p}\left(1  - E\left[ \frac{1}{\hat{f}}\right]E[\hat{f}]\right)\bar{Y}_n - \frac{1}{1-p}\left(E\left[ \frac{1}{\hat{f}}\right]E[\hat{f}] - 1\right)\bar{Y}_c(0)\\
&=  \frac{1}{1-p}\left(1  - E\left[\frac{1}{ \hat{f}}\right]E[\hat{f}]\right)\left( \bar{Y}_c(0)-\bar{Y}_n\right)
\end{align*}
...
&E\left[\widehat{\CACE}_{\text{IV}}\right] - \CACE\\
 &=  \frac{1}{1-p}\left(1  - E\left[\frac{1}{ \hat{f}}\right]E[\hat{f}]\right)\left( \bar{Y}_c(0)-\bar{Y}_n\right)\\
&\approx - \frac{\left( \bar{Y}_c(0)-\bar{Y}_n\right)}{1-p} \frac{\text{var}(\hat{f})}{\pi_c}\left[1 - \frac{1}{\pi_c^2}\frac{(1-2\pi_c)(1-2p)}{N-2}+ \frac{1}{\pi_c^3}c_1\right]\\
\end{align*}
...
\begin{align*}
\text{var}(\hat{f}) &= \frac{1}{pN}\frac{1}{N-1}\sum_{i=1}^N(D_i(1) - \bar{D}(1))^2 + \frac{1}{(1-p)N}\frac{1}{N-1}\sum_{i=1}^N(D_i(0) - \bar{D}(0))^2\\
&  \quad - \frac{1}{N}\frac{1}{N-1}\sum_{i=1}^N(D_i(1) - D_i(0) - \bar{D}(1) +\bar{D}(0))^2 \\
...
\begin{align*}
\text{Cov}(\widehat{\ITT}, \hat{f}) &= \underbrace{\frac{1}{Np}\frac{1}{N-1}\sum_{i=1}^N(Y_i(1) - \bar{Y}(1))(D_i(1)-\bar{D}(1))}_{\text{A}}\\
&\quad  + \underbrace{\frac{1}{N(1-p)}\frac{1}{N-1}\sum_{i=1}^N(Y_i(0)-\bar{Y}(0))(D_i(0)-\bar{D}(0))}_{\text{B}}\\
&\quad  - \underbrace{ \frac{1}{N}\frac{1}{N-1}\sum_{i=1}^N(Y_i(1) - Y_i(0)-\ITT)(D_i(1)  - D_i(0) - \pi_c)}_{\text{C}}
\end{align*}

First we have for A,
\begin{align*}
\text{A} &= \frac{1}{Np}\frac{1}{N-1}\Big[\pi_n\sum_{i: D_i(1) = 1, D_i(0)=0}(Y_i(1) - \bar{Y}(1)) + \pi_n\sum_{i: D_i(1) = 1, D_i(0)=1}(Y_i(1) - \bar{Y}(1))\\
&\qquad  \qquad \qquad   - (\pi_c + \pi_a)\sum_{i: D_i(1) = 0, D_i(0)=0}(Y_i(1) - \bar{Y}(1))\Big]\\
&= \frac{1}{Np}\frac{1}{N-1}\Big[\pi_nn_c(\bar{Y}_c(1) - \bar{Y}(1)) + \pi_nn_a(\bar{Y}_a(1) - \bar{Y}(1))  - (\pi_c + \pi_a)n_n(\bar{Y}_n(0) - \bar{Y}(1))\Big]\\
&= \frac{\pi_n}{p(N-1)}\Big[\pi_c(\bar{Y}_c(1) - \bar{Y}(1)) + \pi_a(\bar{Y}_a(1) - \bar{Y}(1))  - (\pi_c + \pi_a)(\bar{Y}_n(0) - \bar{Y}(1))\Big]\\
&= \frac{\pi_n}{p(N-1)}\Big[\pi_c(\bar{Y}_c(1) - \bar{Y}_n(0)) + \pi_a(\bar{Y}_a(1) - \bar{Y}_n(0))\Big].
\end{align*}

We can get a similar simplification for B:
\begin{align*}
\text{B} &= \frac{\pi_a}{(1-p)(N-1)}\left[\pi_c(\bar{Y}_a(1) - \bar{Y}_c(0)) + \pi_n(\bar{Y}_a(1) - \bar{Y}_n(0))\right].
\end{align*}
...
\begin{align*}
\text{Cov}(\widehat{\ITT}, \hat{f}) &= \frac{\pi_n}{p(N-1)}\Big[\pi_c(\bar{Y}_c(1) - \bar{Y}_n(0)) + \pi_a(\bar{Y}_a(1) - \bar{Y}_n(0))\Big]\\
&\quad + \frac{\pi_a}{(1-p)(N-1)}\left[\pi_c(\bar{Y}_a(1) - \bar{Y}_c(0)) + \pi_n(\bar{Y}_a(1) - \bar{Y}_n(0))\right]\\
&\quad  - \frac{\pi_c(1-\pi_c)}{N-1}\CACE\\
&= \frac{\pi_n\pi_c}{p(N-1)}(\bar{Y}_c(1) - \bar{Y}_n(0)) + \frac{\pi_n\pi_a}{p(1-p)(N-1)}(\bar{Y}_a(1) - \bar{Y}_n(0))\\
&\quad + \frac{\pi_a\pi_c}{(1-p)(N-1)}(\bar{Y}_a(1) - \bar{Y}_c(0)) - \frac{\pi_c(1-\pi_c)}{N-1}\CACE
\end{align*}
...
&\quad - \frac{1}{\pi_c^2}\Big[\frac{\pi_n\pi_c}{p(N-1)}(\bar{Y}_c(1) - \bar{Y}_n(0)) + \frac{\pi_n\pi_a}{p(1-p)(N-1)}(\bar{Y}_a(1) - \bar{Y}_n(0))\\
&\qquad \qquad + \frac{\pi_a\pi_c}{(1-p)(N-1)}(\bar{Y}_a(1) - \bar{Y}_c(0)) - \frac{\pi_c(1-\pi_c)}{N-1}\CACE\Big]\\
& = \frac{\CACE}{\pi_c^2}\left[\frac{1}{N-1}\left(\frac{\pi_n(1-\pi_n)}{p} + \frac{\pi_a(1-\pi_a)}{1-p} \right)\right] \\
&\quad - \frac{1}{\pi_c^2}\Big[\frac{\pi_n\pi_c}{p(N-1)}(\bar{Y}_c(1) - \bar{Y}_n(0)) + \frac{\pi_n\pi_a}{p(1-p)(N-1)}(\bar{Y}_a(1) - \bar{Y}_n(0))\\
&\qquad \qquad + \frac{\pi_a\pi_c}{(1-p)(N-1)}(\bar{Y}_a(1) - \bar{Y}_c(0))\Big]\\
& = \frac{1}{\pi_c^2(N-1)}\Bigg[\left(\frac{\pi_n(\pi_a + \pi_c)}{p} + \frac{\pi_a(\pi_n + \pi_c)}{1-p} \right)(\bar{Y}_c(1) - \bar{Y}_c(0)) \\
&\quad - \Big[\frac{\pi_n\pi_c}{p}(\bar{Y}_c(1) - \bar{Y}_n(0)) + \frac{\pi_n\pi_a}{p(1-p)}(\bar{Y}_a(1) - \bar{Y}_n(0)) + \frac{\pi_a\pi_c}{1-p}(\bar{Y}_a(1) - \bar{Y}_c(0))\Big]\Bigg]\\
& = \frac{1}{\pi_c^2(N-1)}\Bigg[ \frac{\pi_n\pi_c}{p}(\bar{Y}_c(1) - \bar{Y}_c(0) - \bar{Y}_c(1) + \bar{Y}_n(0)) + \frac{\pi_a\pi_c}{1-p}(\bar{Y}_c(1) - \bar{Y}_c(0) -\bar{Y}_a(1) +\bar{Y}_c(0))\\
& \qquad \qquad+ \left(\frac{\pi_n\pi_a}{p} + \frac{\pi_a\pi_n}{1-p} \right)(\bar{Y}_c(1) - \bar{Y}_c(0))- \frac{\pi_n\pi_a}{p(1-p)}(\bar{Y}_a(1) - \bar{Y}_n(0)) \Bigg]\\
& = \frac{1}{\pi_c^2(N-1)}\Bigg[ \frac{\pi_n\pi_c}{p}(\bar{Y}_n(0) - \bar{Y}_c(0)) + \frac{\pi_a\pi_c}{1-p}(\bar{Y}_c(1) -\bar{Y}_a(1) )\\
& \qquad \qquad+ \frac{\pi_n\pi_a}{p(1-p)}(\bar{Y}_c(1) - \bar{Y}_c(0)  - \bar{Y}_a(1) +  \bar{Y}_n(0)) \Bigg]\\
...
Our simulations are for one-sided noncompliance in general.
...
We wanted to investigate whether the uncertainty of the stratified standard error estimators is generally lower, relative to the corresponding true standard error, as compared to the unstratified estimator.
...
\begin{figure}[hbt]
\center
  \includegraphics{figures/se_instability_plot_pool.pdf}
...
We were surprised to see benefits to post-stratification when stratifying on a variable that is neither predictive of compliance status or outcome.
