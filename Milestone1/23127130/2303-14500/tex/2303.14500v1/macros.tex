...
\usepackage{verbatim}
%\usepackage{psfig}
%\usepackage{cite} //by Jianjun (20210106)
\usepackage{url}
\usepackage{color}
\usepackage{alltt}
...
%\newcommand{\Small}[1]{{\small{#1}}} by Jianjun zhao (20210106)
...
%\newtheorem{definition}{Definition} by Jianjun (20210106)
%\newtheorem{theorem}[definition]{Theorem} by Jianjun (20210106)
