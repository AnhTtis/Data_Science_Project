%\documentclass[aps,prd,twocolumn, superscriptaddress]{revtex4} %showpacs,
%\usepackage[utf8]{inputenc}% Include encoding 
%\usepackage{graphicx}% Include figure files 
%\usepackage{dcolumn}% Align table columns on decimal point 
%\usepackage{bm}% bold math 

%\begin{document}
%\title{DUNE Interim Design Report (IDR) Author List - alphabetical - November 2022}
%\title{Authors}
%----------------------------------------------------
...
\newcommand{\Eotvos}{E\"otv\"os Lor{\'a}nd University, 1053 Budapest, Hungary}
...
\author{P.\ Barham~Alzás} \affiliation{\CERN}
...
\author{V.~Bisignani} \affiliation{\INFNNapoli}
...
\author{J.~C.~Carceller} \affiliation{\UniversityCollegeLondon}
...
\author{A.~Hadef} \affiliation{\Mainz}
...
\author{Y.~Nagai} \affiliation{\Eotvos}
...
\author{E.~Renner} \affiliation{\LosAlmos}
...
\author{E.~Romeo} \affiliation{\INFNNapoli}
...
\author{N.~Tata} \affiliation{\Harvard}
...
\author{D.~Vannerom} \affiliation{\Massinsttech}
