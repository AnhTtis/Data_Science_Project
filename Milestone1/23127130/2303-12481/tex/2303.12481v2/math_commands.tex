...
\newcommand{\orig}[1]{{\color[HTML]{AF1E1E} #1}}
\newcommand{\ind}[1]{{\color[HTML]{00D59D} #1}}
\newcommand{\labs}[1]{{\color[HTML]{3492C7} #1}}
\newcommand{\nearopt}[1]{{\color[HTML]{BF9907} #1}}
\newcommand{\gray}[1]{{\color{gray} #1}}
\newcommand{\nopi}[1]{#1}

\usepackage[textsize=tiny]{todonotes}
\newcommand{\ali}[1]{{\color{olive} \textbf{ali}: #1}}
