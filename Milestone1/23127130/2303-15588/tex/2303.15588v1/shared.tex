...
\title{Square Root {LASSO}: well-posedness,
  Lipschitz stability and the tuning trade off\thanks{\today\funding{The first author was partially supported by a postdoc stipend from the Centre de Recherche Mathématiques (CRM) as well as the Institut de valorisation des données (IVADO) and NSERC. The second author acknowledges the support of NSERC through grant RGPIN-2020-06766, the Faculty of Arts and Science of Concordia University and the CRM. The third author was partially supported by the NSERC discovery grant RGPIN-2017-04035.}}}
