...
\iffullversion
	\hideLIPIcs
\else
	\relatedversiondetails[linktext={arXiv:\arxivID}, cite=BauerLenzenEtAl:2023]{Full Version}{https://arxiv.org/pdf/\arxivID.pdf} %linktext and cite
	\usepackage{xr-hyper}
	\begin{filecontents}[overwrite]{fullversion.aux}
		\relax
		...
		\newlabel{tab:results vectors}{{2}{18}{Same as \cref {tab:results compact}, but with matrices in vector format. \relax }{table.caption.14}{}}
		\newlabel{tab:results vectors@cref}{{[appendix-table][2][2147483647]2}{[1][18][]18}}
		\newlabel{rmk:minimization}{{23}{18}{Minimization}{theorem.23}{}}
		\newlabel{rmk:minimization@cref}{{[appendix-remark][23][2147483647]23}{[1][18][]18}}
		\newlabel{eq:minimize}{{7}{18}{Minimization}{equation.A.7}{}}
		\newlabel{eq:minimize@cref}{{[equation][7][2147483647]7}{[1][18][]18}}
		\newlabel{tab:cochain complex chunk}{{3}{19}{Cochain complex chunk preprocessing is faster than chunk preprocessing if implemented with heap-based matrices. Speedup is the run time of homology with chunk preprocessing (see \cref {tab:results compact,tab:results vectors}), divided by the run time of homology with cochain complex chunk preprocessing. \relax }{table.caption.15}{}}
		\newlabel{tab:cochain complex chunk@cref}{{[appendix-table][3][2147483647]3}{[1][18][]19}}
		\newlabel{rmk:run time loops}{{24}{20}{run time of the loops in \cref {alg:bigraded reduction}}{theorem.24}{}}
		\newlabel{rmk:run time loops@cref}{{[appendix-remark][24][2147483647]24}{[1][20][]20}}
		\newlabel{algo:1D persistence clearing}{{3}{20}{Other algorithms}{algocf.3}{}}
		\newlabel{algo:1D persistence clearing@cref}{{[appendix-algocf][3][2147483647]3}{[1][20][]20}}
		\newlabel{alg:lw-algorithm}{{4}{21}{Other algorithms}{algocf.4}{}}
		\newlabel{alg:lw-algorithm@cref}{{[appendix-algocf][4][2147483647]4}{[1][20][]21}}
		\newlabel{alg:ker-mgs}{{5}{21}{Other algorithms}{algocf.5}{}}
		\newlabel{alg:ker-mgs@cref}{{[appendix-algocf][5][2147483647]5}{[1][21][]21}}
		\newlabel{algo:minimize}{{6}{22}{Other algorithms}{algocf.6}{}}
		\newlabel{algo:minimize@cref}{{[appendix-algocf][6][2147483647]6}{[1][21][]22}}
		\newlabel{algo:chain-chunk}{{7}{22}{Other algorithms}{algocf.7}{}}
		\newlabel{algo:chain-chunk@cref}{{[appendix-algocf][7][2147483647]7}{[1][22][]22}}
		\newlabel{algo:cochain-chunk}{{8}{22}{Other algorithms}{algocf.8}{}}
		\newlabel{algo:cochain-chunk@cref}{{[appendix-algocf][8][2147483647]8}{[1][22][]22}}
		\newlabel{algo:factorize}{{9}{22}{Other algorithms}{algocf.9}{}}
		\newlabel{algo:factorize@cref}{{[appendix-algocf][9][2147483647]9}{[1][22][]22}}
		\newlabel{algo:sparsification}{{10}{23}{Other algorithms}{algocf.10}{}}
		\newlabel{algo:sparsification@cref}{{[appendix-algocf][10][2147483647]10}{[1][22][]23}}
	\end{filecontents}
	\externaldocument{fullversion}[https://arxiv.org/pdf/2303.11193.pdf] % this uses the fullversion.aux provided with the submission
\fi
...
We have run our code on a MacBook Pro 2017 with a 2.3 GHz Dual-Core Intel Core i5 and 16GB RAM.
...
\begin{table}
	...
	\begin{tabular}{rr|rrrr|rrr}
		\toprule
		$d$ & sample & chunk   & $H_d$  & sum     & RSS        & $H^{d+2}$ & RSS       & speedup \\ \midrule
