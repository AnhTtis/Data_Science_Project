...
% \mlsystitlerunning{Think Before You Optimize: an Evaluation of Memory Optimization Strategies for Model Training}
\newcommand{\tool}{\textsc{Papaya}\xspace}

\input{macros.tex}

\usepackage{amsmath} % lily
\usepackage{multirow} % lily
\usepackage{inconsolata}

\begin{document}

\twocolumn[
\mlsystitle{What is the state of memory saving for model training?}
...
\mlsysauthor{Xiaoxuan Liu}{ucb}
\mlsysauthor{Siddharth Jha}{ucb}
\mlsysauthor{Chuyan Zhu}{ucb}
% \mlsysauthor{Jialun Lyu}{ucb}
\mlsysauthor{Zhuohan Li}{ucb}
% \mlsysauthor{Xiaoyong Liu}{alibaba}
% \mlsysauthor{Daniel Kang}{ucb}
\mlsysauthor{Alvin Cheung}{ucb}
\end{mlsysauthorlist}

\mlsysaffiliation{ucb}{EECS, UC Berkeley}
% \mlsysaffiliation{alibaba}{Alibaba Inc}


\mlsyscorrespondingauthor{Xiaoxuan Liu}{xiaoxuan\_liu@berkeley.edu}
