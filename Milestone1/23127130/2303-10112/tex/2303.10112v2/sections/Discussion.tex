...
% \subsubsection{Extension causal discovery towards amortized and supervised paradigms (to edit)}
% \subsection{New Paradigm of (Temporal) Causal Discovering}
...
\label{subsection:causal_rep} %这里是章节的标签，引用时需要
...
% 是否可以被称作 unsupervised ?
% 对应另外一条line上的工作的semi/self-supervised ?
...
% CausalRepresentation/nontemp/icml/LocatelloPRSBT20 : multiple views
% CausalRepresentation/iVAE_nontemp/aistats/KhemakhemKMH20: auxiliary variables
% DBLP:conf/aistats/HyvarinenM17: Temporal structure, PCL


% 先说another line, 重点data augmentation & intervention
% 再说von的那篇工作
% 再说temporal setting
% 主讲CITRIS, 顺带提iCITRIS
