...
% % 思考：列表的时候是否还需要分一个field栏目？
% \begin{table}[t]
%     \centering
%     \caption{Some examples of the temporal dataset.}
%     \label{tab:example_dataset}
%     \tiny % 暂时先采用此size  \small  \footnotesize
%     \begin{tabular}{c|c|c|c}   % Data sets |  Data paradigm  |  Descriptions     % 不确定用data paradigm来形容 MTS 与 event stream是否合适？
%         \toprule
%         Data paradigm & Data sets & Fields & Descriptions \\
%         \midrule
%         \multirow{2}{*}{MTS}
%         & Lorenz-96 & Synthetic & ... \\
%         & Linear VAR & Synthetic & ... \\
%         & CMU MoCap & Physics & ... \\
        
%         & Stock returns \cite{Discussion/Nonstation_hetero2/jmlr/Huang0ZRSGS20} & Finance & Daily dividend adjusted closing prices of 10 major stocks from HK and US, spanning 4 years \\     % Description见a review and roadmap，后续相关数据集找到得多的话就可以多列列参考文献，并把description给得模糊一点
%         & fMRI & * & * \\      % Description见a review and roadmap
%         \midrule
%         \multirow{2}{*}{Event sequence}
%         & * & * & *\\
%         & * & * & *\\
%         \bottomrule
%     \end{tabular}
...
% MTS
% 参考
% 1.Dya (section 3.5: Evaluation Metrics)
% 2. Assaad survey
% 3. Moraff survey

% 一段论述
% 每个指标的介绍，形式化表征，取值范围
% True Positive Rate (TPR), False Positive Rate (FPR), Area Over Curve (AOC), Structural Hamming Distance (SHD), Structural Interventional Distance (SID)  ...  (to add, to edit)
% SID指标视情况看加不加， 时序数据中对图做干预可能要难一点
