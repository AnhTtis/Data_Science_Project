...
In the framework of higher-dimensional gauge theory at finite temperature, the scalar fields are possible to induce the first-order phase transitions in the SSB~\cite{Maru:2005jy, Maru:2006wx, Adachi:2019apm, Funatsu:2021gnh}.
...
The phenomenon can be explained by the change of the behavior of $S_3/T$ for changing $g_4$. On the other hand, $R$ is irrelevant to the shape of the GW spectrum, while it controls the GW peak frequency.
These features for $R$ come from the similarity of the potential change for shifting $R$.
%
