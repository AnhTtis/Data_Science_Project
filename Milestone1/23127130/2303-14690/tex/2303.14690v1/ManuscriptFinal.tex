...
\newcommand{\rs}[1]{\S~\ref{sec:#1}}
\newcommand{\rf}[1]{Fig.~\ref{fig:#1}}
\newcommand{\rt}[1]{Tab.~\ref{tab:#1}}

\newcommand{\ms}[1]{\mathrm{#1}} %--straight mathematical variables
\newcommand{\mb}[1]{\mathbf{#1}} %--straight mathematical variables
\newcommand{\pd}[2]{\frac{\partial #1}{\partial #2}}
\newcommand{\trr}[1]{{#1}^{\!\top}}
\newcommand{\invtrr}[1]{{#1}^{\!-\top}}
...
\begin{document}
	...
	\begin{center}
		\Large{\bf{\texttt{TOPress}: a MATLAB implementation for topology optimization ofstructures subjected to design-dependent pressure loads}}\\
		
	\end{center}
	
	\begin{center}

		\large{P. Kumar $^{\star,}$\footnote{pkumar@mae.iith.ac.in; prabhatkumar.rns@gmail.com}}
		\vspace{4mm}
		
		\small{{$\star$}\textit{Department of Mechanical and Aerospace Engineering, Indian Institute of Technology Hyderabad, 502285, India}}
			\vspace{4mm}
...
% \begin{equation}\label{Eq:Forcepressureconversion}
	% 	\mathbf{F}_e = \mathbf{T}_e\,\mathbf{p}_e = -\left[\int_{\mathrm{\Omega}_e} \trr{\mathbf{N}}_\mathbf{u} \mathbf{B}_p  d {\mathrm{\Omega}_e}\right]\, \mathbf{p}_e,
	% \end{equation}
...
\begin{thebibliography}{38}
	...
	\bibitem[{Kumar(2022{\natexlab{a}})}]{kumar2022honeytop90}
	Kumar P (2022{\natexlab{a}}) {HoneyTop90}: A 90-line {MATLAB} code for topology
	optimization using honeycomb tessellation. Optimization and Engineering pp
	1--28
	
	\bibitem[{Kumar(2022{\natexlab{b}})}]{kumar2022topology}
	Kumar P (2022{\natexlab{b}}) Topology optimization of stiff structures under
