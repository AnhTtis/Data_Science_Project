% Version:
\newcommand{\version}{March 15, 2023}
...
At extremely high rates, plastic deformation is governed by high speed dislocations, a regime where dislocation mobility is poorly understood  \cite{Hansen:2013,Luscher:2016,Alshits:1992,Blaschke:2019Bpap,Blaschke:2018anis,Blaschke:2019a}.
A key question in this regard is whether dislocations can reach transonic and supersonic speeds under sufficiently high stress.
...
Experiments cannot track dislocations in real time at these high speeds, but one can hope to indirectly determine the presence of supersonic dislocations and perhaps estimate the fraction and velocity of these dislocations in the near future.
...
The case of accelerating dislocations in anisotropic crystals has also been studied \cite{Markenscoff:1984JE,Markenscoff:1984,Markenscoff:1985a,Markenscoff:1987,Blaschke:2020acc}, with pure screw dislocations having been discussed in the most detail \cite{Markenscoff:1984JE,Blaschke:2020acc}.
...
In this paper, we consider Ref. \cite{Markenscoff:1987} as a starting point to discuss in detail the solution of an accelerating pure edge dislocation in anisotropic crystals.
...
Our code is included in the upcoming version 1.2.7 of PyDislocDyn \cite{pydislocdyn}.
...
Thus, for each term in $U_i$ we interpret the following combination as a strictly positive time variable $\tau$ in order to apply the Cagniard de' Hoop method:
\begin{align}
...
Our python implementation is included in the upcoming version 1.2.7 of the code PyDislocDyn \cite{pydislocdyn}.
