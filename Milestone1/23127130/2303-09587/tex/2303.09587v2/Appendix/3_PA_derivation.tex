...
\begin{align}
    &P^{11+}_{z_{11},m_{11}} = P^{11-}_{z_{11},m_{11}} =  \delta(\frac{m_{11}}{z_{11}} - \rho'_1) \label{MF_probabilities_start} \\
    &P^{22+}_{z_{22},m_{22}} = P^{22-}_{z_{22},m_{22}} =  \delta(\frac{m_{22}}{z_{22}}-\rho'_2)\\
    &P^{12+}_{z_{12},m_{12}} = P^{12-}_{z_{12},m_{12}} = \delta(\frac{m_{12}}{z_{12}}-\rho'_2) \\
    &P^{21+}_{z_{21},m_{21}} = P^{21-}_{z_{21},m_{21}} = \delta(\frac{m_{21}}{z_{21}}-\rho'_1)
