...
node/.style={transform shape, knot crossing, inner sep=2pt}, scale=0.65]
%--------DIAGRAM-----------------
...
\end{tikzpicture} 
\vspace{-7pt}
\caption{ (Left to right:) A Balanced diagram of type $0$, its $A$-circles, its $A$-state graph, and its reduced $A$-state graph }
\label{Balanced type 0 example}
\end{figure}