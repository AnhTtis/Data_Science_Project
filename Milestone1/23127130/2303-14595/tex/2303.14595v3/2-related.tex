...
% \subsection{Architectural Methods}
...
% Early work~\cite{ratcliff1990connectionist, robins1995catastrophic} simply interleaves old and new data and trains the network using the regular task loss (i.e. Cross-Entropy for classification). 
...
% Different from existing work, in this paper, we use a learned linear transformation for feature distillation, which implicitly regularizes the feature directions that are important for old classes and allows expansion along new ones. It can better preserve linear separability and reduces forgetting. 
