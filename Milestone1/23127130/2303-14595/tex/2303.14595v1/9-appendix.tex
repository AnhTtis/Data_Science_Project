...
In Algorithm~\ref{alg:main}, we provide the pseudocode of continual learning with the proposed BFP method. Note that following~\cite{buzzega2020dark}, we sample training datapoints from the memory buffer for each loss independently. 
...
In this section, we list the best hyperparameters used for the compared baselines mentioned in Section~\ref{sec:baselines} and their results are reported Table~\ref{tbl:main_results}. 
