...
xlabel = $\mathit{AFD}$ of the Standard order,
x label style = {font=\small},
ylabel = $\mathit{AFD}$ of the Reversed order,
...
title style = {font=\small},
xlabel = $\mathit{MFD}$ of the Standard order,
x label style = {font=\small},
ylabel = $\mathit{MFD}$ of the Reversed order,
y label style = {font=\small},
width = 0.5\textwidth,
height = 0.5\textwidth,
nodes near coords,
