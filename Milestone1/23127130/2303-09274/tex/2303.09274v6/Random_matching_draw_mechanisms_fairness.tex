...
Section~\ref{Sec55} examines the graphs provided by the 21 historical Champions League seasons, while Section~\ref{Sec56} studies the graphs shown in Figure~\ref{Fig3}.
