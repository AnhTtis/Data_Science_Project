...
\end{proof}
\subsection*{Acknowledgement} We thank Prof. Arvind Ayyer (IISc, Bangalore) and, Prof. Manoj Kumar Yadav (HRI, Prayagraj) for their interest in this work. In a personal communication, it was conveyed by Prof. Leonardo Vendramin (Vrije Universiteit Brussel) that similar matrices were used by him to calculate the number of SYBEs for $n\leq 10$ in \cite{AkMeVe22}. We thank Prof L. Vendramin for pointing out the paper \cite{AkMeVe22} to us.
