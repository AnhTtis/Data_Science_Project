...
\title[Cycle Matrices for SYBE]{Cycle matrices: A combinatorial approach to the solutions of Quantum Yang-Baxter Equations}
...
\bibitem{AkMeVe22}
{\sc O.~Akg\"{u}n, M.~Mereb, and L.~Vendramin}, {\em Enumeration of
  set-theoretic solutions to the {Y}ang-{B}axter equation}, Math. Comp., 91
  (2022), pp.~1469--1481.
