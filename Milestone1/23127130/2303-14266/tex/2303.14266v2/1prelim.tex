...
and $\lambda_1,\dots ,\lambda_d$ are exactly the equivariant first Chern classes of 1-dimensional $\T$-representations with weight $t_1,\dots ,t_d$ respectively. In general \cite[§3.2]{edidin},
