...
\author{
    ...
    % Sunil Issar,\\
    Rongxiang Weng\textsuperscript{\rm 1,2},
    Qiang Wang\textsuperscript{\rm 3,4},
    Wensen Cheng\textsuperscript{\rm 2},
    Changfeng Zhu\textsuperscript{\rm 2},
...
\affiliations{
    ...
    \\
    \textsuperscript{\rm 2}miHoYo AI, Shanghai, China \\
    \textsuperscript{\rm 3}Zhejiang University, Hangzhou, China \\
    \textsuperscript{\rm 4}RoyalFlush AI Research Institute, Hangzhou, China\\
...
\subsection{Results on WMT Tasks} 
