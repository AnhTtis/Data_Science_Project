...
\begin{align}
    d^* = & \ \sup \quad \sum_k \left(I_{X_k}(x_h(0)) v_k(0, x_h(0)) \right)+ \textstyle\int_{-\tau}^{0} \phi(t + \tau_i, x_h(t))  dt\label{eq:u_cont_obj_space}& \\
    & \forall x \in X_k: \nonumber \\
...
\begin{align}
    d^* = & \ \sup \quad v(0, x_h(0)) +\textstyle \textstyle\int_{-\tau}^{0} \phi(t + \tau_i, x_h(t)) dt\label{eq:u_cont_obj_time}& \\
    & \forall x \in X:  \nonumber \\
