...
A word is in order about the possility to estimate the rotation angles
...
%		\rd{This feels too extensive for the needs of the article... I'm not sure how to shorten it.}
	...
	\subsection{Spin Coherent and Squeezed States}
		...
		In a seminal work \cite{KU93} Kitagawa and Ueda
                reimagined what it means for a spin state to be
                squeezed by understanding that one should consider the
                squeezing in directions perpendicular to the main axis
                of a SCS. The authors 
                proposed two squeezing hamiltonians,
		\begin{align}
			H_1 = \mu S_z^2, &&
