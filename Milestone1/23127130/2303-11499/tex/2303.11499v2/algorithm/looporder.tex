\setlength{\textfloatsep}{4mm}% Remove \textfloatsep

\vspace{-1mm}
\begin{algorithm}[ht!]
%\label{algo:inter-op}
\SetInd{0em}{1em}
\caption{Determining the loop orders of the tensor operations to exploit reuse}\label{alg:looporder}
\begin{small}

%\emph{Omitted for space. We will purchase an extra page for publication.}
...
\For{edge $\in$ edges(node)}
{
    ...
    {
        \textcolor{violet}{Assign same order to all non-transitive edges}\\
