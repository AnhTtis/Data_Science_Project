...
\noindent where $\mathcal{N}(\mu,\sigma)$ is additive \AddS{white} Gaussian noise with mean $\mu=0$ and standard deviation $\sigma$. \AddS{ Such a noise model is standard and includes the effects of multiple random processes such as thermal noise~\cite{boncelet2009image, surrel1997additive}.}
