...
\title{
JWST/NIRSpec First Census of Broad-Line AGNs at $\mathbf{z=4-7}$:\\ Detection of 10 Faint AGNs with $\mathbf{M_\mathrm{BH}\sim10^6-10^7\ M_\odot}$ and Their Host Galaxy Properties
}
...
The broad H$\alpha$ line widths of $\mathrm{FWHM}\simeq1000-6000\ \mathrm{km\ s^{-1}}$ suggest that the AGNs have low-mass black holes with $M_\mathrm{BH}\sim10^6-10^7\ M_\odot$, remarkably lower than those of low-luminosity quasars previously identified at $z>4$ with ground-based telescopes.
...
A high fraction of the broad-line AGNs ($\sim5\%$), higher than $z\sim0$, indicates that a number density of such faint AGNs is higher than an extrapolation of the quasar luminosity function, implying a large population of AGNs including type 1 and type 2 in the early universe.
...
The James Webb Space Telescope (JWST) was launched in the end of 2021 and started its operation in early 2022.
...
JWST/NIRSpec deep-spectroscopic observations have confirmed the candidate in \citet{2023ApJ...942L..17O} at $z_\m{spec}=5.2$ by detecting a broad H$\alpha$ emission line that indicates a black hole mass of $M_\m{BH}\sim10^7\ M_\odot$, with an additional finding of a red AGN at $z_\m{spec}=5.6$ \citep{2023arXiv230200012K}.
...
Very recently, \citet{2023arXiv230308918L} have reported a broad H$\beta$ emission line in a galaxy at $z_\m{spec}=8.7$, suggesting a SMBH whose mass is $M_\m{BH}\sim10^7\ M_\odot$ 570 Myrs after the Big Bang.
...
Our sample of low-luminosity AGNs with low-mass SMBHs allow us to obtain the first statistical view on physical properties of faint AGNs and their host galaxies at $z>4$ such as black hole masses, Eddington ratios, number densities, host's stellar mass, and morphologies, crucial to understand the galaxy-SMBH co-evolution in the early universe and implication for cosmic reionization.
...
We use the line spread functions made from spectra of a planetary nebula in \citet{2023arXiv230106811I} for spectra taken with the medium and high-resolution gratings.
...
Most sources can be fitted with a single component whose line width is narrow ($\m{FWHM}<500\ \m{km\ s^{-1}}$), but some sources show a weak moderately broad component in {\sc[Oiii]}$\lambda$5007 that may be due to outflow.
...
Based on these fitting results, we select type 1 AGNs showing broad emission only in a permitted line (i.e., H$\alpha$).
...
\item narrow ($\m{FWHM}<1000\ \m{km\ s^{-1}}$) forbidden {\sc[Oiii]} and {\sc[Nii]} emission lines, even if an outflow component is seen.
\end{enumerate}
...
\label{tab_N23}
\tablehead{\colhead{Name} & \colhead{R.A.} & \colhead{Decl.} & \colhead{$z_\m{spec}$} & \colhead{$M_\m{UV}$} & \colhead{$12+\m{log(O/H)}$} & \colhead{$\m{E(B-V)}$} & \colhead{$\m{SNR_{H\alpha,broad}}$}\\
\colhead{}& \colhead{}& \colhead{}& \colhead{}& \colhead{(mag)}& \colhead{}& \colhead{(mag)}& \colhead{}}
\startdata
\multicolumn{8}{c}{Our Final Broad-Line AGN Sample}\\
CEERS\_01244 & 14:20:57.76 & $+$53:02:09.8 & $4.478$  & $-19.50^{+0.18}_{-0.18}$ & $7.67^{+0.20}_{-0.23}$ & 0.00 & 37.3\\
GLASS\_160133 & 00:14:19.27 & $-$30:25:27.8 & $4.015$  & $-18.94^{+0.08}_{-0.09}$ & $7.95^{+0.06}_{-0.05}$ & 0.16 & 32.5\\
GLASS\_150029 & 00:14:18.52 & $-$30:25:21.3 & $4.583$  & $-19.20^{+0.10}_{-1.08}$ & $7.70^{+0.09}_{-0.08}$ & 0.17 & 18.1\\
CEERS\_00746$^\dagger$ & 14:19:14.19 & $+$52:52:06.5 & $5.624$  & $-17.82^{+0.33}_{-0.61}$ & $8.29^{+0.24}_{-0.22}$ & 1.38 & 17.3\\
CEERS\_01665 & 14:20:42.77 & $+$53:03:33.7 & $4.483$  & $-21.66^{+0.07}_{-0.07}$ & $8.05^{+0.19}_{-0.19}$ & 0.42 & 11.6\\
CEERS\_00672 & 14:19:33.52 & $+$52:49:58.7 & $5.666$  & $-16.71^{+0.31}_{-1.16}$ & $8.57^{+0.30}_{-0.23}$ & 0.80 & 11.6\\
CEERS\_02782$^\dagger$ & 14:19:17.63 & $+$52:49:49.0 & $5.241$  & $-19.50^{+0.12}_{-0.00}$ & $7.51^{+0.16}_{-0.16}$ & 0.28 & 11.2\\
CEERS\_00397 & 14:19:20.69 & $+$52:52:57.7 & $6.000$  & $-21.23^{+0.17}_{-0.24}$ & $7.87^{+0.14}_{-0.14}$ & 0.19 & 6.2\\
CEERS\_00717 & 14:20:19.54 & $+$52:58:19.9 & $6.936$  & $-21.49^{+0.12}_{-0.12}$ & $7.87^{+0.17}_{-0.18}$ & 0.00 & 6.1\\
CEERS\_01236 & 14:20:34.87 & $+$52:58:02.2 & $4.484$  & $-19.61^{+0.27}_{-0.23}$ & $7.55^{+0.29}_{-0.28}$ & 0.00 & 5.9\\
\hline
\multicolumn{8}{c}{Other Possible Candidates with $\m{SNR_{broad}<5}$}\\
CEERS\_01465 & 14:19:33.12 & $+$52:53:17.7 & $5.274$  & $-19.72^{+1.81}_{-0.45}$ & $8.25^{+0.23}_{-0.22}$ & 0.00 & 4.4\\
CEERS\_01019$^*$ & 14:20:08.49 & $+$52:53:26.4 & $8.681$  & $-22.44^{+0.45}_{-0.17}$ & $8.04^{+0.17}_{-0.17}$ & 0.00 & 3.1(H$\beta$)$^*$\\
\enddata
...
\\
$^\dagger$ CEERS\_00746 and CEERS\_02782 are reported as CEERS 3210 and CEERS 1670, respectively, in \citet{2023arXiv230200012K}.\\
...
CEERS\_00746 and CEERS\_02782 were already reported as broad-line AGNs in \citet{2023arXiv230200012K} as CEERS 3210 and CEERS 1670, respectively, and our measured broad line widths are consistent with those of \citet{2023arXiv230200012K} within $1-2\sigma$.
...
Our AGNs are widely distributed in the UV magnitude and redshift space and are not biased compared to the star-forming galaxy sample in \citet{2023arXiv230112825N}.
...
Figure \ref{fig_snapshot} shows snapshots of our selected AGNs.
...
Among these three sources, CEERS\_00746 (CEERS 3210 in \citealt{2023arXiv230200012K}) and CEERS\_00672 show red spectral-energy distributions (SEDs) and large dust attenuation estimated from the Balmer decrement as presented in Section \ref{ss_dust}, indicating that these two sources are dusty red AGNs.
The remaining seven AGNs show extended morphologies, different from the ones reported in \citet{2023arXiv230200012K}.
Such a high fraction (70\%) of extended morphologies indicates that the total lights of the faint AGNs with $-22\lesssim M_\m{UV}\lesssim-17$ mag are partly dominated by their host galaxies like Seyfert galaxies, which is discussed in Section \ref{ss_dis_high}
...
CEERS\_00746 is also reported in \citet{2023arXiv230200012K}.
The red circles and arrows show the measured magnitudes and 2$\sigma$ upper limits, respectively.
The blue curves are the best-fit SEDs if we use galaxy templates.
}
\label{fig_SED}
\end{figure*}
%%%%%%%%%%%%%%%%%%  Figure end
...
CEERS\_00746 was previously reported as a red AGN in \citet{2023arXiv230200012K}, and we have newly found an additional red AGN, CEERS\_00672, at $z=5.666$.
...
These results indicate that our galaxies harboring AGNs cannot be distinguished from normal star-forming galaxies at $z>4$ with the BPT diagram, because of the low metallicities in these sources.
...
We do not find significant high-ionization lines such as Ne{\sc V}$\lambda$3426 and He{\sc ii}$\lambda$4686, except for CEERS\_00746 showing a tentative He{\sc ii}$\lambda$4686 line.
{\sc Ciii]}$\lambda\lambda$1907,1909 emission lines are seen in most of the sources (CEERS\_01244, GLASS\_150029, CEERS\_01665, CEERS\_00672, CEERS\_02782, CEERS\_00397, and CEERS\_00717), and {\sc Oiii]}$\lambda\lambda$1661,1666 lines are seen in CEERS\_00717.
Possible high ionization {\sc Civ}$\lambda\lambda$1548,1551 emission lines are identified in CEERS\_00672 and CEERS\_00397, and a {\sc Civ} broad absorption feature is tentatively seen in CEERS\_00717, consistent with that these sources are AGNs.
...
The red open star and square are AGNs at $z=5.55$ and $8.78$ identified with JWST/NIRSpec observations in \citet{2023arXiv230206647U} and \citet{2023arXiv230308918L}, respectively. 
The green and gray contours show the low redshift AGNs at $z=1-2$ \citep{2019ApJ...873...35S} and $z<0.35$ \citep{2019ApJS..243...21L}.
The dashed lines show the bolometric luminosities with the Eddington ratios of $L_\m{bol}/L_\m{Edd}=1.0$, $0.1$, and $0.01$. 
}
\label{fig_MBH_Lbol}
\end{figure*}
%%%%%%%%%%%%%%%%%%  Figure end
...
\colhead{}& \colhead{($\mathrm{erg\ s^{-1}}$)}& \colhead{} & \colhead{($\mathrm{km\ s^{-1}}$)}& \colhead{($M_\odot$)}& \colhead{($\mathrm{erg\ s^{-1}}$)} & \colhead{($\mathrm{erg\ s^{-1}}$)}}
\startdata
CEERS\_01244 & $1.9^{+0.0}_{-0.1}\times10^{42}$& $2.52^{+0.16}_{-0.23}$& $2228^{+75}_{-52}$& $1.5^{+0.1}_{-0.1}\times10^{7}$& $5.8^{+9.7}_{-1.7}\times10^{44}$& $0.30^{+0.56}_{-0.11}$\\
GLASS\_160133 & $3.0^{+0.2}_{-0.1}\times10^{41}$& $0.26^{+0.02}_{-0.01}$& $1028^{+19}_{-13}$& $1.1^{+0.1}_{-0.0}\times10^{6}$& $3.4^{+14.8}_{-2.6}\times10^{44}$& $2.43^{+10.94}_{-1.89}$\\
GLASS\_150029 & $2.1^{+0.2}_{-0.1}\times10^{41}$& $0.22^{+0.02}_{-0.01}$& $1429^{+10}_{-67}$& $1.7^{+0.1}_{-0.2}\times10^{6}$& $2.8^{+3.0}_{-2.2}\times10^{44}$& $1.22^{+1.57}_{-0.97}$\\
CEERS\_00746 & $1.7^{+0.1}_{-0.1}\times10^{43}$& $5.07^{+1.12}_{-1.28}$& $1660^{+157}_{-162}$& $2.7^{+0.7}_{-0.6}\times10^{7}$& $3.3^{+0.3}_{-0.6}\times10^{45}$& $0.95^{+0.39}_{-0.34}$\\
CEERS\_01665 & $1.7^{+0.2}_{-0.1}\times10^{42}$& $0.28^{+0.05}_{-0.05}$& $1794^{+282}_{-171}$& $8.9^{+4.0}_{-2.3}\times10^{6}$& $1.4^{+1.5}_{-1.1}\times10^{45}$& $1.25^{+2.19}_{-1.03}$\\
CEERS\_00672 & $4.4^{+0.4}_{-0.4}\times10^{42}$& $1.95^{+0.45}_{-0.40}$& $2208^{+277}_{-241}$& $2.3^{+0.7}_{-0.6}\times10^{7}$& $1.3^{+0.1}_{-0.4}\times10^{45}$& $0.42^{+0.19}_{-0.21}$\\
CEERS\_02782 & $1.9^{+0.2}_{-0.2}\times10^{42}$& $0.84^{+0.14}_{-0.09}$& $2534^{+260}_{-266}$& $1.9^{+0.6}_{-0.5}\times10^{7}$& $8.3^{+4.3}_{-4.2}\times10^{44}$& $0.33^{+0.33}_{-0.20}$\\
CEERS\_00397 & $6.4^{+2.1}_{-1.0}\times10^{41}$& $0.19^{+0.07}_{-0.05}$& $1739^{+359}_{-317}$& $4.9^{+3.6}_{-2.2}\times10^{6}$& $8.3^{+34.3}_{-6.7}\times10^{44}$& $1.31^{+10.89}_{-1.16}$\\
CEERS\_00717 & $3.0^{+0.7}_{-0.5}\times10^{41}$& $0.57^{+0.17}_{-0.10}$& $6279^{+805}_{-881}$& $4.6^{+2.0}_{-1.5}\times10^{7}$& $2.1^{+12.7}_{-1.3}\times10^{44}$& $0.04^{+0.33}_{-0.03}$\\
CEERS\_01236 & $1.2^{+0.3}_{-0.2}\times10^{41}$& $2.39^{+1.10}_{-0.59}$& $3521^{+649}_{-485}$& $8.3^{+4.9}_{-2.7}\times10^{6}$& $5.4^{+5.6}_{-1.7}\times10^{43}$& $0.05^{+0.10}_{-0.03}$\\
\enddata
%\tablecomments{XXX}
\end{deluxetable*}
%%%%%%%%%%%%%%%%%% Table of data end
...
We use the broad-line luminosity as an input of Equation (\ref{eq_mbh}) following \citet{2023arXiv230200012K}, because it is not clear whether the narrow-line emission line seen in our AGNs originates from the AGN or {\sc Hii} regions in its host galaxy.
...
Since it is not clear whether the narrow-line emission in our AGNs originates from the AGN or star formation, we set the lower limit of the bolometric luminosity using Equation (\ref{eq_lbol}) with the broad-line H$\alpha$ luminosity as an input and the bolometric correction of $L_\m{bol}=9.8\times L_\m{5100}$ in \citet{2004MNRAS.352.1390M}.
...
The black hole masses and bolometric luminosities of our AGNs are $M_\m{BH}\sim10^6-10^7\ M_\odot$ and $L_\m{bol}\sim10^{44}-10^{45}\ \m{erg\ s^{-1}}$, respectively, indicating that our AGNs have lower black hole masses and lower bolometric luminosities than quasars at $z\sim4-7$ identified in the ground-based observations \citep{2011ApJ...730....7T,2019ApJ...872L...2M,2019ApJ...873...35S,2019ApJ...880...77O}.
...
Deeper NIRSpec spectroscopy is needed to investigate whether the AGNs at $z>4$ with $M_\m{BH}\sim10^6-10^7\ M_\odot$ have systematically higher  $\lambda_\m{Edd}$ than $z\sim0$ AGNs or not.
...
We assume the stellar initial mass function (IMF) of \citet{2003PASP..115..763C}, the intergalactic medium (IGM) attenuation model of \citet{1995ApJ...441...18M}, the \citet{2000ApJ...533..682C} dust attenuation law, and a fixed metallicity of 0.2 $Z_\odot$.
We choose a flexible star formation history as adopted in \citet{2023ApJS..265....5H}.
...
Similar results are obtained in previous studies with a smaller number of AGNs \citep{2023arXiv230200012K,2023arXiv230206647U,2023arXiv230200012K}, but we confirm this trend of lower $M_*$ (higher $M_\m{BH}$) with a sample of 10 AGNs at $z=4-7$.
...
\end{equation}
where the fitting parameters of the galaxy luminosity function are taken from \citet{2022ApJS..259...20H}.
...
Using the effective volume calculated here, we can also evaluate the lower limit of the number density based on the number of detected AGNs in each bin.
...
The red open star at $z\sim5$ is a number density estimate of $z\sim5$ AGNs detected with NIRSpec in \citet{2023arXiv230200012K}.
...
The best estimate of the number density is higher than those of the X-ray selected AGNs \citep{2018MNRAS.474.2904P,2019ApJ...884...19G} and the estimate for broad-line AGNs in \citet{2023arXiv230200012K}, but is consistent within the errors.
...
Our broad-line type-1 AGNs have low-mass black holes with $M_\m{BH}\sim10^6-10^7\ M_\odot$.
...
Our analysis indicates that about 5\% of the galaxies at $z\sim4-7$ harbor faint type-1 AGNs, while studies of local AGNs implies that only 1-2\% of galaxies with similar bolometric luminosities ($L_\m{bol}\sim10^{44}-10^{45}\ \m{erg\ s^{-1}}$, or $L_{6166}\sim10^{43}-10^{44}\ \m{erg\ s^{-1}}$) are type-1 AGNs \citep{2012MNRAS.423..600S}.
...
Although the broad emission lines are detected, the low broad-to-narrow line flux ratios suggest that these AGNs may be partly obscured, implying a high obscured fraction in the universe at $z>4$.
Indeed, several X-ray observations indicate a higher fraction of obscured AGNs in the higher redshift universe at $z\sim0-4$ \citep[e.g.,][]{2008A&A...490..905H,2014ApJ...786..104U,2017ApJS..232....8L,2018ApJ...854...33Z,2020A&A...639A..51I}.
...
We identify 10 faint type-1 AGNs at $z_\m{spec}=4.015-6.936$, two of which are reported in \citet{2023arXiv230200012K}, allowing us to conduct the first statistical census of such faint AGNs in the early universe.
...
\item
Our faint AGNs have low-mass black holes with $M_\mathrm{BH}\sim10^6-10^7\ M_\odot$, remarkably lower than those of low-luminosity quasars previously identified at $z>4$ with ground-based telescopes (Figure \ref{fig_MBH_Lbol}).
...
\end{enumerate}
As previous studies \citep{2023arXiv230200012K,2023arXiv230206647U,2023arXiv230308918L}, this study demonstrates that NIRSpec spectroscopy is an efficient and powerful tool to find faint type-1 AGNs with low mass black holes that are embedded in their host galaxies.
...
\acknowledgments
%\redcc{We thank the anonymous referee for careful reading and valuable comments that improved the clarity of the paper.}
We are grateful to Roberto Maiolino, Ryan Sanders, and John Silverman for useful discussions.
...
This publication is based upon work supported by the World Premier International Research Center Initiative (WPI Initiative), MEXT, Japan, and KAKENHI (20H00180, 21J20785, 21K13953, 21H04467) through Japan Society for the Promotion of Science.
