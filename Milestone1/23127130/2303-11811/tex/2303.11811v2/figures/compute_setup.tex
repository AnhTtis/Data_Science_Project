...
\begin{tikzpicture}[scale=1.0]
    ...
    % Arrows
    \draw [-latex] ([yshift=-12pt]cpu.north east) -- node (nextStep) [above, text width=5cm, xshift=0.4cm] {$\boldsymbol{x}_{\text{p},i}$, $r_i$, $f(r_i)$, sub block information, $\boldsymbol{U}_{\text{p},i}$, ${\boldsymbol{\Omega}}_{\text{p},i}$} ([yshift=-12pt]gpu.north west);
