...
%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\shorttitle{Component reusability evaluation and requirement tracing for agent-based cyber-physical-simulated systems}
\shortauthors{W. Dudek et~al.}
%\begin{frontmatter}

\title [mode = title]{Component reusability evaluation and requirement tracing for agent-based cyber-physical-simulated systems }                      
% \tnotemark[1,2]
