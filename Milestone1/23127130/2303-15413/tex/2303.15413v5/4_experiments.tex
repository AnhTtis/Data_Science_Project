...
\midrule
Baseline~\cite{wang2022score} & 9.58\% & 16.07\%      & 9.67\%  \\
Debiased (Ours)            & \textbf{90.42\%} & \textbf{83.93\%}      & \textbf{90.33\%} \\
\bottomrule
\end{tabular}
\vspace{+5pt}
