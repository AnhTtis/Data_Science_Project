% Versione correzioni 20.03.2023
...
\begin{equation*}
\mathcal F\varphi(\xi):=\frac{1}{(2\pi)^\frac{n}{2}}\int_{\R^3}e^{-i\xi\cdot x}\varphi(x) \,dx\quad\text{for $\xi\in\R^3$},
\end{equation*}
...
\begin{proof}
Let us show that all the terms in~\eqref{eq:u} and~\eqref{eq:varphi} are well defined for $u,v\in W$ and $\varphi,\psi\in W$. As observed before, the bilinear form $\mathcal B_\alpha$ is well defined and continuous on $W\times W\subset H^1(\R^3)\times H^1(\R^3)$. Moreover, by Hölder inequality,
...
Notice that for functional $J\colon W\to\R$ defined in~\eqref{eq:J} we have
\begin{itemize}
  \item $J\in C^1(W)$;
  \item $J(0)=0$;
  \item $J$ is even.
...
Indeed, by~\eqref{young} for any $u\in H^1(\R^3)$ and $\e>0$ we have
\begin{align*}
J(u)&\ge \frac{1}{2}\|\nabla u\|^2_2-\frac{\alpha^{-}}{2}\left(s\e \|\nabla u\|^2_2+(1-s)\e^{-\frac{s}{1-s}}\|u\|^2_2\right)\\
    &\quad + \frac{m^2-\omega^2}{2}\|u\|^2_2+\frac{\omega}{2}\int_{\R^3}\varphi_u u^2\,dx-\frac{1}{p}\|u\|^p_p\\
...
\begin{align*}
J(u) \ge& \min \frac{1}{2}\{c_1,c_2\}\|u\|^2_{H^1}-\frac{C_p^p}{p}\|u\|^p_{H^1}.
\end{align*}
Therefore, for any $u\in S_{\varrho}$, we have
\begin{equation}
J(u)\ge \frac{1}{2}\min \{c_1,c_2\} \cdot \varrho^2-\frac{C_p^p}{p} \cdot \varrho^{p-2}=\varrho^2 \left( \frac{1}{2}\min \{c_1,c_2\}-\frac{C_p^p}{p}\cdot \varrho^{p-2}\right)>0,
\end{equation}
...
By~\eqref{eq:below} we can find $\e_1\in(0,\infty)$ such that
\begin{equation}
...
Note that the sequence $(\varphi_{u_n})_n\subset\mathcal D^{1,2}(\R^3)$ satisfies for all $n\in\N$
\begin{equation*}
...
For such fixed $M$, by $\eqref{V}$ there exists $R_M>0$ such that
\begin{equation*}
...
In order to prove that the functional $J$ satisfies the geometric assumptions $(i)$ and $(ii)$ of the Theorem~\eqref{Rabinowitz86}, we introduce a new operator $\mathcal L_{\alpha,V}\colon W\to W'$, defined as
...
\begin{equation}\label{k0}
    \mathcal \lambda_{k_0}>\frac{\omega^2}{2}.
\end{equation}
Then, there exists a constant $c_0=c_0(s,\alpha,\omega,V_0)>0$ satifying
\begin{align}\label{eq:ck0}
\mathcal B_{\alpha,V}(u,u)-\frac{\omega^2}{2}\|u\|_2^2\ge c_0\|u\|_W^2\quad\text{for all $u\in \mathbb P_{k_0}$}.
\end{align}
Indeed, in view of~\eqref{eq:below2} and \eqref{eq:lambdak}, for all $u\in\mathbb P_{k_0}$ we have
\begin{align*}
\mathcal B_{\alpha,V}(u,u)-\frac{\omega^2}{2}\|u\|_2^2&=\mathcal B_{\alpha,V}(u,u)+\gamma \|u\|_2^2-\frac{\omega^2+2\gamma}{2}\|u\|_2^2\\
&=\left(1-\frac{\omega^2+2\gamma }{2\lambda_{k_0}+2\gamma }\right)\left(\mathcal B_{\alpha,V}(u,u)+\gamma \|u\|_2^2\right)\\
&\quad+\left(\frac{\omega^2+2\gamma}{2\lambda_{k_0}+2\gamma }\right)\left(\mathcal B_{\alpha,V}(u,u)+\gamma \|u\|_2^2\right)-\frac{\omega^2+2\gamma}{2}\|u\|_2^2\\
&\ge\frac{1}{2}\left(1-\frac{\omega^2+2\gamma }{2\lambda_{k_0}+2\gamma }\right)\|u\|_W^2=:c_0\|u\|_W^2.
\end{align*}
...
A.~Maione is also supported by the University of Freiburg, and by the INdAM - GNAMPA project ``Equazioni differenziali alle derivate parziali in fenomeni non lineari'' (Project Grant number CUP\_E55F22000270001).
