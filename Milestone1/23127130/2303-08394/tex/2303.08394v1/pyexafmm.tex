...
S.~K. Lam, A.~Pitrou, and S.~Seibert, ``{Numba: a LLVM-based Python JIT
  compiler},'' {\em Proceedings of the Second Workshop on the LLVM Compiler
  Infrastructure in HPC - LLVM '15}, pp.~1--6, 2015.
\newblock doi:
  \href{https://doi.org/10.1145/2833157.2833162}{10.1145/2833157.2833162}.

\bibitem{Ying2004}
L.~Ying, G.~Biros, and D.~Zorin, ``{A kernel-independent adaptive fast
  multipole algorithm in two and three dimensions},'' {\em Journal of
  Computational Physics}, vol.~196, no.~2, pp.~591--626, 2004.
\newblock doi:
  \href{https://doi.org/10.1016/j.jcp.2003.11.021}{10.1016/j.jcp.2003.11.021}.

\bibitem{Greengard1987}
L.~Greengard and V.~Rokhlin, ``{A fast algorithm for particle simulations},''
  {\em Journal of Computational Physics}, vol.~73, no.~2, pp.~325--348, 1987.
\newblock doi:
  \href{https://doi.org/10.1016/0021-9991(87)90140-9}{10.1016/0021-9991(87)90140-9}.

\bibitem{Lattner2004}
C.~Lattner and V.~Adve, ``{LLVM}: a compilation framework for lifelong program
  analysis amp; transformation,'' in {\em International Symposium on Code
  Generation and Optimization, 2004. CGO 2004.}, pp.~75--86, 2004.
\newblock doi:
  \href{https://doi.org/10.1109/CGO.2004.1281665}{10.1109/CGO.2004.1281665}.

\bibitem{Dongarra2000}
J.~Dongarra and F.~Sullivan, ``Guest editors introduction to the top 10
  algorithms,'' {\em Computing in Science \& Engineering}, vol.~2, no.~01,
  pp.~22--23, 2000.
\newblock doi:
  \href{https://doi.org/10.1109/MCISE.2000.814652}{10.1109/MCISE.2000.814652}.

\bibitem{Sundar2007}
H.~Sundar, R.~S. Sampath, and G.~Biros, ``{Bottom-up construction and 2:1
  balance refinement of linear octrees in parallel},'' {\em SIAM Journal on
  Scientific Computing}, vol.~30, no.~5, pp.~2675--2708, 2007.
\newblock doi: \href{https://doi.org/10.1137/070681727}{10.1137/070681727}.

\bibitem{Wang2021}
T.~Wang, R.~Yokota, and L.~A. Barba, ``{ExaFMM}: a high-performance fast
  multipole method library with c++ and python interfaces,'' {\em Journal of
  Open Source Software}, vol.~6, no.~61, p.~3145, 2021.
\newblock doi: \href{http://doi.org/10.21105/joss.03145}{10.21105/joss.03145}.
