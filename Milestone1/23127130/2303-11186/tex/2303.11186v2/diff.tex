...
%DIF DEL rtas-shepherding-v2.tex       Thu Feb 23 18:40:59 2023
%DIF ADD ../shedding-light-share.tex   Fri Mar  3 23:29:00 2023
...
\begin{figure}
    ...
    \vspace{-0.2cm}
    \caption{Time \DIFdelbeginFL \DIFdelFL{interval }\DIFdelendFL between the \DIFdelbeginFL \DIFdelFL{arrival }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{handling }\DIFaddendFL of different priority interrupts triggered simultaneously\DIFaddbeginFL \DIFaddFL{, i}\DIFaddendFL .\DIFdelbeginFL \DIFdelFL{The Nth index }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{e., for interrupt N }\DIFaddendFL in the X-axis\DIFdelbeginFL \DIFdelFL{is }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, }\DIFaddendFL the \DIFdelbeginFL \DIFdelFL{interval }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{time }\DIFaddendFL between the \DIFaddbeginFL \DIFaddFL{arrival of interrupts }\DIFaddendFL N-1 \DIFdelbeginFL \DIFdelFL{$^{th}$ }\DIFdelendFL and N\DIFdelbeginFL \DIFdelFL{$^{th}$ interrupts}\DIFdelendFL .}
    \label{fig:irqprio}
    \vspace{-0.55cm}
\end{figure}
...
\DIFdelbegin \DIFdel{In this section, we assess VM boot time overheads on SPH.
}\DIFdelend %DIF > In this section, we assess VM boot time overheads on SPH.
