...
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/balloon1/gt/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/balloon1/pred/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/balloon1/int_wrong/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/balloon1/ext_wrong/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/balloon1/both/v000_t023.png}
\end{subfigure}

% Playground
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/balloon2/gt/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/balloon2/pred/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/balloon2/int_wrong/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/balloon2/ext_wrong/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/balloon2/both/v000_t023.png}
\end{subfigure}

% Skating 
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/skating/gt/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/skating/pred/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/skating/int_wrong/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/skating/ext_wrong/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/skating/both/v000_t023.png}
\end{subfigure}

% Jumping 
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/jumping/gt/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/jumping/pred/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/jumping/int_wrong/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/jumping/ext_wrong/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/jumping/both/v000_t023.png}
\end{subfigure}

% Umbrella
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/umbrella/gt/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/umbrella/pred/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/umbrella/int_wrong/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/umbrella/ext_wrong/v000_t023.png}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/umbrella/both/v000_t023.png}
\end{subfigure}
...
\begin{subfigure}{.48\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/int/int_bal1.png}
    \caption{\textit{Scene}: \textbf{Balloon1}}
\end{subfigure}
% Playground
\begin{subfigure}{.48\linewidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/int/int_playground.png}
    \caption{\textit{Scene}: \textbf{Playground}}
\end{subfigure}
% Skating 
\begin{subfigure}{.48\linewidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/int/int_skating.png}
    \caption{\textit{Scene}: \textbf{Skating}}
\end{subfigure}
% Umbrella
\begin{subfigure}{.48\linewidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/int/int_umbrella.png}
...
% Balloon1 
\begin{subfigure}{.48\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/ext/ext_bal1.png}
    \caption{\textit{Scene}: \textbf{Balloon1}}
\end{subfigure}
% Playground
\begin{subfigure}{.48\linewidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/ext/ext_playground.png}
    \caption{\textit{Scene}: \textbf{Playground}}
\end{subfigure}
% Skating 
\begin{subfigure}{.48\linewidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/ext/ext_skating.png}
    \caption{\textit{Scene}: \textbf{Skating}}
\end{subfigure}
% Umbrella
\begin{subfigure}{.48\linewidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/ext/ext_umbrella.png}
    \caption{\textit{Scene}: \textbf{Umbrella}}
\end{subfigure}
...
\begin{subfigure}{.18\textwidth}
    \centering
    \includegraphics[width=0.6\linewidth]{iccv2023AuthorKit/figures/f1.png}
...
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/custom/v000_t000.png}
    \subcaption*{\textit{Frame}: 0}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/custom/v000_t024.png}
    \subcaption*{\textit{Frame}: 24}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/custom/v000_t048.png}
    \subcaption*{\textit{Frame}: 48}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/custom/v000_t072.png}
    \subcaption*{\textit{Frame}: 72}
\end{subfigure}
\begin{subfigure}{.18\textwidth}
    \includegraphics[width=\linewidth]{iccv2023AuthorKit/figures/ablation/custom/v000_t096.png}
    \subcaption*{\textit{Frame}: 96}
\end{subfigure}
...
\bibliography{iccv2023AuthorKit/egpaper_for_review}
}
