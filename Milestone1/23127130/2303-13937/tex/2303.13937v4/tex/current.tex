...
In the case of KLFitter these are used in conjunction with  with transfer functions and the particle decay widths. %With these approaches, reasonably good performance can be achieved. However, there are two main drawbacks to this approach.
...
Other approaches employ physics inspired layers in order to assign parton labels~\cite{Badea:2022dzb} or try to predict the properties of intermediate particles directly~\cite{Qiu:2022xvr}.