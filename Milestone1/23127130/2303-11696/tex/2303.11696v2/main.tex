...
such an approach has been extended~\cite{Bronnikov:2000vy,Fan:2016hvf,Bronnikov:2005gm,Bronnikov:2021uta,Bokulic:2022cyk} to explain all RBH models with the spherical symmetry. It is different from the usual way in finding BH solutions by solving Einstein's field equations. 
...
It was originally thought \cite{Dymnikova:1992ux,Dymnikova:2015yma} that RBHs can be constructed when the singularity at their  centers is replaced by the de Sitter core, which implies the violation of the strong energy condition (SEC). 
...
\end{equation}
as $r$ approaches to zero. Moreover, a spherically symmetric RBH model with a flat core is highlighted in Ref.\ \cite{Simpson:2019mud,Ling:2021olm},
...
\begin{enumerate}
    ...
    Here are some counterexamples: temperature is not independent in Ref.\ \cite{Ma:2014qma}, deviation of internal energy $X$ is not independent in Ref.\ \cite{Maluf:2022jjc}, etc.
...
On the one hand, the NJA depends on theories of gravity. 
