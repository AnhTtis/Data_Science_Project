...
\begin{prop}[\cite{FinkbeinerRS15,FinkbeinerH16}]
\label{prop_hyltlfs}
...
Formally, this is captured by the next formulas:	
    ...
    \begin{multline*}
    \forall \pi.\ \exists\pi'.\ (\add_\pi \wedge \neg \argl_\pi) \rightarrow\\ \left(\add_{\pi'} \wedge  \F( \X\argl_{\pi} \wedge \argl_{\pi'} ) \wedge \F(\argr_\pi \wedge \argr_{\pi'}) \wedge \F(\X\res_{\pi} \wedge \res_{\pi'}) \right)    
    \end{multline*}
...
The formulas differ from those in the proof of \autoref{lem:phiop} only in the use of the guard~$\phi_g$.
    ...
    $\argr \in t'(n_2)$, and $\res \in t'(n_3-1)$ (this captures $n_1 + n_2 = n_3 \Leftrightarrow n_1-1 + n_2 = n_3-1$ for $n_1 > 0$):
    \begin{multline*}
        \forall \pi.\ \exists\pi'.\ (\phi_g\wedge\add_\pi \wedge \neg \argl_\pi) \rightarrow \\
        \left(\add_{\pi'} \wedge  \F( \X\argl_{\pi} \wedge \argl_{\pi'} ) \wedge \F(\argr_\pi \wedge \argr_{\pi'}) \wedge \F(\X\res_{\pi} \wedge \res_{\pi'}) \right)
    \end{multline*}
