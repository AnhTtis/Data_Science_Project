...
%
\institute{Technical Universsity of Munich, Garching, Germany
}
...
\begin{figure}[htpb]
  \centering
  \includegraphics[width=0.7\textwidth]{Network2.png}
...
\begin{figure}[htpb]
  \centering
  \includegraphics[width=0.9\textwidth]{square_anchor_PR.png}
...
\begin{figure}[htpb]
  \centering
  \includegraphics[width=0.9\textwidth]{21_anchor_PR.png}
...
\begin{figure}[htpb]
  \centering
  \includegraphics[width=0.9\textwidth]{12_anchor_PR.png}
...
\begin{figure}[htpb]
  \centering
  \includegraphics[width=0.9\textwidth]{9_feature_maps.png}
...
%This research is funded by the National Key Research and Development Program of China :
%\begin{itemize}
%    \item 2019YFB1600700
%    \item 2019YFB1600701
%\end{itemize}
