...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.9\textwidth}
        \begin{minipage}{.5\textwidth}
          \centering
          \includegraphics[width=\textwidth,trim={0 2cm 2cm 3cm}]{figures/ADNI/mean_LMCI_cortical_weighted_mVAE.png}
            \includegraphics[width=\textwidth,trim={0 8cm 2cm 3cm}]{figures/ADNI/mean_LMCI_subcortical_weighted_mVAE.png}
        \end{minipage}%
        \begin{minipage}{.5\textwidth}
          \centering
            \adjincludegraphics[width=\textwidth,trim={0 7cm 0 3cm},clip]
              {figures/ADNI/circular_mean_LMCI_DTI_weighted_mVAE.png}
        \end{minipage}
     ...
     \begin{subfigure}[b]{0.9\textwidth}
        \begin{minipage}{.5\textwidth}
          \centering
          \includegraphics[width=\textwidth,trim={0 2cm 2cm 3cm}]{figures/ADNI/mean_AD_cortical_weighted_mVAE.png}
            \includegraphics[width=\textwidth,trim={0 8cm 2cm 3cm}]{figures/ADNI/mean_AD_subcortical_weighted_mVAE.png}
        \end{minipage}%
        \begin{minipage}{.5\textwidth}
          \centering
              \adjincludegraphics[width=\textwidth,trim={0 6cm 0 3cm},clip]
              {figures/ADNI/circular_mean_AD_DTI_weighted_mVAE.png}
        \end{minipage}
         % \caption{Average $D_{\text{uf}}$ for AD cohort}
         \caption{}
          \label{fig:ADNI_AD_recon}
     \end{subfigure}
        \caption{(a) Average $D_{\text{uf}}$ using the gPoE-normVAE ($L_{\text{dim}}$=10) model for the LMCI and (b) AD cohort. }\label{fig:deviations_ADNI}
\end{figure}
