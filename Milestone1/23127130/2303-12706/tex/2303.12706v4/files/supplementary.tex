...
\begin{figure}
     ...
     \begin{subfigure}[b]{\textwidth}
         \centering
          \includegraphics[width=\textwidth,trim={0 1cm 0 5cm}]{figures/ADNI/Baseline_vs_proposed_EF_correlations_adjustedforage_5models_AFTER.png}
          \caption{}
          \label{fig:ADNI_corr_EF}
     \end{subfigure}
     \begin{subfigure}[b]{\textwidth}
         \centering
          \includegraphics[width=\textwidth,trim={0 1cm 0 0cm}]{figures/ADNI/Baseline_vs_proposed_MEM_correlations_adjustedforage_5models_AFTER.png}
          \caption{}
