...
\newcommand{\jh}[1]{\textcolor{blue}{{Jeonghwan: #1}}} % for comments
% \newcommand{\jhc}[1]{\textcolor{black}{{#1}}} % for added contents that is not revised
\newcommand{\jhc}[1]{\textcolor{violet}{{#1}}} % for added contents that is not revised
\newcommand{\revised}[1]{\textcolor{olive}{{#1}}}
\newcommand{\sigrev}[1]{\textcolor{cyan}{{sigAreviewers: #1}}}
