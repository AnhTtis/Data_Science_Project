...
\name achieves state-of-the-art performances on Flickr-SoundNet, VGG-Sound, and AVSBench, which demonstrates the effectiveness of our method in mitigating the false negative issue. The code is available at \url{https://github.com/weixuansun/FNAC-AVL}. 
...
Research show~\cite{arora2019theoretical,zheng2021weakly,senocak2022learning,huynh2022boosting} that these false negatives will lead to contradictory objectives and harm the representation learning.
