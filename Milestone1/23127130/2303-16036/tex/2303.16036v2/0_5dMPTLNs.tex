...
\title{Scalar Love numbers and Love symmetries of 5-dimensional Myers-Perry black holes}
\author[a]{Panagiotis Charalambous}%\footnote{\texttt{pc2560@nyu.edu}}}
%\author[a]{Sergei Dubovsky}%\footnote{\texttt{dubovsky@nyu.edu}}}
\author[b,c]{Mikhail M. Ivanov}%\footnote{\texttt{ivanov@ias.edu}}}
...
\affiliation[c]{School of Natural Sciences, Institute for Advanced Study, 1 Einstein Drive, \\ Princeton, NJ 08540, USA}

\emailAdd{pc2560@nyu.edu}
\emailAdd{ivanov@ias.edu}
\date{}
...
\input{1_Intro}
\input{2_TLNsDefinition}
\input{3_TLNsComputation}
\input{4_SL2R}
\input{5_Properties}
\input{6_NHE}
\input{7_Discussion}
...
\appendix
\input{ApA_5dMPGeometry}
\input{ApB_SphericalHarmonics}
\input{ApC_SchwarzschildLimit}
\input{ApD_SL2RGenerators}
