...
\begin{figure}[h]
\centering
\includegraphics[width=0.80\linewidth]{violin_plot.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.80\linewidth]{combined_feature_importances_qrfs_all_fetaures.png}
