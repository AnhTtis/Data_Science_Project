...
\affil[*]{corresponding author(s): Daniel Speckhard (speckhard@fhi.mpg.de)}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{violin_plot.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.70\linewidth]{combined_feature_importances_qrfs_all_fetaures.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{pi_sorted_vs_data_full_95.png}
...
\caption{Stoichiometric model predictions of $\Delta E^{AB}$ for  FHI-aims (left) and \exciting\ (right). The regions of particular interest to DFT practitioners, \ie calculated values between 1 meV/atom and 1 eV/atom, are highlighted by the white background. The RMSLE+1E-4 metric is labeled RMSLE.}
