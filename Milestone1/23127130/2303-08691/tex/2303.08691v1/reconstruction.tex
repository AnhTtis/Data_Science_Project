...
A similar argument that the one used for lower bounding the model identification error in Theorem 5 can be used to lower bound the error of the learned reconstruction function.
