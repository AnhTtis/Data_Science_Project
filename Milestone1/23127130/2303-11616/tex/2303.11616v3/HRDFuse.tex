...
\author{Hao Ai$^{1,2}$\thanks{Intern at ARC Lab, Tencent PCG.} \quad Zidong Cao$^{1}$ \quad Yan-Pei Cao$^{2}$ \quad Ying Shan$^{2}$ \quad Lin Wang$^{1}$$^{,3}$\thanks{Corresponding author (e-mail: linwang@ust.hk)}\\
...
\vspace{-5pt}
For videos, code, demo and more information, you can visit \href{https://VLIS2022.github.io/HRDFuse/}{https://VLIS2022.github.io/HRDFuse/}
