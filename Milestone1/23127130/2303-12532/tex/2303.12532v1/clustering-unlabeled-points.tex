...
\begin{prop}
  \label{lemma3}
  If $e_j \geq 1$ for all $j \in [1,k]$, a valid big-$M$ for Problem~\eqref{equation3} is given by
  \eqref{validM}.
\end{prop}
\begin{proof}
...
\begin{algorithm}
  ...
  \Input{$X\in \mathbb{R}^{d\times N}, y \in \set{-1,1}^n, k^1 \in \mathbb{N}, C_1 >0, C_2 > 0$, and $\tau \in \mathbb{N}$.}
