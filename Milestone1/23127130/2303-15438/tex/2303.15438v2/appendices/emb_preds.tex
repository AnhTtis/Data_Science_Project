...
We train ResNet-50 encoders from moderately small init to close to convergence with Barlow Twins ($\alpha=0.542$), SimCLR ($\alpha=0.284$), and VICReg ($\alpha=0.604$) losses on STL-10.
