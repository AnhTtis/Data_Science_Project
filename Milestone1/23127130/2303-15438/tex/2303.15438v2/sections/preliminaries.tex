...
\end{equation}
Compared to the original loss of \citep{zbontar:2021-barlow-twins}, we have set the hyperparameter $\lambda$ to $1$, removed batchnorm in the definition of $\mC$, and symmetrized $\mC$.
