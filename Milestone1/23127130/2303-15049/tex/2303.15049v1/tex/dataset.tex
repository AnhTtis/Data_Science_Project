\section{Interview Dataset}
\label{sec:dataset}

Audio recordings of 7,361 interviews are automatically transcribed with speaker identification by the online tool RevAI,\footnote{\url{https://www.rev.ai}} where 440 are manually corrected on speaker ID assignment for finetuning and evaluation of our models (Table~\ref{tab:annotated-data}).
...
Appendix \ref{app:interviewee-demographics} provides detailed demographics of the interviewees.
