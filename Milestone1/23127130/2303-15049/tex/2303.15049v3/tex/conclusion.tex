...
\noindent Our InterviewBot is a model-based dialogue system equipped with contextual awareness and topic sensitivity that conducts college admission interviews. 
...
The average satisfaction score of 3.5 projects the prevailing deployment of the InterviewBot for thousands of college applicants, especially for international students. 

With promising future applications, however, the current version of the InterviewBot has two major limitations. 
First, the early ending in Table~\ref{tab:interviewbot-error-analysis} still happens, where an ending utterance gets generated after an insufficient amount of turns, in which case, the interview may not cover critical aspects of the applicant.
