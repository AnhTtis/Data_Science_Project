...
Year-long STCF runs will produce data samples containing $\sim$3T $J/\psi$ events and $\sim$500B $\psi'$ events
for in-depth explorations of light hadron physics. At $E_{\rm c.m.}\approx4230$~MeV, the STCF will function as an
...
Many perturbative QCD properties can also be tested at the STCF, such as the determination of the $R$ values at various energies and therefore also the strong interaction coupling $\alpha_s$, especially at the $\tau$ threshold, as discussed in section 4.2. More data from the STCF can also be used to test NRQCD predictions for charmonium production with high precision.
...
The electroweak interaction based on $SU(2_L\times U(1)_Y$ is an integral part of the SM.
...
As discussed in section 4, the large number of $\tau$ pairs produced at the STCF will provide much more accurate measurements of the electroweak couplings and test the universality of the weak interaction. Many other SM parameters can also be measured to further test the SM.
...
Searching for a non-SM source of $CP$ violation (CPV) is a promising strategy for uncovering signs of physics beyond
...
(1) decays via a flavor-changing neutral current (FCNC),
(2) decays with lepton flavor violation (LFV), and
(3) decays with lepton number violation (LNV).
The STCF will support searches for $\tau$-lepton LFV and LNV decays with sensitivities of $10^{-8}$ to
$10^{-9}$. In addition, as discussed in section 7, it will serve as a platform to search for proposed new low-mass particles such as dark photons, light scalars and millicharged particles.
