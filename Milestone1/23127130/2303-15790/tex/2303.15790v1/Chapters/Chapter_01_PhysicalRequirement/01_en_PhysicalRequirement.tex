...
The proposed STCF in China is a symmetric electron-positron
collider designed to provide $e^{+}e^{-}$ interactions at $\sqrt{s}=\stcfene$.
The peaking luminosity is expected to be
$0.5\times10^{35}$~cm$^{-2}$s$^{-1}$ or higher at $\sqrt{s}=4.0$~GeV.
There is potential to increase luminosity and to realize longitudinal
$e^{-}$ beam polarization in future upgrades.
The STCF, operating at the transition interval between nonperturbative
QCD and perturbative QCD, would be one of the crucial precision frontiers
for exploring the nature of nonperturbative strong interactions, understanding
the internal structure of hadrons,
studying the asymmetry of matter-antimatter
in the baryon, lepton and charm meson sectors,
testing the SM with unprecedented precision and probing physics beyond the SM.
The STCF detector, a state-of-the-art $4\pi$-solid-angle particle detector
at a high luminosity collider, is a general-purpose detector.
It incorporates a tracking system composed of an ITK and MDC,
a PID system, an EMC,
a superconducting solenoid, and a MUD at the outermost.
With such high luminosity, the STCF is expected to deliver an integrated luminosity of more than 1~ab$^{-1}$
per year, which provides an excellent opportunity for a broad physics study in the
$\tau$-charm region. The physics programs to be investigated at the STCF are described in Chapter~\ref{CDR_phys}.

To access the physics potential and scientific merits of the STCF and to understand the demands on the
...
including $CPV$ tests in the $\tau$ lepton, baryon and charm meson sectors, searches for charged lepton flavor violations~(cLFVs), tests of the unitarity of the CKM matrix, nucleon structure research via electromagnetic form factors and fragmentation functions {\it, etc. }.
...
The main goal of the STCF is to precisely measure the production and decay properties of various particles, {\it i.e.}, charmonium states, $XYZ$ particles,
...
results, as shown in Fig.~\ref{D0}(b) and (c).
...
In addition, the photon energy can be as low as dozens of MeV, such as $\psi(2S)\to\gamma\eta_{c}(2S)$ and $D_{s}^{*}\to\gamma D_{s}$. The requires the detector
...
The identification of $\pi$ and $K$ at the STCF is essential for charm physics, tau physics 
and fragmentation function~(FF) studies etc.
The momentum region of $\pi/K$ produced from charm hadrons or tau leptons are within 1.5 GeV
