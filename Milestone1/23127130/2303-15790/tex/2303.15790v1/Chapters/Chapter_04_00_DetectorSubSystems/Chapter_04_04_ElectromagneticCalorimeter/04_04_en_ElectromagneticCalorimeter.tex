...
Considering the high background at the STCF, the EMC background is studied by Monte Carlo simulation. The simulated background energy distribution of the EMC is shown in Fig.~\ref{Fig4:ECAL Background-Energy-CR}(a). Figure~\ref{Fig4:ECAL Background-Energy-CR}(b) shows the background counting rate at each position of the calorimeter (with a threshold value of 1~MeV). The background counting rate is close to about 1~MHz.
...
\item In addition to energy measurement, time measurement is needed and the precision should be better than 200 ps @ 1 GeV.
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure*}[htbp]
 \centering
  %\vskip -1.5cm
  \subfloat[][]{\includegraphics[width=0.45\textwidth]{Figures/Figs_04_00_DetectorSubSystems/Figs_04_04_ElectromagneticCalorimeter/ECAL-MIPs-55.pdf}}
  \subfloat[][]{\includegraphics[width=0.45\textwidth]{Figures/Figs_04_00_DetectorSubSystems/Figs_04_04_ElectromagneticCalorimeter/ECAL-MIPs-1010.pdf}}
