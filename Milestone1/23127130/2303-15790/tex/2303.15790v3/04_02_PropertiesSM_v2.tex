...
$B(K^- \to \mu^- \bar \nu_\mu) = (63.56\pm 0.11)\%$,
and
$B(K^-\to e^-\bar\nu_e) = ( 1.582\pm0.007)10^{-5}$~\cite{ParticleDataGroup:2022pth}.
...
Decays of the form $\tau \to l \bar \nu_l \nu_\tau$ provide sensitive constraints on other forms of interactions due to new physics. Barring exotic interactions such as tensor couplings, the most general form of new physics can be parameterized in terms of the Michel parameters $\rho$, $\eta$, $\xi$, and $\delta$~\cite{ParticleDataGroup:2022pth}:
\begin{eqnarray}
...
\end{eqnarray}
Experimentally, the values are~\cite{ParticleDataGroup:2022pth}
\begin{eqnarray}
