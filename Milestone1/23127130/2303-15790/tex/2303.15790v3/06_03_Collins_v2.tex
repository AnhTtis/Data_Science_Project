...
The general form of these angular distributions can be found in Ref.~\cite{TMDFF}. Studies of the production
...
Collins function can be measured at the STCF. Theoretical predictions concerning the Collins effect in the energy region of $\sqrt{s}\sim 4$~GeV have been presented in Ref.~\cite{SY}.
...
in semi-inclusive deep in-elastic scattering~(DIS), for which one needs to know the TMD parton fragmentation functions in order to extract the TMD parton distribution functions.
