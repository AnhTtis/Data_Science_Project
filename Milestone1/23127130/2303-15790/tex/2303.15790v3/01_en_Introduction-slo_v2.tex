...
accurately describes the transitions between quarks and hadrons. However, at the relevant distance scale
on the order of 1~fm (see Fig.~\ref{fig:SM-free-params}(b)), QCD is a strongly coupled theory, and perturbation theory is not directly applicable.
As a result, the spectrum and properties of
various particles that are seen in experiments haven't been well understood in theory.

\begin{figure}[htbp]
\begin{center}
\begin{overpic}[width=15cm, height=6.cm, angle=0]{Figs_01_Introduction/SM-free-params.pdf}
\end{overpic}
