...
Starting with the discovery of the charmed quark and the $\tau$ lepton during the 1974 ``November Revolution''~\cite{Galison:1992us}, the results
...
SM and to searches for new physics beyond the SM. Of these, the BEPC/BES facility in Beijing, China, is no doubt one of the
most prolific TCFs.
...
explained as a ``smoking-gun'' candidate for a QCD hybrid meson comprising a quark--antiquark pair plus a valence gluon,
...
BESIII) and precise measurements of the hyperon decay parameters and tests of $CP$ invariance in
...
semileptonic decays of $D$ and $D_s$ mesons produced the world's best measurements of the CKM
...
previously unseen modes, dominate the Particle Data Group (PDG)~\cite{PDG2022} listings for this state. In addition, the large samples of $CP$-tagged
...
Measurements of $e^+e^-$ annihilations for CME values between 2.0 and 3.67~GeV have provided R measurements with an unprecedented precision of
...
support detailed studies of charmonium-like $XYZ$ mesons, including some of BESIII's most remarkable results, such as
...
lower than the world average of all previous measurements. It clarified what was the major discrepancy with the SM at that
...
and their underlying dynamics, measurements of $CP$ violation in hyperon decays and other systems, $\tau$ physics and
...
data samples will have distinctly lower backgrounds, near-100\% detection efficiencies, better full-event reconstruction
...
Belle II and LHCb, including the direct production of $1^{--}$ resonances such as charmonium ($J/\psi$, $\psi^{\prime}$
and $\psi^{\prime\prime}$) and nonstandard charmonium-like mesons, such as $Y(4260)$, $Y(4320)$ and $Y(4660)$, as well as operation near
...
A low-mass silicon pixel detector based on the CMOS
MAPS technology is also considered as an alternative option.
...
A hybrid of RPC (3 inner layers) and plastic scintillator (7 outer layers) detectors is proposed as the MUD,
