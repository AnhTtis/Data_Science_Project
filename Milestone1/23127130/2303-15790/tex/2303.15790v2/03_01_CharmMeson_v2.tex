...
${\mathcal B}(D^+\to \mu^+\nu_\mu)$ & $5.1\%_{\rm stat}\,1.6\%_{\rm syst}$~\cite{bes3_muv} &$0.28\%_{\rm stat}$ & $2.8\%_{\rm stat}$~\cite{Kou:2018napp}  \\
...
their precisions are expected to be below 0.1\%. This means that the sizes of the systematic uncertainties at the STCF will be crucial and must be improved to the level of 0.1\%.
In particular, the efficiencies of muon and electron identification will be critical and must be optimized to constrain the total uncertainty to the level of 0.1\%.
...
\end{eqnarray}
Using the world average values of the masses of the leptons and $D^+_{(s)}$~\cite{PDG2022}, one obtains $R_{D^+}=2.67\pm 0.01$ and $R_{D^+_s}=9.75\pm0.01$.
...
neutrinos are Majorana particles. It is therefore meaningful to
...
< 6.2 \times 10^{-9}$ \cite{PDG2022}. However, the semileptonic decays
$D^0\to\pp\MM$, $\kk\MM$ and $K^-\pi^+ \MM$
have been observed at LHCb with BFs at a level of $10^{-7}$~\cite{PDG2022}.
...
Compared to Belle II and LHCb, the STCF has competitive sensitivities in channels that contain neutral final states, such as photons and $\pi^0$, because of its clean backgrounds.
...
(with the exception of ${\cal B}(D^0 \to \mu^\pm e^\mp)<1.3\times 10^{-8}$)~\cite{PDG2022}.
...
\subsubsection{Charmed-meson spectroscopy}
