...
\ifthenelse{\equal{\draftversion}{true}}{
  ...
  \def\tentx#1{\textcolor{blue}{#1}}   % for tent changes by XL
...
\def\tenti#1{\textcolor{red}{#1}}   % for tent changes by IS
  ...
  \def\tentx#1{{#1}}   % for tent changes by XL
...
\def\vk{\mathbf{\tilde v}}
\def\ek{\tilde \epsilon_\kk}
\def\rdot{\mathbf{\dot{r}}}
\def\kdot{\mathbf{\dot{k}}}
\newcommand{\wt}[1]{\widetilde{#1}}
\def\OO{\mathbf{\Omega_\kk}}
\def\ff{\tilde f}
