...
\node[rectangle,  draw = black!60, fill = green!50!black, minimum height = 0.5 cm, minimum width = 0.3 cm, opacity=.5, text opacity=1, right = 0.1 cm of a11.north east, anchor = north west] (b11) node[below = 0 of b11, color = green!50!black] (c11) {\begin{varwidth}{0.6cm} \centering \small $g(P_3)$ \end{varwidth}} %
node[left = -0.2 of c11.west, anchor = east, color = bleudefrance] { \centering \small %\uncover<4->{ {\color{magenta}$h(0)=$}}
{\color{bleudefrance}$f(P_3)$}};
...
\node[rectangle,  draw = black!60, fill = green!50!black, minimum height = 0.5 cm, minimum width = 0.3 cm, opacity=.5, text opacity=1, right = 0.1 cm of a12.north east, anchor = north west] (b12) node[below = 0 of b12, color = green!50!black] (c12) {\begin{varwidth}{0.6cm} \centering \small $g(P_6)$ \end{varwidth}} %
node[left = -0.2 of c12.west, anchor = east, color = bleudefrance] { \centering \small %\uncover<4->{ {\color{magenta}$h(\alpha^5)=$}} 
{\color{bleudefrance}$f(P_6)$}};;
...
\node[rectangle,  draw = black!60, fill = green!50!black, minimum height = 0.5 cm, minimum width = 0.3 cm, opacity=.5, text opacity=1, right = 0.1 cm of a13.north east, anchor = north west] (b13) node[below = 0 of b13, color = green!50!black] (c13) {\begin{varwidth}{0.6cm} \centering \small $g(P_7)$ \end{varwidth}} %
node[left = -0.2 of c13.west, anchor = east, color = bleudefrance] { \centering \small %\uncover<4->{ {\color{magenta}$h(\alpha^{10})=$}} 
{\color{bleudefrance}$f(P_7)$}};;

\node[rectangle,  draw = black!60, fill = bleudefrance, minimum height = 0.3 cm, minimum width = 0.5 cm, opacity=.5, text opacity=1, below right = 0.1 and 0.25 cm of w4.south west, anchor = north west] (a14);
\node[rectangle,  draw = black!60, fill = green!50!black, minimum height = 0.5 cm, minimum width = 0.3 cm, opacity=.5, text opacity=1, right = 0.1 cm of a14.north east, anchor = north west] (b13) node[below = 0 of b13, color = green!50!black] (c13) {\begin{varwidth}{0.6cm} \centering \small$g(P_8)$ \end{varwidth}} %
node[left = -0.2 of c13.west, anchor = east, color = bleudefrance] { \centering \small %\uncover<4->{ {\color{magenta}$h(\alpha^{15})=$}} 
{\color{bleudefrance}$f(P_8)$}};;
}
...
\path<2-3>[<-]
(w1.north)  edge[bend left] node[above left = 0 cm and -1cm, midway, sloped, font=\small] {$f(P_3),g(P_3)$} (m)
[->]
(m) edge[bend right] node[right = -0.2cm, below=-0.05cm, midway, sloped, font=\small] {$f(P_6),g(P_6)$} (w2)
[<-]
(w3.north) edge[bend right] node[above right = 0 cm and -0.8cm, midway, sloped, font=\small] {$f(P_7),g(P_7)$} (m)
[<-]
(w4.north) edge[bend right] node[above right = 0 cm and -0.8cm, midway, sloped, font=\small] {$f(P_8),g(P_8)$} (m)
;
\path<4->[->, color = magenta]
(w1.north)  edge node[above left = 0 cm and -1cm, midway, sloped, font=\small] {$h(P_3)$} (m)
[<-]
(m) edge node[right = -0.2cm, above=0.05cm, midway, sloped, font=\small] {$h(P_6)$} (w2)
[->]
(w3.north) edge node[above right = 0 cm and -0.8cm, midway, sloped, font=\small] {$h(P_7)$} (m)
[->]
(w4.north) edge node[above right = 0 cm and -0.8cm, midway, sloped, font=\small] {$h(P_8)$} (m)
;
