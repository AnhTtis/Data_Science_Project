...
\node<3->[rectangle,  draw = black!60, fill = darkturquoise, minimum height = 2 cm, minimum width = 1cm, opacity=.5, text opacity=1] (a) at (-.5,0) (F1) { };
...
\node<3->[rectangle,  draw = black!60, fill = darkturquoise, minimum height = 2cm, minimum width = 1cm, opacity=.5, text opacity=1] (b) at (5.5,0) (F3) {};

\node[] (server1) at (6,1.5) {\LARGE Server $3$};

\node[rectangle,  draw = black!60, fill = bleudefrance, minimum height = 2cm, minimum width = 2cm, opacity=.5, text opacity=1] (F4) at (9,0) {\huge $f(\alpha_4)$ };

\node<3->[rectangle,  draw = black!60, fill = darkturquoise, minimum height = 2cm, minimum width = 1cm, opacity=.5, text opacity=1] (b) at (8.5,0) { };
...
\node<3->[rectangle,  draw = black!60, fill = darkturquoise, minimum height = 2cm, minimum width = 1cm, opacity=.5, text opacity=1] (b) at (17.5,0) (Fn) {};
...
\path<3->[->]
(F1)  edge[very thick,bend right] node[above left = 0 cm and -1cm, midway, sloped, font=\small] {\large$\tr(f(\alpha_1))$} (GF5)
(F3)  edge[very thick] node[above left = 0 cm and -1cm, midway, sloped, font=\small] {\large$\tr(f(\alpha_3))$} (GF5)
(Fn)  edge[very thick,bend left] node[above left = 0 cm and -1cm, midway, sloped, font=\small] {\large$\tr(f(\alpha_n))$} (GF5)
(F4)  edge[very thick,bend left] node[above left = 0 cm and -1cm, midway, sloped, font=\small] {\large$\tr(f(\alpha_4))$} (GF5);
;
