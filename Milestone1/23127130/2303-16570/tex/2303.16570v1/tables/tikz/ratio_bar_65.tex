...
($(path picture bounding box.north) + (0.2, 0)$) --
($(path picture bounding box.south) + (0.2, 0)$) -- cycle;}}
}
...
\tikzstyle{every state}=[           rectangle,
  ...
  \draw[draw=bar_border] ($(bb.north) + (0.2, 0)$) --
($(bb.south) + (0.2, 0)$);
  
  \node (geo) [align=center] at (-0.85,0) {\small $65\%$};
