...
\input{figures/teaser/teaser_small.tex}
...
After pre-training on the ShapeNet dataset\,\cite{chang2015shapenet}, our experiments demonstrate that \name{} outperforms other self-supervised methods on both the ModelNet40\,\cite{wu2015modelnet40} and ScanObjectNN\,\cite{uy2019scanobjectnn} shape classification benchmarks.
...
\emakefirstuc{\name{}} learns strong and transferable features in a self-supervised manner, outperforming top-performing self-supervised approaches on several downstream tasks.
