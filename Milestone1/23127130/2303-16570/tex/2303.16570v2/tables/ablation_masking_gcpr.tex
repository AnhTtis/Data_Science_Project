...
\parbox{.5\linewidth}{
    ...
    {\vspace{-10pt}\includegraphics[width=0.51\linewidth]{tables/ablation_masking/rand_65_0_gray_crop.png}}
    \subcaptionbox{65\% \emph{block} masking\vspace{-5pt}}{\vspace{-10pt}\includegraphics[width=0.51\linewidth]{tables/ablation_masking/block_65_0_gray_crop.png}}
}
\hspace{-75px}
\parbox{.6\linewidth}{
    \centering
