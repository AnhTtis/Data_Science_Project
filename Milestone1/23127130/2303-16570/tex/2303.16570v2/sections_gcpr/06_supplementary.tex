...
Our code and model are publicly available for research purposes.
\end{abstract}
...
\input{tables/ablation_gcpr_supp}
\parag{Target Layer Aggregation.}
...
\vspace{10pt}
\parag{Pre-Training Data Efficiency.}
...
\parag{Class Confusions on ModelNet40.}
...
\input{tables/hyperparameters_gcpr}
