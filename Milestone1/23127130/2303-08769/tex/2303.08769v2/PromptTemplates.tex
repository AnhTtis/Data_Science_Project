...
& {1. Credibility {\color{red}High}: ``Burj Khalifa.''... 
 this is the official website of the building, providing accurate information.} \\

& {2. Credibility {\color{red}High}: ``The Tallest Buildings in the World.'' Council on Tall Buildings and Urban Habitat... this is a well-respected organization in the field of tall building and urban habitat research.} \\

& {3. Credibility {\color{red}Medium}: ``The Tallest Buildings in the World.'' World Atlas..., 
this is a well-known website providing accurate information on different topics.} \\
\bottomrule
\end{tabular}
};
