...
% Title.
% ------
\title{AD-YOLO: You Look Only Once in training \\ Multiple Sound Event Localization and Detection}
%
% Single address.
% ---------------
...
To address the issue, we proposed an angular-distance-based multiple SELD (AD-YOLO), which is an adaptation of the ``You Look Only Once" algorithm for SELD.
...
We adapt the framework of "You Look Only Once" (YOLO) \cite{Redmon_2016_CVPR}, renowned for multiple object detection from images, to the SELD by using the notion of angular distance, namely proposing angular-distance-based YOLO (AD-YOLO).
