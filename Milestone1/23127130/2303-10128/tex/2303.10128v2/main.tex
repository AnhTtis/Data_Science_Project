...
% \include{references} % we had to discard this solution as it created new problems
...
% The editor wants Section for section, subsection and subsubsection (in stead of the \autoref{} defaults)
% https://tex.stackexchange.com/questions/537420/rename-autoref-subsection-false-with-babelenglish
% DO NOT MOVE THE FOLLOWING COMMANDS BEFORE \begin{document} (they will cease to work)
...
JCM: Writing-review \& editing, Resources;
MW: Writing-review \& editing;
CB: Conceptualization, Writing-review \& editing;
RFC: Conceptualization, Formal analysis, Funding acquisition, Methodology, Project Administration, Supervision, Writing-original draft, Writing-review \& editing.
}
...
Wissenschaftlichen Forschung} (Non-randomness in Morphological Diversity: A Computational Approach Based on Multilingual Corpora, 176305). RFC is supported by a recognition 2021SGR-Cat (01266 LQMC) from AGAUR (Generalitat de Catalunya).
