All the code used to produce the results is available in the repository of the article.\footnote{In the \textit{code} folder of \url{\repository}.}
...
When measuring the association between two variables, we  use both Pearson correlation and Kendall correlation \parencite{Conover1999a}. 
% Note that the traditional view of Pearson being a measure of linear association and Kendall correlation being a measure of monotonic non-linear association has been challenged \parencite{vandenJeuvel2022a}. 
Note that the traditional view of Pearson correlation as a measure of linear association and thus not suitable for non-linear association has been challenged \parencite{vandenJeuvel2022a}. 
