...
%, but with some minor changes: Dhivehi gains significance reaching 99\%, while
 but when length is measured in duration Panjabi ceases to be significant at the 95\% confidence level. Overall, we only fail to find the law of abbreviation in Panjabi given word durations, and using Pearson correlation. This is certainly related to undersampling, as this particular language only features 98 tokens (\autoref{tab:coll_summary_cv}). 
