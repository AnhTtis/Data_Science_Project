...
\begin{document}
	\begin{frontmatter}
	    ...
	    \author[fias,cuhk]{Kai Zhou\corref{mycorrespondingauthor}}
		...
		\address[fias]{Frankfurt Institute for Advanced Studies (FIAS), D-60438 Frankfurt am Main, Germany.}
            \address[cuhk]{School of Science and Engineering, The Chinese University of Hong Kong, Shenzhen 518172, China}
	...
	This work was supported by the Germany BMBF funded KISS consortium (05D23RI1) in the ErUM-Data action plan (KZ), the AI grant of SAMSON AG, Frankfurt (LW and KZ), Xidian-FIAS International Joint Research Center (LW), Huawei Technologies Co., Ltd and the National Natural Science Foundation of China under contract No. 12075098 (LP), Tsinghua University under grant No. 53330500923 (SS), and U.S. Department of Energy, Office of Science, Office of Nuclear Physics, grant No. DE-FG88ER40388 (SS).
