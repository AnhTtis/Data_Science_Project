...
Furthermore, in \cite{RoyChowdhury:2022awr} the previous observation was exploited in detail and two proposals were given regarding the saturation of mutual information (of various subsystems) for two different time domains (before and after the Page time). However, these works were only restricted to the eternal black holes in AdS and asymptotically flat spacetime. In this work, we shall see whether these proposals hold for eternal black holes in de-Sitter spacetime or not. We would like to mention that our work does not take into account certain subtleties in graviational theories, for example diffeomorphism invariance, which enables an arbitrary definition of a subregion. A discussion on this aspect can be found in \cite{Geng:2020fxl,Geng:2021hlu,Raju:2021lwh} which shows that it can have important implications to quantum gravity.
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.5]{Only_SdS.pdf}
...
\begin{figure}[!h]
	\begin{minipage}[t]{0.48\textwidth}
		\centering\includegraphics[width=\textwidth]{BH_Patch.pdf}\\
		{\footnotesize  Black hole patch}
	\end{minipage}\hfill
	\begin{minipage}[t]{0.48\textwidth}
		\centering\includegraphics[width=\textwidth]{CH_Patch.pdf}\\
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=.5]{SdS_with_brane_BH_without_island.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{SdS_with_brane_BH_with_island.pdf}
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.5]{SdS_with_brane_CH_without_island.pdf}
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.5]{SdS_with_brane_CH_with_island.pdf}
...
\noindent ARC would like to thank SNBNCBS for Senior Research Fellowship. AS would like to acknowledge the support by Council of Scientific and Industrial Research (CSIR, Govt. of India) for the Senior Research Fellowship. The
authors would like to thank the anonymous referee for very
useful comments. 
