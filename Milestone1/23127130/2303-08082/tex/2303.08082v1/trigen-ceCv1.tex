...
\foreach \s in {1,...,6}
\path (60:{0.8*(\s-0.5)}) node[left]{$\s$}
	++({4.8-0.8*(\s-0.5)},0) node[right]{$\s$};
...
\draw[->,red,edge,decorate,
	...
	(4.8,0) ++ (120:0.4) -- ++(-150:\half)
	-- ++(150:\full) -- ++(-150:\full) -- ++(150:\full) -- ++(-150:\full)
	-- ++(150:\full) -- ++(90:\full) -- ++(150:\full) -- ++(-150:\full)
	-- ++(150:\full) -- ++(-150:\full) -- ++(150:\half);
\end{tikzpicture}