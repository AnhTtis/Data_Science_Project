...
\coordinate (C) at (1.5,\len);
\begin{scope}[edge]
\draw[-o-={0.3}{<}] (60:3) ++(0.5,0)node[above]{\stsize$n$ }
	to[out=-90,in=30] (C);
\draw[-o-={0.3}{<}] (60:3) ++(1,0)node[above]{\stsize$\bar{i}$}
	to[out=-90,in=30] (C);
\draw[-o-={0.3}{<}] (3,0) ++(-120:0.5)node[right]{\stsize$n$}
	to[out=150,in=-90] (C);
\draw[-o-={0.3}{<}] (3,0) ++(-120:1)node[right]{\stsize$\bar{j}$}
	to[out=150,in=-90] (C);
\draw[-o-={0.3}{<}] (0,0) ++(120:0.5)node[left]{\stsize$n$}
	to[out=30,in=150] (C);
\draw[-o-={0.3}{<}] (0,0) ++(120:1)node[left]{\stsize$\bar{k}$}
	to[out=30,in=150] (C);
