...
\draw[very thick] (0.8,0) ++(60:1.6) -- +(-60:1.6) ++(0.8,0) -- +(-60:1.6);
\draw[very thick] (0.8,0) ++(60:0.8) -- +(-60:0.8);

\fill (1.6,0) ++(60:0.8) coordinate(v)
	circle[radius=0.1];% ++(0,-0.4)node{$v$};
\foreach \x in {1.6,2.4,3.2}
\draw (\x,0) circle[radius=0.15];
\draw (1.6,-0.4)node{$-1$} (2.4,-0.4)node{$1$} (3.2,-0.4)node{$0$};
