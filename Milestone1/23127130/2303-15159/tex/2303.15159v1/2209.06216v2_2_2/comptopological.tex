...
\begin{figure}[h!]
\centering
      \includegraphics[width=0.5\textwidth,angle=0]{2209.06216v2 2 2/coulombtubeSU5.png}
...
\begin{figure}[h]
\centering
      \includegraphics[width=0.5\textwidth,angle=0]{2209.06216v2 2 2/dumbbellSU5.png}
...
\includegraphics[width=0.5\textwidth,angle=0]{2209.06216v2 2 2/monopoledumbbell_afterEW_SU5a.png}


\includegraphics[width=0.5\textwidth,angle=0]{2209.06216v2 2 2/monopoledumbbell_afterEW_SU5b.png}
...
\begin{figure}[h]
\centering
      \includegraphics[width=0.55\textwidth,angle=0]{2209.06216v2 2 2/starfishSU5.png}
...
%\begin{figure}[h]
%\centering
 %     \includegraphics[width=0.35\textwidth,angle=0]{2209.06216v2 2 2/Uchi_UY_monopole_SU5.png}
 %       \caption{$SO(10)$ multimonopole with full $U(1)_\chi$ and $U(1)_Y$ Coulomb fluxes.}
  %\label{Uchi_UY_monopole_SU5}
%\end{figure}
\begin{figure}[h]
\centering
      \includegraphics[width=0.55\textwidth,angle=0]{2209.06216v2 2 2/starfish_afterEW_SU5.png}
...
\Fig{starfishSU5} since $U(1)_Y$ is contractible in $SU(5)$. This makes the stability of the central multimonopole much more secure in a range of parameters. However, after the EW breaking the $U(1)_Y$ $\Z_5$ tubes from the peripheral antimonopoles will be created and terminate on the central multimonopole. This requires that the $U(1)_Y$ flux of this monopole is excited again and this may destabilize it leading to its breaking into five monopoles. The whole starfish-like configuration may then decay, after the EW breaking, into five dumbbells which finally contract. 
...
\begin{figure}[h!]
\centering
      \includegraphics[width=0.6\textwidth,angle=0]{2209.06216v2 2 2/necklaceSU5.png}
...
\begin{figure}[h]
\centering
      \includegraphics[width=0.65\textwidth,angle=0]{2209.06216v2 2 2/necklace_afterEW_SU5.png}
...
\begin{figure}[h]
\centering
      \includegraphics[width=0.65\textwidth,angle=0]{2209.06216v2 2 2/domainwall_necklace_SU5.png}
...
\centering
      ...
      \includegraphics[width=0.6\textwidth,angle=0]{2209.06216v2 2 2/dumbbell422.png}
...
\centering
      ...
      \includegraphics[width=0.6\textwidth,angle=0]{2209.06216v2 2 2/dumbbell_afterEW_422.png}
...
\centering
      ...
      \includegraphics[width=0.45\textwidth,angle=0]{2209.06216v2 2 2/monopole_threetubes_422.png}
...
\centering
      ...
      \includegraphics[width=0.67\textwidth,angle=0]{2209.06216v2 2 2/polypole422.png}
...
\centering
      ...
      \includegraphics[width=0.8\textwidth,angle=0]{2209.06216v2 2 2/polypole_afterEW_422.png}
...
\centering
      ...
      \includegraphics[width=0.8\textwidth,angle=0]{2209.06216v2 2 2/stablepolypole_afterEW_422.png}
...
To secure the stability of the central trimonopole we can remove the contractable loop in $SU(3)_c$ so that the initial Coulomb flux of the trimonopole is 3(B-L) instead of 3X. The configuration in  \Fig{polypole_afterEW_422} then transforms into the one shown in \Fig{stablepolypole_afterEW_422}. Here we took an extra $T^8_c$ flux together with the extra $T^3_L$ flux with each blue monopole. The Coulomb fluxes correspond to unbroken generators and the behavior of the VEVs of the $\nu^c$-type, $h_u$, $h_d$ Higgs fields around the tube is the same as before. The total Coulomb flux is again twice the Schwinger flux.

 

\subsection{Necklace configurations}
In the case with topologically stable $\Z_2$ strings where the VEVs of a $\nu^c\nu^c$-type Higgs field and its conjugate are used, the combined tube in \Fig{dumbbell_afterEW_422} splits into two equal ones as shown in \Fig{splittube422}. We can connect the loose ends in \Fig{splittube422} to construct necklaces of all kinds which can contain both red and blue monopoles and their antimonopoles. Each red monopole can connect with its antimonopole or a blue monopole, and similarly each blue monopole with its antimonopole or a red one. All these configurations are realizations of the $\Z_2$ string since if one inverts the arrows in all lines, the resulting configuration remains unaltered, as displayed with an example in \Fig{necklace422}. 
\begin{figure}[h]
\centering

\includegraphics[width=0.68\textwidth,angle=0]{2209.06216v2 2 2/splittube422a.png}
\includegraphics[width=0.68\textwidth,angle=0]{2209.06216v2 2 2/splittube422b.png}
...
\centering
      ...
      \includegraphics[width=0.8\textwidth,angle=0]{2209.06216v2 2 2/necklace422.png}
...
Note that the brown monopole is the antimonopole of the blue monopole and the green monopole is the antimonopole of the red one, and one can imagine a variety of such necklaces. Their overall Coulomb magnetic flux is a multiple of the Schwinger monopole flux. In particular, the flux of the necklace in \Fig{necklace422} is minus the Schwinger flux.
...
\centering
      ...
      \includegraphics[width=0.3\textwidth,angle=0]{2209.06216v2 2 2/UX_UZ_monopole_flipped.png}
...
\centering
      ...
      \includegraphics[width=0.55\textwidth,angle=0]{2209.06216v2 2 2/coulombtubeflip.png}
...
\centering
      ...
      \includegraphics[width=0.55\textwidth,angle=0]{2209.06216v2 2 2/dumbbellflip.png}
...
\centering
      ...
      \includegraphics[width=0.48\textwidth,angle=0]{2209.06216v2 2 2/dumbbell_afterEW_flip.png}
...
\centering
      ...
      \includegraphics[width=0.4\textwidth,angle=0]{2209.06216v2 2 2/monopole_SU2flux_flip.png}
...
\centering
      ...
      \includegraphics[width=0.35\textwidth,angle=0]{2209.06216v2 2 2/monopole_colorflux_afterEW_flip.png}
...
\centering
      ...
      \includegraphics[width=0.35\textwidth,angle=0]{2209.06216v2 2 2/unconfinedSO10_flip.png}
...
\centering
      ...
      \includegraphics[width=0.6\textwidth,angle=0]{2209.06216v2 2 2/monopolecolorflux_tube_flip.png}
...
\centering
      ...
      \includegraphics[width=0.65\textwidth,angle=0]{2209.06216v2 2 2/dumbbell_colorflux_flip.png}
...
\centering
      ...
      \includegraphics[width=0.45\textwidth,angle=0]{2209.06216v2 2 2/coulombtube_afterEW_flip.png}
...
\centering
      ...
      \includegraphics[width=0.55\textwidth,angle=0]{2209.06216v2 2 2/necklaceflip.png}
