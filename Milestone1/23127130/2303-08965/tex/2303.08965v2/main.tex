...
\newcommand{\revise}[1]{\textcolor{black}{#1}} % Change 'red' to any color you prefer
...
\author{Yuki Shirai$^{\ddagger}$, Devesh K. Jha$^{\ddagger\dagger}$, and Arvind U. Raghunathan$^{\ddagger}$ %   
\thanks{$^{\ddagger}$Yuki Shirai, Devesh K. Jha and Arvind U. Raghunathan are with Mitsubishi Electric Research Laboratories (MERL), Cambridge, MA, USA 02139 {\tt\small \{shirai,jha,raghunathan\}@merl.com}}
...
\input{introduction}
\input{related_work}
\input{mechanics_formulation}
\input{robust_pivoting_formulation.tex}
\input{robust_to}
