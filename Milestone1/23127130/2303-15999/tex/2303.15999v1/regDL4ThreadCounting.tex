...
In this work, we focus on the plain weave and its threads density. Plain weave\footnote{Also known as taffeta, tabby or calico weave.} fabrics are predominant. They are the support for a vast number of paintings thanks to their good compromise between robustness and simplicity \cite{Vanderlip80}. Plain weave is characterized by an intertwining of the vertical threads with the horizontal ones, see Fig. \ref{fig:Taffeta}.a. A set of threads are arranged in parallel on a loom from back to front before starting to weave. These threads are called the warp. The separation between the warp threads follows a deterministic pattern that is determined by their placement on the loom. On the other hand, the weaver pass another thread orthogonally to the warp from one side to the other, tighten it, and pass it back, intertwined. This other thread is the weft. Since weft tightening follows a manual process, %we can expect a certain randomness, and 
...
\centering
\begin{tabular}{cc}
 \includegraphics[width=3.5cm]{figures/tafetanML.png} &\includegraphics[width=4.0cm]{figures/flavorsReg.png}\\
 (a) & (b) 
 \end{tabular}
\caption{In (a) an sketch of plain weave with warp and weft yarns in weaving as described in \cite{Barlow1878} and in (b) crops of 1 cm side from X-ray plates of paintings using plain weave. 
...
\item Improvements in the DA stage: the limitation of the maximum random rotations and the inclusion of more crops from labeled samples to enlarge the dataset.% from 21,540 to 30,156 images.
...
\centering
\begin{tabular}{cccc}
 \includegraphics[width=3.8cm]{figures/oldZoom.png}& 
 \includegraphics[width=3.8cm]{figures/windowZoom.png}\\
(a) & (b) 
\end{tabular}
...
\begin{figure}[htbp]
\centering
 \includegraphics[width=7.7cm]{figures/Inception2.pdf}
...
\begin{figure}[htbp]
\centering
 \includegraphics[width=7.7cm]{figures/Reg_Unet3.pdf}
...
\begin{figure}[htbp]
\centering
 \includegraphics[width=8.1cm]{figures/Reg_model3.pdf}
...
\begin{figure}[htbp]
\centering
 \includegraphics[width=8cm]{figures/RegVGG_model3.pdf}
...
\begin{figure}[htp]
\centering
\input{figures/boxRegressionValidationNMAEVBS32.tex}
...
\begin{figure}[htbp]
\centering
\input{figures/boxRegressionTestNMAEBS32.tex}
...
Regarding DA, adding central crops is also of interest as we are enlarging the data set. Besides, limiting the maximum angle of the random rotations in DA helps to achieve a solution with lower error. 
%
...
%\input{figures/boxRegressionValidationVGGNMAEV1.tex}
...
\centering
%\includegraphics[width=8cm]{../figsDef/boxRegressionValidationAblationNMAEV2}
\input{figures/boxRegressionTestVGGNMAEV1.tex}
\caption{Box diagram of the average NMAE (\%) of the density estimations for the test dataset in the ablation study: the regression model considered (Reg) without equalization (No-Eq), a pre-processing with fixed window (Fix-Win), removing images taken from the central parts of the labeled samples (No-Crops), and limiting the maximum value of the random crop in DA (2xAngle). In each case, 10 different trainings were run. Outliers are represented with diamonds. }  
...
\textbf{Input:} Pre-processed crops and counts (predictions), trained regression DL model.
\begin{algorithmic}[1]
\State  Create a dataset with input crops where the error in the estimation of FT and regression DL in  both vertical and horizontal threads is under 4\%. 
...
\input{figures/ResultsTest_SS.tex} \\
 (a) \\
\input{figures/RegressionVGGTest.tex} \\
 (b) \\
\input{figures/model11BG4.tex}\\
 (c) \\ 
 \input{figures/FT_TestFig.tex}
 \\
 (d) 
\end{tabular}
...
\begin{tabular}{cc}
% \includegraphics[width=11cm]{../figsDef/JUNTOS.png} \\
\includegraphics[width=7cm]{figures/Ribera3} &  \includegraphics[width=7cm]{figures/RiberaFT3}\\
 (a)& (b) \\
 \includegraphics[width=7cm]{figures/RiberaEqNMAE3}&\includegraphics[width=7cm]{figures/RiberaEqNMAESS3}\\
 (c)& (d) \\
\end{tabular}
...
\begin{tabular}{cccc}
% \includegraphics[width=11cm]{../figsDef/JUNTOS.png} \\
\includegraphics[width=13cm]{figures/SPM15v2} \\
 (a) \\
 \includegraphics[width=13cm]{figures/PoussinReg10VGG}\\
 (b) \\
\end{tabular}
...
\begin{figure}[!tp]
\centering
  \includegraphics[width=4.5cm]{figures/piezaPan}
...
\centering
\begin{tabular}{cccc}
 \includegraphics[width=3.57cm]{figures/P01196vis}& 
  \includegraphics[width=3.61cm]{figures/P01195vis}\\
(a) & (b) 
\end{tabular}
...
\centering
\begin{tabular}{cccc}
 \includegraphics[width=3.235cm]{figures/p01195elVertSegPaper}&
  \includegraphics[width=4.1cm]{figures/p01195elVertRegSS} 
\\
 (a) & (b)
\end{tabular}
...
\begin{figure}[!tp]
\centering
 \includegraphics[width=7cm]{figures/matchVelazquez}
...
\centering
\begin{tabular}{cccc}
 \includegraphics[width=4cm]{figures/P001127}& 
  \includegraphics[width=3.2cm]{figures/P007113}\\
(a) & (b) 
\end{tabular}
...
\begin{tabular}{cccc}
% \includegraphics[width=11cm]{../figsDef/JUNTOS.png} \\
\includegraphics[width=16cm]{figures/RizziFT} \\
 (a) \\
 \includegraphics[width=16cm]{figures/Rizzi}\\
 (b) \\
\end{tabular}
...
In Table \ref{tab:comptimesPlates} we report the times needed (in hours) to process some of the plates processed. We include the times invested by segmentation, regression and SS regression DL approaches. 
...
In the novel approach presented, we resort to the regression DL paradigm to directly estimate the thread density. We avoid the signal processing stage of previous segmentation DL methods and are able to define a loss function to measure the error in thread counting, reducing the error. Several models have been proposed, where hyperparameters have been selected through optimized search. %We tried to exploit the encoder layers in the U-Net used in segmentation DL, adding dense layers to estimate the thread density. 
%However, this 
...
\input{regDL4ThreadCounting.bbl}
