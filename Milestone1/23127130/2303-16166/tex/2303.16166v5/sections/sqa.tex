...
\textbf{Portability} and \textbf{usability} refer, respectively, to
the possibility of executing the same experiments in diverse hardware or software environments, and the effort required to use the software (i.e., how easy it is to run the code).
...
On the contrary, proper documentation of the code is a reasonable demand and, in addition to increasing reproducibility, it facilitates code reuse and
%its adoption as the foundation for future works.
adoption for other works.
...
Alongside comprehensive documentation, software maintainability hinges on code structure,
%(
...
is arguably 
%represents 
an excessive demand for research works not expressly dedicated to it.
