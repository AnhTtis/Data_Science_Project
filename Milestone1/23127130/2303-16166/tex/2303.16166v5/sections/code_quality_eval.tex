To assess the level of consideration given to the above SQA attributes within the NLP research community, we examined their inclusion in the review forms of top-tier conferences and journals in the field, namely: 
*ACL (i.e., AACL-IJCNLP, ACL, EACL, EMNLP, NAACL),\footnote{Since EACL 2024, *ACL conferences adopt ARR only.} ACL Rolling Review (ARR), ICASSP, ICML, ICLR, Interspeech, NeurIPS, and TACL.
