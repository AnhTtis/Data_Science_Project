...
The 2-dimensional invariant mass distribution of $\Jpsi$ pair candidates ($m_1(\mu_1^+ \mu_1^-)$, $m_2(\mu_2^+ \mu_2^-)$) is fit in the second step. 
\begin{eqnarray}
...
\begin{figure}[!htbp]
    ...
    \end{center}
    \caption{Projections of a fit to the 2-dimensional invariant mass distribution for inclusive $\Jpsi$ pair candidates for (left) $m_1(\mu_1^+ \mu_1^-)$ and (right) $m_2(\mu_2^+ \mu_2^-)$. 
...
\begin{equation}
 ...
 \epsilon  ({\rm J}/\psi)  \,.
\end{equation}
The $\Jpsi$ $\epsilon$ is computed from Monte Carlo simulations as described in Ref.~\cite{ALICE:2017leg}. 
