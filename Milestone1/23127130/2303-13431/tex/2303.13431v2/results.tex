...
\end{equation}
%
The ratio of the production cross section of the inclusive $\Jpsi$ pair to that of the inclusive $\Jpsi$ is 
\begin{equation}
...
The contamination from beauty-hadron decays to the $\Jpsi$ pair cross section is evaluated to assess the impact on the
...
The effective double-parton scattering cross section is evaluated neglecting the single-parton scattering contribution. 
