...
\item Consistency constraints capture the requirement to take medication consistently at a given time interval. For example, from the DUG for the medication Zocor: "Remember to take it at the \textbf{same time each day}."
...
\textbf{Specialized prompt:} We also develop prompts for extracting each of the MTC types separately. Each of the prompts contains a basic description of the MTC, as well as a heuristic for formatting the MTC correctly. This approach is referred to as the \textit{specialized} model.
