...
\subsection*{C.2.Hyperparameter}
\label{app_exp_hyper}
We have eleven experimental settings on four datasets. Across all experiments, some hyperparameter can be keeped the same value, but the others need fine-tuning. Specifically, we set ${\lambda}_{P-EDL}={\lambda}_{N-EDL}$ (in Eq. (8)), ${\lambda}_{1}=0.01$ (in Eq. (2)) for all experiments and we fine-tune ${\lambda}_{P-EDL}$, ${\lambda}_{CON}$ (in Eq. (7)) and ${\lambda}_{2}$ (in Eq. (3)). For Cifar-10, we set ${\lambda}_{P-EDL}=0.005$,  ${\lambda}_{CON}=0.005$ and ${\lambda}_{2}=0.002$. For Cifar-100, we set ${\lambda}_{P-EDL}=0.03$,  ${\lambda}_{CON}=0.04$ and ${\lambda}_{2}=0.01$. For Mini-ImageNet, we set ${\lambda}_{P-EDL}=0.03$,  ${\lambda}_{CON}=0.01$ and ${\lambda}_{2}=0.002$. For ImageNet-30, we set ${\lambda}_{P-EDL}=0.08$,  ${\lambda}_{CON}=0.01$ and ${\lambda}_{2}=0.01$.
