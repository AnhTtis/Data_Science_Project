...
\jsubfig{\includegraphics[height=2.78cm]{images/attention/crown/crown_2d.png}}{\footnotesize {2D Cross Attention Map}} %
...
\vspace{5pt} 
\caption{\textbf{Optimizing 3D cross-attention grids for edit localization}. %
