...
\subsection{Proof of Proposition~\ref{prop:grad-hess}}
\label{section:proof-grad-hess}
...
converges to zero. As long as the propensity scores are bounded below, the
...
\subsection{Proof of Proposition~\ref{prop:log-dts}}
