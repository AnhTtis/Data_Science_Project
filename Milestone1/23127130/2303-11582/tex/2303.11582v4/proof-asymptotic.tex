...
\subsection{Proof of Theorem~\ref{theorem:asymptotic-rho}}
\label{section:proof-asymptotic-rho}

The proof of Theorem~\ref{theorem:asymptotic-rho} first relies on a
characterization of the gradient of the objective as $T - t \to \infty$.
