...
\cite{BakshyEtAl18, OfferWestortCoGr20, JobjornssonScMuFr22, ChowCh08, EspositoSa22}.
% ~\hn{Cite
...
standard Bayesian bandit formulations (e.g.,~\cite{FrazierPoDa08, Russo20})
that require distributional knowledge of individual rewards, we only use a
prior over the \emph{average rewards} and our likelihood functions over
average rewards are Gaussian from the CLT.  Our formulation thus allows
