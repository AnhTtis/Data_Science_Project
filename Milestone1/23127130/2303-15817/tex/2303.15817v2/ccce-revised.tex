...
% We denote by $\tilde{m}_i^{p,\star},\tilde{m}_i^{p}$ the mass in these cells. It holds  that

% \begin{align*}
%  \tilde{m}_i^{p,\star} &= (X^p-x_{K-1}) c_{i,K}^{p,\star} + (x_{K+1}-X^p) c_{i,K+1}^{p,\star} + \Delta x \, c_{i,K+2}^{p,\star}, \\
...
%     &= \Delta x \, c_{i,K}^{p,\star} + (X^{p}-x_{K}) c_{i,K ^{p-1}}^{p,\star} + \l[ (x_{K+1} - X^p) c_{i,K+1}^{p,\star} + \Delta x ~ c_{i,K+2}^{p,\star}   \r] \\
%     &= \tilde{m}_i^{p-1/2}. 
% \end{aligned}
% \end{equation*}
...
%$\|\bbc_{\Delta x}^{p,k+1}-\bbc_{\Delta x}^{p,k} \|_{\infty} \leq 10^{-12}$. 
...
% \draw [decorate,decoration={brace,amplitude=5pt,raise=4ex}]
%   %(3,0) -- (5.7,0) node[midway, yshift=3em]{$c_{i,K}^{p}$};
%   (3,0) -- (6.3,0) node[midway, yshift=3em]{$\Delta_{K}^{p,\star}$};
% \draw [decorate,decoration={brace,amplitude=5pt,raise=4ex}]
%   %(5.7,0) -- (7,0) node[midway, yshift=3em]{$c_{i,K+1}^{p}$};
%   (6.3,0) -- (7,0) node[midway, yshift=3em]{$\Delta_{K+1}^{p,\star}$};
