...
\caption{Top: views of the same subject cat by a volumetric rendering generator (EG3D) and by our convolutional rendering generator. Bottom: comparison of the inference memory consumption (on a fixed GPU budget) for the two methods.}
\label{fig_main}%
\vspace{-4mm}
\end{figure}
