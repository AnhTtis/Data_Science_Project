...
\caption{Top: views of the same subject cat by a volumetric rendering generator (EG3D) and by our convolutional rendering generator. Bottom: comparison of the inference speed and memory consumption (in terms of the maximum possible batch size on a fixed GPU budget) for the two methods. Ours can provide up to two orders of magnitude speed up.}
\label{fig_main}%
\vspace{-4mm}
\end{figure}
