...
\title
{
	...
	\hspace{-20pt}\includegraphics[width=9.5cm]{ICA_logo.jpeg}
	\hspace{-65pt}\includegraphics[width=10.2cm]{ICA_text2022.png}
	\end{minipage}
	% \vspace{-20cm}
	\includegraphics[width=16.5cm]{ICA_separator.png}\\[0.5cm] \textbf{Kernel-interpolation-based spatial active noise control \\ with exterior radiation suppression}
%
