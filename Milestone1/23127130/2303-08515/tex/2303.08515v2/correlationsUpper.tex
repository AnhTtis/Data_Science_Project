...
\end{prop}
Theorem \ref{thm:mainTheoremMixingRate} then follows from the work of \cite{young_recurrence_1999}. Proving Proposition \ref{prop:AnPolynomial} involves treating separately a set of infrequently returning points, a method due to \cite{markarian_billiards_2004}. For each $z \in \tor$ and $n \geq 1$ define
