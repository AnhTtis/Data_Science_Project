...
\author{Kai Ren\inst{1,2,*} Ke Zou\inst{1,2,*}, Xianjie Liu\inst{2}, Yidi Chen\inst{3}, Xuedong Yuan\inst{1,2}\textsuperscript{\Letter},\\ Xiaojing Shen\inst{1,5}, Meng Wang\inst{6}, Huazhu Fu\inst{6}\textsuperscript{\Letter}}
\authorrunning{K. Ren et al.}
\institute{National Key Laboratory of Fundamental Science on Synthetic Vision,\\ Sichuan
University, Sichuan, China \and College of Computer Science, Sichuan University, Sichuan, China \and Department of Radiology, West China Hospital, Sichuan University, Sichuan, China \and Medical College, Shantou University, Guangdong, China \and College of Mathematics, Sichuan University, Sichuan, China \and Institute of High Performance Computing, A*STAR, Singapore\\
