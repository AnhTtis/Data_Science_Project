...
\newtheorem{propsion}{Proposition}
...
%macros for Graphs (SSG)
\newcommand{\TraceNet}{\textsf{TraceNet}}
\newcommand{\ContractNet}{\textsf{ContractNet}}
\newcommand{\TransactionNet}{\textsf{TransactionNet}}
\newcommand{\TokenNet}{\textsf{TokenNet}}
\newcommand{\FromAddress}{\texttt{from\_address}}
\newcommand{\ToAddress}{\texttt{to\_address}}
...
% NAHEED macro
\newcommand{\naheed}[1]{\textcolor{blue}{[NAHEED: #1]}}