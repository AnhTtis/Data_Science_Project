...
the second-order proximity score computing requires $\bigO(\frac{S_2}{T}\cdot|N(v)|\cdot\log N_{max}^v)$ time,
...
CPU \par
\noindent throughput of {\sf Skip-Gram} model can be significantly improved by
