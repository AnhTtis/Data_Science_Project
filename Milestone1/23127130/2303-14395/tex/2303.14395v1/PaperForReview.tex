...
%%%%%%%%% TITLE - PLEASE UPDATE
\title{MDQE: Mining Discriminative Query Embeddings to Segment \\ Occluded Instances on Challenging Videos}
...
\input{fig/query_init_visual.tex}
\input{tab/sota_yt19.tex}

\input{fig/yt21_visual.tex}
\input{fig/ovis_visual.tex}
\input{fig/ovis_visual2.tex}  
