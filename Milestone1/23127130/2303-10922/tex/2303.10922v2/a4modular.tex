...
\quad
\caption{\footnotesize{Variation plot for NH showing the dependence of Yukawa ($y_1, y_2,y_3$) among themselves in (a). Relation of $y_3$ with Re[$\tau$]  is shown in (b) while (c) shows the variation of $y_1,y_2$ with Re[$\tau$]. The dependence of Im[$\tau$] with ($y_1, y_2,y_3$) is shown in (d).}}
\label{yplotnh}
\end{figure}
