\begin{tikzpicture}
  ...
  \node(recordedData)[draw=red, ultra thick, above left = 2cm and 1.0cm of process, rectangle, minimum width = 3.0cm, minimum height = 0.8cm] {\color{red}{\begin{tabular}{c}\textbf{recorded process}\\ \textbf{data}
  \end{tabular}
  }};

  \draw [-{Latex[length=2mm, width=2mm]}, draw=red, ultra thick] (recordedData.east)-|($(process.north)-(1.25,0)$);
