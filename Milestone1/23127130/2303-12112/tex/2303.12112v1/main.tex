...
\newcommand{\marcy}[1]{\textcolor{magenta}{\textbf{\footnotesize{[#1]}}}}
\newcommand{\lorenzo}[1]{\textcolor{blue}{\textbf{\footnotesize{[#1]}}}}
\newcommand{\rita}[1]{\textcolor{red}{\textbf{\footnotesize{[#1]}}}}
...
%%%%%%%%% TITLE - PLEASE UPDATE
\title{Positive-Augmented Constrastive Learning for\\Image and Video Captioning Evaluation}
...
We thank CINECA for providing computational resources. This work has been conducted under a research grant co-funded by Leonardo S.p.A. and has been supported by the PNRR project ``Future Artificial Intelligence Research (FAIR)'' and by the PRIN project ``CREATIVE: CRoss-modal understanding and gEnerATIon of Visual and tExtual content'' (CUP B87G22000460001), both co-funded by the Italian Ministry of University and Research.
