...
are assigned labels following the rules given there, then (a)~the labels
...
Figure~\ref{fig:nbr}, with the original polykite shaded.  The first
...
is no possible neighbour that can contain kite shaded in green (without
