...
Concurrently to this work, \citet{brehmer2023geometric} also experiment with an equivariant Diffuser variation, but their denoising network is based on geometric algebra representations and a transformer architecture.
