...
The main innovation is a new diffusion model that is equivariant with respect to the symmetry group $\fullgroup$ of spatial, temporal, and object permutation symmetries. Beyond this concrete architecture, our work presents a general blueprint for the construction of networks that are equivariant with respect to a product group and support multiple representations in the data.
