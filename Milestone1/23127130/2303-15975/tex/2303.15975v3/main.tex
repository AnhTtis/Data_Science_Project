...
\begin{document}
%
% \title{A Frustratingly Simple Baseline \\for Incremental Novel Class Discovery} % ICPR Submission Title
...
Subhankar Roy\inst{1} \quad
Zhun Zhong\inst{3,4}\thanks{Corresponding author: Zhun Zhong.} \quad \\%\thanks{Corresponding author: Zhun Zhong.} 
