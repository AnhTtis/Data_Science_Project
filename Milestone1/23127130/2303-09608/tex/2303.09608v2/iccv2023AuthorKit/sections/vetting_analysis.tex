...
\resizebox{\linewidth}{!}{%
    ...
    \hline
        ...
        \multirow{2}{0.5cm}{S} & VEIL-Same Dataset &  \textbf{85.0} & \textbf{94.7} & \textbf{87.0} & \textbf{80.0} & \textbf{81.1} & \textbf{90.6} & \textbf{87.2} & \textbf{95.2} & \textbf{93.9} & \textbf{90.6} & \textbf{100.0} & \textbf{100.0} & \textbf{88.8} \\ 
        ...
        \multirow{2}{0.5cm}{R} & VEIL-Same Dataset  & \textbf{91.7} & 74.1 & \textbf{71.4} & \textbf{85.7} & \textbf{83.3} & \textbf{89.0} & \textbf{68.3} & \textbf{74.8} & \textbf{90.0} & 66.7 & \textbf{88.9} & 80.9 & 76.3 \\ 
        ...
        \multirow{2}{0.5cm}{CC} & VEIL-Same Dataset  & \textbf{60.6} & 83.0 & \textbf{81.2} & 55.0 & \textbf{54.9} & \textbf{53.6} & \textbf{56.3} & 64.2 & \textbf{73.7} & 81.7 & \textbf{100.0} & - & 77.4 \\ 
    ...
    \caption{
    %Vetting 
    VAEL recall performance on CLaN. Bold indicates best performance per column/dataset. We omit named entity results for CC as it substitutes them with predefined categories (e.g. person, org.). Top = SBUCaps, middle = RedCaps, bottom = CC.}
