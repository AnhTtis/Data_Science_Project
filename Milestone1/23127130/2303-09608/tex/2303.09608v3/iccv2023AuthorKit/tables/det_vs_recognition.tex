...
\begin{center}
\small
\begin{tabular}{p{1.72in}|p{0.22in}|p{0.2in}|p{0.2in}}
\hline
...
VEIL-R,CC & \underline{37.8}  &\underline{71.4} & \underline{8.6}\\
...
(GT*) directly vets labels using the pretrained recognition models used to train VEIL.}
%Bold indicates best performance in column excluding GT*.} 
\label{tab:det_v_recognition}
\end{table}