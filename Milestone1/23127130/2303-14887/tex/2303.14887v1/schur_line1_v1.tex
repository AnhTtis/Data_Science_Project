...
Since the algebra of the line operators in our setup of $\mathcal{N}=2^*$ SYM theory would coincide with the spherical DAHA \cite{MR3018956} (also see \cite{MR2133033,Gaiotto:2020vqj,Gukov:2022gei}) as the non-commutative deformation of the coordinate ring of the Coulomb branch \cite{Gaiotto:2010be,Drukker:2009id,Alday:2009fs,Gomis:2011pf}, 
...
\right](\zeta,\tau). 
\end{align}
It follows from the the relation of symmetric functions that 
\begin{align}
&\langle W_{(m)} W_{\overline{(m)}} \rangle^{U(2)}
\nonumber\\
&=(1-m^2)\mathcal{I}^{U(2)}
...
\nonumber\\
&=1+4q^{1/2}+10q+16q^{3/2}+26q^2+40q^{5/2}+50q^3+64q^{7/2}+91q^4+104q^{9/2}+122q^5+\cdots,
\end{align}
...
\langle \mathcal{W}_{n_1}\mathcal{W}_{n_2}\mathcal{W}_{n_3}\mathcal{W}_{-n_1-n_2-n_3}\rangle^{\mathrm{GC}}
\nonumber\\
&=-\sum_{m\ge 0}Q(m;0)(-\mu)^m
-\sum_{m_1,m_2\ge 0}\Bigl[
