...
\noindent
Due to the spatio-temporal correlation of LiDAR point cloud sequences often captured from vehicles in %common 
...
The key idea is that if spatial-overlap among some continuous frame sequence is high due to spatio-temporal redundancy, multiple representative frames can be sub-sampled for training, significantly reducing both training dataset size and redundant training computation. 
