...
\textit{Unreliable} and \textit{Reliable}: selecting negative candidates with top $20 \%$ highest entropy scores and bottom $20 \%$ counterpart respectively. \textit{Random}: sampling randomly regardless of entropy.
}
