\begin{table}[h]
\centering
\caption{\small Complete Tab.~\ref{tab:imagenet_results} results. SSL results on ImageNet with different percentage of labels. $\dagger$ denotes results produced by our codebase. Other results are reported as appearing in the cited work. }
\label{tab:imagenet_results_supp}
% \vspace{-2mm}
