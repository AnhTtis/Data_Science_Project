...
Assuming a galaxy catalog complete up to $z=1$ and dark sirens detected with a network signal-to-noise ratio greater than \num{300}, we show that a network made of ET and two CEs can constrain $\hubble$ ($\Om$) to a promising $0.7\%$ ($9.0\%$) at $90\%$ confidence interval within one year of continuous observations. 
...
Our results imply that a sub-percent measure of $\hubble$ can confidently be attained by a network of 3G detectors, highlighting the need for characterising all systematic effects to a higher accuracy.
