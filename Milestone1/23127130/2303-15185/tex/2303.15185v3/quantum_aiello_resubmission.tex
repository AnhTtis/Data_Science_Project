...
Furthermore,  we  find that the values taken by  $\mathcal{W}_1$ and $\mathcal{C}_2$ are correlated in a \emph{nonlinear} manner  even when the operators $\hat{W}_1$ and $\hat{C}_2$ do commute. This is a purely quantum effect due to the non-localizability of the single-photon field which extends over the surfaces of both detectors. In the jargon of probability theory, we can say that the random variables $W_1$ and $C_2$ are linearly uncorrelated but not independent \cite{MurphyBook2022}.
%
...
\end{enumerate}
%
In the end,  we believe that this work can stimulate the use of the probabilistic techniques used here, in various applications of quantum optics.
...
%\bibliography{C:/Users/aaiello/Desktop/latex_bibliography/bibliography.bib}
...
\bibinfo{author}{\bibfnamefont{W.~K.} \bibnamefont{Wootters}} \bibnamefont{and}
  ...
  \urlprefix\url{https://link.aps.org/doi/10.1103/PhysRevD.19.473}.
...
\bibinfo{author}{\bibfnamefont{C.}~\bibnamefont{Dittel}},
  ...
  \urlprefix\url{https://link.aps.org/doi/10.1103/PhysRevX.11.031041}.
...
\bibinfo{author}{\bibfnamefont{X.-F.} \bibnamefont{Qian}},
  ...
  \urlprefix\url{https://opg.optica.org/optica/abstract.cfm?URI=optica-5-8-942}.
...
\bibinfo{author}{\bibfnamefont{X.-F.} \bibnamefont{Qian}},
  ...
  \urlprefix\url{https://link.aps.org/doi/10.1103/PhysRevResearch.2.012016}.
...
\bibinfo{author}{\bibfnamefont{G.}~\bibnamefont{Jaeger}},
  ...
  \urlprefix\url{https://link.aps.org/doi/10.1103/PhysRevA.51.54}.
...
\bibinfo{author}{\bibfnamefont{H.~M.} \bibnamefont{Wiseman}},
  ...
  \urlprefix\url{https://link.aps.org/doi/10.1103/PhysRevA.56.55}.
...
\bibinfo{author}{\bibfnamefont{S.}~\bibnamefont{D\"urr}},
  ...
  \urlprefix\url{https://link.aps.org/doi/10.1103/PhysRevLett.81.5705}.
...
\bibinfo{author}{\bibfnamefont{G.}~\bibnamefont{Bj\"ork}} \bibnamefont{and}
  ...
  \urlprefix\url{https://link.aps.org/doi/10.1103/PhysRevA.58.3477}.
...
\bibinfo{author}{\bibfnamefont{P.~D.~D.} \bibnamefont{Schwindt}},
  ...
  \urlprefix\url{https://link.aps.org/doi/10.1103/PhysRevA.60.4285}.
...
\bibinfo{author}{\bibfnamefont{C.}~\bibnamefont{Fabre}} \bibnamefont{and}
  ...
  \urlprefix\url{https://link.aps.org/doi/10.1103/RevModPhys.92.035005}.
...
\bibinfo{author}{\bibfnamefont{M.}~\bibnamefont{Hassani}},
  ...
  \urlprefix\url{https://link.aps.org/doi/10.1103/PhysRevLett.119.200502}.
