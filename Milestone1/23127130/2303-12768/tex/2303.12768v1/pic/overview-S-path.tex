\begin{tikzpicture}[thick,scale=0.7]
	\draw (0, 0) node[circle, draw, fill=black!50, inner sep=0pt, minimum width=6pt, label = $u$] {};
	\draw (19, 0) node[circle, draw, fill=black!50, inner sep=0pt, minimum width=6pt,label = $v$] {};
