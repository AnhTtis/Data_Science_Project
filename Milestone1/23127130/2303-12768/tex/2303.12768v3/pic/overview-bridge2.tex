\begin{tikzpicture}[thick,scale=0.8]
	...
	\draw [line width = 0.5mm, color=cyan] (1.1, 0) -- (2.2, 0);
	...
	\draw [line width = 0.5mm, color=cyan] (3.4, 0) -- (4.5, 0);
	...
	\draw [line width = 0.5mm, color=cyan] (17.8, 0) -- (18.9, 0);
	...
	\draw [line width = 0.5mm, color=cyan] (15.5, 0) -- (16.6, 0);
	...
	\draw (17.2, -2.5) node[label={add level-1 demand pairs}]{};
	
	\draw [decorate,
	decoration = {brace}] (5.4,-1.3) -- (0.2,-1.3);
	\draw (2.8, -2.5) node[label={add level-1 demand pairs}]{};
\end{tikzpicture}