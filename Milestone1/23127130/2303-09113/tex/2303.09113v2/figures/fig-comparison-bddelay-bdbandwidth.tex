\begin{figure}[tb]%
    ...
    \begin{tikzpicture}[]%
        ...
        \begin{axis}[
            ...
            \node [align=center] (security) at (axis cs:5e-3,0.40) {Our analysis\\{}(\cref{thm:safety-and-liveness-pow,thm:safety-and-liveness-pos})};
            \draw [-latex] (security) -- (axis cs:2e-3,0.25);
    ...
    \caption[]{%
        Regions of
        fraction $\beta$ of adversarial nodes and
        ...
        for Nakamoto consensus under a fixed processing capacity of $C=1$ block per second.
        ...
        %
        The latter claim is limited to the bounded delay model, as our \teaserattack exploits congested block processing and succeeds at lower adversary $\beta$ than the private attack
        ...
        Our analysis in a bounded bandwidth model characterizes a security region
        (\tikz[x=0.75em,y=0.75em]{ \draw [draw=myParula05Green,thick,fill=myParula05Green,fill opacity=0.3] (0,0) rectangle (1,1); })
        for both PoW and \sapos (a PoS variant).
    }%
