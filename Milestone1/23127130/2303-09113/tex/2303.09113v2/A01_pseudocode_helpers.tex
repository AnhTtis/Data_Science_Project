...
%
        ...
        Relation for distinct headers from the same \BPO (\ie equivocations)
\end{itemize}
...
The environment maintains a mapping $\Env.\TxsMap$ from block headers to the block content (transactions). This mapping is referred to as the `cloud' in \cref{sec:modelprotocol} and \cref{fig:model}.
%
