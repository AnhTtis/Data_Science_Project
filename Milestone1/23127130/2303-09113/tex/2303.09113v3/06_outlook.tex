...
%
Our \teaserattack and security analysis (\cf \cref{fig:comparison-bddelay-bdbandwidth}) serve as the first lower and upper bounds on nodes' minimum bandwidth required to ensure security in the bounded-bandwidth PoW setting. A question remains on how to tighten the gap.
%
One avenue for future work is whether the adversary has better strategies
than the \teaserattack, which we believe may be optimal in the bounded-bandwidth model.
%
\begin{conjecture}
...
%
\cite{garay2017bitcoin}. Security in the bounded-delay and bounded-bandwidth models remains an open problem.
...
if honestly produced orphaned blocks are downloaded by honest parties, leading to a vicious cycle.
%
%
%
%
...
%
%
Under the \rulelc download rule that we consider in this work,
honest nodes do not prioritize downloading orphaned blocks,
but this appears to be the case for download rules that 
%
allow for multiple downloads to take place in parallel. The nuance in this analysis is left for future work.
