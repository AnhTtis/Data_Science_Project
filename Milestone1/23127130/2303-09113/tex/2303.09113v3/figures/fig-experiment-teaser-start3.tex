\begin{figure}[tb]%
    ...
    %
    The simulation consists of $100$ honest nodes with bandwidth $C=2$ blocks per second, collectively mining $\blkratetimeHon=1$ block per second, and one adversary node with variable mining rate $\blkratetimeAdv$ blocks per second.
