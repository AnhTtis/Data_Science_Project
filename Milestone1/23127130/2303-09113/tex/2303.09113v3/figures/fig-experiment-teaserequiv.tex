\begin{figure}[tb]%
    ...
    \vspace{-0.5em}%
    \caption{%
    Results of a simulation of the \PoSTeaserattack comparing the rate of chain growth relative to honest block production rate, when nodes prioritize downloads towards the longest header chain, for various bandwidths. The honest chain growth rate falls to almost zero as the adversary spams honest nodes with longer chains. The \teaserattack is shown for comparison.
%
    %
    }%
