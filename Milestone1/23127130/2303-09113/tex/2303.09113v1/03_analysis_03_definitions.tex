...
download content for $\goodsepbw$ within $\goodsep+1$ \timeslots.
That is, 
...
\begin{definition}
    ...
    \begin{IEEEeqnarray}{rCl}
        \predGood{t} &\;\triangleq\;& (\Hat{t} = 1) \land (\Aat{t} = 0) \land (\Hin{t}{t+\goodsep} + \Ain{t}{t+\goodsep} = 0)
...
\begin{proposition}
    ...
    \end{IEEEeqnarray}
\end{proposition}
Proof is in \secref{appendix-security-proofs}.
%
%
%
%
...
with $\epsGood \in (0,1/2]$ (`honest majority' assumption).
...
The equivalences of \propref{pivot-conditions-equivalence}
hold for \sltcps analogously.
