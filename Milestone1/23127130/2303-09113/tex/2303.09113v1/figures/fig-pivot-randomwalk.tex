\begin{figure}[tb]
    ...
    \caption[]{Illustration of \sltpp
        ...
        weakly above
        $\Xin{0}{k}$ right of $k$
        (\tikz[x=0.75em,y=0.75em]{ \draw [draw=none,fill=myParula05Green,opacity=0.3] (0,0) rectangle (1,1); }), elsewhere (\tikz[x=0.75em,y=0.75em]{ \draw [draw=none,fill=myParula07Red,opacity=0.3] (0,0) rectangle (1,1); }).}
