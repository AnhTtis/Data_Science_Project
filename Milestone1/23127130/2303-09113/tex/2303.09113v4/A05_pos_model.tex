...
Details of the PoS-based block production and verification are abstracted through an idealized functionality $\FtreePoS$ whose pseudocode is provided in \appendixRef{\cref{alg:hdrtree-pow}} (\cf~\appendixRef{\cref{alg:hdrtree-pow}}, \cite[Fig.~2]{sleepy}, \cite[Alg.~3]{bwlimitedposlc}).
