\begin{figure}[tb]%
    ...
    \begin{tikzpicture}[x=1.9cm]
        ...
        \node [myParula02Orange,align=center,anchor=north] at (0.5,-1.02) {\tiny Capacity\\\tiny $\bwtime$};
    ...
    \end{tikzpicture}%
    \caption[]{%
        Bounded-capacity network model~\cite[Fig.~4]{bwlimitedposlc}:
        %
        %
        %
        ...
        %
        \circledScriptBlackSlim{4} Content associated with the header is processed (\ie, downloaded and verified) ($\protocol.\Call{receivedContent}{}$), subject to a maximum rate of~$\bwtime$.
        %
        \circledScriptBlackSlim{5} The adversary can push headers and content to nodes, bypassing the delay and capacity constraints.
        %
        %
        %
        %
