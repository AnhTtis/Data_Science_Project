\begin{figure}
    ...
    \caption{
        ...
        Steps (a)-(e) are the same as in the \teaserattack (\cref{fig:attack-teaser}). Recall that in (c), to delay the processing of the honest block at height $h=3$, the adversary announces a block at height $h+1$ which it was withholding. Since this is the longest announced chain, honest nodes prioritize processing block $2$ on this chain.
        %
