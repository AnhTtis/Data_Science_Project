...
\newcommand{\consu}{~mol(site.\dt)\ensuremath{^{-1}}}
\newcommand{\Sci}[1]{\ensuremath{\times 10^{#1}}}
\newcommand*{\zmm}[2]{{\color{black!50!white}\sout{#1}}{ \color{red!50!yellow}{\bf MJP:}#2}}

\renewcommand{\figurename}{{\bf Figure}}
\renewcommand{\tablename}{{\bf Table}}

\renewcommand{\thefigure}{{\bf S\arabic{figure}}}
\renewcommand{\thetable}{{\bf S\arabic{table}}}

\newcommand{\rev}[2][]{{\color{red}\sout{#1}}{\color{blue}#2}}
%\newcommand{\rev}[2][]{#2}
...
\begin{document}
\newcommand{\TODO}[1]{%
		\fcolorbox{red}{yellow}{\parbox{8cm}{{\color{red}\bf TODO} {\small\it 
		#1}}}}
\newcommand{\REM}[1]{%
		\fcolorbox{red}{lime}{\parbox{8cm}{{\color{red}\bf REMARK mp:} {\small\it 
		#1}}}}
\def\etal{{\it et~al.}}
...
\def\a{\ensuremath{D_n}}
\def\hp{H$^{+}\,$}
\def\ox{O$_2\,$}
%\pagestyle{myheadings}
%\markright{OZIMEK,~W, BANA{\'S},~R, GORA,~P, et al.: `Identifying Promising ...' - 
...
\title{\fourteenpt{\bf Identifying Promising Candidate Radiotherapy Protocols via GPU-GA \textit{in-silico}}}

\author
{Wojciech Ozimek, Rafa\l{} Bana{\'s}, Pawe\l{} Gora,\\ Simon D. Angus$^{\ast}$, Monika J. Piotrowska\\
\\
\normalsize{$^\ast$Corresponding author. Email: simon.angus@monash.edu.au}
}
...
%Audio S1 to S#
%Data S1 to S#
%References (# to #) (if applicable—these should refer only to references in the SM)
\end{itemize}
...
\subsection*{GA Operators: additional details}
...
In total, we ran $8$ series of experiments, their settings are presented in Table~\ref{tab:exp_settings}. Below, we focus on the last batch among all the performed experiments since others served for the improvement of used approaches by testing various settings and configurations of GA algorithms.
