...
\newcommand{\upcite}[1]{{\color{red}\hspace{-1mm}\textsuperscript{\cite{#1}}}}
%上面显示参考文献为红色标记，如果去掉红色，就把上句注释掉，使用下句
...
\newcommand{\mAo}{\setlength\arraycolsep{7pt}
               ...
               -a_{n-1} & 0 & 0 & \cdots & 0 & 1\\
                   -a_n & 0 & 0 & \cdots & 0 & 0\end{array}\right]}
...
%--黑斜体希腊大写----------------------------------
\def\bfGamma{\bm\varGamma}
\def\bfDelta{\bm\varDelta}
\def\bfTheta{\bm\varTheta}
%\def\bfTheta{\bm\Theta}
\def\bfLambda{\bm\varLambda}
\def\bfXi{\bm\varXi}
\def\bfPi{\bm\varPi}

\def\bfSigma{\bm\varSigma}
\def\bfUpsilon{\bm\varUpsilon}
\def\bfPhi{\bm\varPhi}
%\def\bfPhi{\bm\Phi}
\def\bfPsi{\bm\varPsi}
\def\bfOmega{\bm\varOmega}
...
\def\bfzeta{\bm\zeta}
\def\bfeta{\bm\eta}         % note the variation
\def\bftheta{\bm\theta}
\def\bfiota{\bm\iota}
...
%
\def\bfvaralpha{\bm\varalpha}
\def\bfvarbeta{\bm\varbeta}
\def\bfvargamma{\bm\vargamma}
\def\bfvardelta{\bm\vardelta}
\def\bfvarepsilon{\bm\varepsilon}
\def\bfvarzeta{\bm\varzeta}
\def\bfvareta{\bm\vareta}
\def\bfvartheta{\bm\vartheta}
\def\bfvariota{\bm\variota}
\def\bfvarkappa{\bm\varkappa}
\def\bfvarlambda{\bm\varlambda}
\def\bfvarmu{\bm\varmu}
\def\bfvarnu{\bm\varnu}
\def\bfvarxi{\bm\varxi}
\def\bfvaromicron{\bm \varomicron}
\def\bfvarpi{\bm\pi}
\def\bfvarrho{\bm\varrho}
\def\bfvarsigma{\bm\varsigma}
\def\bfvartau{\bm\vartau}
\def\bfvarphi{\bm\varphi}
\def\bfvarchi{\bm\varchi}
\def\bfvarupsilon{\bm\varupsilon}
\def\bfvarpsi{\bm\varpsi}
\def\bfvaromega{\bm\varomega}
...
%--黑斜体希腊大写----------------------------------
\def\bfGamma{\mbox{\boldmath$\varGamma$}}
\def\bfDelta{\mbox{\boldmath$\varDelta$}}
\def\bfTheta{\mbox{\boldmath$\varTheta$}}
%\def\bfTheta{\bm\Theta}
\def\bfLambda{\mbox{\boldmath$\varLambda$}}
\def\bfXi{\mbox{\boldmath$\varXi$}}
\def\bfPi{\mbox{\boldmath$\varPi$}}

\def\bfSigma{\mbox{\boldmath$\varSigma$}}
\def\bfUpsilon{\mbox{\boldmath$\varUpsilon$}}
\def\bfPhi{\mbox{\boldmath$\varPhi$}}
%\def\bfPhi{\bm\Phi}
\def\bfPsi{\mbox{\boldmath$\varPsi$}}
\def\bfOmega{\mbox{\boldmath$\varOmega$}}
