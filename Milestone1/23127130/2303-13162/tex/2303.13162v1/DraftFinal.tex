...
\begin{equation}\label{HomLangevin}
    \ddot{\mathbb{G}}(t)+\Omega^2\mathbb{G}(t)-\int_0^t \chi(t-s)\mathbb{G}(t)ds=\mathds{1}\delta(t)\,,
\end{equation}
...
%
S.M. acknowledges financial support from
``PNRR MUR project PE0000023-NQSTI". A.L. is grateful to profs.~Salvatore Capozziello and Prof.~Orlando Luongo for their help to this project. He is also thankful to INFN, section of Naples, for support.
...
\begin{align}\label{systemLangevin:appendix}
    ...
    \ddot{G}_{\textrm{AB}}(t)-\Sigma_\textrm{A}^2G_{\textrm{AB}}(t)+2\gamma_\textrm{A}\dot{G}_{\textrm{AB}}(t)=&2\frac{\sqrt{\gamma_\textrm{A}\gamma_\textrm{B}}}{d}G_{\textrm{BB}}(t-d)\theta(t-d)\,;\nonumber\\
    \ddot{G}_{\textrm{BA}}(t)-\Sigma_\textrm{B}^2G_{\textrm{BA}}(t)+2\gamma_\textrm{B}\dot{G}_{\textrm{BA}}(t)=&2\frac{\sqrt{\gamma_\textrm{A}\gamma_\textrm{B}}}{d}G_{\textrm{AA}}(t-d)\theta(t-d)\,;\nonumber\\
    \ddot{G}_{\textrm{BB}}(t)-\Sigma_\textrm{B}^2G_{\textrm{BB}}(t)+2\gamma_\textrm{A}\dot{G}_{\textrm{BB}}(t)=&2\frac{\sqrt{\gamma_\textrm{A}\gamma_\textrm{B}}}{d}G_{\textrm{BA}}(t-d)\theta(t-d)\,,
\end{align}
...
\begin{align}\label{noisematrix:appendix}
    \mathbb{N}(t)=&T_{\textrm{BB}}(t)\sigma_{\textrm{BB}}(0)T_{\textrm{BB}}(t)^T+\int_0^tds\int_0^tds'\eta(t-s)\boldsymbol{\nu}(s,s')\eta(t-s'),
\end{align}
