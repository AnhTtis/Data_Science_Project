...
When an $\alpha$ source is positioned near the detector, it induces $\alpha$-particle interaction, generating electron-hole pairs on the detector's surface. The resulting holes then drift across the detector upon application of a negative bias voltage to its bottom. This initiates the following processes within the detector:
\begin{equation}
{h^+} + {A^{0^*}} \rightarrow{A^{+^*}};\\
...
respectively. $v_{tot}$ is the total velocity of the drift holes,
...
$(\epsilon_h)$ of a planar HPGe detector is related to $\lambda_{th}$ by ~\cite{Mei2020, He2001}
\begin{equation}
...
\begin{figure}[htp] 
\centering
\includegraphics[width=0.45\textwidth]{CCEVSFieldNeg.pdf}
...
\begin{figure}[htp] 
\centering
\includegraphics[width=0.45\textwidth]{energydai.pdf}
\caption{The plot depicts the mean energy deposition ($E_{dep}$) as a function of time ($t$) for detector RL in Mode 2. As an illustration, the mean energy deposition ($E_{dep}$) and time ($t$) recorded for a bias voltage of $900$ volts are plotted for detector RL when operated in Mode 2. The error in $E_{dep}$ is attributed to the energy deposition determination, while the error in $t$ is primarily due to the recorded time determination. A linear fit ($E_{dep} = p_0 \times t + p_1$) was applied to the part of the plot where the emission of charge carriers is greater than the trapping of charge carriers. The slope ($p_0$) of the fit was determined to be $654.17\pm32.7$ (eV/s), and the intercept ($p_1$) was found to be $2821.45\pm141.07$. It should be noted that the slope represents the emission rate of charge carriers ($e_n$) in equation~\ref{eq3}.}
\label{fig7}
\end{figure}

As depicted in Figure~\ref{fig7}, the application of bias voltage to the detector leads to a linear increase in the charge emission rate for the initial few minutes. This is because, in the initial minutes, de-trapping through impact ionization of dipole states or cluster dipole states outpaces the trapping of charge carriers at a given voltage. However, once the trapping and de-trapping reach a dynamic equilibrium, the energy deposition becomes constant. The slope of the plot's section, where the emission of charge carriers dominates, gives the charge-energy emission rate per unit of time, represented as $e_n$ in equation~\ref{eq3}. By dividing $e_n$ by the binding energy of dipole states or cluster dipole states $(E_b)$, the electron emission rate can be determined. These emission rates are then used in equation~\ref{eq3} to determine the binding energy for respective dipole states or cluster dipole states. The calculated binding energies are presented in Table~\ref{tab:my_label1}.
...
\begin{adjustbox}{width=\textwidth,center=\textwidth}
    ...
    \hline
        ...
        \hline
         ...
         -200&$186.92\pm9.35$&$116\pm5.80$&$8.105\pm0.405$&$(1.492\pm0.074)\times10^{-10}$&$1160\pm58$&$5.807\pm0.290$&$(4.62\pm0.231)\times10^{-11}$\\
         \hline
         -300&$280.37\pm14.02$&$89\pm4.45$&$7.916\pm0.395$&$(1.18\pm0.059)\times10^{-10}$&$1350\pm67.5$&$5.658\pm0.283$&$(3.59\pm0.179)\times10^{-11}$\\
         \hline
         -600&$560.74\pm28.04$&$119\pm5.95$&$7.239\pm0.362$&$(9.67\pm 0.484)\times10^{-11}$&$1820\pm91$&$5.429\pm0.271$&$(3.37\pm 0.168)\times10^{-11}$\\
         \hline
         -900&$841.12\pm42.06$&$164\pm8.2$&$6.898\pm0.345$&$(6.32\pm 0.316)\times10^{-11}$&$654\pm32.7$&$5.30\pm0.265$&$(2.32\pm0.116)\times10^{-11}$\\
         \hline
         -1100&$1028.04\pm51.40$&$-$& $-$&$-$&$871\pm$43.55&$5.237\pm0.262$&$(1.08\pm0.054)\times 10^{-11}$\\
         \hline
         -1200&$1121.50\pm56.07$&$271\pm13.55$& $6.553\pm0.328$&$(2.08\pm0.104)\times 10^{-11}$&$-$&$-$&$-$\\
         \hline
...
each value, are either the result of measurement errors or the error calculated from the equations used in the paper. Note that we could not get the data at  -1200 V for Mode 2 due to higher leakage current.}
    \label{tab:my_label1}   
\end{table*}
The binding energy of cluster dipole states is measured by the detector in Mode 2, while the binding energy of dipole states is measured by the detector in Mode 1. Additionally, the binding energy values obtained at various bias voltages exhibit a correlation with the electric field. Figure~\ref{fig8} illustrates the binding energies plotted as a function of the electric field at a temperature of 5.2 K.
\begin{figure}[htp] 
\centering
\includegraphics[width=0.45\textwidth]{BindingenergyF.pdf}
