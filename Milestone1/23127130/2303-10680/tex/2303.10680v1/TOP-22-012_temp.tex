...
\def\svnVersion{e71069e-D}\def\svnDate{2023/03/06}\def\cmsCernNoTag{CERN-EP-2023-021}\def\cmsCernDate{\today}\def\cmsMessage{Submitted to the Journal of High Energy Physics}
