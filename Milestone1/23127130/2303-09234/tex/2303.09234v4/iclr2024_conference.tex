...
\author{
Yining Jiao~\footnote[2]{UNC-Chapel Hill}
%Institution1 address\\
\and
Carlton Zdanski~\footnote[2]{UNC-Chapel Hill}
%First line of institution2 address\\
\and 
Julia Kimbell~\footnote[2]{UNC-Chapel Hill}
%First line of institution2 address\\
\and 
Andrew Prince~\footnote[2]{UNC-Chapel Hill}
%First line of institution2 address\\
\and
Cameron Worden~\footnote[2]{UNC-Chapel Hill}
%First line of institution2 address\\
\and
Samuel Kirse~\footnote[3]{Wake Forest School of Medicine}
%First line of institution2 address\\
\and
Christopher Rutter~\footnote[3]{The Ohio State University College of Medicine}
%First line of institution2 address\\
\and
Benjamin Shields~\footnote[2]{UNC-Chapel Hill}
%First line of institution2 address\\
\and
William Dunn~\footnote[2]{UNC-Chapel Hill}
%First line of institution2 address\\
\and
Jisan Mahmud~\footnote[2]{UNC-Chapel Hill}
%First line of institution2 address\\
\and
Marc Niethammer~\footnote[2]{UNC-Chapel Hill}
%First line of institution2 address\\
}
...
\vskip -0.3in
\begin{center}
\centerline{\includegraphics[width=1.\columnwidth]{figs/NAISRoverviewwide.pdf}}
...
\begin{figure}[ht]
\vspace{-0.5in}
\includegraphics[width=1.\columnwidth]{figs/reconstruction_airway_adni.pdf}
\vspace{-0.2in}
