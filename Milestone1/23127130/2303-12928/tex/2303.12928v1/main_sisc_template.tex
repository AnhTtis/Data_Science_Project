...
\ifpdf
\hypersetup{
  pdftitle={Leveraging Multi-time HJ PDEs for Certain SciML Problems},
  pdfauthor={P. Chen, T. Meng, Z. Zou, J. Darbon, G.E. Karniadakis}
}
\fi
...
\def\MLregmat{\Gamma} % currently A
\def\MLreg{\gamma}    % currently \alpha
\def\MLbasismat{\Phi}
\def\MLbasis{\phi}
...
\footnotetext[1]{Division of Applied Mathematics, Brown University, Providence, RI 02912, USA (paula\_chen@brown.edu, zongren\_zou@brown.edu, jerome\_darbon@brown.edu, george\_karniadakis@brown.edu).}
\footnotetext[2]{Department of Mathematics, UCLA, Los Angeles, CA 90025, USA (\email{tingwei@math.ucla.edu}).}
\footnotetext[3]{Paula Chen, Tingwei Meng, and Zongren Zou contributed equally to this work.}
...
P.C. is supported by the SMART Scholarship, which is funded by the Under Secretary of Defense/Research and Engineering (USD/R\&E), National Defense Education Program (NDEP) / BA-1, Basic Research. J.D., G.E.K., and Z.Z. are supported by the MURI/AFOSR FA9550-20-1-0358 project.
