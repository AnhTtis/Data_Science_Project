...
\begin{table*}[tb]
  ...
  Method & Acc. (\%) & Keypoint Detector & COCO $\text{AP}_\text{kp}$ (\%) & Runtime (ms) & Total FPS \\ \hline
...
\begin{minipage}[r]{0.3\textwidth}
  ...
  \begin{tabular}{cc|cc} \hline
    ...
    -            & -            & 47.3 & 89.5 \\ 
    $\checkmark$ & -            & \textbf{48.6} & 7.2 \\ \hline 
    $\checkmark$ & $\checkmark$ & 48.5 & \textbf{4.9} \\ \hline
  \end{tabular} \\
  ...
  \begin{tabular}{ccc|c} \hline
    ...
    -            & -            & -            & 41.2 \\
    $\checkmark$ & $\checkmark$ & -            & 48.6  \\ \hline
    $\checkmark$ & -            & $\checkmark$ & \textbf{49.2}  \\ \hline
  \end{tabular}
...
\end{minipage}
  ...
  \begin{minipage}[c]{0.4\textwidth}
    ...
    \begin{tabular}{cc|c|c} \hline
      ...
      T$\rm{A}^3$N~\cite{Chen2019ICCV}   & \multirow{2}{*}{US} & \multirow{2}{*}{RGB} & 10.0 \\
      C$\rm{O}^2$A~\cite{Costa2022WACV}  &  &  & 16.4 \\ \hline 
      T$\rm{A}^3$N~\cite{Chen2019ICCV} & \multirow{2}{*}{WS} & \multirow{2}{*}{RGB} & 19.1 \\
      C$\rm{O}^2$A~\cite{Costa2022WACV} &  & & 20.1 \\ \hline
  ...
  \begin{minipage}[l]{0.55\textwidth}
    ...
    \begin{tabular}{c|cccc} \hline
      ...
      & \multirow{2}{*}{Only MLPs} & \multirow{2}{*}{\begin{tabular}{c}1st MLP Block  \\ $\rightarrow$ MS-G3D\end{tabular}}  & \multirow{2}{*}{\begin{tabular}{c}Ours  \\ (MLP+ConcatPool) \end{tabular}} \\ 
      & & & \\ \cline{2-4}
