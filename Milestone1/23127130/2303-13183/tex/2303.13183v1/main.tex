\documentclass[pra,twocolumn,superscriptaddress,nobibnotes,longbibliography,notitlepage,nofootinbib,floatfix]{revtex4-1}
...
This experiment both demonstrates the stability of current quantum communication platforms for space-based applications and adds an important reference point for testing the interplay of non-inertial motion and quantum information.
\end{abstract}
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=0.9\textwidth]{SetupFinal_V5.png}
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=0.88\textwidth]{Figure_2_S_Acc_AccZoomIn_Altitude_V4-eps-converted-to.pdf}
\vspace*{-4mm}
...
Our setup with two analyzer modules each on Alice's and Bob's side permits us to measure all four correlation functions
without intermittent switching between different angles.\\[-3mm]
...
The average Bell-CHSH parameter $\overline{S}\suptiny{0.5}{-2}{(1)}= \tfrac{1}{111}\sum_{t=60 \mathrm{s}}^{t=170\mathrm{s}}~S_{t}$ (horizontal black line) across the entire parabola (from $t = 60 \, \mathrm{s}$ to $t = 170 \, \mathrm{s}$, with associated average standard deviation of the mean $\overline{\Delta S}\suptiny{0.5}{-2}{(1)}= \tfrac{1}{111}\sum_{t=60 \mathrm{s}}^{170\mathrm{s}} \Delta S_{t}$) is $-2.678\pm 0.013$, which corresponds to an average distance of $\overline{\sigma}\suptiny{0.5}{-1}{(1)} = \tfrac{1}{111} \sum_{t = 60 \mathrm{s}}^{170 \mathrm{s}} |S_{t}-(-2)|/\Delta S_{t}=48.9$ standard deviations from the local realistic bound of -2.\\[-3mm]

\begin{figure*}[ht!]
\centering
\includegraphics[width=0.48\textwidth]{Plot_S_acc_Jerk_V4-eps-converted-to.pdf}
\includegraphics[width=0.48\textwidth]{Visibility_and_Acceleration_vs_time_V6-eps-converted-to.pdf}
\vspace*{-6mm}
...
$\overline{\Delta S} = \tfrac{1}{6843} \sum_{t} \Delta S_{t} = 0.0140$.\\[-2mm]
...
These results show in more detail that our setup for entanglement generation and detection is insensitive against aircraft vibrations (see also Fig.~\ref{fig:All_Visibilities_values_over_complete_flight}~and~\ref{fig:All_Visibilities_over_complete_flight_6_rows} in the appendix) and accelerations with peak values of up to 1.99 g (here our backup accelerometer measured $2.090 \pm 0.002 \, \mathrm{g}$ while the accelerometer of the aircraft measured 2.07~g, see Fig.~\ref{fig:Comp_three_Accelerometers} in the appendix), at which the acceleration sensor saturates. Our setup provides strongly polarization-entangled photon pairs in this tough ambience over 30 parabolas for 1.9 hours.\\[-3mm]

\noindent\textbf{Effects of non-uniform motion and their tests}.\ To provide some context for our experiment and its results, we will now briefly discuss potential quantum effects connected to strong accelerations and their tests. A fundamental effect related to non-uniform is the dynamical Casimir effect (for a recent review see, e.g, \cite{Dodonov2020}) and related parametric amplification effects caused by non-stationary boundary conditions for quantum fields~\cite{BruschiFuentesLouko2012,FriisLeeLouko2013,AlsingFuentes2012,FriisPhD2013}. Such effects are usually modelled as Gaussian transformations of the field modes corresponding to squeezing (pair creation to lowest order in the relevant parameters) and shifts of excitations. However, the required proper accelerations, or temporal changes thereof, to make the predicted effects visible in experiments are many orders of magnitude away from what can practically be achieved with mechanical motion. Yet, the modulation of microwave-field boundary conditions represented by superconducting quantum interference devices (SQUIDs) can be carried out much more rapidly, which led to the landmark demonstration of the dynamical Casimir effect in~\cite{WilsonJohanssonPourkabirianJohanssonDutyNoriDelsing2011}.\\[-3mm]

In the experiment we present here, the (changes of) accelerations are far too small to expect any effects akin to the dynamical Casimir effect. Nevertheless, our setup provides a testbed for demonstrating the robustness of entanglement-detection experiments under extreme but still reasonably well-controlled conditions that allow ruling out any influence that the non-uniform motion might have.\\[-3mm]
...
’Hyperspace’ 101070168) and from the European Research Council (Consolidator grant ’Cocoquest’ 101043705).\\
...
R.U. conceived and initiated the experiment.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.45\textwidth]{291_4S2A2368_PRINT.jpg}
\caption{
...
\begin{figure*}[hb!]
\centering
\includegraphics[width=0.46\textwidth]{Map_FlightNo1_26102021-eps-converted-to.pdf}
\includegraphics[width=0.46\textwidth]{Map_FlightNo2_27102021-eps-converted-to.pdf}
\vspace*{-4mm}
...
\begin{figure*}[hb!]
\begin{center}
\hspace*{2mm}\includegraphics[width=1.05\textwidth]{Three_Accelerometers_for_Parab_No_1_V2-eps-converted-to.pdf}
\end{center}
\vspace*{-7mm}
...
\begin{figure*}[ht!]
\centering
\hspace*{5mm}\includegraphics[width=0.9\textwidth]{CrystTemp_Druck_TempLev2-eps-converted-to.pdf}
\vspace*{-5mm}
...
\centering
\hspace*{5mm}
\includegraphics[width=0.4\textwidth]{All_Single_Channels_from_4500_to_5900s_V3-eps-converted-to.pdf}
\includegraphics[width=0.4\textwidth]{Singles_and_Acceleration_from_4500_to_5900s_V3-eps-converted-to.pdf}
\vspace*{-4mm}
\caption{
...
\centering
\hspace*{3mm}
\includegraphics[width=0.48\textwidth]{CC_t4500to5900_25_16_28_17_45_36_48_37_V2-eps-converted-to.pdf}
\includegraphics[width=0.48\textwidth]{CC_t4500to5900_26_15_27_18_46_35_47_38_V2-eps-converted-to.pdf}
\vspace*{-2mm}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.5\textwidth]{KST_ECDF_Pno1-10and26-30_V2-eps-converted-to.pdf}
\vspace*{-6mm}
...
\begin{figure*}[h]
\centering
\includegraphics[width=0.9\textwidth]{KST_EDFs_HG_MG_SF_S_and_Acc_vs_time_V2-eps-converted-to.pdf}
\vspace*{-7mm}
...
\begin{figure*}[hb!]
\centering
\includegraphics[width=0.9\textwidth]{KST_EDFs_Jerk_MG_S_and_Acc_vs_time_V3-eps-converted-to.pdf}
\vspace*{-7mm}
...
\begin{figure*}[h]
\centering
\includegraphics[scale=1]{maxDistance_vs_Jerk_V2-eps-converted-to.pdf}
...
\begin{figure*}[h]
\centering
\includegraphics[scale=1]{KST_EDFS_VIS_HV_DA_SF_MG_V2-eps-converted-to.pdf}
...
\begin{figure*}[h]
\centering
\includegraphics[width=0.82\textwidth]{S_over_whole_measurement_with_histogram_and_acceleration_V3-eps-converted-to.pdf}
\vspace*{-2mm}
...
\begin{figure*}[h]
\centering
\includegraphics{Plot_S_values_and_Acc_6_Reihen_V3-eps-converted-to.pdf}
\vspace*{-8mm}
...
\begin{figure*}[h]
\centering
\includegraphics[width=1.0\textwidth]{Visibilities_over_whole_measurement_with_histogram_and_acceleration-eps-converted-to.pdf}
\vspace*{-6mm}
\caption{
...
\begin{figure*}[h]
\centering
\includegraphics{Plot_alle_Vis_und_Acc_6_Reihen_V3-eps-converted-to.pdf}
\vspace*{-3mm}
\caption{
