...
\cellcolor[HTML]{B7FBFF}CLS & &
  ...
  \cellcolor[HTML]{B7FBFF}\textbf{0.675} &
  \cellcolor[HTML]{B7FBFF}\textbf{0.325} &
  \cellcolor[HTML]{B7FBFF}0.847 & &
  \cellcolor[HTML]{B7FBFF}0.114 &
  \cellcolor[HTML]{B7FBFF}0.072 &
  \cellcolor[HTML]{B7FBFF}0.714 &
  \cellcolor[HTML]{B7FBFF}0.189 &
  \cellcolor[HTML]{B7FBFF}0.081 &
  \cellcolor[HTML]{B7FBFF}0.723 &
...
\cellcolor[HTML]{FFE0D1}REG - fixed $\delta$ & &
  ...
  \cellcolor[HTML]{FFE0D1}0.458 &
  \cellcolor[HTML]{FFE0D1}0.145 &
  \cellcolor[HTML]{FFE0D1}0.835 & &
  \cellcolor[HTML]{FFE0D1}0.113 &
  \cellcolor[HTML]{FFE0D1}0.070 &
  \cellcolor[HTML]{FFE0D1}0.706 &
  \cellcolor[HTML]{FFE0D1}0.221 &
...
\cellcolor[HTML]{FFECA8}REG & &
  ...
  \cellcolor[HTML]{FFECA8}0.669 &
  \cellcolor[HTML]{FFECA8}0.297 &
  \cellcolor[HTML]{FFECA8}\textbf{0.862} & &
  \cellcolor[HTML]{FFECA8}0.183 &
  \cellcolor[HTML]{FFECA8}0.103 &
  \cellcolor[HTML]{FFECA8}0.709 &
  \cellcolor[HTML]{FFECA8}0.292 &
  \cellcolor[HTML]{FFECA8}0.118 &
...
Here we achieve new state-of-the-art results on all metrics. The gap between our best variant 
...
On the captioning datasets we observe an interesting result: the \textit{Priors} baseline outperforms or achieves very high performance. 
This supports our argument that captioning datasets are not particularly suitable for our task. 
If a simple look-up table surpasses all learning-based methods, then we conclude it is very difficult to learn adverbs as action changes, 
...
\cellcolor[HTML]{B7FBFF}CLS & &
  ...
  \cellcolor[HTML]{B7FBFF}0.469 &
  \cellcolor[HTML]{B7FBFF}\textbf{0.198} &
  \cellcolor[HTML]{B7FBFF}0.835 & &
  \cellcolor[HTML]{B7FBFF}0.114 &
  \cellcolor[HTML]{B7FBFF}0.072 &
  \cellcolor[HTML]{B7FBFF}0.714 &
  \cellcolor[HTML]{B7FBFF}0.189 &
  \cellcolor[HTML]{B7FBFF}0.078 &
  \cellcolor[HTML]{B7FBFF}0.723 &
...
\cellcolor[HTML]{FFE0D1}REG - fixed $\delta$ & &
  ...
  \cellcolor[HTML]{FFE0D1}0.215 &
  \cellcolor[HTML]{FFE0D1}0.706 &
  \cellcolor[HTML]{FFE0D1}0.461 &
  \cellcolor[HTML]{FFE0D1}0.148 &
  \cellcolor[HTML]{FFE0D1}0.835 & &
  \cellcolor[HTML]{FFE0D1}0.113 &
  \cellcolor[HTML]{FFE0D1}0.070 &
  \cellcolor[HTML]{FFE0D1}0.706 &
  \cellcolor[HTML]{FFE0D1}0.213 &
  \cellcolor[HTML]{FFE0D1}0.095 &
  \cellcolor[HTML]{FFE0D1}0.714 &
...
\cellcolor[HTML]{FFECA8}REG & &
  ...
  \cellcolor[HTML]{FFECA8}0.157 &
  \cellcolor[HTML]{FFECA8}\textbf{0.857} & &
  \cellcolor[HTML]{FFECA8}\textbf{0.120} &
  \cellcolor[HTML]{FFECA8}\textbf{0.073} &
  \cellcolor[HTML]{FFECA8}0.706 &
  \cellcolor[HTML]{FFECA8}\textbf{0.240} &
  \cellcolor[HTML]{FFECA8}\textbf{0.102} &
  \cellcolor[HTML]{FFECA8}\textbf{0.749} &
...
\cellcolor[HTML]{B7FBFF}CLS &
  ...
  \cellcolor[HTML]{B7FBFF}0.420 &
  \cellcolor[HTML]{B7FBFF}0.675 &
  \cellcolor[HTML]{B7FBFF}0.325 & &
  \cellcolor[HTML]{B7FBFF}0.114 &
  \cellcolor[HTML]{B7FBFF}0.072 &
  \cellcolor[HTML]{B7FBFF}0.189 &
  \cellcolor[HTML]{B7FBFF}0.081 &
...
\cellcolor[HTML]{FFECA8}\multirow{-2}{*}{REG} &
  ...
  \cellcolor[HTML]{FFECA8}\textbf{0.481} &
  \cellcolor[HTML]{FFECA8}\textbf{0.716} &
  \cellcolor[HTML]{FFECA8}\textbf{0.393} & &
  \cellcolor[HTML]{FFECA8}0.206 &
...
In Section~\ref{sec:method} we hypothesised that the optimisation of Action Modifiers might be difficult. Results in Table~\ref{tab:results_all} support our hypothesis. When adding the MLP to \textit{Act Mod,} Acc-A remains virtually identical across all datasets. However mAP W/M drop considerably on HowTo100M Adverbs. This dataset is the noisiest among the five datasets, thus in this case increasing the depth of the model makes optimisation more difficult.
Overall, comparing \textit{MLP + Act Mod} to our method we achieve better results even when the additional MLP improves the performance of the original \textit{Act Mod}.
...
Interestingly, Action Modifiers slightly improves 
when removing antonyms, which shows again that 
...
When testing without action labels (Table~\ref{tab:results_no_act_gt}) and learning without antonyms (Table~\ref{tab:results_no_ant}) we notice a more consistent improvement of \textit{REG} over \textit{CLS}.
Rather than maximising the margin between the positive adverb and all other negative adverbs as in classification, with regression we try to learn the extent of the change applied by an adverb. This is evidently a more effective way to learn adverbs 
...
\resizebox{\columnwidth}{!}{%
    ...
    Act Mod~\cite{doughty2020action}             & 0.394 ± 0.023 & 0.140 ± 0.026 & 0.843 ± 0.013 \\
    MLP + Act Mod~\cite{doughty2020action}       & 0.407 ± 0.044 & 0.151 ± 0.033 & 0.842 ± 0.012 \\
    CLS                  & \textbf{0.676} ± 0.001 & \textbf{0.317} ± 0.007 & 0.847 ± 0.001 \\
    REG-fixed $\delta$ & 0.455 ± 0.004 & 0.153 ± 0.018 & 0.835 ± 0.000 \\
    REG                  & 0.662 ± 0.006 & 0.289 ± 0.010 & \textbf{0.863} ± 0.002 \\ \bottomrule
    \end{tabular}%
    }    
...
The size of the evaluated datasets is relatively small for deep learning methods. In order to assess the variance of the results we run experiments on AIR two more times, gathering a total of three runs including results from the paper, following the standard setting where models are trained with antonyms and are tested using the action labels. Table~\ref{tab:res-var} reports mean ± standard deviation of the three evaluation metrics. Our method is more stable than Action Modifiers~\cite{doughty2020action}. Most importantly, the ranking of the methods and the improvement of our method remains the same.
