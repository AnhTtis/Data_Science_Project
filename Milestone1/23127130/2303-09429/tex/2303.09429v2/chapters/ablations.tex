...
{\bf Ablation Study:} \label{sec:ablations}
 First, we construct a reference by replacing pre-trained encoders of CLIP, with BLIP's, presented in \Cref{tab:cirr_test,tab:fiq_val,tab:lasco_val}, named LF-BLIP. Next, we ablate various key-components of \our to examine their impact on performance.
