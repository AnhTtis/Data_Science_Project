...
\documentclass[journal]{IEEEtran}%duoble
%\documentclass[draftclsnofoot,onecolumn]{IEEEtran}% 单栏
\newcommand{\ignore}[1]{}
...
\author{Haiwen~Diao,
        ...
        and~Huchuan~Lu 
\thanks{
% Copyright (c) 2022 IEEE. Personal use of this material is permitted. However, permission to use this material for any other purposes must  be obtained from the IEEE by sending an email to \underline{pubs-permissions@ieee.org}.
