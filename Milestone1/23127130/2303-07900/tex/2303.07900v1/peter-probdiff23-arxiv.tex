...
remove information. A similar, local shuffling has been proposed by Koenderik 
...
\begin{proposition}[Convergences to the Standard Normal Distribution] 
...
over time. Schmidt~\cite{Sc18} has shown that Lyapunov sequences can be 
