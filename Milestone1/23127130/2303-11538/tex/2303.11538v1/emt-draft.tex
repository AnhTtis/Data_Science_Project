...
\definecolor{pine}{rgb}{0.3, 0.5, 0.3}
\newcommand{\CL}[1]{{\color{orange} #1}}
\newcommand{\BP}[1]{{\color{red} #1}}
\newcommand{\QTS}[1]{{\color{blue} #1}}
\allowdisplaybreaks
\begin{document}
...
\end{equation}
Its parametrization in terms of twist-2, twist-3 and twist-4 quark TMDs reads~\cite{Goeke:2005hb,Bacchetta:2006tn}
\begin{equation}
\begin{aligned}
...
\end{aligned} 
\end{equation}
reminding that $k^2_T=-\uvec k_\perp^2$. Setting $\nu=+$ in Eq.~\eqref{reltoTMD}, we find
\begin{equation}
    \begin{aligned}
...
of China under Grant Number 12005191 and the China Scholarship Council 
