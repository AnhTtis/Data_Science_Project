\begin{figure}[h]
    \centering
    {Full results on \textbf{\coco} (\fone score).}\vspace{.25cm}\\
    ...
    We find the \epgloss loss to give the best trade-off between \epg and \fone, whereas the \lone loss (especially at the final layer) provides the best trade-off between \iou and \fone. We further find these results to be consistent across datasets, see \cref{fig:supp:voc:f1_results}.}
    \label{fig:supp:coco:f1_results}
\end{figure}