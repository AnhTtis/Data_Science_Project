...
%\subfloat[Visualization 3\label{fig:vis_3}]{
%\includegraphics[width=0.83\linewidth]{eps/vis_3.eps}
%}
%\\ 
%\subfloat[Example 4\label{fig:vis_4}]{
%\includegraphics[width=0.83\linewidth]{eps/vis_4.eps}
%} 
%\\
%\subfloat[Example 5\label{fig:vis_2}]{
%\includegraphics[width=0.48\linewidth]{eps/vis_2.eps}
%}  \\
%\subfloat[Example 6\label{fig:vis_6}]{
%\includegraphics[width=0.48\linewidth]{eps/vis_6.eps}
%} 
%\\
%\subfloat[Example 7\label{fig:vis_7}]{
%\includegraphics[width=0.48\linewidth]{eps/vis_7.eps}
%}  
%\subfloat[Example 8\label{fig:vis_8}]{
%\includegraphics[width=0.48\linewidth]{eps/vis_8.eps}
%} 
%\\
%\subfloat[Example 9\label{fig:vis_9}]{
%\includegraphics[width=0.48\linewidth]{eps/vis_9.eps}
%}  
%\subfloat[Example 10\label{fig:vis_10}]{
%\includegraphics[width=0.48\linewidth]{eps/vis_10.eps}
%} 
%\\
%\subfloat[Example 11\label{fig:vis_11}]{
%\includegraphics[width=0.48\linewidth]{eps/vis_11.eps}
%}  
%\subfloat[Example 12\label{fig:vis_12}]{
%\includegraphics[width=0.48\linewidth]{eps/vis_12.eps}
%}
%\\
%\subfloat[Example 13\label{fig:vis_13}]{
%\includegraphics[width=0.48\linewidth]{eps/vis_13.eps}
%}  
%\subfloat[Example 14\label{fig:vis_14}]{
