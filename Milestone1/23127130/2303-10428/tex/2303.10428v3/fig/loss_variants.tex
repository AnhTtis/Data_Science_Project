...
\includegraphics[width=0.18\linewidth]{eps/d_loss.eps}
}
\subfloat[$\mathit{Triple}$\label{fig:loss_trip}]{
\includegraphics[width=0.18\linewidth]{eps/t_loss.eps}
}
\subfloat[{$\mathit{Single}_{1}$}\label{fig:loss_inf_vis}]{
\includegraphics[width=0.18\linewidth]{eps/s_loss_1.eps}
}
\subfloat[{$\mathit{Single}_2$}\label{fig:loss_clue_vis}]{
\includegraphics[width=0.18\linewidth]{eps/s_loss_2.eps}
}
\subfloat[{$\mathit{MTL}$}\label{fig:loss_mt}]{
\includegraphics[width=0.18\linewidth]{eps/s_loss_3.eps}
}
