...
\includegraphics[width=0.28\linewidth]{eps/p1_no_train.eps}
}
\subfloat[$\mathit{Single}_{1}$\label{fig:dist_p3_inf_only}]{
\includegraphics[width=0.28\linewidth]{eps/p3_inf_only.eps}
}
 \subfloat[$\mathit{Single}_{2}$\label{fig:dist_p2_clue_only}]{
\includegraphics[width=0.28\linewidth]{eps/p2_clue_only.eps}
}\\
 \subfloat[$\mathit{MKL}$\label{fig:dist_p4_mkl}]{
\includegraphics[width=0.28\linewidth]{eps/p4_mkl.eps}
}
 \subfloat[$\mathit{Triple}$\label{fig:dist_p5_trip}]{
\includegraphics[width=0.28\linewidth]{eps/p5_trip.eps}
}
 \subfloat[$\mathit{Dual}$\label{fig:dist_p6_dual}]{
\includegraphics[width=0.28\linewidth]{eps/p6_dual.eps}
}
