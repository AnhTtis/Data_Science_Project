 \begin{figure}[ht!]
\centering
\subfloat[$\mathit{Dual}$\label{fig:loss_dual}]{
\includegraphics[width=0.19\linewidth]{eps/d_loss.eps}
}
\subfloat[$\mathit{Triple}$\label{fig:loss_trip}]{
\includegraphics[width=0.19\linewidth]{eps/t_loss.eps}
}
\subfloat[{$\mathit{Single}_{1}$}\label{fig:loss_inf_vis}]{
\includegraphics[width=0.19\linewidth]{eps/s_loss_1.eps}
}
\subfloat[{$\mathit{Single}_2$}\label{fig:loss_clue_vis}]{
\includegraphics[width=0.19\linewidth]{eps/s_loss_2.eps}
}
\subfloat[{$\mathit{MTL}$}\label{fig:loss_mt}]{
\includegraphics[width=0.19\linewidth]{eps/s_loss_3.eps}
}
\vspace{-0.3cm}
...
%	\end{subfigure}
  \caption{\textbf{Training Losses}: Dual (a), Triple (b) and Single (c)-(e) contrastive loss for learning to match visual $\boldsymbol{I}$ to texts $\boldsymbol{c}$ and $\boldsymbol{h}$. Solid and dashed lines represent the presence or absence of contrastive loss during training.
}\label{fig:loss_all}
\vspace{-0.3cm}
\end{figure}
