...
RCA (\texttt{R-CTX})&73.31&81.95&60.84&{75.81}&\textbf{86.47} &{61.98} &{76.35} &{75.43} \\
RCA (\texttt{R-CPT})&74.04&82.80&62.81&76.40&86.34&63.12&76.59&75.47 \\
%\rpa~(\texttt{R-CiR})&&&&&&&& \\
    \bottomrule
    \end{tabular}
    }
    %\vspace{-10pt}
           \caption{\textbf{Comparsion on the RefCOCO+/g}. We test with RCA ViT-L14 (336). higher=better}
    \vspace{-10pt}
    \label{tab:res_rc}
\end{table}