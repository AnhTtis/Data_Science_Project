...
% \vspace{-.5cm}
    ...
    % \begin{tabularx}{\linewidth}{l@{\hskip 0.2in}c@{\hskip 0.1in}c@{\hskip 0.1in}c@{\hskip 0.1in}c}
    ...
    % \end{subfigure}
    %\begin{subfigure}[t]{\linewidth}
        \begin{tabularx}{\linewidth}{l@{\hskip 0.2in}c@{\hskip 0.2in}c@{\hskip 0.2in}c}
        \toprule
          &  GroundingYT   &  MiningYT & YouCook-Inter.   \\
    ...
    % \begin{subfigure}[t]{\linewidth}
    %     \begin{tabularx}{\linewidth}{l@{\hskip 0.6in}c@{\hskip 0.2in}c@{\hskip 0.2in}c}
    %     \toprule
    ...
    \caption{
        ...
        % \textbf{(a)} starting with a shorter temporal distance between query-key clips and relaxing the constraint as training progresses improves performance. 
         \textbf{(a)} Sinkhorn strategy results in better supervision. 
        ...
        \textbf{(b)} both losses contribute to the final loss, and the existence of global loss helps the localization task.
        \textbf{(c)} combining cross and self-attention layers boosts the local representation learning performance.
