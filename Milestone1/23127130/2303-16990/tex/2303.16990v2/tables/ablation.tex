...
% \vspace{-.5cm}
    ...
    % \begin{tabularx}{\linewidth}{l@{\hskip 0.4in}c@{\hskip 0.1in}c@{\hskip 0.1in}c@{\hskip 0.1in}c}
    ...
    \resizebox{2\columnwidth}{!}{
        \begin{tabularx}{\linewidth}{l@{\hskip 0.4in}c@{\hskip 0.4in}c@{\hskip 0.4in}c@{\hskip 0.4in}|@{\hskip 0.4in}c@{\hskip 0.4in}c@{\hskip 0.4in}c}
        \toprule
          &  GroundingYT   &  MiningYT & YC-Inter. &  GroundingYT   &  MiningYT & YC-Inter.  \\
                                        &  Spatio-temporal  &  Temporal & Spatial  &  Spatio-temporal  &  Temporal & Spatial  \\
        \midrule
                                        & \multicolumn{3}{c}{w/o Sinkhorn}  & \multicolumn{3}{c}{with Sinkhorn} \\
        \midrule
        None &  17.43    & 18.34  & 57.42  &-& - & - \\
        Global T - Global V &   18.24   &  19.38 &  56.31 &18.96 &19.89 & 57.34 \\
        Global T - Local V &   18.01   &  19.31  &  57.56 & 18.53  & 19.35 &57.67\\
        Local T  - Global V &  18.05    &  19.85 &  57.34 &19.32 & \textbf{20.36} & 58.13 \\
        Local T - Local V &   18.31   & 19.48   & 57.86  & 19.43 & 20.16& \textbf{58.51}\\
        \midrule
        Average over last two  &  18.36  & 19.68   &   57.77  & \textbf{19.45} & 20.33 &58.35 \\
        \bottomrule
        \end{tabularx}}
        \vspace{-5pt}
        %\caption{Effect of different frame selection strategy.}
    ...
    % \begin{subfigure}[t]{\linewidth}
    %     \begin{tabularx}{\linewidth}{l@{\hskip 0.4in}c@{\hskip 0.4in}c@{\hskip 0.4in}c@{\hskip 0.4in}c@{\hskip 0.4in}c}
    %     \toprule
    ...
    % \begin{subfigure}[t]{\linewidth}
    %     \begin{tabularx}{\linewidth}{l@{\hskip 0.6in}c@{\hskip 0.4in}c@{\hskip 0.4in}c}
    %     \toprule
    ...
    % \begin{subfigure}[t]{\linewidth}
    %     \begin{tabularx}{\linewidth}{l@{\hskip 0.4in}c@{\hskip 0.4in}c@{\hskip 0.4in}c}
    %     \toprule
    ...
    % \begin{subfigure}[t]{\linewidth}
    %     \begin{tabularx}{\linewidth}{l@{\hskip 0.15in}c@{\hskip 0.15in}c@{\hskip 0.15in}c}
    %     \toprule
    ...
    \caption{
        ...
        % \textbf{(a)} starting with a shorter temporal distance between query-key clips and relaxing the constraint as training progresses improves performance. 
         \textbf{(a)} Sinkhorn selection results in better supervision. 
         % \textbf{(b)} increasing the video length during training improves the performance but decreases when the video length is too long since it includes irrelevant signals.
        \textbf{(b)} We investigate all possible combinations of global and local representations for frame selection similarity matching. We found keeping the local text representation is crucial, and a combination of local and global representation leads to the best spatio-temporal grounding result.
