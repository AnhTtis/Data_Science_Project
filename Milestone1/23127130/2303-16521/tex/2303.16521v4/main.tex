...
\centering
\caption{Quality of the learned representations, as assessed by linear and KNN probes. Our method performs comparably to CKM on the vision datasets, and better on RealDISP, fitting with the case made in \citet{mahon2022har} against autoencoders in HAR clustering.} \label{tab:probe-results}
\end{table*}
%\end{SCtable*}
