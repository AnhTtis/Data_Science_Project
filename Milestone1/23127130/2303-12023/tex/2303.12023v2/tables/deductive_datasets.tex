...
PARARULE-Plus     & \xmark             &   \xmark       & \checkmark    &        \checkmark          &    \checkmark          &     \xmark      &  400k     \\
...
\end{tabular}}
\caption{Summary of deductive reasoning datasets: D*, ParaRules \& birds-electricity~\citep{DBLP:conf/ijcai/ClarkTR20}; leap-of-thought~\citep{talmor2020leap};
PARARULE-Plus~\citep{bao2022multi}; FOLIO~\citep{DBLP:journals/corr/abs-2209-00840}; D*(CWA) \& D*(OWA)~\citealp{DBLP:conf/acl/TafjordDC21}; EntailmentBank~\citep{DBLP:conf/emnlp/DalviJTXSPC21}; ENWN~\citep{DBLP:journals/corr/abs-2211-00614}.
