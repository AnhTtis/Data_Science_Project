...
\paragraph{DRVN} In the original paper \citep{zhang2022drvn}, only the Biot-Savart kernel is concerned. We extend the DRVN method to the Coulomb case by setting $K$ to be the kernel defined in \eqref{eqn_coulomb_interaction}.
