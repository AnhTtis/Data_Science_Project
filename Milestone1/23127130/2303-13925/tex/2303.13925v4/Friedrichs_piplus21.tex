...
\draw[thick] \connt(150, 2.5, 0, (\r+0.2), 0.3) ++(1,0) .. (0.5,-0.7) -- (-1.2,-0.7); \extl(-1.2, -0.7)
\draw[thick] \connt(210, 2.5, 0, (\r+0.2), 0.3) ++(1,0) .. (0.5,-1) -- (-1.2,-1); \extl(-1.2, -1.0)

\draw[thick] \connt(30, 0, 0, (\r+0.2), 0.3) ++(-1,0) .. (2,1) -- (3.7,1); \extr(3.7, 1)
\draw[thick] \connt(-10, 0, 0, (\r+0.2), 0.8) ++(-1,0) .. (2,0.7) -- (3.7,0.7); \extr(3.7, 0.7)
...
\draw[red, opacity = .8, line width = 1] \connt(10, 0, 0, (\r+0.2), 0.5) \connte(190, 2.5, 0, (\r+0.2), 0.5);
...
\draw[red!50!blue] (2.06,0.24) -- ++(0.6,-1) node[anchor = north] {\scriptsize $ (B, n_B) $};
\draw[red!50!blue, line width = 1, dashed, rotate around = {-10:(0.6,-0.1)} ] (0.6,-0.1) ellipse (0.3 and 0.6);
\draw[red!50!blue, line width = 1, dashed, rotate around = {20:(1.9,-0.2)} ] (1.9,-0.2) ellipse (0.3 and 0.5);
\node[red!50!blue] at (0.4,0.9) {\scriptsize apply $ \sigma, \sigma' $};
\draw[red!50!blue] (0.5,0.7) -- (0.56,0.46);
\draw[red!50!blue] (0.7,0.7) -- (1.68,0.26);
