...
\draw[thick] \connt(150, 2.5, 0, (\r+0.2), 0.8) ++(1,0) .. (0.5,-0.7) -- (-1.2,-0.7); \extl(-1.2, -0.7)
\draw[thick] \connt(230, 2.5, 0, (\r+0.2), 0.3) ++(1,0) .. (0.5,-1) -- (-1.2,-1); \extl(-1.2, -1.0)
...
\draw[red, opacity = .8, line width = 1] \connt(-30, 0, 0, (\r+0.2), 0.5) \connte(190, 2.5, 0, (\r+0.2), 0.5);
\draw[red, opacity = .8, line width = 1] \connt(-50, 0, 0, (\r+0.2), 1) \connte(170, 2.5, 0, (\r+0.2), 0.5);
...
\draw[red!50!blue, line width = 1, ->] (2.08, 0.18) .. controls ++(0.2, -0.2) and ++(0.1,0.2) .. (2.08, -0.34);
\node[blue!50!red] at (2.5,-0.9) {\scriptsize 3 swaps};
