...
\author{
Jing Zhao\footnotemark[1]\\ 
National University of Defense Technology\\
{\tt\small zhaojing@nudt.edu.cn}
\and
Heliang Zheng\\
JD Explore Academy\\
{\tt\small zhengheliang@jd.com}
\and
Chaoyue Wang\\
JD Explore Academy\\
{\tt\small chaoyue.wang@outlook.com}
\and
Long Lan\\
National University of Defense Technology\\
{\tt\small long.lan@nudt.edu.cn}
\and
Wenjing Yang\footnotemark[2]\\
National University of Defense Technology\\
{\tt\small wenjing.yang@nudt.edu.cn}
}
...
\begin{algorithm}[ht]
	\caption{Saliency-aware Noise Blending}  %算法的名�?        \label{HPLA}
...
\begin{figure*}[t]
\begin{center}
   \includegraphics[width=0.95\linewidth]{ SM_car.pdf}
\end{center}
   \caption{Supplementary materials for the experimental results of Application 1.}
\label{fig:10}
\end{figure*}

\begin{figure*}[t]
\begin{center}
   \includegraphics[width=0.95\linewidth]{ SM_car2.pdf}
\end{center}
   \caption{Supplementary materials for the experimental results of Application 1.}
\label{fig:11}
\end{figure*}
...
\begin{figure*}[t] 
\begin{center}
   \includegraphics[width=0.95\linewidth]{ SM_recon.pdf}
\end{center}
\vspace{-5mm}
   \caption{Supplementary materials for the experimental results of Application 2.}
\label{fig:12}
\end{figure*}
...
\begin{figure*}[t] 
\begin{center}
   \includegraphics[width=0.95\linewidth]{ SM_cartoon.pdf}
\end{center}
   \caption{Supplementary materials for the experimental results of Application 3.}
\label{fig:13}
\end{figure*}
