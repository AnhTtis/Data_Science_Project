...
Therefore, we propose {\name} to explicitly model the static and dynamic details for high-fidelity 3D face reconstruction, by designing {\module} module to decouple the static and dynamic factors.
% 
...
\item We propose {\name} to model the static and dynamic details explicitly, and demonstrate the benefits of synthetic data in decoupling the static and dynamic factors for detailed 3D face reconstruction.
