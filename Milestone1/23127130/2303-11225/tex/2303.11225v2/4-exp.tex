...
\myparagraph{Dataset.}
%
We use a hybrid dataset made up from both synthetic~\cite{wood2021fake,raman2022mesh} and real data~\cite{CelebAMask-HQ,mollahosseini2017affectnet}. 
...
%
We follow~\cite{danvevcek2022emoca,wood2022dense,deng2019accurate} to split the dataset into training and validation sets. The test images are from CelebA~\cite{CelebAMask-HQ}, FFHQ~\cite{karras2019style}, LS3D-W~\cite{bulat2017far}, and AFLW2000~\cite{yin2017towards}.
