...
\begin{figure}
    ...
    \end{overpic}
    \put(-225,120){\bfseries\scriptsize (a)}
    \put(-182,120){\bfseries\scriptsize (b)}
    \put(-110,120){\bfseries\scriptsize (c)}
    \put(-35,120){\bfseries\scriptsize (d)}
    \vspace{-10pt}
