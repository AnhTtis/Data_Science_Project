\begin{table}[t]
    ...
    \resizebox{1.0\textwidth}{!}{
        \begin{tabular}{ccccccc}
            ...
            VoRTX \cite{stier2021vortx}               & 0.089              & 0.092                  & 0.618 & 0.589 & 0.603\\
            Ours                                      & 0.068              & 0.062                 & 0.609               & 0.616             & 0.612                \\            
    \Xhline{3\arrayrulewidth}
        \end{tabular} }
    \caption{\textbf{Quantitative 3D reconstruction results on ScanNet.} Our method is superior to two main baselines, Atlas and NeuralRecon, and as competitive as other SOTAs on 3D reconstruction.}
    \vspace{-0.2cm}
