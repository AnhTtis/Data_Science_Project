...
Kendall Tau Distance measures the number of inversions of pairs between two ordered lists, or it could be described as the number of adjacent swaps that need to make from one list to another. It is a metric modified from Kendall-Tau Correlation.
