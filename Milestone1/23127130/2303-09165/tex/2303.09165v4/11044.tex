...
In addition to Table \ref{tab:fd_vs_ut}, we also show the learning process of various network architectures in Figs. \ref{fig:comparison_of_3models} and A6. We take the following interesting observations. 
%
...
\textbf{(3)} With strong data augmentation, ResNet-50 fits best and shows the best convergence, though it has a more volatile learning process for the OOD test (cf. Figs. \ref{fig:comparison_of_3models} and A6).
...
\begin{figure*}[!ht]
	...
	\label{fig:comparison_of_3models_all}
\end{figure*}
...
\begin{figure*}[!ht]
	...
	\subfloat[MCD]{
		\begin{minipage}[t]{0.33\textwidth}
			...
			\label{fig:da_learning_curves_all:3}
		\end{minipage}
	}
	\\
	\subfloat[RCA]{
...
\begin{figure*}[!ht]
	\centering
	\includegraphics[width=1.0\textwidth]{images/dataset_statistics.png}
