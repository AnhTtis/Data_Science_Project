...
%\usepackage[dvips]{epsfig}    % or this line, depending on which
                               % you prefer.
\input{sections/common/preamble}
...
\input{sections/common/sym_defs}
