...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\columnwidth]{figs/control_diagram_5.pdf}
	\caption{Shows the control diagram with signals. Blue indicates computations conducted remotely and green indicates onsite units and yellow the physical components. The grey boxes contain the control layers in the hierarchical control structure. The update period is shown in the modules.}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.6\columnwidth]{figs/control_concept_dotQhp_R.pdf}
