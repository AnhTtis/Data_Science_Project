...
The model in \eqref{eq_all_ss} is observable for any $\Ur, \Uamb > 0$.
\begin{align}
    \mathcal{O} = \begin{bmatrix} \Cm \\ \Cm\Am \end{bmatrix} \ = \begin{bmatrix} 1 & 0 \\ -\left(\Ur + \Uamb\right) & \Ur \end{bmatrix}
\end{align}
