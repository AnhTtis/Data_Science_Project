...
\noindent
{\bf Dense Cross-view consistency} Instead of applying coherence at the global-level, a more granular self-supervision can be obtained by enforcing cross-view consistency between matching local regions \cite{henaff2021efficient,Lebailly_2023_WACV,o2020unsupervised,stegmuller2023croc,wen2022slotcon,wang2021dense}.
