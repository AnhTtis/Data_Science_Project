...
\author{Zidi Xiu\inst{1}\textsuperscript{$\dagger$}, Kai-Chen Cheng\inst{1}, David Q. Sun\inst{1}\textsuperscript{$\dagger$}, Jiannan Lu\inst{1}, Hadas Kotek\inst{1}, Yuhan Zhang\inst{2}\thanks{Contributions made during the internship at Apple in the summer of 2022.}, Paul McCarthy\inst{1},  Christopher Klein\inst{1}, Stephen Pulman\inst{1}, Jason D. Williams\inst{1}% All authors must be in the same font size and format. Use \Large and \textbf to achieve this result when breaking a line
}
