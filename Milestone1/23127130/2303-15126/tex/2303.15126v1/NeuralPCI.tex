...
\def\cvprPaperID{4131} % *** Enter the CVPR Paper ID here
\def\confName{CVPR}
\def\confYear{2023}
...
% background, existing progress, problem state, our appoach to solve this problem, performance
\end{abstract}
...
\input{tables/DHBresults}

\input{tables/NonlinearResults}
...
\input{tables_supp/layer_width.tex}

\input{tables_supp/layer_depth.tex}
...
\input{tables_supp/NNRandom}

\input{tables_supp/multiframes}

\input{tables_supp/InputFrames}
...
\input{tables_supp/ExplicitImplicit}
  
\input{tables_supp/foreground}
