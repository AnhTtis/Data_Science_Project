...
%add and subtract $\dualp{\energy''(\solh)  \solh}{\testfunh}	$
%
	\begin{align}
...
\begin{proof}
We use an Aubin--Nitsche argument and let $\testfunFOUR \in \Honeperp$ be the solution of
	%
	\begin{equation}
