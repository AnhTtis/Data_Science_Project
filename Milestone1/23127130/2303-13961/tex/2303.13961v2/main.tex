...
As another theoretical tool, we also require the orthogonal projection $\projLtwoisol : \Honeperp \rightarrow \VShperp$ satisfying
%
\begin{equation}
...
\bulletpoint{a} The  family of spaces $\VSh$ is dense in $H^1(\Omega)$ in the sense that for each $\testfun \in H^1$ we have
%
\begin{equation}
