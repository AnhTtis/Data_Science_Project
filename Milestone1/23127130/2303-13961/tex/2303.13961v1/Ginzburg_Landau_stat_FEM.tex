...
\title[Error bounds
%/estimates
 for discrete minimizers of the Ginzburg--Landau energy]
{Error bounds
%	/estimates
for discrete minimizers of the Ginzburg--Landau energy
in the high-{\Large$\kappa$} regime}

%{Finite Element approximation to minimizers of the time-independent Ginzburg--Landau equation (parameter explicit?)}
