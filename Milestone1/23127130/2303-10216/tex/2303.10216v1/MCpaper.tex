...
\usepackage[lined,linesnumbered,ruled,commentsnumbered]{algorithm2e}
...
\thanks{co-first author and corresponding author, kostaskotsiopoulos@discover.com} \and  Alexey Miroshnikov\textsuperscript{\specificthanks{1},}\thanks{co-first author, alexeymiroshnikov@discover.com} \and
Khashayar Filom\textsuperscript{\specificthanks{1},}\thanks{khashayarfilom@discover.com}
\and Arjun Ravi Kannan\textsuperscript{\specificthanks{1},}\thanks{arjunravikannan@discover.com}  }
...
\input{Sec3_MC_theory}

\input{Sec4_Numerical_examples}

\input{Appendix}

\input{References_natbib}
