...
The main difference between VideoXum and other existing datasets is that VideoXum contains aligned video and text summaries, while others only have single-modal summaries for source videos.
