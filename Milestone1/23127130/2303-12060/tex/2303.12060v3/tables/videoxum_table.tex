...
\vspace{-2mm}
\small
\begin{adjustbox}{width=0.99\textwidth}\setlength\tabcolsep{10pt}
...
\multicolumn{9}{>{\columncolor[gray]{.85}}l}{\textbf{Single-Modal Video Summarization}}  \vspace{0.2em}                                                                             \\
\multicolumn{9}{>{\columncolor{myred}}l}{{Video-to-Video Summarization}}  \vspace{0.2em} \\
...
\multicolumn{9}{>{\columncolor{myblue}}l}{{Video-to-Text Summarization}}  \vspace{0.2em} \\
TSUM-BLIP (Base)          & -        & -           & -           & 5.5 &	11.7 &	24.9 & 	18.6  & -                 \\ 
$\ \ $+ Temporal Transformer  & -        & -           & -          & 5.6      & 11.8      & 24.9      & 20.9    & -                \\ \midrule[1.2pt]
\multicolumn{9}{>{\columncolor[gray]{.85}}l}{\textbf{Cross-Modal Video Summarization}}    \vspace{0.2em} \\
