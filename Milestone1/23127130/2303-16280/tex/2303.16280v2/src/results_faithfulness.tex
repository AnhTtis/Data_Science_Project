...
\begin{figure}[ht]
    ...
    \caption{Examples of face landmark distance (Lm-$L_2$) between an input and a translated image. On average: EGSDE~(0.0188), EGSDE$^\dag$~(0.0227), and UVCGAN~(0.0152). (\autoref{sec:Faithfulness})}
    \label{fig:face_landmark}
\end{figure}


As an initial attempt, we consider an approximation to such a metric---similarity of face landmarks~\cite{facelm_creusot20103d,facelm_Burgos-Artizzu_2013_ICCV,facelm_mediapipe}.
