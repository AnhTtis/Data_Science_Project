...
\begin{table}[t]
    \caption{\textbf{Model Performance versus magnitude of the pixel-wise consistency loss.}}
    \vskip-3mm
    ...
    \centering
        \begin{tabular}{r|rr|rr}
            ...
            $\lambda_\text{consist}$ & FID$\downarrow$ & $L_2\downarrow$ & FID$\downarrow$ & $L_2\downarrow$ \\ 
            \midrule
