...
The auxiliary tasks performing supervised \cite{hou2019cross} or self-supervised \cite{liu2021learning,lai2022tsf,lai2022rethinking} learning are widely used to improve the generalization ability of few-shot models.
%The auxiliary tasks performing supervised \cite{hou2019cross} or self-supervised \cite{wertheimer2021few,lai2022tsf,lai2022rethinking} learning are widely used to improve the generalization ability of few-shot models, which are demonstrated to be effective for FSL.
%CAN \cite{hou2019cross} added a global classifier which classifies all categories of the base dataset.
%The self-supervised learning methods are integrated for FSL, e.g. contrastive learning \cite{carlos2020self,liu2021learning,wertheimer2021few} and rotation classifier \cite{gidaris2019boosting,su2020does,lai2022tsf,lai2022rethinking}.
...
Then, inspired by \cite{lai2022rethinking}, the overall multi-task loss is:
\begin{small}
\begin{equation}
%\vspace{-0.5mm}
\begin{aligned}
