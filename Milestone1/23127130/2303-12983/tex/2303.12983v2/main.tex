...
%
{\bf George N. Wojcik~\footnote{gwojcik@wisc.edu}, Lisa L.~Everett~\footnote{leverett@wisc.edu}, Shu Tian Eu~\footnote{eu@wisc.edu}, 
 Ricardo Ximenes~\footnote{dossantosxim@wisc.edu}}
%
...
\begin{align}\label{eq:mf-block-def}
    ...
    0 & \frac{y_H v}{\sqrt{2}} & M^+_{L} & 0 & 0 \\ y^{\Delta}_{SE}  r_\Delta v_\Phi  & M_{E}^+ & \frac{y_{HV}v}{\sqrt{2}} & 0 & 0 \\ 0 & 0 & 0 & \frac{y_H v}{\sqrt{2}} & M^-_{L} \\ y^{\Delta}_{SE} r_\Delta v_\Phi  & 0 & 0 & \pm M^-_{E} & \frac{y_{HV}v}{\sqrt{2}}),
\end{align}
in which $v$ is the usual SM electroweak Higgs vev, and we have introduced the 
shorthanded notation $y^\Delta_{SL,SE}=(y_{SL,SE}/2) \cos \theta_\Delta$. 
...
\begin{align}
   L^b_{L}&=\frac{1}{\sqrt{2}}\frac{M^-_L}{M^0_{L}}\Psi_{L_{11}}+\frac{1}{\sqrt{2}}\frac{M^+_L}{M^0_{L}}\Psi_{L_{22}}, \qquad e^b_{R}=\pm\frac{1}{\sqrt{2}}\frac{ M^-_E}{M^0_{E}}\Psi_{R_{11}}+\frac{1}{\sqrt{2}}\frac{M^+_E}{M^0_{E}}\Psi_{R_{22}},\nonumber
     \\
   L^0_{L}&=-\frac{1}{\sqrt{2}}\frac{M^+_L}{M^0_{L}}\Psi_{L_{11}}+\frac{1}{\sqrt{2}}\frac{M^-_L}{M^0_{L}}\Psi_{L_{22}}, \quad L^0_{R}=V^0_R, \\
   E^0_{L}&=V^0_L, \qquad E^0_{R}=-\frac{1}{\sqrt{2}}\frac{M^+_E}{M^0_{E}}\Psi_{R_{11}}\pm \frac{1}{\sqrt{2}}\frac{ M^-_E}{M^0_{E}}\Psi_{R_{22}}, \nonumber
\end{align}
with masses
...
\begin{align}
    L^a_{L}&=S_{L}, \qquad e^a_{R}=S_{R}, \qquad
