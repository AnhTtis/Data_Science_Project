...
\subsection*{Acknowledgements} The author is grateful to Vadim Gorin for a lot of stimulating discussions, and all his useful suggestions on the presentation of this text. We thank Grigori Olshanski for pointing out one useful reference, Simon Marshall for explaining some basics of symmetric spaces, and Margit Roesler for clarification of a technical issue in her lecture notes. We are also indebted to Florent Benaych-Georges, Pierre Mergny and Michael Voit for their valuable comments. The project was partially supported by NSF grants DMS-1949820 and DMS - 2152588.
