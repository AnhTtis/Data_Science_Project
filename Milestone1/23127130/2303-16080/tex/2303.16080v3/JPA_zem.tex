...
\address{Department of Physics, University of Texas 
...
%\keywords{Quantum theory \and gravitaional interaction 
...
Recent results [19] show that the existence of the Schr\"odinger 
...
halo's effects on the particles and the constant density) [20] 
to describe properly the behavior of DM particles in the halo. 

In this paper a quantum theory of a DM halo is developed 
based exclusively on the NAE.  The idea of using the NAE 
to describe DM is justified by the fact that both the SE 
and NAE are complementary, and that the SE describes 
well the microscopic structure of OM but fails to represent 
DM.  Thus, it seems natural to attempt to model DM halos 
using the NAE, and the developed theory is presented in 
this paper.  It must be also pointed out that both the SE
and NAE can be used to describe classical waves, such 
as acoustic waves and their propagation in stratified 
background media (e.g., [36]). 

The developed theory predicts a quantum structure of the halo 
that resembles an atom, which means that each halo has a 
core and an envelope that surrounds it.  The core is free of the 
quantum structure that is only present in the envelope.  The 
behavior of dark matter particles in the core and envelope is 
very different.  In the core, particles move randomly and collide, 
while in the envelope they are confined to their orbits, which 
are quantized.  The theory is applied to a DM halo with a given 
density profile and theoretical predictions of this theory have 
...
\end{equation}  
%   
where $\Omega_c^2 (R)$ plays the role of gravitaional potential.
...
Einasto or NFW profiles (e.g., [37-40]); nevertheless, the model 
...
[41,42].  In addition, the dimensionless constant $\kappa_h$ 
...
which allows finding $\Omega_n$ and using Eq. (\ref{eq19})
the values of $R_n$ in the envelope as well as in the vicinity
of the halo.  It is seen that $R_{min}$ in the envelope is 
reached by a finite number of $n$, and that this number 
...
profiles for DM halos (e.g., [37-40]) are considered, 
...
wave background [43] and make it different than such wave 
background of the envelope that surrounds this core; it is 
suggested that the difference may be detected observationally.
...
The author thanks Dora Musielak for valuable comments 
on the earlier version of this manuscript.  This work was 
...
\bibitem{34} S.C. Spivey, Z.E. Musielak, and J.L. Fry, MNRAS 428 (2013) 712 
\bibitem{35} S.C. Spivey, Z.E. Musielak, and J.L. Fry, MNRAS 448 (2015) 1574 
\bibitem{36} Z.E. Musielak, Adv. Math. Phys., (2023) Article ID 5736419 (14pp)
\bibitem{37} J. Einasto, and U. Haud, Astron. Astrophys. 223 (1989) 89 
\bibitem{38} J.F. Navarro, C.S. Frenk, and S.D. White,  Astrophys. J. 
                   462 (1996) 563 
\bibitem{39} D. Merritt, et al., Astron. J. 132 (2006) 2685
\bibitem{40} J.F. Navarro, et al., MNRAS 402 (2010) 21
\bibitem{41} A.N. Bushev, MNRAS 417 (2011) L83
\bibitem{42} K. Garrett and G. Duda, Adv. Astron. (2011) Article ID 968283 (22 pages)
\bibitem{43} J.D. Romano, and N.J. Cornish, Living Rev. Relativ. 20 (2017) (1): 2
\end{thebibliography}
\end{document}
