...
\section {\uppercase\expandafter{\romannumeral2}. Temperature-dependent optical conductivity}
\subsection{\uppercase\expandafter{\romannumeral2-1} Fitting analysis of the Drude, phonon, and interband contributions}
...
For the interband conductivity, $\sigma^{\mathrm{IB}}(\omega)$ was obtained by subtracting $\sigma^{\mathrm{D}}(\omega)$ and $\sigma^{\mathrm{Ph}}(\omega)$ from $\sigma_{1}(\omega)$, $\sigma^{\mathrm{IB}}(\omega)$ = $\sigma_{1}$$(\omega)$ $-$ [$\sigma^{\mathrm{Ph}}(\omega)$ $+$ $\sigma^{\mathrm{D}}(\omega)$] 

3. Figure \ref{fig:sm:seperate} displays the fitting curves $\sigma^{\mathrm{D}}(\omega)$, $\sigma^{\mathrm{Ph}}(\omega)$ and $\sigma^{\mathrm{IB}}(\omega)$ for 5 K $\leq$ $T$ $\leq$ 300 K for $E \parallel k_x$ and $E \parallel k_z$. 

4. Figure \ref{fig:sm:drude} shows the fitting parameters $\omega_{p}$ and $\gamma$ of the Drude peak as a function of $T$. 

5. Table \ref{table:stable1} summarizes the Drude and phonon fitting parameters at $T$ = 5 K for the two light polarizations. 
\newline
...
\hline
 $E \parallel k_x$ & 500.0 & 16.0 & 117.9 & 200.0 & 1.2 & 171.9 & 300.3 & 1.2 \\
 $E \parallel k_z$ & 1540.4 & 25.2 & 153.1 & 168.6 & 3.7 & 240.7 & 229.9 & 4.7 \\
\hline
\hline
\end{tabular}
\end{table}
...
\subsection{\uppercase\expandafter{\romannumeral2-2} Theoretical phonon frequency calculation}
...
\subsection{\uppercase\expandafter{\romannumeral3}-2. Model Hamiltonian}
...
\subsection{\uppercase\expandafter{\romannumeral3}-3. Determination of the model parameters} \label{sec:sm:params}
...
\subsection{\uppercase\expandafter{\romannumeral3}-4. Methods for calculations of optical conductivity}
