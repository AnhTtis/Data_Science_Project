...
\newcommand{\delete}[1]{\textcolor{emo-rot}{\sout{#1}}}
\newcommand{\replace}[1]{\textcolor{lichtblau}{#1}}
\newcommand{\comm}[1]{\textcolor{magenta}{COMMENT: #1}}
...
\section{Introduction}
    ...
    This suggests to use numerical techniques well-known from hydrodynamics to solve that equation, see also Refs.~\cite{Grossi:2021ksl,Koenigstein:2021syz,Koenigstein:2021rxj,Steil:2021cbu,Stoll:2021ori,Ihssen:2022xjv,Ihssen:2022xkr}.
