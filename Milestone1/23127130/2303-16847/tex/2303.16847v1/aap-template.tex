...
%\usepackage{amsmath}
%\usepackage{amsmath,amssymb} %Thick police
\usepackage{autobreak}
\usepackage{mathtools}
\usepackage{cite} %retour à la ligne dans les equations
\numberwithin{equation}{section} %number the equations by sections
\newcommand\numberthis{\addtocounter{equation}{1}\tag{\theequation}}
%\usepackage{amssymb, amsmath, lmodern} %not Thick police

%\usepackage{fancyhdr} %running head
%\pagestyle{fancy}
%%\fancyhf{}
% \rhead{\footnotesize Optimal Stopping under Model Uncertainty in a General Setting}
% \lhead{ }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newenvironment{proofa}{{\sc Proof of Lemma \ref{lemma uniqueness}.}}{}
\newenvironment{proofaa}{{\sc Proof of Lemma \ref{a prio}.}}{}
...
\author[B]{\fnms{Astrid}~\snm{Hilbert}\ead[label=e2]{astrid.hilbert@lnu.se}}
\and
\author[C]{\fnms{Youssef}~\snm{Ouknine}\ead[label=e3]{ouknine@uca.ac.ma}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Addresses                                %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\address[A]{Department of Mathematics, Linnaeus University\printead[presep={,\ }]{e1}}

\address[B]{Department of Mathematics, Linnaeus University\printead[presep={,\ }]{e2}}

\address[C]{Department of Mathematics, Cadi Ayyad University\printead[presep={,\ }]{e3}}
\end{aug}
