...
We introduce a new representation in which the solution (\ref{spinor}) takes simpler form. The unitary matrix that defines such an representation is:
\be
\label{fw}
F= \frac{1}{\sqrt{2}}
\begin{pmatrix}
