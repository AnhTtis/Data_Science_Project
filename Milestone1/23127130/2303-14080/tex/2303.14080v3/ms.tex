...
\begin{figure}
    ...
    \caption{Guided Grad-CAM results for predicting CAD on test images. The most important features are centered around the left ventricle, matching the most important tabular features. \protect\footnotemark}
    \label{fig:gradcam}
\end{figure}
...
\footnotetext{These images are published with the permission of UK Biobank.}
