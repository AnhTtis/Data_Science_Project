    ...
    \node at (1.5,3.55) {$3\times 3$ convolutional layer};
    \node at (1.5,2.95) {64 dim};
    ...
    \node at (1.5,9.5) {64 dim input};

    \draw[red,ultra thick,->] (1.5,0) -- (1.5,-1.5);
    \draw[black,ultra thick,->] (1.5,2.5) -- (1.5,1);
    \draw[black,ultra thick,->] (1.5,5.5) -- (1.5,4);
    \draw[blue,ultra thick,->] (1.5,9) -- (1.5,7);

    \node at (2.4,-0.7) {ReLU};
    \node at (2.4,4.8) {ReLU};

    \draw[blue,ultra thick,rounded corners,->] (1.5,8.0) -- (5.25,8.0) -- (5.25,0.5) -- (2.5,0.5);
    \node[rotate=90] at (5.7,4.25) {Identity};
