...
\preprint{KYUSHU-HET-258, OU-HET-1177, YITP-23-37}
...
gauge-invariant way, and one can extend the construction to simple and simply-connected
...
transformation alone: From the cocycle condition for transition
functions without tildes, the right-hand side must be an element of~$\mathbb{Z}_N$. This
$\mathbb{Z}_N$ element should transform identically as the left-hand side does under
...
ensured by imposing the admissibility $\{U_\ell\}\in\mathfrak{A}_{\ve}[B_p]$ for
...
as requested. 
Moreover, $\tilde{v}_{n,\mu}(x)$ obeys the $1$-form transformation proeprety \eqref{eq:(3.11)} since $\tilde{S}^{m}_{n,\mu}$ is $1$-form gauge invariant. 
...
in~Ref.~\cite{Luscher:1981zq} works in the same manner by making its every step manifestly $1$-form
...
\end{equation}
In Ref.~\cite{Gaiotto:2017yup} (see also Refs.~\cite{Tanizaki:2017bam, Komargodski:2017dmc, Kikuchi:2017pcp, Tanizaki:2018xto, Karasik:2019bxn, Cordova:2019jnf}), this is
...
flow~\cite{Narayanan:2006rf, Luscher:2009eq, Luscher:2010iy, Luscher:2011bx, Bonati:2014tqa}.
...
the common center, and we may have a 't~Hooft anomaly between the projective 
...
The authors appreciate the conference ``Lattice and continuum field theories 2022'' (YITP-W-22-02) at Yukawa Institute for Theoretical Physics (YITP) in the last July. 
