...
\begin{proof} 
	...
	\end{aligned}
	\end{equation} 
	Note that $\theta_k^{-2} \left[ R \mathbf{v}_l \right]_k w_k \left[ R \mathbf{x}_l \right]_k + \theta_k^{-2} w_k^2 \left[ R \mathbf{x}_l \right]_k^2 = \theta_k^{-3} \left( \theta_k \left[ R \mathbf{v}_l \right]_k - w_k \left[ R \mathbf{x}_l \right]_k \right)^2$. 
