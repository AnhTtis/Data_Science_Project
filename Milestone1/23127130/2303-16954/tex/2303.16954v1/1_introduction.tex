...
\begin{figure}[tb]
	\centering
  	...
  	\begin{subfigure}[b]{0.33\textwidth}
		\includegraphics[width=\textwidth]{%
      		figures/deb_signal1_IAS_L4} 
    	\caption{Recovered first signal}
    	\label{fig:deb_signal1_IAS_L4}
  	\end{subfigure}%
	%
	\begin{subfigure}[b]{0.33\textwidth}
		\includegraphics[width=\textwidth]{%
	...
	\begin{subfigure}[b]{0.33\textwidth}
  	...
  	\begin{subfigure}[b]{0.33\textwidth}
		\includegraphics[width=\textwidth]{%
      		figures/deb_signal2_IAS_L4} 
    	\caption{Recovered second signal}
    	\label{fig:deb_signal2_IAS_L4}
  	\end{subfigure}%
	% 
	\begin{subfigure}[b]{0.33\textwidth}
		\includegraphics[width=\textwidth]{%
	...
	Second/third column: Reconstructions of the signals using the existing IAS/GSBL algorithm to separately recover them (blue triangles) and the proposed MMV-IAS/-GSBL algorithm to jointly recover them (green squares). 
...
For more recent works in this area, see \cite{adcock2019joint,gelb2019reducing,scarnati2020accurate,xiao2022sequential,xiao2023sequential} and their references.
...
\cref{fig:deb_signal_intro} compares the existing IAS and GSBL algorithms with the proposed MMV-IAS and MMV-GSBL algorithms to recover the first two out of four piecewise-constant signals with a common edge profile from noisy blurred data. 
