...
We briefly illustrate how our method for promoting joint sparsity can be integrated with the generalized sparse Bayesian learning (GSBL) framework \cite{tipping2001sparse,wipf2004sparse,glaubitz2022generalized}.
As highlighted in the introduction, both IAS and GSBL serve as established cases of sparsity-promoting algorithms that can benefit from our joint-sparsity-promoting priors in the presence of MMV data. 
