...
\begin{figure*}
  ...
  \captionsetup[subfloat]{captionskip=1.5pt}
  ...
  \subfloat{\begin{picture}(0.2\linewidth,30)
    \includegraphics[width=0.2\linewidth]{images/main/kitti-sf/18-input.jpg}
  \end{picture}}
  \subfloat{\begin{picture}(0.2\linewidth,30)
    \put(0,0){\includegraphics[width=0.2\linewidth]{images/main/kitti-sf/18-drisf.png}}
    \put(1,23){\scriptsize \textcolor{white}{SF-all: 52.75}}
  \end{picture}}
  \subfloat{\begin{picture}(0.2\linewidth,30)
    \put(0,0){\includegraphics[width=0.2\linewidth]{images/main/kitti-sf/18-raft3d.png}}
    \put(1,23){\scriptsize \textcolor{white}{SF-all: 52.14}}
  \end{picture}}
  \subfloat{\begin{picture}(0.2\linewidth,30)
    \put(0,0){\includegraphics[width=0.2\linewidth]{images/main/kitti-sf/18-rigidmask.png}}
    \put(1,23){\scriptsize \textcolor{white}{SF-all: 51.70}}
  \end{picture}}
  \subfloat{\begin{picture}(0.2\linewidth,30)
    \put(0,0){\includegraphics[width=0.2\linewidth]{images/main/kitti-sf/18-camliraft.png}}
    \put(1,23){\scriptsize \textcolor{white}{SF-all: 51.71}}
  \end{picture}}\\
  ...
  \caption{Qualitative results on the KITTI Scene Flow test set. Blue indicates a lower error, red indicates a higher error. Our approach improves accuracy near object boundaries. The bottom row shows a failure case: large occlusions confuse all methods.}
