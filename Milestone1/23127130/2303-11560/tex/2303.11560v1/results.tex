...
We evaluate our method on our test set of sixty synthetic ground truth skeletons (made up of six species). Our results are summarized in Table \ref{table:results} and Figure \ref{fig:result-graphs}. We compute the AUC for F1, precision and recall using the radius threshold \({t}\) ranging from 0 to 1.
