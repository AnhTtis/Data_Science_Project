...
\section{Group B Pulsar Tables, Models and Notes}
...
%Here, our profile measurements follow directly from the 1.4-GHz or 327-MHz profiles in Figs.~\ref{figA1}-\ref{figA27} as well as the LOFAR High Band 100-200-MHz or Pushcino Observatory 102-MHz profiles. Table~\ref{tabA1} gives the sources for these profiles in both principaL-bands as well as each pulsar's observational parameters.   Table~\ref{tabA2} gives the physical parameters that can be computed from the period $P$ and spindown $\dot P$---that is, the spindown energy $\dot E$, spindown age $\tau$, surface magnetic field $B_{surf}$, the acceleration parameter $B_{12}/P^2$ and Beskin \etal's parameter $1/Q$.  

%Following the analysis procedures of Rankin 1993a,b; hereafter, ET VI), we have measured outside conal half-power (3 db) widths and half-power core widths wherever possible. However, we do not plot these directly.  Rather we use the widths to model the core and conal beam geometry, but here emphasizing the 100-MHz frequency range.  The model results are given in Table~\ref{tabA3} for the 1-GHZ band and for the respective 100-200 and $<$100-MHz Band regimes.  
...
%Propagating the observational errors in the width values is very difficult.  They come from different sources at different frequencies and sometimes entail unknown instrumental errors and issues in addition to errors we have made in interpreting the profiles and measuring them.  Therefore, we have chosen rather to provide error bars reflecting the the beam-radii errors for a 10\% uncertainty in the width values and a 10\% uncertainty in the polarization position-angle (PPA) sweep rate.  The error bars shown reflect the {\it rms} of the two sources with the former indicated in the lower bar and the latter in the upper one.  For many pulsars one or the other error is so dominant that the bars corresponding to the two individual error sources are hard to see; however, B1633+24 provides a case where they can be seen quite clearly.  The errors shown for the core-beam angular diameters is uniformly 0.2\degr\ in the scaled width.  
...
%For pulsars where no scattering study is available, we have the option of using the mean scattering level determined for a large ensemble of pulsars as a function of dispersion measure (DM), where $t_scatt$ is some $480 DM^2/f(MHz)^4$ secs.  While this relationship is well determined, a number of pulsars have scattering levels that are up to about 10 times greater or less than the average level.  Therefore, our model plots show the average scattering level (where applicable) as yellow single hatching and with an orange line indicating 10 times this value as a rough upper limit.

%Haley notes:
%Why do we have J0051 in the table?
%Should we denote "this pulsar has never been previously classified" for all pulsars in which this is the case? Pretty sure it's the case for most of them but we don't denote that.
%No description for J0815 (though it is in my LOFAR set, the profile is just scattered and bad) but it's a GORGEOUS quad!
%No profiles for J1740 present in the appendix
%J2007+0910 is not present in this appendix (there's no description)
...
\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=0.]{plots/pJ0245+1433.57844p4a.ps}
...
\end{center}
\end{figure}
\noindent\textit{\textbf{J0245+1433 (nee J0244+14; \cite{dsm+13})}}: The 327-MHz Arecibo profile in Fig.~\ref{figA102} seems to be the only one available, and it shows a double structure with a chaotic PPA behavior.  Striking is the substantial, symmetrical antisymmetric $V$ that is often characteristic of core emission and rare in conal profiles.  However, this pulsar falls well into the conal emission dominated region on the basis of its $\dot E$ of only about $10^{31}$ ergs/s.  So more information is needed to work out its beam structure.  However, the pulsar was weakly detected at 111 MHz (Valerij Malofeev, private communication) so surely deserves more study.
\vskip 0.1in
...
\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=0.]{plots/J0348+0432_Lynch_2013.ps}
...
\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=-90.]{plots/J0435+2749h149fit}
\caption{J0435+2749: Fitted Gaussian-component model for BKK+'s 149-MHz observation.}
\label{figA104}
\end{center}
\end{figure}
\vskip 0.1in
\noindent\textit{\textbf{J0435+2749}}: Following on (\citet{brinkman_freire_rankin_stovall})'s {\bf T} classification, we now see that the LOFAR profile shows a narrow third component in this pulsar, while the central one seems to be broader.  Close inspection of several 327-MHz profiles show dual central features that somewhat broaden the trailing component.  These can be seen in the weak $L$ curve.  Therefore, having explored the quantitative geometry, we now believe a conal quadruple c{\textbf{Q}} beam model is most appropriate for this pulsar.  The PPA rate is difficult to discern accurately, but a shallow negative traverse is most likely.  The LOFAR inner cone width cannot be measured accurately, but a value around 25\degr\ is compatible with those at the higher frequencies---though the fit in Fig.~\ref{figA104} gives a substantially narrower value.  
\vskip 0.1in

\noindent\textit{\textbf{J0457+2333}}: The two profiles are only of moderate quality, but they suggest a ``boxy'' form at 1.4 GHz that may have a core/double cone at 327 MHz---similar to the evolution of many {\bf M} structures.  We  can only guess the PPA rate, but a central traverse is suggested at the lower frequency.  To support this model at core width of about 7\degr\ is needed, and this cannot be verified in the profile structure; nor can we clearly discern the inner cone width.  More and better profiles are needed.
%Joanna, try fluctspec
\vskip 0.1in

\noindent\textit{\textbf{J0533+0402}}: This pulsar seems to be a conal single {\bf S$_d$} pulsar, but its geometry remains inaccurate.  The 1.4-GHz PPA traverse suggests a very central sightline traverse, which is incompatible with this classification; the 327-MHz one does not but gives no useful slope.  Fortunately, the \citet{JK18} profile shows a traverse that may be about  +11\degr/\degr, making $\alpha$ upwards of 90\degr\ for an outer cone.  This is needed because the Pushchino profile shows clear bifurcation and a larger width suggesting the outer conal geometry.
%Joanna, McEwen et al?
\vskip 0.1in
...
\noindent\textit{\textbf{J0621+0336}} seems to have a barely resolved inner conal double {\bf D} profile.  The early edge linear polarization seems to be a different OPM than that prominent on the trailing part of the profile---thus the moderate +ve PPA slope.  A 350-MHz profile is available in the \citet{mcewen} compendium which seems to show a compatible barely double form, but its scale cannot be measured more accurately than the nominal half width they tabulate.  
\vskip 0.1in

\noindent\textit{\textbf{J0621+1002}}: the pulsar has a very broad core-cone triple {\bf T} profile.  The PPA slope is negative, very shallow and difficult to determine accurately, but the earliest portion under the core is steepest and may have a slope near --0.7\degr/\degr.  A 410-MHz profile \citep{stairs99} shows a nearly identical width pointing to an inner cone geometry.
\vskip 0.1in
...
\begin{figure}
\begin{center}
\includegraphics[height=85mm,angle=-90.]{plots/J0623+0340l_prof_30p_avrgs.ps}
...
\noindent\textit{\textbf{J0630--0046}} seems dominated by a core component, and the leading component together with the PPA traverse suggest that they are conal.  It is possible that the core overlies the trailing conal component.  If so an inner cone geometry is indicated, and we have so modeled it.  The \citet{mcewen} profile does suggest a larger width, but its poor quality provides no clarity.   
\vskip 0.1in

\noindent\textit{\textbf{J0646+0905}}: we model the pulsar roughly with an inner conal 
single {\bf S$_d$} configuration, but it could also be outer conal with a larger $\alpha$ 
value.  No clear drift feature is seen in fluctuation spectra.  The $L$ and PPA traverse 
are asymmetric as other B0809+74-like profile, possibly suggesting some ``missing'' 
early emission.
\vskip 0.1in
...
\noindent\textit{\textbf{J0711+0931}}: PSR J0711+0931 has a usual outer conal {\bf S$_d$} evolution. This seems to be a typical conal single ({\bf S$_d$}) configuration.  Scattering may broaden the LOFAR profile slightly.  
...
\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=-90.]{plots/J0943+2253h149fit.ps}
...
\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=-90.]{plots/J1238+2152h149fit.ps}
\caption{J1238+2152: Fitted Gaussian-component model for PHS+'s 149-MHz observation.}
\label{figA108}
\end{center}
\end{figure}
\noindent\textit{\textbf{J1238+2152}}: PSR J1238+2152 has three components that are clearly seen at LOFAR frequencies (see Fig.~\ref{figA108}), visible at 327 MHz, and not so at 1.4 GHz.  Single pulses show what appear to be weak drift bands with a $P_3$ of some 16 $P$.  We model it using a conal triple c{\bf T} beam geometry.   We seen no evidence of scattering at the lowest frequencies.  The pulsar is detected at both 111 MHz \citep{prao} and 20/25 MHz \citep{ZVKU13} but no measurements are possible.
...
\begin{figure}
\begin{center}
\includegraphics[height=85mm,angle=-90.]{plots/PQJ1313+0931_modfold.ps}
...
\begin{figure}
\begin{center}
\includegraphics[height=85mm,angle=-90.]{plots/PQJ1404+1159.57566p_4.7P_modfold.ps}
...
\end{center}
\end{figure}
\noindent\textit{\textbf{J1404+1159}}: The profile is single at 1.4-GHz but develops weak ``outriders'' at 327 MHz.  No doubt that the pulsar has a conal triple configuration, given the strong, regular drifting subpulses shown in Fog.~\ref{figA110}.  The pulsar is strongly detected at 111 MHz \citep{prao} and the width seems compatible with those at higher frequency.
\vskip 0.1in

\noindent\textit{\textbf{J1503+2111}}: seems to show a fairly usual outer conal single {\bf S$_d$} evolution down to 129 MHz is seen in this pulsar.  Scattering seems to be negligible.
%Joanna, Han et al?
\vskip 0.1in
...
\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=-90.]{plots/J1612+2008h149fit.ps}
...
\noindent\textit{\textbf{J1645+1012}}: At LOFAR frequencies, two merged components are present in this pulsar, the leading slightly stronger than the trailing; as frequency increases, the leading component becomes ever less prominent.  We model this a an inner cone double {\bf D} profile, despite the poorly determined PPA rate.  The pulsar is detected at 111 MHz \citep{prao} but no measurements are possible.  Scattering gradually broadens the profiles in the LWA observations down \citep{KTSD23} to 50 MHz.
%Add Bilous profile
\vskip 0.1in

\begin{figure}
\begin{center}
\includegraphics[height=85mm,angle=-90.]{plots/PQJ1649+2533l_prof_1-200.ps}
\caption{Pulsar J1649+2533: 200-pulse sequence at 1.4 GHz showing its 2.5-period modulation and burst/null structure.}
\label{figA112}
\end{center}
\end{figure}
\noindent\textit{\textbf{J1649+2533}}: PSR J1649+2533 has a single component with some structure in all three bands. Fluctuation spectra show a strong 2.6-$P$ phase modulation as well as a strong amplitude modulation at about 30 $P$---the first associated with the prominent drifting subpulses and the latter the structure of bursts and nulls as seen in Fig.~\ref{figA112}.  Seems compatible with an inner conal single {\bf S$_d$} evolution, and we model it as such.  The pulsar is detected at 111 MHz \citep{prao} but no measurements are possible.  Effects of scattering seem to be minimal.
%Joanna, McEwen et al?
%Joanna, Han et al?
\vskip 0.1in
...
\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=-90.]{plots/J1720+2150fit.ps}
\caption{Gaussian-component fitting of J1720+2150 at 149 MHz. The width of the second component is constrained to have the same width as that of component 4---so that the inner conal components have similar widths 
as is usually observed.}
\label{figA113}
\end{center}
\end{figure}
\vskip 0.1in

\noindent\textit{\textbf{J1739+0612}}: the four ``components" of linear polar polarization at 1.4 GHz are suggestive of a conal quadruple {c\bf Q} configuration, and the quantitative geometry seems to bear this out.  Moreover, we see an 11-$P$ fluctuation feature in the single pulses again indicating that the emission we see is conal.  The \citet{ATNF} 692-MHz profile, though noisy, may have a similar structure, though only guesses at the widths are possible.  In any case, we model it.
\vskip 0.1in
...
\noindent\textit{\textbf{J1752+2359}}: This pulsar shows a single component with weak outriders and a flat PPA traverse. We thus model it as a core single {\bf S$_t$} profile.  However, the assymmetric core appears incomplete at both 1.4 GHz and 327 MHz, so we use the 149-MHz width that then squares with the usual inner cone geometry.  Other 327-MHz profiles show the trailing outrider better than this one with a poor baseline.  The pulsar is detected at 111 MHz \citep{prao} but no measurements are possible.  Scattering seems to have a minimal effect.
%Joanna, McEwen et al?
\vskip 0.1in

\noindent\textit{\textbf{J1758+3030}}: A single component is seen at all frequencies.  We then model it as an inner conal single {\bf S$_d$} profile, although \citet{Weltevrede2007} find it has a flat fluctuation spectrum.  The pulsar is detected at 111 MHz \citep{prao} but no measurements are possible.  The LWA profiles \citep{KTSD23} trace the profile width down to 35 MHz where scattering is clearly discernible.
%Add Bilous profile
%Joanna, McEwen et al?
%Joanna, Han et al?
\vskip 0.1in
...
\noindent\textit{\textbf{J1814+1130}}: The profile fo this pulsar seems to have an inner conal single {\bf S$_d$} profile.  The LOFAR non-detection seems likely to have been the result of a usual level of scattering at 149 MHz.

\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=-90.]{plots/J1819+1305h149fit.ps}
...
\noindent\textit{\textbf{J1821+1715}}: This pulsar's triplicity is most evident at 327 MHz, but it can be discerned both at 1.4 GHz and 149 MHz.  The central component always conflated, but its width at 327 MHz must be about 5\degr.  The value is too wide for a core but comfortable for an inner cone.  We therefore model the pulsar as a conal triple c{\bf T} structure.  Scattering seems to have little effect at 149 MHz.
...
\begin{figure}
\begin{center}
\includegraphics[height=85mm,angle=-90.]{plots/PQJ1842+0257.57113_prof_1-256.ps}
\includegraphics[height=85mm,angle=-90.]{plots/PQJ1842+0257.57113_modfold_120-170.ps}
...
\end{center}
\end{figure}
\noindent\textit{\textbf{J1842+0257}} shows a complex emission comprised of what appears to be drift modes and long nulls as shown in Fig.~\ref{figA114}---clearly attesting to its conal character.  Its 1.4-GHz profile is symmetrical with a well defined negative PPA sweep.  The \citet{mcewen} 350-MHz value may indicate an increase with wavelength, so we model the profile as having an outer conal single {\bf S$_d$} geometry. 
\vskip 0.1in

\begin{figure}
\begin{center}
\includegraphics[height=85mm,angle=-90.]{plots/PQhrfJ1843+2024.ps}
...
\noindent\textit{\textbf{J1848+0826}}: The broad 1.4-GHz has two main components and perhaps a hint of a weaker core component; whereas the 327-MHz profile shows substantial scattering at the roughly usual level.  We model the profile as an outer conal double.  A hint of the scattered profile at 149 MHz may be visible. 
\vskip 0.1in
...
\noindent\textit{\textbf{J1850+0026}}: The asymmetric double profile shows a clear 9-$P$ drift modulation in the trailing component.  We model it as having as an outer conal double {\bf D} configuration approximating the PPA sweep rate as --4\degr/\degr.  The 350-MHz measurement \citep{mcewen} is little more than a guess.
%Joanna, Han et al?
\vskip 0.1in

\noindent\textit{\textbf{J1851--0053}}: A very strange profile with a shallow rise and steep decay as well as a flat PPA traverse.  \citet{mcewen} 350-MHz profile is too poor to be of help.  The pulsar is detected at 20/25 MHz \citep{KZUS22} but scattering prevents useful measurements.  No sensible model is possible.  Scattered emission is weakly detected at 20/25 MHz \citep{ZVKU13}.
\vskip 0.1in
...
\noindent\textit{\textbf{J1900+30}}: This pulsar has a single profile at L and P-band as well as at 149 MHz. The disordered PPA traverse and significant Stokes $V$ suggests that this is a core component.  No spindown value has been measured for this pulsar, so we know nothing of the magnetic field strength, age or $\dot E$.  The pulsar was found at 1.4 GHz at a declination of 30\degr/ 56', and the AO feed has a beam size of about 3.5', so the error is about $\pm$2'.
%Joanna, McEwen et al?
\vskip 0.1in

\noindent\textit{\textbf{J1901+1306}}: A triple profile with a weak leading component is present in this pulsar.  The structure is clearest in the 327-MHz profile.   Strangely the components are broader at 1.4 GHz, and this does not appear to be a timing issue, so we have taken the P-band core width.
%Haley: rechecked the L-band timing and reduced the # of samples, but no good solution for this one yet, Joanna
\vskip 0.1in

\noindent\textit{\textbf{J1903+2225}}: PSR J1903+2225 has an asymmetric single profile at 1.4 GHz that evolves into a double form at 327 MHz, with the leading feature much weaker than the trailing one.  There is a hint of this leading feature at 1.4 GHz as well as in \citet{han2009} at 774 MHz, and this total with is roughly that of the 327-MHz width.  On this basis we model the profiles as an {\bf S$_d$} or {\bf D}, but more sensitive profiles are needed to confirm this interpretation.  Scattering may well account for the LOFAR non-detection at 149 MHz.  
%Haley, new text, Joanna
%Joanna, McEwen et al?
%Joanna, Han et al?
\vskip 0.1in

\noindent\textit{\textbf{J1906+1854}}: The 1.4-GHz profile of this pulsar has a very different shape that the others, but its width is only about 10\% greater.  We model its beams as having a conal single {\bf S$_d$} configuration, which is confirmed by the strong regular drifting subpulses.  Scattering may be responsible for the increased widths of the LOFAR profiles.
%Haley: checked the timing, modified the widths, add several LOFAR widths and rewrote the text, Joanna.
%Joanna, Han et al?
\vskip 0.1in

\noindent\textit{\textbf{J1908+0734}}: We have no Arecibo observations of this pulsar but profiles at 1.2, 1.5, 2.4 GHz \citep{Bhat04} and 430 MHz \citep{camilo_nice} have been published.  And at decameter wavelengths it has been detected both at 20/25 MHz \citet{ZVKU13}.  The 1.5-GHz profile seems to have 4 features, but none of the observations are polarimetric, so no interpretation is possible.
\vskip 0.1in

\noindent\textit{\textbf{J1908+2351}}: One component is seen in all three bands in PSR J1908+2351, and the polarization is so slight that no PPA slope can be estimated.  We model its as an inner conal {\bf S$_d$} beam and take $\beta$ as 7\degr\ for a peripheral sightline traverse.  Scattering may be responsible for the broadening at low frequency.  
%Haley: changed the model to S_d and rewrote the text, Joanna.
%Joanna, McEwen et al?
\vskip 0.1in

\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=-90.]{plots/J1909+1859h149fit.ps}
...
\noindent\textit{\textbf{J1911+1758}}: Despite the poor observation, this pulsar seems to have two unresolved features at lower frequencies (see also \citet{han2009}).  Using the patch of significant linear at L-band, the outer conal single {\bf S$_d$} solution shows a small increase of $\rho$ with wavelength.  A high quality 430-MHz profile \citep{camilo_nice} shows a clear central component, so it is possible that a conal triple c{\bf T} model would be more correct, but our observations fail to show this structure clearly enough.  Scattering seems unimportant at 149 MHz.  
%Haley: rewrote the text, Joanna
%Joanna, Han et al?
\vskip 0.1in
...
\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=-90.]{plots/J1913+3732h149fit.ps}
...
\noindent\textit{\textbf{J1915+0227}} seems to reflect a conal beam as 7.9-$P$ amplitude modulation is seen in the single pulses.  We model the geometry using an inner cone because the \citet{mcewen} poorly resolved 350-MHz profile indicated little growth with wavelength.  
\vskip 0.1in

\noindent\textit{\textbf{J1915+0738}}: The two profiles have about the same widths but are asymmetric with a fast rise and slower falloff.  Its profiles almost looks scattered, but the pulsar's small dispersion and \citet{camilo_nice} 430-MHz observation that shows a similar form and width make this unlikely.  One of the profiles also has a very flat PPA traverse.  Overall, the profiles appear to represent the leading portions of a conal double pair, but possible features trailing by 90\degr\ or more are too weak to interpret reliably.  It emits in clumps of a few to perhaps 20 pulses, at times alternating been emission in the leading and trailing parts of the profile.  Occasional drift bands may also be seen.   However, it is the flat PPA traverse that prevents modeling.  
%Joanna, try fluctspec
\vskip 0.1in

\noindent\textit{\textbf{J1919+0134}}: Th pulsar seems to have a standard outer conal double configuration.  The PPA rate is estimated from the 1.4-GHz profile as the polarimetry was faulty at the lower frequency.  
%Joanna, try fluctspec
\vskip 0.1in

\begin{figure}
\begin{center}
\includegraphics[width=65mm]{plots/J1937+2950_VanStraten.ps}
\caption{J1937+2950: Profiles at three frequencies.}
\label{figA117a}
\end{center}
\end{figure}
...
\noindent\textit{\textbf{J1957+2831}}: The energtic pulsar might well have a core component given the $V$ signature, but the apparent shallow PPA traverse suggests that the sightline might miss it.  We have tried to model the profile with a number of double-cone/core configurations, and none seem satisfactory.   The \citet{han2009} 774-MHz profile is similar to ours and seems to have 4 or 5 features, whereas the 350-MHz \citet{mcewen} profile may be single.  Another tack is to interpret the five features as a core/double-cone beam configuration.  The core width could be close to the the 4.4\degr\ polar cap diameter as the 350-MHz latter profile suggests.  This produces the usual conal widths if $\beta$ is some 5/degr/ which in turn requires an 11\degr/degr/ PPA rate; however, this seems incompatible with the profiles that \textit{might} have a rate as low as 40\degr/degr.  This is an interesting pulsar that would reward more investigation.  
\vskip 0.1in
...
\noindent\textit{\textbf{J2008+2513}}: This pulsar seems to be another {c\bf T} or {c\bf Q}.  The outer conal dimensions are easily measured at all three frequencies, and the inner ones as well at the upper two bands.  The problem is that the PPA traverse gives little useful information.  For the double cone geometry model to be satisfactory an $R$ values of about 6\degr/\degr\ is required, and fortunately the \citet{han2009}'s 774-MHz profile confirms this.  Scattering seems minimal at 149 MHz.  
%Joanna, McEwen et al?
%Joanna, Han et al?
\vskip 0.1in

\noindent\textit{\textbf{J2010+2845}}: Clearly a core-cone triple {\bf T} beam configuration.  Fluctuation spectra show weak evidence of conal periodicity in the conal outer pair of components.  The PPA traverse is steep, and the core width can be estimated at about 4\degr---the linear peak has about this width.  This implies an inner cone geometry, and there is no solution for an outer conal one with the observed PPA rate. 
\vskip 0.1in

\noindent\textit{\textbf{J2015+2524}}: PSR J2015+2524 appears to have an outer conal double {\bf D} geometry.  The \citet{camilo_nice} 430-MHz profile confirms the width values.  Scattering seems unusually low at 149 MHz for this pulsar, so does not explain the LOFAR nondetection. 
%Haley, new text Joanna
%Joanna, McEwen et al?
\vskip 0.1in
...
\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=-90.]{plots/J2017+2043h149fit.ps}
...
\noindent\textit{\textbf{J2033+0042}}: This 5-s pulsar seems to be mostly or entirely conal.  The two widths are impossible to measure accurately but seemingly similar.  The PPA rate is a guestimate given the early turndown.  We model it using an inner conal single beam system.  
...
\noindent\textit{\textbf{J2045+0912}}: The profile of this pulsar has a bright central and trailing component and a weaker leading one at P- and L-band, and the LOFAR profile can be read this way as well.  No unique $R$ value could be obtained.  Scattering seems minimal at 149 MHz. 
...
\noindent\textit{\textbf{J2048+2255}}: PSR J2048+2255 seems to have a core-cone triple {\bf T} profile with the three components more or less discernible at each of the three frequencies.  Maybe the PPA rate is about +9\degr/\degr.  No scattering effect evident.
...
\begin{figure}
\begin{center}
\includegraphics[width=60mm,angle=-90.]{plots/J2111+2106h149fit.ps}
...
\begin{figure}
\begin{center}
\includegraphics[width=65mm,angle=-90.]{plots/J2139+2242h168fit.ps}
\includegraphics[width=65mm,angle=-90.]{plots/J2139+2242h129fit.ps}
...
\noindent\textit{\textbf{J2248--0101}}: More work is needed to provide a suitable model for this pulsar
%Joanna, McEwen et al?
\vskip 0.1in
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm,height=53mm]{plots/J0006+1834_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm,height=53mm]{plots/J0030+0451_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm,height=53mm]{plots/J0051+0423_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0006+1834P.ps}}}& 
&%{\mbox{\includegraphics[width=52mm]{plots/J0030+0451P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0051+0423P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J0006+1834L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0030+0451_1.3GHz.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0051+0423L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0122+1416_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0137+1654_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0139+3336_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0122+1416P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J0137+1654P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0139+3336P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J0122+1416L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0137+1654L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0139+3336L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0152+0948_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0329+1654_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0337+1715_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0152+0948P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J0329+1654P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/pJ0337+1715u_shifted.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J0152+0948L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0329+1654L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/PQJ0337+1715.56760la.ps}}}\\
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0348+0432_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0417+35_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0435+2749_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0348+0432_350MHz.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J0417+35P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0435+2749P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/pcJ0348+0432.57131la.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0417+35L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0435+2749L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J0348+0432, J0417+35 and J0435+2749 as in Fig.~\ref{figA1}.}
\label{figA4}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0457+2333_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0533+0402_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0538+2817_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0457+2333P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J0533+0402P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0538+2817P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J0457+2333L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0533+0402L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0538+2817L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0540+3207_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0546+2441_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0609+2130_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0540+3207P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J0546+2441P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/pJ0609+2130.55104pa+.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J0540+3207L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0546+2441L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/PQJ0609+2130.57130la}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0611+30_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0613+3731_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0621+0336_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0611+30P.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/pJ0613+3731.57123pa}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0621+0336_350MHz.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0611+30P.ps}}}& 
&%{\mbox{\includegraphics[width=51mm]{plots/PQJ0621+0336.56932la.ps}}} \\
{\mbox{\includegraphics[width=52mm]{plots/PQJ0621+0336.57004la.ps}}}\\
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J0611+30, J0613+3731 and J0621+0336 as in Fig.~\ref{figA1}.}
\label{figA6a}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0621+1002_Bmodel.ps}}}&
%{\mbox{\includegraphics[width=52mm]{plots/J0621+1002.57005la.ps}}}\\
&%{\mbox{\includegraphics[width=52mm]{plots/J0623+0340_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0625+1015_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0621+1002_410MHz_STC99.ps}}}&
&%{\mbox{\includegraphics[width=52mm]{plots/J0623+0340P}}}& \ \ \  
{\mbox{\includegraphics[width=52mm]{plots/J0625+1015P.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/PQJ0621+1002.56572la.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/PQJ0623+0340.57005la.ps}}}&
%{\mbox{\includegraphics[width=51mm]{plots/PQJ0625+1015.54540la.ps}}}
{\mbox{\includegraphics[width=52mm]{plots/J0625+1015L.ps}}}\\
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0627+0649_Bmodel.ps}}}&
&%{\mbox{\includegraphics[width=52mm]{plots/J0628+0909_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0630-0046_Bmodel.ps}}}\\ 
%{\mbox{\includegraphics[width=52mm]{}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J0627+0649P.ps}}}&
&%{\mbox{\includegraphics[width=52mm]{plots/J0628+0909P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0630-0046_350MHz}}}\\ 
{\mbox{\includegraphics[width=51mm]{plots/J0627+0649L.ps}}}&
%{\mbox{\includegraphics[width=51mm]{plots/PQJ0628+0909.57006la.ps}}} \\
%{\mbox{\includegraphics[width=51mm]{plots/PQJ0628+0909.57113la.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/PQJ0628+0909.57131la.ps}}}& \ \ \ 
%{\mbox{\includegraphics[width=51mm]{plots/PQJ0630-0046.56932l3a.ps}}} \\
%{\mbox{\includegraphics[width=51mm]{plots/PQJ0630-0046.57006la.ps}}}&
{\mbox{\includegraphics[width=51mm]{plots/PQJ0630-0046.56932la.ps}}} \\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J0627+0649, J0628+0909 and J0630--0046 J0658+0022 as in Fig.~\ref{figA1}.}
\label{figA8}
\end{center}
\end{figure*}
...
&
& \\
%{\mbox{\includegraphics[width=52mm]{plots/J0658+0022_Bmodel.ps}}}\\
%{\mbox{\includegraphics[width=52mm]{plots/J0658+0022P.ps}}}\\ 
%{\mbox{\includegraphics[width=51mm]{plots/PQJ0646+0905.56932la.ps}}} \\
{\mbox{\includegraphics[width=51mm]{plots/PQJ0646+0905.57004la.ps}}} &
{\mbox{\includegraphics[width=51mm]{plots/PQJ0647+0913.57005la.ps}}}& \ \ \ 
%{\mbox{\includegraphics[width=51mm]{plots/PQJ0647+0913.57113la.ps}}} \\
%{\mbox{\includegraphics[width=51mm]{plots/PQJ0658+0022.56932la.ps}}}&
%{\mbox{\includegraphics[width=51mm]{plots/PQJ0658+0022.57005la.ps}}}&
{\mbox{\includegraphics[width=51mm]{plots/PQJ0658+0022.57257la.ps}}} \\
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0711+0931_Bmodel.ps}}}&
&%{\mbox{\includegraphics[width=52mm]{plots/J0806+08_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0815+0939_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0711+0931P.ps}}}& 
&%{\mbox{\includegraphics[width=52mm]{plots/J0806+08P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0815+0939P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J0711+0931L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/PQJ0806+08.57200la.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0815+0939L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0843+0719_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0848+1640_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0928+0614_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/pJ0843+0719.56964pa.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J0848+1640P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0928+0614P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J0843+0719+21cms_Burgay+06.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0848+1640L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J0928+0614L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J0943+2253_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0947+2740_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1022+1001_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J0943+2253P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J0947+2740P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1022+1001P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J0943+2253L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J0947+2740L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1022+1001L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
&%{\mbox{\includegraphics[width=52mm]{plots/J1046+0304_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1147+0829_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1238+2152_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1046+0304P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1147+0829P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1238+2152P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1046+0304L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1147+0829L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1238+2152L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1246+2253_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1313+0931_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1404+1159_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1246+2253P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1313+0931P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/pJ1404+1159.57566pa.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1246+2253L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1313+0931L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/pJ1404+1159.57564l2a}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1503+2111_Bmodel.ps}}}& 
&%{\mbox{\includegraphics[width=52mm]{plots/J1538+2345_Bmodel.ps}}}& \ \ \
{\mbox{\includegraphics[width=52mm]{plots/J1549+2113_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1503+2111P.ps}}}& 
&%{\mbox{\includegraphics[width=52mm]{plots/J1538+2345P.ps}}}& \ \ \
{\mbox{\includegraphics[width=52mm]{plots/J1549+2113P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1503+2111L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/PQJ1538+2345.57312l3a.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1549+2113L.ps}}}\\
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1612+2008_Bmodel.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1627+1419_Bmodel.ps}}}& \ \ \
{\mbox{\includegraphics[width=52mm]{plots/J1645+1012_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1612+2008P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1627+1419P.ps}}}& \ \ \
{\mbox{\includegraphics[width=52mm]{plots/J1645+1012P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1612+2008L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1627+1419L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1645+1012L.ps}}}\\
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1649+2533_Bmodel.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1652+2651_Bmodel.ps}}}& \ \ \
\\%{\mbox{\includegraphics[width=52mm]{plots/J1713+0747_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1649+2533P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1652+2651P.ps}}}& \ \ \
\\%{\mbox{\includegraphics[width=52mm]{plots/J1713+0747P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1649+2533L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1652+2651L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/PQJ1713+0747.56768la.ps}}}\\
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1720+2150_Bmodel.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1739+0612_Bmodel.ps}}}& \ \ \
{\mbox{\includegraphics[width=52mm]{plots/J1741+2758_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1720+2150P.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1739+0612.ps_692MHz_ATNF.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1741+2758P.ps}}}\\ 
{\mbox{\includegraphics[width=51mm]{plots/J1720+2150L.ps}}}&
%{\mbox{\includegraphics[width=51mm]{plots/PQJ1739+0612.56768la.ps}}} \\
{\mbox{\includegraphics[width=52mm]{plots/PQJ1739+0612.56605la.ps}}}& \ \ \
{\mbox{\includegraphics[width=52mm]{plots/J1741+2758L.ps}}}\\
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J1720+2150, J1739+0612 and J1741+2758 as in Fig.~\ref{figA1}.}
\label{figA15}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1746+2245_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1746+2540_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1752+2359_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1746+2245P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1746+2540P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1752+2359P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1746+2245L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1746+2540L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1752+2359L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1758+3030_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1807+0756_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1811+0702_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1758+3030P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1807+0756P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1811+0702U.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1758+3030L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1807+0756L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1811+0702L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1813+1822_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1814+1130_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1819+1305_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1813+1822P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1814+1130P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1819+1305P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1813+1822L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1814+1130L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1819+1305L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J1813+1822, J1814+1130 and J1819+1305 as in Fig.~\ref{figA1}.}
\label{figA18}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1821+1715_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1822+0705_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1828+1359_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1821+1715P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1822+0705U.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1828+1359P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1821+1715L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1822+0705L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1828+1359L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1829+0000_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1837+1221_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1837-0045_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1829+0000_350MHz}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1837+1221P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1837-0045P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/PQJ1829+0000.56768la.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1837+1221L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1837-0045L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J1829+0000, J1837+1221 and J1837--0045 as in Fig.~\ref{figA1}.}
\label{figA20}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1838+1650_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1842+0257_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1843+2024_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1838+1650P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1842+0257_350MHz.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1843+2024U_Champion+2005.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1838+1650L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/PQJ1842+0257.57113la.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1843+2024L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J1838+1650, J1842+0257 and J1843+2024 (full period, total power profile from \citet{Champion2005}) as in Fig.~\ref{figA1}.}
\label{figA21}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1848+0826_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1849+2423_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1850+0026_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1848+0826P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1849+2423P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1850+0026_350MHz.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1848+0826L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1849+2423L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/PQJ1850+0026.56415la.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J1848+0826, J1849+2423 and J1850+0026 J1851-0053 and J1859+1526 as in Fig.~\ref{figA1}.}
\label{figA22}
\end{center}
\end{figure*}
...
\begin{tabular}{@{}ll@{}ll@{}}
& %{\mbox{\includegraphics[width=52mm]{}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1859+1526_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1900+30_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1851-0053_350MHz.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1859+1526P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1900+30P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/PQJ1851-0053.54540la.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1859+1526L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1900+30L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J1851-0053, J1859+1526 and J1900+30 as in Fig.~\ref{figA1}.}
\label{figA23}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1901+1306_Bmodel.ps}}}&
& %{\mbox{\includegraphics[width=52mm]{}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1906+1854_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1901+1306P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1903+2225P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1906+1854P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1901+1306L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1903+2225L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1906+1854L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1908+2351_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1909+1859_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1910+0714_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1908+2351P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1909+1859P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1910+0714P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1908+2351L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1909+1859L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1910+0714L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1911+1758_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1912+2525_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1913+3732_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1911+1758P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1912+2525P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1913+3732P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1911+1758L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1912+2525L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1913+3732L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1913+0446_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1914+0219_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1915+0227_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1913+0446P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1914+0219_350MHz.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1915+0227_350MHz.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1913+0446L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/PQJ1914+0219.57131la.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/PQJ1915+0227.57131la.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J1913+0446, J1914+0219 and J1915+0227 as in Fig.~\ref{figA1}.}
\label{figA27}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
&%{\mbox{\includegraphics[width=52mm]{plots/}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1919+0134_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1938+0650_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1915+0738P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1919+0134P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1938+0650P.ps}}}\\ 
%{\mbox{\includegraphics[width=51mm]{plots/PQJ1938+0650.54842la.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1915+0738L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1919+0134L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1938+0650L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J1915+0738, J1919+0134 and J1938+0650 as in Fig.~\ref{figA1}.}
\label{figA28}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1941+1026_Bmodel.ps}}}&
%{\mbox{\includegraphics[width=51mm]{plots/PQJ1941+2525.57114la.ps}}} \\
{\mbox{\includegraphics[width=52mm]{plots/J1951+1123_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1953+1149_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1941+1026P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1951+1123P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1953+1149P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1941+1026L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1951+1123L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1953+1149L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J1941+1026, J1951+1123 and as in Fig.~\ref{figA1}.}
\label{figA29}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J1956+0838_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J1957+2831_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1959+3620_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J1956+0838P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J1957+2831_350MHz.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1959+3620U+Barr+13.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J1956+0838L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/PQJ1957+2831.57981l3a.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J1959+3620L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J1956+0838, J1957+2831 and J1959+3620 as in Fig.~\ref{figA1}.}
\label{figA30}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J2002+1637_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2007+0809_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2007+0910_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J2002+1637P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J2007+0809P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2007+0910P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J2002+1637L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2007+0809L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2007+0910L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J2002+1637, J2007+0809 and J2007+0910 as in Fig.~\ref{figA1}.}
\label{figA31}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J2008+2513_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2010+2845_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2015+2524_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J2008+2513P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J2010+2845_350MHz.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2015+2524P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J2008+2513L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/PQJ2010+2845.57115la.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2015+2524L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J2008+2513, J2010+2845 and J2015+2524 as in Fig.~\ref{figA1}.}
\label{figA32}
\end{center}
\end{figure*}
...
\begin{tabular}{@{}ll@{}ll@{}}
& %{\mbox{\includegraphics[width=52mm]{}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2017+2043_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2033+0042_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J2016+1948_350MHz.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J2017+2043P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/pJ2033+0042.57568p.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/PQJ2016+1948.57115la.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2017+2043L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2033+0042_820MHz_Lynch+13.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J2016+1948, J2017+2043 and J2033+0042 as in Fig.~\ref{figA1}.}
\label{figA33}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J2036+2835_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2040+1657_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2043+2740_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J2036+2835P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J2040+1657P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2043+2740P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J2036+2835L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2040+1657L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2043+2740L.ps}}}\\ 
\end{tabular}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J2045+0912_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2048+2255_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2111+2106_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J2045+0912P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J2048+2255P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2111+2106P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J2045+0912L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2048+2255L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2111+2106L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J2045+0912, J2048+2255 and J2111+2106 as in Fig.~\ref{figA1}.}
\label{figA35}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J2139+2242_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2151+2315_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2155+2813_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J2139+2242P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J2151+2315P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2155+2813P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J2139+2242L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2151+2315L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2155+2813L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for J2139+2242, PSRs J2151+2315 and J2155+2813 as in Fig.~\ref{figA1}.}
\label{figA36}
\end{center}
\end{figure*}
...
{\mbox{\includegraphics[width=52mm]{plots/J2205+1444_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2215+1538_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J2156+2618P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J2205+1444P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2215+1538P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J2156+2618L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2205+1444L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2215+1538L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J2156+2618, J2205+1444 and J2215+1538 as in Fig.~\ref{figA1}.}
\label{figA37}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J2222+2923_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2234+2114_Bmodel.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2243+1518_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J2222+2923P.ps}}}& 
{\mbox{\includegraphics[width=52mm]{plots/J2234+2114P.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2243+1518P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J2222+2923L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2234+2114L.ps}}}& \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2243+1518P.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for J2222+2923, PSRs J2234+2114 and J2243+1518 as in Fig.~\ref{figA1}.}
\label{figA38}
\end{center}
\end{figure*}
...
\begin{center}
\begin{tabular}{@{}ll@{}ll@{}}
{\mbox{\includegraphics[width=52mm]{plots/J2248-0101_Bmodel.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2253+1516_Bmodel.ps}}} \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2307+2225_Bmodel.ps}}}\\
{\mbox{\includegraphics[width=52mm]{plots/J2248-0101P.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2253+1516P.ps}}} \ \ \  
{\mbox{\includegraphics[width=52mm]{plots/J2307+2225P.ps}}}\\ 
{\mbox{\includegraphics[width=52mm]{plots/J2248-0101L.ps}}}&
{\mbox{\includegraphics[width=52mm]{plots/J2253+1516L.ps}}} \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2307+2225L.ps}}}\\ 
\end{tabular}
\caption{Scaled beam dimensions and average profiles for PSRs J2248--0101, J2253+1516 and J2307+2225 as in Fig.~\ref{figA1}.}
\label{figA39}
\end{center}
\end{figure*}
...
%{\mbox{\includegraphics[width=52mm]{plots/J2248--0101_Bmodel.ps}}}&
%{\mbox{\includegraphics[width=52mm]{plots/J2253+1516_Bmodel.ps}}} \ \ \ 
{\mbox{\includegraphics[width=52mm]{plots/J2355+2246_Bmodel.ps}}}\\
%{\mbox{\includegraphics[width=52mm]{plots/J2248--0101P.ps}}}&
%{\mbox{\includegraphics[width=52mm]{plots/J2253+1516P.ps}}} \ \ \  
{\mbox{\includegraphics[width=52mm]{plots/J2355+2246P.ps}}}\\ 
%{\mbox{\includegraphics[width=52mm]{plots/J2248--0101L.ps}}}&
%{\mbox{\includegraphics[width=52mm]{plots/J2253+1516L.ps}}} \ \ \ /
{\mbox{\includegraphics[width=52mm]{plots/J2355+2246L.ps}}}\\ 
\end{tabular}
