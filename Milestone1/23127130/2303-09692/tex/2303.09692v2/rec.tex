...
\begin{thm}[Unique fixed point - finite final states] \label{thm:rec_unique}
    ...
    \begin{align*}
        ...
        \begin{array}[]{ll}
            ...
            \left(\forall s @ \left(\lambda n @ \prrvfunsym{\iterdiff\left(n, b, P, \ufone\right)}(s)\right) \tendsto 0\right) & \land 
