...
\email{gloria.paoli@fau.de (corresponding author)}
...
\email{gianpaolo.piscitelli@unina.it }
...
The test functions used in the proof of Theorem \ref{max_lambda} fall in the class of the so-called web-functions (for more details refer to \cite{gazzola1999existence, makai1959principal,polya1960two}), which
...
\subsection{Inner asymmetry and conclusion}%\label{inner_sec}
