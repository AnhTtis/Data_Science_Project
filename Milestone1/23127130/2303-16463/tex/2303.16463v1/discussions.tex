...
%
To support FDE on such systems, we create an intermediary
storage key $K_{iSK}$~(
...
and an ephemeral storage root key (eSRK).
%
By retrieving the public part of the eSRK, we can wrap the intermediary key
...
the initrd.
%
Finally, we can deliver the wrapped parent key to the \cvm{} once we have
performed the initial attestation of the platform to ensure its
trustworthiness.
...
%
Using this technique, one could store a hierarchy of keys, as we do on a
