...
\centering
\begin{tabular}{lllll}
%{p{0.17\linewidth}p{0.17\linewidth}p{0.17\linewidth}p{0.11\linewidth}p{0.05\linewidth}}
\toprule
...
%In conclusion, our results showed that humans and models behaved similarly in unknown Chinese character naming task. Saliency effect was found in both human and models. There's a high correlation between humans and models in character's accuracy and production probability on answer's regularity type (except for the \textit{semantic} type). However, humans' answers are more similar to each other than to models' answers. \MODB's results are more similar to humans' data than \MODA. 