...
\input{ content/sec-introduction.tex}

\input{ content/sec-related-works.tex}

\input{ content/sec-approach.tex}

\input{ content/sec-experiments.tex}

\input{ content/sec-conclusion.tex}
...
\input{ content/sec-appendix.tex}
