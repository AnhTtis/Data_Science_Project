...
\begin{abstract}
We present the detection of dust depletion in Complex C, a massive, infalling, low-metallicity 
...
In the Milky Way (MW), we can dissect galaxy-scale gas flows in more detail than is possible in any other galaxy. 
...
\begin{figure*}[!ht]
\includegraphics[width=0.98\textwidth]{complexc_hi_anno_5.png}
...
MW Lyman-$\alpha$ absorption was not observed because the G130M/1222 grating setting places it in the gap between COS detector segments A and B.} 
\label{fig:map}
\end{figure*}
...
log\,$N$(\hi)=19.50$\pm$0.01 derived by \citet{shull2011} from a Green Bank Telescope (GBT) 21\,cm spectrum 
...
\oi\ $\lambda$1302, \sw\ $\lambda\lambda$1253, \no\ $\lambda\lambda$1199.5,1200.2,1200.7, 
\few\ $\lambda$1121, 1144, 1608, \alw\ $\lambda$1670, and \siw\ $\lambda\lambda$1304. 
...
We use the same component structure for all seven low ions, with 
...
\tn{d}{\siw\ $\lambda\lambda$1260, 1190, 1193, and 1526 are saturated in Complex C and are 
...
though limits on dust depletion were derived by \citet{tripp2022}.
...
The depletions of Fe, Si, and Al constitute clear evidence for dust 
