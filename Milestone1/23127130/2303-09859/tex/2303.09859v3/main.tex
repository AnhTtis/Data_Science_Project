...
We use the HuggingFace's \texttt{tokenizers} library,\footnote{\url{https://huggingface.co/tokenizers/}} to define and train a subword tokenizer on BNC (training split).\footnote{We share the full definition of the tokenizer in \url{https://github.com/ltgoslo/ltg-bert}.}
