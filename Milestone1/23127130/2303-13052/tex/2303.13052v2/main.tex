...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.65\textwidth]{algorithm-arch-eps-converted-to.pdf}
...
\begin{figure}[t]
	\centering
	\begin{subfigure}[D2SAC~vs DQN, DRQN, Prioritized-DQN, and Rainbow]{\includegraphics[width=0.45\linewidth]{value_based_reward_curves-eps-converted-to.pdf}}
	\end{subfigure}
	\hfill
	\begin{subfigure}[D2SAC~vs REINFORCE, PPO, and SAC]{\includegraphics[width=0.45\linewidth]{policy_based_reward_curves-eps-converted-to.pdf}}
	\end{subfigure}
...
%\begin{figure*}
%	\centering
%	\includegraphics[width=0.8\linewidth]{diffusion-eps-converted-to.pdf}
%	\caption{Illustration of the ``moving" action probability distribution during the reverse diffusion process, i.e., AGOD algorithm. The vertical dotted lines represent the optimal action(s) predicted by the prophet policy.}
%	\label{fig:diffusion}
%\end{figure*}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.4\linewidth]{action_entropy-eps-converted-to.pdf}
