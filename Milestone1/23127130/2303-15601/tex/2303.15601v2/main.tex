...
We thank Persi Diaconis for suggesting the problem and Jimmy He for the idea behind Lemma~\ref{lem:TotalScore}. We also thank two anonymous referees for whose comments greatly improved the presentation of the manuscript.
%%%%%%%%%%%%%%%%%%%%%%%%%
