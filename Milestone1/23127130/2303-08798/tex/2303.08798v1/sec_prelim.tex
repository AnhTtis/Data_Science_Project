...
\end{example}
\begin{remark}
Note that if we vary the wedge points, the obtained wedge graphs are not isomorphic. Furthermore, they do not have a homotopic independence complex as well.
