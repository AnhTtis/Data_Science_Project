...
\begin{figure*}[t!]
\includegraphics[keepaspectratio=true,scale=0.40]{J1600-3053_crn.pdf}
  \includegraphics[keepaspectratio=true,scale=0.40]{J1939+2134_crn_arn_dmn_scn.pdf}
   \caption{Left: J1600$-$3053 posterior distributions of the chromatic index $\chi_{FCN}$. Right: J1939+2134 posterior distributions of the chromatic index $\chi_{FCN}$.}
