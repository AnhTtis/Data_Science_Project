...
\title{Noise analysis in the Indian Pulsar Timing Array Data Release I}
...
\affiliation{Department of Physics, IISER Bhopal, Bhopal Bypass Road, Bahuri, Bhopal 462066, Madhya Pradesh, India}
...
\input{noise_models.tex}
\input{analysis.tex}

\input{resultsdiscussions.tex}
...
\hline
\multirow{2}{*}{Pulsar} & \multirow{2}{*}{Final Models} & \multicolumn{3}{c|}{Red noise} & 
 \multicolumn{3}{c|}{DM variations} & \multicolumn{3}{c|}{Scattering variations} \\

\cline{3-11}
  & & \multicolumn{1}{c|}{$\log_{10}\rm{A}_{RN}$} & \multicolumn{1}{c|}{$\gamma_{RN}$} & \multicolumn{1}{c|}{Fourier modes} & \multicolumn{1}{c|}{$\log_{10}\rm{A}_{DM}$} & \multicolumn{1}{c|}{$\gamma_{DM}$} & \multicolumn{1}{c|}{Fourier modes} & \multicolumn{1}{c|}{$\log_{10}\rm{A}_{Sv}$} & \multicolumn{1}{c|}{$\gamma_{Sv}$} & \multicolumn{1}{c|}{Fourier modes}\\
\hline
J0437$-$4715 & Model2 & $-12.17^{+0.17}_{-0.12}$ & $0.28^{+0.36}_{-0.20}$ & 10 & ------ & ------ & ------ & ------ & ------ & ------ \\  

J0613$-$0200 & Model2 & $-11.85^{+0.16}_{-0.14}$  & $1.10^{+0.59}_{-0.57}$ & 27 & ------ & ------ & ------& ------ & ------ &------ \\

J0751+1807 & Model1 & ------ & ------ & & ------ & ------ & ------ & ------ & ------ &  ------\\

J1012+5307 & Model6 & ------ & ------ & ------ & $-13.17^{+0.19}_{-0.20}$ & $0.53^{+0.55}_{-0.37}$ & 16 & ------ & ------ & ------ \\

J1022+1001 & Model6 & ------ & ------ &------ & $-12.64^{+0.15}_{-0.13}$ & $0.59^{+0.44}_{-0.36}$ & 40 & ------ & ------ &------ \\

 J1600$-$3053 & Model1 & ------ & ------ & & ------ & ------ &------ & ------ & ------ & ------\\

J1643$-$1224 & Model5 & $-12.44^{+0.25}_{-0.33}$ & $4.11^{+1.62}_{-1.37}$ & 27 & $-12.42^{+0.09}_{-0.08}$ & $2.46^{+0.29}_{-0.24}$ & 40 & $-13.46^{+0.17}_{-0.16}$ & $3.44^{+1.17}_{-0.99}$ & 6 \\

J1713+0747 & Model4 & ------ & ------ & ------ & $-13.85^{+0.25}_{-0.17}$ & $0.48^{+0.62}_{-0.34}$ & 34 & $-14.48^{+0.22}_{-0.23}$ & $3.70^{+1.61}_{-1.39}$ & 5\\

J1744$-$1134 & Model6 & ------ & ------ & ------ & $-11.97^{+0.43}_{-0.36}$ & $3.65^{+1.09}_{-1.02}$ & 4 & ------ & ------ & ------ \\

J1857+0943 & Model2 & $-12.09^{+0.22}_{-0.52}$ & $1.43^{+2.40}_{-0.97}$ & 6 & ------ & ------ & ------ & ------ &  ------ & ------ \\

J1909$-$3744 & Model5  & $-12.45^{+0.13}_{-0.13}$ & $0.67^{+0.32}_{-0.33}$ & 40 & $-13.43^{+0.12}_{-0.10}$ & $2.06^{+0.69}_{-0.46}$ & 40 & ------ & ------ & ------ \\

J1939+2134 & Model5 & $-12.52^{+0.10}_{-0.10}$ & $1.09^{+0.26}_{-0.27}$ & 40 & $-12.75^{+0.08}_{-0.07}$ & $1.84^{+0.24}_{-0.23}$ & 40 & $-14.12^{+0.10}_{-0.09}$ & $3.13^{+0.54}_{-0.48}$ & 16 \\

J2124$-$3358 & Model2 & $-12.23^{+0.15}_{-0.14}$ & $1.04^{+0.96}_{-0.70}$ & 6 & ------ & ------ & ------ & ------ & ------ &------ \\

J2145$-$0750 & Model5 & $-12.23^{+0.12}_{-0.11}$ & $1.98^{+0.71}_{-0.52}$ & 40 & $-13.43^{+0.30}_{-0.37}$ & $4.50^{+1.55}_{-1.49}$ & 27 & $-14.07^{+0.11}_{-0.10}$ & $1.63^{+0.29}_{-0.27}$ & 40 \\ \hline
...
\caption{1D marginalized posterior distributions with 68\%,90\%,99\% credible intervals for red noise components present in respective pulsars.}
 ...
 \includegraphics[keepaspectratio=true,scale=0.4]{J0437-4715_arn.pdf}
	\end{subfigure}
 \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{blank.pdf}
	\end{subfigure}
 \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{blank.pdf}
 ...
 \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{J0613-0200_arn.pdf}
	\end{subfigure}
 \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{blank.pdf}
 ...
 \vspace{1cm}
 	...
 	\begin{subfigure}
		\centering	
 \includegraphics[keepaspectratio=true,scale=0.4]{J1012+5307_dm.pdf}
	\end{subfigure}
    \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{blank.pdf}
...
\begin{figure*}[h!]
 	\begin{subfigure}
	\centering	
 \includegraphics[keepaspectratio=true,scale=0.4]{J1022+1001_dm.pdf}
 	\end{subfigure}
   \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{blank.pdf}
...
\begin{subfigure}
 \centering
 \includegraphics[keepaspectratio=true,scale=0.4]{J1643-1224_arn.pdf}
\end{subfigure} 
 \begin{subfigure}
 \centering
 \includegraphics[keepaspectratio=true,scale=0.4]{J1643-1224_dm.pdf}
\end{subfigure} \begin{subfigure}
 \centering
 \includegraphics[keepaspectratio=true,scale=0.4]{J1643-1224_sc.pdf}
  \captionsetup{labelformat=empty}
...
\begin{subfigure}
 \centering
 \includegraphics[keepaspectratio=true,scale=0.4]{J1713+0747_dm.pdf}
\end{subfigure} 
\begin{subfigure}
 \centering
 \includegraphics[keepaspectratio=true,scale=0.4]{J1713+0747_sc.pdf}
\end{subfigure}
    \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{blank.pdf}
...
\begin{figure*}[h!]
 ...
 \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{J1744-1134_dm.pdf}
	\end{subfigure}
  \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{blank.pdf}
 ...
 \vspace{1.5cm}
	...
	\begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{J1857+0943_arn.pdf}
	\end{subfigure}
  \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{blank.pdf}
...
\begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{J1909-3744_arn.pdf}
	\end{subfigure}
 	\begin{subfigure}
		\centering	
 \includegraphics[keepaspectratio=true,scale=0.4]{J1909-3744_dm.pdf}
	\end{subfigure}
  \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{blank.pdf}
...
\begin{figure*}[h!]
 	...
 	\begin{subfigure}
		\centering	
 \includegraphics[keepaspectratio=true,scale=0.4]{J1939+2134_arn.pdf}
	\end{subfigure}	
 \begin{subfigure}
		\centering	
  \includegraphics[keepaspectratio=true,scale=0.4]{J1939+2134_dm.pdf}
	\end{subfigure}
 	\begin{subfigure}
		\centering	
 \includegraphics[keepaspectratio=true,scale=0.4]{J1939+2134_sc.pdf}
    \captionsetup{labelformat=empty}
...
\vspace{1.5cm}
	...
	\begin{subfigure}
		\centering	 
  \includegraphics[keepaspectratio=true,scale=0.4]{J2124-3358_arn.pdf}
	\end{subfigure}
  \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{blank.pdf}
 ...
 \vspace{1.5cm}
	...
	\begin{subfigure}
		\centering	
 \includegraphics[keepaspectratio=true,scale=0.4]{J2145-0750_arn.pdf}
	\end{subfigure}
 	\begin{subfigure}
		\centering	
 \includegraphics[keepaspectratio=true,scale=0.4]{J2145-0750_dm.pdf}
 	\end{subfigure}
 \begin{subfigure}
		\centering
 \includegraphics[keepaspectratio=true,scale=0.4]{J2145-0750_sc.pdf}
     \captionsetup{labelformat=empty}
...
\label{fullcorner}
 \vspace*{1in}
 \centering
 \includegraphics[keepaspectratio=true,scale=0.40]{J0437-4715_final.pdf}
 \captionsetup{labelformat=empty}
...
\begin{figure*}[h!]
 \centering
 \vspace*{1.75in}
 \includegraphics[keepaspectratio=true,scale=0.40]{J0613-0200_final.pdf}
 \captionsetup{labelformat=empty}
...
\begin{figure*}
 \centering
 \vspace*{2in}
 \includegraphics[keepaspectratio=true,scale=0.35]{J0751+1807_final.pdf}
 \captionsetup{labelformat=empty}
...
\begin{subfigure}
 \centering
 \includegraphics[keepaspectratio=true,scale=0.35]{J1012+5307_final.pdf}
   \captionsetup{labelformat=empty}
...
\begin{subfigure}
 \centering
 \includegraphics[keepaspectratio=true,scale=0.35]{J1744-1134_final.pdf}
  \captionsetup{labelformat=empty}
...
\begin{figure*}
 \centering
 \vspace*{1.25in}
 \includegraphics[keepaspectratio=true,scale=0.33]{J1022+1001_final.pdf}
   \captionsetup{labelformat=empty}
...
\begin{figure*}
 \centering
 \vspace*{1.25in}
 \includegraphics[keepaspectratio=true,scale=0.40]{J1600-3053_final.pdf}
  \captionsetup{labelformat=empty}
...
\begin{figure*}
 \centering
 \vspace*{1.25in}
 \includegraphics[keepaspectratio=true,scale=0.23]{J1643-1224_final.pdf}
  \captionsetup{labelformat=empty}
...
\begin{figure*}
 \centering
 \vspace*{1.25in}
 \includegraphics[keepaspectratio=true,scale=0.27]{J1713+0747_final.pdf}
   \captionsetup{labelformat=empty}
...
\begin{figure*}
 \centering
 \vspace*{1.25in}
 \includegraphics[keepaspectratio=true,scale=0.33]{J1857+0943_final.pdf}
   \captionsetup{labelformat=empty}
...
\begin{figure*}
 \centering
 \vspace*{1.25in}
   \includegraphics[keepaspectratio=true,scale=0.28]{J1909-3744_final.pdf}
  \captionsetup{labelformat=empty}
...
\begin{figure*}
 ...
 \centering
 \vspace*{1.25in}
 \includegraphics[keepaspectratio=true,scale=0.23]{J1939+2134_final.pdf}
   \captionsetup{labelformat=empty}
...
\begin{figure*}
 \centering
 \vspace*{1in}
 \includegraphics[keepaspectratio=true,scale=0.4]{J2124-3358_final.pdf}
   \captionsetup{labelformat=empty}
...
\begin{figure*}
 \centering
 \vspace*{1.25in}
 \includegraphics[keepaspectratio=true,scale=0.23]{J2145-0750_final.pdf}
   \captionsetup{labelformat=empty}
