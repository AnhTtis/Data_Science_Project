...
\usepackage[algo2e,lined,algonl,boxed]{algorithm2e}
...
\begin{frontmatter}
\title{Robust Exponential Runge--Kutta Embedded Pairs\thanks{This work
was supported by the Natural Sciences and Engineering Research Council
of Canada.}}

\author{Thoma Zoto\corref{cor1}}
\cortext[cor1]{Corresponding author}
\address{RAPSODI, Inria Lille--Nord Europe, Villeneuve d'Ascq 59650, France}
\ead{thomazoto1@gmail.com}
...
We have implemented a Mathematica script that checks the
...
This is done in a supplementary Mathematica script, which generates the
