...
\author{Yitong Hu, Zixuan Zhu, Yizhe Wang, Junxiang Wang, Zehao Xing}
\address{Beijing University of Posts and Telecommunications, Beijing, China}
\ead{\{huyt, ternura, anonymity, 1034696975, sonaldovski\}@bupt.edu.cn}
...
contribution to that paper. Therefore, we can assume that the scholar's contribution is non-uniformly proportional to his ranking in that paper. An exponential function shown in Figure \ref{exponential} is used to represent the scholar's contribution.
