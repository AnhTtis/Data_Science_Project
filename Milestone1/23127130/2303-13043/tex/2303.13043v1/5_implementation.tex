...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \subsection{Variational Approximation to Bayesian Inference}
...
%We empirically show that the query $\xi$ actually learns to coarsely detect the foreground object.
