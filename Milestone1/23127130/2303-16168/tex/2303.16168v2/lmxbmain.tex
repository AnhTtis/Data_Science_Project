...
\begin{document} 
   ...
   \thanks{The catalogue table is available in electronic form at the CDS via anonymous ftp to \rurl{cdsarc.cds.unistra.fr} (130.79.128.5) or via \url{https://cdsarc.cds.unistra.fr/cgi-bin/qcat?J/A+A}. \\
   An online version of the catalogue table, along with the corresponding finding charts and other useful information is also publicly accessible at \url{http://astro.uni-tuebingen.de/~xrbcat}.}
   }
