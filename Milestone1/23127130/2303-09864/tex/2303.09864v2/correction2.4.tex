...
\eea
%
where the propagators are given by \footnote{In \cite{Needed} there are $D_8=(l_1+p_3)^2$ and $D_9=(l_2-p_1)^2-m^2$ which is for the tensor structure. Since we use the different way to deal with tensor, we do not include them here.}
%
\bea
%
