...
\newcommand{\basicfontsize}{\footnotesize}

% define XML
\lstset{
  basicstyle=\basicfontsize\ttfamily\color{black},
...
% define json
\newcommand{\jsonkey}{\color{darkblue}}
\newcommand{\jsonvalue}{\color{orange}}
\newcommand{\jsonnumber}{\color{cyan}}
\newcommand{\jsonbool}{\color{codegreen}}
