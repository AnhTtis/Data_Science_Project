...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \end{tikzpicture}$};
        \node at (9.5,0) {$\begin{tikzpicture}
            \node[sevB] (1) at (0,0) {};
            \node[sevB] (2) at (1,0) {};
        ...
        \end{tikzpicture}$};
        \node at (9.5,-3) {$\begin{tikzpicture}
            \node at (0,0) {};
            \node[sevB] (2) at (1,0) {};
            \node[sevR] (3u) at (2,1) {};
            \node[sevR] (3d) at (2,-1) {};
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node (O) at (0,0) {$\begin{tikzpicture}
            \draw[blue] (0,-1)--(0,1) (1,-1)--(1,1);
            \draw[goodgreen] (2,-1)--(2,1);
            \node[NS] (ns) at (1.5,0) {};
            \draw (0,0)--(ns);
        ...
        \end{tikzpicture}$};
        \node (L) at (-2,3) {$\begin{tikzpicture}
            \draw[blue] (0,-1)--(0,1) (1,-1)--(1,1);
            \draw[goodgreen] (2,-1)--(2,1);
            \node[NS] (ns) at (1.5,0) {};
            \draw (0,-0.4) .. controls (2.5,-0.6) .. (1,-0.8);
        \end{tikzpicture}$};
        \node (R) at (2,3) {$\begin{tikzpicture}
            \draw[blue] (0,-1)--(0,1) (1,-1)--(1,1);
            \draw[goodgreen] (2,-1)--(2,1);
            \node[NS] (ns) at (1.5,0) {};
...
\begin{equation}
    \makebox[\textwidth][c]{
    \raisebox{-.5\height}{\begin{tikzpicture}[scale=0.7]
...
\begin{equation}
\begin{split}
    \HS(\HV(\mathrm{U}(2)-\mathrm{USp}(4)-[D_2]))=&\HS  \left(\raisebox{-.3\height}{\begin{tikzpicture}[scale=0.3]
    \node[hasse] (a1) at (0,0) {};
    \node[hasse] (b1) at (-1,1) {};
    \node[hasse] (c1) at (-2,2) {};
    \draw (a1)--(b1)--(c1);
    \end{tikzpicture}} \right)+\HS \left(\raisebox{-.3\height}{\begin{tikzpicture}[scale=0.3]
    \node[hasse] (a1) at (0,0) {};
    \node[hasse] (a2) at (1,1) {};
    \node[hasse] (b1) at (-1,1) {};
    \node[hasse] (b2) at (0,2) {};
...
The magnetic quiver at each intersection of the the Hasse diagram is simply the maximal quiver that can be subtracted from its dominant quivers. Thus, the diagram for each magnetic quiver $\mathsf{Q}_m^{k,l}$ follows from \eqref{magnetic:uspHl} as:
\begin{equation}
\raisebox{-.5\height}{
    \begin{tikzpicture}
...
%It would be interesting to compute the Hall-Littlewood formula \cite{Cremonesi:2014kwa}, which according to the conjecture in \cite{Akhond:2022jts}, yields the Hilbert series of the local Coulomb branch at the most singular point. However, here we have four most singular points on the Coulomb branch, with two pairs being identical; it is an open question to determine which singularity is sought out by the Hall-Littlewood formula. 
