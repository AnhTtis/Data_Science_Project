...
In our experiments we set $X \in \mathbb{R}^{n_1 \times n_2}$ to be a random matrix with $n_1 = 100$, $n_2 = 50$ and rank $r = 5$ and i.i.d. Gaussian entries with distribution $\mathcal{N} \left(0,1\right)$.
