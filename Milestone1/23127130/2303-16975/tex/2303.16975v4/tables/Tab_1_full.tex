...
% \hline
Cross-Task~\cite{cross_task} & \multicolumn{2}{l|}{\qquad \cmark $\kern 3.5pc$ \xmark} & \multicolumn{4}{l|}{\qquad \cmark $\kern 2.7pc$ \xmark $\kern 2.8pc$ \cmark $\kern 3.2pc$ \xmark} & \multicolumn{2}{l}{\qquad \cmark $\kern 2.1pc$ \cmark}\\
\hline
...
\vspace{2mm}
\caption{\textbf{\etv vs. existing video-language datasets.} \etv benchmark enables reasoning (compositional, causal, and temporal); has unique dataset characteristics along with capabilities for systematic investigation (diagnostics); requires grounding of objects, relations, and actions.}
