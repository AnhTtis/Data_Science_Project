...
% \hline
Cross-Task~\cite{cross_task} & \multicolumn{3}{l|}{\qquad\qquad \cmark $\kern 2.7pc$ \cmark $\kern 2.6pc$ \cmark} & \multicolumn{3}{l}{\qquad \xmark $\kern 2.8pc$ \cmark $\kern 3.2pc$ \xmark}\\
\hline
