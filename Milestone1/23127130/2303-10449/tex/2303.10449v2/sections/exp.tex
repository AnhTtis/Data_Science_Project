...
% The ID set in SCOOD benchmarks is conducted by collecting images belonging to ID classes from different datasets, and then the remaining samples that do not overlap with the ID classes in these datasets compose the OOD set. In this way, OOD samples can be distributed outside of the ID classes by means of semantic, instead of being viewd as OOD just because they're from another dataset like conventional OOD benchmarks. SCOOD benchmarks is proposed to address the essential problem of OOD detection: making models distinguish semantic shifts between ID and OOD samples without being affected by  covariate shifts between different datasets. Therefore, SCOOD benchmarks are more practical to meet the actual deployment requirements in real-world.
...
%   \centerline{\includegraphics[width=4.3cm]{lufan_CVPR2023/fig/Automoblie-dis.png}}
%   \centerline{\footnotesize{(a) Result 1}}
% \end{minipage}
% \hfill
% \begin{minipage}{.48\linewidth}
%   \centerline{\includegraphics[width=4.3cm]{lufan_CVPR2023/fig/Automoblie-energy.png}}
%   \centerline{\footnotesize{(a) Result 1}}
% \end{minipage}
% \vfill
% \begin{minipage}{0.48\linewidth}
%   \centerline{\includegraphics[width=4.3cm]{lufan_CVPR2023/fig/Bird-dis.png}}
%   \centerline{\footnotesize{(a) Result 1}}
% \end{minipage}
% \hfill
% \begin{minipage}{0.48\linewidth}
%   \centerline{\includegraphics[width=4.3cm]{lufan_CVPR2023/fig/Bird-energy .png}}
%   \centerline{\footnotesize{(a) Result 1}}
% \end{minipage}
% %\end{tabular}
% \caption{Consistency.}
