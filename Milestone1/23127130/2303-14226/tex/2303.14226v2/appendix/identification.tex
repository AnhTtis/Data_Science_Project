...
%
Below, the symbol $\stackrel{AX}{=}$ and $\stackrel{DX}{=}$ imply that the equality follows from Assumption $X$ and Definition $X$, respectively. 
%
We begin with the proof of Theorem \ref{thm:identification} (a). 
%
For a donor unit $u \in \mathcal{I}$ and $\pi \in \Pi \setminus \Pi_u$, we have
\begin{align*}
...
\end{align*}
%
\noindent Next, we establish the  proof of Theorem \ref{thm:identification} (b). For a non-donor unit $n$ and  $\pi \in \Pi \setminus \Pi_n$, we have
\begin{align*}
