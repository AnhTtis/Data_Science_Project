...
KCMS formed a consortium with Mecaro Co., Ltd. for the production of the foil, but after the consortium ended, the equipment for the production is being moved to the institute of basic science for the production of ME0 foils.
...
The machine can form patterns of up to \SI{125x58}{\centi\meter} in size.
...
\subsection{Dry film resist striping}
...
With this technique, the soldering process, which was once a bottleneck for GEM foil production, can now be completed more quickly and accurately with less work fatigue.
...
The validation of the production techniques was conducted by assembling the CMS GE1/1 type detectors with the foils produced by the new vendor and measuring characteristics such as gain, gain uniformity and Etc. \cite{ICHEP18_Validation}.
In addition, the production technology was verified again through the results of the mass production and QC as described in section.~\ref{sec:overview}.
