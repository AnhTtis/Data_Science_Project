...
%%Title
\title{Techniques for mass production of large-sized GEM foil in Korea for CMS phase-2 upgrade}
...
\section{GEM foil production by Korea}
...
The Korean CMS group (KCMS) has been designated as the second supplier of large-sized GEM foils together with the CERN Micro Pattern Technologies workshop (MPT) for the CMS GEM upgrades.
...
So far, KCMS has produced 285 GE2/1 foils that have passed the quality control criteria established by the CMS GEM upgrade projects.
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.3\textwidth]{UV_Exposure.png}
	\qquad
	\includegraphics[width=.3\textwidth]{Developer.png}
