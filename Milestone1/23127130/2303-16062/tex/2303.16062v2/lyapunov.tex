...
amsmath,amssymb,superscriptaddress,aps,floatfix]{revtex4}
...
Z(t)=\Xi^{-T}(t)\qquad
\Leftrightarrow\qquad Z^{-1}(t)=\Xi^{T}(t).
\end{equation}
...
\begin{quote}
A regular or irregular time evolution of a {\em nonlinear\/}
mapping $(\vecq,\vecp)_{t=0}\mapsto(\vecq,\vecp)_t$
is reflected by the properties of the time evolution
of the ``transfer matrix'' $\Xi^{T}(t)$
that describes the {\em linear\/} reverse mapping
${(\HC,-\onehalf\vecq\vecp,\quarter\vecq^{2})}_{t}
\mapsto {(\HC,-\onehalf\vecq\vecp,\quarter\vecq^{2})}_{t=0}$.
\end{quote}
...
for $\lambda_{1}(t)$ from Eq.~(\ref{lyapfunct1}) are given by
\begin{eqnarray*}
\ddot{x}+x+2Cxy&=&0\,,\qquad\ddot{y}+y+C(x^{2}-y^{2})=0\\
\ddot{\phi}+g_{2}\,\phi&=&0\,,\qquad
g_{2}=4+10C\,y\frac{x^{2}-y^{2}/3}{x^{2}+y^{2}}.
\end{eqnarray*}
We first verify the energy-second-moment map~(\ref{invgsys}) for the numerical integration of the system~(\ref{hhdef}).
The deviations $\Delta I_j(t)$ of the numerical invariants from the exact invariants given by the initial conditions
$h_0$, $\vecq_0$, and $\vecp_0$ of the numerical integration are plotted in Fig.~\ref{f0}.
\begin{figure}[ht]
\centering\includegraphics[height=\linewidth,angle=-90]{invar.eps}
\caption{Numerical errors $\Delta I_1=h|_{t=0}-h_0$, $\Delta I_2=-\onehalf\vecq\vecp|_{t=0}+\onehalf\vecq_0\vecp_0$,
and $\Delta I_3=\quarter\vecq^{2}|_{t=0}-\quarter\vecq_0^{2}$ of the invariants $I_1=h|_{t=0}$, $I_2=-\onehalf\vecq\vecp|_{t=0}$,
and $I_3=\quarter\vecq^{2}|_{t=0}$, calculated with quadruple precision.}
\label{f0}
\end{figure}
...
\centerline{\includegraphics[height=\linewidth,angle=-90]{yyp1.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{irrlam2.eps}}
\end{minipage}
...
\begin{figure}[t]
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=1.1\linewidth,angle=-90]{xy.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}\vfill
\centerline{\includegraphics[height=\linewidth,angle=-90]{reglam2.eps}}
\vfill\end{minipage}
...
\begin{figure}[t]
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{yypr.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}\vfill
\centerline{\includegraphics[height=\linewidth,angle=-90]{reglam3.eps}}
\vfill\end{minipage}
...
\begin{figure}[t]
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{yyp1a.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{irrlam2a.eps}}
\end{minipage}
\caption{\label{f1a}
...
\begin{figure}[ht]
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{yyp1b.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{irrlam2b.eps}}
\end{minipage}
\caption{\label{f1b}
Right: enlarged view of the Lyapunov function
$\lambda_{1}(t)$ from Fig.~\ref{f1} for the time
...
\begin{figure}[t]
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap1a.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap1b.eps}}
\end{minipage}
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap2a.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap2b.eps}}
\end{minipage}
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap3a.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap3b.eps}}
\end{minipage}
...
\begin{figure}[ht]
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap4a.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap4b.eps}}
\end{minipage}
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap5a.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap5b.eps}}
\end{minipage}
\begin{minipage}[b]{.48\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap6a.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap6b.eps}}
\end{minipage}
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap7a.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap7b.eps}}
\end{minipage}
...
\begin{figure}[t]
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap8a.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap8b.eps}}
\end{minipage}
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap9a.eps}}
\end{minipage}\hfill
\begin{minipage}[b]{.49\linewidth}
\centerline{\includegraphics[height=\linewidth,angle=-90]{lyap9b.eps}}
\end{minipage}
