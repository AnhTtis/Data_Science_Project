...
Most glaringly, we find no decay or other trend
...
ensuring that $\hat c_{n,k}t^{(k-n)/{2z}} \ll \hat c_{n,n}$ at all orders $n>k\geq 0$. Unlike in the regular case, the left-hand side now decays with time. \cite{rosenberg2023dynamics}
