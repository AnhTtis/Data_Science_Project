...
\author{%
  Haoheng Lan\thanks{ Equal contribution}\;\,$^1$, \;\; Jindong Gu$^*$$^2$, \;\; Philip Torr$^2$, \;\; Hengshuang Zhao$^3$ \\
  ...
  \footnotesize{\texttt{hszhao@cs.hku.hk}} \\
}
...
\begin{figure}[t]
    ...
    \resizebox{0.97\linewidth}{!}{
        \begin{tabular}{@{\hspace{0.0mm}}c@{\hspace{1.0mm}}c@{\hspace{1.0mm}}c@{\hspace{1.0mm}}c@{\hspace{0.0mm}}}
            ...
            \includegraphics[scale=0.158]{figures/benign_output.pdf}\\
            ...
            \includegraphics[scale=0.158]{figures/attacked_output.pdf}\\
