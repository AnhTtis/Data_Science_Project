...
% When submitting to IMRN, complex use of tikz-cd have problems.
% We are going to change graphics to xymatrix.
% Previous tikz-cd diagrams are commented out.
\usepackage{tikz-cd}
% \usepackage{tikz}
% \input tikz.tex
% \usetikzlibrary{cd}
...
% JPAA format
\title{Enriched Morita theory of monoids in a closed symmetric monoidal category\tnoteref{t1}}
...
\ead{jhlee1228lee@postech.ac.kr}
\author{
  Jae-Suk Park
  \corref{cor2}
  %\fnref{fn2}
}
\ead{jaesuk@postech.ac.kr}
\affiliation{
organization={Department of Mathematics, POSTECH},
addressline={77 Cheongam-Ro},
postcode={37673},
city={Pohang},
...
\begin{keyword}
Morita theory\sep the Eilenberg-Watts theorem\sep enriched category
\end{keyword}

% Classification code: 18D20
...
\newproof{proof}{Proof}
\newproof{proof thm EWthm cocomCcat}{Proof of Theorem~\ref{thm EWthm cocomCcat}}
\newproof{proof thm Intro CosMorita}{Proof of Theorem~\ref{thm Intro CosMorita}}
...
\begin{theorem} \label{thm Intro EWthm}
  ...
  \begin{equation*}
    \xymatrix@R=0pt{
      \text{ }\!\!_{\mathfrak{b}}T
      \ar@{~>}[r]^-{\simeq}
      &{\mathlcal{C}\text{-}\mathit{Funct}_{\mathit{tc}}(\bm{\mathcal{M}}_{\mathfrak{b}},\bm{T})}
      \\%1
      \text{ }\!\!_{\mathfrak{b}}X
      \ar@{|->}[r]
  ...
  to the category 
  of $\mathlcal{C}$-enriched functors 
  $\bm{\mathcal{F}}:\bm{\mathcal{M}}_{\mathfrak{b}}\rightsquigarrow\bm{T}$
  preserving tensored objects and weighted coequalizers.
\end{theorem}
...
\begin{corollary} \label{cor Intro EWthm}
  ...
  \begin{equation*}
    \xymatrix@R=0pt{
      ...
      \ar@{~>}[r]^-{\simeq}
      &{\mathlcal{C}\text{-}\mathit{Funct}_{\mathit{tc}}(\bm{\mathcal{M}}_{\mathfrak{b}},\bm{\mathcal{M}}_{\mathfrak{b}'})}
      \\%1
...
is conservative, and preserves tensored objects and weighted coequalizers.
...
\begin{example}
  ...
  \begin{equation*}
    \xymatrix@C=50pt{
      ...
      \ar@{^{(}->}[r]^-{\mathit{eq}_{z_{\mathfrak{b}},\tilde{z}_{\mathfrak{b}}}}
...
if for each pair
$\xymatrix@C=18pt{X_1\ar@<0.5ex>[r]\ar@<-0.5ex>[r]&X_2}$
...
$\xymatrix@C=18pt{\bm{T}(X,Y)\ar[r]&\bm{T}(X_2,Y)\ar@<0.5ex>[r]\ar@<-0.5ex>[r]& \bm{T}(X_1,Y)}$
...
$\xymatrix@C=18pt{X_1\ar@<0.5ex>[r]\ar@<-0.5ex>[r]& X_2\ar[r]&X}$
...
\begin{example}
  We explain what $\bm{\mathcal{M}}_{\mathfrak{b}}$, $\text{ }\!\!_{\mathfrak{b}}\mathcal{M}_{\mathfrak{b}'}$
  are for some examples of $\mathlcal{C}$.
  \begin{itemize}
  \item
  When $\mathlcal{C}=\mathlcal{Ab}$,
  monoids $\mathfrak{b}$, $\mathfrak{b}'$ are rings
  and
  $\bm{\mathcal{M}}_{\mathfrak{b}}$ is the preadditive category of right modules over a ring $\mathfrak{b}$.
  Moreover, $\text{ }\!\!_{\mathfrak{b}}\mathcal{M}_{\mathfrak{b}'}$
  is the category of $(\mathfrak{b},\mathfrak{b}^{\pr})$-bimodules.

  \item
  When $\mathlcal{C}=\mathlcal{fAb}$,
  monoids $\mathfrak{b}$, $\mathfrak{b}'$ are rings finitely generated as $\mathbb{Z}$-modules,
  and $\bm{\mathcal{M}}_{\mathfrak{b}}$ is the preadditive category of finitely generated abelian groups
  equipped with a right action of the ring $\mathfrak{b}$.
  Moreover, $\text{ }\!\!_{\mathfrak{b}}\mathcal{M}_{\mathfrak{b}'}$
  is the category of finitely generated abelian groups equipped with a bi-action of the rings $\mathfrak{b}$, $\mathfrak{b}'$.

  \item
  When $\mathlcal{C}=\mathlcal{sSet}$,
  monoids $\mathfrak{b}$, $\mathfrak{b}'$ are simplicial monoids,
  and
  ...
  \item
  When $\mathlcal{C}=\mathlcal{Ban}$,
  monoids $\mathfrak{b}$, $\mathfrak{b}'$ are associative unital Banach algebras,
  and
  ...
  \item
  When $\mathlcal{C}=\mathlcal{S\!p}^{\Sigma}_{\mathit{CGT}_{\!*}}$,
  monoids $\mathfrak{b}$, $\mathfrak{b}'$ are symmetric ring spectra,
  and 
  ...
  Moreover, $\text{ }\!\!_{\mathfrak{b}}\mathcal{M}_{\mathfrak{b}'}$
  is the category of symmetric spectra equipped with a bi-action of the symmetric ring spectra $\mathfrak{b}$, $\mathfrak{b}'$.
  \end{itemize}
\end{example}
...
\begin{definition}\label{def tensorCfunct}
  ...
  \begin{equation*}
    \xymatrix@C=50pt{
      ...
      &z\!\circledast\! X
      \ar@{->>}[r]^-{\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}\!X}}
  ...
  \begin{equation*}
    \xymatrix@R=13pt@C=45pt{
      z\!\circledast\! X
      \ar@{->>}[d]_-{\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}X}}
      % \ar[d,two heads,"\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}X}\text{ }"']
      \ar[r]^-{l\circledast \tilde{l}}
      % \ar[r,"l\circledast \tilde{l}"]
      &\tilde{z}\!\circledast\! \tilde{X}
      \ar@{->>}[d]^-{\mathit{coeq}_{\tilde{z}_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}\tilde{X}}}
  ...
  \begin{equation*}
    \xymatrix@R=13pt@C=50pt{
      w\!\circledast\! \bigl(z\!\circledast\! X\bigr)
      \ar@{->>}[d]_-{\I_w\circledast \mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}X}}
      ...
      \ar@{->>}[d]^-{\mathit{coeq}_{w\circledast z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}X}}
...
\begin{equation}\label{eq leftadj}
  ...
  % \end{tikzcd}
\end{equation}
from the category of left $\mathfrak{b}$-module objects in $T$
to the category of $\mathlcal{C}$-enriched functors $\bm{\mathcal{F}}:\bm{\mathcal{M}}_{\mathfrak{b}}\rightsquigarrow \bm{T}$.
...
\begin{equation*}
  \xymatrix@R=13pt@C=50pt{
    b\!\circledast\! X
    \ar@{->>}[d]_-{\mathit{coeq}_{b_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}X}}
    ...
    \ar@{.>}[r]^-{\exists!\text{ }\imath^{\mathfrak{b}}_{\text{ }\!\!_{\mathfrak{b}}X}}_-{\cong}
...
\begin{proposition} \label{prop bXtensorHomCadj}
  ...
  \begin{itemize}
    ...
    % \begin{tikzcd}[cramped,column sep=15]
    %   z_{\mathfrak{b}}
    %   \ar[r]&
    %   \bm{T}\bigl(\text{ }\!\!_{\mathfrak{b}}X,z_{\mathfrak{b}}\!\circledast_{\mathfrak{b}}\! \text{ }\!\!_{\mathfrak{b}}X\bigr)
    % \end{tikzcd}
    ...
    \begin{equation*}
      ...
      \xymatrix@C=40pt{
        ...
        % \ar[r,"{\mathit{Cv}_{z,X}}"]
        &\bm{T}\bigl(X,z\!\circledast\! X\bigr)
        \ar[r]^-{(\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}X})_{\star}}
    ...
    \begin{equation*}
      \xymatrix@R=13pt@C=60pt{
        \bm{T}(X,Y)\!\circledast\! X
        \ar@{->>}[d]_-{\mathit{coeq}_{\bm{T}(\text{ }\!\!_{\mathfrak{b}}X,Y),\text{ }\!\!_{\mathfrak{b}}X}}
        % \ar[d,two heads,"{\mathit{coeq}_{\bm{T}(\text{ }\!\!_{\mathfrak{b}}X,Y),\text{ }\!\!_{\mathfrak{b}}X}\text{ }}"']
        \ar@/^1.2pc/[dr]^-{\mathit{Ev}_{X,Y}}
...
\begin{proposition} \label{prop lambdaF}
  ...
  \begin{equation} \label{eq prop lambdaF}
    \xymatrix@R=20pt@C=60pt{
      ...
      \ar@{->>}[d]_-{\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}\bm{\mathcal{F}}(b_{\mathfrak{b}})}}
...
\begin{proof}
  ...
  \begin{equation*}
    \hspace*{-4.3cm}
    \xymatrix@R=12pt@C=6pt{
      &w\!\circledast\! \bigl(z\!\circledast\! \bm{\mathcal{F}}(b_{\mathfrak{b}})\bigr)
      \ar@{->>}[d]^-{\I_w\circledast \mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}\bm{\mathcal{F}}(b_{\mathfrak{b}})}}
      ...
      % \ar[r,equal]
      &w\!\circledast\! \bigl(z\!\circledast\! \bm{\mathcal{F}}(b_{\mathfrak{b}})\bigr)
      \ar@{->>}@<4ex>[d]_-{\I_w\circledast \mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}\bm{\mathcal{F}}(b_{\mathfrak{b}})}}
      ...
      \ar@{->>}[d]^-{\mathit{coeq}_{w\circledast z_{\mathfrak{b}},\bm{\mathcal{F}}(b_{\mathfrak{b}})}}
  ...
  We are left to check that the statements (i)-(iii) are equivalent.
  By Proposition~\ref{prop bXtensorHomCadj}, 
  (i) implies (ii).
  We immediately see that (ii) implies (iii).
  We claim that (iii) implies (i).
...
\begin{proof}
  ...
  \begin{equation} \label{eq lambdaF CnaturalinF}
    \xymatrix@R=13pt@C=30pt{
      -\!\circledast_{\mathfrak{b}}\! \text{ }\!\!_{\mathfrak{b}}\bm{\mathcal{F}}(b_{\mathfrak{b}})
      \ar@2{->}[d]_-{-\text{ }\! \circledast_{\mathfrak{b}}\xi_{b_{\mathfrak{b}}}}
      % \ar[d,Rightarrow,"-\text{ }\! \circledast_{\mathfrak{b}}\xi_{b_{\mathfrak{b}}}\text{ }"']
      \ar@2{->}[r]^-{\bm{\lambda}^{\bm{\mathcal{F}}}}
      ...
      \ar@2{->}[r]^-{\bm{\lambda}^{\tilde{\bm{\mathcal{F}}}}}
  ...
  \begin{equation*}
    ...
    \xymatrix@R=13pt@C=10pt{
      &z\!\circledast\! \bm{\mathcal{F}}(b_{\mathfrak{b}})
      \ar@{->>}[d]^-{\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}\bm{\mathcal{F}}(b_{\mathfrak{b}})}}
      ...
      \ar[d]^-{t^{\tilde{\bm{\mathcal{F}}}}_{z,b_{\mathfrak{b}}}}
      % \ar[d,"\text{ }t^{\tilde{\bm{\mathcal{F}}}}_{z,b_{\mathfrak{b}}}"]
      \ar@{=}[r]
      % \ar[r,equal]
      &z\!\circledast\! \tilde{\bm{\mathcal{F}}}(b_{\mathfrak{b}})
      \ar@{->>}[d]^-{\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}\tilde{\bm{\mathcal{F}}}(b_{\mathfrak{b}})}}
      ...
      \ar[d]^-{\tilde{\bm{\mathcal{F}}}(\gamma_{z_{\mathfrak{b}}})}
      ...
      \ar[d]^-{\lambda^{\tilde{\bm{\mathcal{F}}}}_{z_{\mathfrak{b}}}}
...
\begin{proof thm EWthm cocomCcat}
  ...
  \begin{equation*}
    \xymatrix@R=13pt@C=40pt{
      -\!\circledast_{\mathfrak{b}}\! \text{ }\!\!_{\mathfrak{b}}X
      \ar@2{->}[r]^-{-\circledast_{\mathfrak{b}}(\imath^{\mathfrak{b}}_{\text{ }\!\!_{\mathfrak{b}}X})^{-1}}
    ...
    \xymatrix@R=13pt@C=40pt{
      \text{ }\!\!_{\mathfrak{b}}\bm{\mathcal{F}}(b_{\mathfrak{b}})
      \ar[r]^-{(\imath^{\mathfrak{b}}_{\text{ }\!\!_{\mathfrak{b}}\bm{\mathcal{F}}(b_{\mathfrak{b}})})^{-1}}
  ...
  To verify the other relation,
  let $z_{\mathfrak{b}}\in\Obj(\bm{\mathcal{M}}_{\mathfrak{b}})$
  and consider the following diagram.
  \begin{equation*}
    \hspace*{-3cm}
    \xymatrix@R=13pt@C=10pt{
      &z\!\circledast\! X
      \ar@{->>}[d]^-{\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}X}}
      ...
      \ar@{->>}[d]^-{\I_z\circledast \mathit{coeq}_{b_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}X}}
      ...
      \ar@{->>}[d]^-{\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}b_{\mathfrak{b}}\circledast_{\mathfrak{b}}\text{ }\!\!_{\mathfrak{b}}X}}
      ...
      \ar@{->>}[d]^-{\mathit{coeq}_{z\circledast b_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}X}}
...
\begin{definition}
  ...
  \begin{itemize}
    \item[(i)]
    $X$ is \emph{$\mathlcal{C}$-enriched compact}
    if the $\mathlcal{C}$-enriched functor
    $\bm{T}(X,-):\bm{T}\rightsquigarrow \bm{\mathscr{C}}$
    preserves tensored objects and weighted coequalizers;
 
    \item[(ii)]
    $X$ is a \emph{$\mathlcal{C}$-enriched generator}
    if the $\mathlcal{C}$-enriched functor
    $\bm{T}(X,-):\bm{T}\rightsquigarrow \bm{\mathscr{C}}$
    is conservative;
  
    \item[(iii)]
    $X$ is a \emph{$\mathlcal{C}$-enriched compact generator}
    if the $\mathlcal{C}$-enriched functor
    $\bm{T}(X,-):\bm{T}\rightsquigarrow \bm{\mathscr{C}}$
    is conservative,
    and preserves tensored objects and weighted coequalizers.
  \end{itemize}    
\end{definition}
...
\begin{itemize}
  \item 
  the collection of isomorphisms $\bar{\gamma}_{z_{\mathfrak{b}}}:z\xrightarrow[]{\cong}\bm{\mathcal{M}}_{\mathfrak{b}}(b_{\mathfrak{b}},z_{\mathfrak{b}})$
  in $\bm{\mathscr{C}}$
  is $\mathlcal{C}$-enriched natural in variable $z_{\mathfrak{b}}\in\Obj(\bm{\mathcal{M}}_{\mathfrak{b}})$;

  \item
  the forgetful $\mathlcal{C}$-enriched functor
  $\bm{\mathcal{M}}_{\mathfrak{b}}\rightsquigarrow\bm{\mathscr{C}}$ is conservative,
  and preserves tensored objects and weighted coequalizers.
\end{itemize}
...
\begin{proof}
  ...
  $\bm{T}(X,-):\bm{T}\rightsquigarrow\bm{\mathscr{C}}$
  as well as the forgetful $\mathlcal{C}$-enriched functor
  $\bm{\mathcal{M}}_{\mathfrak{b}}\rightsquigarrow\bm{\mathscr{C}}$
  preserve tensored objects and weighted coequalizers,
  ...
  also preserves tensored objects and weighted coequalizers.
  ...
  \begin{equation*}
    \hspace*{-0.7cm}
    \xymatrix@R=13pt@C=8pt{
      &b
      \ar[d]^-{\mathit{Cv}_{b,X}}
      % \ar[d,"\text{ }\mathit{Cv}_{b,X}"]
      \ar@<-4ex>@/_1pc/[dd]_-{\eta_{b_{\mathfrak{b}}}}
      ...
      \ar[d]^-{(\mathit{coeq}_{b_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}X})_{\star}}
  ...
  \begin{equation*}
    \xymatrix@R=20pt@C=60pt{
      ...
      \ar[d]_-{\I_{\bm{T}(X,Y)}\circledast f\circledast \I_X}^-{\cong}
      % \ar[d,"\I_{\bm{T}(X,Y)}\circledast f\circledast \I_X\text{ }"',"\text{ }\cong"]
      \ar@<0.5ex>[r]^-{\gamma_{\bm{T}(X,Y)}\circledast \I_X}
      % \ar[r,shift left=0.7,"{\gamma_{\bm{T}(X,Y)}\circledast \I_X}"]
      \ar@<-0.5ex>[r]_-{\I_{\bm{T}(X,Y)}\circledast \rho_X}
      % \ar[r,shift right=0.7,"{\I_{\bm{T}(X,Y)}\circledast \rho_X}"']
      &\bm{T}(X,Y)\!\circledast\! X
      \ar@{=}[d]
      % \ar[d,equal]
      \ar@{->>}[r]^-{\mathit{coeq}_{\bm{T}(\text{ }\!\!_{\mathfrak{b}}X,Y),\text{ }\!\!_{\mathfrak{b}}X}}
  ...
  $\bm{T}(X,-):\bm{T}\rightsquigarrow\bm{\mathscr{C}}$
  on the above diagram, and obtain the following diagram in $\bm{\mathscr{C}}$.
  Recall that the $\mathlcal{C}$-enriched functor
  $\bm{T}(X,-):\bm{T}\rightsquigarrow\bm{\mathscr{C}}$
  preserves tensored objects and weighted coequalizers.  
  \begin{equation*}
    \hspace*{-0.3cm}
...
\begin{equation}\label{eq jmathb}
  \xymatrix@R=13pt@C=50pt{
    z\!\circledast\! b_{\mathfrak{b}}
    \ar@{->>}[d]_-{\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}b_{\mathfrak{b}}}}
    ...
    \ar@{.>}[r]^-{\exists!\text{ }\jmath^{\mathfrak{b}}_{z_{\mathfrak{b}}}}_-{\cong}
...
\begin{equation*}
  ...
  \xymatrix@C=42pt{
    b\!\circledast\! \bigl(x_{\mathfrak{b}'}\!\circledast_{\mathfrak{b}'}\! \text{ }\!\!_{\mathfrak{b}'}y_{\mathfrak{b}''}\bigr)
    \ar[r]^-{a_{b,x_{\mathfrak{b}'},\text{ }\!\!_{\mathfrak{b}'}y_{\mathfrak{b}''}}}_-{\cong}
...
\begin{equation*}
  \xymatrix@R=13pt@C=70pt{
    z\!\circledast\! \bigl(x_{\mathfrak{b}'}\!\circledast_{\mathfrak{b}'}\! \text{ }\!\!_{\mathfrak{b}'}y_{\mathfrak{b}''}\bigr)
    \ar@{->>}[d]_-{\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}x_{\mathfrak{b}}\text{ }\!\!\!\!\!_{\text{ }^{\pr}}\circledast_{\mathfrak{b}}\text{ }\!\!\!\!\!_{\text{ }^{\pr}}\text{ }\!\!_{\mathfrak{b}}\text{ }\!\!\!\!\!_{\text{ }^{\pr}}y_{\mathfrak{b}}\text{ }\!\!\!\!\!_{\text{ }^{\pr\pr}}}}
    ...
    \ar@{->>}[d]^-{\mathit{coeq}_{z_{\mathfrak{b}},\text{ }\!\!_{\mathfrak{b}}x_{\mathfrak{b}}\text{ }\!\!\!\!\!_{\text{ }^{\pr}}}\circledast_{\mathfrak{b}'}\I_{\text{ }\!\!_{\mathfrak{b}'}y_{\mathfrak{b}''}}}
...
\begin{proof thm Intro CosMorita}
  ...
  there exist a pair of $\mathlcal{C}$-enriched functors
  ...
  preserving weighted coequalizers and tensored objects,
...
The authors are grateful to an anonymous reviewer for his/her comments, suggestions and careful reading of our paper.
This paper is supported by Basic Science Research Institute Fund, whose NRF grant number is 2021R1A6A1A10042944.
