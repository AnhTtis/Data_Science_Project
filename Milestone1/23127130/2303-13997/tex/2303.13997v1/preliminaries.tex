...
average power consumption 1,029\,$\mu$W, while the quantized weight value -2 has only
539\,$\mu$W.  \textit{According to this observation, by restricting neural
...
\begin{figure}[t]
  ...
  \begin{minipage}[c]{0.45\linewidth}
    ...
    \includegraphics[width=1\linewidth]{Fig/power_analysis_result.pdf}
