...
\author{
    ...
    Written by AAAI Press Staff\textsuperscript{\rm 1,2,3,4}\thanks{With help from the AAAI Publications Committee.}\\
...
\author {
    ...
    Second Author Name\thanks, \textsuperscript{\rm 1,2,3,4}
...
\affiliations{
    ...
    \textsuperscript{\rm 4}zhanglinhao20@mails.ucas.ac.cn, jinlimails@gmail.com\\
