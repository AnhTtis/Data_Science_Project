...
Liu et al. \cite{hybrid_top_down} extend this idea for object classification and use a feedback loop from the ANN to the input to the SNN.
...
Recently, human pose estimation with event cameras has gained traction due to their inherent ability to filter out temporally redundant information like the background~\cite {eventcap, eventhpe, dhp19, tore_volume, lifting_monocular_events}. These works adopt one of two main approaches.
...
Our approach benefits from the high accuracy of ANNs and low power consumption of SNNs to improve the accuracy to power consumption tradeoff.
