...
Autophoretic particles \cite{bechinger2016_active,moran2019_microswimmers,zhang2021_chemically-powered,zottl2023_modeling} and, particularly, their experimental realisation by active droplets \cite{maass2016_swimming,babu2022_motile,birrer2022_we,dwivedi2022_selfpropelled,michelin2023_selfpropulsion,hanczyc2007_fatty,thutupalli2011_swarming,peddireddy2012_solubilization,izri2014_self-propulsion,herminghaus2014_interfacial} 
...
On heating, physical intuition suggests that motion should accelerate and destabilise, either by the increase of translational and rotational diffusion with decreasing viscosity, or by increased activity from the molecular thermodynamics driving the motion. %FIG S5
...
The swimming medium is Newtonian, with mixed micelles forming above $T_\text{CMC}\approx\SI{21}{\celsius}$ and only weakly temperature dependent viscosity (see rheology, light scattering, and calorimetry data in SI).%and we have quantified the mixed micelle formation using dynamic light scattering and calorimetry (see SI).
\par
