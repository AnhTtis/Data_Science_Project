...
In-domain (``D") means the model had access to the dataset during training (for \cite{brooks2022hallucinating}) or finetuning (for \Ours{}). \textbf{Bold} and \underline{underlined} indicate best and next best numbers. \vspace{0cm}}
