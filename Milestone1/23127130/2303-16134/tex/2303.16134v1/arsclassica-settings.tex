...
% Personal commands
% ******************************************************************** 
\newcommand{\myName}{Minas Karamanis}
\newcommand{\myTitle}{Bayesian Computation in Astronomy}
\newcommand{\mySubTitle}{Novel methods for parallel and gradient--free inference}
\newcommand{\myUniversity}{Doctor of Philosophy\\The University of Edinburgh\\July 2022}
...
% Bibliography
% ******************************************************************** 
\bibliography{Bibliography, Ess_Bibliography, Zeus_Bibliography, PMC_Bibliography, PocoMC_Bibliography}
