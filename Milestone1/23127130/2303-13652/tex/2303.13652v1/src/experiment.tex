...
IH2.6M~\cite{moon2020interhand2} and the whole-body version of MSOCO~\cite{lin2014microsoft,jin2020whole} are used for the training.
...
Additionally, we report errors on IH2.6M as it is one of the representative datasets for the 3D interacting hand mesh recovery although it is a MoCap dataset.
