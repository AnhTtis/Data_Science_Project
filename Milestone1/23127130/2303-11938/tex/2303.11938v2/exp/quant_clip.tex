...
%   {Method} & $\uparrow$ ID \\
  %
  \midrule
  Ours (w/ $f_\theta$) & {0.337} & {0.291} &  18.4 s\\
  Optimization~\cite{Karras2019stylegan2} & {0.358} & {0.343} & 55.5 s\\
  \midrule
  DreamFusion~\cite{poole2022dreamfusion} & \multicolumn{2}{c|}{0.271} & 90 mins\\
  Magic3D~\cite{lin2022magic3d} & \multicolumn{2}{c|}{0.285} & 40 mins\\
  \midrule
  %
