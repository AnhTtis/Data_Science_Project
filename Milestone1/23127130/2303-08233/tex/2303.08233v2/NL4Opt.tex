...
\input{pages/1-Introduction.tex}
\input{pages/2-Competition.tex}
\input{pages/3-Dataset.tex}
\input{pages/4-Solutions.tex}
\input{pages/5-Winning.tex}
\input{pages/6-Discussion.tex}
\input{pages/7-Conclusion.tex}
