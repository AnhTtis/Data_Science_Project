...
\begin{itemize}
    ...
    \item We delve deeper into self-supervised learning within our framework, extending its application to 3D reconstruction through the representation of the signed distance function.
