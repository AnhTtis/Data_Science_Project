...
\def\paperID{245} % *** Enter the Paper ID here
\def\confName{3DV\xspace}
\def\confYear{2024\xspace}

%%%%%%%%% TITLE - PLEASE UPDATE
% \title{Unifying depth, 3D occupancy, and 3D reconstruction within a simple framework in autonomous driving}
\title{A Simple Framework for 3D Occupancy Estimation in Autonomous Driving}
