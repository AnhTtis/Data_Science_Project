...
While this result might seem to contradict the result from Subsection \ref{a.traininglonger}, the two findings are in fact consistent. The key assumption is that the snapshotting frequency $f$ is high enough for the chips to contain at least one logged snapshot per period $\monitoringperiod$ with high probability.
