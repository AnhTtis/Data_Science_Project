...
\begin{figure}[h]
    \includegraphics[width=1\linewidth]{fesineu.eps}
		\caption{\label{structure} Cubic $B$20 crystal structure for FeSi, blue spheres are Fe, grey spheres are Si (lattice parameter $a \sim 4.48$\,\AA ).}
\end{figure}
...
From the x-ray analysis we obtain the evolution of the cubic lattice parameter as function of alloying (Fig. \ref{lattice}). Surprisingly, the data do not simply follow Vegard's law. With the lattice parameter of FeSi, $a = 4.48411(34)$\,\AA , significantly larger than that of CoSi, $a = 4.44225(50)$\,\AA, a (close to) linear shrinking of the lattice parameter would be expected with Co doping \cite{Wu2019}. Instead, in the low-doping regime we observe a shallow minimum of the lattice parameter. So far, this anomaly has been overlooked, as this alloying range has not been considered in detail in x-ray analysis (see for instance Refs. \cite{Manyala2000,Manyala2004}). The second main free structural parameter in the $B20$ structure, the $x,y,z$ position of (Fe/Co) and Si, exhibits a smooth increase from ($x = 0$) $\sim 0.137$ to ($x = 1$) $\sim 0.144$ (experimental error $\sim 0.002$).

\begin{figure}[h]
    \includegraphics[width=1\linewidth]{xray_Gitterparameter.eps}
...
%	\begin{table}
%	\caption{\label{fesi} Lattice parameters in the $B$20 structure, positional parameters, displacement parameters and refinement factors of Fe$_{1-x}$Co$_x$Si as function of Co content $x$, derived from room temperature powder x-ray diffraction.}
%	\begin{center}
%			\begin{tabular}{c|c|c|c|c}
%			$x$ & $a$ (\AA ) & Fe & Si & $R_{Bragg}$ (\% ) \\ \hline
%			0 & 4.4845(2) & 0.138(1) & 0.842(1) & 6.92 \\
%			0.01 & 4.4789(3) & 0.138(1) & 0.844(1) & 3.72  \\
%			0.02 & 4.4785(3) & 0.140(1) & 0.848(2) & 5.32  \\
%			0.03 &  & x & x & x  \\	
%			0.04 & 4.4819(6) & 0.140(1) & 0.847(1) & 5.62  \\
%			0.05 & 4.4837(4) & 0.139(1) & 0.842(1) & 9.48  \\
%			\end{tabular}
%	\end{center}		
%	\end{table}
...
\begin{figure}[h]
    \includegraphics[width=1\linewidth]{Suszeptibilitaet_neu.eps}
...
\begin{figure}[h]
    \includegraphics[width=1\linewidth]{5_Heisen_Inoue.eps}
...
\bibitem{Schlesinger1993} Z. Schlesinger, Z. Fisk, H.-T. Zhang, M. B. Maple, J. DiTusa, and G. Aeppli, Phys. Rev. Lett. {\bf 71}, 1748 (1993).
...
\bibitem{supplement} In the Supplement we summarize ...
...
\bibitem{Mattheiss1993} L. F. Mattheis, and D. R. Hamann, Phys. Rev. B {\bf 47}, 13114 (1993).
\bibitem{Anisimov1996} V. I. Anisimov, S. Yu Ezhov, I. S. Elfimov, I. V. Solovyev, and T. M. Rice, Phys. Rev. Lett. {\bf 76}, 1735 (1997).
