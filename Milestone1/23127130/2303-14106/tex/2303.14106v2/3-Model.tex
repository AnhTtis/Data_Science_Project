...
We start with definitions of signal values and production rules in our context. 
...
Examples for non-binary values are glitches, oscillations, and metastable values.
...
Further, as already demanded in the last bullet above, the guards of these opposing production rules will not both evaluate to true for any choice of signal values; if not, the pull-up and pull-down stacks of this gate will drive the gate's output at the same time.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.2\columnwidth]{figs/trace-inv.pdf}
    ~
    \includegraphics[width=0.2\columnwidth]{figs/trace-inv-glitch.pdf}
    ~
    \includegraphics[width=0.2\columnwidth]{figs/trace-inv-glitch-prop.pdf}
