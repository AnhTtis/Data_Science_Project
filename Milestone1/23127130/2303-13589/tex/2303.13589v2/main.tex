...
\title{On the Efficacy of Generalization Error Prediction Scoring Functions}
...
\input{020prelim_v2.tex}

\section{A Closer Look at Scoring Functions}
\label{sec:method}
\input{030methodology_v2}
\input{simplicity_bias_table}
\section{Effect of Simplicity Bias on GEPs}
\input{040_simplicitybias}
\label{sec:simp_bias}
\vspace{-0.2pt}
\section{Conclusion}
\label{sec:concl}
\input{050_conclusions}
