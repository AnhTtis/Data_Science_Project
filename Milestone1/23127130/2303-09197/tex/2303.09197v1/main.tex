...
\title{Temporality and Causality in Abstract Argumentation}
...
\begin{document}
    ...
    %%%%%%%                     INTRODUCTION                  %%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \input{0.2_introduction}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%     PARTIE : Système d'argumentation abstrait     %%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \input{1_Argumentation_Framework}
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%          PARTIE : Action language semantics     %%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \input{2_Action_Language}
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%               PARTIE : Transformation             %%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \input{3_Transformation}
...
Universit\'e and SCAI).
    ...
    %%%%%%%                   BIBLIOGRAPHIE                   %%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \input{0.4_bibliographie}
    

    % \begin{proposition}\label{prop:max_admiss_state}
    %     Given~${AF=(A,R)}$ and its associated~$S_{farg}^\chi(t)$, then $\left\{x\in AF, acc_x\in S_{farg}^\chi(t)\right\}$ is the maximal admissible set of $A$.
    % \end{proposition}
