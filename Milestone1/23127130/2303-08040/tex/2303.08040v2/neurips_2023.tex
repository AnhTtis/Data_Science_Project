...
We propose a new formalization for equal treatment by (i) considering the influence of feature values on predictions, such as computed by Shapley values explaining classifications, 
...
\appendix
\tableofcontents
\input{content/AppendixFoundations}
\input{content/AppendixShap}
