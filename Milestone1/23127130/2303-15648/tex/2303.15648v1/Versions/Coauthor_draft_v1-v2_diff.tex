...
%DIF ADD Coauthor_draft_v2.tex   Mon Jan  9 15:53:43 2023
%
...
, along with data from }\textit{\DIFadd{Swift}}\DIFadd{/XRT.
        ...
        \DIFadd{We reduced }\textit{\DIFadd{Swift}}\DIFadd{/XRT data and extracted a light curve in the 0.3-10 keV band for J1803 using HEASOFT (v6.29) and UK }\textit{\DIFadd{Swift}} \DIFadd{Science Data Centre online platform}\footnote{\DIFadd{https://www.swift.ac.uk/user\_objects/}} \DIFadd{\mbox{%DIFAUXCMD
...
. At the beginning of an outburst, usually type-C QPOs are present, which eventually disappear and are often replaced by type-B QPOs, which are thought to be related to the ejection of transient jet material \mbox{%DIFAUXCMD
...
which causes the higher frequencies to decay quicker) to the predict the ALMA flux density at the time of the VLBA epoch C observation. This revealed an approximately flat spectral index at the time of epoch C, which indicates that we likely captured close to the peak of the flux density of the component in our VLBA images. 
            ...
            \DIFadd{Figure~\ref{fig:Combined Images} shows a small discrepancy between the position of component C from the imaging and the modelling. We suggest that this is likely caused by a faint, extended, and asymmetric region of flux density that is }\DIFaddend resolved out in \DIFdelbegin \DIFdel{this epoch}\DIFdelend \DIFaddbegin \DIFadd{the imaging by is detected by our modelling. Another possibility is that the phase calibration in this epoch was poor due to the low elevation of the source. This would most affect the long baselines, which were suppressed in our imaging by the $uv$-taper, but were not excluded from our modelling}\DIFaddend . By epoch D, \DIFdelbegin \DIFdel{this jet }\DIFdelend \DIFaddbegin \DIFadd{the jet seen in epoch C }\DIFaddend had expanded and become almost completely resolved out, with only a small amount of emission being detected by that innermost baseline. We were unable to detect jets in any subsequent epochs, despite the ATCA light curves showing that the system was well above our VLBA detection threshold for the entire duration of the May/June monitoring campaign. This suggests that the emission was resolved out in our \DIFaddbegin \DIFadd{VLBA }\DIFaddend observations due to this expansion. While we know that the jets were expanding, we were unable to fit models that explicitly parameterised this expansion within each of the VLBA observations, likely due to the low signal-to-noise ratio and sparse $uv$-coverage of the observations. 
            ...
            Jet opening angles have only been constrained for a small number of black hole X-ray binaries \DIFdelbegin \DIFdel{, with only four measurements that are not upper limits \mbox{%DIFAUXCMD
...
}\DIFdelend \DIFaddbegin \DIFadd{In MAXI J535-571, \mbox{%DIFAUXCMD
\citep{Russell2020rapid} }\hspace{0pt}%DIFAUXCMD
}\DIFaddend observed the quenching of \DIFdelbegin \DIFdel{the compact jet in }\DIFdelend \DIFaddbegin \DIFadd{a compact radio jet close in time to the launching of a transient jet. The quenching began $\sim1$ day before it was detectable in the radio band. Due to poor constraints on the transient jet ejection date, the comparison of the timing of the jet quenching and the jet ejection was limited. \mbox{%DIFAUXCMD
\citet{Bright2020AnJ1820+070} }\hspace{0pt}%DIFAUXCMD
observed the fading of the 15\,GHz radio flux density of }\DIFaddend MAXI J1820+070 prior to a bright radio flare and the ejection of transient jets. \DIFaddbegin \DIFadd{This decrease in flux density may attributed to the quenching of the compact jet prior to the ejection, although this is impossible to tell without simultaneous multi-wavelength observations. }\DIFaddend Following the ejection of component B, the compact radio core was quenched for the remainder of the intermediate state and into the soft state. We were unable to detect the reestablishment of the radio core in our VLBA observations. 
...
\DIFaddbegin \section{\DIFadd{ATCA Measurements}}\label{sec:ATCA Data}
