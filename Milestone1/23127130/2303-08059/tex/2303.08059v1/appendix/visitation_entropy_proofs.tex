...
For any $\delta \in (0,1)$ and for the following choices of functions $\gamma,$
\begin{align*}
...
\begin{proof}
    ...
    \[
        \varepsilon T \leq 18 \frac{(SAT)^{1/3}}{1/3} \sqrt{ H^4 S^2 AT \log(4SAH/\delta) \frac{(\rme T)^{1/18}}{1/18} \frac{T^{1/18}}{1/18} } + HSA \frac{(2\rme T)^{8/9}}{8/9} \leq T^{8/9} \left( 1010 \sqrt{H^4 S^2 A^2 \log(2SAH/\delta)} \right),
    \]
