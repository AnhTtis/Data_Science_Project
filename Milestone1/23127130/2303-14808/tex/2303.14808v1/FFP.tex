...
\begin{document}
	\onehalfspacing
	\title[Phase transition]{A Phase transition in zero count probability for Stationary Gaussian Processes}



\author[Naomi Dvora Feldheim]{Naomi Dvora Feldheim}
 \address{Naomi Dvora Feldheim \hfill\break
Department of Mathematics, Bar-Ilan University}
\email{naomi.feldheim@biu.ac.il}


\author[Ohad Noy Feldheim]{Ohad Noy Feldheim}
...
\email{ohad.feldheim@mail.huji.ac.il}
    ...
    \author[Lakshmi Priya {M.E.}]{Lakshmi Priya M.E.}
