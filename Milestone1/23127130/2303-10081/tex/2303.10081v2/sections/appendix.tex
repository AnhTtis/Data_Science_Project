...
\underbrace{\bmat{ccc}
w_1 & \cdots & w_{m'}
\emat}_{:=W \in \Real{m \times m'}} \zeta^\star = \kscedit{L_g b(x,\theta)\tran},
\eea 
...
\eea
It remains to show $\zeta^\star$ is bounded. Similar to \kscedit{Appendix}~\ref{app:bound:y:cleanvdp}, the KKT conditions tell us either $\zeta^\star = 0$ or 
\bea  
