...
\fancyhead[R]{\includegraphics{format/MMlogoDK_left}}
...
\tikzstyle{terminator} = [black, rectangle, draw, text centered, rounded corners, minimum height=2em]
\tikzstyle{process} = [black, rectangle, draw, text centered, minimum height=2em]
\tikzstyle{decision} = [black, diamond, draw, text centered, minimum height=2em]
\tikzstyle{connector} = [black, draw, -latex']
\tikzstyle{data}=[black, trapezium, draw, text centered, trapezium left angle=80, trapezium right angle=100, minimum height=2em]
