...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{figures/unicycle_SampleTraj_big.pdf}
    \caption{Sample plans for 30 robots with 2nd-order unicycle dynamics under both motion and sensing uncertainties. Ellipses are $95\%$ safety contours.}
