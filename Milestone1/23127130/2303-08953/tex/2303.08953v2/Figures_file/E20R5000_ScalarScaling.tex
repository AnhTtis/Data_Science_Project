...
\caption{E50R2000 matrix with scalar scaling. The top sub-figure shows the relative residual and LOO errors of GMRES and adaptive $s$-step GMRES using different polynomial bases in the MPK. The lower sub-figure shows the adapted step size $s$.}
