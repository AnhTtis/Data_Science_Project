...
\acmJournal{PACMHCI}
\acmYear{2023} \acmVolume{7} \acmNumber{CSCW2} \acmArticle{270} \acmMonth{10} \acmPrice{}\acmDOI{10.1145/3610061}
...
% \acmConference[CSCW '23]{Proceedings of the ACM on Human-Computer Interaction}{October 14-18, 2023}{Minneapolis, MN}
...
\renewcommand{\shortauthors}{K. J. Kevin Feng et al.}
