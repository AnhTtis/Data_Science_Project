...
\paragraph{Small capacity gap setting.}
We ablate the importance of the repulsive force in the low-capacity gap setting, whereby we observe a much smaller performance improvement (table \ref{table:repulsive_force}). This observation is likely attributed to the teacher no longer providing any sufficiently more discriminative representations to aid in the knowledge distillation process.
