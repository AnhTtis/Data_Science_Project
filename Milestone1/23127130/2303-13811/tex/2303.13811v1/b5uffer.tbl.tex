...
~~$n$ & &mes & \ti{pqe} & \ti{pqe} & \ti{pqe}$^+$    &   \ti{pqe}  &   \ti{pqe}   &   \ti{pqe}$^+$     &    \ti{pqe}      &  \ti{pqe}         &   \ti{pqe}$^+$            &    \ti{pqe}      &       \ti{pqe}   &  \ti{pqe}$^+$            \\ \hline
 ~~8    & ~300      &~ 5  &  1,236  &  311    & ~\tb{8}   &~2\%  & \tb{37\%} & 33\% &no &\tb{yes}&\tb{yes}&12,141&2,138  &\tb{52} \\ \hline
  ~~8    & ~300      &~ 10  & ~560   & 737     &~\tb{39}  &~2\%  & 1\% & \tb{4\%}  &\tb{yes} &\tb{yes}&\tb{yes}&5,551&7,681    &\tb{380}         \\ \hline
  ~~16    & ~560      &~ 5  & 2,288   & 2,288  &~\tb{17}   &~1\% & 66\% & \tb{69\%}  &no &no&\tb{yes}& 22,612    & 9,506    &\tb{57}        \\ \hline
  ~~16   & ~560      &~ 10  & 653 &  2,288   &~\tb{24} &~1\%  & 36\% & \tb{39\%}  &\tb{yes} &no&\tb{yes}&6,541  &16,554&\tb{152}      \\ \hline  
\end{tabular}                
%\end{center}
\vspace{5pt}
\label{tbl:buff}
