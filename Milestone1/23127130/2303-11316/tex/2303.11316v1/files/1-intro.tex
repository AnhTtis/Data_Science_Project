...
%
This enables the use of a pretrained latent posterior distribution (\eg\ VQVAE~\cite{ramesh2021zero}) of existing generative models.
%
...
To achieve this, we introduce an fixed pre-trained VQVAE~\cite{ramesh2021zero} and a couple of lightweight transformation modules, which can be trained with minimal cost, or they can be manually set up without requiring any additional training. 
