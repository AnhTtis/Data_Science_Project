...
\def\tCinv{\tilde{C}_{\textup{inv}}}
\newcommand{\CHonethree}{C_{H^1 \hookrightarrow L^3}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%    Letters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\ueps}{u^{\varepsilon}}
\newcommand{\uteps}{u_t^{\varepsilon}}
\newcommand{\utteps}{u_{tt}^{\varepsilon}}
...
\newcommand{\revisedd}[2]{#2}
\newcommand{\reviseV}[1]{\color{black} #1}