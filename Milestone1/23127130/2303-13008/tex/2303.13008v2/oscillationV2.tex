...
\begin{equation}
\tilde{N}=\ln \frac{a_f H_f}{a_i H_i}=\ln \left(  a_f H_f \times   \frac{\left[ 1+\tanh^2 \left( \frac{\phi_i}{2F} \right) \right]^{2/3}}{\tanh^{1/3} \left( \frac{\phi_i}{2F} \right)} \right)<0.088,   
\end{equation}
where $a_f H_f =0.688$ can be obtained from Eq.~(\ref{pf}). 
