...
Our work does not explicitly constrain the sampled grasps to the object's geometry. Nevertheless, we do draw inspiration from these as we select bins that constrain the generated grasp directions to lie in the plane normal to the largest \ac{pc} and along the second largest \ac{pc} of the observed \pc{}.
