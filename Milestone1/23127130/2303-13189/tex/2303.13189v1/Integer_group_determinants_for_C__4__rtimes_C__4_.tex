...
\begin{align*}
{\rm C}_{4} \rtimes {\rm C}_{4} := \langle g_{1}, g_{2} \mid g_{1}^{4} = g_{2}^{4} = e, \: g_{2} g_{1} = g_{1}^{3} g_{2} \rangle = \{ g_{1}^{r} g_{2}^{s} \mid 0 \leq r, s \leq 3 \}. 
\end{align*}
...
For any $g = g_{1}^{r} g_{2}^{s} \in G \: (0 \leq r, s \leq 3)$, 
we denote the variable $z_{g}$ by $z_{j}$, where $j := r + 4 s$, 
and let 
$$
...
where 
\begin{align*}
\varphi_{k}(g_{1}) := \sqrt{- 1}^{k}, \quad \varphi_{k}(g_{2}) := (- 1)^{[ \frac{k}{4} ]} 
\end{align*}
for any $0 \leq k \leq 7$ and 
\begin{align*}
\varphi_{k}(g_{1}) := \sqrt{- 1}^{k} \begin{pmatrix} 1 & 0 \\ 0 & - 1 \end{pmatrix}, \quad
\varphi_{k}(g_{2}) := (- 1)^{k} \begin{pmatrix} 0 & - 1 \\ 1 & 0 \end{pmatrix} 
\end{align*}
...
\end{align*}
where $M_{k} := \sum_{0 \leq r \leq 3} \sum_{0 \leq s \leq 3} \varphi_{k}(g_{1}^{r} g_{2}^{s}) z_{r + 4 s}$. 
...
&= \prod_{k = 0}^{7} M_{k} \\ 
&= \prod_{k = 0}^{7} \sum_{r = 0}^{3} \sum_{s = 0}^{3} \sqrt{- 1}^{k r} (- 1)^{[\frac{k}{4}] s} z_{r + 4 s} \\ 
&= \prod_{k = 0}^{7} \sum_{r = 0}^{3} \sum_{s = 0}^{1} \sqrt{- 1}^{k r} (- 1)^{[\frac{k}{4}] s} (z_{r + 4 s} + z_{r + 4 (s + 2)}) \\
&= \prod_{k = 0}^{7} \sum_{r = 0}^{3} \sum_{s = 0}^{1} \chi_{k}( (\overline{r}, \overline{s}) ) (z_{r + 4 s} + z_{r + 4 s + 8}) \\ 
&= D_{4 \times 2}(z_{0} + z_{8}, z_{1} + z_{9}, \ldots, z_{7} + z_{15}). 
\end{align*}
Also, for any $8 \leq k \leq 9$, we have 
\begin{align*}
M_{k} 
&= \sum_{r = 0}^{3} \sum_{s = 0}^{3} \sqrt{- 1}^{k r} (- 1)^{k s} z_{r + 4 s} 
\begin{pmatrix} 1 & 0 \\ 0 & - 1 \end{pmatrix}^{r} \begin{pmatrix} 0 & - 1 \\ 1 & 0 \end{pmatrix}^{s} \\ 
%&= \sum_{0 \leq r \leq 3} \sum_{0 \leq s \leq 1} \sqrt{- 1}^{k r} \begin{pmatrix} 1 & 0 \\ 0 & - 1 \end{pmatrix}^{r} 
%\left\{ (- 1)^{k s} z_{r + 4 s} \begin{pmatrix} 0 & - 1 \\ 1 & 0 \end{pmatrix}^{s} + (- 1)^{k (s + 2)} z_{r + 4 (s + 2)} \begin{pmatrix} 0 & - 1 \\ 1 & 0 \end{pmatrix}^{s + 2} \right\} \\ 
&= \sum_{r = 0}^{3} \sum_{s = 0}^{1} \sqrt{- 1}^{k r} (- 1)^{k s} (z_{r + 4 s} - z_{r + 4 s + 8}) \begin{pmatrix} 1 & 0 \\ 0 & - 1 \end{pmatrix}^{r} \begin{pmatrix} 0 & - 1 \\ 1 & 0 \end{pmatrix}^{s} \\ 
&= \sum_{r = 0}^{3} \left\{ \sqrt{- 1}^{k r} (z_{r} - z_{r + 8}) \begin{pmatrix} 1 & 0 \\ 0 & (- 1)^{r} \end{pmatrix} + \sqrt{- 1}^{k r} (- 1)^{k} (z_{r + 4} - z_{r + 12}) \begin{pmatrix} 0 & - 1 \\ (- 1)^{r} & 0 \end{pmatrix} \right\} \\ 
&= 
\begin{pmatrix} 
\sum_{r = 0}^{3} \sqrt{- 1}^{k r} \tilde{z}_{r} & \sum_{r = 0}^{3} (- 1)^{k + 1} \sqrt{- 1}^{k r} \tilde{z}_{r + 4} \\ 
\sum_{r = 0}^{3} (- 1)^{k + r} \sqrt{- 1}^{k r} \tilde{z}_{r + 4} & \sum_{r = 0}^{3} (- 1)^{r} \sqrt{- 1}^{k r} \tilde{z}_{r} 
\end{pmatrix}, 
\end{align*}
where $\tilde{z}_{r} := z_{r} - z_{r + 8}$ for $0 \leq r \leq 7$. 
Therefore, 
\begin{align*}
\det{M_{k}} 
&= \sum_{r = 0}^{3} \sqrt{- 1}^{k r} \tilde{z}_{r} \sum_{s = 0}^{3} (- 1)^{s} \sqrt{- 1}^{k s} \tilde{z}_{s} + \sum_{r = 0}^{3} \sqrt{- 1}^{k r} \tilde{z}_{r + 4} \sum_{s = 0}^{3} (- 1)^{s} \sqrt{- 1}^{k s} \tilde{z}_{s + 4} \\ 
