...
Intelligence is a multifaceted and elusive concept that has long challenged psychologists, philosophers, and computer scientists. Three decades ago, a group of psychologists attempted to capture the essence of intelligence by proposing to define it as a {\em very general mental capability that, among other things, involves the ability to reason, plan, solve problems, think abstractly, comprehend complex ideas, learn quickly and learn from experience}.\footnote{We use this definition for its simplicity and for being agreed upon by a large group of experts. However, this definition was published in an editorial containing claims that we disavow. We do not cite the editorial, and refer to \cite{Gillborn} for a thorough rebuttal.}
...
Building an artificial system that exhibits the kind of general intelligence captured by the above definition is a long-standing and ambitious goal of AI research.
...
In this paper, we report on evidence that a new LLM developed by OpenAI, which is an early and \textbf{non-multimodal} version of \DV\ \cite{gpt4}, exhibits many traits of intelligence, according to the definition above. 
