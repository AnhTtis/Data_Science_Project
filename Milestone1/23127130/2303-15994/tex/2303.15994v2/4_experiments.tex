...
%     \begin{tabular}{l|cc}
%     \hline
%         Method & All & Rare Relations\\ \hline
%         PSGTR & 22.1 & 6.2 \\
%         HiLo (ours) & 33.1 (\textcolor{darkgreen}{+11.0}) & 20.3 (\textcolor{darkgreen}{+14.1}) \\ \hline
%     \end{tabular}
%     % }
%     \vspace{+1mm}
%     \caption{Verification of the improvements in the long-tail problem.}
%     \vspace{-4mm}
%     \label{table:verify}
% \end{table}
...
%     \begin{tabular}{l|cc}
%     \hline
%         Method & All & Relational Semantic Overlap \\ \hline
%         PSGTR & 22.1 & 23.5 \\
%         HiLo (ours) & 33.1 (\textcolor{darkgreen}{+11.0}) & 38.8 (\textcolor{darkgreen}{+15.3}) \\ \hline
%     \end{tabular}
%     % }
%     \vspace{+1mm}
%     \caption{Verification of the improvements in relational semantic overlap.}
%     \vspace{-4mm}
%     \label{table:verify}
% \end{table}
...
% \noindent \textbf{Time cost for relation augmentation and swapping.}
...
Given the same input sizes $(1280, 800)$ and ResNet-50 as backbone, the resource usage is shown in Tab. \ref{table:resource}.
