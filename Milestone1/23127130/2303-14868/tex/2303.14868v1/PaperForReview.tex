...
\def\cvprPaperID{8237} % *** Enter the CVPR Paper ID here
\def\confName{CVPR}
\def\confYear{2023}
...
%%%%%%%%% TITLE - PLEASE UPDATE
\title{The Resource Problem of Using Linear Layer Leakage Attack in Federated Learning}
% \title{The Practical Problems with Linear Layer Leakage for Large Scale Data Reconstruction in Federated Learning}

\author{Joshua C. Zhao$^1$, Ahmed Roushdy Elkordy$^2$, Atul Sharma$^1$, Yahya H. Ezzeldin$^2$ \\Salman Avestimehr$^2$, Saurabh Bagchi$^1$\\
...
\input{2_related}
\vspace{-5 pt}
\section{Decreasing the resource cost}
\label{sec:methodology}
\input{3_methodology}
\vspace{-5 pt}
\section{Experiments}
\label{sec:expeirments}
\input{4_experiments}
\vspace{-15 pt}

\iffalse
\section{Application to FedAVG}
\label{sec:additional_discussions}
\input{5_additional_discussions}
\fi
