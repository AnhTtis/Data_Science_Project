% Time-stamp: <2023-03-23 11:48:40 sglass>
%%--{G}

\documentclass[12pt,twoside]{article}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% A4 = 210 x 297 mm      1in=25.4mm   297-2*25.4=246.2 mag=82%
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\usepackage[pagewise,mathrefs]{lineno}

\usepackage[xetex,a4paper,hmargin={1.0in,1.0in},top=1.0in,bottom=1.0in]{geometry}
\usepackage{setspace} 
%\setstretch{1.3} % instead of \setstretch{1.25}=onehalfspacing
%\onehalfspacing
\setstretch{1.05}
...
%\usepackage{kpfonts}  %!!!
%\usepackage[scale=1.0,p,osf]{cochineal} % instead of \usepackage{newtxtext}\usepackage{textcomp}  
%STIX
%\usepackage{stix}
% some refinements that interfere with page breaking
\widowpenalty=10000
\clubpenalty=10000  

%\usepackage[scale=1.0,varqu,varl,var0]{inconsolata} %\texttt (not used in this paper) %!!!


%%%%%%%%%%%%%%%%%%%%%%
% 
% change here  (preferably not)    
%  
%%%%%%%%%%%%%%%%%%%%%%
\usepackage[scale=1.0,libertine,vvarbb]{newtxmath} %!!! 
%\usepackage[cal=boondox, calscaled=1.0,bb=stix,bbscaled=1.0]{mathalpha} %!!!
\usepackage[cal=boondox, calscaled=1.0]{mathalpha} %!!!
\usepackage{bm}

%\usepackage{libertinust1math} 
%\usepackage[scale=1.0,cochineal,vvarbb]{newtxmath} %instead of \usepackage[vvarbb]{newtxmath}
 
%\usepackage[scr=boondox, scrscaled=1.0,cal=boondoxupr,calscaled=1.0,frak=esstix,frakscaled=1.0,bb=txof,bbscaled=1.0]{mathalfa}
%\usepackage[scr=boondox, scrscaled=1.0, cal=boondoxupr,calscaled=1.0,frak=esstix,frakscaled=1.0]{mathalfa} 
...
\usepackage{marvosym}
%\usepackage{mathrsfs} %% a matter of preference for ℝ
%\usepackage{bbold} %% a matter of preference for ℝ
\usepackage{stmaryrd}


\usepackage{mathtools,amsmath}
%\usepackage{amssymb} % not needed with {newtextmath}  
\usepackage{natbib} 
\usepackage{hypernat}
...
%\usepackage[inner]{showlabels,rotating} 
...
%%%%%%%%%%%%%%%%%%%%%%%
% 
% CHANGES IN THEOREM STYLE –- not needed in this paper
% \makeatletter  
...
% \makeatletter 
%  \newtheoremstyle{mychange}% 
%   {\item[\hskip\labelsep \bf (##2)\ ##1\theorem@separator]}%
%   {\item[\hskip\labelsep \bf (##2){}##1\ ##3:\theorem@separator]}
% \makeatother
%
...
%\renewcommand{\theparagraph}{\bullet\arabic{section}.\arabic{paragraph}}
...
%
% ADJUSTMENT OF MULTIPLICATION, QED, AND SOME FRACTION SYMBOLS
% 
% \def\oneq{{\hbox{\small\fontencoding{TS1}\fontfamily{Cochineal-LF}\selectfont\char188}}}
% \def\twoq{{\hbox{\small\fontencoding{TS1}\fontfamily{Cochineal-LF}\selectfont\char189}}}
% \def\threeq{{\hbox{\small\fontencoding{TS1}\fontfamily{Cochineal-LF}\selectfont\char190}}}

\def\times{\tts{\hbox{\fontencoding{TS1}\fontfamily{Cochineal-LF}\selectfont\char214}}\tts}
%\def\bullet{\tts{\hbox{\fontencoding{TS1}\fontfamily{Cochineal-LF}\selectfont\char136}}\tts}
\def\half{{\frac12}}
%\def\specsymb{{\fontencoding{TS1}\fontfamily{Cochineal-LF}\selectfont\char98}}

\def\qedsymb{{$\bulletS$}}   %!!!!!  
%\def\qedsymb{{$\bullet$}} %STIX  
\def\qed{\ifmmode\nobreak\hbox{\quad\qedsymb}\else\nobreak\relax\nobreak\hbox{\quad\qedsymb}\fi}
%%%%%%%%%%%%%%%%
%\let\leadsto\rightarrow

%\let\swtc\relax 
\let\swtc\small
%\def\SWTC{\onehalfspacing\relax}
...
\theoremstyle{plain}  
%\newtheorem{thm}{Theorem}[section] % not needed
...
\title{%%%%%%%%%%
%On the Transport of a Large Population of Traders
%%
%    Dynamic Transportation Theory for a Population \\ of Interacting Economic Agents
%%
%    Dynamic Transportation Theory and Algorithms \\ for a Large Population of Traders
%%
Dynamic Transportation of Economic Agents%
%%
%and Computation of General Equilibrium 
\thanks{Supersedes the paper ``Another look at the distribution of income and wealth in
the macroeconomy.''}
}%%% 

%\runtitle{Another Look at Some Classical Heterogeneous Agent Models}
...
% DOI: 10.5281 / zenodo.7502056 || https://doi.org/10.5281/zenodo.7502056
%
% 
%  https://ssrn.com/abstract=4315884
%  https://dx.doi.org/10.2139/ssrn.4315884
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\titlespacing*{\section}{0pt}{.75ex plus 0.25ex minus .125ex}{0.55ex  plus 0.125ex minus 0.125ex}

\usepackage{titling}

\setlength{\droptitle}{-6.5em}

%\renewcommand{\abstractname}{\vspace{-2.5cm}}
\renewcommand{\abstractname}{\vspace{-1.5cm}}
%\renewcommand{\abstractname}{\vspace{-0cm}}
\footnotesep=0.75\baselineskip

%%%%%%%%%%%% headers and footers
%\iffalse % change here to turn on and off
...
%\fancyfoot[L]{\copyright$\,$\the\year\ by Andrew Lyasoff}
\fancyfoot[L]{} 
}
\pagestyle{fancy}
%\headheight=15.2pt
...
%\fancyhead[CO]{\small INCOMPLETE MARKET HETEROGENEOUS AGENT MODELS REVISITED}
%\fancyhead[CO]{\small ON THE TRANSPORT OF A LARGE POPULATION OF TRADERS}
\fancyhead[CO]{\small DYNAMIC TRANSPORTATION OF ECONOMIC AGENTS} 
\fancyhead[LE,RO]{\thepage}
\fancyfoot{}
%\fancyfoot[LO,LE]{\ifnum\thepage=1\small\copyright$\,$\the\year\ by Andrew Lyasoff\else\relax\fi}
%\fancyfoot[LO,LE]{\small\copyright$\,$\the\year\ by Andrew Lyasoff}  

%\fi  % change here to turn on and off 

%%%%%%%%%%%%%%%%%%%%% 


% make math numbers same as text
\iffalse
\DeclareSymbolFont{numbers}{T1}{cochineal}{m}{n}
\SetSymbolFont{numbers}{bold}{T1}{cochineal}{bx}{n}
...
\DeclareMathSymbol{0}{0}{letters}{"84}
\DeclareMathSymbol{1}{0}{letters}{"85}
\DeclareMathSymbol{2}{0}{letters}{"86}
\DeclareMathSymbol{3}{0}{letters}{"87}
\DeclareMathSymbol{4}{0}{letters}{"88}
\DeclareMathSymbol{5}{0}{letters}{"89}
\DeclareMathSymbol{6}{0}{letters}{"8A}
\DeclareMathSymbol{7}{0}{letters}{"8B}
\DeclareMathSymbol{8}{0}{letters}{"8C}
\DeclareMathSymbol{9}{0}{letters}{"8D}
%\DeclareMathSymbol{1}{0}{letters}{"85}
%\DeclareMathSymbol{2}{0}{letters}{"86}
%\DeclareMathSymbol{3}{0}{letters}{"87}
...
It is argued that incomplete-market general equilibrium models with
endogenous prices and large number of agents cannot be resolved in the
usual way by solving the private optimal control problems with given prices and then varying the
prices until market clearing is enforced. 
%
...
%
By~mimicking the technique proposed by
\citel{DL12}, the paper develops a new approach to address this problem and
provides a novel description of the
...
to depend continuously on a parameter, when the transition matrix depends on this
...
that
the strategy of identifying the distribution of all households as the running
distribution of a single (however defined) Markov chain and, more broadly,
the strategy for resolving general equilibrium models with
endogenous prices and large number of agents 
by solving the private optimal control problems with given prices and then varying the
prices until market clearing is enforced, may be wanting of an alternative.
Developing such an
