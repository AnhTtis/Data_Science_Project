Consider a game among three friends \playA (A), \playB (B) and \playboss. A and B have $\ngrad$ private numbers $g_1,\dots, g_{\ngrad}$ whose sum should be communicated correctly to \playboss (D). The problem is that one player is trying to cheat on D.
...
\end{enumerate*}
For a more elaborate example in the same spirit see Appendix~\ref{app:biggerexample}.
