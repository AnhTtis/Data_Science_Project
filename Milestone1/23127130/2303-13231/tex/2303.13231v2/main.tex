...
\ARXIVonly{
  ...
  \input{sections/toy_solution}

  \subsection{Symmetrization Attack Table}
  \label{app:large_table}
  \input{sections/large_table}


  \FloatBarrier
  \subsection{General Scheme Description}\label{app:general_case}
  \input{sections/general_case.tex}

  \FloatBarrier
  \subsection{Proof of \cref{thm:converse_T}}\label{app:proof_lower_bound_kappa_rho}
  \input{sections/lower_bound_kappa_rho.tex}


  \FloatBarrier
  \subsection{Proof of \cref{thm:scheme}}
  \label{app:scheme_proof}
  \input{sections/achievability_proof}

  \FloatBarrier
  \subsection{Achievability vs. Converse for $\commoh$}
  \label{app:achievability_vs_converse}
  \input{sections/achievability_vs_converse}
