...
% your contribution title if the original one is too long
\institute{Henning Samtleben \at ENSL, CNRS, Laboratoire de physique, F-69342 Lyon, Institut Universitaire de France (IUF), France, \email{henning.samtleben@ens-lyon.fr}}
%
...
The interest to study supergravity theories in higher dimensions $D>4$, and their dimensional reduction is (at least) twofold. On the one hand supergravity theories appear as the low-energy effective action for string theories, which generically live in higher dimensions. 
...
The associated interacting theory is unique and has been found by Cremmer, Julia, and Scherk~\cite{Cremmer:1978km}.
...
due to its high degree of symmetry and the finiteness properties of its 
higher loop amplitudes~\cite{Bern:2007hh,Bern:2009kd,Arkani-Hamed:2008owk,Green:2010sp,Vanhove:2010nf,Bjornsson:2010wm,Pioline:2015yea,Bern:2018jmv}.
...
a considerable part of the exceptional symmetries has no direct higher-dimensional interpretation and is often referred to as {\em hidden symmetries}.
...
remarkably compact way. For example, the scalar sector of the theory is most concisely described as a non-linear sigma model on the coset space
${\rm E}_{7(7)}/{\rm SU}(8)$.
...
theories, i.e., the global symmetries that descend from particular diffeomorphism and gauge transformations in higher dimensions.
...
\label{susyalg11}
\end{equation} 
where $Q_\alpha$ are the $32$ independent real supercharges in 
eleven-dimensional Minkowski spacetime.
$P_M$ with $M=0, 1, \dots, 10$, is the $D=11$ momentum, and $\Gamma^M$
...
F_{N_1N_2\dots N_7}  
=
-\frac1{24}\,|E|\,\varepsilon_{N_1N_2 \dots N_7M_1M_2M_3M_4} F^{M_1M_2M_3M_4}  +~\mbox{fermions}
\,.
\label{F47}
\end{equation}
...
As a consequence, these equations are often imposed separately, while the
...
$m^{\alpha\beta}=\varepsilon^{\alpha\gamma}\varepsilon^{\beta\delta}m_{\gamma\delta}$, 
...
invariance~\cite{Henneaux:1988gg,Schwarz:1993vs,DallAgata:1997gnw,DallAgata:1998ahf,Hohm:2013vpa,Sen:2015nph,Mkrtchyan:2022xrm}.
%
...
on a torus, first for pure gravity and next for the $p$-forms, which typically span the matter sector of higher-dimensional supergravities.
...
\end{equation}
One may think of a normal mode expansion of the fields and drop all modes other than the zero modes.
...
The ellipsis in (\ref{LL}) represents the matter couplings in the $D$-dimensional theory,
...
For example, for reductions from 11D supergravity,  $\mathfrak{g}_0=\mathfrak{gl}(d)$, whereas 
...
Let us also note that part of the shift symmetries (\ref{shift1}) may arise from the dual higher-dimensional $p$-forms. For example, we have noted in
...
For example,  the $D$-dimensional 3-forms $C_{\mu\nu\rho\, m_1m_2m_3}$, transform as
\begin{equation}
\delta C_{\mu\nu\rho\, m_1m_2m_3} =
 - \frac32\,  C_{\mu\nu\rho}\,\xi_{m_1m_2m_3} 
 \;,
...
\end{split}  
\end{equation} 
with $\gamma$ and $\beta$ from (\ref{gamma}) and (\ref{GL1}),
...
From (\ref{gamma}) and (\ref{GL1}), we find the values $\beta=\frac9{14}$, $\gamma=-\frac17$.
...
For example, the coefficients in (\ref{112}) allowing the symmetry enhancement (\ref{gss}) are precisely the coefficients 
...
The full set of coset spaces is listed in Table~\ref{table:groups}.
...
This is the coset space that already appears in the ten-dimensional IIB supergravity (\ref{cosetIIB})
...
descending from the 11D 3-form. On the other hand, it follows from the discussion of section~\ref{subsec:maximalD9} 
...
\begin{eqnarray}
{\cal V} &\equiv& 
{\rm exp}\left[\varepsilon^{klmnpqr}  A_{klmnpq}\, t_{(+4)\,r}\right]
...
The dual scalar fields encountered in $D>3$ supergravities have all been identified among the components of the 11D dual 6-form.
...
dimensional reduction remains ambiguous.
...
\label{ExFTfieldsE7A}
\end{equation}
in alignment with the field content of $D=4$ maximal supergravity, except for all fields keeping their dependence on the internal coordinates $y^m$.
...
that restrict the dependence of all fields to 7 and 6 coordinates, respectively.
...
I wish to thank all my collaborators and in particular Bernard de Wit, Olaf Hohm, Emanuel Malek, Hermann Nicolai, 
...
\bibitem [{\citenamefont {Arkani-Hamed}\ \emph {et~al.}(2010)\citenamefont
  ...
  {Stop}%
\bibitem [{\citenamefont {Green}\ \emph {et~al.}(2010)\citenamefont {Green},
  \citenamefont {Russo},\ and\ \citenamefont {Vanhove}}]{Green:2010sp}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {M.~B.}\ \bibnamefont
  {Green}}, \bibinfo {author} {\bibfnamefont {J.~G.}\ \bibnamefont {Russo}}, \
  and\ \bibinfo {author} {\bibfnamefont {P.}~\bibnamefont {Vanhove}},\ }\href
  {\doibase 10.1007/JHEP06(2010)075} {\bibfield  {journal} {\bibinfo  {journal}
  {JHEP}\ }\textbf {\bibinfo {volume} {06}},\ \bibinfo {pages} {075} (\bibinfo
  {year} {2010})},\ \Eprint {http://arxiv.org/abs/1002.3805} {arXiv:1002.3805
  } \BibitemShut {Stop}%
\bibitem [{\citenamefont {Vanhove}(2010)}]{Vanhove:2010nf}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {P.}~\bibnamefont
  {Vanhove}},\ }\href@noop {} {\  (\bibinfo {year} {2010})},\ \Eprint
  {http://arxiv.org/abs/1004.1392} {arXiv:1004.1392} \BibitemShut
  {Stop}%
\bibitem [{\citenamefont {Bjornsson}\ and\ \citenamefont
  {Green}(2010)}]{Bjornsson:2010wm}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {J.}~\bibnamefont
  {Bjornsson}}\ and\ \bibinfo {author} {\bibfnamefont {M.~B.}\ \bibnamefont
  {Green}},\ }\href {\doibase 10.1007/JHEP08(2010)132} {\bibfield  {journal}
  {\bibinfo  {journal} {JHEP}\ }\textbf {\bibinfo {volume} {08}},\ \bibinfo
  {pages} {132} (\bibinfo {year} {2010})},\ \Eprint
  {http://arxiv.org/abs/1004.2692} {arXiv:1004.2692} \BibitemShut
  {Stop}%
\bibitem [{\citenamefont {Pioline}(2015)}]{Pioline:2015yea}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {B.}~\bibnamefont
  {Pioline}},\ }\href {\doibase 10.1007/JHEP04(2015)057} {\bibfield  {journal}
  {\bibinfo  {journal} {JHEP}\ }\textbf {\bibinfo {volume} {04}},\ \bibinfo
  {pages} {057} (\bibinfo {year} {2015})},\ \Eprint
  {http://arxiv.org/abs/1502.03377} {arXiv:1502.03377} \BibitemShut
  {Stop}%
...
\bibitem [{\citenamefont {Dall'Agata}\ \emph {et~al.}(1997)\citenamefont
  {Dall'Agata}, \citenamefont {Lechner},\ and\ \citenamefont
  {Sorokin}}]{DallAgata:1997gnw}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {G.}~\bibnamefont
  {Dall'Agata}}, \bibinfo {author} {\bibfnamefont {K.}~\bibnamefont {Lechner}},
  \ and\ \bibinfo {author} {\bibfnamefont {D.~P.}\ \bibnamefont {Sorokin}},\
  }\href {\doibase 10.1088/0264-9381/14/12/003} {\bibfield  {journal} {\bibinfo
   {journal} {Class. Quant. Grav.}\ }\textbf {\bibinfo {volume} {14}},\
  \bibinfo {pages} {L195} (\bibinfo {year} {1997})},\ \Eprint
  {http://arxiv.org/abs/hep-th/9707044} {arXiv:hep-th/9707044} \BibitemShut
  {Stop}%
...
\bibitem [{\citenamefont {Mkrtchyan}\ and\ \citenamefont
  {Valach}(2023)}]{Mkrtchyan:2022xrm}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {K.}~\bibnamefont
  {Mkrtchyan}}\ and\ \bibinfo {author} {\bibfnamefont {F.}~\bibnamefont
  {Valach}},\ }\href {\doibase 10.1103/PhysRevD.107.066027} {\bibfield
  {journal} {\bibinfo  {journal} {Phys. Rev.}\ }\textbf {\bibinfo {volume}
  {D107}},\ \bibinfo {pages} {066027} (\bibinfo {year} {2023})},\ \Eprint
...
\bibitem [{\citenamefont {Neugebauer}\ and\ \citenamefont
  ...
  {\bibinfo  {journal} {Ann. Phys.}\ }\textbf {\bibinfo {volume} {24}},\
...
\bibitem [{\citenamefont {Bouchareb}\ \emph {et~al.}(2007)\citenamefont
  ...
  (\bibinfo {year} {2007})},\ \bibinfo {note} {[Erratum: Phys. Rev. {\bf D78}, 029901
...
\bibitem [{\citenamefont {Compere}\ \emph {et~al.}(2009)\citenamefont
  ...
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {G.}~\bibnamefont
  {Comp\`ere}}, \bibinfo {author} {\bibfnamefont {S.}~\bibnamefont {de~Buyl}},
...
\bibitem [{\citenamefont {de~Wit}\ \emph {et~al.}(2008)\citenamefont {de~Wit},
  ...
  {http://arxiv.org/abs/arXiv:0801.1294} {arXiv:0801.1294}
  \BibitemShut {Stop}%
