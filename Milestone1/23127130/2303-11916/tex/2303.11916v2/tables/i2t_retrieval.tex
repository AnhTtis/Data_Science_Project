...
\end{tabular}
\vspace{.5em}
\caption{\small \textbf{Comparisons of various design choices for handling textual embeddings on cross-modal retrieval results on COCO, CxC and ECCV Caption datasets.} For all metrics, higher is better.}
