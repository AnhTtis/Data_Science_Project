...
\hline
$\V_{1, 3, 3}$ & $2$ & $3^4$ & $1$ & $ 81s_{00}^9+162s_{00}^8s_{01}+351s_{00}^7s_{01}^2+333s_{00}^6s_{01}^3 \cdots  $\\
$\V_{1, 4, 3}$ & $2$ & $2^{16}$ & $20$ & $ s_{001}s_{011}^2-12s_{001}s_{100}^2-16s_{010}s_{100}^2-5s_{011}s_{100}^2 \cdots $\\
$\V_{2, 2, 3}$ & $5$ & $2^7 $ & $1$ & $s_{12}^2+2s_{12}s_{21}+s_{21}^2-4s_{11}s_{22}-2s_{22}t_{11}$\\
& & & & \quad $ -2s_{11}t_{22} -t_{11}t_{22}+2s_{12}t_{12}+2s_{21}t_{12}+t_{12}^2 $\\
$\V_{2, 3, 2}$ & $3$ & $3^{24}$ & $77$ & $u_{212}v_{112}-u_{211}v_{122}-u_{112}v_{122}+u_{111}v_{222}$\\
%$\V_{2, 3, 3}$ & $7$ & $28$ & $...er$ & $ s_{12}^2+2s_{12}s_{21}+s_{21}^2-4s_{11}s_{22}-2s_{22}t_{11} $ \\
 & & & & \quad $-2s_{11}t_{22}-t_{11}t_{22}+2s_{12}t_{12}+2s_{21}t_{12}+t_{12}^2$ \\
$\V_{3, 2, 2}$ & $5$ & $2^{15}$ & $24$ & $t_{23}t_{32}-t_{22}t_{33}, t_{13}t_{32}-t_{12}t_{33}, \cdots $ \\
\hline
\end{tabular}
\end{center}
...
\begin{rem}
We note that the dimension-bound argument presented in the proof above works for any fixed weight, and displays the intuition that given a large enough time series size, a simple dimension argument allows us to construct a solution. 
...
CB is supported by the ERC starting grant ``LoRDeT"; he also acknowledges the support of the TU Berlin, where he was employed when this project was started. RP was supported by the Max Planck Institute for the mathematics in the sciences for part of this project. Both authors would like to thank fruitful conversations with Sylvie Paycha and Bernd Sturmfels. We would also like to thank  \'Angel R\'ios Ortiz, Pierpaola Santarsiero and Nikolas Tapia for all the suggestions and comments on discrete signatures, tensor algebras and algebraic varieties. The authors are thankful for the helpful comments of the reviewers, in particular on noting \cref{rem:power_degree}.
