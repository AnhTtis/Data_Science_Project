...
\includegraphics[width=3.8cm,keepaspectratio]{images/bar-field-vis-1.png}\timestamp{\tsBarFieldVis}
\end{wrapfigure}
...
\cite{BarbicJames:RealTimeSTVK} or sub-structuring \cite{Barbic:2011:RealTimeLargeDefoSubstructuring}.
%
...
\begin{figure}
\includegraphics[width=\linewidth,keepaspectratio]{images/cthulu_local_minimum-1.png}\timestamp{\tsCthuluLocalMinimum}
\caption{
We compute the subspace at rest (top-left). A user rotates the mesh and perturbs the system with a random initial deformation.  Using displacement modes creates jarring local minimum artefacts in a rotated frame. Our skinning modes find the global minimum effortlessly, avoiding costly subspace re-computation or updates. \label{fig:random-init-linear-subspace}}
\end{figure}
...
\begin{figure}[!b]
\includegraphics[width=\linewidth,keepaspectratio]{images/bingby_local_rotation_light-1.png}\timestamp[-0.125cm]{\tsBingbyLocalRotation}
