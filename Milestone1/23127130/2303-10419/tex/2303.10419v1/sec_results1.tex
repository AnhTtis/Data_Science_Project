...
Figure \ref{2D_time_evolution_q25_a100nm} shows the time evolution of (a) density, (b) magnetic resistivity, (c) dust size, and (d) plasma $\beta$ in our fiducial model, ModelA100Q25.
...
At this stage, the total magnetic resistivity ($\eta_O+\eta_A$) is $\sim 10^{19} \etacm$ and relatively large (panel 1-b).
...
However, at this epoch, the decrease in the magnetic diffusion does not lead to a decrease in the disk size; instead, the disk continues to expand. The plasma $\beta$ also remains high.
...
The strong magnetic field amplifies the magnetic resistivity  ($\eta_A$) in the central region (panel 3-b).
...
However, that the density structure of the central region is very similar in panels 3-a and 4-a.
