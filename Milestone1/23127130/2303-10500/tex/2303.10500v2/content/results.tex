...
Due to the novelty of our approach, it is comparable with the state of the art only regarding gas costs. Deployment is on par with, or is better than, the existing solutions. However, the cost of updating the state is significantly higher; ChorChain uses about 92,905 gas on average for each message. Caterpillar requires similar amounts of gas on average. 
