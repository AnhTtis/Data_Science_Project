...
\label{sec:procorch}
Smart contracts, as a rule, cannot be altered after deployment; thus, to minimize the probability of software faults, domain-specific languages and Model-Driven Engineering (MDE) techniques are steadily gaining ground in smart contract development~\cite{model_driven}. In our context, this means that the established approach is a BPMN model to serve as a \textit{specification}, and orchestrator smart contract logic is generated automatically from the model.
