...
\input{content/aproach.tex}

\input{content/BPMN.tex}

\input{content/mapping}

\input{content/protocol}
...
was born in Budapest, Hungary, in 2000. He received  his BSc in computer engineering in 2023 from the Budapest University of Technology and Economics (BME). Currently, he is an MSc student at BME, with a primary specialization in cybersecurity and a secondary specialization in critical systems.
\end{IEEEbiography}
