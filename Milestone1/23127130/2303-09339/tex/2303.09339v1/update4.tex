...
In this paper, we discuss the creation process of \emph{ShabbyPages} and demonstrate the utility of \emph{ShabbyPages} by training convolutional denoisers which remove real noise features with a high degree of human-perceptible fidelity, establishing baseline performance for a new \emph{ShabbyPages} benchmark.
\end{abstract}
...
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth]{figures/shabbyreal_figure1.png}
