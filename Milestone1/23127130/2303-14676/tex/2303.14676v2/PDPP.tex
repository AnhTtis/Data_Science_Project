...
\multicolumn{1}{l}{Ours$_{Base}$}             &      C       &    25.52   &    53.43    &     \color{gray}{56.90}   &   15.40    &   49.42     &    \color{gray}{56.99}    \\
...
\multicolumn{1}{l}{Ours$_{Base}$}            & 25.52 & 15.40 & 9.37 & 6.76 \\
\multicolumn{1}{l}{Ours$_{How}$}            & \textbf{37.20} & \textbf{21.48} & \textbf{13.45} & \textbf{8.41} \\
\hline
\end{tabular}
}
...
\multirow{6}{*}{$T$ = 3} & \multicolumn{1}{l}{Random}          & -    & 2.21   & 4.07   & \color{gray}{6.09}  &   $<$0.01     &    $<$0.01    & \color{gray}{2.47}   \\
                     ...
                     & \multicolumn{1}{l}{P$^3$IV \cite{DBLP:conf/cvpr/0004HDDWJ22}}           & L    & 24.68  & \textbf{49.01}  & \color{gray}{74.29} & 15.4   & 21.67  & \color{gray}{76.31}  \\
                     & \multicolumn{1}{l}{Ours}            & C    & \textbf{30.20}  & 48.45  & \color{gray}{57.28} & \textbf{21.33}  & \textbf{45.62}  & \color{gray}{51.82}  \\ \hline
\multirow{6}{*}{$T$ = 4} & \multicolumn{1}{l}{Random}          & -    & 1.12   & 2.73   & \color{gray}{5.84}  &   $<$0.01     &    $<$0.01    & \color{gray}{2.32}   \\
                     ...
                     & \multicolumn{1}{l}{Ours}            & C    & \textbf{26.67}  & \textbf{46.89}  & \color{gray}{59.45} & \textbf{14.41}  & \textbf{44.10}  & \color{gray}{51.39}  \\ \hline
\end{tabular}
}
...
ResMLP+Crossentropy & 81.60           & 82.47          & 82.77          & 82.83          \\ \hline
ResMLP+MSEloss      & \textbf{83.87} & \textbf{83.64} & \textbf{83.37} & 83.85          \\ \hline
\end{tabular}
}
...
\multirow{4}{*}{Ours$_{Base}$} & 1         &  56.90     &  56.99   &   56.32  & 57.51    \\
...
Inspired by \cite{DBLP:conf/iccv/GaoG19}, we establish a baseline not using this prior knowledge by tiling the observations and task class conditions to the output of the U-Net encoder before decoding. A residual convolution block is applied to reduce the channel dimension of observation features. Then the features and conditions are replicate $k$ times($k$ is the horizon length of the U-Net encoder output) and concatenated along the channel dimension. We conduct experiments on CrossTask and the results are shown in \cref{tile}, which demonstrates that the introduced prior knowledge is quite useful to the learning process with visual features provided by CrossTask(Ours$_{Base}$), while not good when better visual features are provided(Ours$_{How}$).
...
\multirow{2}{*}{} & \multicolumn{3}{c}{T=3}                                            & \multicolumn{3}{c}{T=4}                                                \\ \cline{2-7} 
                  & SR$\uparrow$                   & mAcc$\uparrow$                 & mIoU$\uparrow$                 & SR$\uparrow$                   & mAcc$\uparrow$                 & mIoU$\uparrow$ \\ \hline
Tile$_{Base}$              &        22.34              &         49.10             &       53.71               &         14.13             &       45.80               &    55.03                      \\
Ours$_{Base}$              &         \textbf{25.52}             &          \textbf{53.43}            &        \textbf{56.90}              &          \textbf{15.40}            &          \textbf{49.42}            &           \textbf{56.99}               \\ \hline
...
Ours              &  \textbf{30.20}  &    \textbf{31.78}      &     33.09    &  \textbf{26.67}  &    \textbf{29.10}      &    \textbf{33.08}     \\ \bottomrule
\end{tabular}}
