...
The potential functions for some models in statistics and machine learning such as the quadratic loss of two-layer ReLU neural networks with elastic net regularization are dissipative and weakly differentiable but neither convex nor continuously differentiable.
The proposed algorithms are useful for sampling from the posterior distributions with such models of current interest.
