...
in a related voting system, two-round runoff~\cite{bordignon2016moderating}. In contrast, there has been almost no theoretical work on the subject. One interesting but specialized exception can be found in the work of \citet{grofman2004if}, who showed that IRV is at least as likely as plurality
to elect the median candidate under single-peaked preferences and
four or fewer candidates.
...
\begin{figure}[t]
\centering
  \includegraphics[width=\textwidth]{figures/k-3-4-5-winner-distributions-bars.pdf}
...
selecting the Condorcet winner whenever one exists (a property that holds for the
