...
\begin{align}\label{eq:Geff_nl_ndgp}
    &G_{\rm eff}^{\rm NL}(a,R) = G\left[1 + 2\deltaG\frac{R^{3}}{R_{V}^{3}}\left(\sqrt{1+\frac{R_{V}^{3}}{R^{3}}}\right) - 1 \right],
\end{align}
