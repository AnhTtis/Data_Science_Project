...
$B_0$                       & \si{N/(A m)}         &  Scale for magnetic flux                    &  $W(x)$                      & \si{1/m^2}           &  Spatial distribution of laser spot         \\
$\widehat{\bol{B}}$         & N.D.                 &  Nondimensional Magnetic flux               &  $x,y,z$                     & \si{m}               &  Components of coordinates                  \\
$c_p$                       & \si{J/(kg K)}        &  Specific heat                              &  $\bol{x}$                   & \si{m}               &  Spatial coordinates                        \\
$C_D$                       & N.D.                 &  Drag coefficient                           &  $\bol{X}$                   & N.D.                 &  Nondimensional coordinates                 \\
$d$                         & \si{m}               &  Droplet diameter                           &  $z_c$                       & \si{m}               &  Axial coordinate of droplet center         \\
...
$p$                         & \si{Pa}              &  Pressure                                   &  $\varphi$                   & \si{rad}             &  Polar angle                                \\
