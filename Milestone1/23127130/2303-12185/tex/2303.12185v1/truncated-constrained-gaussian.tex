...
\begin{abstract}
  We consider how to use Hamiltonian Monte Carlo to sample from distribution
...
Our motivation comes from modeling dicot (e.g. maize) root growth in a piecewise
