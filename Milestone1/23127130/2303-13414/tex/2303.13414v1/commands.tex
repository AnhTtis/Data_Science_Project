...
% 6) USER-DEFINED COMMANDS
\definecolor{dgreen}{cmyk}{1.,0.,1.,0.4} % dark green
...
\newcommand{\NSC}            {\ensuremath{\mathrm{NSC}}\xspace}
\newcommand{\AC}            {\ensuremath{\mathrm{AC}}\xspace}
\newcommand{\NAC}           {\ensuremath{\mathrm{NAC}}\xspace}
\newcommand{\trento}        {T\ensuremath{_\mathrm{R}}ENTo}