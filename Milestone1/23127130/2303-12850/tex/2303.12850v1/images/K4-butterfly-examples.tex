...
\begin{subfigure}[b]{0.47\textwidth}
    ...
    %         \end{scope} 
    %     \end{tikzpicture}
    %     \caption{The unique extreme point optimum of the complete graph $K_4$ along the all-ones objective direction for (\ref{FVS-LP:weak-density-cycle-cover}) is as shown. Consequently, the integrality gap of (\ref{FVS-LP:weak-density-cycle-cover}) is at least $3$.}
