...
\author{{\fontsize{14}{20} \textbf{Christophe Bruneel-Zupanc}}\footnote{E-mail address: \href{mailto:christophe.bruneel@gmail.com}{christophe.bruneel@gmail.com}. I am especially grateful to Jad Beyhum, Geert Dhaene, and Alexandre Gaillard for their tremendous help and to Gregory Veramendi for his help with the data of an earlier version. I also thank Jaap Abbring, Otilia Boldea, Christian Bontemps, Laurens Cherchye, Edoardo Ciscato, Ben Deaner, Sebastian Fleitas, Ferre de Graeve, Olivier de Groote, Vincent Han, Xavier d'Haultfoeuille, Peter Hull, Toru Kitagawa, Tobias Klein, Denis Kojevnikov, Soonwoo Kwon, Louise Laage, Pascal Lavergne, Arthur Lewbel, Jan de Loecker, Iris Kesternich, Sebastian Maes, Thierry Magnac, Matt Masten, Arnaud Maurel, Costas Meghir, Geert Meesters, Bob Miller, Erwin Ooghe, Aureo de Paula, Krishna Pendakur, Christian Proebsting, Bram de Rock, Adam Rosen, Silvia Sarpietro, Sami Stouli, Alexandros Theloudis, Jo Van Biesebroeck, Frank Verboven, Frederic Vermeulen, Ao Wang, Martin Weidner, Frank Windmeijer, Nese Yildiz, Andrei Zeleneev, Mariana Zerpa, and participants in seminars and conferences in Antwerp, Duke, Leuven, Rotterdam, Bristol, Toulouse, Manchester, San Antonio, Tilburg, Oxford, Barcelona, and Thessaloniki for helpful discussions, suggestions, and comments. I acknowledge financial support from KU Leuven grant STG/21/040 and FWO grant G018725N. } \\%\footnote{E-mail address: \href{mailto:christophe.bruneel@gmail.com}{christophe.bruneel@gmail.com}. I am especially grateful to Jad Beyhum, Geert Dhaene, and Alexandre Gaillard for their tremendous help and to Gregory Veramendi for his help with the data of an earlier version. I also thank Jaap Abbring, Otilia Boldea, Christian Bontemps, Laurens Cherchye, Edoardo Ciscato, Ben Deaner, Sebastian Fleitas, Ferre de Graeve, Olivier de Groote, Vincent Han, Xavier d'Haultfoeuille, Peter Hull, Toru Kitagawa, Tobias Klein, Denis Kojevnikov, Louise Laage, Pascal Lavergne, Arthur Lewbel, Jan de Loecker, Iris Kesternich, Sebastiaan Maes, Thierry Magnac, Matt Masten, Arnaud Maurel, Costas Meghir, Geert Meesters, Bob Miller, Erwin Ooghe, Aureo de Paula, Krishna Pendakur, Christian Proebsting, Bram de Rock, Adam Rosen, Silvia Sarpietro, Sami Stouli, Alexandros Theloudis, Jo Van Biesebroeck, Frank Verboven, Frederic Vermeulen, Ao Wang, Martin Weidner, Andrei Zeleneev, Mariana Zerpa, and participants to the seminars and conferences in Antwerp, Duke, Leuven, Rotterdam, Bristol, Toulouse, Manchester, San Antonio, Tilburg, Oxford, Barcelona, and Thessaloniki for helpful discussions, suggestions, and comments. I acknowledge financial support from the Research Fund KU Leuven through the grant STG/21/040.} \\
...
For instance, when IVs influence treatment selection uniformly in the same direction for all individuals -- a condition known as monotonicity \citep{imbensangrist1994} -- they enable the nonparametric identification of average treatment effects for individuals whose treatment choice is influenced by the IVs. These include local average treatment effect (LATE) \citep{imbensangrist1994} and marginal treatment effect (MTE) \citep{heckmanvytlacil2005} parameters, which are widely estimated in applied research. % both widely used in applied research. 
...
%
%
\indent When the treatment is binary, two semi-IVs -- one excluded from the potential outcome under treatment and the other from the potential outcome under control -- are sufficient to nonparametrically identify LATE and MTE parameters, just as an IV would. 
Crucially, this identification does not require any additional assumption beyond those in the standard IV framework (monotonicity of the selection), nor any restriction on how the semi-IVs affect the potential outcomes from which they are not excluded. The identification is \textit{IV-like} and stems directly from the observable variations induced by the semi-IVs.
...
As the main running example, which also corresponds to the empirical application in Section \ref{sec:application}, I focus on the identification of the earnings returns to working in the manufacturing sector \citep{heckmansedlacek1985, heckmansedlacek1990}. Workers select into sectors based on their unobservable, sector-specific skills, leading to endogenous selection. As a result, the comparison of earnings between manufacturing and nonmanufacturing workers is confounded. Ideally, we would like to find an IV to address the selection on unobservables, but finding one that influences the sector choice without also influencing the earnings is particularly challenging. 
%
%
Fortunately, we have access to many sector-specific characteristics, with observable variations across time and space, at the geographical market (e.g., state) level, which can be leveraged for identification. For instance, for each market, we observe historical measures of a sector's size, productivity, or growth, such as (lagged) shocks to the sector-specific size (e.g., GDP). These are promising semi-IV candidates. Indeed, they are likely to affect workers' sector choices: all else equal, the more attractive a sector, the more likely a worker is to select it. Such aggregate shocks are also independent of the workers' unobserved sector-specific skills. %and preferences. % "and preferences" is ambiguous - because the function in the first stage can also be thought of as preference, so it's not clear to put it there; 
...
%
%
\indent In fact, the observable changes in the average nonmanufacturing earnings and the selection probability, both induced by changes in the excluded manufacturing sector size (as semi-IV), are precisely the variations that identify the mean nonmanufacturing potential earnings for the compliers who select into manufacturing jobs as a result of the change in the semi-IV. Similarly, shifts in the nonmanufacturing sector size identify the mean manufacturing potential earnings for the compliers resulting from these shifts. %entering nonmanufacturing because of these shifts. 
...
%
%
\indent Such a decomposition hints at why semi-IVs are sufficient to identify treatment effects. LATE and MTE parameters compare the potential outcomes under treatment (e.g., manufacturing) and under control (e.g., nonmanufacturing) for specific subpopulations of (marginal) compliers. 
...
%
%
\indent Overall, the primary trade-off of the semi-IV approach is that researchers must find two semi-IVs, rather than a single IV, to identify similar treatment effects.\footnote{The two semi-IVs also need to be capable of inducing similar flows of compliers. This is always possible at the margin if both semi-IVs are continuous and relevant. So, to identify MTE parameters, there is no extra requirement on the semi-IVs compared to standard IVs, which are also required to be continuously distributed. However, LATE parameters can be identified using only discrete (or even binary) IVs. Exactly matching compliers with two discrete semi-IVs (and thus a limited support of the observable treatment probabilities) is theoretically possible but may be complicated in practice. To avoid these concerns, having at least one continuous semi-IV is recommended. This is a mild additional requirement. } %
%This is an additional restriction with respect to the counterpart identification of the LATE with (possibly binary) IVs. This additional cost is relatively mild since most examples of semi-IVs are continuously distributed in practice. }
In many cases, valid semi-IVs naturally mirror each other in the sense that they are alternative-specific versions of the same type of variable (e.g., sector-specific size). As a result, researchers often only need to identify a single type of semi-IV that can be adapted to all potential outcomes. The additional cost of implementing the semi-IV approach is, therefore, relatively modest, especially in comparison to its key advantage: relaxing the stringent full exclusion restriction of IVs. This makes semi-IVs a convenient alternative to IVs for causal inference. \\
%
%
%
\indent Building on constructive identification arguments, this paper develops both nonparametric and semi-parametric methods for estimating MTEs (and thus LATEs) with semi-IVs. In particular, the semi-parametric method adapts the local IV MTE estimation \citep{heckmanvytlacil1999, carneiroheckmanvytlacil2011, andresen2018exploring} to the semi-IV framework. The estimator is fast, easy-to-implement, and performs well, as illustrated by simulations in Online Appendix \ref{app:montecarlo}. A user-friendly implementation is available in the companion R package \texttt{semiIVreg} \citep{semiivreg}.\footnote{The package is available for download on \href{https://github.com/cbruneelzupanc/semiIVreg}{Github}. See the associated vignette at \href{https://cbruneelzupanc.github.io/semiIVreg/}{https://cbruneelzupanc.github.io/semiIVreg/} for user guidelines and replicable simulated examples. } \\  
...
the semi-IV approach naturally extends to the more general case of a discrete treatment with $J > 2$ distinct alternatives. In this setting, having one alternative-specific semi-IV -- which must be excluded from all but one potential outcome -- for each potential outcome (giving a total of $J$ distinct semi-IVs) is sufficient to nonparametrically identify discrete treatment effects, such as the effect of one treatment relative to the best alternative \citep{heckmanurzuavytlacil2006, heckmanvytlacil2007a, heckmanvytlacil2007b} or margin-specific MTEs \citep{mountjoy2022community}. 
Notably, identifying these treatment effects with standard IV methods typically requires $J-1$ special "alternative-specific" IVs, which must affect the latent utility of only one alternative but must be excluded from all potential outcomes, unlike semi-IVs. Thus, semi-IVs provide a natural generalization by conveniently allowing the alternative-specific instruments to also impact their corresponding potential outcomes, hence enlarging the available variation to identify discrete treatment effects. This gain comes at the modest cost of requiring $J$ semi-IVs instead of $J-1$ IVs. 
...
\noindent \textbf{Related Literature.} Exploiting targeted exclusion restrictions from certain potential outcomes to achieve identification has been used in part of the literature on Roy models \citep{heckmansedlacek1985, heckmansedlacek1990, heckmanhonore1990, heckman1990, heckmanvytlacil2007a, heckmanvytlacil2007b, bayeretal2011, frenchtaber2011, dhaultfoeuillemaurel2013}. 
For instance, the sector-specific variables in \cite{heckmansedlacek1985, heckmansedlacek1990} and \cite{dhaultfoeuillemaurel2013} can be interpreted as semi-IVs, excluded from the potential outcomes of workers selecting into other sectors.
...
Thus, semi-IVs provide an alternative to IVs for identifying LATE and MTE parameters in the most general models (i.e., generalized Roy models). This is particularly advantageous in empirical applications, where we want to avoid structural assumptions and where semi-IVs -- such as occupation or location-specific characteristics -- are often readily available but have so far only been used as control variables, neglecting their identification power. \\% as semi-IVs. \\
%
%
%
...
The IVQR and LATE frameworks encompass most models used in applied research.  Since semi-IVs achieve similar identification results in both frameworks, they can substitute for IVs in many empirical applications.\footnote{This paper focuses on nonparametric \textit{point} identification results. Extensions of the IV nonparametric \textit{set} identification results \citep[e.g.,][]{manskipepper2000, chesher2010, chesherrosen2017} to semi-IVs are left for future research.} \\
%
%
%
\indent More broadly, this paper contributes to the literature on identifying treatment effects by relaxing key IV assumptions, particularly the exclusion restriction. A more detailed discussion of this literature is in Online Appendix \ref{app:literature}. For a recent survey, see \cite{lewbel2019identification}. \\
...
We want to evaluate the effect of a binary treatment $D \in \mathcal{D}=\{0, 1\}$ on a scalar, real-valued outcome $Y$. Let $Y_d$ be the latent potential outcome under treatment state $d$, for $d\in \mathcal{D}$. The researcher only observes the realized outcome, $Y$, corresponding to the potential outcome of the selected alternative $D$. That is, %we observe  
...
The validity of the semi-IVs holds conditional on a given set of control variables $X$, with support $\mathcal{X}$, which have no identifying power ($X$ may be neither excluded, exogenous, nor relevant). %Conditional on $X$, $(Z_0, Z_1)$ are valid semi-IVs under the following conditions. 
...
\indent In the remainder of the paper, I refer to the conditional independence Assumption \ref{ass:exogeneity}(ii) as the \textit{(partial) exclusion restriction}, and call $Z_{1-d}$ \textit{excluded} from $Y_d$ given $(Z_d, X)$. This terminology is a simplification, as, similar to IVs \citep{angristimbensrubin1996}, satisfying $Y_d \indep Z_{1-d} | (Z_d, X)$ actually requires two conditions: exclusion \textit{and} exogeneity. To clarify the distinction between the two, denote by $Y_d(z, x)$ the potential outcome when $D$ is exogenously set to $d$, $Z$ to $z$, and $X$ to $x$. Thus, the potential outcomes defined earlier are $Y_d = Y_d(Z, X)$, and the observed outcome is $Y=Y_D=Y_D(Z,X)$. Then, the exclusion restriction is that, for all $x \in \mathcal{X}$, for all $(z_0, z_1)$, $(z_0, z_1')$, and $(z_0', z_1) \in \mathcal{Z}$, and for each $d=0, 1$, 
	...
	That is, there is no direct effect on $Y_d$ of exogenously switching $Z_{1-d}$ from $z_{1-d}$ to $z_{1-d}'$, once we already control for $Z_d=z_d$ and $X=x$. Furthermore, exogeneity requires that $Z_{1-d}$ be independent of the potential outcomes, i.e., $Y_d(z_d, x) \indep Z_{1-d} | (Z_d, X)$.\footnote{\label{footnote:exogeneity}A stronger version of exogeneity in \ref{ass:exogeneity} is to assume that $(Y_0(z_0, x), Y_1(z_1, x), D(z)) \indep (Z_0, Z_1) | X$ for all $(z_0, z_1) \in \mathcal{Z}$ and $x \in \mathcal{X}$. This is still very general and only restricts how the semi-IVs affect their corresponding potential outcomes: through a direct effect rather than via their correlation with unobservables affecting the potential outcomes (see Online Appendix \ref{app:heckmanvyt}). This assumption enables a clearer causal interpretation of the effect of exogenous changes in semi-IVs on outcomes but is stronger than necessary for identification. } Notice that $Y_d(z_d, x)$ is not necessarily independent of  $Z_d$ nor $X$. This is because $Z_d$ and $X$ may be correlated with the unobservables affecting $Y_d(z_d, x)$. 
...
\noindent \textbf{Selection into treatment (monotonicity).} 
As in the literature on IVs, the identification of causal effects also requires a restriction on how the semi-IVs affect the selection into treatment. I impose on the semi-IVs the same monotonicity/no-defier condition that \cite{imbensangrist1994} impose on IVs.\footnote{This is exactly the same monotonicity assumption as \cite{imbensangrist1994} but imposed on multiple semi-IVs. From \cite{mogstadetal2021}, we know that \cite{imbensangrist1994}'s monotonicity assumption is stronger when applied to multiple IVs. Semi-IVs are not necessarily comparable to multiple unrelated IVs, however. Indeed, in most examples, the semi-IVs are alternative-specific versions of similar variables (e.g., sector-specific GDP). Thus, it is often the comparison between two alternatives (e.g., the difference, the ratio, or some other utility comparison) that affects selection, rather than two unrelated semi-IVs. 
Therefore, the monotonicity assumption can be considered as an assumption imposed on the comparison between the semi-IVs rather than on each of the two semi-IVs separately. This implies that individuals uniformly value the comparison of the semi-IVs, which is a reasonable assumption in many discrete choice models for selection (as in Online Appendix \ref{app:discrete}).}\footnote{It is possible to relax the monotonicity to a weaker (unordered) \textit{partial monotonicity condition} \citep[as in][]{mogstadetal2021, mountjoy2022community} applied to each semi-IV separately \citep[or to the vector monotonicity of][]{goff2024}. 
Then, the mean potential outcomes/marginal treatment responses would still be identified but possibly for different sets of compliers for each semi-IV. Additional manipulations would be required to align these sets of compliers and obtain the marginal treatment effects. For instance, point identification could be achieved using a "comparable compliers" assumption \citep{mountjoy2022community}; see Online Appendix \ref{app:discrete}.} 
...
\noindent \textbf{Equivalent selection model with latent resistance to treatment.} For IVs, the monotonicity condition is equivalent to the existence of a weakly separable rule for the selection into treatment \citep{vytlacil2002}. The same holds for semi-IVs: if the semi-IVs are valid, then the monotonicity assumption is equivalent to assuming that the treatment is determined by a weakly separable rule of the form
...
\noindent \textbf{Causal graph representation.} 
 Figure \ref{fig_graph_semiIV} provides a causal graph representation of the model (Assumption \ref{ass:semiiv}) conditional on a specific $X=x$ (which is not displayed). The exclusion is visible by the absence of a link between $Z_{1-d}$ and $Y_d$ for each $d$.  
...
Conversely, $D=0$ when $V > P(z,x)$. Therefore, for any $z' \neq z$, if $P(z,x)=P(z',x)$, then $D_i(z', x) = D_i(z, x)$ for all individuals. The propensity score serves as a \textit{sufficient statistic} for the effect of the semi-IVs on selection: any two values of the semi-IVs yielding the same propensity score select the same individuals into treatment and control (because the semi-IVs are independent of $V$). This allows one to use multiple IVs (in our case, semi-IVs) and summarize their effect through the propensity score \citep[see][for an example of estimation of the MTE of college on earnings using multiple IVs]{carneiroheckmanvytlacil2011}. \\
\indent Moreover, Assumption \ref{ass:exogeneity}' (or \ref{ass:exogeneity}) implies that%\footnote{Since we are interested only in average effects, one could relax the full independence of \ref{ass:exogeneity}'(ii) and only impose the mean independence of Equation \eqref{eq:mean_independence}, which is sufficient to identify the MTE and LATE.} 
...
Consider the important question of identifying the effects of occupation choice ($D$) on earnings ($Y$). The question relates to decisions to work in the manufacturing sector \citep{heckmansedlacek1985, heckmansedlacek1990}, agriculture \citep{lagakoswaugh2013}, or a white-collar, blue-collar, or military occupation \citep{keanewolpin1997}. Similar questions arise about joining a union \citep{lee1978unionism}, attending college \citep{angristkrueger1991, card1995, card2001, carneiroheckmanvytlacil2011}, or selecting a specific college major \citep{arcidiacono2004, arcidiacono2020ex}.
One needs to address endogeneity due to the self-selection of individuals into occupations based on their unobserved occupation-specific abilities. To do so, occupation-specific characteristics such as the occupation-specific wage rate, unemployment rate, task content, firm size, revenue, productivity, profits, or subsidies can serve as valid semi-IVs. 
...
%
%
\indent \textit{Returns to working in manufacturing.} The main application in this paper (Section \ref{sec:application}) focuses on the effect of the manufacturing ($D=1$) versus the nonmanufacturing ($D=0$) sector choice on earnings ($Y$). 
I use the one-year lagged manufacturing GDP ($Z_1$) and nonmanufacturing GDP ($Z_0$) of the market (state of residence of the worker) as semi-IVs. 
First, these are likely to be relevant variables for sectoral choice because, all else equal, a larger or more active sector is more attractive to new (young) workers. 
%the larger or more active a given sector is, the more attractive it is to new (young) workers. 
Second, the aggregate sector-specific GDPs are likely to be exogenous with respect to the workers' unobserved sector-specific skills and their unobserved resistance to treatment.  %implying $(Y_0(z_0), Y_1(z_1)) \indep Z | X$,  and with respect to the resistance to treatment, that is $Z \indep V | X$. 
Exogeneity requires that, aside from differences in the semi-IVs, the various markets represent otherwise comparable environments. To ensure this, I control for time trends and pre-existing differences across markets by including year and market (state) fixed effects in $X$. This approach addresses concerns about the self-selection of high-skilled workers into more favorable markets and accounts for the global evolution of worker skills. Consequently, the identifying variation consists of deviations of sector-specific GDPs from these fixed effects, which I will occasionally refer to as "shocks to" the variables.\footnote{Instead of fixed effects, one could via $X$ control for the permanent levels of the semi-IVs in each market, as done by \cite{carneiroheckmanvytlacil2011} for some of their IVs, or use shocks to these variables directly as semi-IVs. } 
Third, (shocks to) the sector GDPs are not valid IVs because they may influence the potential earnings of workers in that sector (e.g., through changes in productivity, costs, or economies of scale): the sector-specific semi-IV is \textit{included} in the corresponding sector-specific potential earnings, i.e., $Z_d$ influences $Y_d$. % varies with $z_d$. %i.e., $Y_d(z_d)$ varies with $z_d$. 
However, conditional on the GDP of the manufacturing sector, shocks to the GDP of the nonmanufacturing sector should not directly affect the potential earnings of manufacturing workers, and vice versa. In other words, $Y_d$ is independent of $Z_{1-d}$ conditional on $Z_d$ and $X$. 
%In other words, $Y_d(z_d)$ is independent of $Z_{1-d}$ conditional on $Z_d$ and $X$. 
Once the included manufacturing characteristics are controlled for, similar characteristics of the other sectors do not affect the manufacturing potential earnings, and vice versa. \\
\indent Note that, in a given market, the shocks to the manufacturing and nonmanufacturing GDP are likely to be correlated. As long as they are not perfectly correlated, so that some locations experience relatively larger shocks to their manufacturing sectors compared to their nonmanufacturing sectors than other locations, this is not a problem for identification. \\
\indent As is standard with IVs, we rule out general equilibrium effects that could pose a threat to the partial exclusion restrictions. For instance, an increase in manufacturing GDP might alter worker composition, thereby affecting equilibrium wage rates in both sectors and indirectly influencing nonmanufacturing workers' earnings. To address this, we assume a partial equilibrium framework or a specific timing, so that wage rates are fixed or determined in the previous period.
Fortunately, and unlike the IV case, general equilibrium concerns are largely mitigated here. Indeed, the exclusion of $Z_{1-d}$ from $Y_d$ holds conditional on $Z_d$, and $Z_{1-d}$ can be correlated with $Z_d$. Thus, to a large extent, general equilibrium effects of $Z_{1-d}$ on $Y_d$ are captured by the effects of $Z_{1-d}$ on $Z_d$. Controlling for $Z_d$ absorbs most equilibrium effects since sector-specific wage rates are largely determined by the sector’s own characteristics (e.g., productivity, size). Thus, general equilibrium effects of the excluded semi-IV $Z_{1-d}$ mostly impact $Y_d$ through $Z_d$. This property is most salient when $Z_0$ and $Z_1$ are the sector-specific wage rates: controlling for the equilibrium wage rate in sector $d$, the wage rate in the other sector has no effect on $Y_d$.  In fact, by specifying some additional structure, one could even identify general equilibrium models with semi-IVs. For example, \cite{heckmansedlacek1985} propose a general equilibrium framework where sector-specific total labor compensation (closely linked to GDP) could serve as semi-IVs. Alternatively, one could directly use sector-specific wage rates for specific tasks across markets as semi-IVs to identify general equilibrium models, provided such data are available.\footnote{In this example, another threat to the validity of the semi-IVs could be monopsony power with strategic interactions between sectors, such as manufacturing firms adjusting wages based on the size of the nonmanufacturing sector. %\citep{staiger2010there, berger2022labor}. 
However, evidence suggests within-sector strategic responses are small, with \cite{staiger2010there} estimating an elasticity of only $0.128$ in the case of VA (Veteran Affairs) and non-VA hospitals. Between-sector interactions are likely to be even smaller and negligible, as sectors do not explicitly compete. Given that I focus on large (state-level) markets with many firms in each sector, individual firms are relatively small and primarily compete within their own sector, further diminishing the risk of significant cross-sector strategic interaction. In short, I assume that firms are price takers without monopsony power.} \\
%Strategic interactions are directly ruled out if we assume the firms in each sectors are price takers with no monopsony power. } \\
...
\noindent \textbf{Example 2 (Location/migration choice).} Consider the related problem of identifying the marginal earnings returns to endogenous location/migration choices of workers \citep{borjas1987, dahl2002, chiquiar2005international, bayeretal2011, abramitzky2012europe, abramitzky2014nation, roca2017learning} or firms \citep{combes2012productivity}. Location-specific (variations in) expected earnings \citep{kennanwalker2011}, welfare benefits \citep{borjas1999welfare, kennanwalker2010, abramitzky2009effect, agersnap2020welfare}, tax rates \citep{kleven2013taxation, kleven2014migration, kleven2020taxation, akcigit2016inventors, munoz2021european}, or more generally, any place-based policy \citep{neumark2015place} or measures of local amenities, may serve as valid semi-IVs. Again, these are (i) relevant for the choice to migrate, (ii) exogenous with respect to the individuals' unobserved characteristics, and (iii) the partial exclusion holds because, conditional on one's location-specific shocks, the shocks to the other locations are excluded from one's potential outcome. One can use temporal variation in these location-specific semi-IVs for identification. \\ 


\noindent \textbf{Example 3 (Demand estimation).} 
Semi-IVs can be used to estimate the demand for different products. For instance, consider the effect of car type -- gasoline ($D=0$) or diesel ($D=1$) -- on subsequent energy consumption, gasoline ($Y_0$) or diesel ($Y_1$). Endogeneity arises because individuals with different unobserved preferences (e.g., for higher mileage) select different cars. Estimating demand for gasoline/diesel cars is crucial for designing optimal energy transition policies, such as taxation or subsidies \citep{verboven2002quality, grigolon2018consumer}.
...
Semi-IVs can also be used to measure the effectiveness (or value-added) of specific types of institutions or products, net of selection effects. For instance, in education, consider the estimation of the effect of charter schools ($D=1$) \citep{angristetal2010, abdulkadiroglu2011charter, angristpathakwalters2013, abdulkadirouglu2016charters, walters2018charter, dobbiefryer2020}, boarding schools \citep{behaghel2017ready}, catholic schools \citep{altonjietal2005}, or private schools \citep{angrist2002vouchers, carneirodasreis2022} compared to public schools ($D=0$), on academic achievements or future labor market outcomes ($Y$). In health, consider the estimation of the effectiveness of different insurance plans (e.g., private vs public) \citep{abalucketal2021, finkelsteinhendrenluttmer2019}, type of hospitals \citep{gowrisankaran1999estimating, geweke2003hospital, hull2018estimating}, or nursing homes \citep{einav2022producing} on health outcomes. 
...
In this section, I show the identification of the MTE, followed by the LATE. I also describe the identification of the \textit{direct effects} of the semi-IVs on the potential outcomes from which they are not excluded. 
...
\noindent \textbf{Marginal treatment effect (MTE).} The marginal treatment effect (MTE) was introduced by \cite{bjorklund1987estimation} and generalized to the nonparametric case by \cite{heckmanvytlacil1999, heckmanvytlacil2005, heckmanvytlacil2007a, heckmanvytlacil2007b}. With semi-IVs, the MTE is naturally defined by
\begin{align}
...
\indent The key to identification is having a source of variation that can shift the propensity score at fixed $Z_1$ without directly affecting $DY$. This is precisely the role of $Z_0$, as visible in Equation \eqref{eq:observable_property}. Implicitly, the derivative in Equation \eqref{eq:mtr1} is identified by the local IV regression of $YD$ on $D$, instrumented by $Z_0$, at a specific value $\tilde{z}_0$ of $Z_0$ such that $P(\tilde{z}_0, z_1) = v$, i.e., \begin{align*}
...
\begin{align}\label{eq:localiv}
	...
	%&= m_1(u, w_1) - m_0(u, w_0). 
\end{align}
The problem with semi-IVs is that it is not possible to shift $P$ while fixing \textit{both} $Z_0$ and $Z_1$. This is why we use Property \eqref{eq:split} to split $Y$ in two subsamples, and rewrite \eqref{eq:localiv} as
...
\caption{Semi-IV shifts identifying MTE$(p, z_0, z_1)$ (if $p'=p+dp$) and LATE$(p, p', z_0, z_1)$} %, with $p'=p+dp$}
...
\indent To contextualize this graph, in the application of earnings returns to manufacturing sector choice, identifying returns for workers with resistance $V=v$ in an environment with manufacturing GDP $Z_1=z_1$ and nonmanufacturing GDP $Z_0=z_0$ requires observing two environments with different relative sector GDPs but the same propensity to work in manufacturing, $P=v$. The mean manufacturing potential earnings at $V=v$ and $Z_1=z_1$ are identified by marginally decreasing nonmanufacturing GDP (from $\tilde{z}_0$ to $\tilde{z}_0'$), which increases the propensity score from $p$ to $\bar{p}$ while holding $Z_1=z_1$ fixed. The resulting change in average $DY$ is due solely to the entry of the marginal compliers with $V=v$ into treatment, identifying their mean manufacturing earnings. 
...
\noindent Even without continuous semi-IVs, some LATE for compliers with $V \in [v, v')$ at $Z_1=z_1, Z_0=z_0$ can be identified if, for both $d$, there exist two semi-IV combinations with $Z_d=z_d$, one yielding $P=v$ and the other $P=v'$ (see Figure \ref{fig:late_identification}). 
%on both isocurves of probability levels $v$ and $v'$ (see Figure \ref{fig:late_identification}).  
With two discrete semi-IVs, or better, a discrete and a continuous one, a broad set of LATE is likely identifiable. With two discrete semi-IVs, even if the observable combinations of semi-IVs do not align exactly with the same propensity scores, treatment effects may still be tightly bounded. \\
%iso-probability curves, treatment effects may still be tightly bounded. \\ %one may tightly bound the treatment effects. \\
\indent In the extreme case where the researcher only has two binary semi-IVs ($Z_d \in \{0, 1\}$), identifying any LATE requires specific conditions that the effect of the semi-IVs on the selection probabilities compensate each other exactly.\footnote{More precisely, if $P(0, 0) = P(1, 1)=p$, then LATE$(p, P(1,0), 0, 1)$ and LATE$(p, P(0,1), 1, 0)$ are identified, while if $P(0,1)=P(1,0)=p$ then LATE$(p, P(0,0), 1, 1)$ and LATE$(p, P(1,1), 0, 0)$ are identified. } 
In most cases this will not hold, but the condition is easily testable and may hold in specific contexts. \\ %This will not hold in general, but the condition is easily testable and will hold in specific contexts. \\
...
\subsection{Direct effect of the semi-IVs (targeted policy evaluation)}

\indent In general, for each $d=0,1$, an exogenous change\footnote{To discuss the effects of \textit{exogenous changes} in the semi-IVs, one must adopt the stronger version of the exogeneity assumption \ref{ass:exogeneity} outlined in footnote \ref{footnote:exogeneity}, i.e., $(Y_0(z_0), Y_1(z_1), D(z)) \indep (Z_0, Z_1) | X$. This ensures that the semi-IVs are exogenous, influencing the potential outcomes only through general direct effects (because they are not excluded), without being correlated with $d$-specific unobservables. This stronger assumption is perfectly reasonable in most applications. } in $Z_d$ from $z_d$ to $z_d'$ has two effects on the observed average outcome $Y$: (i) a \textit{selection effect} since it alters the composition of the treated and untreated population by shifting the treatment incentives ($P$), and (ii) a \textit{direct effect} since, holding the composition fixed, the change in $Z_d$ directly affects the potential outcomes $Y_d$. %changing $Z_d$ from $w_d$ to $w_d'$ affects $Y_d$. 
%
...
\subsection{Other policy relevant treatment effects (PRTE)}
Since the MTRs are identified, any parameter expressed as a weighted function of the MTRs is also identified. The generalized LATE is already a specific policy-relevant treatment effect (PRTE) with semi-IVs (with unit weights). More broadly, \cite{mogstad2018ecta} (Table 1) provide a list of parameters expressed as weighted functions of the MTRs, along with their corresponding weights with IVs. Many of these parameters and weights can be adapted to identify their counterparts using semi-IVs. \\
\indent Similarly, when the semi-IVs have limited support -- restricting the observable propensity score and the range of unobserved $V$ for which MTRs are identified -- treatment effects can be extrapolated using approaches analogous to those in \cite{mogstad2018ecta} for IVs.
...
\begin{figure}[h!]
    ...
    \begin{adjustbox}{max width=1\textwidth,center}
        \begin{subfigure}[b]{0.5\textwidth}
            \centering
            \includegraphics[width=1\textwidth]{figures/US_evol_employment2.pdf}
        ...
        \begin{subfigure}[b]{0.5\textwidth}
            \centering
            \includegraphics[width=1\textwidth]{figures/US_evol_semiiv.pdf}
...
\begin{figure}[t]
	...
	\includegraphics[width=0.55\linewidth]{figures/ols_evol_return2_solo2.pdf}
...
%
%
\indent A naive look at earnings by sector (Figure \ref{fig:return_ols}) suggests that (i) manufacturing workers earn $13.5\%$ more on average than their nonmanufacturing counterparts throughout the period and (ii), perhaps surprisingly, this gap \textit{increased} from $13.2\%$ in $1999$ to $17.2\%$ in $2018$. \\
...
\begin{table}[t] \centering 
  ...
  \label{tab:semiiv} 
  \resizebox{0.8\textwidth}{!}{ % Scale to text width
  \small
...
\indent Figure \ref{fig:w1_proba} provides a more detailed view of the distribution of $P$ conditional on $Z_1$. It is visible that $Z_0$ is relevant because, given any fixed $Z_1 = z_1$, $P$ still exhibits substantial variation. This is the variation used for identification (while further controlling for covariates). 
...
\begin{figure}[p]
    ...
    \begin{subfigure}[b]{0.6\textwidth}
		\centering
        \includegraphics[width=1\textwidth]{figures/evol_mtr.pdf}
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{figures/evol_mte.pdf}
        \caption{$\Delta_t$MTE }
        \label{fig:evol_mte}
    \end{subfigure}
    \hfill % Horizontal spacing
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        %\hspace*{-0.7in}
        \includegraphics[width=1\textwidth]{figures/proba_evol_p.pdf}
...
\noindent \textbf{Relaxing the exclusion restriction.} Given the importance of IVs for causal inference and the restrictiveness of the standard assumptions imposed on them, numerous papers explore identification while relaxing some of these assumptions \citep{dhaultfoeuillefevrier2015, torgovitsky2015, dechaisemartin2017,  neweystouli2021, mogstadetal2021, kitagawa2021} or provide tests of their validity \citep{kitagawa2015, caetanoetal2016, andresenhuber2021, dhaultfoeuilleetal2021, kwon2024testingmechanisms}. 
...
\\
$\quad $ $D$: $\mu_1 - \mu_0 $ & 0.4 & -0.428 & 0.068  & 0.402 & 0.405 & 0.401\\
& & (0.019) & (0.074) & (0.071) & (0.123) & (0.049) \\
\\
$\quad$ $Z_0(1-D)$: $\delta_0$ & 0.8 & 0.706 &  & 0.788  & 0.800  & 0.801 \\
& & (0.013) & & (0.028)  & (0.016)  & (0.015) \\
%& & \\
\\
$\quad$ $Z_1D$: $\delta_1$ &  0.5 & 0.595 & & 0.486  & 0.501 & 0.500 \\ 
%& & \\
& & (0.013) & & (0.028) & (0.016) & (0.015) \\
\\
...
\\
$\quad $ Intercept: $\mu_0$ & 3.2 & 3.613 & 3.200 & 3.199 & 3.205 & 3.199 \\
& & (0.013) & (0.023) & (0.036) & (0.090) & (0.026) \\
\\
$\quad $ $D$: $\mu_1 - \mu_0 $ & 0.4 & -0.427 & 0.400  & 0.400 & 0.393 & 0.401\\
& & (0.019) & (0.042) & (0.070) & (0.129) & (0.048) \\
\\
$\quad$ $Z_0(1-D)$: $\delta_0$ & 0 & -0.094 &  & 0.000  & 0.000  & 0.000 \\
& & (0.012) & & (0.027)  & (0.016)  & (0.014) \\
%& & \\
\\
$\quad$ $Z_1D$: $\delta_1$ &  0 & 0.095 & & 0.000  & 0.000 & 0.000 \\ 
%& & \\
& & (0.014) & & (0.029) & (0.017) & (0.016) \\
