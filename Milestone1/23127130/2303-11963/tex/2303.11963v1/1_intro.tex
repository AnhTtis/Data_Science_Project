...
\begin{figure}[t]
\begin{center}
   \includegraphics[width=1.1\linewidth]{img/teaser-new.pdf}
\vspace{-0.9cm}
\end{center}
...
To summarize, our contributions are as follows\footnote {Code and datasets will be made public upon acceptance.}: 
\begin{tight_itemize}
\vspace{-0.2cm}
