...
\author{Ruihai Wu$^{1}$\thanks{Equal contribution, order determined by coin flip.} \quad  Chuanruo Ning$^{1}$\footnotemark[1] \quad Hao Dong$ ^{1}$\thanks{Corresponding author}\\
