...
\author{Ruihai Wu$^{1}$\thanks{Equal contribution, order determined by coin flip.} \quad  Chuanruo Ning$^{1}$\footnotemark[1] \quad Hao Dong$ ^{1,2}$\thanks{Corresponding author}\\
$^1$CFCS, CS Dept., PKU \quad % Peking University \quad
$^2$AIIT,  PKU \quad \\ %Peking University\quad\\
{\tt\normalsize \{wuruihai,chuanruo,hao.dong\}@pku.edu.cn}
% \\
% \\ \\
...
Please see our project page for {\color{red}\textbf{video records}} of real-world manipulations for both \textbf{SpreadCloth} and \textbf{RopeConfiguration} tasks.
