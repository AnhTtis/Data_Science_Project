...
\begin{figure}[!htb]
\centering
     \includegraphics[width=1.0\textwidth]{model-train.png}
...
\begin{figure}[!htb]
  ...
  \begin{minipage}{0.5\textwidth}
    \includegraphics[width=\linewidth]{loss-graph-spat.png}
  ...
  \begin{minipage}{0.48\textwidth}
    \includegraphics[width=\linewidth]{loss-graph-prob.png}
...
\begin{figure}[!htb]
\centering
     \includegraphics[width=1.0\textwidth]{sop-loss.png}
...
\begin{figure}[!htb]
\centering
     \includegraphics[width=1.0\textwidth]{mop-loss.png}
...
\begin{figure}[!htb]
\centering
     \includegraphics[width=1.0\textwidth]{total-loss.png}
...
\begin{figure}[!htb]
\centering
     \includegraphics[width=1.0\textwidth]{prediction-example.png}
...
In general, only Geospatial metrics, such as Acc@161, mean and median SAE, are utilized for the comparison with previous works in Table \ref{tab:datasets-metrics}. Note that both Twitter-US and Twitter-World datasets were reproduced locally from the archived database of Twitter posts from the year 2021. 
...
\hline
\multirow{18}{*}{\rotcell{NG+GO}} & \multirow{2}{*}{PSOP} & TO & \multirow{2}{*}{1} & 1881.2 & 153 & 50.5 & 1954 & 352.8 & 174 & 60.8 & 12.5 \\
 &  & NG &  & 568.3 & 32.1 & 78.3 & 639.2 & 70.4 & 60.9 & \textbf{3.7} & 19.6 \\ 
\cline{2-12}
 & \multirow{12}{*}{PMOP} & \multicolumn{1}{c|}{TO} & \multirow{2}{*}{3} & 1876.2 & 134.9 & 51.5 & 1911.8 & 219.9 & 24.1 & 16.2 & 22 \\
 &  & \multicolumn{1}{c|}{NG} & & 561.7 & 29.5 & 78.7 & 601.1 & \textbf{63.3} & \textbf{13.9} & 7.9 & \textbf{31.2} \\ 
\cline{3-12}
 &  & TO & \multirow{2}{*}{5} & 1845 & 135.9 & 51.5 & 1896.3 & 214.7 & 27.9 & 15.2 & 15.9 \\
 &  & NG &  & \textbf{551.4} & 29.4 & \textbf{79} & \textbf{600.4} & 79.1 & 15.3 & 9.6 & 23.4 \\ 
\cline{3-12}
...
% \textbf{Stat} & \textbf{All} & \multicolumn{1}{c}{\textbf{Great Britain}} & \multicolumn{1}{c}{\textbf{France}} & \multicolumn{1}{c}{\textbf{Canada}} \\ 
% \hline
% Train size & 3,000,000 & 1,772,344 & 366,882 & 860,834 \\
% English & 2,494,749 & 1,649,065 & 53,753 & 791,931 \\
% French & 326,165 & 17,052 & 281,163 & 27,950 \\
% Other & 179,086 & 106,227 & 31,906 & 40,953 \\ 
% \hline
% Test size & 300,000 & 176,894 & 36,607 & 86,499 \\
% English & 249,750 & 164,661 & 5,424 & 79,665 \\
% French & 32,344 & 1702 & 25,905 & 2,737 \\
% Other & 17,906 & 10,531 & 5,278 & 4,097 \\ 
% Mean SAE & 57.19 & 31.15 & 65.51 & 106.93 \\
% Med SAE & 3.68 & 3.3 & 5.9 & 3.94 \\
% Acc@161 & 96 & 97 & 92 & 95
% \end{tabular}
% \end{table}
