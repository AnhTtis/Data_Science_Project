...
We will calculate the self energies of charm mesons 
...
A loop diagram with an internal pion line and an internal charm-meson line
includes a zero-temperature part, a thermal part from the forward scattering of an on-shell pion,
and a thermal part from the forward scattering of an on-shell charm meson.
...
The thermal pion part can be represented by a forward scattering diagram
in which the pion line is cut and the two ends are attached to open circles,
as in the diagram for the $D$ self energy in Fig.~\ref{fig:Dselfenergy}.
An on-shell pion emerges from one open circle
with momentum $\bm{q}$ and flavor $i$ and
 it is scattered back into the other open circle with the same momentum and  flavor.
...
In the contributions from the second diagram,
 the sum over the pion  flavor $i$ of the Clebsch-Gordon factors from the pion vertices
...
The leading terms in the thermal mass shifts do not depend on the $D$ and $D^\ast$ flavors:
%=======
\begin{subequations}
\bqa
\mathrm{Re}[\delta \varepsilon_d] &\approx& 
\frac{3g_\pi^2 m_\pi}{2f_\pi^2} \,  \mathfrak{n}_\pi \, \left\langle \frac{1}{\omega_q} \right\rangle,
\label{Re[deltaepsilonb]}
\\
 \mathrm{Re}[\delta \varepsilon_{\ast c}] &\approx&
...
these thermal mass shifts are $\mathrm{Re}[\delta \varepsilon_d]=+1.26$\,MeV
and $\mathrm{Re}[\delta \varepsilon_{\ast c}]=-0.42$\,MeV. 
...
Most of the calculations considered  temperatures ranging from 0 to 200\,MeV, 
which is well beyond the hadronization temperature.
We will quote the results of previous calculations at 100 and 150\,MeV.
Our results are not applicable at temperatures as high as 150\,MeV,
which is near the hadronization temperature.
...
have been calculated by Fuchs et al.\ using a resonance approach \cite{Fuchs:2004fh}.
...
As $T$ increases from 100 to 150\,MeV, the $D$ mass shift decreases from $-7$ to $-18$\,MeV 
and the $D^\ast$ mass shift decreases from $-6$  to $-15$\,MeV. 
The $D$ thermal width increases from 8 to 28\,MeV  
and the $D^\ast$ thermal width increases from 12 to 37\,MeV. 
Similar results for the $D$ thermal width were obtained 
by He et al.\   using a resonance approach \cite{He:2011yi}.

The  thermal widths of $D$ and $D^\ast$ in a pion gas
have been calculated by Cleven et al.\  using a self-consistent unitarized approach \cite{Cleven:2017fun}.
...
As $T$ increases from 100  to 150\,MeV, 
the  $D$ thermal width increases  from 15 to 44\,MeV 
and the $D^\ast$ thermal width increases  from 10 to 31\,MeV. 


The complex thermal energies of $D$ in a pion gas and in a gas of $\pi$, $K$ and $\eta$ mesons
have been calculated by Monta\~na et al.\  using a different self-consistent unitarized approach  \cite{Montana:2020lfi}.
...
Self-consistent solutions to the integral for the thermal  $D^{(\ast)}$ self energy
and the  Lippmann-Schwinger integral equation for the thermal $\pi D^{(\ast)}$ amplitude were obtained numerically.
As $T$ increases  from 100 to 150\,MeV, 
the $D$ energy shift in a pion gas decreases  from $-13$ to $-40$\,MeV 
and the $D$ thermal width increases from 17 to 70\,MeV. 
The results were extended to other charm mesons including $D^*$ in Ref.~\cite{Montana:2020vjg}.
As $T$ increases  from 100 to 150\,MeV,
 the $D^\ast$ energy shift in a pion gas  decreases  from $-12$  to $-38$\,MeV 
and the $D^\ast$ thermal width increases  from 17  to 74\,MeV. 

The thermal mass shifts and thermal widths for $D$ and $D^\ast$ calculated in 
Refs.~\cite{Fuchs:2004fh,He:2011yi,Cleven:2017fun,Montana:2020lfi,Montana:2020vjg} 
differ at most by about a factor of 2.5 in the range of $T$ from 100 to 150\,MeV.
We will compare our results with those in Refs.~\cite{Montana:2020lfi,Montana:2020vjg} at $T=100$\,MeV.
The flavor averages of the thermal mass shifts for $D$ from Eq.~\eqref{deltaepsilonDb} 
...
are both negative and  approximately equal. 
They are larger than our results by about one and two orders of magnitude, respectively.
At $T=100$\,MeV, the flavor averages of the thermal widths for $D$ from Eq.~\eqref{deltaepsilonDb} 
and for $D^\ast$ from Eq.~\eqref{deltaepsilonD*a} are 64\,keV and 15\,keV. 
The  thermal widths in Refs.~\cite{Montana:2020lfi,Montana:2020vjg}
are approximately equal for $D$ and $D^\ast$, and they are about 3 orders of magnitude larger than our results.
...
Another possibility is that  the iteration of the integral equation
used to obtain self-consistent solutions in Refs.~\cite{Montana:2020lfi,Montana:2020vjg}
 violates the low-temperature constraints from chiral symmetry.
In this case, their thermal mass shifts and thermal widths for charm mesons 
could be much too  large at low temperatures.
...
At the 4 lowest temperatures, the thermal shifts in the masses  of $D$ and $D^\ast$
were consistent with zero to within the errors, which were about 6\,MeV.
The lowest temperature where the thermal shifts were significant was 152\,MeV,
where the shift was $-20 \pm 7$\,MeV for $D$ and  $-43 \pm 10$\,MeV for $D^\ast$.
Thus lattice QCD does not yet provide useful results for the thermal shifts in charm-meson masses
at temperatures well below the hadronization temperature.
...
and then take the limit $\Lambda \to \infty$, the 2-loop contribution to the $D^\ast D$ self energy at NLO reduces to
%=======
\beq
\Sigma_5^\mathrm{(NLO)}  =
-\frac{g_\pi^2}{3 f_\pi^2} \,  \mathfrak{n}_\pi 
...
\caption{
Thermal rest energies (left panel) and thermal widths (right panel) for $X(3872)$ and $T_{cc}^+(3875)$ 
in the pion gas as functions of the temperature $T$.
...
in the pion gas and at $T=0$, respectively.
In the right panel, the solid curves are the sums of the decay width at $T=0$ and the thermal width
for $X$ (red upper curvs) and $T_{cc}^+$ (blue lower curve).
The horizontal lines are the decay widths at $T=0$.
The dashed curves  are the sums of the  decay widths at $T=0$ and the thermal widths of the $D^\ast$ and $D$ constituents.
}
...
As $T$ increases from 0 to 100 to 150\,MeV,  the energy of $X$ increases from $-2.5$ to +3 to +13\,MeV. Although it was not stated in Ref.~\cite{Cleven:2019cre}, the $D^\ast D$ threshold was actually
...
As $T$ increases from 0 to 100 to 150\,MeV, the width of $X$ increases from 0 to 30 to 60\,MeV. 
...
As $T$ increases from 0 to 100 to 150\,MeV, the energy of $X$ decreases from $-4$ to $-30$ to $-75$\,MeV. 
Most of the change comes from the thermal mass shifts of the charm-meson constituents,
whose sum decreases from 0 to $-27$ to $-88$\,MeV. 
The energy of $X$ relative to the $T$-dependent charm-meson-pair threshold
increases from $-4$ to $-3$ to $+13$\,MeV. 
This energy changes sign at a temperature just above 100\,MeV, 
which can be interpreted as the $X$ becoming unbound.
As $T$ increases from 0 to 100 to 150\,MeV, the width of $X$ increases 
from 0 to 30 to 160\,MeV. 
Most of the change comes from the thermal widths of the charm-meson constituents,
whose sum increases from 0 to 34 to 140\,MeV. 
The thermal width agrees with that in Ref.~\cite{Cleven:2019cre} at 100\,MeV,
but it is larger by about a factor of 2.5 at 150\,MeV.

Our results are not applicable at temperatures as high as 150\,MeV, which is near the hadronization temperature.
We will only compare our results for $X(3872)$ with those in MRTT for the pion gas at $T=100$\,MeV.
The sum of the thermal mass shifts of the constituents $D^{*0}$ and $\bar D^0$
from Eqs.~\eqref{deltaepsilonDb} and \eqref{deltaepsilonD*a} is +1.0\,MeV. 
...
We cannot exclude the possibility  that higher orders in the chiral expansion are much larger than the leading order,
 even at temperatures as low as 100\,MeV.
Another possibility is that  the iteration of the integral equation used to obtain self-consistent solutions 
for the thermal charm-meson  self-energies in Ref.~\cite{Montana:2022inz}
violates the low-temperature constraints from chiral symmetry. 
As a result, their thermal mass shifts and thermal widths for the charm-meson molecule 
could be much too  large at low temperatures.
...
violates the low-temperature constraints from chiral symmetry. 
As a result, their thermal mass shift and thermal width for $X$
could be much too  large at low temperatures.
