Numerical
simulation of turbulent fluid dynamics needs to either parameterize turbulence---which
...
Based on this we apply a quantum algorithm for simulating the Carleman-linerized
