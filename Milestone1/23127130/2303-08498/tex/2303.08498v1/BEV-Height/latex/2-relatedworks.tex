...
Additionally, transformer-based detectors' implicit 3D location information also can benefit from accurate depth cues. CrossDTR~\cite{tseng2022crossdtr} proposed depth-guided transformers, which compose depth-aware embedding from depth maps and are supervised by ground truth depth maps to enhance performance.
