...
We observe that our methods outperform the baseline in all three settings. Note that, the BEVDepth only identify two objects under roll-pitch disturbance while ours identify nine. }
