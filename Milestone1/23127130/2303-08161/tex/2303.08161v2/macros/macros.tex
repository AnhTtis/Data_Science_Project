...
%%To add to the main if not thm style file
...
\renewcommand{\adr}[1]{#1} %Adrienne
\renewcommand{\cadr}[2]{#2} %Adrienne
...
\newcommand{\bswax}{{\Downarrow}\textsc{-ax}}
\newcommand{\bswbeta}{{\Downarrow}\textsc{-@}\betav}
\newcommand{\bswappnf}{{\Downarrow}\textsc{-@nf}}
...
\newcommand{\mlasrelnafex}{\, \mlasrelnafexsym \,}
...
\newcommand{\symequivsone}{@\symfont{l}}
\newcommand{\equivsone}{\equiv_{\symequivsone}}
\newcommand{\equivsthree}{\equiv_{v@\symfont{r}}}
\newcommand{\equivexsthree}{\equiv_{@\symfont{r}}}
\renewcommand{\symequivsone}{@l}
\renewcommand{\equivsthree}{(\equiv_{@r})_{|ltr}}
\renewcommand{\equivexsthree}{\equiv_{@r}}
\newcommand{\equivsthreeb}{\equiv_{\sigma_{3'}}}
\newcommand{\equivcom}{\equiv_{{\mathtt{com}}}}
\renewcommand{\equivcom}{\equiv_{com}}
...
\newcommand{\equivom}{\equiv_{\Omega}}
\newcommand{\equivomv}{\equiv_{\Omega_v}}
...
\newcommand{\mscabseta}{\mlassenopsym_{\eta_v}}
...
\newcommand{\vsctsym}{\symfont{vsc}_{blub}}
...
\newcommand{\bswleftsym}{\Downarrow_{l}} 
\newcommand{\bswleft}[1]{\bswleftsym^{#1}}
\newcommand{\bswlefts}{\bswleftsym\,} 
\newcommand{\bswleftdiv}{\not\bswlefts} 
...
\newcommand{\bsvsctsym}{\Downarrow_{\vscsym}}
...
\newcommand{\VSCmodulo}{\VSC_{\symequivsone}}
...
\newcommand{\lasrelncbvsym}{\ncbvfp\lasrelsym}
\newcommand{\lasrelncbv}{\, \lasrelncbvsym \,}

\newcommand{\etav}{\eta_v}

%%%% Contextual equivalences
\newcommand{\contextualsym}{\mathcal{C}}
\newcommand{\opensym}{\mathcal{O}}
\newcommand{\substsym}{\mathcal{S}}

\newcommand{\equivcp}[1]{\simeq_\contextualsym^{#1}}
\newcommand{\leqcp}[1]{\precsim_\contextualsym^{#1}}
%\newcommand{\eqcv}{\simeq_C^v}
%\newcommand{\leqcv}{\precsim_C^v}

\newcommand{\equivcopenp}[1]{\simeq_{\contextualsym\opensym}^{#1}}
\newcommand{\leqcopenp}[1]{\precsim_{\contextualsym\opensym}^{#1}}


\newcommand{\equivsubp}[1]{\simeq_\substsym^{#1}}
\newcommand{\leqsubp}[1]{\precsim_\substsym^{#1}}
...
\newcommand{\cbnheadsym}{\symfont{h}}
\newcommand{\leqccbnhead}{\precsim_{\contextualsym}^\cbnheadsym}
\newcommand{\equivccbnhead}{\simeq_{\contextualsym}^\cbnheadsym}


\newcommand{\cbnweakheadsym}{\symfont{wh}}
\newcommand{\leqccbnweakhead}{\precsim_{\contextualsym}^\cbnweakheadsym}
\newcommand{\equivccbnweakhead}{\simeq_{\contextualsym}^\cbnweakheadsym}

\newcommand{\cbvweaksym}{\symfont{w}}
\newcommand{\leqccbvweak}{\precsim_{\contextualsym}^\cbvweaksym}
\newcommand{\equivccbvweak}{\simeq_{\contextualsym}^\cbvweaksym}
...
%Abstract reduction for naive bisimilarities
\newcommand{\wxsym}{u}
\newcommand{\towx}{\Rew{\wxsym}}
\newcommand{\bswxsym}{\Downarrow_{\wxsym}} 
\newcommand{\bswx}[1]{\bswxsym^{#1}}
\newcommand{\bswxs}{\bswxsym\,}
\newcommand{\bswxdiv}{\not\bswxs}

\newcommand{\sizetm}[1]{\symfont{size}(#1)}