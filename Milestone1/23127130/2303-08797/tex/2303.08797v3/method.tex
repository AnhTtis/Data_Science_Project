...
%
To sample stochastically, the listed SDE can be integrated using standard techniques such as the Euler-Maruyama method or the Heun sampler introduced in~\citep{Karras2022edm}.
%
...
The minimizer of~\eqref{eq:obj:E} provides us with an energy-based model (EBM)~\cite{lecun2006tutorial,song2021train} that can in principle be used to sample the PDF of the stochastic interpolant, $\rho(t,x)$, at any fixed $t\in [0,1]$ using e.g. Langevin dynamics. 
%
