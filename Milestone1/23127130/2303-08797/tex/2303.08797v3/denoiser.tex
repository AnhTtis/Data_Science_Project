...
\end{equation}
while trivially $\EE (x_1| x^\OSLIN_{t=0} ) = \EE[x_1]$ since $x^\OSLIN_{t=0} = z$. This expression is commonly used in denoising methods~\cite{simoncelli1996, kadkhodaie2021solving}, and it is Stein’s unbiased risk estimator (SURE) for $x_1$ given the noisy information in $x^\OSLIN_t$~\cite{stein1981estimation}. 
%
