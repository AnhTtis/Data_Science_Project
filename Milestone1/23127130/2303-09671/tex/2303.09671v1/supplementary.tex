...
\begin{align}\label{gb35}
     \mu|^{\pm} = \frac{f_s(c_{s,0}) - f_l(c_{l,0})}{c_{s,0}-c_{l,0}} + \frac{\kappa}{c_{s,0}-c_{l,0}} & + \frac{V_n}{c_{s,0}-c_{l,0}}\Bigg\{ \alpha - \frac{(c_{s,0}-c_{l,0})^2}{\partial c_{l,0}/\partial\mu}\Big[F^{\pm} + M - (1-A)^2 N \nonumber \\
     & + (1-A)P\Big]\Bigg\}- q_n^-\frac{\partial\mu_0}{\partial r}\Big|^- AH 
\end{align}
