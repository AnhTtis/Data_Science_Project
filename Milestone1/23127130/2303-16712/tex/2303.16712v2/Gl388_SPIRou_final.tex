...
\begin{document} 
   ...
   \subtitle{A 2.23 days rotation period and no evidence for a corotating planet.
          }
...
The RV zero point correction was derived from observations of a set of RV RV standards
