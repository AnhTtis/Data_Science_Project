...
\thanks{We thank Wenjing Liao for helpful discussions on line spectral estimation, and Zhiyan Ding and Lin Lin for explaining the work in \cite{ding2023sim} and comments and suggestions. The work of L.Y. is partially supported by the National Science Foundation under awards DMS-2011699 and DMS-2208163}
...
\begin{proof}
    ...
    \end{equation}
    and any element $m$ of this set
    satisfies \eqref{eq:disjoint}.
\end{proof}
...
\begin{theorem}\label{thm:complexityreal 2}
    ...
    \begin{equation}\label{eq:cond alpha}
     \alpha<\min\left\{\frac{C\beta}{8(C-1)\sqrt{2S}}\sqrt{1-\frac{2(C-1)S}{C\K}}, \frac{\beta}{80S^2}\sqrt{\frac{(C-1)^3\K}{C^3(2+\K)}}\left(1-\frac{2CS}{(C-1)\K}\right)\eta\right\}  - \omega,
    \end{equation}
    and $N_\HR$ satisfy
    \begin{equation}
       N_\HR = 2\left\lceil\frac{4}{\alpha^2}\left(\log\frac{4}{\p}+\log\left(\left\lceil\log_2\frac{\eta}{\eps}\right\rceil+1\right)+\log(\K+1)\right)\right\rceil,
...
\begin{cor}\label{cor:prefacsp}
    When $\omega$ is sufficiently close to zero, one can take $\eta = \Theta(\frac{\omega}{\beta})$ and  $\K =\Theta(\frac{4}{\tilde{\Delta}})$, then we have
    \begin{equation}
...
\begin{theorem}\label{thm:real hybrid}
    ...
    \frac{80S^2}{\beta}\sqrt{\frac{C^3(2+\K_2)}{(C-1)^3\K_2}}\left(1-\frac{2CS}{(C-1)\K_2}\right)^{-1} \omega < \eta <\frac{1}{8S(2S-1)},
    \end{equation}
    ...
    \begin{equation}\label{eq:cond alpha3}
     \alpha_2<\min\left\{\frac{C\beta}{8(C-1)\sqrt{2S}}\sqrt{1-\frac{2(C-1)S}{C\K_2}}, \frac{\beta}{80S^2}\sqrt{\frac{(C-1)^3\K_2}{C^3(2+\K_2)}}\left(1-\frac{2CS}{(C-1)\K_2}\right)\eta\right\}  - \omega,
    \end{equation}
    \begin{equation}
...
\begin{cor}
    ...
    \begin{equation}
        \tm = O_{S,\beta}\left(\max\{\omega^{-1}\Delta^{-1}, \omega\eps^{-1}\}\right), \quad \tt = \tilde{O}_{S,\beta}\left(\omega^{-2}\Delta^{-1}+ \omega^{-1}\eps^{-1}\right).
    \end{equation}
\end{cor}
...
\begin{theorem}\label{thm:int hybrid}
  Let $\tdm\ge2$ such that $\tilde{\Delta}:= \tdm \Delta < \frac{1}{4Sp_{\frac{S(S-1)}{2}}p_{\frac{S(S-1)}{2}+1}}$. Let $\eta\le \frac{1}{6}$ such that
    \begin{equation}\label{eq:cond eta4}
      \frac{80S^2}{\beta}\sqrt{\frac{C^3(2+\K_2)}{(C-1)^3\K_2}}\left(1-\frac{2CS}{(C-1)\K_2}\right)^{-1} \omega < \eta <\frac{1}{4Sp_{\frac{S(S-1)}{2}}p_{\frac{S(S-1)}{2}+1}},
    \end{equation}
...
\begin{cor}\label{cor:hybridint}
    If we choose $\tilde{\Delta} = \frac{1}{4Sp_{\frac{S(S-1)}{2}}p_{\frac{S(S-1)}{2}+1}}$ and $\eta = \Theta(\omega\beta^{-1})$ in \Cref{thm:int hybrid}, then the maximal and total runtime of the algorithm are
    \begin{equation}
        \tm = O_{S,\beta}\left(\max\{\omega^{-1}\Delta^{-1}, \omega\eps^{-1}\}\right), \quad \tt = \tilde{O}_{S,\beta}\left(\omega^{-2}\Delta^{-1}+ \omega^{-1}\eps^{-1}\right).
    \end{equation}
\end{cor}
