...
\newcommand{\sussex}{Department of Physics and Astronomy, University of Sussex, Brighton, BN1 9RQ, UK}
...
\newcommand\icc{\textsf{icc}\xspace}
\newcommand\ifort{\textsf{ifort}\xspace}
\newcommand\clang{\textsf{LLVM clang}\xspace}
\newcommand\appleclang{\textsf{AppleClang}\xspace}
...
\newcommand{\restframes}{\textsf{RestFrames}\xspace}
