...
%\begin{figure*}[tbp]
%  \centering
%  \includegraphics[width=0.5\columnwidth]{images/Auxilliary/FeynMannDiagramTChannel}
%  \includegraphics[width=0.5\columnwidth]{images/Auxilliary/FeynMannDiagramUChannel}
...
%\begin{align}
%\begin{split}
%    \mathcal{M} = & \frac{-g_{\text{DM}}^2}{2\mathrm{P}^2(1-\cos{\theta}) + m_{\text{M}}^2} \frac{\big(\mathrm{P}^2 - (\mathrm{P}^2 + m_{\text{DM}}^2) \cos{\theta} \big)^2}{m_{\text{DM}}^4} \\
%     &  \times \big(6\mathrm{P}^2 + 4 m_{\text{DM}}^2 + 2\mathrm{P}^2 \cos{\theta} \big) \\
%   & + \frac{-g_{\text{DM}}^2}{2\mathrm{P}^2(1+\cos{\theta})+ m_{\text{M}}^2} \frac{\big(\mathrm{P}^2 + (\mathrm{P}^2 + m_{\text{DM}}^2) \cos{\theta} \big)^2}{m_{\text{DM}}^4} \\
%    & \times \big(6\mathrm{P}^2 + 4 m_{\text{DM}}^2 -2\mathrm{P}^2 \cos{\theta}\big).
%\end{split}
%\end{align}
%
...
%\begin{align}
%\begin{split}
%    \mathcal{M} = & \sum_{\text{S}=-1,1}  \frac{-g_{\text{DM}}^2}{2\mathrm{P}^2(1+\text{S}\cos{\theta}) + m_{\text{M}}^2} \\  & \times \frac{\big(\mathrm{P}^2 +\text{S} (\mathrm{P}^2 + m_{\text{DM}}^2) \cos{\theta} \big)^2}{m_{\text{DM}}^4} \\
%    & \times \big(6\mathrm{P}^2 + 4 m_{\text{DM}}^2 - 2\text{S} \mathrm{P}^2 \cos{\theta} \big).
%\end{split}
%\end{align}
%
% Writing it simply as the sum of the other terms
%
\begin{align}
    \mathcal{M}_{ii}(s,\cos{\theta}) = \mathcal{M}_t + \mathcal{M}_u\,.
\end{align}
%Substituting into Eq~\ref{UnitarityIntegral} gives
%\begin{align}
%\begin{split}
%    \mathcal{M}^{J}_{ij}(s) = \frac{g_{\text{DM}}^2}{96 \pi m_{\text{DM}}^4 (\frac{s}{2} - 2 m_{\text{DM}}^2)^4} \frac{\sqrt{s - 4 m_{\text{DM}}^2}}{\sqrt{s}} \\
%    \Bigg( (s - 4 m_{\text{DM}}^2)\Big((\frac{s}{2} - 2 m_{\text{DM}}^2)^2 \big((\frac{s}{4})^2 ( -4s +4 m_{\text{DM}}^2 )\\
%    + \frac{3 m_{\text{DM}}^2 s}{2}(\frac{3s}{2} - 2 m_{\text{DM}}^2) + 3m_{\text{DM}}^4 (\frac{s}{2} - 2m_{\text{DM}}^2) \big) \\
%    + \frac{3 m_{\text{M}}^2 s}{4} (\frac{s}{2} -2  m_{\text{DM}}^2)  (\frac{3s^2}{8} + \frac{1}{2} m_{\text{DM}}^2 s - 4m_{\text{DM}}^4) \\
%    + \frac{3m_{\text{M}}^4 s^2}{16} (\frac{s}{2} - 2 m_{\text{DM}}^2) \Big)\\
%    - 3 \big(\frac{m_{\text{M}}^2 s}{4}+m_{\text{DM}}^2 (\frac{s}{2} - 2 m_{\text{DM}}^2) \big)^2 \\
%     \big((\frac{s}{2} - 2 m_{\text{DM}}^2)(2s - 4 m_{\text{DM}}^2)+m_{\text{M}}^2 (\frac{s}{2} - 2m_{\text{DM}}^2) \big) \\
%     \ln{\Big(\frac{s - 4 m_{\text{DM}}^2+m_{\text{M}}^2}{m_{\text{M}}^2} \Big)}  \Bigg).
%\end{split}
%\end{align}
%
% Formatting a little differently
%\begin{align}
%\begin{split}
%    \mathcal{M}^{J}_{ij}(s) = \frac{g_{\text{DM}}^2}{96 \pi m_{\text{DM}}^4 (\frac{s}{2} - 2 m_{\text{DM}}^2)^4} \sqrt{\frac{s - 4 m_{\text{DM}}^2}{s}} \\
%    \Bigg( (s - 4 m_{\text{DM}}^2)\Big((\frac{s}{2} - 2 m_{\text{DM}}^2)^2 \big(\frac{s^2}{4} ( m_{\text{DM}}^2 - s )\\
...
%\begin{split}
%    \Bigg|\frac{g_{\text{DM}}^2}{96 \pi m_{\text{DM}}^4 (\frac{s}{2} - 2 m_{\text{DM}}^2)^4} \frac{\sqrt{s - 4 m_{\text{DM}}^2}}{\sqrt{s}} \\
%    \Bigg( (s - 4 m_{\text{DM}}^2)\Big((\frac{s}{2} - 2 m_{\text{DM}}^2)^2 \big((\frac{s}{4})^2 ( -4s +4 m_{\text{DM}}^2 )\\
%    + \frac{3 m_{\text{DM}}^2 s}{2}(\frac{3s}{2} - 2 m_{\text{DM}}^2) + 3m_{\text{DM}}^4 (\frac{s}{2} - 2m_{\text{DM}}^2) \big) \\
%    + \frac{3 m_{\text{M}}^2 s}{4} (\frac{s}{2} -2  m_{\text{DM}}^2)  (\frac{3s^2}{8} + \frac{1}{2} m_{\text{DM}}^2 s - 4m_{\text{DM}}^4) \\
%    + \frac{3m_{\text{M}}^4 s^2}{16} (\frac{s}{2} - 2 m_{\text{DM}}^2) \Big)\\
...
%\label{UnitatityBoundEq}
%\begin{split}
%    \Bigg|\frac{g_{\text{DM}}^2}{96 \pi m_{\text{DM}}^4 (\frac{s}{2} - 2 m_{\text{DM}}^2)^4} \sqrt{\frac{s - 4 m_{\text{DM}}^2}{s}}  \Bigg( (s - 4 m_{\text{DM}}^2)\Big((\frac{s}{2} - 2 m_{\text{DM}}^2)^2 \big(\frac{s^2}{4} ( m_{\text{DM}}^2 - s ) + \frac{3 m_{\text{DM}}^2 s}{4}(3s - 4 m_{\text{DM}}^2)\\
...
%     - 3 \big(\frac{m_{\text{M}}^2 s}{4}+m_{\text{DM}}^2 (\frac{s}{2} - 2 m_{\text{DM}}^2) \big)^2  \big((\frac{s}{2} - 2 m_{\text{DM}}^2)(2s - 4 m_{\text{DM}}^2)+m_{\text{M}}^2 (\frac{s}{2} - 2m_{\text{DM}}^2) \big) \ln{\Big(\frac{s - 4 m_{\text{DM}}^2+m_{\text{M}}^2}{m_{\text{M}}^2} \Big)}  \Bigg) \Bigg| \leq \frac{1}{2}.
%\end{split}
%\end{align}
%\begin{align}
%\label{UnitatityBoundEq}
%\begin{split}
%    \Bigg|\frac{g_{\text{DM}}^2}{96 \pi m_{\text{DM}}^4 (\frac{s}{2} - 2 m_{\text{DM}}^2)^4} \sqrt{\frac{s - 4 m_{\text{DM}}^2}{s}} \\
%    \Bigg( (s - 4 m_{\text{DM}}^2)\Big((\frac{s}{2} - 2 m_{\text{DM}}^2)^2 \big(\frac{s^2}{4} ( m_{\text{DM}}^2 - s )\\
%    + \frac{3 m_{\text{DM}}^2 s}{4}(3s - 4 m_{\text{DM}}^2) + 3m_{\text{DM}}^4 (\frac{s}{2} - 2m_{\text{DM}}^2) \big) \\
%    + \frac{3 m_{\text{M}}^2 s}{8} (s -4  m_{\text{DM}}^2)  (\frac{3s^2}{8} + \frac{1}{2} m_{\text{DM}}^2 s - 4m_{\text{DM}}^4) \\
%    + \frac{3m_{\text{M}}^4 s^2}{32} (s - 4 m_{\text{DM}}^2) \Big)\\
...
\end{align}
which was supplied to \textsf{DDCalc v2.2.0}~\cite{DarkBit,HP}, to compute the differential cross-section and target element of interest. We do not include the effect of operator mixing from running as it has been shown to have little effect for pure vector couplings of the mediator to quarks~\cite{DEramo:2016gos}.
...
\begin{figure*}[tbp]  
  \centering
  \includegraphics[width=\columnwidth]{images/ScanResults/VectorDM_RDupper_Extended}
  \caption{Profile likelihood, profiled over couplings, for DM and mediator masses up to $10^5$ GeV. The measured DM relic abundance is taken as an upper limit. 1$\sigma$ and 2$\sigma$ contours are shown in white.}
  \label{ProfileLike_Extended}
\end{figure*}
...
In Figure~\ref{ProfileLike_Extended}, we show how the profile likelihood changes if the scan range were extended to masses up to $100$ TeV. The resonance region closes off around 30 -- 40 TeV as DM becomes overabundant unless the couplings become non-perturbative. The non-resonant region continues on with a largely flat likelihood. For DM masses well beyond 100 TeV, thermally produced DM will violate generic unitarity bounds~\cite{Griest:1989wd}.
