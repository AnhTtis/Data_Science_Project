...
\begin{itemize}
  ...
  \item \relax Versatility: The proposed model is effective to gauge novelty, but it can be used for other purposes, such as trend analysis (e.g., Choi \& Hwang, 2014 \cite{choi2014patent}). 
\end{itemize}
...
\subsection{Data}Google patent is a platform where patents from 2016 to 2020 granted by United States Patent and Trademark Office are provided. Of them, Artificial Intelligence Patent Dataset (Giczy et al., 2019 \cite{giczy2022identifying}) are adopted for this research. Using Google patent, we randomly extract 420 pairs patents from 2019 to 2020, with which we perform expert validation.
