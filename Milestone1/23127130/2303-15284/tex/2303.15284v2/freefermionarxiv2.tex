...
\caption{Representative profiles of the quasienergies for $p=2$. The dashed lines in panel (a) correspond to Eq.~(\ref{Ansatz}). The bottom panels show the energy dependence of what will become the zero mode in the thermodynamic limit on the coupling parameters.
Note that for the configuration in panel (c) the zero mode is only present for $\lambda_A/\lambda_C<1$.}\label{fig:quasip2}
\end{figure}
...
we verified that the behavior observed in Fig.~\ref{fig:pic5}
...
\bibitem[{\citenamefont{Alcaraz and Pimenta}(2021)}]{AP21}
\bibinfo{author}{\bibfnamefont{F.~C.} \bibnamefont{Alcaraz}} \bibnamefont{and}
  \bibinfo{author}{\bibfnamefont{R.~A.} \bibnamefont{Pimenta}},
  \bibinfo{journal}{Phys. Rev. E} \textbf{\bibinfo{volume}{104}},
  \bibinfo{pages}{054121} (\bibinfo{year}{2021}),
  \urlprefix\url{https://link.aps.org/doi/10.1103/PhysRevE.104.054121}.
