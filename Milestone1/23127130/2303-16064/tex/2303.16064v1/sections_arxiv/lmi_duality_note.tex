...
Under assumptions A1-A6, \eqref{eq:chance_lmi} inherits the strong duality property of its infinite-dimensional counterpart \eqref{eq:var_meas_soc}, and its optima will converge to \eqref{eq:var_meas_soc} i.e. $\lim_{d \rightarrow \infty} p^*_{r, d} = p^*_r$.
\end{thm}
\begin{proof}
