...
\urg{Add CVAR content, deplagarize Sections \eqref{eq:example_twostate} and \eqref{eq:example_twostate}. Correct the tables of data.}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{img/motion_cvar_6_corr.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\linewidth]{img/twist_cvar_6.png}
