...
\begin{figure}[h]
    \centering
    \includegraphics[width=\exfiglength]{img/scatter_discrete.png}
    \caption{Trajectories of \eqref{eq:scatter_discrete} with $\epsilon = \{0.5, \textrm{ES} \ 0.15\}$ bounds }
    \label{fig:scatter_discrete}
\end{figure}

Table \ref{tab:twist_scatter} reports \ac{CVAR} bounds for $-x_2$ at orders $1$ to $6$. The \ac{VP} and Cantelli objectives produce bounds that are greater than $1.5$ (outside $X$) for the $d$ and $\epsilon$ values tested. As an example, the VP bound at $d=6, \epsilon = 0.15$ is $p(x) \leq -2.1252$
...
\begin{tabular}{lcccccc}
\multicolumn{1}{c}{order}          & 2      & 3      & 4      & 5      & 6  & \ac{CVAR} MC \\ \hline
mean                                     & 0.8766                & 0.8128                & 0.8002                & 0.7982                & 0.7976     &          \\
$\epsilon = 0.15$                       & 1.5000                & 1.2139                & 1.0971                & 1.0743                & 1.0663  & 1.0287              \\
$\epsilon = 0.1$                          & 1.5000                & 1.2973                & 1.1446                & 1.1083                & 1.0997              & 1.0601  \\
$\epsilon = 0.05$                        & 1.5000                & 1.4500                & 1.2285                & 1.1653                & 1.1540  & 1.1092             
...
\begin{tabular}{lcccccc}
\multicolumn{1}{c}{order}                 & 2      & 3      & 4      & 5     & 6   & \ac{VAR} MC   \\ \hline
mean & 0.4304 & 0.3823 & 0.3630 & 0.3487 & 0.3352 & 0.0788\\
$\epsilon = 0.15$ & 0.9953 & 0.9328 & 0.9076 & 0.8918 & 0.8853 & 0.2384\\
$\epsilon = 0.1$   & 1.2888 & 1.2162 & 1.1865 & 1.1687 & 1.1609 & 0.2755\\
$\epsilon = 0.05$  & 1.9469 & 1.8516 & 1.8120 & 1.7891 & 1.7799 & 0.3334           
\end{tabular}
\end{table}

\begin{figure}[!h]
    \centering
    \includegraphics[width=\exfiglength]{img/lin_switch.png}
...
mean & 0.362 & 0.389 & 0.570 & 1.755 & 2.499 \\
$\epsilon = 0.15$ &  0.257 & 0.295 & 0.587 & 1.812 & 3.718 \\
$\epsilon = 0.1$   & 0.237 & 0.281 & 1.636 & 2.364 & 3.191 \\
$\epsilon = 0.05$  & 0.251 & 0.291 & 0.906 & 1.735 & 2.638
\end{tabular}
\end{table}
...
\begin{tabular}{lcccccc}
\multicolumn{1}{c}{order}                 & 2      & 3      & 4      & 5     & 6   & \ac{CVAR} MC   \\ \hline
mean                                     & 0.4304                & 0.3823                & 0.3630                & 0.3488                & 0.3350                                       \\
$\epsilon = 0.15$         & 0.9698                & 0.7882                & 0.7157                & 0.6803                & 0.6540     & 0.4220                                  \\
$\epsilon = 0.1$                       & 1.1137                & 0.8818                & 0.7886                & 0.7433                & 0.7133   & 0.4470                                    \\
$\epsilon = 0.05$                         & 1.3924                & 1.0548                & 0.9207                & 0.8585                & 0.8200  & 0.4688                                    
\end{tabular}
\end{table}
...
\begin{tabular}{lcccccc}
\multicolumn{1}{c}{order}            & 2      & 3      & 4      & 5      & 6      \\ \hline
mean                                       & 0.471                 & 0.466                 & 0.674                 & 1.916                 & 3.310 \\
$\epsilon = 0.15$                          & 0.336                 & 0.371                 & 0.835                 & 1.954                 & 3.170 \\
$\epsilon = 0.1$                          & 0.330                 & 0.360                 & 0.816                 & 2.177                 & 4.237 \\
$\epsilon = 0.05$                         & 0.331                 & 0.373                 & 0.728                 & 1.486                 & 3.602
...
\begin{tabular}{lcccccc}
\multicolumn{1}{c}{order}                & 2      & 3      & 4      & 5       & 6     & VAR MC \\ \hline
mean &  1.1929 & 1.2337 & 1.2425 & 1.2490 & 1.2506 & 1.3162\\
$\epsilon = 0.15$  & 0 & 0 & 0 & 0.0182 & 0.0235 & 1.2432\\
$\epsilon = 0.1$  & 0 & 0 & 0 & 0 & 0 & 1.2261\\
$\epsilon = 0.05$  & 0 & 0 & 0 & 0 & 0  & 1.2012                   
\end{tabular}
\end{table}
...
\begin{figure}[!h]
    \centering    \includegraphics[width=0.9\exfiglength]{img/lin_distance.png}
...
\multicolumn{1}{c}{order}            & 2      & 3      & 4      & 5      & 6      \\ \hline
mean &  0.507 & 0.512 & 1.772 & 6.569 & 21.331 \\
$\epsilon = 0.15$ &  0.346 & 0.453 & 1.233 & 5.836 & 23.930 \\
$\epsilon = 0.1$  &  0.344 & 0.482 & 1.522 & 5.172 & 21.034 \\
$\epsilon = 0.05$ &  0.384 & 0.485 & 1.711 & 5.954 & 26.974
\end{tabular}
\end{table}
...
\begin{tabular}{lcccccc}
\multicolumn{1}{c}{order}                & 2      & 3      & 4      & 5       & 6   & \ac{CVAR} MC \\ \hline
mean                          & 1.1929                & 1.2337                & 1.2427                & 1.2498                & 1.2494      &         \\
$\epsilon = 0.15$                         & 0                & 0                & 0.4884                & 0.5061                & 0.7980           & 1.2079     \\
$\epsilon = 0.1$           & 0                & 0                & 0.2825                & 0.3018                & 0.7047              & 1.1942  \\
$\epsilon = 0.05$                           & 0                & 0                                & 0                & 0                & 0.4952      & 1.1734         
...
\begin{tabular}{lcccccc}
\multicolumn{1}{c}{order}      &      & 2      & 3      & 4      & 5      & 6      \\ \hline
mean                          & 0.272                 & 0.295                 & 1.229                 & 10.869                & 6.556                 \\
$\epsilon = 0.15$                          & 0.147                 & 0.207                 & 1.616                 & 4.403                 & 8.655                 \\
$\epsilon = 0.1$                           & 0.129                 & 0.187                 & 1.178                 & 4.987                 & 8.386                 \\
$\epsilon = 0.05$                         & 0.119                 & 0.193                 & 0.430                 & 1.382                 & 7.617                   
