...
In our case, this size is at most $\binom{n+1+d}{d}$ with a scaling impact of $(n+1)^{6 d}$ or $d^{4(n+1)}$. The complexity of using this chance-peak routine increases in a jointly polynomial manner with $d$ and  $n$.
