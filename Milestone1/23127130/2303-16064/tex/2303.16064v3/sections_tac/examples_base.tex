...
The dash-dot, dotted, and solid red lines in Figure \ref{fig:sde_flow} are the mean, $\epsilon=0.15$ \ac{CVAR}, and $\epsilon=0.15$ \ac{VP} bounds respectively at order 5.
...
\begin{figure}
    ...
    \caption{Trajectories of \eqref{eq:flow_sde} with mean (dash-dot red), \ac{CVAR} $\epsilon=0.15$  (dotted red), and \ac{VP} $\epsilon=0.15$ (solid red) bounds}
    \label{fig:sde_flow}
\end{figure}
...
mean                      & 0.8818                & 0.8773                & 0.8747                & 0.8745                & 0.8744                & 0.8559                                           \\
...
\begin{tabular}{lcccccc}
\multicolumn{1}{c}{order}            & 2      & 3      & 4      & 5      & 6     & \ac{CVAR} \ac{MC} \\ \hline
mean                      & 0.9100                & 0.8312                & 0.8231                & 0.8211                & 0.8203                &                         0.7206        \\
