...
In contrast, the chance-peak approach upper-bounds the maximum \ac{VAR} of the continuous-time \ac{SDE} state distribution of $x(t)$ across all times. We will solve this problem by maximizing the Cantelli \cite{cantelli1929sui}
and \ac{VP} \cite{vysochanskij1980justification} upper bounds for the \ac{VAR}.
