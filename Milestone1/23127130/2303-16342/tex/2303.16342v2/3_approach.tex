...
Method   &  detectors & proposals & SDR $\uparrow$  & SIR $\uparrow$ & SAR $\uparrow$ &  SDR $\uparrow$ & SIR $\uparrow$ & SAR $\uparrow$\\
\hline
Co-Separation \cite{gao2019co} & Yes & 2 & 7.38 & 13.70 & 10.82 & 7.42 & 13.81 & 10.60 \\
AVSGS\tablefootnote{\text{Compute-efficient.}} \cite{chatterjee2021visual} & Yes & 42 & \textbf{9.04} & \textbf{14.45} & \textbf{12.24} & \textbf{10.25} & \textbf{15.60} & \textbf{12.82} \\
\hline
