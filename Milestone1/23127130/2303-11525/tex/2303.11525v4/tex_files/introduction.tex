...
\begin{figure}[ht]
    ...
    models and sparsity levels, $s \in \{\text{50\%, 75\%, 90\%}\}$, while using the same training FLOPs as its dense
    counterpart. }
...
configurations. This enables DST methods to navigate the search space
...
\begin{enumerate}%[noitemsep]
    ...
    for training on the Cerebras CS-2~\citep{lie2023cerebras}
