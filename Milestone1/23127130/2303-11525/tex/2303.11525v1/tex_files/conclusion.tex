\section{Conclusion}
We introduce a new family of Sparse Iso-FLOP Transformations (SIFT) to improve
the training efficiency of DNNs. These transformations can be used as drop-in
replacements for dense layers and increase the representational capacity while
using sparsity to maintain training FLOPs. This increase in capacity also
...
as the original dense model, SIFT improves the training efficiency across
