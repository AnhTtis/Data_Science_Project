...
\begin{tikzpicture}
    ...
    \node [
        above right,
        inner sep=0] (image) at (0,0) {\includegraphics[width=.9\linewidth]{figures/GWEn_rotation_axes.png}};
    ...
    \begin{scope}[
        ...
        \draw[latex-, thick,seemoo_organge] (6.4,5.9) -- ++(0.5,0.5)
        ...
        \draw[latex-, thick,seemoo_organge] (5.0,2.8) -- ++(0.5,+0.5)
        ...
        \draw[latex-, thick,seemoo_organge] (2,6.5) -- ++(-0.5,-0.5)
            node[below,black,fill=white]{\tiny Holding Plate with phone};
        ...
        \draw[thick,seemoo_organge] (3.0,2.5) rectangle (6.0,0.15) 
            node[above left,white,fill=seemoo_organge]{\tiny Base};

        \draw[thick,seemoo_organge] (5.2,3.15) rectangle (6.0,10) 
