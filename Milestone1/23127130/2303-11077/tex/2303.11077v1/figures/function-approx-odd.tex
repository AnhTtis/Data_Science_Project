...
\begin{axis}[
    ...
    \addplot[yellow, ultra thick, domain=-pi:0] (x, -1/2);
    \addplot[yellow, ultra thick, domain=0:pi] (x, 1/2);
    \addplot[yellow, ultra thick, domain=pi:4] (x, -1/2);
    \addplot[yellow, ultra thick, domain=-4:-pi] (x, 1/2);
    ...
    \node at (axis cs:-1.5,0.35) {$\phi_1(x)$};
