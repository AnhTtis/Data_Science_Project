...
\begin{table}[!tb]
\caption{\textbf{Ablation: Contribution of each component on KITTI-to-DrivingStereo Foggy. % need to be modified lower is better
}}
\centering
