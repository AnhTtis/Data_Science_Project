\begin{tabular}{l|c|c|c|c|c|c}
 ...
 solver & size & error &  & in \eqref{eq:nextguess1} & to Remark \ref{rem:propconst}  & to Remark \ref{rem:propconstauto} \\
		\hline
\multirow[c]{3}{*}{Adams}    &  0.0140  & $ 5.4 \cdot 10^{-2^{\vphantom{1}}}$  & 21 &  3 &  3 &  3 \\
    &  0.0070  & $ 3.6 \cdot 10^{-2^{\vphantom{1}}}$  & 23 &  3 &  3 &  3 \\
    &  0.0035  & $ 2.5 \cdot 10^{-2^{\vphantom{1}}}$  & 22 &  3 &  3 &  3 \\
\hline
\multirow[c]{3}{*}{BDF2}    &  0.0140  & $ 1.7 \cdot 10^{-5^{\vphantom{1}}}$  & 22 &  3 &  2 &  2 \\
    &  0.0070  & $ 8.1 \cdot 10^{-6^{\vphantom{1}}}$  & 22 &  3 &  2 &  2 \\
    &  0.0035  & $ 1.3 \cdot 10^{-6^{\vphantom{1}}}$  & 23 &  3 &  2 &  2 \\
\end{tabular}
