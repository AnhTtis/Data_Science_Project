\begin{tabular}{l|c|c|c|c|c|c}
 ...
 solver & size & error &  & in \eqref{eq:nextguess1} & to Remark \ref{rem:propconst}  & to Remark \ref{rem:propconstauto} \\
		\hline
\multirow[c]{3}{*}{Adams}    &  0.0020  & $ 4.8 \cdot 10^{-6^{\vphantom{1}}}$  & 63 &  6 &  6 &  6 \\
    &  0.0010  & $ 1.5 \cdot 10^{-6^{\vphantom{1}}}$  & 64 &  6 &  6 &  6 \\
    &  0.0005  & $ 4.3 \cdot 10^{-7^{\vphantom{1}}}$  & 65 &  6 &  6 &  6 \\
\hline
\multirow[c]{3}{*}{BDF2}    &  0.0020  & $ 1.3 \cdot 10^{-5^{\vphantom{1}}}$  & 62 &  6 &  6 &  6 \\
    &  0.0010  & $ 3.2 \cdot 10^{-6^{\vphantom{1}}}$  & 65 &  6 &  6 &  6 \\
    &  0.0005  & $ 8.2 \cdot 10^{-7^{\vphantom{1}}}$  & 65 &  6 &  6 &  6 \\
\end{tabular}
