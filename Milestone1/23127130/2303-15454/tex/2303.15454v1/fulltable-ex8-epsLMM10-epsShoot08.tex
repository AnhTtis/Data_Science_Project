\begin{tabular}{l|c|c|c|c|c|c}
 ...
 solver & size & error &  & in \eqref{eq:nextguess1} & to Remark \ref{rem:propconst}  & to Remark \ref{rem:propconstauto} \\
		\hline
\multirow[c]{3}{*}{Adams}    &  0.0400  & $ 2.0 \cdot 10^{-4^{\vphantom{1}}}$  & 25 &  7 &  8 &  7 \\
    &  0.0200  & $ 5.0 \cdot 10^{-5^{\vphantom{1}}}$  & 26 &  7 &  8 &  7 \\
    &  0.0100  & $ 1.2 \cdot 10^{-5^{\vphantom{1}}}$  & 24 &  7 &  8 &  7 \\
\hline
\multirow[c]{3}{*}{BDF2}    &  0.0400  & $ 5.1 \cdot 10^{-4^{\vphantom{1}}}$  & 26 &  7 &  8 &  7 \\
    &  0.0200  & $ 1.3 \cdot 10^{-4^{\vphantom{1}}}$  & 27 &  7 &  8 &  7 \\
    &  0.0100  & $ 3.4 \cdot 10^{-5^{\vphantom{1}}}$  & 27 &  7 &  8 &  7 \\
\end{tabular}
