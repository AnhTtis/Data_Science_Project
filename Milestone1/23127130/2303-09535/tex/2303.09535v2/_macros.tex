...
\definecolor{colorx}{rgb}{0.92,0.49,0.19}

\newcommand{\xiaodong}[1]{{\textcolor{colorx}{[xiaodong: #1]}}}
\newcommand{\xd}[1]{{\textcolor{colorx}{#1}}}

\newcommand{\chenyang}[1]{\textcolor{blue}{(chenyang: #1)}}
\newcommand{\yong}[1]{\textcolor{cyan}{(yong: #1)}}
\newcommand{\RM}[1]{}
