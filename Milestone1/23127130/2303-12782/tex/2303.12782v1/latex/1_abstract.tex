...
%
Specifically, it achieves almost 13\% relative improvements on VIPSeg and 4\% improvements on KITTI-STEP over the strong baseline Video K-Net. When using a ResNet50 backbone on Youtube-VIS-2019 and 2021, Tube-Link boosts IDOL by 3\% and 4\%, respectively. Code will be available.
