...
\acrodef{ALS}[ALS]{Amyotrophic Lateral Sclerosis}
\acrodef{ALSFRS-R}[ALSFRS-R]{ALS Functional Rating Scale Revisited}
...
\acrodef{FVC}[FVC]{Forced Vital Capacity}
...
\acrodef{iDPP}[iDPP@CLEF]{Intelligent Disease Progression Prediction at CLEF}
...
\acrodef{MS2}[MS]{Multiple Sclerosis}
...
\acrodef{NIV}[NIV]{Non-Invasive Ventilation}
...
\acrodef{PEG}[PEG]{Percutaneous Endoscopic Gastrostomy}
...
\acrodef{RTM}[RTM]{Representational Theory of Measurement}
