...
%\DeclareMathSymbol{\theta}{\mathalpha}{operators}{2}
\usepackage{upgreek}
...
% http://www.ctan.org/pkg/algorithm
...
contents={
\begin{tikzpicture}
\node at (current page.center) [align=center] {\textcopyright 2019 IEEE. Personal use of this material is permitted. 
...
\author{\IEEEauthorblockN{Tim Puphal$^{1\dagger}$, Malte Probst$^{1\dagger}$, Misa Komuro$^{2}$, Yiyang Li$^{2}$ and Julian Eggert$^{1}$}
\IEEEauthorblockA{$^{1}$ Honda Research Institute (HRI) Europe, 
	Carl-Legien-Str. 30, 63073 Offenbach, Germany \\
	Email: {\tt\small \{tim.puphal, malte.probst, julian.eggert\}@honda-ri.de} \\
	$^{2}$ Honda Innovation Lab (HIL) Tokyo, Honda R\&D Co., Ltd. 9-7-1 Akasaka, 107-6238 Tokyo, Japan \\
	Email: {\tt\small \{Misa\_Komuro, Yiyang\_Li\}@n.t.rd.honda.co.jp} \\
...
\noindent This work has been partially supported by the European Unions Horizon 2020 project \textit{VI-DAS}, under the grant agreement number 690772. The authors would like to thank Fabian M\"uller for providing the damage model.
%\vspace{0.7cm}
\vfill
