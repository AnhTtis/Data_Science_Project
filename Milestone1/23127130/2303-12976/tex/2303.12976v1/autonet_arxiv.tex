...
%% Title
\title{NVAutoNet: Fast and Accurate 360$^{\circ}$ 3D Perception \\ For Self Driving
%%%% Cite as
...
\begin{table}[t]
	...
	\hline
	Inputs & Outputs & Architecture & Speed & Training data & Mid-fusion & End-to-end & In-car tested \\
	\hline
	8 cameras & 3D signals & cnn + mlp  & 18ms (53fps) & 2.2M scenes & Yes & Yes & Yes\\
	\hline
	\end{tabular}
	\centering
...
\caption{An overview of NVAutoNet architecture. Multiple view images are inputs to CNN backbones to extract 2D features, which are uplifted and fused into an unified BEV feature map. The BEV features are then used for 3D detection heads.}
\label{fig:nvautonet}  
\end{figure}
