...
As shown in Figure \ref{fig:performance_illustration}, compared with the pure planar rendering~\cite{Li_2021_ICCV2}, the joint rendering predicts more details and fewer blurs in both the RGB and depth rendering. 
