...
We compare the proposed Ra\srk, Gr\srk~and BlockBFGSv2 with baseline methods on problem~(\ref{prob:logstic}).
...
We conduct our experiments on a PC with Apple M1 and implement all algorithms in Python 3.8.12.
