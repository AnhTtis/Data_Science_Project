\begin{table}[th]
    ...
    \centering
    \begin{tabularx}{\textwidth}{c|l|CCCCC|CC|X}
        % \hline
                                               &                              &
        ...
        \parbox[t]{4mm}{\multirow{15}{*}{\rotatebox[origin=c]{90}{AllSAT}}}
                                               ...
                                               & \textsc{TabularAllSAT}       & \cmark & \cmark & \xmark & \cmark & \xmark & \cmark & \xmark &                         \\
        \hline
        \parbox[t]{4mm}{\multirow{4}{*}{\rotatebox[origin=c]{90}{AllSMT}}}
                                               &                              &        &        &        &        &        &        &                                  \\
                                               & \textsc{MathSAT}             & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark &                         \\
