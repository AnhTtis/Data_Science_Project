...
\renewenvironment{rschange}{\color{blue}}{\normalcolor}
...
\makenewenumerate{aenumerate}{({\em\alph{cntaenumerate}})}
\makenewenumerate{aenumerateprime}{({\em\alph{cntaenumerateprime}$'$})}
\makenewenumerate{aenumeratesecond}{({\em\alph{cntaenumeratesecond}$''$})}
...
\newcommand{\GMCHANGE}[1]{\textcolor{red}{#1}}
\newenvironment{gmchange}{\color{red}}{\normalcolor}
\newenvironment{gmchangep}{\color{forestgreen}}{\normalcolor}
\newcommand{\GMCHANGEp}[1]{\textcolor{forestgreen}{#1}}
\newcommand{\GMTODO}[1]
{\todo[inline,color=orange!40]{{\small{GM TODO: #1}}}}
\newcommand{\GSTODO}[1]
{\todo[inline,color=yellow!40]{{\small{GS: #1}}}}
\newcommand{\GSCHANGE}[1]{\textcolor{orange}{#1}}
\newcommand{\GSSIDENOTE}[1]{\todo[color=yellow!40]{{\small{GS: #1}}}}
...
% \newcommand{\nmodels}{\not\models}
\newcommand{\cnfnamed}[2][]{\ensuremath{\mathsf{CNF_{#2}^{#1}}}}
\newcommand{\DeMorganCNF}{\cnfnamed{DM}}
\newcommand{\TseitinCNF}{\cnfnamed{TS}}
%% RS la "s" in TS non e' prima lettera
\renewcommand{\TseitinCNF}{\cnfnamed{Ts}}
\newcommand{\PlaistedCNF}{\cnfnamed{PG}}
\newcommand{\PlaistedCNFdup}{\cnfnamed[\mathsf{dup}]{PG}}
\newcommand{\NNF}[1]{\ensuremath{\mathsf{NNF}(#1)}}
\newcommand{\NNFna}{\ensuremath{\mathsf{NNF}}}
\newcommand{\NNFPlaisted}{\NNFna{}+\PlaistedCNF{}}
\newcommand{\allA}{\ensuremath{\mathbf{A}}\xspace}
\newcommand{\allalpha}{\ensuremath{\boldsymbol{\alpha}}\xspace}
...
\newcommand{\TAna}{\ensuremath{\calt\hspace{-.1cm}\cala}\xspace}
\newcommand{\TTA}[1]{\ensuremath{\calt\hspace{-.1cm}\calt\hspace{-.1cm}\cala(#1)}\xspace}
\newcommand{\muA}{\ensuremath{\mu^\allA}\xspace}
\newcommand{\mualpha}{\ensuremath{\mu^{\allalpha}}\xspace}
\newcommand{\etaA}{\ensuremath{\eta^\allA}\xspace}
\newcommand{\muAprime}{\ensuremath{\muA{}'}\xspace}
\newcommand{\muAsecond}{\ensuremath{\muA{}''}\xspace}
\newcommand{\muB}{\ensuremath{\mu^\allB}\xspace}
\newcommand{\etaB}{\ensuremath{\eta^\allB}\xspace}
\newcommand{\etaBprime}{\ensuremath{\etaB{}'}\xspace}
\newcommand{\residual}[2]{\ensuremath{#1|_{#2}}\xspace}
\newcommand{\exdone}{\ensuremath{\hfill\diamond}}
\newcommand{\vi}{\ensuremath{\varphi}}
\newcommand{\vinnf}{\ensuremath{\varphi'}}
\newcommand{\vicnf}{\ensuremath{\psi}}
\newcommand{\vicnfts}{\ensuremath{\TseitinCNF(\vi)}}
\newcommand{\vicnfdm}{\ensuremath{\DeMorganCNF(\vi)}}
\newcommand{\vicnfpg}{\ensuremath{\PlaistedCNF(\vi)}}
\newcommand{\vicnfgen}{\ensuremath{\cnfnamed{}(\vi)}}
\newcommand{\vinnfcnfpg}{\ensuremath{\PlaistedCNF(\NNF{\vi})}}
\newcommand{\any}{\ensuremath{*}}

\newcommand{\minus}{\scalebox{0.5}[0.5]{\(-\)}}
\newcommand{\plus}{\scalebox{0.5}[0.5]{\(+\)}}
\newcommand{\poslab}[1]{\ensuremath{#1^{\plus}}}
\newcommand{\neglab}[1]{\ensuremath{#1^{\minus}}}

\newcommand{\eqcomment}[1]{\textcolor{darkgreen}{//#1}}
\newcommand{\overbar}[1]{\mkern 1.5mu\overline{\mkern-1.5mu#1\mkern-1.5mu}\mkern 1.5mu}
\newcommand{\Iff}{\ensuremath{\Leftrightarrow}\xspace}
\newcommand{\eqind}{\ensuremath{\stackrel{\text{\scalebox{.7}{ind}}}{=}}\xspace}
\newcommand{\Iffind}{\ensuremath{\stackrel{\text{\scalebox{.7}{ind}}}{\Iff}}\xspace}

\renewcommand{\B}{\ensuremath{\mathbb{B}}\xspace}
...
\def\newplaintheorem#1#2{%
\newtheorem{#1plain}{#2}%
\newenvironment{#1}{\begin{#1plain} \em}{\end{#1plain}}}
\newplaintheorem{generalremark}{General Remark}
\crefname{generalremark}{General Remark}{General Remarks}

\newcommand{\ADDED}[1]{\textcolor{blue}{#1}}
\newenvironment{added}{\color{blue}}{\normalcolor}

\newcommand{\tabularallsat}{\textsc{TabularAllSAT}\xspace}
\newcommand{\tabularallsmt}{\textsc{TabularAllSMT}\xspace}
\newcommand{\df}{\textsc{d4}}
\newcommand{\decdnnf}{\textsc{model-graph}\xspace}
\newcommand{\dfdecdnnf}{\textsc{\df+\decdnnf}\xspace}
