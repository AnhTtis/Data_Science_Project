...
\newcommand{\GMTODO}[1]
{\todo[inline,color=blue!20]{{\small{#1}}}}
\newcommand{\GSTODO}[1]
...
% \newcommand{\nmodels}{\not\models}
\newcommand{\cnfnamed}[1]{\ensuremath{\mathsf{CNF_{#1}}}}
...
\newcommand{\NNFna}[1]{\ensuremath{\mathsf{NNF}}}
...
\renewcommand{\RSCHANGE}[1]{{#1}}
\renewcommand{\GMCHANGE}[1]{{#1}}
\renewcommand{\GSCHANGE}[1]{{#1}}
\renewenvironment{gmchange}{}{}
\renewenvironment{rschange}{}{}
\renewcommand{\ignoreinlong}[1]{}
\renewcommand{\ignoreinshort}[1]{#1}