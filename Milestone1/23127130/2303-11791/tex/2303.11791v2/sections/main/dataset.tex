...
We ask 3 subjects (each changes 3 different clothes) to walk at various speeds to generalize the dataset.
...
\begin{table}
  ...
  \caption{\textbf{A brief summary of existing NLOS datasets.} Transient and Steady under the Modal column denote time-resolved transient-state and conventional RGB steady-state respectively. ``/" denotes difficulty to report the data size due to mixed data types.}
  \label{tab:datasets}
  \vspace{-10pt}
\end{table}
