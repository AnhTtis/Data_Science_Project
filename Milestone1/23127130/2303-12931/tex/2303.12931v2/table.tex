...
%%%%%%%%%%%%%%%%%%%%%%
& $\mathrm{N}_p(\theta%\boldsymbol{\theta}
, \Sigma)$ & $N_p(\eps_k \theta%\boldsymbol{\theta}
, \eps_k \Sigma)$ & &   \\
%%%%%%%%%%%%%%%%%%%%%%
& $\mathrm{Multinomial}_p(r, \theta%\boldsymbol{\theta}
)$ & 
$\mathrm{Multinomial}_p(\eps_k r, \theta%\boldsymbol{\theta}
)$  & & \\
%%%%%%%%%%%%%%%%%%%%%%
\cline{2-5}
%%%%%%%%%%%%%%%%%%%%%%
...
In cases where they are used, $\epsilon_k > 0$ is a tuning parameter such that $\sum_{k=1}^K \epsilon_k = 1$, $n_1,\dots,n_K$ are integers that sum to $n$, and all other parameters are constrained appropriately. Note that Examples \ref{ex:weibull}, \ref{ex:scaled-beta}, and \ref{ex:shifted-exponential} are discussed in the supplementary materials.
}
