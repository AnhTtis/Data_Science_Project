...
Suppose that we want to \emph{fit} and \emph{validate} a model using %on the basis of 
...
additional technical details are deferred to the supplementary materials.  
...
\emph{Right:} Generalized data thinning splits each observation into two parts that are independent and that can be used to recover the original observation $T(\xo, \Xt{2})=X$. 
