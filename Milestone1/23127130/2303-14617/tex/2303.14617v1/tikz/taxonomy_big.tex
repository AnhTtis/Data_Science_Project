...
%   },
  ...
  L3/.style={rectangle, draw, fill=gray!20, rounded corners, thick,edge={line width=0.5pt}, text width=3cm},
...
\begin{forest}
    ...
    \textbf{Query Engine},L3
        [\textbf{Graph}\\{\hyperref[sec:graphs]{Section \ref{sec:graphs}}},L3
            [Modality,L3
                [Triple KGs,L55
        ...
        [\textbf{Learning}\\ {\hyperref[sec:learning]{Section \ref{sec:learning}}},L3
            [Learning,L3
                [Transductive,L25
        ...
        [\textbf{Queries}\\ {\hyperref[sec:queries]{Section \ref{sec:queries}}},L3
            [Query Operators,L3
                [Projection + JOIN,L45
            ...
            [Projected Variables,L3
                ...
                [Arbitrary non-anchor \\ nodes + literals,L45
                    [None ,L45
                    ]
                ]
            ]
