\begin{table}
\centering
\caption{From of the temporal propagation. 'Perspective and Object' mean propagating temporal information via image features and object queries respectively. 'Propagated' indicates concatenating the foreground object queries of the last frame with the current frame.}
\vspace{2pt}
