...
\begin{figure*}[ht]
    \centering
    \includegraphics[scale=0.6]{Pictures/Logical-Operators.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[scale=0.5]{Pictures/relation-rotation.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[scale=0.7]{Pictures/query-structures.png}
