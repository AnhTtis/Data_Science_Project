...
%\newcommand{\bianco}[1]{\color{bianco} #1}
\newcommand{\red}{\textcolor{red}}

\tikzstyle{block} = [rectangle, fill=bianco,
...
% \usepackage{lastpage}
% \jmlrheading{}{}{1-\pageref{LastPage}}{}{}{}{Beraha, Favaro and Sesia}

% % Short headings should be running head and authors last names

% % \ShortHeadings{Random measure priors in Bayesian recovery from sketches}{Beraha, Favaro and Sesia}
% \firstpageno{1}
...
The authors thank the Action Editor, Professor Debdeep Pati, and three anonymous Referees for their helpful suggestions. M.~B.~and S.~F.~were funded by the European Research Council under the Horizon 2020 research and innovation programme, grant 817257. M.~B.~and S.~F.~also gratefully acknowledge support from the Italian Ministry of Education, University and Research, ``Dipartimenti di Eccellenza" grant 2023-2027.
