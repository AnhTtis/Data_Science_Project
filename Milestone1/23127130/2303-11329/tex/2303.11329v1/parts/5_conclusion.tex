...
Second, we assume that both the 3D scene and sound sources are stationary.
Third, we do not evaluate our model on extreme viewpoint changes~\cite{ma2022virtual}, which requires reasoning about images that have little or no overlap, and is largely solved using supervised methods.
