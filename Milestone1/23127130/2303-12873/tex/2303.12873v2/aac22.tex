...
The plot to the right, strong scaling, shows the decrease in time-to-solution that can be gained by keeping the computational domain constant, but increasing provided parallel computing power.
