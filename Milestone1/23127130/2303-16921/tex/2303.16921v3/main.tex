...
In the special case that $\mathcal{F}$ describes a finite group symmetry $G$, then $\mathcal{A}^{\mathcal{F}}$  is simply the subalgebra $\mathcal{A}^G$ of $G$-invariant states. 
