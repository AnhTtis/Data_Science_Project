...
\wprp =\!\!\sum_{-\pimax}^{\pimax}\!\!\left(\frac{D_1D_2 - D_1R_2 - D_2R_1}{R_1R_2} + 1 \right),
...
\input{fig_wp_mag_bins_ir}

\input{fig_wp_mag_bins_opt}

\input{fig_wp_full_sample}

\input{table_scatter_params}
