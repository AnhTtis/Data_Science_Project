...
\input{figures/fig_wp_lrg}

\input{figures/fig_color_color}

\input{figures/fig_data_sed}

\input{tables/table_data_sed}
...
\input{figures/fig_hod_lrg}

\input{tables/table_hod_stats}
...
\input{tables/table_hod_params_priors}

\input{tables/table_hod_params}
