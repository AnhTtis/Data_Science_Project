...
\input{figures/fig_zstarve_example}
...
\input{figures/fig_abs_mag_cuts}

\input{figures/fig_cmd}

\input{tables/table_masks}

\input{tables/table_parent_samples}

\input{tables/table_mag_bins}
