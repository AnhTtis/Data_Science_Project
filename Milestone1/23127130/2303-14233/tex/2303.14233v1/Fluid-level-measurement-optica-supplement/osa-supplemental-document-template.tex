...
\section{Derivation of Image Distance function}
Labeled values are in reference to items in figure 1 of the main document
\label{supp:derivation}
$$
h = h_0 + L + h_1 
$$
since $h_0$ varies with $L$ but $h$ is constant we reframe $h_0$ as
$$
h_0 = (h - h_1) - L
$$
