...
\end{equation}
suggesting that distances scaling with $N$ should be achievable. The vanishing rate is also not inherently problematic as this is also the case for other error-correcting codes like the $[[A^2, 2, A]]$ toric code \cite{kitaev_fault_tolerant_quantum_2003}.
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.8\textwidth]{figures/volume_law.png}
