...
\begin{table*}[]
  ...
  \renewcommand{\tabcolsep}{15pt}
   %\small
   \caption{\textbf{\texttt{Seen} Setting.} The affordance corresponding to each object and the number of its corresponding images and point clouds.}
   \label{dataset:Seen}
   \vspace{5pt}
...
\textbf{Bottle}                   & wrapgrasp,contain,open,pour          & 253            & 60                                 & 288              & 60              \\
\textbf{Bowl}                     & wrapgrasp,contain,pour               & 118            & 27                                 & 132              & 27              \\
...
\par For the paradigm that establishes the mapping between object structures and semantic affordance categories, the limited generalization does not only exist on unseen object categories. If some structures in the object are not associated with the affordance category, which means, for the affordance category, some structures are unseen, it is still hard to generalize. Thus, we make another \textbf{\texttt{Unseen\_2}} partition to verify the effectiveness of our learning paradigm in this situation. Specifically, we remove one or more affordance categories of some objects from the training set and only let them appear in the testing set. The objects and affordances in the testing are screened according to criteria, for example, the affordance ``grasp'' corresponding to ``scissors'' is chosen for the testing set, then the training set should contain other objects with the affordance ``grasp'', like ``knife''. In this way, the model can learn the affordance through other objects that display the same interaction, and during the inference process, even if the object affordance is not in the training set, it can also be inferred through the interaction in the image. This partition simulates the reasoning and transformation of the objective world by the embodied agent after interacting with the environment. Finally, we select $11$ object categories with $8$ affordance classes to the testing set. Tab. \ref{dataset:Unseen_train} and Tab. \ref{dataset:Unseen_test} show the \textbf{\texttt{Unseen\_2}} partition. 
...
\begin{table}[]
  ...
  \renewcommand{\tabcolsep}{4pt}
   %\small
   \caption{\textbf{\texttt{Unseen\_2} Train.} The object in the training set and its corresponding affordance type in the \textbf{\texttt{Unseen\_2}}, as well as the number of corresponding images and point clouds.}
   \label{dataset:Unseen_train}
   \vspace{5pt}
\begin{tabular}{c|c|cc}
\toprule
\multirow{2}{*}{\textbf{Objects}} & \multirow{2}{*}{\textbf{Affordance}} & \multicolumn{2}{c}{\textbf{Train Number}}                 \\ \cmidrule{3-4} 
                                  &                                      & \multicolumn{1}{c|}{\textbf{Image}} & \textbf{Point} \\ \midrule
\textbf{Vase}                     & contain                              & 66                                & 83             \\
\textbf{Bed}                      & sit                                  & 42                                & 42             \\
\textbf{Microwave}                & open                                 & 77                                & 77             \\
\textbf{Door}                     & push,open                            & 130                               & 130            \\
\textbf{Earphone}                 & listen,grasp                         & 179                               & 179            \\
\textbf{Bottle}                   & wrapgrasp,open                       & 197                               & 197            \\
\textbf{Bowl}                     & contain,pour                         & 80                                & 84             \\
\textbf{Laptop}                   & display,press                        & 296                               & 337            \\
\textbf{Clock}                    & display                              & 47                                & 257            \\
\textbf{Scissors}                 & cut,stab                             & 37                                & 39             \\
\textbf{Mug}                      & grasp,pour                           & 86                                & 87             \\
\textbf{Faucet}                   & open,grasp                           & 244                               & 244            \\
\textbf{StorageFurniture}         & contain,open                         & 270                               & 376            \\
\textbf{Bag}                      & open,grasp,lift                      & 72                                & 72             \\
\textbf{Chair}                    & sit,move                             & 996                               & 1000           \\
\textbf{Dishwasher}               & contain                              & 46                                & 70             \\
\textbf{Refrigerator}             & contain,open                         & 148                               & 148            \\
\textbf{Table}                    & move,support                         & 501                               & 1000           \\
\textbf{Hat}                      & wear,grasp                           & 178                               & 178            \\
\textbf{Keyboard}                 & press                                & 125                               & 125            \\
\textbf{Knife}                    & cut,grasp                            & 211                               & 211            \\
\textbf{TrashCan}                 & contain,open,pour                    & 148                               & 252            \\ \bottomrule
\end{tabular}
\end{table}
...
\begin{table}[]
  ...
  \renewcommand{\tabcolsep}{8pt}
   %\small
   \caption{\textbf{\texttt{Unseen\_2} Test.} The categories of objects and the corresponding affordance type in the \textbf{\texttt{Unseen\_2}} testing set, ``Test Number'' represents the number of point clouds and images, which are equal.}
   \label{dataset:Unseen_test}
   \vspace{5pt}
\begin{tabular}{c|c|c}
\toprule
\textbf{Objects}    & \textbf{Affordance} & \textbf{Test Number} \\ \midrule
\textbf{Vase}       & wrapgrasp           & 166           \\
\textbf{Display}    & display             & 262           \\
\textbf{Bed}        & lay                 & 103           \\
\textbf{Microwave}  & contain             & 61            \\
\textbf{Bottle}     & contain,pour        & 117           \\
\textbf{Bowl}       & wrapgrasp           & 66            \\
\textbf{Scissors}   & grasp               & 16            \\
\textbf{Mug}        & wrapgrasp,contain   & 91            \\
\textbf{Bag}        & contain             & 17            \\
\textbf{Dishwasher} & open                & 58            \\
\textbf{Knife}      & stab                & 29            \\ \bottomrule
\end{tabular}
\end{table}
...
\multirow{4}{*}{\textbf{\texttt{Ours}}}    & \textbf{AUC}     & 76.38          & 86.10            & 99.30         & 86.38         & 91.72        & 95.27        & 85.00            & 66.36              & 84.57         & 72.50         & 89.36            & 77.45         & 85.22           & 72.88         & 89.66          & 90.61        & 75.41         \\
                                  & \textbf{aIOU}     & 14.87          & 15.32            & 45.98         & 23.45         & 26.06        & 37.16        & 11.24            & 5.70               & 15.31         & 6.79         & 29.15            & 6.27          & 15.94           & 6.20          & 14.29          & 14.02        & 7.49         \\
                                  & \textbf{SIM}    & 0.488          & 0.497            & 0.651         & 0.338         & 0.650         & 0.706        & 0.707            & 0.585              & 0.452         & 0.488         & 0.653            & 0.382         & 0.655           & 0.563         & 0.375          & 0.651        & 0.282         \\
                                  & \textbf{MAE}     & 0.113          & 0.093            & 0.024         & 0.051         & 0.086        & 0.069        & 0.099            & 0.137              & 0.102         & 0.143         & 0.088            & 0.092         & 0.085           & 0.123         & 0.064          & 0.067        & 0.089         \\ \bottomrule
\end{tabular}
\end{table*}
...
\multirow{4}{*}{\textbf{\texttt{Ours}}} & \textbf{AUC}  & 70.41                      & 84.59        & 71.97        & 50.64          & 83.83         & 83.26            & 96.58         & 78.48          & 76.17          & 94.12        \\
                            & \textbf{aIOU} & 6.98                       & 17.71        & 8.61         & 1.81           & 5.74          & 14.81            & 10.21         & 4.64           & 7.74           & 22.12        \\
                            & \textbf{SIM}  & 0.437                      & 0.518        & 0.419        & 0.544          & 0.160         & 0.351            & 0.473         & 0.551          & 0.275          & 0.586        \\
                            & \textbf{MAE}  & 0.135                      & 0.134        & 0.140        & 0.155          & 0.089         & 0.141            & 0.049         & 0.096          & 0.114          & 0.063        \\ \bottomrule
\end{tabular}
\end{table*}
...
% \small
  ...
  \caption{{\textbf{Evaluation Metrics in \textbf{\texttt{Unseen\_2}}.} Objective results of each affordance type for all comparison methods in the \textbf{\texttt{Unseen\_2}}. ``wrap.'' denotes ``wrapgrasp''}}
\label{table:results_Unseen}
\vspace{5pt}
\begin{tabular}{c|c|cccccccc}
\toprule
\textbf{Method}                   & \textbf{Metrics}             & \textbf{contain} & \textbf{lay} & \textbf{pour} & \textbf{wrap.} & \textbf{open} & \textbf{display} & \textbf{stab} & \textbf{grasp} \\ \midrule
\multirow{4}{*}{\textbf{\texttt{Baseline}}}    & \textbf{AUC}      & 57.65            & 77.65        & 56.87         & 52.92              & 57.88         & 58.32            & 38.62         & 36.81          \\
                                  & \textbf{aIOU}      & 4.11             & 11.29        & 5.76          & 3.81               & 2.48          & 3.93             & 2.28          & 1.44           \\
                                  & \textbf{SIM}     & 0.406            & 0.466        & 0.406         & 0.464              & 0.328         & 0.313            & 0.228         & 0.177          \\
                                  & \textbf{MAE}      & 0.191            & 0.119        & 0.183         & 0.225              & 0.217         & 0.248            & 0.375         & 0.392          \\ \midrule
\multirow{4}{*}{\textcolor[rgb]{0.2,0.8,0.1}{\texttt{\textbf{MBDF}}} \cite{tan2021mbdf}}    & \textbf{AUC}     & 56.50             & 79.15        & 58.36         & 53.73              & 56.36         & 60.17            & 41.75         & 49.30           \\
                                  & \textbf{aIOU}     & 4.30             & 10.98        & 7.57          & 2.08               & 3.46          & 4.21             & 1.68          & 1.09           \\
                                  & \textbf{SIM}     & 0.477            & 0.500        & 0.422         & 0.451              & 0.319         & 0.381            & 0.239         & 0.157          \\
                                  & \textbf{MAE}      & 0.179            & 0.105        & 0.180         & 0.183              & 0.182         & 0.226            & 0.358         & 0.346          \\ \midrule
\multirow{4}{*}{\textcolor[rgb]{0.2,0.8,0.1}{\texttt{\textbf{PMF}}} \cite{zhuang2021perception}}     & \textbf{AUC}     & 55.07            & 82.43        & 60.67         & 49.66              & 62.19         & 61.84            & 43.31         & 51.83          \\
                                  & \textbf{aIOU}     & 3.25             & 11.34        & 8.43          & 2.32               & 4.60          & 4.18             & 2.42          & 2.12           \\
                                  & \textbf{SIM}     & 0.413            & 0.526        & 0.447         & 0.469              & 0.396         & 0.375            & 0.233         & 0.148          \\
                                  & \textbf{MAE}      & 0.160            & 0.130        & 0.155         & 0.187              & 0.194         & 0.230            & 0.297         & 0.301          \\ \midrule
\multirow{4}{*}{\textcolor[rgb]{0.2,0.8,0.1}{\texttt{\textbf{FRCNN}}} \cite{xu2022fusionrcnn}}   & \textbf{AUC}      & 63.86            & 82.82        & 65.93         & 48.52              & 63.74         & 63.47            & 62.96         & 55.56          \\
                                  & \textbf{aIOU}    & 6.00             & 12.28        & 8.60          & 4.66               & 5.32          & 4.32             & 2.40          & 1.97           \\
                                  & \textbf{SIM}    & 0.434            & 0.514        & 0.459         & 0.495              & 0.344         & 0.339            & 0.260         & 0.192          \\
                                  & \textbf{MAE}   & 0.165            & 0.102        & 0.153         & 0.197              & 0.189         & 0.218            & 0.225         & 0.283          \\ \midrule
\multirow{4}{*}{\textcolor[rgb]{0.99,0.5,0.0}{\textbf{\texttt{ILN}}} \cite{chen2022imlovenet}}     & \textbf{AUC}      & 74.20            & 80.27        & 64.00         & 47.20              & 58.46         & 62.70            & 47.80         & 53.89          \\
                                  & \textbf{aIOU}      & 5.67             & 12.71        & 3.29          & 2.29               & 2.64          & 4.26             & 3.20          & 2.60           \\
                                  & \textbf{SIM}      & 0.506            & 0.451        & 0.258         & 0.564              & 0.328         & 0.335            & 0.244         & 0.260          \\
                                  & \textbf{MAE}      & 0.167            & 0.149        & 0.262         & 0.190              & 0.192         & 0.196            & 0.198         & 0.232          \\ \midrule
\multirow{4}{*}{\textcolor[rgb]{0.99,0.5,0.0}{\textbf{\texttt{PFusion}}} \cite{xu2018pointfusion}} & \textbf{AUC}      & 60.10            & 82.66        & 52.89         & 51.51              & 63.00         & 63.55            & 57.62         & 59.63          \\
                                  & \textbf{aIOU}      & 5.38             & 16.18        & 2.39          & 2.97               & 5.06          & 4.36            & 3.43          & 3.10           \\
                                  & \textbf{SIM}      & 0.520            & 0.587        & 0.281         & 0.491              & 0.255         & 0.339            & 0.324         & 0.238          \\
                                  & \textbf{MAE}      & 0.149            & 0.143        & 0.234         & 0.172              & 0.131         & 0.183            & 0.253         & 0.260          \\ \midrule
\multirow{4}{*}{\textcolor[rgb]{0.99,0.5,0.0}{\textbf{\texttt{XMF}}} \cite{aiello2022cross}}     & \textbf{AUC}   & 57.89            & 83.21        & 60.75         & 55.92              & 75.05         & 65.25            & 78.07         & 60.84          \\
                                  & \textbf{aIOU}      & 4.75             & 13.76        & 7.64          & 4.68               & 7.61          & 4.58            & 5.75          & 2.59           \\
                                  & \textbf{SIM}      & 0.475            & 0.533        & 0.494         & 0.481              & 0.320         & 0.356            & 0.247         & 0.233          \\
                                  & \textbf{MAE}     & 0.173            & 0.125        & 0.192         & 0.166              & 0.192         & 0.180            & 0.203         & 0.249          \\ \midrule
\multirow{4}{*}{\textbf{\texttt{Ours}}}     & \textbf{AUC}     & 73.16            & 85.17        & 78.42         & 58.63              & 83.13          & 68.85            & 84.42         & 75.24           \\
                                  & \textbf{aIOU}      & 9.12             & 18.69        & 22.13         & 4.67               & 13.36          & 5.64             & 11.87          & 6.46           \\
                                  & \textbf{SIM}      & 0.419            & 0.572        & 0.340         & 0.553              & 0.240         & 0.361            & 0.343         & 0.587          \\
                                  & \textbf{MAE}      & 0.126       & 0.114        & 0.120         & 0.154              & 0.067         & 0.175            & 0.101         & 0.107          \\ \bottomrule
\end{tabular}
\end{table*}
...
\item [$\bm{-}$] \textcolor[rgb]{0.99,0.5,0.0}{\textbf{\texttt{XMFnet (XMF)}}} \cite{aiello2022cross}: This study focus on point cloud completion, it is the SOTA on cross-modal point cloud completion task. The proposed framework is called XMFnet, which is composed of two modality-specific feature extractors that capture localized features of the input point cloud and image. For the extracted features, it uses the combined cross-attention and self-attention to fuse the features of the two modalities. And we apply this block to compute the image and point cloud feature in the pipeline.
\end{itemize}
...
\par We give the overall results of each method in the main paper. Here, we display the results of each affordance respectively. The experimental results of all methods in \textbf{\texttt{Seen}} are shown in Tab. \ref{table:results_Seen}. And \textbf{\texttt{Unseen}} results are shown in Tab. \ref{table:obj_useen}. As can be seen, our method achieves the best results under most affordance categories, which demonstrates the superiority of our method in grounding 3D object affordance. In addition, we also give the evaluation metrics in \textbf{\texttt{Unseen\_2}}, the results are shown in Tab. \ref{table:results_Unseen}. The results indicate that our model has great performance whether it is for unseen objects or structures that have not been mapped to a certain affordance. These experiments indicate the stability and the generalization of our model. At the same time, other methods also achieve considerable objective results under our setting, which proves the rationality of the setting.
...
\textbf{Setting} & \textbf{Metrics} & \textbf{S-Atten.} & \textbf{EM-Atten.} & \textbf{MLP} \\ 
 \midrule
\multirow{4}{*}{\textbf{\texttt{Seen}}} & \textbf{AUC} &85.01 & 82.37 & 82.93 \\
 &\textbf{aIOU}  & 19.71 & 16.03 & 17.56  \\
 & \textbf{SIM}  & 0.547 & 0.521 & 0.527  \\ 
 & \textbf{MAE}  & 0.088 & 0.102 & 0.948  \\ 
 \midrule
\multirow{4}{*}{\textbf{\texttt{Unseen}}} & \textbf{AUC} & 70.54 & 67.45 & 68.12 \\
 &\textbf{aIOU}  & 8.65 & 6.78 & 7.04  \\
 & \textbf{SIM}  & 0.440 & 0.429 & 0.432  \\ 
 & \textbf{MAE}  & 0.141 & 0.174 & 0.159  \\
 \bottomrule
\end{tabular}
\end{table}
...
\textbf{Setting} & \textbf{En. P} & \textbf{En. I} & \textbf{AUC} & \textbf{aIOU} & \textbf{SIM} & \textbf{MAE} \\ 
 \midrule
\multirow{6}{*}{\textbf{\texttt{Seen}}} & \multirow{3}{*}{\textbf{PN}} &Res18 & 85.01 & 19.71 & 0.547 & 0.088 \\
 & &  Res34  & 85.25 & 19.70 & 0.552 & 0.086 \\
 & &  Res50 & 85.53 & 20.13 & 0.561 & 0.082 \\ 
 \cmidrule{2-7} 
 & \multirow{3}{*}{\textbf{PM}} & Res18 & 84.89 & 19.47 & 0.543 & 0.095 \\
 & & Res34 & 84.98 & 19.66 & 0.548 & 0.088 \\
 & & Res50 & 85.31 & 19.93 & 0.554 & 0.084 \\
 \midrule
\multirow{6}{*}{\textbf{\texttt{Unseen}}} & \multirow{3}{*}{\textbf{PN}} & Res18 & 70.54 & 8.65 & 0.440 & 0.141 \\
 & & Res34 & 70.68 & 8.70 & 0.442 & 0.137 \\
 & & Res50& 71.12 & 8.97 & 0.458 & 0.133 \\ 
 \cmidrule{2-7} 
...
1                                               & 0.3                                             & 0.5                                             & \cellcolor{mygray}\textbf{85.01} & \cellcolor{mygray}\textbf{19.71} & \cellcolor{mygray}\textbf{0.547} & \cellcolor{mygray}\textbf{0.088} & \cellcolor{mygray}\textbf{70.54} & \cellcolor{mygray}\textbf{8.65} & \cellcolor{mygray}\textbf{0.440} & \cellcolor{mygray}\textbf{0.141} \\
0.8                                             & 0.3                                             & 0.5                                             & 83.16          & 17.05          & 0.521          & 0.116          & 68.92          & 7.25          & 0.421          & 0.175          \\
1                                               & 0.3                                             & 0.7                                             & 83.78          & 17.75          & 0.527          & 0.112          & 69.03          & 7.52          & 0.429          & 0.168          \\
1                                               & 0.3                                             & 0.3                                             & 83.49          & 17.68          & 0.525          & 0.114          & 69.00          & 7.47          & 0.426          & 0.173          \\
1                                               & 0.5                                             & 0.5                                             & 83.93          & 18.05          & 0.531          & 0.104          & 69.55          & 7.85          & 0.432          & 0.156           \\
1                                               & 0.1                                             & 0.5                                             & 83.42          & 17.84          & 0.525          & 0.115          & 69.17          & 7.60          & 0.425          & 0.163          \\
1                                               & 0.3                                             & 0                                             & 82.42          & 15.84          & 0.497          & 0.183          & 66.23          & 6.92          & 0.402          & 0.273          \\ 
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Setting} & \textbf{Metrics} & \textbf{1} & \textbf{2} & \textbf{4} & \textbf{6} \\ 
 \midrule
\multirow{4}{*}{\textbf{\texttt{Seen}}} & \textbf{AUC}  &84.75 & 85.01 & 85.44 & 84.82\\
 &\textbf{aIOU}  & 19.45 & 19.71 & 19.83  & 19.65\\
 & \textbf{SIM}  & 0.540 & 0.547 & 0.551  & 0.547\\ 
 & \textbf{MAE}  & 0.095 & 0.088 & 0.083  & 0.090\\ 
 \midrule
\multirow{4}{*}{\textbf{\texttt{Unseen}}} & \textbf{AUC} & 69.98 & 70.54 & 71.02 & 70.32 \\
 &\textbf{aIOU}  & 8.37 & 8.65 & 8.72  & 8.58\\
 & \textbf{SIM}  & 0.429 & 0.440 & 0.453  & 0.433\\ 
 & \textbf{MAE}  & 0.150 & 0.141 & 0.138  & 0.144\\
 \bottomrule
\end{tabular}
\end{table}
...
\begin{figure*}[]
	\centering
		\begin{overpic}[width=0.90\linewidth]{figs/sup_comparative_Unseen.pdf}

        \put(5,99){\textbf{Lay}}
        \put(16,99){\textbf{Open}}
        \put(25.5,99){\textbf{Wrapgrasp}}
        \put(38.5,99){\textbf{Grasp}}
	...
	\end{overpic}
	\caption{\textbf{Visual results.} We give some visual results of all comparison methods and our method in the \textbf{\texttt{Unseen}} and \textbf{\texttt{Unseen\_2}}.}
...
\begin{figure*}[h]
	\centering
		\begin{overpic}[width=0.86\linewidth]{figs/sup_ourresult.pdf}
	...
	\end{overpic}
	\caption{\textbf{Visual results of Our Method.} We give more results of our method in \textbf{\texttt{Seen}}, \textbf{\texttt{Unseen}}, and \textbf{\texttt{Unseen\_2}}.}
	\label{Ours_results}
\end{figure*}
