...
\keywords{defect pattern recognition \and wafer map \and dimensionality reduction}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.4]{Definitions/One-defect.pdf}
...
\begin{figure}
    \centering
   \includegraphics[scale=0.6]{Definitions/median.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.53]{Definitions/accuracies.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.45]{Definitions/pca.pdf}
