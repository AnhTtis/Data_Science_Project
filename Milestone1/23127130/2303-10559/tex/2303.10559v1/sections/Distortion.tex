...
\begin{figure}[!t]
  ...
  %\vspace{-20pt}
  \caption{Architecture of FE-GAN. The figure is from ~\cite{FE-GAN}.}
  \label{fig:FE-GAN}
  \vspace{-0.3cm}
\end{figure}
...
\begin{figure}[!t]
  ...
  %\vspace{-20pt}
  \caption{Architecture of RSC-Net. The figure is from ~\cite{RSC-Net}.}
  \label{fig:RSC-Net}
  \vspace{-0.06cm}
\end{figure}
...
\begin{figure}[!t]
  ...
  %\vspace{-20pt}
  \caption{Architecture of AW-RSC. The figure is from ~\cite{AW-RSC}.}
  \label{fig:AW-RSC}
  \vspace{-0.3cm}
\end{figure}
