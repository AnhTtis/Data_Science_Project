...
\author{
Jorge Ignacio Gonz\'alez C\'azares\footnote{Universidad Nacional Autónoma de México, IIMAS, \texttt{jorge.gonzalez@sigma.iimas.unam.mx}}\and
Feng Lin\footnote{University of Warwick, \texttt{feng.lin.1996@outlook.com}}\and
Aleksandar Mijatovi\'c\footnote{University of Warwick \& The Alan Turing Institute, \texttt{a.mijatovic@warwick.ac.uk}}}
...
% Text Node
\draw    (180.33,211) -- (384.33,211) -- (384.33,271) -- (180.33,271) -- cycle  ;
...
\begin{proof}[Proof of Proposition~\ref{prop:joint_law}]
...
\begin{proof}[Proof of Proposition~\ref{prop:undershoot}]
...
\begin{proof}[Proof of Proposition~\ref{prop:psi_1}]
...
\begin{proof}[Proof of Proposition~\ref{prop:psi_2}]
...
\begin{proof}[Proof of Lemma~\ref{lem:bound_of_expectation_complicated_thing}]
...
\begin{proof}[Proof of Theorem~\ref{thm:expectation_of_time_complexity}]
...
\begin{proof}[Proof of Theorem~\ref{thm:tempered_expect_time}]
...
\begin{proof}[Proof of Corollary~\ref{cor:improved_tempered_expected_time}]
...
FL is funded by The China Scholarship Council and The University of Warwick  PhD scholarship. 
...
\begin{proof}[Proof of Theorem~\ref{thm:joint_law}]
...
\begin{proof}[Proof of Lemma~\ref{lem:exp_moment}]
...
\begin{figure}[ht]
\centering
    \includegraphics[width=12cm]{Python_output.jpeg}\caption{Rounding errors\label{fig:python} in Python produce singular random variables.}
\end{figure}
