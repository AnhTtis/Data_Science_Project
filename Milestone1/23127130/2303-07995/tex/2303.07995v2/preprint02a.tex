...
\begin{figure}
    \begin{center}
    \includegraphics[width=.75\columnwidth]{images/figure6_updated.png}
    \end{center}
...
A closer examination of the individual engagement factor scores reveals indications that the participants paid close attention during the task completion, perceived the usability as good (in allignment with the SUS scores), found the prototype aesthetically appealing, and their experience rewarding (with medians around 4) -- all in anticipation of its general design objective. % modified sentence
