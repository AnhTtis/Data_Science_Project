...
Figure \ref{fig:figs1} presents the two (NLS and GP) C-statistic learning curves as a function of sample size. Both GP and NLS work well with most predicted C-statistics falling within the 95\% CIs for most sample sizes. Table \ref{tab:tabs1} presents the point estimation of learning learning curve model. The GP model appears more robust even with only 5 data points and 100 total sample size. GP and NLS had similar results after the total sample size were 300 or more.  
