...
\begin{align}
\widehat{\cC}^{(3, 3)}_{N,p}(\tau_2) &=\left[ 1+\frac{2p}{3}\right] \frac{18 N \zeta(3)}{\tau_2 \pi}-\left[1+ { \left(5N^2+67\right) p \over \left(N^2{+}5\right) \left(N^2{+}7\right)  } \left( \frac{ N^2+5 }{6 }+\frac{ p}{3  } \right) \right] \frac{90 N^2 \zeta(5)}{\tau_2^{2} \pi^{2}} \\
