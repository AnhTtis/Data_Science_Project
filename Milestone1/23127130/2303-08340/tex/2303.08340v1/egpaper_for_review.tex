...
Hongwei Qin$^{3}$ \and
Jifeng Dai$^{4}$ \and
Hongsheng Li$^{1}$\thanks{Corresponding author: Hongsheng Li} \\ \and
...
% During the flow refinement iterations, the information from the three frames are fused at the center frame.
