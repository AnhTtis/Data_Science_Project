...
While we implemented the HPX-SYCL integration using both the
\lstinline{host_task} SYCL feature and event polling, in the end, the version
...
requires further testing with codes beyond Octo-Tiger before up-streaming it.
Between these Kokkos changes and the SYCL integration, Octo-Tiger's overall
runtime behavior of the Kokkos SYCL execution space becomes comparable to the
