...
\begin{equation}
    \begin{aligned}
    \mathcal{L}_{(3D,2D)} = \frac{1}{2} \sum_{(f^{3D}, f^{2D}) \in B}  \text{NCE} (f^{3D},f^{2D}) + \\  \text{NCE} (f^{2D}, f^{3D}) 
    \end{aligned}
\end{equation}
\begin{equation}
    \begin{aligned}
    \mathcal{L}_{(3D,text)} = \frac{1}{2} \sum_{(f^{3D}, f^{text}) \in B}  \text{NCE} (f^{3D},f^{text}) + \\  \text{NCE} (f^{text}, f^{3D}) 
    \end{aligned}
\end{equation}
...
\begin{equation}
    \begin{aligned}
    \mathcal{L}_{P} = - \sum_{(f^{2D}, f^{text}) \in B} (\log \text{NCE} (f^{text},f^{2D}) + \\ \log \text{NCE} (f^{2D}, f^{text}) )
    \end{aligned}
\end{equation}
