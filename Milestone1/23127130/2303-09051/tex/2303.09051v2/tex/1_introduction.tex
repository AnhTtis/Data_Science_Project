...
We show that our defense strategy highly improves robustness compared to the current diffusion-based purification methods under our proposed evaluation scheme.
...
\begin{itemize}
    ...
    \item We propose a gradual noise-scheduling strategy for diffusion-based purification, improving the robustness of diffusion-based purification.
\end{itemize}