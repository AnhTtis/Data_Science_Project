\begin{table}[!t]
    ...
    \end{tabular}
    \caption{Robust accuracy of our defense strategy against several threat models $\ell_\infty (\epsilon = 8/255)$ on CIFAR-10. Square attack is a black-box attack, and the others are white-box attacks.}
