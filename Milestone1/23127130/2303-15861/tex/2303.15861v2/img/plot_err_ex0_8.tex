...
title={$\boldsymbol{\lambda=0.17}$},
legend style={at={(0.5,0.08)}, font=\scriptsize, anchor=south west, legend cell align=left, align=left, draw=white!15!black, legend columns=1}
]
\addplot [color=mycolor1, line width=1.1pt, mark size=3.5pt, mark=o, mark options={solid, mycolor1}]
  table[row sep=crcr]{%
16	0.00159603050915978\\
64	0.000394805182136802\\
256	0.000667843038369431\\
293.573294034139	12.5892541179417\\
};
\addlegendentry{\textsc{sle}}

\addplot [color=mycolor2, line width=1.1pt, mark size=3.5pt, mark=x, mark options={solid, mycolor2}]
  table[row sep=crcr]{%
16	0.00161883979208275\\
64	0.000400490771727264\\
80.9714738716388	12.5892541179417\\
};
\addlegendentry{\textsc{le}}

\addplot [color=mycolor3, line width=1.1pt, mark size=3.5pt, mark=+, mark options={solid, mycolor3}]
  table[row sep=crcr]{%
16	0.00205348101133825\\
18.9094163972867	12.5892541179418\\
};
...
\addplot [color=mycolor5, line width=1.1pt, mark size=3.5pt, mark=triangle, mark options={solid, mycolor5}]
  table[row sep=crcr]{%
16	2.09610027254457e-05\\
64.0000000000001	1.26704814926524e-06\\
122.022374875128	12.5892541179417\\
};
...
\addplot [color=mycolor7, line width=1.1pt, mark size=3.5pt, mark=triangle, mark options={solid, rotate=90, mycolor7}]
  table[row sep=crcr]{%
16	0.00863508545848884\\
18.5491696915454	12.5892541179417\\
};
...
\addplot [color=mycolor8, line width=1.1pt, mark size=3.5pt, mark=triangle, mark options={solid, rotate=180, mycolor8}]
  table[row sep=crcr]{%
16	0.0161177106677327\\
18.2974047681636	12.5892541179417\\
};
