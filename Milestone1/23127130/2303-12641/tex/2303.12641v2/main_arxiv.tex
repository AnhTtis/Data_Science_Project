...
\subsubsection{Model Correction}\label{app:sec:additional_results:model_correction}
        ...
        \begin{figure}[!ht] \centering
            \includegraphics[width=0.99\textwidth]{figures/experiments/corrected_behavior_resnet_reduced.pdf}
        ...
        \end{figure}
        \begin{figure}[!ht] \centering
            \includegraphics[width=0.99\textwidth]{figures/experiments/corrected_behavior_efficientnet_reduced.pdf}
