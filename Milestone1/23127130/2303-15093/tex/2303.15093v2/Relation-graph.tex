...
\node[draw, rounded corners, align=center] (AnSuff-2) at (-5.5,10) {$\exists q<2$: \ $B$ is $q$-admissible\\ $T$ is exp. stable\\ $T$ is similar to contraction sg.};

\node[draw, rounded corners, align=center] (AnSuff) at (-0.5,10) {$\exists \gamma\in (0,\frac{1}{2})$: \ $B \in L(U,X_{-\gamma})$\\ $T$ is exp. stable\\ $T$ is similar to contraction sg.};

\node[draw, rounded corners, align=center] (Self-AdSuff) at (5,9) {$B \in L(U,X_{-\frac{1}{2}})$\\ $T$ is exp. stable\\ $T$ is similar to contraction sg.};
...
\node[draw, rounded corners, align=center] (quad-LF-2) at (5,5) {$B$ is 2-admissible\\$T$ is exp. stable\\ $T$ is similar to contraction sg.};
...
\node[draw, rounded corners, align=center] (L2-ISS-crit) at (5,2.5) {$B$ is 2-admissible\\ $T$ is exp. stable};
