...
In the main body we report results of the more successful methods: CKA and PWCCA. Additional baseline are reported in Appendix \ref{sec:additional_methods}. Our source code is available at \url{https://github.com/technion-cs-nlp/ContraSim}.  %We report results of PWCCA, CKA and our method -- \method{}. 
