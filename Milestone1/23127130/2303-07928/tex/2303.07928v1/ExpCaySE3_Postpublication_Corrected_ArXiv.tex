...
\tilde{\mathbf{u}}+\tilde{\mathbf{u}}\tilde{\mathbf{x}})+\delta \left( 
...
\end{equation}%
where $\mathbf{U}=\left( \mathbf{u},\mathbf{v}\right) $, and the directional
derivative of matrix $\mathbf{Ddexp}^{-1}$ possesses the explicitly form%
\begin{align}
(\mathrm{D}_{\mathbf{X}}\mathbf{Ddexp}^{-1})%
%TCIMACRO{\TeXButton{-0.5ex}{\hspace{-0.5ex}}}%
%BeginExpansion
\hspace{-0.5ex}%
%EndExpansion
\left( \mathbf{U}\right) =& -\tfrac{1}{2}\tilde{\mathbf{v}}+\tfrac{1-\gamma 
...
\mathbf{v}+\mathbf{y}^{T}\mathbf{u})(2+\tfrac{1}{4}(\mathbf{x}^{T}\mathbf{y}%
...
=& -\tfrac{1}{2}\tilde{\mathbf{v}}+\tfrac{1-\gamma }{\left\Vert \mathbf{x}%
\right\Vert ^{2}}\left( \tilde{\mathbf{x}}\tilde{\mathbf{v}}+\tilde{\mathbf{v%
}}\tilde{\mathbf{x}}+\tilde{\mathbf{y}}\tilde{\mathbf{u}}+\tilde{\mathbf{u}}%
\tilde{\mathbf{y}}\right)  \label{diff2dexpInvSO32} \\
& +\tfrac{\left( 1-\gamma \right) }{\left\Vert \mathbf{x}\right\Vert ^{2}}(%
\mathbf{x}^{T}\mathbf{u})\left( \tfrac{1}{4}-\tfrac{1}{\left\Vert \mathbf{x}%
\right\Vert ^{2}}(2+\gamma )\right) (\tilde{\mathbf{x}}\tilde{\mathbf{y}}+%
\tilde{\mathbf{y}}\tilde{\mathbf{x}})+\tfrac{1}{\left\Vert \mathbf{x}%
\right\Vert ^{4}}(\gamma +\tfrac{1}{\beta }-2)(\mathbf{x}^{T}\mathbf{y})(%
\tilde{\mathbf{x}}\tilde{\mathbf{u}}+\tilde{\mathbf{u}}\tilde{\mathbf{x}}) 
\notag \\
& +\tfrac{1}{\left\Vert \mathbf{x}\right\Vert ^{4}}%
%TCIMACRO{\TeXButton{Big}{\Big}}%
%BeginExpansion
\Big%
%EndExpansion
((\gamma +\tfrac{1}{\beta }-2)(\mathbf{x}^{T}\mathbf{v}+\mathbf{y}^{T}%
\mathbf{u})  \notag \\
& 
%TCIMACRO{\TeXButton{TeX field}{\hspace{7ex}}}%
%BeginExpansion
\hspace{7ex}%
%EndExpansion
-(\mathbf{x}^{T}\mathbf{y})(\mathbf{x}^{T}\mathbf{u})\left( \tfrac{1}{4}(%
\mathbf{x}^{T}\mathbf{v}+\mathbf{y}^{T}\mathbf{u})+\tfrac{1}{\left\Vert 
\mathbf{x}\right\Vert ^{2}}%
%TCIMACRO{\TeXButton{big}{\big}}%
%BeginExpansion
\big%
%EndExpansion
(\gamma \left( 3+\gamma \right) +\tfrac{2}{\beta ^{2}}\left( \alpha +\beta
\right) -8%
%TCIMACRO{\TeXButton{big}{\big}}%
%BeginExpansion
\big%
...
\begin{proof}
The directional derivative of (\ref{diffDexpInvSO3}) involves the derivative
of parameter $\gamma $ 
\begin{equation}
...
\end{equation}%
The derivative of the coefficient of $\tilde{\mathbf{x}}^{2}$ in (\ref%
{diffDexpInvSO3}) is then found to be, along with (\ref{DD2}),%
\begin{align}
...
\hspace{-0.5ex}%
%EndExpansion
\left( \mathbf{U}\right) =& \tfrac{1}{\left\Vert \mathbf{x}\right\Vert ^{4}}(%
\mathbf{x}^{T}\mathbf{v}+\mathbf{y}^{T}\mathbf{u})(\gamma +\tfrac{1}{\beta }%
-2-\tfrac{1}{4}(\mathbf{x}^{T}\mathbf{y})(\mathbf{x}^{T}\mathbf{u})) \\
& +\tfrac{(\mathbf{x}^{T}\mathbf{y})(\mathbf{x}^{T}\mathbf{u})}{\left\Vert 
\mathbf{x}\right\Vert ^{6}}\left( \gamma \left( 1-\gamma \right) +\tfrac{2}{%
\beta ^{2}}\left( \beta -\alpha \right) -4(\gamma +\tfrac{1}{\beta }%
-2)\right) .  \notag
\end{align}%
...
\bibliography{ExpCaySE3_Postpublication_Corrected_ArXiv}
