...
Boolean algebra. $\P B$, the set of all subsets of $B$, is the domain of
a Boolean algebra with respect to the operators $(\emptyset, \cdot^C, \cup,
\cap)$ with some additional operators describable; the internal, or point-wise
operators $\ibot$, $\ilnot$, $\ilor$, and $\iland$. These operators are
defined as follows:
\begin{align*}
    \ibot &= \set{\bot}, \\
    \ilnot A &= \set{\lnot a | a \in A},\\
    A \ilor B &= \set{a \lor b | a \in A, b \in B}, \text{ and}\\
    A \iland B &=\set{a \land b | a \in A, b \in B}.
\end{align*}
Here $a \lor b \in B$ is the result of the operator $\lor$ in the Boolean
algebra $B$ applied to $a$ and $b$.
...
Substitutionality follows directly from the definition of the entailment relation.
...
\emph{labelled formulas}. The labels have their inteded reading as elements
...
$\phi$ a formula. The intended meaning is that
irregardless of the values of the propositional variables in $a$ and $\phi$,
$a$ is an element in $\phi$. Formally we define the consequence relation by
referring to homomorphisms:
...
Next we add rules for the internal operations. The rule $\iae$ are modelled on
the fact that $x \in H(\phi \iland \psi)$ iff there are $y,z$ such that $x
\in H(\phi)$, $y \in H(\psi)$ and $x=y \land z$ holds in $B$. Similar for
$\ioe$. 
