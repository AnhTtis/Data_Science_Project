...
\section{Definability}\label{sec:definable}
 ...
 definitions we give that there are plenty of similar constructions to define
...
and $\Diamond$ interpreted using the universal accessibility relation.
...
large. As example, the first statement is written directly without defined
connectives as $$\vDash \neg P \lor \lnot((([\lnot (((P \iland \lnot
...
proof system showing the related proof theoretic statement 
\[
	a\of P \vdash a\of\slnot\slnot P,
\] 
using defined connectives as notational abbreviations.
