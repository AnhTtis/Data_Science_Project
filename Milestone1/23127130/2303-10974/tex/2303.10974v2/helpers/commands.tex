...
% \note - note (for debug):
\newcommand{\mynote}[1]{ {\color[HTML]{8b1d1d}/* #1 */} }
% \renewcommand{\note}[1]{} % Comment this for debug

% \todopa - todo for papers (read and add info):
\newcommand{\todopa}[4]{
    {\color[HTML]{8b1d1d}TODO : describe the paper.}
    #2
    (see~\cite{#1}; text \url{#3}).
    {\color[HTML]{8b1d1d}#4}
}
