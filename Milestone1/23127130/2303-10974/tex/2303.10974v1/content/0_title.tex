...
\author{
%Anonymous authors
    Andrei Chertkov\inst{1}\orcidID{0000-0001-9990-6598}
    \and
    Olga Tsymboi\inst{2, 3}\orcidID{0000-0002-8078-1876}
    \and
    Mikhail Pautov\inst{1}\orcidID{0000-0003-0438-6361}
    \and
    Ivan Oseledets\inst{1,4}\orcidID{0000-0003-2071-2163}
}
...
\begin{abstract}
    ...
    % at least from Russian to English and vice versa. 
