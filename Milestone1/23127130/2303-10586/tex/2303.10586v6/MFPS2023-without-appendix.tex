...
\textbf{Corrigendum:} The previous statement of our running example was incorrect in saying that it worked over any semiring $R$. However, the statement of Ex \ref{ex:RELsym} is true, so our example does work when $R = \mathbb{N}$. So we make this minor correction in our running example by fixing $R = \mathbb{N}$ in Ex \ref{ex:REL!}, \ref{ex:RELd}, \ref{ex:RELbialg}, \ref{ex:RELaddbialg}, and \ref{ex:RELcoder}. This does not affect the overall story or theory, and the rest of the paper remains unchanged. 
