...
\end{align*}
So $k\text{-}\mathsf{MOD}$ is also an $\mathbb{N}$-graded differential linear category, though the resulting graded bimonoid (which does not appear to be same as the one in Ex \ref{ex:mod}) and differential structure is somewhat mysterious. 
\end{example}
