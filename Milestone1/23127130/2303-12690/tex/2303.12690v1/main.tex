...
This paper addresses an observer in uniform circular motion in an ambient thermal bath. We model the the observer as an Unruh-DeWitt detector, coupled to a massless scalar field in $2 + 1$
...
There exist parameter regimes where the the observer sees a temperature lower than the ambient temperature, experiencing a cooling Unruh effect. 
\end{abstract}
...
Experimental interest in the circular motion Unruh effect has a long standing \cite{BellLeinaas,Bell:1986ir,Leinaas:1998tu,Unruh:1998gq,Lochan:2019osm}, 
...
and the effective temperature involves also dependency on the orbital speed and the excitation energy. A detailed comparison of the linear and circular acceleration Unruh temperatures in $2+1$ and $3+1$ spacetime dimensions is given in \cite{Biermann}. Related earlier analyses are given in \cite{Good:2020hav,Takagi,Unruh:1998gq,Muller:1995vk,Hodgkinson}. 

In the conventional setting of the Unruh effect, as reviewed above, 
...
\begin{figure}[t]
    ...
    The large $\beta\Eabs$ heating effect~\eqref{eqn: Tlin-largeproduct}, the 
    the small $\beta\Eabs$ cooling effect \eqref{eqn: Tlin-smallproduct} 
