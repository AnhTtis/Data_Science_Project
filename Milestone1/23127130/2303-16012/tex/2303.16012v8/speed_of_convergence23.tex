...
(FMLS) model (see \cite{carr2003finite}), the truncation error due
...
\citet[Sec. 2.2.1]{ruijter2015application} or \cite{leitao2018data}.
...
and stable densities, see \cite{junike2022precise}. 
\begin{lem}
...
Proposition 2 in \cite{junike2022precise} provides a bound for $B_{f}(L)$,
...
with different choices for the truncation range $[-L,L]$ for the
FMLS model.}
\end{figure}
