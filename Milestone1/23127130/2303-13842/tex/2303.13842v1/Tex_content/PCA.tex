...
\end{equation}
where $z_{pca}$ denotes the final mixed feature output of the proposed PCA mechanism, the $C_{BN}$ denotes the bottleneck layer and SA denotes the self-attention mechanism which is calculated as $SA(Q, K, V){=}Softmax(QK^{T}/\sqrt{{\rho}})V$ and $\rho$ denotes the scale factor.
