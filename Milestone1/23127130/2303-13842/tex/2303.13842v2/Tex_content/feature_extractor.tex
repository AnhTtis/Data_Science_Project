...
\end{split}
\end{equation}
where SW-MSA stands for the Shifted-Window based Multi-head Self-Attention, LN indicates layer normalization, MLP is multi layer perception with GELU nonlinearity, $l$ marks the layer number, $\hat{z}_{l-1}$ is the attention output, $z_{l-1}$ and $z_{l}$ are the outputs of $\{l-1\}{-}th$ and $\{l\}{-}th$ modules, respectively.
