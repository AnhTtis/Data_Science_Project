...
\begin{figure}[t]
    ...
    \caption{IRT support rates in repositories based on various characteristics. In the case of repositories with a number of stargazers between $6.5^6$ and $6.5^7$~(with average stargazers number of $6^{6.27}$), the odds of supporting an IRT is $0.643$.}
