...
A natural question that arises is whether the distortion function $T$ is Theorem \ref{Theorem: law inv, Dist} in nondecreasing or, in other words, if the default risk measure $\DR\colon C\to [0,1]$ is \textit{consistent} with $\P$, i.e., 
\[
