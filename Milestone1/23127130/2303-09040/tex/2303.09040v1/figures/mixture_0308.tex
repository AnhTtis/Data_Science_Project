\begin{figure*}
	...
	\begin{minipage}[l]{0.22\linewidth}
		\begin{flushleft}
			\vspace{-0.1mm}
			\hspace{-3mm}
			\includegraphics[width=1.045\linewidth]{imgs/0308/mixture/gt_left.png}\\
	...
	\vspace{-3mm}
	\caption{Visual comparison for simulated complex noise removal on ICVL dataset. (\emph{mixture} case)}
	\label{fig:complex}
\end{figure*}