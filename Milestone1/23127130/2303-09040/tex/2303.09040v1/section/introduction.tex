...
Motivated by the intrinsic properties of HSI, traditional HSI denoising approaches \cite{yuan2012hyperspectral, he2019non} often exploit the optimization schemes with priors, \eg, low rankness \cite{zhao2020fast,wei2019low}, non-local similarities \cite{maggioni2012nonlocal}, spatial-spectral correlation \cite{peng2014decomposable}, and global correlation along the spectrum \cite{wei20203}.
