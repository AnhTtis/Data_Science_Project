...
\newacronym[\glsshortpluralkey=SINRs,\glslongpluralkey=the signal-to-interference-plus-noise ratios]{sinr}{SINR}{the signal-to-interference-plus-noise ratio}
...
\newacronym[]{vskf}{vSKF}{\emph{vector-covariance} Simplified Kalman Filter}
\newacronym[]{sskf}{sSKF}{\emph{scalar-covariance} Simplified Kalman Filter}
