...
However, the poor performance of IDM may be specific to the dataset considered in this paper (see Appendix, Section \ref{sec:iqm_comparison}).
...
It should be noted that in the estimated IDM model, the parameter estimate $a_{max}$  is significantly lower than that reported in \cite{Hoogendorn_2010}.
