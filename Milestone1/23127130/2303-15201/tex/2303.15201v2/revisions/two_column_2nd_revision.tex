...
\begin{table}[!htb]
\caption{\textcolor{blue}{Fitted IDM parameters: mean and standard deviations across 15 seeds.}}\label{eq:hyperparams}
\centering
\begin{tabular}{ccc}
\hline
$\Tilde{v}$ & $\tau$ & $d_{0}$ \\
\hline
\textcolor{blue}{12.2 $\pm$ 0.2} & \textcolor{blue}{0.83 $\pm$ 0.03} & \textcolor{blue}{1.07 $\pm$ 0.07} \\
\hline
$a_{max}$ & $b$ & $\sigma$ \\
\hline
\textcolor{blue}{0.21 $\pm$ 0.006} & \textcolor{blue}{2.68 $\pm$ 0.19} & \textcolor{blue}{0.46 $\pm$ 0.004} \\
\hline
\end{tabular}
\end{table}
