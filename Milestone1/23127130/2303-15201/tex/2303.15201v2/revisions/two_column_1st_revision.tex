...
{Author \MakeLowercase{\textit{et al.}}: Regularized Q-Learning}
\begin{document}
\title{Learning An Active Inference Model of Driver Perception and Control:
Application to Vehicle Car-Following}
\author{Ran Wei,
Alfredo Garcia,
Anthony McDonald,
Gustav Markkula,
Johan Engstrom, Matthew O'Kelly}
\thanks{This work was supported in part by Army Research Office ARO under grant W911NF-22-1-0213. }
...
\includegraphics[width=0.4\textwidth]{figs_rebuttal/online_pred_sparse.png}
    \caption{{\blue Online evaluation ADE for each time step averaged over all online testing episodes for the dense-lane (top) and sparse-lane (bottom) settings by the best seed of each model.}}
