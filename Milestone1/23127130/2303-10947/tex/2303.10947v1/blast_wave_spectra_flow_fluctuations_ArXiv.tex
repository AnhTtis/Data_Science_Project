...
\begin{document}
\title{Flow fluctuations and kinetic freeze-out of identified hadrons at SPS energies}
...
To the best of our knowledge, this is the first attempt to incorporate the flow fluctuations into the non-boost-invariant blast-wave model to describe the transverse spectra of identified hadrons at SPS energies. As mentioned earlier, authors of Ref.~\cite{Akkelin:2009nx} have implemented the flow fluctuations into the boost-invariant blast-wave model to study the heavy hadrons namely, $J/\psi$, $\phi$ and $\Omega$. There was an attempt made to consider the transverse flow fluctuations in non-central collisions by the authors of Refs.~\cite{Voloshin:2008dg,Ollitrault:2009ie}. The authors have also used Bessel-Gaussian formulations for the descriptions of the initial state eccentricity fluctuations which are not purely Gaussian especially for peripheral collisions. Since in this article, we are exclusively dealing with central collisions, we refrain from using the Bessel Gaussian formulation.
...
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_light_20_etad_n1_all_simul_Dec07_2022_V2_FlatFluc_NewEtaMax_NewIter.eps}}
\put(50,125){(a)}
\end{picture}
\begin{picture}(160,140)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_light_30_etad_n1_all_simul_Dec07_2022_V2_FlatFluc_NewEtaMax_NewIter.eps}}
\put(50,125){(b)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_light_40_etad_n1_all_simul_Dec07_2022_V2_FlatFluc_NewEtaMax_NewIter.eps}}
\put(50,125){(c)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_light_80_etad_n1_all_simul_Dec07_2022_V2_FlatFluc_NewEtaMax_NewIter.eps}}
\put(50,125){(d)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_light_158_etad_n1_all_simul_Dec07_2022_V2_FlatFluc_NewEtaMax_NewIter.eps}}
\put(50,125){(e)}
\end{picture}
%
...
%
\begin{picture}(160,140)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_20_etad_n1_all_simul_Dec07_2022_V2_FlatFluc_NewEtaMax_NewIter.eps}}
\put(50,125){(a)}
\end{picture}
\begin{picture}(160,140)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_30_etad_n1_all_simul_Dec07_2022_V2_FlatFluc_NewEtaMax_NewIter.eps}}
\put(50,125){(b)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_40_etad_n1_all_simul_Dec07_2022_V2_FlatFluc_NewEtaMax_NewIter.eps}}
\put(50,125){(c)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_80_etad_n1_all_simul_Dec07_2022_V2_FlatFluc_NewEtaMax_NewIter.eps}}
\put(50,125){(d)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_158_etad_n1_all_simul_Dec07_2022_V2_FlatFluc_NewEtaMax_NewIter.eps}}
\put(50,125){(e)}
\end{picture}
%
...
%
\begin{picture}(160,140)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_light_20_etad_n1_all_simul_Feb26_2023_V2_GausFluc3_Range_NewEtaMax_NewIter.eps}}
\put(50,125){(a)}
\end{picture}
\begin{picture}(160,140)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_light_30_etad_n1_all_simul_Feb26_2023_V2_GausFluc3_Range_NewEtaMax_NewIter.eps}}
\put(50,125){(b)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_light_40_etad_n1_all_simul_Feb26_2023_V2_GausFluc3_Range_NewEtaMax_NewIter.eps}}
\put(50,125){(c)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_light_80_etad_n1_all_simul_Feb26_2023_V2_GausFluc3_Range_NewEtaMax_NewIter.eps}}
\put(50,125){(d)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_light_158_etad_n1_all_simul_Feb26_2023_V2_GausFluc3_Range_NewEtaMax_NewIter.eps}}
\put(50,125){(e)}
\end{picture}
%
...
%
\begin{picture}(160,140)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_20_etad_n1_all_simul_Feb26_2023_V2_GausFluc3_Range_NewEtaMax_NewIter.eps}}
\put(50,125){(a)}
\end{picture}
\begin{picture}(160,140)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_30_etad_n1_all_simul_Feb26_2023_V2_GausFluc3_Range_NewEtaMax_NewIter.eps}}
\put(50,125){(b)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_40_etad_n1_all_simul_Feb26_2023_V2_GausFluc3_Range_NewEtaMax_NewIter.eps}}
\put(50,125){(c)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_80_etad_n1_all_simul_Feb26_2023_V2_GausFluc3_Range_NewEtaMax_NewIter.eps}}
\put(50,125){(d)}
\end{picture}
\begin{picture}(160,160)
\put(0,0){\includegraphics[scale=0.28]{blast_bniv_158_etad_n1_all_simul_Feb26_2023_V2_GausFluc3_Range_NewEtaMax_NewIter.eps}}
\put(50,125){(e)}
\end{picture}
%
...
\caption{Simultaneously fitted $p_{T}$ spectra of $\rm J/\psi$ and $\psi^{'}$ at 158A GeV beam energies using Uniform (left) and Gaussian (right) description of transverse flow fluctuations. Error bars indicate available statistical error.}
%
\label{fig3}
\end{figure*}
