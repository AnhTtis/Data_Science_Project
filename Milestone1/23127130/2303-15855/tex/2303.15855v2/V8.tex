...
due to Gournay \cite{Gournay2012}, combined with Proposition 
%\ref{prop:weakOka1}
\ref{prop:int}
...
Campana and Winkelmann give further examples of complex manifolds 
...
rational curves in rationally connected manifolds, in particular, on smoothing a  
...
rationally connected manifolds, referring to the monographs by 
...
rationally connected $n$-manifold $X$. To see this, recall that 
...
Furthermore, on any rationally connected 
...
manifold $X$ satisfies the Oka-1 property with approximation (see Definition \ref{def:Oka1}).  
