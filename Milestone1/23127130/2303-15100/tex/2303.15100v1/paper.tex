...
%
%\author{Christos Theodoropoulos\inst{1}\orcidID{0000-0002-2810-7817} \and
%Marie-Francine Moens\inst{2}\orcidID{0000-0002-3732-9323}}
...
%This work is supported by the Research Foundation – Flanders (FWO). The authors are affiliated with Leuven.AI - KU Leuven institute for AI, B-3000, Leuven, Belgium.

%\section*{Appendix}
%\subsection*{Student's t-test}
%\label{sec:appendix}

%The ADE dataset \cite{gurulingappa2012development} is not predefined in the training, development, and test sets. Hence, we use 10-fold cross-validation \cite{li2017neural} with the same split as Eberts and Ulges (2020) \cite{eberts2020span} used in their study. The development set for every fold is defined by randomly selecting 15\% of the training set. We use the same seed for the development-training split across the models for a fair comparison. We conduct an extensive statistical t-test for both setups (baseline and advanced) to compare and point out the statistical significance of the performance differences. Tabs. 8-11 present the results of the test for the NER and RE tasks in detail. 

%\begin{table}[!h]
%    \caption{ADE dataset, NER task, Baseline setup: T values/P values/Statistical Significance (p value $\leq$ 0.05)}
%    \centering
%    \resizebox{\linewidth}{!}{
%    \begin{tabular}{cccc}
%        \toprule
%        & medical\_CharacterBERT & b-BERT\_avg & b-BERT\_sum \\
%        \midrule
%        medical\_CharacterBERT & \cellcolor{lightgray} & 10.07985/ 1.67E-06/ yes & 7.88616/ 1.24E-05/ yes \\
%        \midrule
%        b-BERT\_avg & & \cellcolor{lightgray} & -0.22696/ 4.31E-10/ no \\
%        \midrule
%        b-BERT\_sum & & & \cellcolor{lightgray} \\
%        \bottomrule
%    \end{tabular}}
%    \vspace{-8mm}
%\end{table}
...
%\begin{table}[!h]
%    \caption{ADE dataset, RE task, Baseline setting: T values/P values/Statistical Significance (p value $\leq$ 0.05)}
%    \resizebox{\linewidth}{!}{
%    \begin{tabular}{cccc}
%        \toprule
%        & medical\_CharacterBERT & b-BERT\_avg & b-BERT\_sum \\
%        \midrule
%        medical\_CharacterBERT & \cellcolor{lightgray} & 6.57049/ 5.14E-05/ yes & 7.24329/ 2.43E-05/ yes \\
%        \midrule
%        b-BERT\_avg & & \cellcolor{lightgray} & 1.37279/ 0.10152/ no \\
%        \midrule
%        b-BERT\_sum & & & \cellcolor{lightgray} \\
%        \bottomrule
%    \end{tabular}}
...
%\begin{table}[!h]
%    \caption{ADE dataset, NER task, Advanced setup: T values/P values/Statistical Significance (p value $\leq$ 0.05)}
%    \centering
%    \resizebox{\linewidth}{!}{
%    \begin{tabular}{ccccc}
%        \toprule
%        & medical\_CharacterBERT & b-BERT & b-BERT\_avg & b-BERT\_sum \\
%        \midrule
%        medical\_CharacterBERT & \cellcolor{lightgray} & 6.61186/ 4.9E-05/ yes  & 4.46268/ 0.00078/ yes  & 3.85327/ 0.00194/ yes \\
%        \midrule
%        b-BERT & & \cellcolor{lightgray} & -1.69667/ 0.06199/ no & -6.83933/ 3.78E-05/ yes \\
%        \midrule
%        b-BERT\_avg & & & \cellcolor{lightgray} & -2.78582/ 0.01059/ yes \\
%        \midrule
%        b-BERT\_sum & & & & \cellcolor{lightgray} \\
%        \bottomrule
%    \end{tabular}}
...
%\begin{table}[!h]
%    \caption{ADE dataset, RE task, Advanced setup: T values/P values/Statistical Significance (p value $\leq$ 0.05)}
%    \centering
%    \resizebox{\linewidth}{!}{
%    \begin{tabular}{ccccc}
%        \toprule
%        & medical\_CharacterBERT & b-BERT & b-BERT\_avg & b-BERT\_sum \\
%        \midrule
%        medical\_CharacterBERT & \cellcolor{lightgray} & 4.57545/ 0.00066/ yes & 4.57047/ 0.00067/ yes & 4.10552/ 0.00132/ yes \\
%        \midrule
%        b-BERT & & \cellcolor{lightgray} & -0.50711/ 0.31213/ no & -3.31743/ 0.00448/ yes \\
%        \midrule
%        b-BERT\_avg & & & \cellcolor{lightgray} & -2.172/ 0.02896/ yes \\
%        \midrule
%        b-BERT\_sum & & & & \cellcolor{lightgray} \\
%        \bottomrule
%    \end{tabular}}
