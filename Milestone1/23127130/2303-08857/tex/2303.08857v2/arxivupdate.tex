...
structure and texture of the sample after static compression to 7 GPa at 300 K. (b) and (e): structural and textural changes occurring after heating at \textit{HP} up to 1360 K and 1450 K, respectively. (c) and (f): samples' structure after dynamic loading and quench down to 300 K; in both cases, the final Fe structure corresponds to the $\epsilon$ phase. }
\end{figure*}
