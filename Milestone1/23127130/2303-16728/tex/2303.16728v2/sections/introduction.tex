...
For a probabilistic approach to MFGs, we refer to the two-volume book by Carmona and Delarue \cite{librone}.
...
Remarkably, the flow of measures is naturally stochastic, as the aggregation of individual behaviours preserves the stochasticity of the correlation device.
...
Interestingly, they propose a different definition of CE for the mean field game from that in \cite{bonesiniCE,campifischer2021}, and in \cite{muller2022learningCE} the authors discuss on how the two definitions of CE can be seen as equivalent.
...
Finally, \cite{campi2023LQ} introduces the notion of CCEs in a class of continuous time linear quadratic MFGs.
