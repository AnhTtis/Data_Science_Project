...
As mentioned in Appendix~\ref{sec:algo_pseudocodes}, we based this work on the QDax framework \cite{lim2022accelerated, chalumeau2023qdax} and used hyperparameters values presented in \cite{chalumeau2022neuroevolution} for MAP-Elites and PGA-MAP-Elites (as well as their Low-Spread counterparts), which are standard values in the literature.
