...
We chose to use surveys instead of more active methods such as think-aloud studies~\cite{??} to minimize the interference with users' game experiences.
...
% three individuals indicated that they owned a VR headset, while none of them reported that they frequently used them. They mainly used VR for gaming; some participants also reported that they had used VR for education, training, and socialization purposes as well. 
...
% As such, we focus mainly on qualitative analysis instead of quantitative data. 