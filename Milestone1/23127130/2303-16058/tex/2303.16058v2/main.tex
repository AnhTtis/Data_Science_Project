...
\author{
    ...
    Yizhuo Li$^{4,3}$\textsuperscript{*}\quad
    Yi Wang$^{3}$\quad
    Yinan He$^{3}$\\
    Limin Wang$^{5,3}$\quad
    Yu Qiao$^{3,1}$\textsuperscript{$\dag$}\vspace{0.2em}\\
    % \textsuperscript{\dag}
    ...
    \small{Code \& Models: \url{https://github.com/OpenGVLab/unmasked_teacher}}
}
...
\input{paragraphs/acknowledgement.tex}
