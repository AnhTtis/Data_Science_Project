...
\section{Experiments}
In this part, we compare our tactile manipulation system to several baselines in both the simulation and the real. Specifically, we are interested in the following questions:
\begin{enumerate}
