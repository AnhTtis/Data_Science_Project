...
\begin{figure*}[t]
  \centering
  \vspace{30pt}
  \includegraphics[width=0.99\linewidth]{figures_supp/fig_supp_styles.pdf}
   \caption{\textbf{ReVersion for Diverse Styles and Backgrounds}. The \R{} inverted by ReVersion can be applied robustly to relate entities in scenes with diverse backgrounds or styles.
   }
...
\begin{figure*}[t]
  \centering
   \includegraphics[width=0.6\linewidth]{figures_supp/fig_supp_painted_on.pdf}
...
\begin{figure*}[t]
  \centering
   \includegraphics[width=0.95\linewidth]{figures_supp/fig_supp_carved_by.pdf}
...
\begin{figure*}[t]
  \centering
   \includegraphics[width=0.95\linewidth]{figures_supp/fig_supp_ride_on_hug.pdf}
...
\begin{figure*}[t]
  \centering
   \includegraphics[width=0.99\linewidth]{figures_supp/fig_supp_inside_a_back2back.pdf}
   \caption{\textbf{More Qualitative Results}.
   }
...
\begin{figure*}[t]
  \centering
   \includegraphics[width=0.99\linewidth]{figures_supp/fig_supp_inside_b.pdf}
   \caption{\textbf{More Qualitative Results}.
   }
...
\begin{figure*}[t]
  \centering
   \includegraphics[width=0.93\linewidth]{figures_supp/fig_supp_hanging_from_shake_hands.pdf}
   \caption{\textbf{More Qualitative Results}.
   }
