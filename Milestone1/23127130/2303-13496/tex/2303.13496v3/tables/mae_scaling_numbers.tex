\begin{table}[h]
    ...
    \begin{tabu}{c|cc|cccc}
        ...
        \vitTwoB & 87.8 & 85.6 & \bf 53.6 & \bf 48.6 & \bf 59.9 & \bf 52.0\\
        \vitSixB & \bf 88.3 & \bf 86.6 & --\textsuperscript{\textasteriskcentered} & --\textsuperscript{\textasteriskcentered} & --\textsuperscript{\textasteriskcentered} & --\textsuperscript{\textasteriskcentered} \\
    \end{tabu}%
    }
    \caption{
        \textbf{Scaling \mae with model and dataset size.} We show the performance in tabular form of \mae pretraining on \inetOneK 
        and \igSize. \mae scales with both data and model size.
        \inetOneKShort and \inatShort finetuning results are at 224px.
        \textsuperscript{\textdagger}Training was unstable. \textsuperscript{\textasteriskcentered}Training skipped due to compute limitations.
    }
