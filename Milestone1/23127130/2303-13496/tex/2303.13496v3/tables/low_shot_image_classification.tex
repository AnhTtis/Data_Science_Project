\begin{table}[H]
    ...
    \begin{tabu}{llcH|ccc|ccc}
        ...
        \midrule
        \oursShort & \igSizeShort & \vitH & Adapter & 57.1 & 79.8 & 82.5 & 31.7 & 67.8 & 76.1 \\
        \oursShort & \igSizeShort & \vitTwoB & Adapter & 62.1 & 81.5 & 83.7 & 35.5 & 72.8 & 80.3 \\
        \oursShort & \igSizeShort & \vitSixB & Adapter & \textbf{63.6} & 82.6 & 84.6 & %
        \textbf{36.4} & \textbf{73.7} & \textbf{80.9}  %
        \\ 
    \end{tabu}%
    }
    \caption{
        \textbf{Low shot image classification.} We compare the performance of our models using just a few examples per class for 
        \inetOneK and \inat. \oursShort excels at classification even with just 1 example per class. Pretraining on large scale data 
