...
Most prominently, our model sets new state-of-the-art results on image classification on \inat (91.7\%) and \inetReal (91.1\%), 1-shot \inetOneK classification (63.6\%),
