...
%70--90\% &  0.16 $\pm$ 0.0037 & 11.34 $\pm$ 0.16 \\
...
The \jpsi were assumed to be unpolarised, in agreement with the small polarisation, compatible with zero, measured in \PbPb collisions for $2<\pt<10$~\GeVc~\cite{ALICE:2020iev}. As in the analysis at midrapidity, the simulations take into account the time dependence of the detector conditions, such as the status of the tracking chambers and the residual detector element misalignment. The trigger-chamber efficiency was determined from data and used as input in the simulations. The (\AccEff) reaches a minimum of 11\% at \pt $\approx$~2~GeV/c and increases up to 13\% at low \pt and up to 46\% at high \pt in the 0--20\% centrality interval. It increases slightly towards peripheral collisions~\cite{Abelev:2014ffa}. 
