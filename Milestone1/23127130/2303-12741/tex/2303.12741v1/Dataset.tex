...
Consenting was optional, and refusal to do so did not preclude the experience in any way.
...
\begin{figure}[h]
  ...
  \caption{Example images from the clusters obtained via cluster-based filtering. Certain clusters contained similarly depicted characters, such as stick figures, hollow characters, and solid marker characters (retained clusters 1, 2, and 3, respectively). Other clusters contained out-of-domain images, such as human faces, anime characters, and anime faces (discarded clusters 4, 5, and 6, respectively).}
...
After manual review, approximately 178,000 images remained.

\hjs{Of the images that were excluded, 30\% were not freehand drawings, 20\% contained personally identifiable information, 15\% contained protected intellectual property, 24\% did not contain full-bodied human figures, 3\% contained vulgar content, 4\% had out of domain content, and 4\% were uploaded and annotated with an incorrect orientation.}

\subsection{Release}
We will release the retained images, along with their annotations, for use by the research community upon acceptance of this paper. 
