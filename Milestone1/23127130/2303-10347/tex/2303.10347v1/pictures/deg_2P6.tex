...
% Text Node
\draw (4.02,29.79) node [anchor=north west][inner sep=0.75pt]    
{\ref{eq:P6_2}};
% Text Node
\draw (70.02,29.8) node [anchor=north west][inner sep=0.75pt]    
{\ref{eq:P5_2}};
% Text Node
\draw (135.8,4.04) node [anchor=north west][inner sep=0.75pt]   
{$\PPIIIprn{1}$};
% Text Node
\draw (135.8,57.4) node [anchor=north west][inner sep=0.75pt]    
{\ref{eq:P4_1_m2}};
% Text Node
\draw (202.77,29.79) node [anchor=north west][inner sep=0.75pt]    
{$\PPIIn{1}$};
% Text Node
\draw (267.02,26.8) node [anchor=north west][inner sep=0.75pt]    
{$\PIn{H}$};
