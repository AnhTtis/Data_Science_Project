...
\ead{Matteo.Barbetti@fi.infn.it}
...
The simulation of high-energy collisions, of the decays of the generated particles, and of the physics processes occurring within the detector by the decay products are a key necessity of analysis, typically for separating the signal from background sources or for efficiency studies.
...
Hence, the LHCb Collaboration is making great efforts to modernize the simulation software stack~\cite{Corti:2023pme, Mazurek:2022tlu} and develop novel and faster simulation options~\cite{Rama:2019smm, Maevskiy:2019vwj, Ratnikov:2021uwg, Rogachev:2022hjg, Anderlini:2022ofl}.
...
To validate the \emph{ultra-fast simulation} approach adopted machine-learning-based models are trained on detailed simulated samples and the output of \lamarr is compared to the reference distributions as described in Section~\ref{sec:validation}.
