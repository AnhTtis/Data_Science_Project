...
\section{Adversarial attack with running statistics}

\begin{figure}[!h]
    \centering
    \includegraphics[width=0.48\textwidth]{src/cifar_fgsm_8_16_32_resnet_32_v4.png}
    ...
    \label{fig:appendix_adversarial}
\end{figure}
