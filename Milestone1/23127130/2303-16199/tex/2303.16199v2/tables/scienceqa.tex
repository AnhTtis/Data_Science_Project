...
\begin{table*}[t]
    \centering
    \small
     \caption{\textbf{Question Answering Accuracy (\%) on ScienceQA's~\cite{scienceqa} test set.}
     We report GPT-3~\cite{brown2020language}, ChatGPT~\cite{chatgpt}, and GPT-4~\cite{OpenAI2023GPT4TR} for zero-shot inference. $CoT$ denotes to utilize additional chain of thought for question answering. $T$ denotes the single-modal model with text-only input.}
    % \vspace{0.1cm}
    \label{tab:scienceqa}
    \resizebox{\textwidth}{!}{%
    ...
    ChatGPT$_{CoT}$~\cite{chatgpt}                   & 0M                                    & 78.31            & 78.82             & 70.98             & 83.18             & 77.37             & 67.92             & 86.13             & 80.72             & 74.03              \\
    GPT-4$_{CoT}$~\cite{OpenAI2023GPT4TR}                      & 0M                                    & 83.99            & 85.48             & 72.44             & 90.27             & 82.65             & 71.49             & 92.89             & 86.66             & 79.04             \\
    MM-COT$_T$ \cite{zhang2023multicot}                    & 223M            & 70.53            & 71.09             & 70.75             & 69.18             & 71.16             & 65.84             & 71.57             & 71.00             & 69.68             \\ 
