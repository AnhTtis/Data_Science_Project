...
\newcommand{\salpp}{SAL${\scriptstyle^+\scriptstyle^+}$}
\newcommand{\sal}{SAL}
\newcommand{\vol}{V} %
...
\newcommand{\ali}[1]{{\color{blue}{\bf[Ali:} #1{\bf]}}}
\newcommand{\al}[1]{{\color{blue}{\bf[Alb:} #1{\bf]}}}
\newcommand{\ar}[1]{{\color{blue}{\bf[Art:} #1{\bf]}}}
\newcommand{\li}[1]{{\color{blue}{\bf[Lior:} #1{\bf]}}}
\newcommand{\rebb}[1]{{\color{black}{}#1{}}}
\def \etal{{et al}.}
\newcommand{\eg}{{e.g.}}
\newcommand{\ie}{{i.e.}}
