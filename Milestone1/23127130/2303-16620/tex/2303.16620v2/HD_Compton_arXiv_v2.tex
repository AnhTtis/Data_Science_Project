...
\begin{center}
\large{Matthew J. Lake${}^{a,b,c,d,e*}$\footnote{matthewjlake@narit.or.th}, Shi-Dong Liang${}^{c,f}$\footnote{stslsd@mail.sysu.edu.cn} and Anucha Watcharapasorn${}^{b,g}$\footnote{anucha@stanfordalumni.org}} 
\end{center}
\begin{center}
...
\emph{$^{f}$State Key Laboratory of Optoelectronic Material and Technology, \\ Guangdong Province Key Laboratory of Display Material and Technology, 
\\ Sun Yat-Sen University, Guangzhou 510275, People's Republic of China \\}
\emph{$^{g}$Center of Excellence in Quantum Technology, \\ Faculty of Engineering, Chiang Mai University, \\ 239 Huaykaew Rd, T. Suthep, A. Muang, Chiang Mai 50200, Thailand}
\vspace{0.1cm}
\end{center}
...
This work was supported by the Natural Science Foundation of Guangdong Province, grant no. 2021A1515010036. 
