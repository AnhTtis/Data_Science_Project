...
Also, for all five abelian groups of order $16$, and for four of the non-abelian groups (${\rm D}_{16}, {\rm D}_{8} \times {\rm C}_{2}, {\rm Q}_{8} \times {\rm C}_{2}, {\rm Q}_{16}$), 
...
Let 
$$
G := {\rm C}_{2}^{2} \rtimes {\rm C}_{4} = \langle g_{1}, g_{2}, g_{3} \mid g_{1}^{2} = g_{2}^{2} = g_{3}^{4} = e, \: g_{1} g_{2} = g_{2} g_{1}, \: g_{1} g_{3} = g_{3} g_{1}, \: g_{2} g_{3} = g_{3} g_{2} g_{1}  \rangle, 
$$
