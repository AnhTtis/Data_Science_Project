...
\begin{subfigure}{0.16\linewidth}
    ...
    \end{subfigure}%
     ...
     In all cases, the model produces grid artifacts, i.e. up-sampling and boundary artifacts.
     %For each reconstruction there are also zoomed-in regions of each image.
     }
