...
% \copyrightyear{2024}
% \acmYear{2024}
% \acmDOI{10.1145/1122445.abcdefg}
...
\section{Annotating Reviews and Model Training}
...
\subsection{Extracting Deep Learning Features from App Review}
...
\section{Statistical Methods for Identifying and Ranking exploitable Apps}
...
\subsection{Selecting Threshold for Prediction}
...
\section{Performance on Snowball Dataset}
\label{sec:snowball}
...
\section{Scrutinizing Utility Apps}
\label{sec:utilities}
...
\section{Contacting App Developers}
...
\section{List of exploitable Apps Identified}
