...
{0pt}                             % altura del pie de pï¿½gina
{1.5cm}                           % espacio entre el texto y el pie de pï¿½gina
...
\begin{document}
	...
	\title{Quasi-equilibrium and quantum correlation in an open
		spin-pair system}
	\author{J.A. Taboada, H.H. Segnorile, C.E. González, and R.C. Zamar}
	\maketitle
...
\begin{thebibliography}{10}
	...
	Malcolm Levitt and Frank Försterling.
	\newblock Spin dynamics: Basics of Nuclear Magnetic Resonance, Second Edition.
	\newblock {\em Medical Physics - MED PHYS}, 37, Jan 2010.
