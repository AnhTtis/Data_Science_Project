...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%......................... Einfache Änderung entweder im Reviewtool oder mit den unten angegebenen Commands .............................%
%............................... für Zuweisungszwecke id=name durch z.b. id=db oder id=ss austauschen ...................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[textsize=small]{todonotes}
\usepackage[deletedmarkup=xout]{changes}
\definechangesauthor[name={David Bauch}, color=blue]{db}
\definechangesauthor[name={Dustin Siebert}, color=red]{ds}
\definechangesauthor[name={Jens Förstner}, color=red]{jf}
\definechangesauthor[name={Klaus D. Jöns}, color=red]{kj}
\definechangesauthor[name={Stefan Schumacher}, color=red]{ss}
%   \added[id=name]{Added Text}
%   \deleted[id=name]{Deleted Text}
%   \replaced[id=name]{Text that got replaced}{with this text}
...
\newcommand{\kbt}{\kb T}
%% Exciton/Biexciton names in text
\newcommand{\XB}{\text{XX}}
\newcommand{\XS}{\text{X}}
\newcommand{\XH}{\text{H}}
\newcommand{\XV}{\text{V}}
...
\title{On-demand indistinguishable and entangled photons \\using tailored cavity designs}% Force line breaks with \\
...
\begin{abstract}
The biexciton-exciton emission cascade commonly used in quantum-dot systems to generate polarization entanglement yields photons with intrinsically limited indistinguishability. %This restriction can be alleviated, however, by reducing the biexciton lifetime, leading to less temporal uncertainty in the correlated emission of the two photons. Following this approach, improved photon indistinguishability was demonstrated for single photons emitted from the exciton after stimulating the biexciton emission with a short laser pulse. 
...
% General Motivation
%% QD as sources for highly indistinguishable photons (scholl2020crux,bauch2021ultrafast, ...)
%%% reasons for HOM-indist...
%% QD as only sources for on demand highly entangled twin photons from the biexciton-exciton cascade (bauch2021ultrafast, dirch, sources aus scholl2020crux ...)
%%% reasons for conc (quantum cryptography, ...)...
%% applications like quantum relays, quantum repeaters (scholl2020crux) need highly indistinguishable and entangled photons
%%% challenging even under ideal excitation
%% Reasoning is due to the lifetime of the biexciton (scholl2020crux), ref overview
%% Increase Indist by reducing XX Lifetime: https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.125.233605

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%......................................... Goal: Explain Telecom Wavelength for Communication ...........................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%............................................... Goal: Move to single photon source, QD .................................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%..................................... Goal: Explain Numerical Aspects of Circular Bragg Reflector ......................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%............................................... Goal: Explain 4LS and biexciton energies ...............................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%......................................... Figure: Biexciton System, Cavity and Energy Structure ........................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[t]
\includegraphics[width=\columnwidth]{images_prx/poster_content.pdf}
...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%................................... Figure: Comparison Visibility/Indistinguishability with Crux Paper .................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[t]
\includegraphics[width=\columnwidth]{images_prx/3ls_lifetimes_vertical.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%....................................... Goal: Explain why we use indist and not visibility (G2) ........................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Hence, the more complex single photon indistinguishability (\cref{eqn:homindist}) will be evaluated. 
%Without loss of generality, for the results shown in this work, the visibility can be treated as the upper limit for the indistinguishability, where in the limit of $\Bar{\Bar{G}}^{(2)}\approx 0$, both quantities are equal (compare \cref{fig:poc_3ls}).
Thus, to include the relevant multi-photon processes in the emission cascade, the indistinguishability $\indist$, as defined in the appendix in \cref{eqn:homindist}, will be utilized. %, assuming it provides a lower limit for the visibility.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%...................................................... Goal: Reference to Crux .........................................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%.................................. Goal: Explain Excitation of QD, reason why we dont include excitation ...............................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
In order to isolate the effect of the Purcell-enhanced biexciton-exciton transition, in the first part of the analysis we will  assume a perfectly prepared biexciton at $t = 0$. % before emission starts\deleted{ to occur with $\rho(t=0) = \ketbra{\XB}$}. 
...
\begin{figure}[t]
\includegraphics[width=\columnwidth]{images_prx/cbg_optimization.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%................................................ Figure: Cavity Render and Mode Simulation .............................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{figure}[t]
\includegraphics[width=\columnwidth]{images_prx/new_fig_4.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%................................................. Purpose: Defined Overlaying Conditions ...............................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%....................................... Figure: General Trend for swept cavity and sweot $\Q$-factor ......................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[t]
\includegraphics[width=\columnwidth]{images_prx/kappa_gamma_sweep_vertical_2.pdf}
...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%................................................. Purpose: Explain Figure poc_biexciton ................................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Swept cavity and cavity loss rate, which directly translates to $\Q$-factor,  
...
%%% at exciton yields highly indistinguishable X photon and photons are highly entangled.
...
%%%% strong coupling means fast decay of population, which means preperation of the biexciton is strongly hindered
%%%% ... %%%%
%%% at 2photon, yields highly entangled photon pair, but because of energy degeneracy, indistinguishability is intrinsically reduced.
...
%%%% for lower-Q cavities, properties are reduced to reference values
%%%% ... %%%%
%%% around xx-x transition, indist can be increased significantly
...
%%%% We see that indist is actually maximized shortly before reaching E_XX
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%................. Figure: Display Purcell enhancement turn-on. F_p modulating by changing kappa or g, respectively .....................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[t]
%\includegraphics[width=\columnwidth]{images_prx/purcell_enable_cavity.pdf}
\includegraphics[width=\columnwidth]{images_prx/purcell_enable_cavity_2.5_vertical.pdf}
...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%................................................. Purpose: Explain Figure purcell_scan .................................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% swept F_P. ref to F_P, we see that if we set gamma_rad = 5mueV constant, we can change F_P via kappa or via g or kappa, i.e. coupling or Q-fac
...
%%% again with phonons, significant increase in indist, because of dephasing, paths dont mix as much
%% for modulation via coupling:
...
\begin{figure}[t]
\includegraphics[width=\columnwidth]{images_prx/reference_and_pulse.pdf}
...
Because a low $\Q$-factor and high light matter coupling constant $\hbar g$ appear to be required for generating strongly entangled and individually highly indistinguishable photons, a broad sweep of both parameters is evaluated in \cref{fig:g_kappa_sweepT4.2k}. Here it becomes clear that maximizing all properties at the same time is possible  over a large range of parameters. %even when some variation in the parameters is allowed.
...
\begin{figure}[t]
\includegraphics[width=\columnwidth]{images_prx/g_kappa_sweep_at_T4.2K_linear_offset.pdf}
\caption{\label{fig:g_kappa_sweepT4.2k}Indistinguishability of the exciton photon $\indist_\XS$ \textbf{(a,d)}, of the biexciton photon $\indist_\XB$ \textbf{(b,e)} and their concurrence $\conc$ \textbf{(c,f)} for a swept cavity coupling $\hbar g \in[\SI{100}{\mueV},\SI{500}{\mueV}]$ and Purcell factor $\purcell\in[1,50]$. The radiative decay rate is set to $\SI{2.5}{\mueV}$ and the temperature is set to $T=\SI{4.2}{\kelvin}$ (d-f, no electron phonon coupling in a-c). The cavity is set to exactly the biexciton-exciton transition. A linear fit for the local maxima of the 2D data (white dotted line) reveals the maxima of the product of all the quantum properties depicted to follow $\hbar g =\alpha \purcell + \beta$ with $\alpha \approx 10.3~(11.6)$ and $\beta \approx 38~(72)$ (with no electron phonon coupling, black dotted line). The blue cross in (e) corresponds to the simulated cavity in \cref{fig:maxwell_optimized_cavities},a.}
\end{figure}

These results are illustrated in \cref{fig:g_kappa_sweepT4.2k}. 
%Because of the large line widths of the cavity, the inclusion of additional side modes which are described in \cref{fig:maxwell_cavity_mode} may become necessary.
...
% TODO: finestructure induced precession of the exciton states reduces concurrence to these values.

We may also fit a linear dependency of the light-matter coupling and the Purcell enhancement to $\hbar g \approx \alpha\purcell + \beta$, where for our parameters and for $T=\SI{4.2}{K}$, $\alpha\approx \SI{10.3}{\mueV}$ and $\beta\approx \SI{38}{\mueV}$ (compare \cref{fig:g_kappa_sweepT4.2k},b,e) %In other words, using \cref{eqn:purcell_factor_qd}, we can estimate 
%\begin{align}
%    \gamma_\text{Rad} \kappa &= 2\alpha g ~,\\
%    \Q &= \frac{E_c\gamma_\text{Rad}}{2\alpha g}~,
%\end{align}
for the QD-cavity system to yield the best possible photons. The scaling factor $\alpha$ depends on the strength of the electron-phonon coupling and therefore the temperature (see \cref{subsec:tempdep}). This information can then be used to refine the fitness function for the Maxwell optimizer described in \cref{sec:cavity}, resulting in precise tuning of the required cavity mode to maximize the photon quality.

% Hier vielleicht die optimization results mit g = 11 FP einpflegen
...
%\added[comment={test}]{new added}
% Motivation; quantum emitter at televom wavelength
We have presented an in-depth theoretical and numerical analysis of a quantum emitter generating highly indistinguishable and simultaneously entangled photons.
%% already realized with bullseye cavities
...
%% new: indistinguishable AND entangled photons
...
%% Increased Purcell enhancement reduces biexciton liftime
...
%%% by adding cavity to XX-X transition
...
% Summarize Maxwell
We optimized the cavity structure to favour low $\Q$-factors and large coupling values with low Purcell enhancement. Notably, our results show that optimization towards large Purcell enhancements, as is customary for these structures \cite{Rickert:19,bremer2022numerical}, is not equally advantageous.
% Summarize exact results
%% removing intrinsic limit, leaving conc high
...
%% for purcell of 5-10
For the investigated set of cavity parameters, a Purcell enhancement of $\purcell\in[5,15]$ appears to be ideal, where the exact value depends on the details of the individual quantum dot, most importantly the rate of radiative decay and the temperature. %For strong couplings, the ideal Purcell enhancement shifts to slightly larger values, up to $\purcell > 40$.
%%  Phonon can even increase values
...
%% Pulse influence 
Similarly, an excitation method with maximum biexciton preparation fidelity is preferred, but not required for this emission scheme to yield high quality photons. %, where the indistinguishabilities as well as the entanglement remain high. 
However, the specifics of the excitation process depend strongly on the cavity, where utilizing advanced excitation methods like pulse shaping \cite{praschan2022pulse} or the SUPER scheme \cite{karli2022super,heinisch2023swing} may prove beneficial.
While our results are tailored towards the telecom wavelength at $\SI{1550}{nm}$, other wavelengths can be achieved with little further adjustment due to the broad cavity mode.
%
%Overall, for the purposes of this work, high coupling and low $\Q$ cavities are required, which proved to be possible using circular Bragg structures.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%........................................................................................................................................%
%........................ Theory - Includes Purcell Enhancement, Visibility, Indistinguishability, Concurrence ..........................%
%........................................................................................................................................%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The optical excitation pulse is considered by driving the electronic coherences using a Gaussian envelope \cite{bauch2021ultrafast,PhysRevB.105.045302}. Implementation details can be found at \cite{Bauch_QDLC-C_2023}.
...
\begin{figure}[b]
	\includegraphics[width=\columnwidth]{images_prx/maxFP_Plot.pdf}
...
\subsection{Temperature Dependency of the Linear Optimization}\label{subsec:tempdep}
Varying the temperature for the configuration given in \cref{fig:g_kappa_sweepT4.2k} reveals the fitting parameters with scaling $\alpha(T)$ and offset $\beta(T)$, which is shown in \cref{fig:tempdep}. The reciprocal scaling of the fitting parameters may be induced by the also reciprocal temperature scaling of the phonon interactions. We see a slight decline in the scaling $\alpha$ with raising temperature, and when disabling the linear offset $\beta$, a pure reciprocal scaling can be observed. 
\begin{figure}[h!]
\includegraphics[width=\columnwidth]{images_prx/g_kappa_sweep_tempdep_fit.pdf}
\caption{\label{fig:tempdep}Temperature dependency of the fitting parameters $\alpha(T)$ and $\beta(T)$. Four different temperatures are shown exemplary for $T\in{0,5,10,20}$. The settings for the simulations correspond to \cref{fig:g_kappa_sweepT4.2k}, including the linear fit (white dashed lines). The temperature dependency for the fitting parameters is shown for the proportionality $\alpha(T)$ (e) and the offset $\beta(T)$ (f). Fitting with a nonzero offset (violet lines) are compared with a fit through the origin (orange lines). Fitting only the biexciton-exciton indistinguishability $\indist_\XB$ (solid lines) is compared to fitting the product of all indistinguishabilities and the concurrence (dashed lines).}
\end{figure}
Because these simulations are complex and very time-intensive, we calculate the temperature dependency of the fitting parameters at low-resolution (\cref{fig:tempdep},e,f) and hence exclude them from the main text. Fitting the biexciton-exciton photons indistinguishability does not significantly differ from fitting the product of all three quantum properties. Nevertheless, fitting the product can lead to slight artifacts, as can be seen in \cref{fig:tempdep},e,f.

\subsection{CBG Dimensions}\label{subsec:cbgdim}
%\vspace*{-1em}
\begin{table}[h!]
	...
	\begin{tabular}{ |c||c|c| }
		\hline 
		\textbf{Dimension [nm]} & \textbf{Fig. \ref{fig:maxwell_optimized_cavities},a} & \textbf{Fig. \ref{fig:Plots_maxFP},c} \\ [0.5ex]
		\hline
		\hline
		Grating Period & 563.3 & 561.9\\
		\hline
		1. Trench Width & 154.3 & 204.5\\
		\hline
		Trench Width & 161 & 93.3\\
		\hline
		Cavity Radius & 584.1& 588.1\\
		\hline
		CBG Height & 450.6& 363.8 \\
		\hline
		Thickness SiO\textsubscript{2} & 359.6 & 189.6\\
		\hline
	\end{tabular}
\end{table}
...
%\begin{figure}[!htb]
%\includegraphics[width=\columnwidth]{images_prx/kappa_gamma_sweep_vertical_em_2.pdf}
%\caption{\label{fig:poc_biexciton_em}Emission Probabilities of the exciton emission \textbf{(a)} and the biexciton emission \textbf{(b)} for %a swept cavity energy $E_c = \hbar\omega_c$ and cavity emission rate $\hbar\kappa$ scaled by the fixed QD-cavity coupling $\hbar g = \SI{200}%{\mueV}$. The data corresponds to the quantum properties shown in \cref{fig:poc_biexciton}}
%\end{figure}
%\newpage
\clearpage
\bibliography{bibo}% Produces the bibliography via BibTeX.
