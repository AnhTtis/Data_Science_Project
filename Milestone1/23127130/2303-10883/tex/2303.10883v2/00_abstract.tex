...
Different from the previous visual prompting which is typically a dataset-level implicit embedding, our key insight is to enforce the tunable parameters focusing on the explicit visual content from each individual image, \ie, the features from frozen patch embeddings and the input's high-frequency components.
...
Our code is available at:~\url{https://github.com/NiFangBaAGe/Explicit-Visual-Prompt}.
