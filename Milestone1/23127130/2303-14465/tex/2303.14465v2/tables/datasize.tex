...
% represents training with 10K steps for efficiency. 
% \linjie{Why we only report on real image sub-set? Do we have results on synthetic sub-sets too? If no, we should provide a reason in the main text. Add results on Kubric?}
}
\label{tab:datasize}
\end{table}