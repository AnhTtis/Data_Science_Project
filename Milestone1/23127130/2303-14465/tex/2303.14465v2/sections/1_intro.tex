...
% , as indicated by the fluctuating ranking line (\inlineimg{images-inline/green-line}).
% Although CLIP correctly retrieved the top-$1$ image, the semantically incorrect images \linjie{(\eg \#xx)} are falsely ranked higher than the correct ones \linjie{(\eg \#2)}, as indicated by 
% % the chaotic color sorting 
% irregular color changes 
% highlighted in the red dashed box. 
...
% While being effective on standard retrieval benchmarks, we show that the
