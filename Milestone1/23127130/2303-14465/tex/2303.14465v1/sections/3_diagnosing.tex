...
We argue that standard VL evaluation kits~\cite{plummer2015flickr30k, Lin2014MicrosoftCC} are too coarse to evaluate the equivariance of VLMs similarity. Existing VLMs can easily distinguish most samples in conventional retrieval benchmarks, \eg, images of a group of people against those with cars, given a caption of ``a group of people standing on the street''.
