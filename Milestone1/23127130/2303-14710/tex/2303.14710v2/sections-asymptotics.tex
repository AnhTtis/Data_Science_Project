...
from Theorem~\ref{thm:matrix} are clearly satisfied and this leaves a large amount of
...
is uniform in~$n$.
Now, recall that DOAG labelled transition matrices are a sub-class of variations
