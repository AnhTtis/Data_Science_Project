...
\caption{Markov Chain with four states%
\ifarxiv{.}
\else
; labels are drawn next to their state.
\fi}
...
(the labels of $\latentmdp$ are drawn next to their state).
\else
Let $\latentmdp$ be the discrete MC of Fig.~\ref{fig:markov-chain-independent-bernoulli}.
\fi
