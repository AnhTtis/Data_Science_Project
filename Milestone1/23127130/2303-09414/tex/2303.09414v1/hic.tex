...
with velocity $v=z/t$ in the center of mass frame, in a manner reminiscent of
...
$\sqrt{s}=19.6,~130~{\rm and}~200~\rm GeV$. Gray band represents most central
collisions in $0-6\%$ centrality bin. The plots are taken from
...
This idealized picture can be expressed as a set of symmetry assumptions which
...
One can parameterise the eigenvalues $\pL, \pT$
as 
\begin{equation}
