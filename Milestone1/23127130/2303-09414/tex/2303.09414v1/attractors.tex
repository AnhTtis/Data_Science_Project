...
It is important to realize that there are corrections to \rf{eq:MISlatetime}
...
divergent factorially: at large $n$, up to a constant factor, one has 
\be
\label{eq:dingle}
...
The most straightforward and widely-used way to carry out the required analytic continuation is 
...
pressure anisotropy in parameterising the dissipative part of the general-frame
