...
\caption{Left: evolution of explained variance ratio of each principal component
  ...
  centres lying in the middle of initial dots of corresponding colour in
...
${\cal A}_\star$.  The background colour encodes the speed at which
...
$C_{\tau_{\pi}} = 1$; 
$\tau_{0}$ denotes the initialisation time.
...
background colour is determined by~$V$, where  bluer colour implies lower speed.
...
generalises directly to phase spaces of any dimension. 
