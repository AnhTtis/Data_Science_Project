%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Attractor behaviour through AdS/CFT} 
\label{sec:attractorHolo}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
This procedure has been in tested in the case of the HJSW
model~\cite{Heller:2014wfa} which has a similar singularity structure  and where
the true attractor is easily found numerically.  The relevant equation which is
...
the transient transseries contributions are no longer negligible. Moreover,
