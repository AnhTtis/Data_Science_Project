...
\begin{enumerate}
    ...
    \item To address the memory restrictions of robotic platforms, we develop a fixed-size replay buffer based on rare class sampling and image diversity.
