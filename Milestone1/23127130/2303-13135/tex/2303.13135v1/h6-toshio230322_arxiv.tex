...
\begin{equation}
R^{(n)}_c=a^{(n)}_{\tau,m}R^{(m)}_\tau+b^{(n)}_\tau,
\end{equation}
the element $(R^{(m)}_{\tau,i}, R^{(n)}_{c,i})$ by the model $i$ satisfies
\begin{equation} 
R^{(n)}_{c,i}=a^{(n)}_{\tau,m}R^{(m)}_{\tau,i}+b^{(n)}_\tau+\delta^{(m,n)}_{\tau,i},
 \end{equation}
and by the definition of LSL, their mean values is given by Eq.(\ref{nmmean}) as
\begin{equation}
\avr{R^{(n)}_c}=a^{(n)}_{\tau,m}\avr{R^{(m)}_\tau}+b^{(n)}_\tau,
\end{equation}
...
Now, we take into account the deviation $\Delta^{(n,m)}_{\tau,i}$ from Eq.(\ref{nm}) as
\begin{equation}
R^{(n)}_{c,i}=\sum_{\tau,m}\alpha^{(n)}_{\tau,m}R^{(m)}_{\tau,i}
 +\sum_{\tau,m}W^{(n,m)}_{\tau,i} + C^{(n)}+\Delta^{(n,m)}_{\tau,i}.\label{nmi}
\end{equation}
In assuming $\avr{\Delta^{(n,m)}_{\tau,i}}=0$,
Eq.(\ref{nmm}) holds as
\begin{equation}
\avr{R^{(n)}_c}=\sum_{\tau,m}\alpha^{(n)}_{\tau,m}\avr{R^{(m)}_\tau}
...
+\sum_{\tau,m}\left(W^{(n,m)}_{\tau,i}-\avr{W^{(n,m)}_{\tau,i}}\right)
...
\left(1-\frac{\delta^{(m,n)}_{\tau,i}}{R^{(n)}_{c,i}-\avr{R^{(n)}_c}}\right) 
 ...
 \left(1-\frac{\delta^{(m,n)}_{W_\tau,i}}{R^{(n)}_{c,i}-\avr{R^{(n)}_c}}\right)
...
\Delta^{(n,m)}_{\tau,i}\ll(R^{(n)}_{c,i}-\avr{R^{(n)}_c})$.
Eq.(\ref{sumrule0}) implies that Eq.(\ref{lslexp0}) is also affected by  
$\delta^{(m,n)}_{\tau,i}, \delta^{(m,n)}_{W_\tau,i}$ and $\Delta^{(n,m)}_{\tau,i}$.
