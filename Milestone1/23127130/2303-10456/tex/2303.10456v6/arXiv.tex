...
% \subsubsection{Purturbation Approach 3}
% First, we observe that it suffices to consider the corner points 
% of the pentagonal region $\mathfrak{R}(\phi,\mathcal{L}_1,\mathcal{L}_2)$.
