...
%
%
\cite{vanLoockAltBecherBensonBocheDeppe:20p,Pereg:22p,PeregDeppeBoche:23p1,BFSDBFJ:20b}. 
...
%
%
 The capacity region $\opC_{\text{CRT}}(P_{Y|X_1,X_2})$  %
...
For a general MAC without assisting resources, the capacity region under a maximal error criterion is unknown. %
...
we include
 correlations that  are obtained in the limit of %
%
%
%
%
...
4.5cm},clip]{EntangledTx_Figure_Example_1.pdf} %
%
...
The square indicate is the capacity region $\mathcal{C}_{\text{ET}}(P_{Y|X_1,X_2})$, with entangled transmitters. The red area represents rate pairs that can be achieved with entanglement, but cannot be achieved with classical CR.
%
}
...
%
\caption{Achievable rate regions for the magic-square  multiple-access channel $P_{Y|X_1,X_2}$  with entangled transmitters and, either classical or quantum, conferencing, as we in Example~\ref{Example:Magic_Square}.
%
...
In this section, we %
show that the inner and outer regions %
...
\end{align}
for $\lambda\in \left[0,\frac{1}{2} \right]$.
...
p_{V_1}(v_1)p_{V_2}(v_2) \trace\left[ (L_1(x_1|v_1)\otimes L_2(x_2|v_2)) \varphi_{A_1 A_2} \right] P_{Y|X_1,X_2}(y|x_1,x_2) \,.
...
\begin{align}
\frac{\partial}{\partial \epsilon} [ \gamma_1 I(V_1;Y|V_2)+\gamma_2 I(V_2;Y)]
\Big|_{\epsilon=0}
=\gamma_1(  H_f(V_1,V_2)
- H_f(Y,V_1,V_2))
= 0 \,.
...
Hence, for
$(\breve{V}_1,\breve{V}_2,\breve{X}_1,\breve{X}_2,\breve{Y})\sim \tilde{Q}_\epsilon$, %
%
%
%
\begin{align}
...
\Big|_{\epsilon=0}
=(1-2\lambda)\frac{\partial^2}{\partial \epsilon^2} H(\breve{Y},\breve{V}_2) \Big|_{\epsilon=0}
\leq 0 \,,
\end{align}
which is equivalent to
\begin{align}
...
%
\begin{align}
\tilde{Q}_\epsilon(u_2,y)&=\tilde{Q}(u_2,y) \,.
\end{align}
It follows that 
\begin{align}
I(\breve{V}_1;\breve{Y}|\breve{V}_2)&=
...
$G$, we also have
\begin{align}
\frac{\partial}{\partial \epsilon} [ (1-\lambda) I(V_1;Y|V_2)+\lambda I(V_2;Y)]
\Big|_{\epsilon=0}
...
2032991, 
the Junior Faculty Program for Quantum Science and Technology of the Israel Planning and Budgeting Committee of the Council for Higher Education   (VATAT)  through Grant 86636903, Chaya Career Advancement Chair, Grant 8776026, and the Nevet Program of the Helen Diller Quantum Center at the Technion.
