...
\author{
Junyi Zhang$^1$\thanks{Work done during an internship at Microsoft Research Asia.} \qquad Jiaqi Guo$^2$ \qquad Shizhao Sun$^2$ \qquad Jian-Guang Lou$^2$ \qquad Dongmei Zhang$^2$\\
...
\begin{abstract}
    ...
    Project page: \url{https://layoutdiffusion.github.io}.
\end{abstract}
\vspace{-5px}
%%%%%%%%% BODY TEXT
\input{cvpr2023-author_kit-v1_1-1/latex/sections/intro}
\input{cvpr2023-author_kit-v1_1-1/latex/sections/related}
\input{cvpr2023-author_kit-v1_1-1/latex/sections/preliminary}
\input{cvpr2023-author_kit-v1_1-1/latex/sections/approach}
\input{cvpr2023-author_kit-v1_1-1/latex/sections/quant_ungen}
\input{cvpr2023-author_kit-v1_1-1/latex/sections/exp.tex}
...
We would like to thank Zhaoyun Jiang for helpful discussions. 
We also appreciate Zhaoyun Jiang's support in providing the pre-processed datasets and pretrained models for the FID evaluations.
...
\onecolumn
\input{cvpr2023-author_kit-v1_1-1/latex/sections/Suppl.tex}
\end{document}
