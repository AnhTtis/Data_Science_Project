...
Following the accessible paradigm, we present an implementation called \textbf{\method}\footnote{``Troika'' is a traditional harness driving combination, using three horses abreast, usually pulling a sleigh.}.
...
\begin{figure}[!t]
  \centering
   \includegraphics[width=\linewidth]{figure/CMT-new-latest.pdf}
   \vspace{-7mm}
   \caption{%
   \textbf{An example of the \CMT module.}
   The commonly learned prompts might be farther away from individual images with the same concept, and
