...
The latest DFSP~\cite{Lu:DFSP} proposes a cross-modal decomposed fusion module to learn more expressive image features.
...
CLIP-based CZSL methods~\cite{Nayak:CSP,Xu:PromptCompVL,Lu:DFSP} continue the vein by tuning both the inserted prefix and the primitive vocabulary tokens on downstream semantics.
While following the \MP paradigm to establish three independent branches, 
