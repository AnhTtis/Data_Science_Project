...
This paper has supplementary downloadable material available at http://ieeexplore.ieee.org., provided by the author. The material includes additional experimental results from both simulations and using our developed prototype camera.
}}

% The paper headers
\ifx\ManuscriptType\IEEEpaper
\markboth{IEEE transactions on computational imaging, vol. xx, YEAR XXXX}{C. S. A. V. Silva Neto \MakeLowercase{\textit{et al.}}: Extended Depth-of-Field Lensless Imaging using an Optimized Radial Mask}
\fi
...
\input{sections/2-radialOptimization}
\input{sections/3-extendedDOF}
...
\bibitem{Asif2017} M. S. Asif, A. Ayremlou, A. Sankaranarayanan, A. Veeraraghavan and R. G. Baraniuk, "FlatCam: Thin, Lensless Cameras Using Coded Aperture and Computation," in IEEE Transactions on Computational Imaging, vol. 3, no. 3, pp. 384-397, Sept. 2017.
...
\bibitem{Chen2017} C. Fu, M. L. Don, and G. R. Arce, "Compressive Spectral Imaging via Polar Coded Aperture," in IEEE Transactions on Computational Imaging, vol. 3, no. 3, pp. 408-420, Sept. 2017.

\bibitem{Don2017} M. L. Don, C. Fu, and G. R. Arce, "Compressive imaging via a rotating coded aperture," Appl. Opt. 56, B142-B153, 2017.

\bibitem{Ming2021} Y. Ming, X. Meng, C. Fan, H. Yu, Deep learning for monocular depth estimation: A review, Neurocomputing, Volume 438, Pages 14-33, 2021.
