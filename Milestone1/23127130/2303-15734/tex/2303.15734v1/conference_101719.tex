...
The levels for HP are 400, 300, 250, 200, 150, 100, and 50, which are connected to the instrument’s volume levels of 75\%, 60\%, 55\%, 40\%, 35\%, 25\%, and 10\% respectively. For  EP of both players, the instruments’ volume levels are the same as HP, but EP levels are 300, 250, 200, 150, 100, and 50. For PD, the levels are 800, 600, 500, 400, 300, 60, and 0,  which are connected to the instrument’s volume levels of 75\%, 60\%, 50\%, 40\%, 30\%, 20\%, and 10\%. The reason for the abrupt change from 300 to 60 is for the players without vision to know without a doubt that the opponent player is near them.
