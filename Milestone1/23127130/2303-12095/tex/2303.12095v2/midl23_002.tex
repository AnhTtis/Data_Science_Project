...
\begin{figure}[h!]
    ...
    \caption{H\&E image, Attention maps, cell level predictions and pathologist annotation for UC patient with lesional macroscopic appearance and high endoscopic score.}
