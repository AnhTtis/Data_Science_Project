            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \[ \begin{prooftree}
                        ...
                        \infer2[(\ruleAppPOne)]{\seqi{(x : \mul{\tvar}) + \Gam_p}{up}{\tneutral}{(b_p,1+s_p)}}
                    \end{prooftree} \]
                    where $\tau = \tneutral$, $\Gam = (x : \mul{\tvar}) + \Gam_p$ is tight, $b = b_p$, and $s = 1 + s_p$. Moreover, $\Gam_p$ is tight. By the \ih over $\Phi_p$, we have that $b_p = 0$. So we can conclude with $b = b_p = 0$.
