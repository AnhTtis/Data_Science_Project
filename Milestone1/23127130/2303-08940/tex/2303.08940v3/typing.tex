...
\begin{figure}[h]
    \[ \begin{array}{c}
        ...
        \\[.5cm]
        \begin{prooftree}
            \hypo{\seqi{\Gam}{t}{\tcomptype{\stype}{\tightt}{\cmiguel{\stype}{\stype'}}}{(b,m,d)}}
            \infer1[(\ruleAppPOne)]{\seqi{(x : \mul{\tvar}) + \Gam}{x t}{\tcomptype{\stype}{\tneutral}{\cmiguel{\stype}{\stype'}}}{(b,m,1+d)}}
        \end{prooftree}
        \sep 
        \begin{prooftree}
            \hypo{\seqi{\Gam}{u}{\tcomptype{\stype}{\tneutral}{\cmiguel{\stype}{\stype'}}}{(b,m,d)}}
            \infer1[(\ruleAppPTwo)]{\seqi{\Gam}{(\lam x.t) u}{\tcomptype{\stype}{\tneutral}{\cmiguel{\stype}{\stype'}}}{(b,m,1+d)}}
        \end{prooftree}
        \\[.5cm]     
