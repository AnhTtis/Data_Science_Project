...
In this paper, we aim to co-optimize the accuracy and hardware efficiency for GNNs on edge devices.
...
For instance, the GNN-based predictor can predict the latency of a candidate architecture for a target edge device within milliseconds on Nvidia RTX3080.