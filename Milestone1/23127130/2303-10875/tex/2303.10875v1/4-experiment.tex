...
\textbf{Edge devices.}
We employ four edge devices for comparing HGNAS and competitors: (1) Nvidia RTX3080~\cite{3080}, (2) Intel i7-8700K~\cite{cpu}, (3) Jetson TX2~\cite{tx2} with $8$GB memory, (4) Raspberry Pi 3B+~\cite{raspberry} with a Cortex-A5 processor and $1$GB memory. The latency and peak memory usage are obtained by deploying the GNN models on the above devices for inference using PyG framework.

\subsection{Exploration by HGNAS}

The models designed by HGNAS are comprehensively compared with baselines in terms of model size, accuracy, latency, peak memory. 
