...
%\paperheight = 11.69in
\usepackage[top=0.7in,bottom=0.70in,left=0.58in,right=0.58in]{geometry}
...
\thanks{This work is supported by National Natural Science Foundation of China (Grant No. 62072019). Corresponding authors are Jianlei Yang and Chunming Hu, Email: \url{jianlei@buaa.edu.cn}, \url{hucm@buaa.edu.cn}.
}
}

\author{Ao Zhou, Jianlei Yang, Yingjie Qi, Yumeng Shi, Tong Qiao, Weisheng Zhao, Chunming Hu}

\affil{Beihang University, Beijing, China}

% 周傲，杨建磊，齐英杰，施雨萌，乔同，赵巍胜，胡春明

\IEEEoverridecommandlockouts
\IEEEpubid{\makebox[\columnwidth]{
979-8-3503-2348-1/23/\$31.00~\copyright 2023 IEEE
 \hfill}
\hspace{\columnsep}\makebox[\columnwidth]{ }}
% For all other papers the copyright notice is: 979-8-3503-2348-1/23/$31.00 ©2023 IEEE
