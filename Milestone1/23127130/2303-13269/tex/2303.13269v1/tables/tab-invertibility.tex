...
\centering
\small
\caption{Re-identifiability of proposed ID transformation methods.}
...
\multicolumn{4}{c|}{} & \footnotesize{FaceNet} & \multicolumn{1}{c|}{\footnotesize{SphereFace}} & \footnotesize{FaceNet} & \footnotesize{SphereFace} \\ \midrule
