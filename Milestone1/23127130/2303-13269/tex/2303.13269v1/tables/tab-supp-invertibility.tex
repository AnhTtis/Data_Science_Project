...
\centering
\small
\caption{Re-identification performance and invertibility of different proposed ID transformation methods. ``NA" means that the evaluation cannot be performed, \eg, because the original images cannot be inverted or because the evaluation function (SphereFace) is also used by the evaluated method, causing fairness issues.}
...
Ours \scriptsize(mix, mlp, eye) & 0.07 & \multicolumn{1}{c|}{\textbf{0.00}} & 36.70 & \textbf{34.70} \\
Ours \scriptsize(sph, mlp, eye) & \textbf{0.00} &  \multicolumn{1}{c|}{\cellcolor{gray!33}}    & 68.70 & \cellcolor{gray!33} \\
Ours \scriptsize(mix, mlp, eye) & \textbf{0.00} &  \multicolumn{1}{c|}{\multirow{-2}{*}{\cellcolor{gray!33}  \color{white}NA}}   & \textbf{31.93} & \multirow{-2}{*}{\cellcolor{gray!33}  \color{white}NA} \\
