...
\begin{figure*}[t]
    ...
    \vspace{-12pt}
    \caption{\textit{Disguise} outperforms existing methods in various aspects, including image quality, de-id rate, and utility. For non-invertibility, our solution is close to other methods that completely erase the original IDs (\ie, recovering pure Gaussian noise).}
    \label{fig:hist-4dist}
    \vspace{-10pt}
\end{figure*}