...
\begin{figure}[!ht]
    ...
    \caption{Left: Histogram of $\ell_2$ distances between positive, negative, and original-anonymized pairs from LFW set. Right: ROC curves of validation rate for images altered by various methods.
    }
    \label{fig:hist-all}
\end{figure}
