...
\affil{\tt\small zheng@mines.edu,xlzhang@mines.edu}
...
\begin{equation}
  l_{n,t}=\left\{\begin{array}{cc}
0.5(H_\theta(x_t)-\theta_t)^2, & \text { for }|H_\theta(x_t)-\theta|<1 \\
|H_\theta(x_t)-\theta_t|-0.5, & \text { otherwise }
\end{array}\right.
  \label{eq:smooth_l1}
\end{equation}
