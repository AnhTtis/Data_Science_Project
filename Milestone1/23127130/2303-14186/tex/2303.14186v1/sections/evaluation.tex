...
We provide further details on these choices of dataset and task in \Cref{app:exp_setup}.
...
\Cref{fig:headline_full} and \Cref{tab:all_best}). Indeed, \trak attains
...
(on average) over 100 times smaller.
