...
a canonical data attribution method proposed by \citet{pregibon1981logistic}
...
complex models back to the logistic regression case.
...
\end{equation}
where, again, $\widehat{\lambda}$ is selected via cross-validation.
