We release an easy-to-use library, \texttt{traker},\footnote{\url{https://github.com/MadryLab/trak}}, which computes \trak scores using \Cref{alg:estimator_pseudo}.
...
1TB of storage. One solution is to generate the projection by blocks and
partially project the gradients. This solution is possible (and offered in our
...
write the results at the end. This forces us to use pseudo-randomness but is
not a problem since a true random matrix would make experiments impossible to
reproduce exactly.
