...
\begin{table}[h]
    ...
    \begin{tabular}{llrrrrrrrrr}
        ...
        & LDS & {\bf 0.216(4)} & 0.056(7) & 0.037(13) & 0.199(4) \\
        \midrule
        ...
        & LDS & {\bf 0.193(6)} & 0.008(6) &   0.037(6) & 0.1445(6) \\
        \bottomrule
        \end{tabular}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\linewidth,trim={0 0 0 0},clip]{figures/imagenet_nns_extra.pdf}
\caption{
...
\begin{figure}
    ...
    \bottomrule
\end{tabular}
\caption{{\em Top \trak attributions for \qnli examples.}}
\label{tab:qnli_more}
\end{figure}
