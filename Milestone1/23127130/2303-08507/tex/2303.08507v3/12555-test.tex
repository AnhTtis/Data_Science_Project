...
\author{David Auger\thanks{Address for correspondence:   Universit\'e Paris-Saclay, UVSQ, DAVID,
                     78035, Versailles, France.}\thanks{This work was supported by a public grant as part of the
                     Investissement d'avenir project, reference ANR-11-LABX-0056-LMH, LabEx LMH.}
 \\
Universit\'e Paris-Saclay, UVSQ, DAVID\\
...
\runninghead{D.~Auger et al.}{Neighbourhood Balancing Games}
...
Our model of nonatomic Neighbourhood Balancing Games lies somewhere between the model of nonatomic selfish routing (or "Wardrop model", see \cite{wardrop1952road}), selfish load balancing and congestion \linebreak games.
...
\begin{align*}
\alpha \geq \max \Big( & \max_{x \in [0,r]} \left\{ -\frac{ \partial D_1}{\partial x_1}(x,r-x) + \frac{ \partial D_1}{\partial x_2}(x,r-x) \right\}, \\[5pt]
...
C_i(\x) = x_i + \sum_{j \neq i} \alpha_{j,i} x_j, \vspace*{-2mm}
\end{equation}
...
\medskip
 ...
 \noindent Summing these two inequalities, we obtain after cancellations
...
\eject
\noindent We define two social costs:
\begin{itemize}
...
\item Step $2$: search for a non-uniform equilibrium: try with uncharged vertices, respecting Rules~\ref{rule:1} and~\ref{rule:2} above (Rule~\ref{rule:3} is respected because we are in a case when no uniform equilibrium has been found).
 ...
 \medskip
 Now, we restrict ourselves to the cases $\alpha = \frac{1}{2}$ and $\alpha =1$, the study of general $\alpha$ being seemingly out of reach. We recall Conjecture \ref{conjalph} when $\alpha <\frac{1}{2}$.
...
\begin{itemize}
    ...
    \item When $n=3k+1$ or $n=3k$, there is a unique solution, respectively \\
     $(\frac{3}{n+2},0,0,\frac{3}{n+2},0,0, \ldots , \frac{3}{n+2})$ or $(0,\frac{3}{n},0,0,\frac{3}{n},0, \ldots ,0,\frac{3}{n},0)$, which means that in both cases $det(M_{n,1})\neq 0$.
\end{itemize}
...
\bibitem{lasaulce2011game}
Lasaulce S, Tembine H.
\newblock Game theory and learning for wireless networks: fundamentals and
  applications.
\newblock Academic Press, 2011.  doi:10.1016/C2009-0-62852-X.

\bibitem{aryafar2013rat}
Aryafar E, Keshavarz-Haddad A, Wang M, Chiang M.
\newblock RAT selection games in HetNets.
\newblock In: INFOCOM, 2013 Proceedings IEEE. IEEE, 2013 pp. 998--1006.
doi:10.1109/INFCOM.2013.6566889.

\bibitem{wardrop1952road}
Wardrop JG.
\newblock Road paper. some theoretical aspects of road traffic research.
\newblock \emph{Proceedings of the institution of civil engineers}, 1952.
\newblock \textbf{1}(3):325--362.   doi:10.1680/ipeds.1952.11259.

\bibitem{Rosenthal1973class}
Rosenthal RW.
\newblock A class of games possessing pure-strategy Nash equilibria.
\newblock \emph{International Journal of Game Theory}, 1973.
\newblock \textbf{2}:65--67. doi:10.1007/BF01737559.

\bibitem{correa2011wardrop}
Correa JR, Stier-Moses NE.
\newblock Wardrop equilibria.
\newblock \emph{Encyclopedia of Operations Research and Management Science.
  Wiley}, 2011.  doi:10.1002/9780470400531.eorms0962.

\bibitem{beckmann1956studies}
Beckmann M, McGuire CB, Winsten CB.
\newblock Studies in the Economics of Transportation.
\newblock \emph{The Economic Journal}, 1957.
\newblock \textbf{67}(265).

\bibitem{koutsoupias1999worst}
Koutsoupias E, Papadimitriou C.
\newblock Worst-case equilibria.
\newblock In: Annual Symposium on Theoretical Aspects of Computer Science.
  Springer, 1999 pp. 404--413. doi:10.1007/3-540-49116-3\_38.

\bibitem{roughgarden2002bad}
Roughgarden T, Tardos {\'E}.
\newblock How bad is selfish routing?
\newblock \emph{Journal of the ACM (JACM)}, 2002.
\newblock \textbf{49}(2):236--259.  doi:10.1145/506147.506153.

\bibitem{roughgarden2002price}
Roughgarden T.
\newblock The price of anarchy is independent of the network topology.
\newblock In: Proceedings of the thiry-fourth annual ACM symposium on Theory of
  computing. 2002 pp. 428--437.  doi:10.1145/509907.509971.

\bibitem{colini2016price}
Colini-Baldeschi R, Cominetti R, Scarsini M.
\newblock On the price of anarchy of highly congested nonatomic network games.
\newblock In: Algorithmic Game Theory: 9th International Symposium, SAGT 2016,
  Liverpool, UK, September 19--21, 2016, Proceedings 9. Springer, 2016 pp.
  117--128.  doi:10.1007/978-3-662-53354-3\_10.

\bibitem{colini2020selfish}
Colini-Baldeschi R, Cominetti R, Mertikopoulos P, Scarsini M.
\newblock When is selfish routing bad? The price of anarchy in light and heavy  traffic.
\newblock \emph{Operations Research}, 2020.
\newblock \textbf{68}(2):411--434.  doi:10.1287/ opre.2019.1894.

\bibitem{wu2021selfishness}
Wu Z, M{\"o}hring RH, Chen Y, Xu D.
\newblock Selfishness need not be bad.
\newblock \emph{Operations Research}, 2021.
\newblock \textbf{69}(2):410--435.  doi:10.1287/opre.2020.2036.

\bibitem{nisan2007algorithmic}
Nisan N, Roughgarden T, Tardos E, Vazirani VV.
\newblock Algorithmic game theory, volume~1.
\newblock Cambridge University Press Cambridge, 2007.
ISBN-10:0521872820,  13:978-0521872829.

\bibitem{CzumajVocking:Tight-bounds-for-worst-case}
Czumaj A, V{\"o}cking B.
\newblock Tight bounds for worst-case equilibria.
\newblock In: Proceedings of the 13th Annual ACM-SIAM Symposium on Discrete
  Algorithms. 2002 pp. 413--420.  ISBN:0-89871-513-X,

\bibitem{ChristodoulouKoutsoupiasNanavati:Coordination-Mechanisms}
Christodoulou G, Koutsoupias E, Nanavati A.
\newblock Coordination Mechanisms.
\newblock In: Proceedings of the 31st International Colloquium on Automata,
  Languages and Programming (ICALP). 2004 pp. 345--357.
  doi:10.1007/978-3-540-27836-8\_31.

\bibitem{durr2009non}
D{\"u}rr C, Thang NK.
\newblock Non-clairvoyant scheduling games.
\newblock In: International Symposium on Algorithmic Game Theory. Springer,
  2009 pp. 135--146.   doi:10.1007/978-3-642-04645-2\_13.

\bibitem{ImmorlicaLiMirrokni:Coordination-Mechanisms-for-Selfish}
Immorlica N, Li L, Mirrokni VS, Schulz A.
\newblock {C}oordination Mechanisms for Selfish Scheduling.
\newblock In: Proceedings of the 1st International Workshop on Internet and
  Network Economics (WINE). 2005 pp. 55--69.  doi:10.1007/11600930\_7.

\bibitem{Thang:NP-hardness-of-pure-Nash}
Thang NK.
\newblock $\mathcal{NP}$-hardness of pure {N}ash equilibrium in {S}cheduling
  and {C}onnection {G}ames.
\newblock In: Proceedings of the 35th International Conference on Current
  Trends in Theory and Practice of Computer Science (SOFSEM). 2009 pp.
  413--424.  doi:10.1007/978-3-540-95891-8\_38.

\bibitem{abed2014optimal}
Abed F, Correa JR, Huang CC.
\newblock Optimal coordination mechanisms for multi-job scheduling games.
\newblock In: European Symposium on Algorithms. Springer, 2014 pp. 13--24.
doi:10.1007/978-3-662-44777-2\_2.

\bibitem{AwerbuchAzarRichter:Tradeoffs-in-worst-case-equilibria}
Awerbuch B, Azar Y, Richter Y, Tsur D.
\newblock {T}radeoffs in worst-case equilibria.
\newblock \emph{Theoretical Computer Science}, 2006.
\newblock \textbf{361}(2-3):200--209.  doi:10.1016/j.tcs.2006.05.010.

\bibitem{GairingLuckingMavronicolas:Computing-Nash-equilibria}
Gairing M, L{\"u}cking T, Mavronicolas M, Monien B.
\newblock {C}omputing {N}ash equilibria for scheduling on restricted parallel   links.
\newblock In: Proceedings of the 36th ACM Symposium on Theory of Computing
  (STOC). 2004 pp. 613--622.  doi:10.1145/1007352.1007446.

\bibitem{roughgarden2015intrinsic}
Roughgarden T.
\newblock Intrinsic robustness of the price of anarchy.
\newblock \emph{Journal of the ACM (JACM)}, 2015.
\newblock \textbf{62}(5):32.  doi:10.1145/2806883.

\bibitem{SchuurmanVredeveld:Performance-guarantees-of-local}
Schuurman P, Vredeveld T.
\newblock Performance guarantees of local search for multiprocessor scheduling.
\newblock \emph{Informs Journal on Computing}, 2007.
\newblock \textbf{361}(1):52--63.  doi:10.1287/ijoc.1050.0152.

\bibitem{schulz2003performance}
Schulz AS, Moses NES.
\newblock On the performance of user equilibria in traffic networks.
\newblock In: SODA, volume~3. 2003 pp. 86--87.   doi:10.1145/644108.644121.

\bibitem{caragiannis2006tight}
Caragiannis I, Flammini M, Kaklamanis C, Kanellopoulos P, Moscardelli L.
\newblock Tight bounds for selfish and greedy load balancing.
\newblock In: Automata, Languages and Programming: 33rd International
  Colloquium, ICALP 2006, Venice, Italy, July 10-14, 2006, Proceedings, Part I
  33. Springer, 2006 pp. 311--322.  doi:10.1007/11786986\_28.

\bibitem{christodoulou2005price}
Christodoulou G, Koutsoupias E.
\newblock On the price of anarchy and stability of correlated equilibria of
  linear congestion games.
\newblock In: Algorithms--ESA 2005: 13th Annual European Symposium, Palma de
  Mallorca, Spain, October 3-6, 2005. Proceedings 13. Springer, 2005 pp.
  59--70.   doi:10.1007/11561071\_8.

\bibitem{christodoulou2015price}
Christodoulou G, Gairing M.
\newblock Price of stability in polynomial congestion games.
\newblock \emph{ACM Transactions on Economics and Computation (TEAC)}, 2015.
\newblock \textbf{4}(2):1--17.  doi:10.1145/2841229.

\bibitem{vetta2002nash}
Vetta A.
\newblock Nash equilibria in competitive societies, with applications to
  facility location, traffic routing and auctions.
\newblock In: Foundations of Computer Science, 2002. Proceedings. The 43rd
  Annual IEEE Symposium on. IEEE, 2002 pp. 416--425.   doi:10.1109/SFCS.2002.1181966.

\bibitem{durr2007nash}
D{\"u}rr C, Thang NK.
\newblock Nash equilibria in Voronoi games on graphs.
\newblock In: European Symposium on Algorithms. Springer, 2007 pp. 17--28.
doi:10.1007/978-3-540-75520-3\_4.

\bibitem{teramoto2006voronoi}
Teramoto S, Demaine ED, Uehara R.
\newblock Voronoi game on graphs and its complexity.
\newblock In: 2006 IEEE Symposium on Computational Intelligence and Games.
  IEEE, 2006 pp. 265--271.  doi:10.1109/CIG.2006.311711.

\bibitem{bandyapadhyay2015voronoi}
Bandyapadhyay S, Banik A, Das S, Sarkar H.
\newblock Voronoi game on graphs.
\newblock \emph{Theoretical Computer Science}, 2015.
\newblock \textbf{562}:270--282.  doi:10.1016/j.tcs.2014.10.003.

\bibitem{nash1950equilibrium}
Nash~Jr JF.
\newblock Equilibrium points in n-person games.
\newblock \emph{Proceedings of the national academy of sciences}, 1950.
\newblock \textbf{36}(1):48--49.  doi:10.1073/pnas.36.1.48.

\bibitem{chva73}
Chv{\'a}tal V.
\newblock On the computational complexity of finding a kernel, report CRM300.
\newblock \emph{Universit{\'e} de Montr{\'e}al, Centre de Recherches
  Math{\'e}matiques}, 1973.

\bibitem{gare79}
Garey MR, Johnson DS.
\newblock Computers and intractability, volume 174.
\newblock Freeman San Francisco, 1979. ISBN-10:0716710455, 13:978-0716710455.

\bibitem{braess1968paradoxon}
Braess D.
\newblock {\"U}ber ein Paradoxon aus der Verkehrsplanung.
\newblock \emph{Unternehmensforschung}, 1968.
\newblock \textbf{12}:258--268.  doi:10.1007/BF01918335.
\end{thebibliography}
              %%\bibliographystyle{fundam}%%%plain}\bibliography{nonatomix}
