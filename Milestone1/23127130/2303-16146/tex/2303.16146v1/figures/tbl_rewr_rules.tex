...
\begin{table*}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/sources/tbl_rewr_rules.pdf}
  ...
  symbol $\mathfrak S$ denotes syntactic preconditions while $\mathfrak R$ denotes runtime ones.}
  \label{tbl:rewr_rules}
\end{table*}