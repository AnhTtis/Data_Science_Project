	...
	\begin{tikzpicture}[scale=0.6, thick,fsnode/.style={draw,circle,fill=black,scale=0.4}, lnode/.style={draw=red,circle,fill=red,scale=0.4}, snode/.style={draw=blue,circle,fill=blue,scale=0.4},tnode/.style={draw=black,circle,scale=0.4}, ltnode/.style={draw=red,circle,scale=0.4}]
	% ----------------A0'--------------------%
