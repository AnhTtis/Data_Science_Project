...
A list of datasets and additional settings can be found in \autoref{app:settings}.
...
Similarly to \citet{prood}, we adopted the policy of graying out the models with an accuracy drop greater than $3\%$ relative to the model with the highest accuracy.
