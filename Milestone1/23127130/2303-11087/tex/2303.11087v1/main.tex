% \documentclass[fleqn,preprint,12pt]{elsarticle}
%\documentclass[fleqn,final,3p]{elsarticle}
% \documentclass[letter,fleqn,preprint]{elsarticle}

%% Use the option review to obtain double line spacing
\documentclass[fleqn, preprint,review,12pt]{elsarticle}
...
\bibitem{Tartakovsky2008-mt}
A.~M. Tartakovsky, D.~M. Tartakovsky, T.~D. Scheibe, P.~Meakin, {Hybrid
  Simulations of Reaction-Diffusion Systems in Porous Media}, SIAM J. Sci.
  Comput. 30~(6) (2008) 2799--2816.
\newblock \href {https://doi.org/10.1137/070691097}
  {\path{doi:10.1137/070691097}}.
...
M.~Yousefzadeh, Y.~Yao, I.~Battiato, {A level-set immersed boundary method for
  ...
  Phys. 478~(111958) (2023) 111958, accepted.
...
K.~Pietrzyk, G.~Bucci, M.~Behandish, I.~Battiato, {Automated Upscaling via
  Symbolic Computing for Thermal Runaway Analysis in Li-ion Battery Modules},
  Submitted to Journal of Computational Science (2023).
