...
\begin{figure}[t]
  ...
  %\fbox{\rule{0pt}{2in} \rule{0.9\linewidth}{0pt}}
   ...
   \caption{Task-distribution shift between meta training and testing. The pseudo data (as visualized in \cite{fang2021contrastive}) distilled from pre-trained models only contains partial semantic information learned by pre-trained models.}
   \label{fig:shift}
   \vspace{-0.5cm}
\end{figure}
