...
%%%%%%%%% TITLE
\title{ViewRefer: Grasp the Multi-view Knowledge for 3D Visual Grounding}%\\by Linguistic-dense GPT and Prototypes\vspace{-0.4cm}}
...
With our designed paradigm, ViewRefer achieves superior performance on three benchmarks and surpasses the second-best by \textbf{+2.8\%}, \textbf{+1.5\%}, and \textbf{+1.35\%} on Sr3D, Nr3D, and ScanRefer.
\end{abstract}
