...
g= dt^2 + A^2 \left(\sum_{i=1}^3 \left(e_i^+\right)^2 \right) + B^2 \left( \sum_{i=1}^3 \left(e_i^-\right)^2 \right)
\end{align}
...
\end{align}
with $\lbrace E_i \rbrace_{i=1,2,3}$ a basis of left-invariant vector-fields dual to $\lbrace e_i \rbrace_{i=1,2,3}$, and real-valued functions $\left( f_+, f_- \right)$ satisfying the ODE system  
