...
classical dissipativity, see \cite{Willems1972, HillMoylan1980}, {has been throughly investigated. However, $L$-dissipativity has not been directly considered.} 
...
\end{align*}
{as discussed in \cite{Toth2011_SSrealizationTCST}. This form is easily computable in the SISO case, while computation in the {MIMO} case requires the choice of an algebraically independent state basis, which can be accomplished via \cite{Toth15CDCb}.} 
...
\end{equation}
Hence, model-based $L$-dissipativity verification corresponds to
