...
\begin{center}
For information on how to cite and for the publisher's version, please
...
of the features and it preserves zero entries in sparse datasets (which
...
property prediction and another for predicting Raman spectra prediction.
...
slighly better results: it outperformed the ST-NN in 24 properties
...
to viscosity. Properties predicted better by random forest than NN
were mostly targets with more than 10k examples.
