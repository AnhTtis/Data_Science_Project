...
\setlength\belowcaptionskip{-1.3\baselineskip}
    \centering
    \includegraphics[width=0.8\columnwidth]{Figures/Fig1_new.pdf}
...
\setlength\belowcaptionskip{-0.5\baselineskip}
    \centering
    \includegraphics[width=0.82\linewidth]{Figures/Visualization_1.pdf}
...
\begin{figure*}[t]
\setlength\belowcaptionskip{-1.6\baselineskip}
    \centering
    \begin{minipage}{.42\textwidth}
        \centering
        \includegraphics[width=1\columnwidth]{Figures/pascal_sparsity_3.pdf}
    ...
    \begin{minipage}{0.46\textwidth}
       \centering
        \includegraphics[width=1\columnwidth]{Figures/Human_parse_abliation_study.pdf}
        \caption{The impacts of $\lambda_w$ and $\lambda_{a1}$ on the human parsing task for Pascal-context dataset.}
    \label{fig:fig_abl_task}
    \end{minipage}
\end{figure*}
...
\newcommand{\tabelablationnpascal}{
    ...
    \hline
    \multirow{2}{*}{\textbf{Method}}        & \textbf{Semseg} & \textbf{Parsing} & \textbf{Saliency} & \textbf{Normal} & \textbf{Boundary} & \multirow{2}{*}{\textbf{Param} (M)}  & \textbf{Total} & \textbf{Base-task} & \textbf{Per Sub-task}                \\
     ...
     Single Task (ST) & 78.24 &	73.85&	85.33&	13.32&	79.9&	438.02&	585.15 & 120.53 & 116.15      \\ \hline
    \\[\dimexpr-\normalbaselineskip+2pt]
    InvPT  & 77.33  & 66.62 & 85.14 & 13.78 & 73.2 & 176.35 & 412.17 & 82.43 & 82.43  \\
    Ours + weight sharing        & 78.24 & 73.16 & 85.42 & 13.34 & 79.9 & 114.02 & 585.15  & 120.53 & 116.15 \\
    \rowcolor[gray]{.90}
        Ours + weight + act sharing   & \textbf{78.24}  & \textbf{71.71} & \textbf{85.28}  & \textbf{13.65} & \textbf{78.6} & \textbf{114.02} & \textbf{295.84}& 120.53 & \textbf{43.76}\\
     \hline
    \end{tabular}}}
    ...
    \hline
    \multirow{2}{*}{\textbf{Method}}        & \textbf{Semseg} & \textbf{Depth} & \textbf{Normal} & \textbf{Boundary} & \multirow{2}{*}{\textbf{Param} (M)}  & \textbf{Total} & \textbf{Base-task} & \textbf{Per Sub-task}                    \\
           ...
           \\[\dimexpr-\normalbaselineskip+2pt]
    Single Task (ST) & 50.48 &		521.5& 17.26&	77.84&		366.64&	314.14 & 75.20 & 79.64        \\ \hline
    \\[\dimexpr-\normalbaselineskip+2pt]
    InvPT  &  50.30  & 536.7 & 19.00 & 77.6 &  160.57 & 229.43 & 57.35 & 57.35  \\
    Ours + weight sharing        & 50.46 &  529.6& 17.62 & 77.84 &  122.46 & 314.14  & 75.20 & 79.64 \\
    \rowcolor[gray]{.90}
    Ours + weight + act sharing   & \textbf{50.46}  & \textbf{533.2} & \textbf{18.42}  & \textbf{77.89} &  \textbf{122.46} & \textbf{186.88} & 75.20 & \textbf{37.22}   \\
     \hline
    \end{tabular}}}
    \vspace{-7mm}
    \end{table*}
...
%\caption{Temporal comparison results on NYUD-v2.} 
  ...
  %\caption{table 1}
    \caption{Performance on Pascal-context dataset using Swin-B as the transformer backbone (replacing ViT-B).}
    \vspace{-1mm}
    \centering
    \hrule
    \label{SWINB}
    ...
    \rowcolor[gray]{.90}
    \shortstack{Ours}        & \textbf{79.1} & \textbf{70.0} & \textbf{84.2} & \textbf{14.3} &   \textbf{74.5} & \textbf{149.3} &\textbf{241.1} \\
