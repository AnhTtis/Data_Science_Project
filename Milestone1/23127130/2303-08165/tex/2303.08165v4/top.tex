...
\newcounter{comments}
\newcommand{\commentSF}[1]{\textbf{\color{red}(SF\arabic{comments})} \marginpar{\scriptsize\raggedright\textbf{\color{red}(SF\arabic{comments}):} #1}
    \addtocounter{comments}{1}}

\newcommand{\commentPS}[1]{\textbf{\color{blue}(PS\arabic{comments})} \marginpar{\scriptsize\raggedright\textbf{\color{blue}(PS\arabic{comments}):} #1}
    \addtocounter{comments}{1}}