...
\end{enumerate}
These lightcurve intervals and their corresponding sub-intervals will be referenced throughout this work.
...
In light of the recent quasi-periodic oscillation (QPO) study of GRB\,211211A reported in \citet{xiao2022_qpo} and of GRB\,910711 and GRB\,931101B reported in \citet{Chirenti2023}, we performed a QPO search on \grb using the high time-resolution \gbm \tte data across a wide range of frequencies using two different methods. 

We separately searched interval I (the triggering pulse), intervals III+IVa (the beginning of the main emission period before the first \gbm BTI), intervals IVc+V+VIa (the emission between the two \gbm BTIs), and intervals VIc+VII+VIII (the period after the end of the second \gbm BTI). Since the loss of \tte packets during the \gbm BTIs creates artificial structure in the lightcurves, we do not consider these regions in our analysis. Visual inspection of sub-interval Vc suggests potentially interesting variability, thus we also search that segment separately.
