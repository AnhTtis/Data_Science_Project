...
\begin{document}
	...
	\begin{equation}
		\begin{aligned}
			...
			\overline{|Y|^2} &= \frac{1}{q}\frac{(1 / r)((r / 2) !)^2}{(N / 2)^{r-1}}.
		\end{aligned}
	\end{equation}
	...
	\begin{widetext}
		\begin{equation}
			\begin{aligned}
				S_{0;i} = - \operatorname{Tr} \ln\left(\Gg_{o;i}^{-1} - \Sigma_i\right) - \int d t_1 d t_2\left(\Sigma_i\left(t_1, t_2\right) \Gg_i\left(t_2, t_1\right)-\frac{J_i(t_1)J_i(t_2)}{2q^2}\left(-4\Gg_i\left(t_1, t_2\right) \Gg_i\left(t_2, t_1\right)\right)^{\frac{q}{2}}\right)
			\end{aligned}
