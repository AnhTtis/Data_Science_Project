...
Recently the subensemble acceptance method~(SAM) to correct the fluctuation measurements for global conservation laws has been  developed~\cite{Vovchenko:2020tsr,Vovchenko:2020gne,Poberezhnyuk:2020ayn,Vovchenko:2021yen,Barej:2022jij,Barej:2022ccb,Savchuk2022msa}. 
...
\begin{figure}
    ...
    \caption{The variant of the volume fraction occupied by the liquid phase, ${\rm Var}[x]$, as a function of $\mean{x}\equiv x_0$ and $\alpha$ calculated in the Minecraft model~[Eq.~(\ref{cube-var})]. 
