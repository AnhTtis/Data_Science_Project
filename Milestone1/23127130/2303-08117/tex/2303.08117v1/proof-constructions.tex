...
\begin{align}
    \alpha(A, i-\ell, i) =&  \sum_{B, C \in \gN} \sum_{j=i-\ell}^{i-1} \Pr[A \rightarrow B C]  \cdot \alpha(B, i-\ell, j) \cdot \alpha(C, j+1, i) \nonumber \\
    =& \sum_{j=i-\ell}^{i-1} \sum_{B, C \in \gN}  \Pr[A \rightarrow B C]  \cdot \alpha(B, i-\ell, j) \cdot \alpha(C, j+1, i). \label{eq:construction-inside-computation-soft-attn}
    %\\
...
\begin{align*}
    & (\mK_{A}^{(\ell)} \ve_j^{(\ell-1)})^{\top}  \mQ_{A}^{(\ell)} \ve_i^{(\ell-1)} = \sum_{B, C \in \gN}   \Pr[A \to B C] \cdot \alpha(B, i-\ell_1, i) \cdot  \alpha (C, j - (\ell - 1 - \ell_1), j).
\end{align*}
...
\begin{align*}
    & (\mK_{A}^{(\ell)} \ve_j^{(\ell-1)})^{\top}  \mQ_{A}^{(\ell)} \ve_i^{(\ell-1)} = \sum_{\ell_1 \le \ell-1} \sum_{B, C \in \gN}   \Pr[A \to B C] \cdot \alpha(B, i-\ell_1, i) \cdot  \alpha (C, j - (\ell - \ell_1 - 1), j).
\end{align*}
...
\begin{align*}
     \text{ReLU}(\mK_{A}^{(\ell)} \ve_j^{(\ell-1)} + p_{j-i} - b_{j-i, \ell})^{\top}  \mQ_{A}^{(\ell)} \ve_i^{(\ell-1)} &= \sum_{B, C \in \gN} \Pr[A \to B C] \cdot \alpha(B, j+1, i) \cdot  \alpha (C, i-\ell, j),
\end{align*}
...
\begin{align}
    ...
    \beta_1(A,i,i+\ell) = \sum_{j=1}^{i-1}  \sum_{C,B \in \gN} \Pr[B \to C A] \alpha(C, j, i-1) \beta(B, j, i+\ell), \text{ and } \label{eq:beta1_soft} \\&
    \beta_2(A, i, i+\ell) = \sum_{j=i+\ell+1}^{L} \sum_{B,C \in \gN}  \Pr[B \to A C] \alpha(C, i+\ell+1, j) \beta(B, i, j). \label{eq:beta2_soft}
\end{align}
...
\begin{align*}
    & (\mK_{A}^{(\tilde\ell)} \ve_j^{(\tilde\ell-1)})^{\top}  \mQ_{A}^{(\tilde\ell)} \ve_i^{(\tilde\ell-1)} = \sum_{B, C \in \gN}   \Pr[B \to CA] \cdot \alpha(C, i-1-\ell_1, i-1) \cdot  \beta (B, j, j + \ell + \ell_1 + 1).
\end{align*}
...
\begin{align*}
    & (\mK_{A}^{(\tilde\ell)} \ve_j^{(\tilde\ell-1)})^{\top}  \mQ_{A}^{(\tilde\ell)} \ve_i^{(\tilde\ell-1)} = \sum_{\ell_1 \ge 0} \sum_{B, C \in \gN}   \Pr[B \to CA] \cdot \alpha(C, i-1-\ell_1, i-1) \cdot  \beta (B, j, j + \ell + \ell_1 + 1).
\end{align*}
...
\begin{align*}
    & (\mK_{A}^{(\tilde\ell)} \ve_j^{(\tilde\ell-1)})^{\top}  \mQ_{A}^{(\tilde\ell)} \ve_i^{(\tilde\ell-1)} = \sum_{B, C \in \gN}   \Pr[B \to AC] \cdot \alpha(C,  j-\ell_1+\ell+L, j-1) \cdot  \beta (B, i, i + \ell_1 - L).
\end{align*}
...
\begin{align*}
    & (\mK_{A}^{(\tilde\ell)} \ve_j^{(\tilde\ell-1)})^{\top}  \mQ_{A}^{(\tilde\ell)} \ve_i^{(\tilde\ell-1)} = \sum_{ \ell_1 \ge \ell + 1 } \sum_{B, C \in \gN}   \Pr[B \to AC] \cdot \alpha(C, j-\ell_1+\ell, j-1) \cdot  \beta (B, i, i + \ell_1).
\end{align*}
...
\begin{align*}
     \text{ReLU}(\mK_{A}^{(\tilde\ell)} \ve_j^{(\tilde\ell-1)} + p_{j-i} - b_{j-i, \tilde\ell})^{\top}  \mQ_{A}^{(\tilde\ell)} \ve_i^{(\tilde\ell-1)} &= \sum_{j=i+\ell+1}^{L} \sum_{B,C \in \gN}  \Pr[B \to A C] \alpha(C, i+\ell+1, j) \beta(B, i, j),
\end{align*}
