...
These are the necessary conditions for thermodynamic equilibrium of the hadronic and quark phases, also called Gibbs' conditions.
...
In the present work, due to limitations of the effective models employed, we only deal with first order phase transitions. In this kind of transition, the absorption or loss of energy in the form of latent heat is always possible \cite{greiner_thermodynamics} and this quantity will be discussed later on, in a future section.
