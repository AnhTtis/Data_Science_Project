...
\label{sec:metamodel-composition}
	...
	Besides standard ROS communication methods, the Non-ROS are also included (e.g., http request) to achieve interfaces with Non-ROS parts of the general system. An Action Data Structure comprises data used by three of five Topics composed in Action, i.e., goal, feedback and result. Two remaining Topics, i.e., cancel and status are standardised.
	 ...
	 \end{figure}
  	...
  	The Running System (Fig.~\ref{fig:running_system_bdd}) composes ROS and Non-ROS Communicating Component specializations as well as Connections between them.  Again, two Nodes are highlighted for ROS~1: rosout and ROS master. Additionally, a Parameter block is introduced also for ROS~1. In ROS~2, due to safety reasons, Parameter is composed only into Nodes.
	
		% DLA SKLADU ZMIENIONO WIELKOSC Z 0.7	
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[scale=0.71]{img/meros_pkg/running_system_bdd.png}}
		\end{center}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[scale=0.7]{img/meros_pkg/intrasystem_bdd.png}}
		\end{center}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[scale=0.7]{img/meros_pkg/namespace_bdd.png}}
		\end{center}
...
\label{sec:metamodel-communication}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[scale=0.7]{img/meros_pkg/topic_communication_with_dedicated_component_ibd.png}}
		\end{center}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[scale=0.7]{img/meros_pkg/topic_split_publisher_ibd.png}}
		\end{center}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[scale=0.7]{img/meros_pkg/topic_split_subscriber_ibd.png}}
		\end{center}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[scale=0.7]{img/meros_pkg/topic_communication_without_dedicated_component_ibd.png}}
		\end{center}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[scale=0.7]{img/meros_pkg/topic_communication_without_dedicated_component_sd.png}}
		\end{center}
...
\label{sec:metamodel-service}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[scale=0.7]{img/meros_pkg/service_communication_ibd.png}}
		\end{center}
...
\label{sec:application-example}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[scale=0.68]{img/rico_pkg/rico_workspace_nodes_bdd.png}}
		\end{center}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[scale=0.68]{img/rico_pkg/rico_workspace_msgs_bdd.png}}
		\end{center}
