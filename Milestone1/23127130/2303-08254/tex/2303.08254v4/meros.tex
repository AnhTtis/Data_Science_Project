...
\begin{document}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[width=\columnwidth]{img/requirement_pkg/communicating_components_req.png}}
		\end{center}
	...
	Other concepts [R3.4] depicted in Fig.~\ref{fig:other_concepts_req} include three elements. ROS Parameter Server [R3.4.1] manages ROS Parameters [3.4.2], roscore [R3.4.3] forms a collection of programs and nodes that are pre-requisites of a ROS~1-based system.
	...
	To achieve intuitiveness MeROS presents Running system structure (Fig.~\ref{fig:running_system_req}) following rqt\_graph pattern [R4.1]. In particular, there are two ways to present communication with topics, including [R4.1.1]
	...
	Relations of Communicating Components are depicted in Fig.~\ref{fig:communication_blocks_bdd} and \ref{fig:communication_blocks2_bdd}. 
	
	
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[width=.95\columnwidth]{img/meros_pkg/communicating_component_bdd.png}}
		\end{center}
	...
	\begin{figure}[H]
		\centering
		\begin{center}
			{\includegraphics[width=.95\columnwidth]{img/meros_pkg/communicating_component2_bdd.png}}
		\end{center}
	...
	The part of the <<Workspace>> \texttt{Rico} that includes previously mentioned elements is presented in Fig.~\ref{fig:rico_workspace_nodes_bdd} and.~\ref{fig:rico_workspace_msgs_bdd}.
	
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[width=\columnwidth]{img/rico_pkg/rico_workspace_nodes_bdd.png}}
		\end{center}
	...
	\begin{figure}[htb]
		\centering
		\begin{center}
			{\includegraphics[width=\columnwidth]{img/rico_pkg/rico_workspace_msgs_bdd.png}}
		\end{center}
