...
\author{Alexandra Silva}{Department of Computer Science, Cornell University, Ithaca, NY, USA}{}{}{}%
\author{Gerco van Heerdt}{Droit Financial Technologies, London, UK}{}{}{}%{[orcid]}{[funding]}
\author{Leon Witzman}{Department of Computer Science, Cornell University, Ithaca, NY, USA}{}{}{}%{[orcid]}{[funding]}
%{[orcid]}{[funding]}TODO mandatory, please use full name; only 1 author per \author macro; first two parameters are mandatory, other parameters can be empty. Please provide at least the name of the affiliation and the country. The full address is optional. Use additional curly braces to indicate the correct name splitting when the last name consists of multiple name parts.
