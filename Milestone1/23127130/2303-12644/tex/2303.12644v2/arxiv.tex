...
Our image to sequence approach achieves an $R^2$ score of 93\%, which is 38 points higher than recently proposed sequence to sequence generation methods. Code and models will be available at: \url{https://github.com/HReynaud/EchoDiffusion}.
