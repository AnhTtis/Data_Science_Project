...
%\usepackage{lmodern}                % Package is forbidden because it changes the main fonts
\usepackage{algorithm}
\usepackage{svg}
\usepackage{algpseudocode}
\usepackage{listings}
\usepackage{ifthen}
%\usepackage{geometry}               % Package is forbidden because it changes the page dimensions
...
\newenvironment{proof_of}[1]{\begin{proof}[Proof of #1.]}{\end{proof}}
