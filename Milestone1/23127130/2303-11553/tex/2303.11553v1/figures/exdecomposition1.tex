...
\begin{tikzpicture}[remember picture]
    \node [tnode] at (0, 0) (root) {
        \begin{tikzpicture}[scale=1/2]
            ...
            % \node [node] at (0, 0) (rootfriend) {};
            \node [nts] at (1/2, -3/2) (root1) {\scriptsize 1};
            \node [nts] at (-1, -1) (root2) {\scriptsize 2};
    ...
    \node [tnode] at (2/3 - 1/10, -\levelone) (1l2) {
        \begin{tikzpicture}[scale=2/3]
            ...
            \node [nts] at (-7/10, -1/2) (1l2n1) {\scriptsize 1};
    ...
    \begin{scope}[on background layer]
        \draw [cone, name path=root2l] (root2.west) -- (1l1.north west);
        \draw [cone, name path=root2r] (root2.south) -- (1l1.east);
        \tikzfillbetween[
            on layer=background,
            of=root2l and root2r
        ] {plotgrey};

        \draw [cone, name path=root1l] (root1.south west) -- (1l2.west);
        \draw [cone, name path=root1r] (root1.south east) -- (1l2.north east);
        \tikzfillbetween[
            on layer=background,
            of=root1l and root1r
        ] {plotgrey};
        \draw [cone, name path=root1m] (root1.south west) -- (1l2.south);
        \tikzfillbetween[
            on layer=background,
            of=root1m and root1r
        ] {plotgrey};
