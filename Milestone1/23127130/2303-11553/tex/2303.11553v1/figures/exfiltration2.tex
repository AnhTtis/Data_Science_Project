...
\begin{tikzpicture}[sloped]
    \begin{scope}[scale=1, xscale=1] % xscale=-1
        \node (root) at (5 * \linelength, 0 * \linelength) {};
        \node (bc) at (5 * \linelength, -1 * \linelength) {};
        \node (bl1) at (-4 * \linelength, -2 * \linelength) {};
        \node (bl21) at (-18 * \linelength, -3 * \linelength) {};
        \node (bl2prime) at (-14 * \linelength, -3 * \linelength) {};
        ...
        \node (br2m) at (12 * \linelength, -2 * \linelength) {};
        \node (br2p) at (18 * \linelength, -2 * \linelength) {};

        \node [node] (a) at (-18 * \linelength, \botnodelevel * \linelength) {};
        \node [addnode] (x) at (-16 * \linelength, \botnodelevel * \linelength) {};
        \node [addnode] (y) at (-14 * \linelength, \botnodelevel * \linelength) {};
        \node [addnode] (z) at (-12 * \linelength, \botnodelevel * \linelength) {};
        ...
        \node [delnode] (m) at (12 * \linelength, \botnodelevel * \linelength) {};
        \node [node] (n) at (14 * \linelength, \botnodelevel * \linelength) {};
        \node [node] (o) at (16 * \linelength, \botnodelevel * \linelength) {};
        \node [delnode] (p) at (18 * \linelength, \botnodelevel * \linelength) {};
        \node [node] (q) at (20 * \linelength, \botnodelevel * \linelength) {};

        \draw [addfedge] (bl2prime.center) |- (bl1.center);
        \draw [addfedge] (x) |- (bl2prime.center);
        \draw [addfedge] (y) |- (bl2prime.center);
        \draw [addfedge] (z) |- (bl2prime.center);
        \draw [delfedge] (m) -- (br2m);
        \draw [delfedge] (p) -- (br2p);
