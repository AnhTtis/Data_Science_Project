\begin{tikzpicture}
    \begin{scope}[scale=1]  % for the nodes
        ...
        \node [node, draw=white, fill=white] at (pa1) (a1) {};
        \node [node] at (pb1) (b1) {};
        \node [node] at (pc1) (c1) {};
        \node [node] at (pd1) (d1) {};
        \node [node] at (pe1) (e1) {};
        ...
        \node [node, shift={(\radtri + 1*\rottri : \figscale/3)}] at (pf1) (f2) {};
        ...
        \node [node, shift={(\radtri + 2*\rottri : \figscale/3)}] at (pfhub) (f5) {};
    \end{scope}
    \begin{scope}[scale=1] % for the edges
        ...
        \draw [edge] (fhub) -- (f4);
        \draw [edge] (fhub) -- (f5);
        \draw [edge, bend right=\arcstraight] (f3) -- (f4);
        \draw [edge, bend right=\arcstraight] (f4) -- (f5);
