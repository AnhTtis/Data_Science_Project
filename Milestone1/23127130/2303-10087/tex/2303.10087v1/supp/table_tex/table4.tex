...
% \midrule
\multirow{4}{*}{\makecell[c]{same lr}}&$lr_{R}=lr_t=0.1$              & 0.91m/22.70$\degree$\\
&$lr_{R}=lr_t=0.01$             & 0.49m/1.51$\degree$\\
&$lr_{R}=lr_t=0.003$\cite{lin21barf,Chng22garf}            & 0.54m/2.44$\degree$\\
&$lr_{R}=lr_t=0.001$\cite{wang2021nerfmm,bian22nope,yen2020inerf}            & 0.57m/2.48$\degree$\\
\midrule
