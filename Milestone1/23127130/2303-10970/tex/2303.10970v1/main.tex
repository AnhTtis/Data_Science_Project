...
\end{equation*}
    where $rank(\vert u_i\vert)$ is the rank of the distinct values of $|u|$; (see \cite{skalski2022pattern},\cite{bogdan2022pattern}). 
...
\end{equation}
\begin{corollary}\label{recovery of the true signal}
