...
More recently, InstructPix2Pix \cite{brooks2022instructpix2pix} tackled the problem via a different approach, requiring only human-readable editing instruction to perform image editing. 
...
A concurrent work \cite{Lee2023aligning} also leverages human feedback to align text-to-image generation, where they intuitively consider reward as weights for negative log-likelihood. 
Our work tackles the problem of \textit{instructional image editing}, where there are \textit{no ground truth data} for the alignment between \textit{human-readable} editing instructions and {edited images}, making human feedback extremely valuable. 
