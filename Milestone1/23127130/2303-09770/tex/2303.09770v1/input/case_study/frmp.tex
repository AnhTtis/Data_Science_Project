...
Solving this nonlinear constrained least squares optimization problem can be expensive; the original study\footnote{Work is currently being done to replicate this study for a fairer computational comparison.} required over 8 hours to optimize each graph to determine $J(G_i)$.
