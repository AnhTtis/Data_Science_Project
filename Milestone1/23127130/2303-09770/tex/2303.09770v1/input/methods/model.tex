...
This process creates numerical features as vectors from the graph structure. 
...
Typically, this value ranges from $0.0$ to $1.0$. 
...
The number of epochs is explored in the different experiments in the case study. 
...
Instead of processing data points one-by-one or all at once, a mini-batch groups a set of data points of intermediary size. 
