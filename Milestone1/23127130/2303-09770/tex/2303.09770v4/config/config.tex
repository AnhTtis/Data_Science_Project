...
\hypersetup{
    ...
    pdftitle={On the Use of Geometric Deep Learning for the Iterative Classification and Down-Selection of Analog Electric Circuits},    % title
...
% watermark
%\usepackage[hpos=0.5\paperwidth,hanchor=c]{draftwatermark} % watermarks
% \newcommand{\xwatermarktext}{\parbox{20in}{\centering\textsf{\textbf{DRAFT}}\\\vspace*{-0.25\baselineskip} [do not distribute]}}
% \SetWatermarkText{\makebox[1.5\width]{\xwatermarktext\hfill\xwatermarktext}}

%\SetWatermarkText{\textsf{\textbf{DRAFT} [do not distribute]}}
% \SetWatermarkText{a}
% \SetWatermarkAngle{0}
% \SetWatermarkColor{black!50}
% \SetWatermarkHorCenter{5.425in}
% \SetWatermarkVerCenter{12in}
% \SetWatermarkScale{0.12}

% line numbers
\usepackage[displaymath,switch]{lineno}
