...
% To begin, let us go over the definition of a graph. 
...
% A vertex that has a degree of $0$ is considered isolated.
...
% As mentioned, we can now extract the features from this circuit graph, the features being the components, and we represent it with the matrix $\textbf{X} \in \mathrm{R}^{n \times c}$ and for this graph is shown in \eref{feature2}.
% Each row represents the vertex number, and $c$ represents the feature.
\subsubsection{Representing Electric Circuits as Graphs.}
% The following section will take what we learned here and apply it to a real-world system.
% We will discuss how to represent a system as a graph, extract its features, and show how isomorphism plays a role in these design problems.
...
% Since the first case study involves circuits, we will use a circuit as an example to represent a system as a graph.
...
% The graph still contains the same basic structure as the original circuit, and 
...
% As mentioned, we can now extract the features from this circuit graph, the features being the components, and we represent it with the matrix $\textbf{X} \in \mathrm{R}^{n \times c}$ and for this graph is shown in \eref{feature2}.
% Each row represents the vertex number, and $c$ represents the feature.
% A features matrix can have as many columns as necessary to represent the features associated with each vertex.

% To represent the structure of the circuit with an adjacency matrix, we use \eref{adjeq}, and the matrix is shown in \eref{adjmat} where $1$ represents a connection between two vertices.
% \begin{equation}
% % \arraycolsep=1.8pt
% \def\arraystretch{0.8}
% \textbf{A} = \left[\begin{array}{ccccccccccccc}  
% \xz{0} & 1 & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0}\\ 1 & \xz{0} & 1 & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0}\\ \xz{0} & 1 & \xz{0} & 1 & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0}\\ \xz{0} & \xz{0} & 1 & \xz{0} & 1 & \xz{0} & \xz{0} & \xz{0} & 1 & 1 & \xz{0} & \xz{0} & \xz{0}\\ \xz{0} & \xz{0} & \xz{0} & 1 & \xz{0} & 1 & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0}\\ \xz{0} & \xz{0} & \xz{0} & \xz{0} & 1 & \xz{0} & 1 & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0}\\ \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & 1 & \xz{0} & 1 & 1 & \xz{0} & \xz{0} & \xz{0} & \xz{0}\\ \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & 1 & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0}\\ \xz{0} & \xz{0} & \xz{0} & 1 & \xz{0} & \xz{0} & 1 & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0}\\ \xz{0} & \xz{0} & \xz{0} & 1 & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & 1 & \xz{0} & \xz{0}\\ \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & 1 & \xz{0} & 1 & \xz{0}\\ \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & 1 & \xz{0} & 1\\ \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & \xz{0} & 1 & \xz{0} \end{array}\right]
% \label{adjmat}
% \end{equation}
