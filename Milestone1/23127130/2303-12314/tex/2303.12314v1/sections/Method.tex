...
\paragraph{Analysis of SUPMER.} Here we give some analysis to help better understand SUPMER, especially the meta-gradient regularization method. Focusing on one meta-training task, we can denote the objective of SUPMER as follows for convenience:
\begin{equation}
\label{eq:obj}
\small
...
\end{aligned}
\end{equation}
So far, we have completed the description of the whole SUPMER framework. And we give the pseudo-codes of SUPMER in Appendix \ref{app:pseudo_code}.
