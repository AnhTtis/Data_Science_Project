...
Several  studies have claimed that post-Newtonian corrections to the Newtonian equations of galaxy dynamics remove the need for dark matter.    
...
Recently, however, a number of studies have suggested that GR effects can account for galaxy rotation curves, eliminating the need for  
unseen matter components or modifications of Newtonian dynamics.  This includes the analysis of \citet{cetal_20}, who took \emph{Gaia} data on the motion 
of Galactic stars and attempted to fit the results using both a Newtonian model with dark matter, and a GR model without dark matter.  
