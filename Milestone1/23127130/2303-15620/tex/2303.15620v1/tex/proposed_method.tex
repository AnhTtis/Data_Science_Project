...
% \begin{figure}
%     \centering
%     \includegraphics[width=1\linewidth]{img/fall_detection/proposed_method/IMG_0799.jpg}
%     \captionsetup{font=scriptsize}
%     \caption{This figure depicts how the training data is determined for the abrupt fault and incipient fault SVM based on the results of the fault detector SVM.
%     }
%     \label{fig:trainData_classifiers}
% \end{figure}