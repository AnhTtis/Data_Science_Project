...
\begin{figure}[t]
    \begin{center}
        \centering
        \includegraphics[trim={0.8cm 0.8cm 0.8cm 0.8cm},clip,width=0.5\textwidth]{figures/detector/detector-v1.pdf}
    \end{center}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.7\textwidth]{figures/detector/geometryok_color.png}
    \includegraphics[width=.7\textwidth, trim={-10 0 0 -10}]{figures/detector/geometry_zoom2_color.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/BIB_time.pdf}\includegraphics[width=0.5\textwidth]{figures/detector/BIB_zmu.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/BIB_Ekin.pdf}\includegraphics[width=0.5\textwidth]{figures/detector/BIB_z.pdf}
...
\begin{figure*}[h]
    \begin{center}
        \centering
\includegraphics[width=0.8\textwidth]{figures/detector/1mevneq_nodump.png}
    \end{center}
...
\begin{figure*}[h]
    \begin{center}
        \centering
        \includegraphics[width=.8\textwidth]{figures/detector/tid_nodump.png}
    \end{center}
...
\begin{figure}[!ht]
\center
\includegraphics[width=0.5\textwidth, trim= {35 55 0 0 } , clip]{figures/detector/HitDensity.png}
...
\begin{figure*}[h]
\centering
\includegraphics[width=0.95\textwidth]{figures/detector/CMOS_and_LGAD.jpg}
...
\begin{figure*}[h]
\centering
\includegraphics[width=0.95\textwidth]{figures/detector/Bump_and_hybrid.png}
...
\begin{figure}[!ht]
\center
\includegraphics[width=0.425\textwidth, trim = {65 55 0 10} ,clip]{figures/detector/occupancy_calo_barrel.png}
...
\begin{figure}[!ht]
\center
\includegraphics[width=0.4226\textwidth,trim = {65 45 0 0} ,clip]{figures/detector/occupancy_calo_endcap.png}
...
\begin{figure}[!t]
\center
\includegraphics[width=0.48\textwidth,trim = {14 9 0 0} ,clip]{figures/detector/edeposit_ECAL.png}   \caption{Energy deposited by the BIB in a single bunch-crossing in the ECAL.}
\label{fig:ecal_deposit}
\end{figure}
   
\begin{figure}[!t]
\center
\includegraphics[width=0.48\textwidth,trim = {12 9 0 0} ,clip]{figures/detector/edeposit_HCAL.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/detector/CADprototype.png}
...
\begin{figure}[!t]
    \center
    \includegraphics[width=0.48\textwidth, trim = {10 6 0 32} , clip]{figures/detector/cell.png}
...
\begin{figure}[!t]
    \center
    \includegraphics[trim={0cm 0cm 0cm 2cm},clip,width=0.5\textwidth]{figures/detector/BIBEnergyDistribution_NeutronsvsTheta.png}
...
\begin{figure}[!h]
    \center
    \includegraphics[trim={0cm 0cm 0cm 2cm},clip,width=0.5\textwidth]{figures/detector/BIBEnergyDistribution_PhotonsvsTheta.png}
...
\begin{figure}[!ht]
    \center
    \includegraphics[trim={1cm 1cm 0cm 2cm},clip,width=0.5\textwidth]{figures/detector/Comparison_NeutronHitRate_BF.png}
...
\begin{figure}[!ht]
    \center
    \includegraphics[trim={1cm 1cm 0cm 2cm},clip,width=0.5\textwidth]{figures/detector/Comparison_GammaHitRate_BF.png}
...
\begin{figure}[!t]
\center
\includegraphics[width=0.42\textwidth]{figures/detector/HLT_swEB.png}
\includegraphics[width=0.42\textwidth]{figures/detector/HLT_hwEB.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.49\textwidth, trim = {0 4 0 18 } , clip]{figures/detector/eff_vs_pt_purity50.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.49\textwidth, trim = {0 8 0 18 } , clip]{figures/detector/res_vs_theta_purity50_chi2ndf10.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.49\textwidth, trim = {0 10 0 18 } , clip]{figures/detector/trk_res_D0.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.49\textwidth, trim = {0 10 0 18 } , clip]{figures/detector/trk_res_Z0.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/detector/double_layer.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.47\textwidth]{figures/detector/dPhi_pt_vxdb.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.47\textwidth]{figures/detector/dTheta_pt_bs_vxdb.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/detector/hit_mult_dl.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.486\textwidth, trim = {0 0 0 15 } , clip]{figures/detector/efficiency_muonGun_truth_pt.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.475\textwidth, trim = {0 0 0 25 } , clip]{figures/detector/efficiency_muonGun_truth_theta.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth, trim = {0 0 0 10 } , clip]{figures/detector/fakevsreal_muonGun_pt.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.475\textwidth]{figures/detector/fakevsreal_muonGun_nhit.pdf}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.48\textwidth]{figures/detector/norm_time_calo.pdf}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.47\textwidth]{figures/detector/jet_ntracks.pdf}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/jet_eff_flavour.pdf}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.48\textwidth]{figures/detector/jet_eff_theta.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/jet_fake_rate.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.48\textwidth]{figures/detector/jec_0.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.48\textwidth]{figures/detector/jec_3.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/delta_theta.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{figures/detector/jet_reso_flavour.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{figures/detector/higgs_vs_z.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.48\textwidth]{figures/detector/higgs_noBIB.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/detector/calo_longitudinal.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{figures/detector/nvtx_hits_def.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{figures/detector/p_t_tracks_def_log.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{figures/detector/z0.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{figures/detector/tau.pdf}
...
\begin{figure}[b]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/b_tagging.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/b_tagging_theta.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/c_misidentification.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/c_misidentification_theta.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/light_misidentification.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/light_misidentification_theta.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/photon_eff_ene.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/photon_eff_theta.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/photon_res_ene.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/photon_res_theta.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/detector/photon_misID_ene.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{figures/detector/electron_eff_ene.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{figures/detector/electron_eff_theta.pdf}
...
\begin{figure}[t]
\center
\includegraphics[width=0.47\textwidth]{figures/detector/efficiency_pt.pdf}
...
\begin{figure}[t]
\center
\includegraphics[width=0.47\textwidth]{figures/detector/efficiency_theta.pdf}
...
\begin{figure}[t]
\center
\includegraphics[width=0.5\textwidth]{figures/detector/resolution.pdf}
