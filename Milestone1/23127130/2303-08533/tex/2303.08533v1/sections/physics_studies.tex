...
\begin{figure*}[ht]
\centering
\includegraphics[width=\linewidth]{figures/physics_studies/Global_Kappa_HL_MC.pdf}
...
\begin{figure*}[ht]
\centering
\includegraphics[width=0.95\linewidth]{figures/physics_studies/Global_SILH_HL_MC_4col.pdf}
...
\centering
\begin{tabular}{c c}
\hspace{-0.2cm}\includegraphics[width=0.49\linewidth]{figures/physics_studies/CHplotMuColl_Excl.pdf}
&
\includegraphics[width=0.49\linewidth]{figures/physics_studies/MZpplotMuColl_Excl.pdf}\\
%
\end{tabular}
%
...
\centering
\begin{tabular}{c c}
\hspace{-0.2cm}\includegraphics[width=0.49\linewidth]{figures/physics_studies/CHplotMuColl_Excl_ops_MC3TeV.pdf}
&
\includegraphics[width=0.49\linewidth]{figures/physics_studies/CHplotMuColl_Excl_ops_MC10TeV.pdf}\\
%
\end{tabular}
...
\begin{figure*}[ht]
\begin{centering}
\includegraphics[width=0.67\linewidth]{figures/physics_studies/singlet_new}
\caption{95~\% 
...
\begin{figure*}
\centering{}\includegraphics[width=0.45\linewidth]{figures/physics_studies/MuC_EWPT_diHiggs_4}
%
\includegraphics[width=0.43\linewidth]{figures/physics_studies/MuC_EWPT_indirect_6}
...
\begin{figure*}[ht]
\centering{}\includegraphics[width=0.5\linewidth]{figures/physics_studies/Scalar_Pair_3TeV.pdf}\hfill
\includegraphics[width=0.5\linewidth]{figures/physics_studies/Fermion_Associated_Radiation_Return_3TeV.pdf}
...
\begin{figure*}
\centering{}
\includegraphics[width=0.47\linewidth]{figures/physics_studies/lumin_3TeV.pdf}
\includegraphics[width=0.47\linewidth]{figures/physics_studies/BarsMonoX}\\
\includegraphics[width=0.47\linewidth]{figures/physics_studies/lumin_10TeV.pdf}
\includegraphics[width=0.47\linewidth]{figures/physics_studies/BarsMonoX10}\\
...
\end{equation}
where $X$ denotes any SM particle or set of particles allowed by the interactions and $\chi$ is either the DM particle or a generic state belonging to the DM $n$-plet. In both cases, $\chi$ is not seen if the mass splitting is low and no dedicated strategy is adopted to detect disappearing track as discussed in Section~\ref{secunc}.


\begin{figure*}
    \centering
    \includegraphics[width=0.45\textwidth]{figures/physics_studies/fermionic_ltplot_30000_horizontal_track_syst.pdf}\hfill
        \includegraphics[width=0.45\textwidth]{figures/physics_studies/scalar_ltplot_30000_horizontal_track_syst.pdf}
...
\subsubsection{\label{subsec:2-body-processes}Indirect reach through high-energy measurements}
...
Keeping this caveat in mind, the overall picture is clear: WIMPs can be good dark matter candidates over a large range of masses from the TeV to the PeV. A muon collider programme where the energy is progressively raised in stages can probe the resonant production of heavier and heavier candidates, but a complete coverage of the heaviest WIMPs will have to exploit off-shell effects in precision measurements of SM processes, with a mass reach that is potentially above the direct production threshold. This indirect search strategy can be effectively pursued at the muon collider through the measurement of high energy cross sections~\cite{DiLuzio:2018jwd}. These measurements benefit from a boosted sensitivity to new physics above the collider reach as explained in Section~\ref{HEM}, and they fall in the same category of those employed in Section~\ref{sec:EFT} for EFT searches.
...
\begin{figure*}
\begin{centering}
\includegraphics[width=0.49\linewidth]{figures/physics_studies/1.5-14_TeV_indirect_WinoHiggsino_with_CC.pdf}
\includegraphics[width=0.49\linewidth]{figures/physics_studies/1.5-14_TeV_indirect_Dirac_with_CC.pdf}
\par\end{centering}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/physics_studies/hino_m_vs_lifetime}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.5\textwidth]{figures/physics_studies/wino_m_vs_lifetime}
...
\begin{itemize}
\item If the physics responsible for $\Delta a_\mu$ is heavy enough, an Effective Field Theory (EFT) description holds up to the high $\mc$ energies. This was studied in \cite{Buttazzo:2020ibd}. In this case, scattering cross sections induced by the new physics effective operators grow at high energies (analogously to what discussed in Sections \ref{HEM}, \ref{sec:EFT} and \ref{secdm}), so that a measurement with modest  precision at a sufficiently high energy will be sufficient to disentangle new physics effects from the SM background. These considerations are  independent from the specific underlying model.
...
\begin{figure*}
\centering%
\includegraphics[width=0.55\textwidth]{figures/physics_studies/feyn}
...
\begin{figure*}
\centering%
\includegraphics[width=0.6\textwidth]{figures/physics_studies/reach_gm2_tan.pdf}
...
%\vspace*{-10mm}
\hspace{-0.75cm}
\includegraphics[width=0.5\textwidth]{figures/physics_studies/Singlets_Vector_Visible.pdf} ~
\includegraphics[width=0.5\textwidth]{figures/physics_studies/Singlets_Scalar_Visible.pdf}  \\ 
\hspace{-0.75cm}
\includegraphics[width=0.5\textwidth]{figures/physics_studies/Singlets_Vector_Invisible.pdf} ~
\includegraphics[width=0.5\textwidth]{figures/physics_studies/Singlets_Scalar_Invisible.pdf} 
\caption{
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.46\linewidth]{figures/physics_studies/MuC_EFT}~\includegraphics[width=0.5\linewidth]{figures/physics_studies/xsection_tanb}
\end{center}
\vspace{-0.5cm}
...
\includegraphics[width=0.9\linewidth]{figures/physics_studies/contour_SMVLL_R1c_EPJC.pdf} 
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.75\textwidth]{figures/physics_studies/lfv_4fermi_1ab}
...
\begin{figure*}[t!]
\centering
\includegraphics[width=7cm]{figures/physics_studies/3TeV_fixmB_plot.pdf}
~
\includegraphics[width=7cm]{figures/physics_studies/3TeV_mBscan_plot.pdf}
%
...
\begin{figure}[t]
	\begin{center}
		%\hspace{-1cm}
\includegraphics[width=0.45\textwidth]{figures/physics_studies/contour.pdf}
	\end{center}
	\vspace{-0.3cm}
	\caption{The sensitivity~\cite{Huang:2021nkl} of the 3~TeV MuC with $1~{\rm ab^{-1}}$ luminosity, given as orange regions. Other limits and projections are also shown for comparison. The region explaining the $(g-2)^{}_{\mu}$ anomaly is outlined by the yellow band.}
	\label{fig:contour}
\end{figure}
...
\begin{figure*}[t]
\centering
\includegraphics[bb=0.0in -0.1in 7in 6.0in,width=250pt]{figures/physics_studies/mrecoil}
...
%\noindent
As discussed in Section~\ref{sec:extendedHiggs}, the muon collider has much better perspectives than the HL-LHC to observe new heavy Higgs bosons already at the 3~TeV stage. It would also enable a very detailed characterisation of the newly discovered extended scalar sector by a number of precision measurements, including line shape studies of the new resonances produced in the $s$-channel~\cite{Eichten:2013ckl,Alexahin:2013ojp}, once their mass will be known with sufficient precision. If the mass is unknown, one can exploit the ``radiative return'' (RR) process. Namely
\begin{equation}
...
\begin{figure*}[t]
\centering
\includegraphics[scale=0.38]{figures/physics_studies/kappas}
