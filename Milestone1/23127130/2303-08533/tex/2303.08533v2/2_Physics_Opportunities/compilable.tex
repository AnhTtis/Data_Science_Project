...
%\subsection{Overview}\label{intro}
...
\begin{center}
\includegraphics[width=\textwidth]{Figures/muvsp.pdf}
\end{center}
\end{minipage}
\hfill
\begin{minipage}{0.47\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{Figures/2to2.pdf}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=\textwidth]{Figures/Pair10TeV.pdf}
\end{center}
\end{minipage}
\hfill
...
\vspace{0pt}
\includegraphics[width=.93\textwidth]{Figures/dk3.pdf}
\end{minipage}
...
\begin{figure*}
\begin{minipage}{0.47\textwidth}
\includegraphics[width=0.96\textwidth]{Figures/10TeVCTEC.pdf}
\end{minipage}
\hfill
\begin{minipage}{0.47\textwidth}
\vspace{0pt}
\includegraphics[width=0.96\textwidth]{Figures/Zprime10TeV.pdf}
\end{minipage}
...
%Obviously, we can dream of such a glorious outcome of the project only because energy and precision are simultaneously available at a muon collider.
...
{5_Physics_Studies/figures/reach_gm2_tan.pdf}
%{5_Physics_Studies/figures/reach_gm2.pdf}
%Figures/gm2}
\end{center}
%\begin{minipage}{0.53\textwidth}
%\begin{center}
%\includegraphics[width=\textwidth]{Figures/gm2}
%\end{center}
%\end{minipage}
%\hfill
...
%\end{center}
%\end{minipage}
\caption{Summary, from Section~\ref{muonspec} of the muon collider perspectives to probe the muon $g$-2 anomaly.
%Left panel: reach on the muon $g$-2 from high-energy measurements (solid lines), and from direct searches for new particles in explicit models (dashed lines). Right panel: reach from $\mu\mu\to jj$ (solid line) on the scale $\Lambda$ of semi-leptonic interactions that can account for the $B$-anomalies.
\label{fan}}
\end{figure}
...
%In the figure, dashed lines illustrate the sensitivity to three classes of models:  those featuring EW-singlet scalars or vectors, the ones including EW-charged particles in models with minimal flavour violation (MFV), and heavy lepton-like particles that mix with the muon. A complete coverage of several models is possible already at a $3$~TeV MuC, and a collider of tens of TeV could provide a full-fledged no-lose theorem.
