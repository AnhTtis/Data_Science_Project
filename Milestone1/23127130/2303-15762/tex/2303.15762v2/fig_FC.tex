...
\begin{figure*}[t]%
    ...
    \Description{}%
    \caption{
        \textbf{Sample-solve: PLT as a variance reduction technique.}
        ...
        (b) When the incident light is highly collimated (subtends a very small solid angle from the scene), hence is moderately coherent, the diffraction lobes are clearly visible.
