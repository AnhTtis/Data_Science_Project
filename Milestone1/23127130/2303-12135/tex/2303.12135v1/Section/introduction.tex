...
In addition, legal documents can be extremely long~\cite{kalamkar2022corpus}, which makes dependency-based techniques and models, such as RNN models, fail to extract the context information due to gradient vanishes.
