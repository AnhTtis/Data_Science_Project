...
As written in Section \ref{sec:EMAKI-discussion}, we evaluated if the size of EMAKI allows our data-driven method to recognise interactive tasks.
We used different percentages of the training set to train the method and examined their performances.
According to Figure~\ref{fig:TR-Ours}c, the best results were achieved by BPE-300 when windows have 150 actions.
