...
As written in Section \ref{sec:mousepreprocessing}, the Dispersion-threshold identification (I-DT) algorithm~\cite{salvucci2000identifying} was used to categorise mouse behaviour to \textit{pinpointing} a target (resembling gaze fixations) and \textit{re-direction} between targets.
