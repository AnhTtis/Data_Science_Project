...
\textbf{Locking 2-Toggle.} The Locking $2$-toggle (L2T) is a $4$ location, $3$ state gadget. The states of the gadget are shown in Figure \ref{fig:L2T}. The L2T has advantages because it universal for reversible deterministic gadgets. Reversibility was important to picking a gadget since swap reactions are naturally reversible. 
...
%    \end{subfigure}
    ...
    \end{subfigure}\hfill
    \begin{subfigure}[b]{0.13\textwidth}
        \includegraphics[width=\linewidth]{images/trav9.pdf}
    \end{subfigure}
%    \begin{subfigure}{0.08\textwidth}
...
$1$-reconfiguration is PSPACE-complete with $4$ species and $3$ swap reactions or greater even when the surface is a subset of the grid graph. 
\end{theorem}
\begin{proof}
