...
Reconfiguration in $2$-burnout sCRNs with species $(A, B, C)$ and reaction $A + B \rightarrow C + A$ is NP-complete.
\label{thm:hamPath}
\end{theorem}
\begin{proof}
...
\begin{theorem} \label{thm:3satburn}
    ...
    $1$-reconfiguration in $1$-burnout sCRNs with $17$ species and $40$ reactions is NP-complete.
\end{theorem}
